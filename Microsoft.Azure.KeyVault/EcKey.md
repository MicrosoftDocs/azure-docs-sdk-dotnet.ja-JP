<Type Name="EcKey" FullName="Microsoft.Azure.KeyVault.EcKey">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            コンス トラクターは、GUID 識別子を持つ P-256 キーを作成します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid">使用するキー識別子</param>
        <param name="ecdsa">キーの ECDsa オブジェクト</param>
        <summary>
            コンストラクターです。
            </summary>
        <remarks>ECDsa IDisposable、このクラスは ECDsa オブジェクトへの参照を保持するが、破棄はありませんは、オブジェクトがこのコンス トラクターの呼び出し元がこのパラメーターの有効期間を担当します。</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid">使用するキー識別子</param>
        <param name="curve">楕円曲線を使用するの名前</param>
        <summary>
            コンストラクターです。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid">使用するキー識別子</param>
        <param name="curve">楕円曲線; を使用するの名前サポートされる値は、このクラスに示す定数です。</param>
        <param name="x">公開ポイント フィールド X の値。</param>
        <param name="y">公開ポイント フィールド Y の値。</param>
        <param name="d">D. 秘密キーの値Null の場合は、公開キーの操作のみが許可されます。</param>
        <summary>
            コンストラクター
            </summary>
        <remarks>To be added.</remarks>
