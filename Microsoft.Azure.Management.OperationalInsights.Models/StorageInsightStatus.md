<Type Name="StorageInsightStatus" FullName="Microsoft.Azure.Management.OperationalInsights.Models.StorageInsightStatus">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            StorageInsightStatus クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="state">ワークスペースに、ストレージ インサイトの接続の状態。 使用可能な値が含まれます: 'OK'、'ERROR'</param>
        <param name="description">記憶域 insight の状態の説明です。</param>
        <summary>
            StorageInsightStatus クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            取得またはワークスペースに、ストレージ インサイトの接続の状態を設定します。 使用可能な値が含まれます: 'OK'、'ERROR'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
