<Type Name="SearchMetadataSchema" FullName="Microsoft.Azure.Management.OperationalInsights.Models.SearchMetadataSchema">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SearchMetadataSchema クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">メタデータのスキーマの名前。</param>
        <param name="version">メタデータのスキーマのバージョン。</param>
        <summary>
            SearchMetadataSchema クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
