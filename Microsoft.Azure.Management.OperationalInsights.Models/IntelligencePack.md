<Type Name="IntelligencePack" FullName="Microsoft.Azure.Management.OperationalInsights.Models.IntelligencePack">
  ...
  <Docs>
    <summary>
            インテリジェンス パックを文字列名とそれが有効かどうかを示すブール値を格納します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            IntelligencePack クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">インテリジェンス パックの名前。</param>
        <param name="enabled">インテリジェンス パックの有効なブール値。</param>
        <summary>
            IntelligencePack クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            取得またはインテリジェンス パックの有効なブール値を設定します。
            </summary>
