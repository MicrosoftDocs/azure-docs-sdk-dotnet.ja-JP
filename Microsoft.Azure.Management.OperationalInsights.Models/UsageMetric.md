  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="unit">メトリックに使用する単位です。</param>
        <param name="currentValue">メトリックの現在の値。</param>
        <param name="limit">メトリックのクォータ制限します。</param>
        <param name="nextResetTime">メトリックの値をリセットする時刻。</param>
        <param name="quotaPeriod">値の間の時間の長さを決定するクォータ期間がリセットされます。</param>
        <summary>
            UsageMetric クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="QuotaPeriod">
      ...
      <Docs>
        <summary>
            取得または値のリセット間隔の長さを決定するクォータを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
