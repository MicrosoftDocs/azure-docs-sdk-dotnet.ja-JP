<Type Name="SavedSearch" FullName="Microsoft.Azure.Management.OperationalInsights.Models.SavedSearch">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Savedsearch でクラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="category">保存された検索のカテゴリ。 これにより、保存済み検索を高速検索をユーザーにします。 </param>
        <param name="displayName">表示名の検索を保存します。</param>
        <param name="query">保存された検索のクエリ式。
            参照用 https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-search-reference を参照してください。</param>
        <param name="version">クエリ言語のバージョン番号。 ここでは、バージョン 1 のみを使用します。</param>
        <param name="id">保存された検索の id。</param>
        <param name="etag">保存された検索の etag。</param>
        <param name="tags">保存された検索に関連付けられたタグ。</param>
        <summary>
            Savedsearch でクラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Category">
      ...
      <Docs>
        <summary>
            取得または保存された検索のカテゴリを設定します。 これにより、保存済み検索を高速検索をユーザーにします。
            </summary>
    ...
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            取得または保存された検索のクエリ式を設定します。 参照用 https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-search-reference を参照してください。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            取得またはクエリ言語のバージョン番号を設定します。 ここでは、バージョン 1 のみを使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
