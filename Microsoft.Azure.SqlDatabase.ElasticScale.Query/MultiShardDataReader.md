<Type Name="MultiShardDataReader" FullName="Microsoft.Azure.SqlDatabase.ElasticScale.Query.MultiShardDataReader">
  ...
  <Docs>
    <summary>
            順方向専用のストリームを読み取る行は、シャード セットから取得する方法を提供します。 
            </summary>
  ...
  <Members>
    <Member MemberName="Close">
      ...
      <Docs>
        <summary>
            MultiShardDataReader オブジェクトを閉じます。
            </summary>
        <remarks>
            同様に DbDataReader、閉じるがべき等です。
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Connection">
      ...
      <Docs>
        <summary>
            取得、 <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.Query.MultiShardConnection" /> MultiShardDataReader に関連付けられています。
            </summary>
    ...
    <Member MemberName="CreateObjRef">
      ...
      <Docs>
        <param name="requestedType"><see cref="T:System.Type" />オブジェクトを新しい<see cref="T:System.Runtime.Remoting.ObjRef" />参照することができます。</param>
        <summary>
            このメソッドは現在サポートされていません。 メソッドを呼び出すと、例外が発生します。
            </summary>
    ...
    <Member MemberName="Dispose">
      ...
      <Docs>
        <param name="disposing">
            マネージ コードとアンマネージ リソースを解放する場合は trueアンマネージ リソースだけを解放する場合は false。
            </param>
        <summary>
            DbDataReader によって使用されているマネージ リソースを解放し、必要に応じてアンマネージ リソースを解放します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Equals">
      ...
      <Docs>
        ...
        <summary>
            指定したオブジェクトが、現在のオブジェクトと等しいかどうかを判断します。 (<see cref="T:System.Object" /> から継承。)
            </summary>
    ...
    <Member MemberName="GetBytes">
      ...
      <Docs>
        ...
        <summary>
            指定された列からバイトのストリームを読み取りますは、bufferOffset によって示される位置から始まる、バッファーに dataOffset、によって示される位置から始まります。
            </summary>
    ...
    <Member MemberName="GetChar">
      ...
      <Docs>
        ...
        <returns>指定された列の値。</returns>
        <remarks>MSDN、あたりこれは、SqlDataReader のサポートされていません。</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetChars">
      ...
      <Docs>
        ...
        <param name="length">読み取り対象の最大文字数。</param>
        <summary>
            指定された列から文字のストリームを読み取りますは、bufferOffset によって示される位置から始まる、バッファーに dataOffset、によって示される位置から始まります。
            </summary>
    ...
    <Member MemberName="GetDateTime">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            DateTime オブジェクトとして指定された列の値を取得します。
            </summary>
        <returns>指定された列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetDateTimeOffset">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            DateTimeOffset オブジェクトとして指定された列の値を取得します。
            </summary>
        <returns>指定された列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetDbDataReader">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            要求された列序数に基づくプロバイダー固有の実装をオーバーライドできる DbDataReader オブジェクトを返します。
            </summary>
        <returns>DbDataReader オブジェクトです。</returns>
        <remarks />
      </Docs>
    </Member>
    ...
    <Member MemberName="GetDouble">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            Double 型のオブジェクトとして指定された列の値を取得します。
            </summary>
        <returns>指定された列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetFieldValue&lt;T&gt;">
      ...
      <Docs>
        <typeparam name="T">された列の値を取得する型。</typeparam>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            同期的に、型として指定された列の値を取得します。
            </summary>
        <returns>指定された列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetFieldValueAsync&lt;T&gt;">
      ...
      <Docs>
        ...
        <param name="cancellationToken">
            取り消し命令、操作を取り消す必要がある通知を伝達します。 これは、操作では、取り消しは保証されません。 CancellationToken.None の設定でこのメソッドは GetFieldValueAsync に相当します。 取り消された、返されたタスクをマークする必要があります。
            </param>
        <summary>
            非同期的に、型として指定された列の値を取得します。
            </summary>
        <returns>指定された列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetHashCode">
      ...
      <Docs>
        <summary>
            役に立ちますの等価性にクイック チェックの既定のハッシュ関数として機能します。
            </summary>
    ...
    <Member MemberName="GetProviderSpecificFieldType">
      ...
      <Docs>
        ...
        <returns>指定された列のデータ型を記述する型オブジェクト。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetProviderSpecificValue">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            オブジェクトのインスタンスとして指定された列の値を取得します。
            </summary>
        <returns>指定された列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetProviderSpecificValues">
      ...
      <Docs>
        <param name="values">属性列のコピー先のオブジェクトの配列。</param>
        <summary>
            現在の行のコレクション内にあるプロバイダー固有の属性列をすべて取得します。
            </summary>
        <returns>配列内のオブジェクトのインスタンスの数。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSchemaTable">
      ...
      <Docs>
        <summary>
            返します、 <see cref="T:System.Data.DataTable" /> MultiShardDataReader の列メタデータを記述します。
            </summary>
    ...
    <Member MemberName="GetSqlBinary">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlBinary、として指定された列の値を取得します。
            </summary>
        <returns>SqlBinary で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlBoolean">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlBoolean として指定された列の値を取得します。
            </summary>
        <returns>SqlBoolean で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlByte">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlByte として指定された列の値を取得します。
            </summary>
        <returns>SqlByte で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlBytes">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlBytes として指定された列の値を取得します。
            </summary>
        <returns>SqlBytes で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlChars">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlChars として指定された列の値を取得します。
            </summary>
        <returns>SqlChars で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlDateTime">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlDateTime として指定された列の値を取得します。
            </summary>
        <returns>SqlDateTime で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlDecimal">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlDecimal、として指定された列の値を取得します。
            </summary>
        <returns>SqlDecimal で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlDouble">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlDouble として指定された列の値を取得します。
            </summary>
        <returns>SqlDouble で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlGuid">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlGuid として指定された列の値を取得します。
            </summary>
        <returns>SqlGuid で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlInt16">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlInt16 として指定された列の値を取得します。
            </summary>
        <returns>SqlInt16 で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlInt32">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlInt32 として指定された列の値を取得します。
            </summary>
        <returns>SqlInt32 で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlInt64">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlInt64 として指定された列の値を取得します。
            </summary>
        <returns>SqlInt64 で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlMoney">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlMoney として指定された列の値を取得します。
            </summary>
        <returns>SqlMoney で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlSingle">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlSingle として指定された列の値を取得します。
            </summary>
        <returns>SqlSingle で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlString">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SqlString として指定された列の値を取得します。
            </summary>
        <returns>SqlString で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlValue">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            SQL Server のネイティブ型として指定された列にデータ値を返します。 
            </summary>
        <returns>SqlDbType で表される列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSqlValues">
      ...
      <Docs>
        <param name="values">
            値をコピー先のオブジェクトの配列。 列の値は、SQL Server 型として表されます。
            </param>
        <summary>
            レコード内のすべての列の値を格納しているオブジェクトの配列がいっぱいになったは、SQL Server のネイティブ型として表されます。
            </summary>
    ...
    <Member MemberName="GetSqlXml">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            XML 値として指定された列の値を取得します。
            </summary>
        <returns>対応するフィールド内に格納された XML を含む SqlXml 値です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="GetTimeSpan">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            TimeSpan オブジェクトとして指定された列の値を取得します。
            </summary>
        <returns>指定された列の値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetXmlReader">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            XmlReader として XML データ型を取得します。
            </summary>
        <returns>XmlReader としてデータ。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="HasRows">
      ...
      <Docs>
        <summary>
            この MultiShardDataReader が 1 つまたは複数の行を含めるかどうかを示す値を取得します。 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsClosed">
      ...
      <Docs>
        <summary>
            指定した MultiShardDataReader が閉じているかどうかを示す値を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsDBNull">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            列に存在しない値や欠落値 (NULL 値) が含まれるかどうかを示す値を取得します。
            </summary>
        <returns>指定された列が DBNull; に等しい場合は true。それ以外の場合は false。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsDBNullAsync">
      ...
      <Docs>
        <param name="ordinal">取得する 0 から始まる列です。</param>
        <param name="cancellationToken">
            取り消し命令、操作を取り消す必要がある通知を伝達します。 これは、操作では、取り消しは保証されません。 CancellationToken.None の設定でこのメソッドは IsDBNullAsync に相当します。 取り消された、返されたタスクをマークする必要があります。
            </param>
        <summary>
            非同期バージョンのデータ型は、列に存在しない値や欠落値 (NULL 値) が含まれるかどうかを示す値を取得します。
            </summary>
        <returns>指定された列の値が DBNull の場合は false と等価である場合は true。</returns>
        <remarks />
      </Docs>
    </Member>
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="ordinal">0 から始まる列序数。</param>
        <summary>
            オブジェクトのインスタンスとしてネイティブ形式で指定された列の値を取得します。
            </summary>
        <value>指定された列の値。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Item">
    ...
    <Member MemberName="MultiShardExceptions">
      ...
      <Docs>
        <summary>
            シャード間で、コマンドを処理するときに発生した例外のコレクションを取得します。
            コレクションが作成されるときに<see cref="F:Microsoft.Azure.SqlDatabase.ElasticScale.Query.MultiShardExecutionPolicy.PartialResults" />がコマンドの実行ポリシーとして選択します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Read">
      ...
      <Docs>
        ...
        <returns>複数の行がある場合は true。それ以外の場合は false。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReadAsync">
      ...
      <Docs>
        ...
        <summary>
             非同期バージョンの読み取りで、次のレコードに、MultiShardDataReader を進めます。
    ...
    <Member MemberName="VisibleFieldCount">
      ...
      <Docs>
        <summary>
            非表示になっていない MultiShardDataReader 内のフィールドの数を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
