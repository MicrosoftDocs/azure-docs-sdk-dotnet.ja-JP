<Type Name="MultiShardAggregateException" FullName="Microsoft.Azure.SqlDatabase.ElasticScale.Query.MultiShardAggregateException">
  ...
  <Docs>
    <summary>
            1 つまたは複数を表す<see cref="T:System.Exception" />シャード セット間でクエリを実行するときに発生したエラー。 InnerExceptions フィールドがこれらの例外を収集し、さらに検査または処理のため InnerExceptions を反復処理できる 1 つ。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.Query.MultiShardAggregateException" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="innerExceptions">一連の<see cref="T:System.Exception" />現在の例外の原因となった</param>
        <summary>
            <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.Query.MultiShardAggregateException" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="innerException"><see cref="T:System.Exception" />現在の例外の原因となった</param>
        <summary>
            <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.Query.MultiShardAggregateException" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            シリアル化されたデータを持つ MultiShardAggregateException クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException"><paramref name="innerExceptions" />が null です </exception>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
    ...
    <Member MemberName="InnerExceptions">
      ...
      <Docs>
        <summary>
            読み取り専用コレクションを取得、<see cref="T:System.Exception" />現在の例外の原因となったのインスタンス。
            </summary>
