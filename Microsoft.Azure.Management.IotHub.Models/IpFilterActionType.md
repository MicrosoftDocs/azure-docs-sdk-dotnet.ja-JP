<Type Name="IpFilterActionType" FullName="Microsoft.Azure.Management.IotHub.Models.IpFilterActionType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="639e8-101">IpFilterActionType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="639e8-101">Defines values for IpFilterActionType.</span></span>
            </summary>
