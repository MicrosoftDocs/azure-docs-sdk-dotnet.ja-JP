<Type Name="ImportDevicesRequest" FullName="Microsoft.Azure.Management.IotHub.Models.ImportDevicesRequest">
  ...
  <Docs>
    <summary>
            パラメーターを提供する、ハブのすべてのデバイスのインポートを要求するときに使用します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ImportDevicesRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="inputBlobContainerUri">入力 blob コンテナーへの URI。</param>
        <param name="outputBlobContainerUri">出力 blob コンテナーへの URI。</param>
        <summary>
            ImportDevicesRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="InputBlobContainerUri">
      ...
      <Docs>
        <summary>
            取得または入力 blob コンテナーへの URI を設定します。
            </summary>
    ...
    <Member MemberName="OutputBlobContainerUri">
      ...
      <Docs>
        <summary>
            取得または出力 blob コンテナーへの URI を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
