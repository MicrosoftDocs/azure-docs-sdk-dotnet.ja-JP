<Type Name="SharedAccessSignatureAuthorizationRule" FullName="Microsoft.Azure.Management.IotHub.Models.SharedAccessSignatureAuthorizationRule">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SharedAccessSignatureAuthorizationRule クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="keyName">共有アクセス ポリシーの名前。</param>
        <param name="rights">共有アクセス ポリシーに割り当てられた権限。 使用可能な値が含まれます: 'RegistryRead'、'RegistryWrite'、'接続'、'DeviceConnect'、'RegistryRead、RegistryWrite'、'RegistryRead、接続、'RegistryRead, DeviceConnect'、'RegistryWrite、接続、' RegistryWrite、DeviceConnect'、'接続、DeviceConnect'、'RegistryRead、RegistryWrite、接続'、'RegistryRead、RegistryWrite、DeviceConnect'、'RegistryRead、接続、DeviceConnect'、'RegistryWrite、接続、DeviceConnect' 'RegistryRead、RegistryWrite、接続、DeviceConnect'</param>
        <param name="primaryKey">主キー。</param>
        <param name="secondaryKey">セカンダリ キー。</param>
        <summary>
            SharedAccessSignatureAuthorizationRule クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Rights">
      ...
      <Docs>
        <summary>
            取得または共有アクセス ポリシーへのアクセス許可を設定します。
            使用可能な値が含まれます: 'RegistryRead'、'RegistryWrite'、'接続'、'DeviceConnect'、'RegistryRead、RegistryWrite'、'RegistryRead、接続、'RegistryRead, DeviceConnect'、'RegistryWrite、接続、' RegistryWrite、DeviceConnect'、'接続、DeviceConnect'、'RegistryRead、RegistryWrite、接続'、'RegistryRead、RegistryWrite、DeviceConnect'、'RegistryRead、接続、DeviceConnect'、'RegistryWrite、接続、DeviceConnect' 'RegistryRead、RegistryWrite、接続、DeviceConnect'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
