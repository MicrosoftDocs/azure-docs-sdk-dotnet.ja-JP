<Type Name="ExportDevicesRequest" FullName="Microsoft.Azure.Management.IotHub.Models.ExportDevicesRequest">
  ...
  <Docs>
    <summary>
            パラメーターを提供するすべてのデバイスが IoT hub でのエクスポートを要求するときに使用します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="exportBlobContainerUri">エクスポート blob コンテナーへの URI。</param>
        <param name="excludeKeys">キーをエクスポート中に除外するかどうかを示す値。</param>
        <summary>
            ExportDevicesRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ExcludeKeys">
      ...
      <Docs>
        <summary>
            取得またはキーをエクスポート中に除外するかどうかを示す値を設定します。
            </summary>
    ...
    <Member MemberName="ExportBlobContainerUri">
      ...
      <Docs>
        <summary>
            取得またはエクスポート blob コンテナーへの URI を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
