<Type Name="IotHubNameAvailabilityInfo" FullName="Microsoft.Azure.Management.IotHub.Models.IotHubNameAvailabilityInfo">
  ...
  <Docs>
    <summary>
            指定された IoT ハブ名が使用できるかどうかを示すプロパティです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            IotHubNameAvailabilityInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="nameAvailable">指定された名前が使用できるかどうかを示す値です。</param>
        <param name="reason">使用できなくなるのためです。 使用可能な値が含まれます: '無効'、'に対する'</param>
        <param name="message">理由の詳細なメッセージです。</param>
        <summary>
            IotHubNameAvailabilityInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Reason">
      ...
      <Docs>
        <summary>
            利用できない理由を取得します。 使用可能な値が含まれます: '無効'、'に対する'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
