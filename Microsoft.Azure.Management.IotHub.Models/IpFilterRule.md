<Type Name="IpFilterRule" FullName="Microsoft.Azure.Management.IotHub.Models.IpFilterRule">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            IpFilterRule クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="filterName">IP フィルタの規則の名前。</param>
        <param name="action">このルールによってキャプチャされた要求に対する目的の操作です。 使用可能な値が含まれます: 'Accept'、'拒否'</param>
        <param name="ipMask">ルールの CIDR 表記法で IP アドレスの範囲を表す文字列。</param>
        <summary>
            IpFilterRule クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Action">
      ...
      <Docs>
        <summary>
            取得または、このルールによってキャプチャされた要求に対する目的の操作を設定します。
            使用可能な値が含まれます: 'Accept'、'拒否'
            </summary>
    ...
    <Member MemberName="IpMask">
      ...
      <Docs>
        <summary>
            取得またはルールの CIDR 表記法で IP アドレスの範囲を表す文字列を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
