<Type Name="SequencePropertyInitializer" FullName="Microsoft.ApplicationInsights.Extensibility.SequencePropertyInitializer">
  ...
  <Docs>
    <summary>
            <see cref="T:Microsoft.ApplicationInsights.Extensibility.ITelemetryInitializer" />を設定する<see cref="P:Microsoft.ApplicationInsights.Channel.ITelemetry.Sequence" />プロパティは、Microsoft 内部利用統計情報の Vortex エンドポイントに送信します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Initialize">
      ...
      <Docs>
        ...
        <summary>
            設定<see cref="P:Microsoft.ApplicationInsights.Channel.ITelemetry.Sequence" />一意の ID とシーケンス番号を使用します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
