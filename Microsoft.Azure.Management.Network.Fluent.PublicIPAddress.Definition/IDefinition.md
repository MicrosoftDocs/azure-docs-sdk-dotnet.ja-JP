<Type Name="IDefinition" FullName="Microsoft.Azure.Management.Network.Fluent.PublicIPAddress.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="caa27-101">すべての定義のコンテナー インターフェイスです。</span><span class="sxs-lookup"><span data-stu-id="caa27-101">Container interface for all the definitions.</span></span>
            </summary>
