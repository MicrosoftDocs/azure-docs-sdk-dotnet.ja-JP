  ...
  <Members>
    <Member MemberName="BeginCreate">
      ...
      <Docs>
        ...
        <param name="resourceGroupName">
            Data Lake Analytics account.the アカウントが含まれている Azure リソース グループの名前に関連付けられます。
            </param>
        <param name="accountName">
            作成する Data Lake Analytics アカウントの名前。
            </param>
        <param name="parameters">
            パラメーターは、作成する Data Lake Analytics アカウントの操作を指定します。
            </param>
        <summary>
            指定された Data Lake Analytics アカウントを作成します。 Data Lake Analytics ワークロード向けの計算サービスによりユーザーを提供します。
            </summary>
    ...
    <Member MemberName="BeginDelete">
      ...
      <Docs>
        ...
        <param name="accountName">
            削除する Data Lake Analytics アカウントの名前
            </param>
        <summary>
            アカウント名で指定された Data Lake Analytics アカウント オブジェクトの削除プロセスを開始します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BeginUpdate">
      ...
      <Docs>
        ...
        <param name="accountName">
            更新する Data Lake Analytics アカウントの名前。
            </param>
        <param name="parameters">
            パラメーターは、更新プログラムに Data Lake Analytics アカウントの操作を指定します。
            </param>
        <summary>
            Data Lake Analytics アカウントのアカウント オブジェクトの内容でアカウント名で指定されたオブジェクトを更新します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DataLakeStoreAccountExists">
      ...
      <Docs>
        ...
        <param name="accountName">
            Data Lake Store アカウントの存在をテストするための Data Lake Analytics アカウントの名前。
            </param>
        <param name="dataLakeStoreAccountName">
            存在をテストする Data Lake Store アカウントの名前
            </param>
        <summary>
            指定された Data Lake Store アカウントが指定された Data Lake Analytics アカウントにリンクされているかどうかをテストします。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Exists">
      ...
      <Docs>
        ...
        <param name="accountName">
            存在をテストする Data Lake Analytics アカウントの名前。
            </param>
        <summary>
            指定された Data Lake Analytics アカウントの存在をテストします。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <param name="accountName">
            取得する Data Lake Analytics アカウントの名前。
            </param>
        <summary>
            指定された Data Lake Analytics アカウントの詳細を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="List">
      ...
      <Docs>
        ...
        <summary>
            現在のサブスクリプション内に存在する場合は、Data Lake Analytics アカウントの最初のページを取得します。 存在する場合、次のページへのリンクが含まれます。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListByResourceGroup">
      ...
      <Docs>
        ...
        <summary>
            特定のリソース グループ内に存在する場合は、Data Lake Analytics アカウントの最初のページを取得します。 存在する場合、次のページへのリンクが含まれます。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageAccountExists">
      ...
      <Docs>
        ...
        <param name="accountName">
            Azure ストレージ アカウントの存在をテストするための Data Lake Analytics アカウントの名前。
            </param>
        <param name="storageAccountName">
            存在をテストする対象の Azure ストレージ アカウントの名前。
            </param>
        <summary>
            指定された Azure ストレージ アカウントが、指定された Data Lake Analytics アカウントにリンクされているかどうかをテストします。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageContainerExists">
      ...
      <Docs>
        ...
        <param name="storageAccountName">
            Azure のストレージ アカウントから blob コンテナーの存在をテストするための名前。
            </param>
        <param name="containerName">
            存在をテストする Azure ストレージ コンテナーの名前。
            </param>
        <summary>
            特定の Data Lake Analytics と Azure ストレージ アカウントに関連付けられている、指定された Azure ストレージ コンテナーの存在をテストします。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
