<Type Name="LegacyApplianceConfiguration" FullName="Microsoft.WindowsAzure.Management.StorSimple.LegacyApplianceConfiguration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6365b-101">によって返されるレガシ アプライアンス構成レガシの構成コマンドレットをインポートします。</span><span class="sxs-lookup"><span data-stu-id="6365b-101">Legacy appliance configuration to be returned by import legacy config cmdlet</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ConfigFile">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6365b-102">取得または設定をインポートする構成ファイルの名前</span><span class="sxs-lookup"><span data-stu-id="6365b-102">Get or sets the name of the config file which is imported</span></span>
            </summary>
    ...
    <Member MemberName="Details">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6365b-103">取得または移行する必要がある従来のアプライアンスから構成メタデータを設定</span><span class="sxs-lookup"><span data-stu-id="6365b-103">Gets or sets the config metadata from legacy appliance which needs to be migrated</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ImportedOn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6365b-104">取得または設定のインポートをローカル時刻の設定</span><span class="sxs-lookup"><span data-stu-id="6365b-104">Gets or sets the local time at which config is imported</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LegacyConfigId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6365b-105">取得またはインポートされているどの構成では、一意の識別子を設定</span><span class="sxs-lookup"><span data-stu-id="6365b-105">Gets or sets the unique identifier for the config which being imported</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Result">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6365b-106">取得または設定のインポート構成 o/p 結果</span><span class="sxs-lookup"><span data-stu-id="6365b-106">Gets or sets the o/p result of import config</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetApplianceName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6365b-107">取得またはアプライアンスのターゲットの名前を設定</span><span class="sxs-lookup"><span data-stu-id="6365b-107">Gets or sets the name of target appliance</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
