<Type Name="ActivityLogAlertAllOfCondition" FullName="Microsoft.Azure.Management.Monitor.Management.Models.ActivityLogAlertAllOfCondition">
  ...
  <Docs>
    <summary>
            満たすには、すべてのメンバー条件が満たされたときに、アクティビティ ログ アラート条件。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ActivityLogAlertAllOfCondition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="allOf">アクティビティ ログの警告条件の一覧。</param>
        <summary>
            ActivityLogAlertAllOfCondition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AllOf">
      ...
      <Docs>
        <summary>
            取得またはログ アラート状態のアクティビティの一覧を設定します。
            </summary>
