<Type Name="LogSettings" FullName="Microsoft.Azure.Management.Monitor.Management.Models.LogSettings">
  ...
  <Docs>
    <summary>
            MultiTenantDiagnosticSettings の一部です。 特定のログの設定を指定します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            LogSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="enabled">このログが有効になっているかどうかを示す値です。</param>
        <param name="category">診断ログのカテゴリの名前、リソースの種類はこの設定に適用されます。 リソースの診断ログ カテゴリの一覧を取得するには、まず診断設定の取得操作を実行します。</param>
        <param name="retentionPolicy">このログの保持ポリシーです。</param>
        <summary>
            LogSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Category">
      ...
      <Docs>
        <summary>
            取得またはにこの設定が適用されるリソースの種類の診断ログのカテゴリの名前を設定します。 リソースの診断ログ カテゴリの一覧を取得するには、まず診断設定の取得操作を実行します。
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            取得または、このログが有効になっているかどうかを示す値を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
