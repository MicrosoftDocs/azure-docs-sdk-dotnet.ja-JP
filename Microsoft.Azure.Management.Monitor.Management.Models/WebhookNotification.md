<Type Name="WebhookNotification" FullName="Microsoft.Azure.Management.Monitor.Management.Models.WebhookNotification">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serviceUri">通知を受信するサービスのアドレス。</param>
        <param name="properties">設定のプロパティ バッグ。 この値を空にすることができます。</param>
        <summary>
            WebhookNotification クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            取得または設定のプロパティ バッグを設定します。 この値を空にすることができます。
            </summary>
