<Type Name="MetricSettings" FullName="Microsoft.Azure.Management.Monitor.Management.Models.MetricSettings">
  ...
  <Docs>
    <summary>
            MultiTenantDiagnosticSettings の一部です。 特定のメトリックの設定を指定します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MetricSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="enabled">このカテゴリが有効になっているかどうかを示す値です。</param>
        <param name="timeGrain">ISO8601 の形式で、メトリックの timegrain します。</param>
        <param name="category">診断のメトリックのカテゴリの名前、リソースの種類はこの設定に適用されます。 リソースの診断メトリックのカテゴリの一覧を取得するには、まず診断設定の取得操作を実行します。</param>
        <param name="retentionPolicy">このカテゴリの保有期間ポリシー。</param>
        <summary>
            MetricSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Category">
      ...
      <Docs>
        <summary>
            取得またはにこの設定が適用されるリソースの種類の診断のメトリックのカテゴリの名前を設定します。 リソースの診断メトリックのカテゴリの一覧を取得するには、まず診断設定の取得操作を実行します。
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            取得または、このカテゴリが有効になっているかどうかを示す値を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeGrain">
      ...
      <Docs>
        <summary>
            取得または ISO8601 の形式で、メトリックの timegrain を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
