<Type Name="ActivityLogAlertLeafCondition" FullName="Microsoft.Azure.Management.Monitor.Management.Models.ActivityLogAlertLeafCondition">
  ...
  <Docs>
    <summary>
            アクティビティ ログ フィールドと値を比較することによって満たされたアクティビティ ログ アラート条件。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ActivityLogAlertLeafCondition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="field">この状態は検査して、フィールドの名前。 このフィールドの値には (大文字と小文字): 'resourceId'、'カテゴリ'、'呼び出し元'、'level'、'operationName'、'resourceGroup'、'resourceProvider'、'status'、'副状態'、'resourceType' または 'のプロパティです。' で始まるものです。</param>
        <param name="equals">フィールドの値は、条件が満たされるかどうかを決定する (大文字と小文字) この値と比較されます。</param>
        <summary>
            ActivityLogAlertLeafCondition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Equals">
      ...
      <Docs>
        <summary>
            取得またはフィールドの値と比較されます、条件が満たされるかどうかを決定する (大文字と小文字) この値を設定します。
            </summary>
    ...
    <Member MemberName="Field">
      ...
      <Docs>
        <summary>
            取得または設定は、この条件の検証されるフィールドの名前。 このフィールドの値には (大文字と小文字): 'resourceId'、'カテゴリ'、'呼び出し元'、'level'、'operationName'、'resourceGroup'、'resourceProvider'、'status'、'副状態'、'resourceType' または 'のプロパティです。' で始まるものです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
