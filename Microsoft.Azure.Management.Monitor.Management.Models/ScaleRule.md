<Type Name="ScaleRule" FullName="Microsoft.Azure.Management.Monitor.Management.Models.ScaleRule">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6cfc0-101">スケーリング処理のトリガーとパラメーターを指定するルール。</span><span class="sxs-lookup"><span data-stu-id="6cfc0-101">A rule that provide the triggers and parameters for the scaling action.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cfc0-102">ScaleRule クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="6cfc0-102">Initializes a new instance of the ScaleRule class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="metricTrigger"><span data-ttu-id="6cfc0-103">スケーリング処理で生成されるトリガー。</span><span class="sxs-lookup"><span data-stu-id="6cfc0-103">the trigger that results in a scaling action.</span></span></param>
        <param name="scaleAction"><span data-ttu-id="6cfc0-104">スケーリング処理のパラメーターです。</span><span class="sxs-lookup"><span data-stu-id="6cfc0-104">the parameters for the scaling action.</span></span></param>
        <summary>
            <span data-ttu-id="6cfc0-105">ScaleRule クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="6cfc0-105">Initializes a new instance of the ScaleRule class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="MetricTrigger">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cfc0-106">取得または設定をスケーリング処理で発生させるトリガー。</span><span class="sxs-lookup"><span data-stu-id="6cfc0-106">Gets or sets the trigger that results in a scaling action.</span></span>
            </summary>
    ...
    <Member MemberName="ScaleAction">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cfc0-107">取得またはスケーリング処理のパラメーターを設定します。</span><span class="sxs-lookup"><span data-stu-id="6cfc0-107">Gets or sets the parameters for the scaling action.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cfc0-108">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="6cfc0-108">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="6cfc0-109">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="6cfc0-109">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
