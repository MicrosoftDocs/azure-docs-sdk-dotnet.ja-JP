<Type Name="OperationDisplay" FullName="Microsoft.Azure.Management.Monitor.Management.Models.OperationDisplay">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provider">サービス プロバイダー: microsoft.insights に</param>
        <param name="resource">操作が実行されるリソース: AlertRules、Autoscale などです。</param>
    ...
    <Member MemberName="Provider">
      ...
      <Docs>
        <summary>
            取得またはサービス プロバイダーの設定: microsoft.insights に
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Resource">
      ...
      <Docs>
        <summary>
            取得または設定操作の実行対象となるリソース: AlertRules、Autoscale などです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
