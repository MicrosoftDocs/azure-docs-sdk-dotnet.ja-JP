<Type Name="TemplateNotification" FullName="Microsoft.Azure.NotificationHubs.TemplateNotification">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="templateProperties">テンプレートのプロパティです。</param>
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.TemplateNotification" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">プロパティ</exception>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
