<Type Name="WnsHeaderCollection" FullName="Microsoft.Azure.NotificationHubs.WnsHeaderCollection">
  ...
  <Docs>
    <summary>Windows プッシュ通知サービス (WNS) ヘッダーのコレクションを表します。</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.WnsHeaderCollection" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
