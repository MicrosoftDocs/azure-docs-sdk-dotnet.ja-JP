<Type Name="SharedAccessSignatureToken" FullName="Microsoft.Azure.NotificationHubs.SharedAccessSignatureToken">
  ...
  <Interfaces />
  <Docs>
    <summary>共有アクセス署名トークンを表します。</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.NotificationHubs.SharedAccessSignatureToken" />トークン文字列を指定しています。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.NotificationHubs.SharedAccessSignatureToken" />指定したトークン文字列と有効期限を持つクラス。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">トークンの識別子です。</param>
        <param name="tokenString">トークン文字列。</param>
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.NotificationHubs.SharedAccessSignatureToken" />クラスを指定した識別子とトークン文字列を使用します。 </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tokenString">トークン文字列。</param>
        <param name="expiry">トークンの有効期限。</param>
        <param name="audience">トークンの対象ユーザーです。</param>
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.NotificationHubs.SharedAccessSignatureToken" />したトークン文字列の指定された、有効期限および対象ユーザー。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ExpiresOnFieldName">
      ...
      <Docs>
        <summary>フィールド名の有効期限の値を取得します。</summary>
        <value>この値はフィールド名の有効期限です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="KeyValueSeparator">
      ...
      <Docs>
        <summary>キー値の区切り記号を取得します。</summary>
        <value>キーの値の区切り記号。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="SasKeyValueSeparator">
      ...
      <Docs>
        <summary>共有アクセス署名トークンのキー値の区切り記号を指定します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SasPairSeparator">
      ...
      <Docs>
        <summary>共有アクセス署名トークンのペアの区切り記号を指定します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SharedAccessSignature">
      ...
      <Docs>
        <summary>共有アクセス署名を指定します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="SignedExpiry">
      ...
      <Docs>
        <summary>トークンの署名の有効期限を指定します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SignedKeyName">
      ...
      <Docs>
        <summary>符号付きのキーの名前を指定します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SignedResource">
      ...
      <Docs>
        <summary>署名対象のリソースを指定します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SignedResourceFullFieldName">
      ...
      <Docs>
        <summary>署名対象のリソースのフル フィールド名を指定します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
