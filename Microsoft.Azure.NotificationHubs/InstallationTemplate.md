<Type Name="InstallationTemplate" FullName="Microsoft.Azure.NotificationHubs.InstallationTemplate">
  ...
  <Docs>
    <summary>
            インスタンスに属する可能性がありますを表すテンプレート<see cref="T:Microsoft.Azure.NotificationHubs.Installation" />クラス
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Body">
      ...
      <Docs>
        <summary>
            取得または送信操作中に実際のデータを使用して入力をプレース ホルダーを含むことが通知のペイロードのテンプレート本体の設定
            </summary>
    ...
    <Member MemberName="Expiry">
      ...
      <Docs>
        <summary>
            取得または設定の有効期限を APNS を対象とした通知の適用
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Headers">
      ...
      <Docs>
        <summary>
            MPNS を対象とした通知の該当するヘッダーのセットのコレクションを取得または
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            取得または特定のテンプレートのタグのコレクションを設定します。 Ususaly 1 つのタグ (テンプレート名) は、ここにする必要があります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
