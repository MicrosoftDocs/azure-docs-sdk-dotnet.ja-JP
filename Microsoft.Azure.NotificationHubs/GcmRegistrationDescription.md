  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.GcmRegistrationDescription" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
    ...
    <Member MemberName="GcmRegistrationId">
      ...
      <Docs>
        <summary>取得または設定の GCM 登録 id。</summary>
        <value>GCM 登録 id。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
