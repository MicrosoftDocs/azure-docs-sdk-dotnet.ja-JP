<Type Name="OAuthTokenProvider" FullName="Microsoft.Azure.NotificationHubs.OAuthTokenProvider">
  ...
  <Interfaces />
  <Docs>
    <summary>Service bus の認証トークンを提供します。</summary>
  ...
  <Members>
    <Member MemberName="BuildKey">
      ...
      <Docs>
        <param name="appliesTo">キーの適用されるプロバイダー。</param>
        <param name="action">アクション。</param>
        <summary>プロバイダーのキーを作成します。</summary>
        <returns>キーがあります。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NormalizeAppliesTo">
      ...
      <Docs>
        <param name="appliesTo">正規化を適用するトークン プロバイダー。</param>
    ...
    <Member MemberName="OnBeginGetToken">
      ...
      <Docs>
        ...
        <summary>プロバイダーが開始されると、トークンを取得します。</summary>
    ...
    <Member MemberName="OnBeginGetWebToken">
      ...
      <Docs>
        <param name="appliesTo">プロバイダー web トークンが適用されます。</param>
        <param name="action">アクション。</param>
        <param name="timeout">期間。</param>
        <param name="callback">コールバック。</param>
        <param name="state">操作の状態。</param>
        <summary>プロバイダーが開始されると、web トークンを取得します。</summary>
        <returns>操作の非同期の結果。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndGetToken">
      ...
      <Docs>
        ...
        <param name="cacheUntil">データを格納するプロバイダーの期間です。</param>
        <summary>プロバイダーの終了時に、トークンを取得します。</summary>
