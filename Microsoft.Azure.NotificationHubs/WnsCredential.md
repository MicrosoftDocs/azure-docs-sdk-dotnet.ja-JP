<Type Name="WnsCredential" FullName="Microsoft.Azure.NotificationHubs.WnsCredential">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.WnsCredential" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="packageSid">パッケージの id。</param>
    ...
    <Member MemberName="Equals">
      ...
      <Docs>
        ...
        <summary>かどうかこのインスタンスの os、指定したオブジェクトと同じかを指定します。</summary>
    ...
    <Member MemberName="PackageSid">
      ...
      <Docs>
        <summary>取得または、この資格情報のパッケージ ID を設定します。</summary>
        <value>この資格情報のパッケージ ID。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SecretKey">
      ...
      <Docs>
        <summary>取得または秘密キーを設定します。</summary>
        <value>共有キー。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WindowsLiveEndpoint">
      ...
      <Docs>
        <summary>取得または Windows Live エンドポイントを設定します。</summary>
        <value>Windows Live のエンドポイント。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
