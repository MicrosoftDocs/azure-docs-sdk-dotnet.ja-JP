<Type Name="AdmRegistrationDescription" FullName="Microsoft.Azure.NotificationHubs.AdmRegistrationDescription">
  ...
  <Docs>
    <summary>Amazon デバイス メッセージング (ADM) 登録の説明を表します。</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.AdmRegistrationDescription" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
    ...
    <Member MemberName="AdmRegistrationId">
      ...
      <Docs>
        <summary>取得または Amazon Device Messaging の登録識別子を設定します。</summary>
        <value>Amazon Device Messaging の登録識別子です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
