<Type Name="MpnsTemplateRegistrationDescription" FullName="Microsoft.Azure.NotificationHubs.MpnsTemplateRegistrationDescription">
  ...
  <Docs>
    <summary>テンプレートの MPNS 登録の手順を説明します。</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.MpnsTemplateRegistrationDescription" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="channelUri">チャネル URI です。</param>
        <param name="templatePayload">XML テンプレートです。</param>
        <param name="mpnsHeaders">MPNS ヘッダーの一覧。</param>
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.MpnsTemplateRegistrationDescription" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="channelUri">チャネル URI です。</param>
        <param name="templatePayload">XML テンプレートです。</param>
        <param name="tags">タグを説明します。</param>
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.MpnsTemplateRegistrationDescription" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="channelUri">チャネル URI です。</param>
        <param name="templatePayload">XML テンプレートです。</param>
        <param name="mpnsHeaders">WNS ヘッダーの一覧。</param>
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.MpnsTemplateRegistrationDescription" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="MpnsHeaders">
      ...
      <Docs>
        <summary>取得または MPNS ヘッダーのコレクションを設定します。</summary>
        <value>MPNS ヘッダーのコレクション。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TemplateName">
      ...
      <Docs>
        <summary>取得または MPNS テンプレートの名前を設定します。</summary>
