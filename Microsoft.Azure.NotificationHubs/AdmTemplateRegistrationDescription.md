<Type Name="AdmTemplateRegistrationDescription" FullName="Microsoft.Azure.NotificationHubs.AdmTemplateRegistrationDescription">
  ...
  <Docs>
    <summary>Amazon デバイス メッセージング (ADM) のテンプレート登録の説明を表します。</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.NotificationHubs.AdmTemplateRegistrationDescription" />登録で指定されたソース クラスです。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="admRegistrationId">Amazon Device Messaging の登録識別子です。</param>
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.NotificationHubs.AdmTemplateRegistrationDescription" />指定 Amazon Device Messaging の登録の識別子を持つクラス。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.AdmTemplateRegistrationDescription" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
    ...
    <Member MemberName="BodyTemplate">
      ...
      <Docs>
        <summary>取得または CDataMember 通知の本文を設定します。</summary>
        <value>CDataMember 通知の本文。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TemplateName">
      ...
      <Docs>
        <summary>取得または Amazon Device Messaging のテンプレートの名前を設定します。</summary>
        <value>Amazon Device Messaging のテンプレートの名前。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
