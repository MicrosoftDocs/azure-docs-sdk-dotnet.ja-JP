<Type Name="CollectionQueryResult&lt;T&gt;" FullName="Microsoft.Azure.NotificationHubs.CollectionQueryResult&lt;T&gt;">
  ...
  <Docs>
    <typeparam name="T"><span data-ttu-id="d8829-101">結果の型。</span><span class="sxs-lookup"><span data-stu-id="d8829-101">The type of the result.</span></span></typeparam>
    <summary><span data-ttu-id="d8829-102">コレクションのクエリ結果を表します。</span><span class="sxs-lookup"><span data-stu-id="d8829-102">Represents a collection query result.</span></span></summary>
  ...
  <Members>
    <Member MemberName="ContinuationToken">
      ...
      <Docs>
        <summary><span data-ttu-id="d8829-103">取得または使用して次の結果セットを取得する継続トークンを設定します。</span><span class="sxs-lookup"><span data-stu-id="d8829-103">Gets or sets the continuation token to use to retrieve the next set of results.</span></span></summary>
        <value><span data-ttu-id="d8829-104">継続トークンです。</span><span class="sxs-lookup"><span data-stu-id="d8829-104">The continuation token.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="d8829-105">コレクションを反復処理する列挙子を返します。</span><span class="sxs-lookup"><span data-stu-id="d8829-105">Returns an enumerator that iterates through the collection.</span></span></summary>
        <returns><span data-ttu-id="d8829-106">コレクションを反復処理する列挙子。</span><span class="sxs-lookup"><span data-stu-id="d8829-106">An enumerator that iterates through the collection.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="d8829-107">コレクションを反復処理する列挙子を返します。</span><span class="sxs-lookup"><span data-stu-id="d8829-107">Returns an enumerator that iterates through the collection.</span></span></summary>
        <returns><span data-ttu-id="d8829-108">コレクションを反復処理する列挙子。</span><span class="sxs-lookup"><span data-stu-id="d8829-108">An enumerator that iterates through the collection.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
