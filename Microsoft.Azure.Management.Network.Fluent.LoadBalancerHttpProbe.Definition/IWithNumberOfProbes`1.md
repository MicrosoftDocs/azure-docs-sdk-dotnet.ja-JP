<Type Name="IWithNumberOfProbes&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerHttpProbe.Definition.IWithNumberOfProbes&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="6b62d-101">親の型。</span><span class="sxs-lookup"><span data-stu-id="6b62d-101">The parent type.</span></span></typeparam>
    <summary>
            <span data-ttu-id="6b62d-102">HTTP プローブ定義できるようにするというエラーを確認する前に失敗したプローブの数を指定する段階です。</span><span class="sxs-lookup"><span data-stu-id="6b62d-102">The stage of the HTTP probe definition allowing to specify the number of unsuccessful probes before failure is determined.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithNumberOfProbes">
      ...
      <Docs>
        <param name="probes"><span data-ttu-id="6b62d-103">プローブの数。</span><span class="sxs-lookup"><span data-stu-id="6b62d-103">Number of probes.</span></span></param>
        <summary>
            <span data-ttu-id="6b62d-104">エラーを確認する前に、失敗したプローブの数を指定します。</span><span class="sxs-lookup"><span data-stu-id="6b62d-104">Specifies the number of unsuccessful probes before failure is determined.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="6b62d-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="6b62d-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>