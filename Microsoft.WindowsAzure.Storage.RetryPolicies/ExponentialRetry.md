<Type Name="ExponentialRetry" FullName="Microsoft.WindowsAzure.Storage.RetryPolicies.ExponentialRetry">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.RetryPolicies.ExponentialRetry" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.WindowsAzure.Storage.RetryPolicies.ExponentialRetry" />クラスの指定されたデルタと再試行の最大数を使用します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
