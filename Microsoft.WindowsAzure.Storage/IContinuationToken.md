<Type Name="IContinuationToken" FullName="Microsoft.WindowsAzure.Storage.IContinuationToken">
  ...
  <Docs>
    <summary>
            継続トークンの種類に必要なインターフェイスです。
            </summary>
    <remarks><see cref="T:Microsoft.WindowsAzure.Storage.Table.TableContinuationToken" />、 <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContinuationToken" />、および<see cref="T:Microsoft.WindowsAzure.Storage.Queue.QueueContinuationToken" />クラスで実装、<see cref="T:Microsoft.WindowsAzure.Storage.IContinuationToken" />インターフェイスです。</remarks>
  </Docs>
  <Members>
