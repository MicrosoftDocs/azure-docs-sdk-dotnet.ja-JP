<Type Name="SharedAccessAccountResourceTypes" FullName="Microsoft.WindowsAzure.Storage.SharedAccessAccountResourceTypes">
  ...
  <Docs>
    <summary>
            一連の共有アクセス ポリシーのアカウントの符号付きのリソースの種類を指定します。
            </summary>
  ...
  <Members>
    <Member MemberName="Container">
      ...
      <Docs>
        <summary>
            コンテナー レベル付与 Api (Blob コンテナー、テーブル、キュー、ファイル共有) にアクセスする権限です。
            </summary>
      </Docs>
    </Member>
    ...
    <Member MemberName="Object">
      ...
      <Docs>
        <summary>
            オブジェクト レベル付与 Api (Blob、テーブル エンティティ、キュー メッセージ、ファイル) にアクセスする権限
            </summary>
      </Docs>
    </Member>
