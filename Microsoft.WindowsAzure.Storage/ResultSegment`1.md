<Type Name="ResultSegment&lt;TElement&gt;" FullName="Microsoft.WindowsAzure.Storage.ResultSegment&lt;TElement&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="TElement">結果セグメントとして返される要素の型。</typeparam>
    <summary>
            使用可能な結果セット全体から取得された結果セグメントを表します。
            </summary>
  ...
  <Members>
    <Member MemberName="ContinuationToken">
      ...
      <Docs>
        ...
        <value><see cref="T:Microsoft.WindowsAzure.Storage.IContinuationToken" /> 型のオブジェクト。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Results">
      ...
      <Docs>
        ...
        <value>型の結果の列挙可能なコレクション<c>TElement</c>です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
