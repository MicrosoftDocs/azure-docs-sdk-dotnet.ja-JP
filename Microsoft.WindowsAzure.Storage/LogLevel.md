<Type Name="LogLevel" FullName="Microsoft.WindowsAzure.Storage.LogLevel">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="892d4-101">ログに出力するメッセージを指定します。</span><span class="sxs-lookup"><span data-stu-id="892d4-101">Specifies what messages to output to the log.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Error">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="892d4-102">エラー処理メッセージを出力します。</span><span class="sxs-lookup"><span data-stu-id="892d4-102">Output error-handling messages.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Informational">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="892d4-103">情報メッセージ、警告、およびエラー処理メッセージを出力します。</span><span class="sxs-lookup"><span data-stu-id="892d4-103">Output informational messages, warnings, and error-handling messages.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Off">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="892d4-104">トレース メッセージおよびデバッグ メッセージを出力します。</span><span class="sxs-lookup"><span data-stu-id="892d4-104">Output no tracing and debugging messages.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Verbose">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="892d4-105">すべてのデバッグおよびトレースのメッセージを出力します。</span><span class="sxs-lookup"><span data-stu-id="892d4-105">Output all debugging and tracing messages.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Warning">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="892d4-106">出力の警告およびエラー処理メッセージです。</span><span class="sxs-lookup"><span data-stu-id="892d4-106">Output warnings and error-handling messages.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
