<Type Name="IWithHostName" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayListener.Update.IWithHostName">
  ...
  <Docs>
    <summary>
            アプリケーション ゲートウェイのフロント エンド リスナーのステージでは、トラフィックを受信する web サイトのホスト名を指定する許可を更新します。
            </summary>
