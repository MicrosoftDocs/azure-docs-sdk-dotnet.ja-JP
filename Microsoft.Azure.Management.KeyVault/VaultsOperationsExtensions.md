  ...
  <Members>
    <Member MemberName="BeginPurgeDeleted">
      ...
      <Docs>
        ...
        <param name="location">
            論理削除された資格情報コンテナーの場所です。
            </param>
        <summary>
            指定した資格情報コンテナーを完全に削除します。 別名が削除された Azure key vault を削除します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="CreateOrUpdate">
      ...
      <Docs>
        ...
        <summary>
            作成または指定したサブスクリプションでキー資格情報コンテナーを更新します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Delete">
      ...
      <Docs>
        ...
        <param name="resourceGroupName">
            資格情報コンテナーが属するリソース グループの名前。
            </param>
        <param name="vaultName">
            削除する資格情報コンテナーの名前
            </param>
        <summary>
            指定した Azure key vault を削除します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="List">
      ...
      <Docs>
        ...
        <summary>
            一覧操作では、サブスクリプションに関連付けられている資格情報コンテナーに関する情報を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListByResourceGroup">
      ...
      <Docs>
        ...
        <summary>
            一覧操作では、および指定されたリソース グループ内で、サブスクリプションに関連付けられている資格情報コンテナーに関する情報を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListDeleted">
      ...
      <Docs>
        ...
        <summary>
            サブスクリプションの削除済みの資格情報コンテナーに関する情報を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
