<Type Name="SyncAgent" FullName="Microsoft.Azure.Management.Sql.Models.SyncAgent">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SyncAgent クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="syncAgentName">同期エージェントの名前です。</param>
        <param name="syncDatabaseId">同期エージェントで、sync データベースの ARM リソース id です。</param>
        <param name="lastAliveTime">同期エージェントがアライブの最後の時刻。</param>
        <param name="state">同期エージェントの状態です。 使用可能な値が含まれます: 'オンライン'、'Offline'、'NeverConnected'</param>
        <param name="isUpToDate">同期エージェントのバージョンが最新の状態の場合は。</param>
        <param name="expiryTime">同期エージェントのバージョンの有効期限。</param>
        <param name="version">同期エージェントのバージョンです。</param>
        <summary>
            SyncAgent クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IsUpToDate">
      ...
      <Docs>
        <summary>
            場合は、同期エージェントのバージョンが最新の状態を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            同期エージェントの状態を取得します。 使用可能な値が含まれます: 'オンライン'、'Offline'、'NeverConnected'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SyncDatabaseId">
      ...
      <Docs>
        <summary>
            取得または同期エージェントで、sync データベースの ARM リソース id を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
