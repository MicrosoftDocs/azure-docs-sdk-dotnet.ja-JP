<Type Name="DatabaseUsage" FullName="Microsoft.Azure.Management.Sql.Models.DatabaseUsage">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DatabaseUsage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">使用状況メトリックの名前。</param>
        <param name="resourceName">リソースの名前。</param>
        <param name="displayName">使用状況メトリックの表示名。</param>
        <param name="currentValue">使用状況メトリックの現在の値。</param>
        <param name="limit">使用状況メトリックの現在の制限。</param>
        <param name="unit">使用状況メトリックの単位です。</param>
        <param name="nextResetTime">次は、使用状況メトリック (ISO8601 形式) の時刻をリセットします。</param>
        <summary>
            DatabaseUsage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="NextResetTime">
      ...
      <Docs>
        <summary>
            取得、次へは、使用状況メトリック (ISO8601 形式) の時刻をリセットします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
