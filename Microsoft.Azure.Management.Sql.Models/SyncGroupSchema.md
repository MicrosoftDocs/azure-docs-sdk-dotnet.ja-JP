<Type Name="SyncGroupSchema" FullName="Microsoft.Azure.Management.Sql.Models.SyncGroupSchema">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SyncGroupSchema クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tables">同期グループのスキーマ内のテーブルの一覧です。</param>
        <param name="masterSyncMemberName">スキーマの作成はマスター同期メンバーの名前。</param>
        <summary>
            SyncGroupSchema クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="MasterSyncMemberName">
      ...
      <Docs>
        <summary>
            取得または場所からは、スキーマ マスターの同期メンバーの名前を設定します。
            </summary>
    ...
    <Member MemberName="Tables">
      ...
      <Docs>
        <summary>
            取得または同期グループのスキーマでテーブルの一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
