<Type Name="ServiceObjectiveCapability" FullName="Microsoft.Azure.Management.Sql.Models.ServiceObjectiveCapability">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ServiceObjectiveCapability クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">サービス目標の名前です。</param>
        <param name="status">サービス目標の状態です。 使用可能な値が含まれます: 'Visible'、使用可能'、'Default'、'Disabled'</param>
        <param name="unit">ユニットの種類がサービス目標のパフォーマンス レベルを測定するために使用します。 使用可能な値が含まれます: 'DTU'</param>
        <param name="value">パフォーマンス レベルの値。</param>
        <param name="id">サービス目標の一意の ID。</param>
        <param name="supportedMaxSizes">このサービス目標のサポートされている最大データベース サイズの一覧です。</param>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            サービス目標の状態を取得します。 使用可能な値が含まれます: 'Visible'、使用可能'、'Default'、'Disabled'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SupportedMaxSizes">
      ...
      <Docs>
        <summary>
            このサービス目標のサポートされている最大データベース サイズの一覧を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            サービス目標のパフォーマンス レベルを測定するために使用する単位の種類を取得します。
            使用可能な値が含まれます: 'DTU'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
