<Type Name="SyncFullSchemaProperties" FullName="Microsoft.Azure.Management.Sql.Models.SyncFullSchemaProperties">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tables">データベースの完全スキーマ内のテーブルの一覧です。</param>
        <param name="lastUpdateTime">データベース スキーマの時間の最終更新します。</param>
        <summary>
            SyncFullSchemaProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
