<Type Name="ImportExportResponse" FullName="Microsoft.Azure.Management.Sql.Models.ImportExportResponse">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ImportExportResponse クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="requestType">操作の要求の種類。</param>
        <param name="requestId">操作の要求の種類。</param>
        <param name="serverName">サーバーの名前。</param>
        <param name="databaseName">データベースの名前。</param>
        <param name="status">サーバーからステータス メッセージが返されます。</param>
        <param name="lastModifiedTime">操作の状態には、最終更新時刻を設定します。</param>
        <param name="queuedTime">操作がキューに置かれた時間。</param>
        <param name="blobUri">Blob の uri。</param>
        <param name="errorMessage">サーバーからエラー メッセージが返されます。</param>
        <summary>
            ImportExportResponse クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
