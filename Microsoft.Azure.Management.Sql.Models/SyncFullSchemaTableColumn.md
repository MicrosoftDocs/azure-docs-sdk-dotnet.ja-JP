<Type Name="SyncFullSchemaTableColumn" FullName="Microsoft.Azure.Management.Sql.Models.SyncFullSchemaTableColumn">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SyncFullSchemaTableColumn クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="errorId">エラー列の id。</param>
        <param name="hasError">テーブルにエラーがある場合は。</param>
        <param name="isPrimaryKey">テーブルの主キーの場合。</param>
        <param name="name">列の名前です。</param>
        <param name="quotedName">列の名前を引用符で囲まれました。</param>
        <summary>
            SyncFullSchemaTableColumn クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
