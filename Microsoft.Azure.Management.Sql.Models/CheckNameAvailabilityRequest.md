<Type Name="CheckNameAvailabilityRequest" FullName="Microsoft.Azure.Management.Sql.Models.CheckNameAvailabilityRequest">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            CheckNameAvailabilityRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">使用できるかどうかを調べる名前。</param>
        <summary>
            CheckNameAvailabilityRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
