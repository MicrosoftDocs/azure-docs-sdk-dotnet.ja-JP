<Type Name="SyncAgentLinkedDatabase" FullName="Microsoft.Azure.Management.Sql.Models.SyncAgentLinkedDatabase">
  ...
  <Docs>
    <summary>
            Azure SQL Database では、エージェントのリンクされたデータベースを同期します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SyncAgentLinkedDatabase クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="databaseType">同期エージェントのリンクされたデータベースの種類です。
            使用可能な値が含まれます: 'AzureSqlDatabase'、'SqlServerDatabase'</param>
        <param name="databaseId">同期エージェントのリンクされたデータベースの id です。</param>
        <param name="description">同期エージェントのリンクされたデータベースの説明です。</param>
        <param name="serverName">同期エージェントのリンクされたデータベースのサーバー名。</param>
        <param name="databaseName">同期エージェントのリンクされたデータベースのデータベース名。</param>
        <param name="userName">同期エージェントのリンクされたデータベースのユーザー名。</param>
        <summary>
            SyncAgentLinkedDatabase クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DatabaseId">
      ...
      <Docs>
        <summary>
            同期エージェントのリンクされたデータベースの id を取得します。
            </summary>
    ...
    <Member MemberName="DatabaseName">
      ...
      <Docs>
        <summary>
            同期エージェントのリンクされたデータベースの名前を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseType">
      ...
      <Docs>
        <summary>
            同期エージェントのリンクされたデータベースの型を取得します。 使用可能な値が含まれます: 'AzureSqlDatabase'、'SqlServerDatabase'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Description">
      ...
      <Docs>
        <summary>
            同期エージェントのリンクされたデータベースの説明を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerName">
      ...
      <Docs>
        <summary>
            同期エージェントのリンクされたデータベースのサーバー名を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
