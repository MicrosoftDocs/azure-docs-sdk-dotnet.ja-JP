<Type Name="FailoverGroup" FullName="Microsoft.Azure.Management.Sql.Models.FailoverGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="10dd7-101">フェールオーバー グループです。</span><span class="sxs-lookup"><span data-stu-id="10dd7-101">A failover group.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="10dd7-102">FailoverGroup クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-102">Initializes a new instance of the FailoverGroup class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="readWriteEndpoint"><span data-ttu-id="10dd7-103">フェールオーバー グループ インスタンスのエンドポイントを読み取り/書き込みです。</span><span class="sxs-lookup"><span data-stu-id="10dd7-103">Read-write endpoint of the failover group instance.</span></span></param>
        <param name="partnerServers"><span data-ttu-id="10dd7-104">グループにフェールオーバー パートナー サーバー情報の一覧です。</span><span class="sxs-lookup"><span data-stu-id="10dd7-104">List of partner server information for the failover group.</span></span></param>
        <param name="id"><span data-ttu-id="10dd7-105">リソースの ID</span><span class="sxs-lookup"><span data-stu-id="10dd7-105">Resource ID.</span></span></param>
        <param name="name"><span data-ttu-id="10dd7-106">リソース名。</span><span class="sxs-lookup"><span data-stu-id="10dd7-106">Resource name.</span></span></param>
        <param name="type"><span data-ttu-id="10dd7-107">リソースの種類。</span><span class="sxs-lookup"><span data-stu-id="10dd7-107">Resource type.</span></span></param>
        <param name="location"><span data-ttu-id="10dd7-108">リソースの場所。</span><span class="sxs-lookup"><span data-stu-id="10dd7-108">Resource location.</span></span></param>
        <param name="tags"><span data-ttu-id="10dd7-109">リソース タグ。</span><span class="sxs-lookup"><span data-stu-id="10dd7-109">Resource tags.</span></span></param>
        <param name="readOnlyEndpoint"><span data-ttu-id="10dd7-110">フェールオーバー グループ インスタンスのエンドポイントを読み取り専用です。</span><span class="sxs-lookup"><span data-stu-id="10dd7-110">Read-only endpoint of the failover group instance.</span></span></param>
        <param name="replicationRole"><span data-ttu-id="10dd7-111">フェールオーバー グループ インスタンスのローカル レプリケーション ロール。</span><span class="sxs-lookup"><span data-stu-id="10dd7-111">Local replication role of the failover group instance.</span></span> <span data-ttu-id="10dd7-112">使用可能な値が含まれます 'Primary'、'セカンダリ'。</span><span class="sxs-lookup"><span data-stu-id="10dd7-112">Possible values include: 'Primary', 'Secondary'</span></span></param>
        <param name="replicationState"><span data-ttu-id="10dd7-113">フェールオーバー グループ インスタンスのレプリケーション状態です。</span><span class="sxs-lookup"><span data-stu-id="10dd7-113">Replication state of the failover group instance.</span></span></param>
        <param name="databases"><span data-ttu-id="10dd7-114">フェールオーバー グループ内のデータベースの一覧です。</span><span class="sxs-lookup"><span data-stu-id="10dd7-114">List of databases in the failover group.</span></span></param>
        <summary>
            <span data-ttu-id="10dd7-115">FailoverGroup クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-115">Initializes a new instance of the FailoverGroup class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Databases">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="10dd7-116">取得またはフェールオーバー グループ内のデータベースの一覧を設定します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-116">Gets or sets list of databases in the failover group.</span></span>
            </summary>
    ...
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="10dd7-117">リソースの場所を取得します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-117">Gets resource location.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PartnerServers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="10dd7-118">取得またはグループのフェールオーバーのパートナー サーバーの情報の一覧を設定します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-118">Gets or sets list of partner server information for the failover group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadOnlyEndpoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="10dd7-119">取得またはフェールオーバー グループ インスタンスの読み取り専用のエンドポイントを設定します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-119">Gets or sets read-only endpoint of the failover group instance.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadWriteEndpoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="10dd7-120">取得またはフェールオーバー グループ インスタンスの読み取り/書き込みのエンドポイントを設定します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-120">Gets or sets read-write endpoint of the failover group instance.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReplicationRole">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="10dd7-121">フェールオーバー グループ インスタンスのローカル レプリケーション ロールを取得します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-121">Gets local replication role of the failover group instance.</span></span>
            <span data-ttu-id="10dd7-122">使用可能な値が含まれます 'Primary'、'セカンダリ'。</span><span class="sxs-lookup"><span data-stu-id="10dd7-122">Possible values include: 'Primary', 'Secondary'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReplicationState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="10dd7-123">フェールオーバー グループ インスタンスのレプリケーション状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-123">Gets replication state of the failover group instance.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="10dd7-124">取得またはリソース タグを設定します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-124">Gets or sets resource tags.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="10dd7-125">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="10dd7-125">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="10dd7-126">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="10dd7-126">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
