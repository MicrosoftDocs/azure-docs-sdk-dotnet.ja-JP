<Type Name="SyncGroupSchemaTable" FullName="Microsoft.Azure.Management.Sql.Models.SyncGroupSchemaTable">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SyncGroupSchemaTable クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="columns">同期グループのスキーマ内の列の一覧です。</param>
        <param name="quotedName">同期グループ スキーマ テーブルの名前を引用符で囲みます。</param>
        <summary>
            SyncGroupSchemaTable クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="QuotedName">
      ...
      <Docs>
        <summary>
            取得または同期グループ スキーマ テーブルの引用符で囲まれた名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
