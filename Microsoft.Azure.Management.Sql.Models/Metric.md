<Type Name="Metric" FullName="Microsoft.Azure.Management.Sql.Models.Metric">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="startTime">メトリック (ISO 8601 形式) の開始時刻。</param>
        <param name="endTime">メトリック (ISO 8601 形式) の終了時刻。</param>
        <param name="timeGrain">メトリックの値の集計に使用する時間ステップします。</param>
        <param name="unit">メトリックの単位。 使用可能な値が含まれます: 'count'、'バイト'、'秒数'、'%'、'countPerSecond'、'bytesPerSecond'</param>
        <param name="name">メトリックの名前情報。</param>
        <param name="metricValues">指定された時間ウィンドウおよびタイム ステップのメトリックの値。</param>
        <summary>
            メトリックのクラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="MetricValues">
      ...
      <Docs>
        <summary>
            指定された時間ウィンドウとタイム ステップのメトリックの値を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
