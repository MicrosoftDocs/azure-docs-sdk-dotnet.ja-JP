<Type Name="SyncFullSchemaTable" FullName="Microsoft.Azure.Management.Sql.Models.SyncFullSchemaTable">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SyncFullSchemaTable クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="columns">データベースの完全スキーマのテーブル内の列の一覧です。</param>
        <param name="errorId">テーブルのエラーの id。</param>
        <param name="hasError">テーブルにエラーがある場合は。</param>
        <param name="name">テーブルの名前。</param>
        <param name="quotedName">テーブルの名前を引用符で囲まれました。</param>
        <summary>
            SyncFullSchemaTable クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
