<Type Name="EditionCapability" FullName="Microsoft.Azure.Management.Sql.Models.EditionCapability">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            EditionCapability クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">エディション名。</param>
        <param name="status">エディションの状態です。 使用可能な値が含まれます: 'Visible'、使用可能'、'Default'、'Disabled'</param>
        <param name="supportedServiceLevelObjectives">エディションのサポートされているサービス目標の一覧。</param>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            エディションのステータスを取得します。 使用可能な値が含まれます: 'Visible'、使用可能'、'Default'、'Disabled'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SupportedServiceLevelObjectives">
      ...
      <Docs>
        <summary>
            エディションのサポートされているサービス目標の一覧を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
