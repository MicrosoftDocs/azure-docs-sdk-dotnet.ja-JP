<Type Name="BackupLongTermRetentionVault" FullName="Microsoft.Azure.Management.Sql.Models.BackupLongTermRetentionVault">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            BackupLongTermRetentionVault クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="recoveryServicesVaultResourceId">Azure recovery services コンテナーのリソース id</param>
    ...
    <Member MemberName="RecoveryServicesVaultResourceId">
      ...
      <Docs>
        <summary>
            取得または設定、azure recovery services コンテナーのリソース id
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
