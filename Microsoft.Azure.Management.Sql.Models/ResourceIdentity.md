<Type Name="ResourceIdentity" FullName="Microsoft.Azure.Management.Sql.Models.ResourceIdentity">
  ...
  <Docs>
    <summary>
            Azure Active Directory id のリソースを構成します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="principalId">Azure Active Directory のプリンシパル id。</param>
        <param name="type">Id の種類。 これを自動的に作成し、Azure Active Directory のプリンシパルのリソースを割り当てるために 'SystemAssigned' に設定します。 使用可能な値が含まれます: 'SystemAssigned'</param>
        <param name="tenantId">Azure Active Directory テナント id です。</param>
        <summary>
            ResourceIdentity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="PrincipalId">
      ...
      <Docs>
        <summary>
            Azure Active Directory のプリンシパル id を取得します。
            </summary>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            取得または id の種類を設定します。 これを自動的に作成し、Azure Active Directory のプリンシパルのリソースを割り当てるために 'SystemAssigned' に設定します。 使用可能な値が含まれます: 'SystemAssigned'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
