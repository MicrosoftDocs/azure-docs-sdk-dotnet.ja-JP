<Type Name="ElasticPoolActivity" FullName="Microsoft.Azure.Management.Sql.Models.ElasticPoolActivity">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ElasticPoolActivity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="requestedDatabaseDtuMax">使用可能な場合、データベースごとの最大 DTU の要求。</param>
        <param name="requestedDatabaseDtuMin">使用可能な場合、データベースごとの要求された最小 DTU です。</param>
        <param name="requestedDtu">使用可能な場合、プールの DTU の要求。</param>
        <param name="requestedElasticPoolName">要求された使用可能な場合は、弾力性プールの名前。</param>
        <param name="requestedStorageLimitInGB">プール GB 利用可能な場合に要求記憶域の上限。</param>
        <param name="elasticPoolName">弾力性プールの名前。</param>
        ...
        <param name="requestedStorageLimitInMB">Mb 単位で要求記憶域の上限。</param>
        <param name="requestedDatabaseDtuGuarantee">要求された各データベースの DTU 保証します。</param>
        <param name="requestedDatabaseDtuCap">要求されたデータベースの DTU 上限ごとです。</param>
        <param name="requestedDtuGuarantee">要求した DTU 保証します。</param>
        <summary>
            ElasticPoolActivity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="RequestedDatabaseDtuMax">
      ...
      <Docs>
        <summary>
            使用可能な場合、データベースごとの最大 DTU の要求を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestedDatabaseDtuMin">
      ...
      <Docs>
        <summary>
            使用可能な場合は、データベースあたりの要求された最小 DTU を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestedStorageLimitInGB">
      ...
      <Docs>
        <summary>
            GB 利用可能な場合に、プールの要求記憶域の上限を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
