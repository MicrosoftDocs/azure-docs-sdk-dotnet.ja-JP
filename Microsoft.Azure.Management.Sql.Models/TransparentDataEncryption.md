<Type Name="TransparentDataEncryption" FullName="Microsoft.Azure.Management.Sql.Models.TransparentDataEncryption">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            TransparentDataEncryption クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="status">データベースの透過的なデータ暗号化の状態です。 使用可能な値が含まれます: 'Enabled'、'Disabled'</param>
        <summary>
            TransparentDataEncryption クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            取得またはデータベースの透過的なデータ暗号化の状態を設定します。 使用可能な値が含まれます: 'Enabled'、'Disabled'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
