<Type Name="ElasticPoolEditionCapability" FullName="Microsoft.Azure.Management.Sql.Models.ElasticPoolEditionCapability">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ElasticPoolEditionCapability クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">弾力性プールのエディション名。</param>
        <param name="status">弾力性プール エディションの状態です。
            使用可能な値が含まれます: 'Visible'、使用可能'、'Default'、'Disabled'</param>
        <param name="supportedElasticPoolDtus">エディションのサポートされている弾力性プールの DTU レベルの一覧。</param>
        <param name="zoneRedundant">かどうかエディションのゾーンの冗長性がサポートされています。</param>
        <summary>
            ElasticPoolEditionCapability クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            弾力性プール エディションのステータスを取得します。 使用可能な値が含まれます: 'Visible'、使用可能'、'Default'、'Disabled'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SupportedElasticPoolDtus">
      ...
      <Docs>
        <summary>
            エディションのサポートされている弾力性プールの一覧の DTU レベルを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ZoneRedundant">
      ...
      <Docs>
        <summary>
            エディションのゾーンの冗長性がサポートされているかどうかを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
