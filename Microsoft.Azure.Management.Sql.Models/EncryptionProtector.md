<Type Name="EncryptionProtector" FullName="Microsoft.Azure.Management.Sql.Models.EncryptionProtector">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serverKeyType">'ServiceManaged'、'AzureKeyVault' のような暗号化の保護の種類。 使用可能な値が含まれます: 'ServiceManaged'、'AzureKeyVault'</param>
        <param name="id">リソースの ID</param>
        <param name="name">リソース名。</param>
        <param name="type">リソースの種類。</param>
        <param name="kind">暗号化の保護機能の種類。 これは、Azure ポータルのエクスペリエンスで使用されるメタデータです。</param>
        <param name="location">リソースの場所。</param>
        <param name="subregion">暗号化の保護機能のサブ地域。</param>
        <param name="serverKeyName">サーバー キーの名前です。</param>
    ...
    <Member MemberName="ServerKeyType">
      ...
      <Docs>
        <summary>
            取得または 'ServiceManaged'、'AzureKeyVault' のような暗号化の保護の種類を設定します。 使用可能な値が含まれます: 'ServiceManaged'、'AzureKeyVault'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
