<Type Name="ReplicationLink" FullName="Microsoft.Azure.Management.Sql.Models.ReplicationLink">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ReplicationLink クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="isTerminationAllowed">終了が許可されているかどうかを示すレガシ値。  現在常に true を返します。</param>
        <param name="replicationMode">このレプリケーション リンクのレプリケーション モードです。</param>
        <param name="partnerServer">パートナーのデータベースをホストしているサーバーの名前。</param>
        <param name="partnerDatabase">パートナーのデータベースの名前。</param>
        <param name="partnerLocation">パートナーのデータベースの Azure リージョン。</param>
        <param name="role">レプリケーション リンクで、データベースのロール。 使用可能な値が含まれます 'Primary'、'セカンダリ'、'NonReadableSecondary'、'Source'、[コピー]。</param>
        <param name="partnerRole">レプリケーション リンクにパートナーのデータベースのロール。 使用可能な値が含まれます 'Primary'、'セカンダリ'、'NonReadableSecondary'、'Source'、[コピー]。</param>
        <param name="startTime">レプリケーション リンクの開始時刻です。</param>
    ...
    <Member MemberName="PartnerLocation">
      ...
      <Docs>
        <summary>
            パートナーのデータベースの Azure リージョンを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PartnerRole">
      ...
      <Docs>
        <summary>
            レプリケーション リンクにパートナーのデータベースの役割を取得します。
    ...
    <Member MemberName="PartnerServer">
      ...
      <Docs>
        <summary>
            パートナーのデータベースをホストしているサーバーの名前を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Role">
      ...
      <Docs>
        <summary>
            レプリケーション リンクに、データベースの役割を取得します。 使用可能な値が含まれます 'Primary'、'セカンダリ'、'NonReadableSecondary'、'Source'、[コピー]。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
