<Type Name="PartnerInfo" FullName="Microsoft.Azure.Management.Sql.Models.PartnerInfo">
  ...
  <Docs>
    <summary>
            パートナー サーバー グループの情報をフェールオーバーします。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PartnerInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">パートナー サーバーのリソース識別子。</param>
        <param name="location">パートナー サーバーの地理的場所。</param>
        <param name="replicationRole">パートナー サーバーのレプリケーションのロール。 使用可能な値が含まれます 'Primary'、'セカンダリ'。</param>
        <summary>
            PartnerInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ReplicationRole">
      ...
      <Docs>
        <summary>
            パートナー サーバーのレプリケーションのロールを取得します。 使用可能な値が含まれます 'Primary'、'セカンダリ'。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
