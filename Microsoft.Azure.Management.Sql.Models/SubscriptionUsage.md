<Type Name="SubscriptionUsage" FullName="Microsoft.Azure.Management.Sql.Models.SubscriptionUsage">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SubscriptionUsage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="displayName">メトリックのユーザーが判読できる名前です。</param>
        <param name="currentValue">メトリックの現在の値。</param>
        <param name="limit">メトリックの境界値です。</param>
