<Type Name="LocationCapabilities" FullName="Microsoft.Azure.Management.Sql.Models.LocationCapabilities">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            LocationCapabilities クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="status">Azure SQL データベースの状態、場所をします。
            使用可能な値が含まれます: 'Visible'、使用可能'、'Default'、'Disabled'</param>
        <param name="supportedServerVersions">サポートされているサーバーのバージョンの一覧。</param>
        <summary>
            LocationCapabilities クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            場所の azure SQL データベースの状態を取得します。 使用可能な値が含まれます: 'Visible'、使用可能'、'Default'、'Disabled'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
