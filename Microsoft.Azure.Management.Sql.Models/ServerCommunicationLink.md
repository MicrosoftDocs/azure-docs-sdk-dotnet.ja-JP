<Type Name="ServerCommunicationLink" FullName="Microsoft.Azure.Management.Sql.Models.ServerCommunicationLink">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="partnerServer">パートナー サーバーの名前です。</param>
        <param name="id">リソースの ID</param>
        <param name="name">リソース名。</param>
        <param name="type">リソースの種類。</param>
        <param name="state">状態。</param>
        <param name="location">通信リンクの場所です。</param>
        <param name="kind">通信リンクの種類。  このプロパティは、Azure ポータルのメタデータに使用されます。</param>
        <summary>
            ServerCommunicationLink クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Kind">
      ...
      <Docs>
        <summary>
            通信リンクの種類を取得します。  このプロパティは、Azure ポータルのメタデータに使用されます。
            </summary>
