<Type Name="OperationImpact" FullName="Microsoft.Azure.Management.Sql.Models.OperationImpact">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="895d7-101">絶対パスと相対の両面で、操作の影響。</span><span class="sxs-lookup"><span data-stu-id="895d7-101">The impact of an operation, both in absolute and relative terms.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="895d7-102">OperationImpact クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="895d7-102">Initializes a new instance of the OperationImpact class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="895d7-103">影響のディメンションの名前。</span><span class="sxs-lookup"><span data-stu-id="895d7-103">The name of the impact dimension.</span></span></param>
        <param name="unit"><span data-ttu-id="895d7-104">ディメンションへの影響を測定する単位の推定値。</span><span class="sxs-lookup"><span data-stu-id="895d7-104">The unit in which estimated impact to dimension is measured.</span></span></param>
        <param name="changeValueAbsolute"><span data-ttu-id="895d7-105">ディメンションへの絶対への影響。</span><span class="sxs-lookup"><span data-stu-id="895d7-105">The absolute impact to dimension.</span></span></param>
        <param name="changeValueRelative"><span data-ttu-id="895d7-106">ディメンション (該当しない場合は null) に相対的影響</span><span class="sxs-lookup"><span data-stu-id="895d7-106">The relative impact to dimension (null if not applicable)</span></span></param>
        <summary>
            <span data-ttu-id="895d7-107">OperationImpact クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="895d7-107">Initializes a new instance of the OperationImpact class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ChangeValueAbsolute">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="895d7-108">ディメンションへの絶対の影響を取得します。</span><span class="sxs-lookup"><span data-stu-id="895d7-108">Gets the absolute impact to dimension.</span></span>
            </summary>
    ...
    <Member MemberName="ChangeValueRelative">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="895d7-109">ディメンションに対する相対的な影響を (該当しない場合は null) を取得します。</span><span class="sxs-lookup"><span data-stu-id="895d7-109">Gets the relative impact to dimension (null if not applicable)</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="895d7-110">影響のディメンションの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="895d7-110">Gets the name of the impact dimension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="895d7-111">ディメンションへの影響を推定が値が測定単位を取得します。</span><span class="sxs-lookup"><span data-stu-id="895d7-111">Gets the unit in which estimated impact to dimension is measured.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
