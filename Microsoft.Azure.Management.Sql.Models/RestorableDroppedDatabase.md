<Type Name="RestorableDroppedDatabase" FullName="Microsoft.Azure.Management.Sql.Models.RestorableDroppedDatabase">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0be41-101">復元可能な削除されたデータベース</span><span class="sxs-lookup"><span data-stu-id="0be41-101">A restorable dropped database</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0be41-102">RestorableDroppedDatabase クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="0be41-102">Initializes a new instance of the RestorableDroppedDatabase class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="0be41-103">リソースの ID</span><span class="sxs-lookup"><span data-stu-id="0be41-103">Resource ID.</span></span></param>
        <param name="name"><span data-ttu-id="0be41-104">リソース名。</span><span class="sxs-lookup"><span data-stu-id="0be41-104">Resource name.</span></span></param>
        <param name="type"><span data-ttu-id="0be41-105">リソースの種類。</span><span class="sxs-lookup"><span data-stu-id="0be41-105">Resource type.</span></span></param>
        <param name="location"><span data-ttu-id="0be41-106">リソースが存在する地理的な場所</span><span class="sxs-lookup"><span data-stu-id="0be41-106">The geo-location where the resource lives</span></span></param>
        <param name="databaseName"><span data-ttu-id="0be41-107">データベースの名前</span><span class="sxs-lookup"><span data-stu-id="0be41-107">The name of the database</span></span></param>
        <param name="edition"><span data-ttu-id="0be41-108">データベースのエディション</span><span class="sxs-lookup"><span data-stu-id="0be41-108">The edition of the database</span></span></param>
        <param name="maxSizeBytes"><span data-ttu-id="0be41-109">データベースのバイト単位の最大サイズ</span><span class="sxs-lookup"><span data-stu-id="0be41-109">The max size in bytes of the database</span></span></param>
        <param name="serviceLevelObjective"><span data-ttu-id="0be41-110">データベースのサービス レベル目標の名前</span><span class="sxs-lookup"><span data-stu-id="0be41-110">The service level objective name of the database</span></span></param>
        <param name="elasticPoolName"><span data-ttu-id="0be41-111">データベースの弾力性プールの名前</span><span class="sxs-lookup"><span data-stu-id="0be41-111">The elastic pool name of the database</span></span></param>
        <param name="creationDate"><span data-ttu-id="0be41-112">データベース (ISO8601 形式) の作成日</span><span class="sxs-lookup"><span data-stu-id="0be41-112">The creation date of the database (ISO8601 format)</span></span></param>
        <param name="deletionDate"><span data-ttu-id="0be41-113">データベース (ISO8601 形式) の削除日</span><span class="sxs-lookup"><span data-stu-id="0be41-113">The deletion date of the database (ISO8601 format)</span></span></param>
        <param name="earliestRestoreDate"><span data-ttu-id="0be41-114">データベース (ISO8601 形式) の最も早い復元日</span><span class="sxs-lookup"><span data-stu-id="0be41-114">The earliest restore date of the database (ISO8601 format)</span></span></param>
        <summary>
            <span data-ttu-id="0be41-115">RestorableDroppedDatabase クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="0be41-115">Initializes a new instance of the RestorableDroppedDatabase class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreationDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0be41-116">データベース (ISO8601 形式) の作成日を取得します。</span><span class="sxs-lookup"><span data-stu-id="0be41-116">Gets the creation date of the database (ISO8601 format)</span></span>
            </summary>
    ...
    <Member MemberName="DatabaseName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0be41-117">データベースの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="0be41-117">Gets the name of the database</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DeletionDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0be41-118">データベース (ISO8601 形式) の削除日を取得します。</span><span class="sxs-lookup"><span data-stu-id="0be41-118">Gets the deletion date of the database (ISO8601 format)</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EarliestRestoreDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0be41-119">取得可能な最初のデータベース (ISO8601 形式) の日付を復元します。</span><span class="sxs-lookup"><span data-stu-id="0be41-119">Gets the earliest restore date of the database (ISO8601 format)</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Edition">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0be41-120">データベースのエディションを取得します。</span><span class="sxs-lookup"><span data-stu-id="0be41-120">Gets the edition of the database</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ElasticPoolName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0be41-121">データベースの弾力性プールの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="0be41-121">Gets the elastic pool name of the database</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0be41-122">リソースが存在する地理的な場所を取得します。</span><span class="sxs-lookup"><span data-stu-id="0be41-122">Gets the geo-location where the resource lives</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaxSizeBytes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0be41-123">データベースのバイト単位で最大サイズを取得します。</span><span class="sxs-lookup"><span data-stu-id="0be41-123">Gets the max size in bytes of the database</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceLevelObjective">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0be41-124">データベースのサービス レベル目標の名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="0be41-124">Gets the service level objective name of the database</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
