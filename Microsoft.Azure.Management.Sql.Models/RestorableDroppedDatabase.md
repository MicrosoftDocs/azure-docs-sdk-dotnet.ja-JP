  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="edition">データベースのエディション</param>
        <param name="maxSizeBytes">データベースのバイト単位の最大サイズ</param>
        <param name="serviceLevelObjective">データベースのサービス レベル目標の名前</param>
        <param name="elasticPoolName">データベースの弾力性プールの名前</param>
        <param name="creationDate">データベース (ISO8601 形式) の作成日</param>
        <param name="deletionDate">データベース (ISO8601 形式) の削除日</param>
        <param name="earliestRestoreDate">データベース (ISO8601 形式) の最も早い復元日</param>
        <summary>
            RestorableDroppedDatabase クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EarliestRestoreDate">
      ...
      <Docs>
        <summary>
            取得可能な最初のデータベース (ISO8601 形式) の日付を復元します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
