<Type Name="IWithFromImageCreateOptionsUnmanaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.Definition.IWithFromImageCreateOptionsUnmanaged">
  ...
  <Docs>
    <summary>
            イメージから仮想マシンが作成されるときに、さまざまな設定を含む仮想マシンの定義の段階です。
            </summary>
  ...
  <Members>
    <Member MemberName="WithComputerName">
      ...
      <Docs>
        <param name="computerName">コンピューター名です。</param>
        <summary>
    ...
    <Member MemberName="WithCustomData">
      ...
      <Docs>
        <param name="base64EncodedCustomData">カスタム データを Base64 にエンコードされます。</param>
        <summary>
            仮想マシン用のカスタム データを指定します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>定義の次のステージ。</return>
