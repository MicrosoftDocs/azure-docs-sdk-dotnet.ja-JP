<Type Name="ITableData" FullName="Microsoft.Azure.Mobile.Server.Tables.ITableData">
  ...
  <Docs>
    <summary>
            <see cref="T:Microsoft.Azure.Mobile.Server.Tables.ITableData" />特定のテーブルのデータ モデルのシステム プロパティをクライアントと通信するときにシリアル化する方法を示す抽象化を提供します。 システムのプロパティのシリアル化の uniform こと、クライアントは処理システム プロパティ一様プラットフォーム間でことを確認します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Deleted">
      ...
      <Docs>
        <summary>
            取得またはエンティティが削除されたかどうかを示す値を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            取得またはエンティティが更新されるたびに更新される一意のバージョン識別子を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
