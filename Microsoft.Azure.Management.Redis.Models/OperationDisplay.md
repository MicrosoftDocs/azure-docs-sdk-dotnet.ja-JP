<Type Name="OperationDisplay" FullName="Microsoft.Azure.Management.Redis.Models.OperationDisplay">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provider">リソース プロバイダーのフレンドリ名</param>
        <param name="operation">操作の種類: 読み取り、書き込み、削除、listKeys/アクションなどです。</param>
        <param name="resource">操作が実行されるリソースの種類。</param>
        <param name="description">操作のフレンドリ名</param>
        <summary>
            OperationDisplay クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Operation">
      ...
      <Docs>
        <summary>
            取得または設定操作の種類: 読み取り、書き込み、削除、listKeys/アクションなどです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
