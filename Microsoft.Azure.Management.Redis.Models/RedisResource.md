<Type Name="RedisResource" FullName="Microsoft.Azure.Management.Redis.Models.RedisResource">
  ...
  <Docs>
    <summary>
            リストまたは Get 操作で 1 つの Redis アイテムです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RedisResource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="redisVersion">Redis バージョン。</param>
        <param name="provisioningState">インスタンスのプロビジョニングの状態、redis します。</param>
        <param name="hostName">ホスト名を redis します。</param>
        <param name="port">非 SSL ポートを redis します。</param>
        <param name="sslPort">SSL ポートを redis します。</param>
        <param name="accessKeys">未設定の場合、このオブジェクトは作成または更新プログラムへの応答ではありません - Redis cache のキーの redis キャッシュ</param>
        <param name="linkedServers">キャッシュに関連付けられているリンク サーバーの一覧</param>
    ...
    <Member MemberName="AccessKeys">
      ...
      <Docs>
        <summary>
            このオブジェクトがない場合、応答の作成や更新 redis キャッシュを設定できません - Redis cache のキーを取得します。
            </summary>
    ...
    <Member MemberName="LinkedServers">
      ...
      <Docs>
        <summary>
            キャッシュに関連付けられているリンク サーバーの一覧を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            取得は redis インスタンスのプロビジョニングの状態です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
