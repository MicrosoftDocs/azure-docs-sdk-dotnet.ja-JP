<Type Name="MonitorConfig" FullName="Microsoft.Azure.Management.TrafficManager.Models.MonitorConfig">
  ...
  <Docs>
    <summary>
            エンドポイントの Traffic Manager プロファイルの設定の監視を含むクラスです。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="profileMonitorStatus">取得または Traffic Manager プロファイルのプロファイル レベルの監視状態を設定します。</param>
        <param name="protocol">取得またはエンドポイントの正常性のプローブに使用するプロトコル (HTTP、HTTPS または TCP) を設定します。</param>
        <param name="port">取得またはエンドポイントの正常性のプローブに使用する TCP ポートを設定します。</param>
        <param name="path">取得またはエンドポイントの正常性のプローブに使用されるエンドポイント ドメイン名の相対パスを設定します。</param>
        <param name="intervalInSeconds">取得または、このプロファイルでエンドポイントのモニターの間隔を設定します。 これは、Traffic Manager がこのプロファイル内の各エンドポイントの正常性を確認する間隔です。</param>
        <param name="timeoutInSeconds">取得または、このプロファイルでエンドポイントの監視のタイムアウトを設定します。 これは、Traffic Manager でヘルス チェックに応答するには、このプロファイルにエンドポイントが許容される時間です。</param>
        <param name="toleratedNumberOfFailures">取得または Traffic Manager は、次の正常性チェックが失敗した後、このプロファイルの"degraded"のエンドポイントを宣言する前に許容できる連続した正常性チェックの数を設定します。</param>
        <summary>
            MonitorConfig クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IntervalInSeconds">
      ...
      <Docs>
        <summary>
            取得または、このプロファイルでエンドポイントのモニターの間隔を設定します。
            これは、Traffic Manager がこのプロファイル内の各エンドポイントの正常性を確認する間隔です。
            </summary>
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
            取得またはエンドポイントの正常性のプローブに使用されるエンドポイント ドメイン名の相対パスを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            取得またはエンドポイントの正常性のプローブに使用する TCP ポートを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProfileMonitorStatus">
      ...
      <Docs>
        <summary>
            取得または Traffic Manager プロファイルのプロファイル レベルの監視状態を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Protocol">
      ...
      <Docs>
        <summary>
            取得またはエンドポイントの正常性のプローブに使用するプロトコル (HTTP、HTTPS または TCP) を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeoutInSeconds">
      ...
      <Docs>
        <summary>
            取得または、このプロファイルでエンドポイントの監視のタイムアウトを設定します。
            これは、Traffic Manager でヘルス チェックに応答するには、このプロファイルにエンドポイントが許容される時間です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ToleratedNumberOfFailures">
      ...
      <Docs>
        <summary>
            取得または Traffic Manager は、次の正常性チェックが失敗した後、このプロファイルの"degraded"のエンドポイントを宣言する前に許容できる連続した正常性チェックの数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
