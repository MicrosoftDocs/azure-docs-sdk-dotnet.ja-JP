<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Redis.Fluent.RedisCache.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="917ed-101">リソース グループを設定できるように Redis Cache の定義。</span><span class="sxs-lookup"><span data-stu-id="917ed-101">A Redis Cache definition allowing resource group to be set.</span></span>
            </summary>
