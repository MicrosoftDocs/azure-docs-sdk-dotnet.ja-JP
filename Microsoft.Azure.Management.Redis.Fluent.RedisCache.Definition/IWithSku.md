<Type Name="IWithSku" FullName="Microsoft.Azure.Management.Redis.Fluent.RedisCache.Definition.IWithSku">
  ...
  <Docs>
    <summary>
            設定される sku を許可する Redis Cache の定義。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="WithBasicSku">
      ...
      <Docs>
        <param name="capacity">Basic sku ファミリで C は (0、1、2、3、4、5、6) を展開する Redis キャッシュのサイズを指定します。</param>
        <summary>
            Redis Cache の基本的な sku を指定します。
            </summary>
        <returns>To be added.</returns>
    ...
    <Member MemberName="WithPremiumSku">
      ...
      <Docs>
        <param name="capacity">P ファミリ (1、2、3、4) と標準的な sku を展開する Redis キャッシュのサイズを指定します。</param>
        <summary>
            Redis Cache の Premium sku を指定します。
            </summary>
        <returns>To be added.</returns>
    ...
    <Member MemberName="WithStandardSku">
      ...
      <Docs>
        <param name="capacity">C ファミリ (0、1、2、3、4、5、6) と標準的な sku を展開する Redis キャッシュのサイズを指定します。</param>
        <summary>
            Redis Cache の標準的な sku を指定します。
            </summary>
        <returns>To be added.</returns>
