<Type Name="OperationContext" FullName="Microsoft.ApplicationInsights.Extensibility.Implementation.OperationContext">
  ...
  <Docs>
    <summary>
            操作に関する情報をカプセル化します。 操作は通常、ユーザーの操作から開始するエンド ツー エンド シナリオを反映して (例: ボタンをクリック)。  
            </summary>
  ...
  <Members>
    <Member MemberName="CorrelationVector">
      ...
      <Docs>
        <summary>
            取得または現在の製品利用統計情報アイテムの相関関係ベクターを設定します。
            </summary>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            取得または最上位の操作をアプリケーションで定義された操作 ID を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得または設定、アプリケーションで定義された最上位操作の名前。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SyntheticSource">
      ...
      <Docs>
        <summary>
            取得または SyntheticSource アプリケーション定義の操作を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
