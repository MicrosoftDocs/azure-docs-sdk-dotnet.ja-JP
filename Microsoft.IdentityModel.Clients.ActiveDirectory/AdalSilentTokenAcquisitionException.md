<Type Name="AdalSilentTokenAcquisitionException" FullName="Microsoft.IdentityModel.Clients.ActiveDirectory.AdalSilentTokenAcquisitionException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c0506-101">例外の種類がトークンをサイレントに取得できない場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="c0506-101">The exception type thrown when a token cannot be acquired silently.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
             <span data-ttu-id="c0506-102">Exception クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c0506-102">Initializes a new instance of the exception class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
