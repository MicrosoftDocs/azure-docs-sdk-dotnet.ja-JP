<Type Name="SrvRecord" FullName="Microsoft.Azure.Management.Dns.Fluent.Models.SrvRecord">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="priority">この SRV レコードの優先度の値。</param>
        <param name="weight">この SRV レコードの重みの値です。</param>
        <param name="port">この SRV レコードのポートの値。</param>
        <param name="target">この SRV レコードのターゲットのドメイン名。</param>
        <summary>
            SrvRecord クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Target">
      ...
      <Docs>
        <summary>
            取得またはこの SRV レコードの対象のドメイン名を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
