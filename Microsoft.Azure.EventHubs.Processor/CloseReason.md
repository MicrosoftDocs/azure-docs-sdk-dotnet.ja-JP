<Type Name="CloseReason" FullName="Microsoft.Azure.EventHubs.Processor.CloseReason">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e7edd-101">終了の理由、<see cref="T:Microsoft.Azure.EventHubs.Processor.EventProcessorHost" />です。</span><span class="sxs-lookup"><span data-stu-id="e7edd-101">Reason for closing an <see cref="T:Microsoft.Azure.EventHubs.Processor.EventProcessorHost" />.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="LeaseLost">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7edd-102">リースが失われたか、新しいプロセッサ インスタンスに移行します。</span><span class="sxs-lookup"><span data-stu-id="e7edd-102">The lease was lost or transitioned to a new processor instance.</span></span> 
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Shutdown">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e7edd-103"><see cref="T:Microsoft.Azure.EventHubs.Processor.EventProcessorHost" />シャット ダウンされました。</span><span class="sxs-lookup"><span data-stu-id="e7edd-103">The <see cref="T:Microsoft.Azure.EventHubs.Processor.EventProcessorHost" /> was shutdown.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
