<Type Name="PartitionContext" FullName="Microsoft.Azure.EventHubs.Processor.PartitionContext">
  ...
  <Docs>
    <summary>
            によって使用されるイベント ハブ パーティションに関連する情報をカプセル化<see cref="T:Microsoft.Azure.EventHubs.Processor.IEventProcessor" />です。
            </summary>
  ...
  <Members>
    <Member MemberName="CheckpointAsync">
      ...
      <Docs>
        <summary>
            チェックポイント マネージャーを使用してチェックポイント ストアに、現在のオフセットと sequenceNumber を書き込みます。
            </summary>
    ...
    <Member MemberName="CheckpointAsync">
      ...
      <Docs>
        <param name="eventData">有効なオフセットと sequenceNumber 受信 EventData</param>
        <summary>
            オフセットと指定された受信 EventData インスタンスから sequenceNumber を保存し、チェックポイント マネージャーを使用してチェックポイント ストアにこれらの値を書き込みます。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentNullException">指定の eventData が null の場合</exception>
        <exception cref="T:System.ArgumentOutOfRangeException">場合、sequenceNumber は最後のチェックポイントが設定された値より小さい</exception>
      </Docs>
    </Member>
    ...
    <Member MemberName="RuntimeInformation">
      ...
      <Docs>
        <summary>
            ...
            設定を有効にするを参照してください。<see cref="P:Microsoft.Azure.EventHubs.Processor.EventProcessorOptions.EnableReceiverRuntimeMetric" /></summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
            次の format:"PartitionContext({EventHubPath}/{ConsumerGroupName}/{PartitionId}/{SequenceNumber}) でパーティション コンテキストを提供します"
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
