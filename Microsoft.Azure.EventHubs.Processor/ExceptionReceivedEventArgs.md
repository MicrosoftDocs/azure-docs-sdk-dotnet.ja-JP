<Type Name="ExceptionReceivedEventArgs" FullName="Microsoft.Azure.EventHubs.Processor.ExceptionReceivedEventArgs">
  ...
  <Docs>
    <summary>
            <see cref="M:Microsoft.Azure.EventHubs.Processor.EventProcessorOptions.NotifyOfException(System.String,System.String,System.Exception,System.String)" /> イベントのデータを提供します。
            </summary>
  ...
  <Members>
    <Member MemberName="Action">
      ...
      <Docs>
        <summary>
            どのような一般的なアクティビティが例外をスローしたかを示す短い文字列。
            使用可能な値の一覧については、EventProcessorHostActionString を参照してください。
            </summary>
    ...
    <Member MemberName="Hostname">
      ...
      <Docs>
        <summary>
            により、複数のホストの 1 つのプロセスでエラーの発生元を区別できます。
            </summary>
        <value>例外が発生したため、ホストの名前。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PartitionId">
      ...
      <Docs>
        ...
        <value>例外が発生したため、パーティション id です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
