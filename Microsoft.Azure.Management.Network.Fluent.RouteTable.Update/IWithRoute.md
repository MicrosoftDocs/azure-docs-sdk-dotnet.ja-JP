<Type Name="IWithRoute" FullName="Microsoft.Azure.Management.Network.Fluent.RouteTable.Update.IWithRoute">
  ...
  <Docs>
    <summary>
            追加するに許可するルート テーブル定義のステージを削除またはルートを変更します。
            </summary>
  ...
  <Members>
    <Member MemberName="DefineRoute">
      ...
      <Docs>
        ...
        <summary>
            ...
            定義は、Route.UpdateDefinitionStages.WithAttach.attach() への呼び出しで完了する必要があります。
            </summary>
    ...
    <Member MemberName="UpdateRoute">
      ...
      <Docs>
        <param name="name">既存のルートの名前。</param>
        <summary>
            このルート テーブルに対する既存のルートの更新を開始します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="WithoutRoute">
      ...
      <Docs>
        <param name="name">このルート テーブルに対する既存のルートの名前。</param>
        <summary>
