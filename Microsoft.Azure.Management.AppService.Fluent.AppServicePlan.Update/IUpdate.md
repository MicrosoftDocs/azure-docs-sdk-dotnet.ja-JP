<Type Name="IUpdate" FullName="Microsoft.Azure.Management.AppService.Fluent.AppServicePlan.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f6ca7-101">変更可能なすべての設定を含む、サイトの更新操作のテンプレートです。</span><span class="sxs-lookup"><span data-stu-id="f6ca7-101">The template for a site update operation, containing all the settings that can be modified.</span></span>
            </summary>
