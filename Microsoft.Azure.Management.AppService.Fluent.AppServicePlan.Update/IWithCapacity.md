<Type Name="IWithCapacity" FullName="Microsoft.Azure.Management.AppService.Fluent.AppServicePlan.Update.IWithCapacity">
  ...
  <Docs>
    <summary>
            設定するインスタンスの容量を許可するアプリ サービスの計画定義します。
            </summary>
  ...
  <Members>
    <Member MemberName="WithCapacity">
      ...
      <Docs>
        <param name="capacity">インスタンスの最大数。</param>
        <summary>
            この app service プランの実行中のインスタンスの最大数を指定します。
            </summary>
