<Type Name="EventHubEventSubscriptionDestination" FullName="Microsoft.Azure.Management.EventGrid.Models.EventHubEventSubscriptionDestination">
  ...
  <Docs>
    <summary>
            イベント サブスクリプションのイベント ハブ転送先に関する情報
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resourceId">イベント サブスクリプションの Event Hub の変換先のエンドポイントを表す Azure リソースの Id。</param>
        <summary>
            EventHubEventSubscriptionDestination クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ResourceId">
      ...
      <Docs>
        <summary>
            取得または設定のイベント サブスクリプション、Event Hub の変換先のエンドポイントを表します。 Azure リソースの Id。
            </summary>
