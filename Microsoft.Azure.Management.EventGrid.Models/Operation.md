  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="display">操作の表示名</param>
        <param name="origin">操作の原点です。 使用可能な値が含まれます: 'User'、'System'、'UserAndSystem'</param>
        <param name="properties">操作のプロパティ</param>
        <summary>
            Operation クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Origin">
      ...
      <Docs>
        <summary>
            取得または操作の原点を設定します。 使用可能な値が含まれます: 'User'、'System'、'UserAndSystem'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
