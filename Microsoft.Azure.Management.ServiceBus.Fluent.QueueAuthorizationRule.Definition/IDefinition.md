<Type Name="IDefinition" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.QueueAuthorizationRule.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1f3ce-101">キューの承認規則の定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="1f3ce-101">The entirety of the queue authorization rule definition.</span></span>
            </summary>
