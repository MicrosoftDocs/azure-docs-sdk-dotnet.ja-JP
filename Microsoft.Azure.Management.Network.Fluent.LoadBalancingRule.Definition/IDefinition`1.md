<Type Name="IDefinition&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.Definition.IDefinition&lt;ReturnT&gt;">
  ...
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="4efe6-101">最終的な DefinitionStages.WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="4efe6-101">The return type of the final  DefinitionStages.WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="4efe6-102">負荷分散のルールの定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="4efe6-102">The entirety of a load balancing rule definition.</span></span>
            </summary>
