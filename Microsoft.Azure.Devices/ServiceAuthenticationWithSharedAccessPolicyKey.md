<Type Name="ServiceAuthenticationWithSharedAccessPolicyKey" FullName="Microsoft.Azure.Devices.ServiceAuthenticationWithSharedAccessPolicyKey">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cee3a-101">共有アクセス ポリシー キーを使用する認証方法です。</span><span class="sxs-lookup"><span data-stu-id="cee3a-101">Authentication method that uses a shared access policy key.</span></span> 
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="policyName"><span data-ttu-id="cee3a-102">使用する共有アクセス ポリシーの名前です。</span><span class="sxs-lookup"><span data-stu-id="cee3a-102">Name of the shared access policy to use.</span></span></param>
        <param name="key"><span data-ttu-id="cee3a-103">共有アクセス ポリシーに関連付けられたキー。</span><span class="sxs-lookup"><span data-stu-id="cee3a-103">Key associated with the shared access policy.</span></span></param>
        <summary>
            <span data-ttu-id="cee3a-104"><see cref="T:Microsoft.Azure.Devices.ServiceAuthenticationWithSharedAccessPolicyKey" /> クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="cee3a-104">Initializes a new instance of the <see cref="T:Microsoft.Azure.Devices.ServiceAuthenticationWithSharedAccessPolicyKey" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
