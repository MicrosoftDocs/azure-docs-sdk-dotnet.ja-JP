<Type Name="IAuthenticationMethod" FullName="Microsoft.Azure.Devices.IAuthenticationMethod">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7e7d0-101">Iot Hub の通信に使用する認証のインターフェイスです。</span><span class="sxs-lookup"><span data-stu-id="7e7d0-101">Authentication interface to use for IoTHub communications.</span></span>
            </summary>
