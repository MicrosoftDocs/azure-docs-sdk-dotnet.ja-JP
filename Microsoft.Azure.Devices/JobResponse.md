<Type Name="JobResponse" FullName="Microsoft.Azure.Devices.JobResponse">
  ...
  <Members>
    ...
    <Member MemberName="DeviceId">
      ...
      <Docs>
        <summary>
            この応答に関連する deviceId です。
            (例: 親オーケストレーション) の場合は null になります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
