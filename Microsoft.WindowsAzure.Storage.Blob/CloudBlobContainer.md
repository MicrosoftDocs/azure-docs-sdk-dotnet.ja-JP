<Type Name="CloudBlobContainer" FullName="Microsoft.WindowsAzure.Storage.Blob.CloudBlobContainer">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="containerAddress">A<see cref="T:System.Uri" />コンテナーへの絶対 URI を指定するオブジェクト。</param>
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.Blob.CloudBlobContainer" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BeginCreate">
      ...
      <Docs>
        <param name="accessType"><see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContainerPublicAccessType" />コンテナー内のデータをパブリックにアクセスすることがあるかどうかと、許可されるには、どのアクセス レベルを指定するオブジェクト。</param>
        <param name="options">A<see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobRequestOptions" />要求の追加のオプションを指定するオブジェクト。</param>
        <param name="operationContext"><see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" />を現在の操作コンテキストを表すオブジェクト。</param>
        <param name="callback"><see cref="T:System.AsyncCallback" />非同期操作が完了したら、通知を受信するデリゲート。</param>
        <param name="state">コールバック デリゲートに渡されるユーザー定義のオブジェクト。</param>
        <summary>
            コンテナーを作成し、コンテナーのデータへのアクセスのレベルを指定する非同期操作を開始します。
            </summary>
        <returns><see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" />非同期操作を参照します。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginCreateIfNotExists">
      ...
      <Docs>
        ...
        <param name="state">コールバック デリゲートに渡されるユーザー定義のオブジェクト。</param>
        <summary>
            既に存在しない場合、コンテナーを作成する非同期要求を開始します。
            </summary>
        <returns><see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" />非同期操作を参照します。</returns>
    ...
    <Member MemberName="BeginDeleteIfExists">
      ...
      <Docs>
        ...
        <param name="state">コールバック デリゲートに渡されるユーザー定義のオブジェクト。</param>
        <summary>
            既に存在する場合は、コンテナーを削除する非同期要求を開始します。
            </summary>
        <returns><see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" />非同期操作を参照します。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginExists">
      ...
      <Docs>
        ...
        <param name="state">コールバック デリゲートに渡されるユーザー定義のオブジェクト。</param>
        <summary>
            コンテナーが存在するかどうかを確認する非同期要求を開始します。
            </summary>
        <returns><see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" />非同期操作を参照します。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginGetBlobReferenceFromServer">
      ...
      <Docs>
        ...
        <param name="state">コールバック デリゲートに渡されるユーザー定義のオブジェクト。</param>
        <summary>
            このコンテナーに blob への参照を取得する非同期操作を開始します。
            </summary>
        <returns><see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" />非同期操作を参照します。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginGetPermissions">
      ...
      <Docs>
        ...
        <param name="state">コールバック デリゲートに渡されるユーザー定義のオブジェクト。</param>
        <summary>
            コンテナーのアクセス許可の設定を取得する非同期の要求を開始します。
            </summary>
        <returns><see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" />非同期操作を参照します。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginSetMetadata">
      ...
      <Docs>
        ...
        <param name="state">コールバック デリゲートに渡されるユーザー定義のオブジェクト。</param>
        <summary>
            ユーザー定義メタデータをコンテナーに設定する非同期操作を開始します。
            </summary>
        <returns><see cref="T:Microsoft.WindowsAzure.Storage.ICancellableAsyncResult" />非同期操作を参照します。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginSetPermissions">
      ...
      <Docs>
        <param name="permissions">コンテナーに適用するアクセス許可。</param>
        <param name="callback"><see cref="T:System.AsyncCallback" />非同期操作が完了したら、通知を受信するデリゲート。</param>
        <param name="state">コールバック デリゲートに渡されるユーザー定義のオブジェクト。</param>
        <summary>
    ...
    <Member MemberName="BreakLeaseAsync">
      ...
      <Docs>
        <param name="breakPeriod">A<see cref="T:System.TimeSpan" />秒に切り捨てを維持するには、リースを許可する時間の時間を表すです。 場合<c>null</c>、中断期間は、現在のリースまたは 0 に無限リースの残りの部分です。</param>
        <summary>
            このコンテナーで、現在のリースを中断する非同期操作を開始します。
            </summary>
        <returns>非同期操作を表す <see cref="T:System.Threading.Tasks.Task`1" /> オブジェクト。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Create">
      ...
      <Docs>
        ...
        <param name="operationContext"><see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" />を現在の操作コンテキストを表すオブジェクト。</param>
        <summary>
            コンテナーが作成され、コンテナーのデータへのアクセスのレベルを指定します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="CreateIfNotExists">
      ...
      <Docs>
        ...
        <param name="operationContext"><see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" />を現在の操作コンテキストを表すオブジェクト。</param>
        <summary>
            既に存在しない場合は、コンテナーを作成します。
            </summary>
        <returns>
          <c>true</c>いて、コンテナーがまだ存在せず作成されたそれ以外の<c>false</c>です。</returns>
        <remarks>この API は、作成または書き込みアクセス許可が必要です。</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreateIfNotExists">
      ...
      <Docs>
        ...
        <param name="operationContext"><see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" />を現在の操作コンテキストを表すオブジェクト。</param>
        <summary>
            コンテナーまたは blob がパブリックにアクセスできるかどうかを指定してが存在しない場合は、コンテナーを作成します。
            </summary>
        <returns>
          <c>true</c>いて、コンテナーがまだ存在せず作成されたそれ以外の<c>false</c>です。</returns>
        <remarks>この API は、作成または書き込みアクセス許可が必要です。</remarks>
    ...
    <Member MemberName="CreateIfNotExistsAsync">
      ...
      <Docs>
        <summary>
            既に存在しない場合は、コンテナーを作成する非同期操作を開始します。
            </summary>
        <returns>非同期操作を表す <see cref="T:System.Threading.Tasks.Task`1" /> オブジェクト。</returns>
        <remarks>この API は、作成または書き込みアクセス許可が必要です。</remarks>
      </Docs>
    ...
    <Member MemberName="DeleteIfExistsAsync">
      ...
      <Docs>
        <summary>
            既に存在する場合は、コンテナーを削除する非同期操作を開始します。
            </summary>
        <returns>非同期操作を表す <see cref="T:System.Threading.Tasks.Task`1" /> オブジェクト。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EndCreateIfNotExists">
      ...
      <Docs>
        <param name="asyncResult"><see cref="T:System.IAsyncResult" />保留中の非同期操作を参照します。</param>
        <summary>
            既に存在しない場合、コンテナーを作成する非同期の要求の結果を返します。
            </summary>
        <returns>
          <c>true</c>場合、コンテナーがまだ存在せず作成された、それ以外の<c>false</c>です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="EndDeleteIfExists">
      ...
      <Docs>
        <param name="asyncResult"><see cref="T:System.IAsyncResult" />保留中の非同期操作を参照します。</param>
        <summary>
            既に存在する場合は、コンテナーを削除する非同期の要求の結果を返します。
            </summary>
        <returns>
          <c>true</c>場合、コンテナーがまだ存在せず作成された、それ以外の<c>false</c>です。</returns>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EndExists">
      ...
      <Docs>
        <param name="asyncResult"><see cref="T:System.IAsyncResult" />保留中の非同期操作を参照します。</param>
        <summary>
            コンテナーが存在するかどうかを確認する要求の非同期の結果を返します。
            </summary>
        <returns>
          <c>true</c>コンテナーが存在する場合。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="EndGetBlobReferenceFromServer">
      ...
      <Docs>
        <param name="asyncResult"><see cref="T:System.IAsyncResult" />保留中の非同期操作を参照します。</param>
        <summary>
            このコンテナーに blob への参照を取得する非同期操作を終了します。
            </summary>
        <returns>Blob への参照。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EndGetPermissions">
      ...
      <Docs>
        <param name="asyncResult"><see cref="T:System.IAsyncResult" />保留中の非同期操作を参照します。</param>
        <summary>
            コンテナーのアクセス許可の設定を取得する要求の非同期の結果を返します。
            </summary>
        <returns>コンテナーのアクセス許可。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EndListBlobsSegmented">
      ...
      <Docs>
        ...
        <returns>実装するオブジェクトを含む結果セグメント<see cref="T:Microsoft.WindowsAzure.Storage.Blob.IListBlobItem" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="EndSetMetadata">
      ...
      <Docs>
        <param name="asyncResult"><see cref="T:System.IAsyncResult" />保留中の非同期操作を参照します。</param>
        <summary>
            コンテナー上のユーザー定義メタデータを設定するための非同期要求操作を終了します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EndSetPermissions">
      ...
      <Docs>
        <param name="asyncResult"><see cref="T:System.IAsyncResult" />保留中の非同期操作を参照します。</param>
        <summary>
            コンテナーのアクセス許可を設定する非同期の要求の結果を返します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="GetAppendBlobReference">
      ...
      <Docs>
        <param name="blobName">追加 blob の名前を含む文字列。</param>
        <summary>
            このコンテナー内には、追加 blob への参照を取得します。
            </summary>
    ...
    <Member MemberName="GetBlockBlobReference">
      ...
      <Docs>
        <param name="blobName">ブロック blob の名前を含む文字列。</param>
        <summary>
            このコンテナーにブロック blob への参照を取得します。
            </summary>
    ...
    <Member MemberName="GetDirectoryReference">
      ...
      <Docs>
        <param name="relativeAddress">仮想 blob ディレクトリの名前を含む文字列。</param>
        <summary>
    ...
    <Member MemberName="GetPageBlobReference">
      ...
      <Docs>
        <param name="blobName">ページ blob の名前を含む文字列。</param>
        <summary>
    ...
    <Member MemberName="GetPermissionsAsync">
      ...
      <Docs>
        <summary>
            コンテナーのアクセス許可の設定を取得する非同期操作を開始します。
            </summary>
        <returns>非同期操作を表す <see cref="T:System.Threading.Tasks.Task`1" /> オブジェクト。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetSharedAccessSignature">
      ...
      <Docs>
        <param name="policy">A<see cref="T:Microsoft.WindowsAzure.Storage.Blob.SharedAccessBlobPolicy" />共有アクセス署名のアクセス ポリシーを指定するオブジェクト。</param>
        <param name="groupPolicyIdentifier">コンテナー レベルのアクセス ポリシー。</param>
        <summary>
            コンテナーの共有アクセス署名を返します。
            </summary>
        <returns>URI クエリ文字列としての共有アクセス署名します。</returns>
    ...
    <Member MemberName="ListBlobs">
      ...
      <Docs>
        ...
        <param name="operationContext"><see cref="T:Microsoft.WindowsAzure.Storage.OperationContext" />を現在の操作コンテキストを表すオブジェクト。</param>
        <summary>
            遅延を取得したコンテナー内の blob の列挙可能なコレクションを返します。
            </summary>
    ...
    <Member MemberName="Metadata">
      ...
      <Docs>
        ...
        <value><see cref="T:System.Collections.Generic.IDictionary`2" />コンテナーのメタデータを含むオブジェクト。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        ...
        <value><see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContainerProperties" /> オブジェクト。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="StorageUri">
      ...
      <Docs>
        ...
        <value>型のオブジェクト<see cref="P:Microsoft.WindowsAzure.Storage.Blob.CloudBlobContainer.StorageUri" />コンテナーの Uri は、プライマリとセカンダリの両方の場所を格納します。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Uri">
      ...
      <Docs>
        ...
        <value>A<see cref="T:System.Uri" />プライマリの場所にコンテナーへの絶対 URI を指定します。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
