<Type Name="BlobContinuationToken" FullName="Microsoft.WindowsAzure.Storage.Blob.BlobContinuationToken">
  ...
  <Docs>
    ...
    <remarks>
      <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContinuationToken" />継続トークンを返すメソッドで使用されます、<see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobResultSegment" />などのオブジェクト<see cref="M:Microsoft.WindowsAzure.Storage.Blob.CloudBlobDirectory.ListBlobsSegmented(Microsoft.WindowsAzure.Storage.Blob.BlobContinuationToken)" />です。</remarks>
  </Docs>
  <Members>
    ...
    <Member MemberName="NextMarker">
      ...
      <Docs>
        <summary>
            取得または設定の結果を継続するための次のマーカー<see cref="T:Microsoft.WindowsAzure.Storage.Blob.ICloudBlob" />列挙操作します。
            </summary>
