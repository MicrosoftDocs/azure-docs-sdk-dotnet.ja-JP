<Type Name="BlobListingDetails" FullName="Microsoft.WindowsAzure.Storage.Blob.BlobListingDetails">
  ...
  <Docs>
    <summary>
            一連の blob を一覧表示するときに含める項目を指定します。
            </summary>
  ...
  <Members>
    <Member MemberName="All">
      ...
      <Docs>
        <summary>
            すべての利用可能なコミットされた blob、コミットされていない blob、およびスナップショットを一覧表示し、それらの blob に対するすべてのメタデータとコピー状態を返します。
            </summary>
      </Docs>
    </Member>
    ...
    <Member MemberName="Metadata">
      ...
      <Docs>
        <summary>
            リストで、各 blob の blob メタデータの取得が返されます。
            </summary>
      </Docs>
    </Member>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
            コミットされた blob のみを一覧表示し、blob のメタデータは返されません。
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Snapshots">
      ...
      <Docs>
        <summary>
            コミットされた blob を一覧表示して、blob のスナップショットです。
            </summary>
      </Docs>
    </Member>
