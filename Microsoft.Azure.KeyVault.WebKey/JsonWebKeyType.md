<Type Name="JsonWebKeyType" FullName="Microsoft.Azure.KeyVault.WebKey.JsonWebKeyType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="085d8-101">サポートされている JsonWebKey キー型 (kty)</span><span class="sxs-lookup"><span data-stu-id="085d8-101">Supported JsonWebKey key types (kty)</span></span>
            </summary>
