<Type Name="IWithCreate" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a818c-101">仮想マシンのスケールのステージは、セットの定義を作成するリソースのすべての必須入力を格納しているが、指定する省略可能なその他の設定も行うことをがします。</span><span class="sxs-lookup"><span data-stu-id="a818c-101">The stage of a virtual machine scale set definition containing all the required inputs for the resource to be created, but also allowing for any other optional settings to be specified.</span></span>
            </summary>
