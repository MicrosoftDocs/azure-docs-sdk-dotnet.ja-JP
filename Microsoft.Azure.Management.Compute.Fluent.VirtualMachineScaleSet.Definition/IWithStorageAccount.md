<Type Name="IWithStorageAccount" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithStorageAccount">
  ...
  <Docs>
    <summary>
            仮想マシンのスケールのステージでは、定義がストレージ アカウントを指定する許可を設定します。
            </summary>
  ...
  <Members>
    <Member MemberName="WithExistingStorageAccount">
      ...
      <Docs>
        ...
        <summary>
            スケール セット内の仮想マシンの Vhd は OS とデータ ディスクの既存のストレージ アカウントを指定します。
            </summary>
    ...
    <Member MemberName="WithNewStorageAccount">
      ...
      <Docs>
        <param name="creatable">作成可能なステージでストレージ アカウントの定義。</param>
        <summary>
            スケール セット内の仮想マシンの Vhd は OS とデータ ディスクの新規ストレージ アカウントを指定します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>定義に次のステージ。</return>
