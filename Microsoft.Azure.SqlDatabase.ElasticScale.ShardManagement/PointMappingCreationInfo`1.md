<Type Name="PointMappingCreationInfo&lt;TKey&gt;" FullName="Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.PointMappingCreationInfo&lt;TKey&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="TKey">キー (ポイント) の型。</typeparam>
    <summary>
            作成するための引数、<see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.PointMapping`1" />です。
            </summary>
