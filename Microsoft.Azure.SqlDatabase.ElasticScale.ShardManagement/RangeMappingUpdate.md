<Type Name="RangeMappingUpdate" FullName="Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.RangeMappingUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a8334-101">更新の間のマッピングを表す、<see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.Range`1" />値の<see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.Shard" />そのデータを格納します。</span><span class="sxs-lookup"><span data-stu-id="a8334-101">Represents updates to a mapping between a <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.Range`1" /> of values and the <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.Shard" /> that stores its data.</span></span> <span data-ttu-id="a8334-102">参照してください<see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.RangeMapping`1" />です。</span><span class="sxs-lookup"><span data-stu-id="a8334-102">Also see <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.RangeMapping`1" />.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a8334-103">新しい範囲のマッピングの更新プログラム オブジェクトをインスタンス化します。</span><span class="sxs-lookup"><span data-stu-id="a8334-103">Instantiates a new range mapping update object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsBeingTakenOffline">
      ...
      <Docs>
        <param name="originalStatus"><span data-ttu-id="a8334-104">元の状態です。</span><span class="sxs-lookup"><span data-stu-id="a8334-104">Original status.</span></span></param>
        <param name="updatedStatus"><span data-ttu-id="a8334-105">更新された状態です。</span><span class="sxs-lookup"><span data-stu-id="a8334-105">Updated status.</span></span></param>
        <summary>
            <span data-ttu-id="a8334-106">かどうか、現在のマッピングがオフラインになるかを検出します。</span><span class="sxs-lookup"><span data-stu-id="a8334-106">Detects if the current mapping is being taken offline.</span></span>
            </summary>
        <returns><span data-ttu-id="a8334-107">マッピングがオフラインになる場合は、派生型で検出します。</span><span class="sxs-lookup"><span data-stu-id="a8334-107">Detects in the derived types if the mapping is being taken offline.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
