<Type Name="MxRecord" FullName="Microsoft.Azure.Management.Dns.Models.MxRecord">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="preference">この MX レコードの優先順位の値。</param>
        <param name="exchange">この MX レコードのメールのホストのドメイン名。</param>
        <summary>
            MxRecord クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Exchange">
      ...
      <Docs>
        <summary>
            取得またはこの MX レコードのメールのホストのドメイン名を設定します。
            </summary>
