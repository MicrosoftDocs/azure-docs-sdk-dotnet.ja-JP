<Type Name="CaaRecord" FullName="Microsoft.Azure.Management.Dns.Models.CaaRecord">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            CaaRecord クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="flags">この CAA のフラグは、0 から 255 までの整数として記録します。</param>
        <param name="tag">この CAA レコードのタグ。</param>
        <param name="value">この CAA レコードの値です。</param>
        <summary>
            CaaRecord クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Flags">
      ...
      <Docs>
        <summary>
            取得または 0 から 255 までの整数としてこの CAA レコードのフラグを設定します。
            </summary>
