<Type Name="OperationsExtensions" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.OperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="aaa82-101">操作の拡張メソッド。</span><span class="sxs-lookup"><span data-stu-id="aaa82-101">Extension methods for Operations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="List">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="aaa82-102">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="aaa82-102">The operations group for this extension method.</span></span>
            </param>
        <summary>
            <span data-ttu-id="aaa82-103">使用可能な操作の一覧を返します。</span><span class="sxs-lookup"><span data-stu-id="aaa82-103">Returns the list of available operations.</span></span>
            </summary>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="aaa82-104">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="aaa82-104">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="aaa82-105">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="aaa82-105">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="aaa82-106">使用可能な操作の一覧を返します。</span><span class="sxs-lookup"><span data-stu-id="aaa82-106">Returns the list of available operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNext">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="aaa82-107">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="aaa82-107">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="aaa82-108">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="aaa82-108">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <summary>
            <span data-ttu-id="aaa82-109">使用可能な操作の一覧を返します。</span><span class="sxs-lookup"><span data-stu-id="aaa82-109">Returns the list of available operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="aaa82-110">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="aaa82-110">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="aaa82-111">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="aaa82-111">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="aaa82-112">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="aaa82-112">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="aaa82-113">使用可能な操作の一覧を返します。</span><span class="sxs-lookup"><span data-stu-id="aaa82-113">Returns the list of available operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
