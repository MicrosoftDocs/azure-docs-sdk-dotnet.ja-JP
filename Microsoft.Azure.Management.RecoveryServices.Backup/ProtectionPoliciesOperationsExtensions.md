<Type Name="ProtectionPoliciesOperationsExtensions" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.ProtectionPoliciesOperationsExtensions">
  ...
  <Docs>
    <summary>
            ProtectionPoliciesOperations の拡張メソッド。
            </summary>
  ...
  <Members>
    <Member MemberName="CreateOrUpdate">
      ...
      <Docs>
        ...
        <summary>
            作成するか、バックアップ ポリシーを変更します。 これは非同期操作です。
            GetPolicyOperationResult API を使用して、操作の状態を取得できます。
            </summary>
    ...
    <Member MemberName="Delete">
      ...
      <Docs>
        ...
        <summary>
            指定された、Recovery Services コンテナーからのバックアップ ポリシーを削除します。 これは非同期操作です。 GetPolicyOperationResult API を使用して、操作の状態を取得できます。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
