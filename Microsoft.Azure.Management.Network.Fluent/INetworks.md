<Type Name="INetworks" FullName="Microsoft.Azure.Management.Network.Fluent.INetworks">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0d0af-101">Azure で仮想ネットワーク管理 API へのエントリ ポイントです。</span><span class="sxs-lookup"><span data-stu-id="0d0af-101">Entry point to virtual network management API in Azure.</span></span>
            </summary>
