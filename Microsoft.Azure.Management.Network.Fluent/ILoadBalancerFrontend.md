<Type Name="ILoadBalancerFrontend" FullName="Microsoft.Azure.Management.Network.Fluent.ILoadBalancerFrontend">
  ...
  <Docs>
    <summary>
            ロード バランサーのフロント エンドの変更できないクライアント側表現。
            </summary>
    <remarks>
  ...
  <Members>
    <Member MemberName="InboundNatPools">
      ...
      <Docs>
        <summary>
            インデックスの名前をこのフロント エンドを使用する、このロード バランサー上の NAT の受信プールを取得します。
            </summary>
    ...
    <Member MemberName="InboundNatRules">
      ...
      <Docs>
        <summary>
            インデックスの名前をこのフロント エンドを使用する、このロード バランサー上の NAT の受信規則を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsPublic">
      ...
      <Docs>
        <summary>
            True の場合、フロント エンド パブリック、つまりが関連付けられているパブリック IP アドレスを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
