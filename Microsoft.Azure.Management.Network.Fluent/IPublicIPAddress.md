  ...
  <Members>
    ...
    <Member MemberName="GetAssignedLoadBalancerFrontend">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return>ロード バランサー パブリック フロント エンドにこのパブリック IP アドレスが割り当てられています。</return>
      </Docs>
    </Member>
    <Member MemberName="GetAssignedNetworkInterfaceIPConfiguration">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>ネットワーク インターフェイス IP 構成をこのパブリック IP アドレスが割り当てられます。</return>
      </Docs>
    </Member>
    <Member MemberName="HasAssignedLoadBalancer">
      ...
      <Docs>
        <summary>
            このパブリック IP アドレスがロード バランサーに割り当てられている場合は true を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HasAssignedNetworkInterface">
      ...
      <Docs>
        <summary>
            このパブリック IP アドレスがネットワーク インターフェイスに割り当てられている場合は true を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReverseFqdn">
      ...
      <Docs>
        <summary>
            存在する場合は、割り当て済みの逆引き FQDN を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
