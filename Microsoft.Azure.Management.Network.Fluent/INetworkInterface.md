<Type Name="INetworkInterface" FullName="Microsoft.Azure.Management.Network.Fluent.INetworkInterface">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0d5bf-101">ネットワーク インターフェイスです。</span><span class="sxs-lookup"><span data-stu-id="0d5bf-101">Network interface.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="IPConfigurations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d5bf-102">インデックスの名前をこのネットワーク インターフェイスの IP 構成を取得します。</span><span class="sxs-lookup"><span data-stu-id="0d5bf-102">Gets the IP configurations of this network interface, indexed by their names.</span></span>
            </summary>
    ...
    <Member MemberName="PrimaryIPConfiguration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d5bf-103">このネットワーク インターフェイスのプライマリ IP 構成を取得します。</span><span class="sxs-lookup"><span data-stu-id="0d5bf-103">Gets the primary IP configuration of this network interface.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
