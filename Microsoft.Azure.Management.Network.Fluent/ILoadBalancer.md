<Type Name="ILoadBalancer" FullName="Microsoft.Azure.Management.Network.Fluent.ILoadBalancer">
  ...
  <Members>
    <Member MemberName="Backends">
      ...
      <Docs>
        <summary>
            取得負荷を分散するには、このロード バランサーのバックエンド間で、着信トラフィック名でインデックスを作成します。
            </summary>
    ...
    <Member MemberName="Frontends">
      ...
      <Docs>
        <summary>
            着信トラフィックをこのロード バランサーのフロント エンドを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HttpProbes">
      ...
      <Docs>
        <summary>
            このロード バランサーは、名前によってインデックス設定の HTTP プローブを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAddressIds">
      ...
      <Docs>
        <summary>
            このロード バランサーのフロント エンドに割り当てられたパブリック IP アドレスのリソース Id を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TcpProbes">
      ...
      <Docs>
        <summary>
            このロード バランサーは、名前によってインデックス設定の TCP プローブを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
