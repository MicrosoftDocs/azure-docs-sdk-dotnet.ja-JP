<Type Name="IApplicationGatewayFrontend" FullName="Microsoft.Azure.Management.Network.Fluent.IApplicationGatewayFrontend">
  ...
  <Docs>
    <summary>
            アプリケーション ゲートウェイのフロント エンドの変更できないクライアント側表現。
            </summary>
    <remarks>
  ...
  <Members>
    <Member MemberName="GetSubnet">
      ...
      <Docs>
        ...
        <return>関連付けられているサブネットです。</return>
      </Docs>
    </Member>
    <Member MemberName="IsPrivate">
      ...
      <Docs>
        <summary>
            取得 true は、フロント エンド プライベート IP アドレスを使用してアクセスできます。
            </summary>
    ...
    <Member MemberName="IsPublic">
      ...
      <Docs>
        <summary>
            フロント エンドは、パブリック IP アドレス、それ以外の場合は false を使用してアクセスできる場合は true を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
