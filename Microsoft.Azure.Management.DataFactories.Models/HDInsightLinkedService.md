<Type Name="HDInsightLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.HDInsightLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="13fbc-101">HDInsight linkedService のプロパティです。</span><span class="sxs-lookup"><span data-stu-id="13fbc-101">The properties for the HDInsight linkedService.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="13fbc-102">HDInsightBYOCLinkedService クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="13fbc-102">Initializes a new instance of the HDInsightBYOCLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="13fbc-103">必須の引数で HDInsightBYOCLinkedService クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="13fbc-103">Initializes a new instance of the HDInsightBYOCLinkedService class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ClusterUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="13fbc-104">必須。</span><span class="sxs-lookup"><span data-stu-id="13fbc-104">Required.</span></span> <span data-ttu-id="13fbc-105">HDInsight クラスター URI です。</span><span class="sxs-lookup"><span data-stu-id="13fbc-105">HDInsight cluster URI.</span></span>
            </summary>
    ...
    <Member MemberName="HcatalogLinkedServiceName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="13fbc-106">HCatalog データベースを指す Azure SQL のリンクされたサービスの名前。</span><span class="sxs-lookup"><span data-stu-id="13fbc-106">The name of Azure SQL linked service that point to the HCatalog database.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LinkedServiceName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="13fbc-107">省略可能。</span><span class="sxs-lookup"><span data-stu-id="13fbc-107">Optional.</span></span> <span data-ttu-id="13fbc-108">記憶域サービスの名前。</span><span class="sxs-lookup"><span data-stu-id="13fbc-108">Storage service name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="13fbc-109">必須。</span><span class="sxs-lookup"><span data-stu-id="13fbc-109">Required.</span></span> <span data-ttu-id="13fbc-110">HDInsight クラスターのパスワードです。</span><span class="sxs-lookup"><span data-stu-id="13fbc-110">HDInsight cluster password.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SchemaGeneration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="13fbc-111">入力を生成する/変更するために使用するには、どのようなオプションを定義し、HDInsight アクティビティのデータセットを出力</span><span class="sxs-lookup"><span data-stu-id="13fbc-111">Define what options to use for generating/altering an input and output Datasets for an HDInsight activity</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="13fbc-112">必須。</span><span class="sxs-lookup"><span data-stu-id="13fbc-112">Required.</span></span> <span data-ttu-id="13fbc-113">HDInsight クラスターのユーザー名。</span><span class="sxs-lookup"><span data-stu-id="13fbc-113">HDInsight cluster user name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
