<Type Name="OnPremisesCassandraLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.OnPremisesCassandraLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Management.DataFactories.Models.OnPremisesCassandraLinkedService" />の新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.Management.DataFactories.Models.OnPremisesCassandraLinkedService" />必須の引数を持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            必須。 Cassandra データベースへの接続に使用する認証の種類。 基本認証または匿名にする必要があります。 
            </summary>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            必須。 1 つ以上の IP アドレスまたは Cassandra サーバーのホスト名です。
            複数のサーバーに接続する場合は、IP アドレスまたはホスト名のコンマ区切りのリストを指定します。
            各サーバーは、レプリカです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            省略可能。 Cassandra サーバーがクライアント接続をリッスンするように使用する TCP ポート番号。 既定値は、9042 です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
