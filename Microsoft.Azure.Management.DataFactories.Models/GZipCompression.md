<Type Name="GZipCompression" FullName="Microsoft.Azure.Management.DataFactories.Models.GZipCompression">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="666a4-101">テーブルで使用される GZip 圧縮メソッド。</span><span class="sxs-lookup"><span data-stu-id="666a4-101">The GZip compression method used on a table.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="666a4-102"><see cref="T:Microsoft.Azure.Management.DataFactories.Models.CompressionLevel" />のために使用します。</span><span class="sxs-lookup"><span data-stu-id="666a4-102">The <see cref="T:Microsoft.Azure.Management.DataFactories.Models.CompressionLevel" /> used.</span></span>
            </summary>
