<Type Name="OnPremisesOracleLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.OnPremisesOracleLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            OnPremisesOracleLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で OnPremisesOracleLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="DriverType">
      ...
      <Docs>
        <summary>
            省略可能。 内部設置型 Oracle サーバーのドライバーの種類。 Oracle ドライバを使用する ODBC driver for Oracle または"ODP"を使用するには、"Microsoft"を指定します。 指定されていない場合、Oracle ドライバが適用されます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
