<Type Name="OnPremisesOdbcLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.OnPremisesOdbcLinkedService">
  ...
  <Docs>
    <summary>
            オープン データベース コネクティビティ (ODBC) データ ソースのリンクされたサービス。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            必須。 ODBC データ ストアへの接続に使用される認証の種類です。 Anonymous と Basic のいずれかの値になります。
            </summary>
    ...
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            必須。 接続文字列と同様の省略可能な非アクセス資格情報の部分がなど、資格情報を暗号化"ドライバー {Sqlserver} を = です。サーバー = myserver; Database = mydb です。EncryptedCredential myencryptedcredential を ="です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Credential">
      ...
      <Docs>
        <summary>
            省略可能。 例: ドライバー固有のプロパティと値の形式で指定された接続文字列のアクセス資格情報の部分"Uid someusername; を =Pwd = somepassword です。RefreshToken = mytoken;"です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            省略可能。 基本認証または Windows 認証のパスワードです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
