<Type Name="WebTableDataset" FullName="Microsoft.Azure.Management.DataFactories.Models.WebTableDataset">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="72f91-101">Web のテーブルです。</span><span class="sxs-lookup"><span data-stu-id="72f91-101">A web table.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Index">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="72f91-102">Web ページ内のテーブルの 0 から始まるインデックス。</span><span class="sxs-lookup"><span data-stu-id="72f91-102">The zero-based index of the table in the web page.</span></span>
            </summary>
    ...
    <Member MemberName="PartitionedBy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="72f91-103">パスで使用されるパーティションです。</span><span class="sxs-lookup"><span data-stu-id="72f91-103">The partitions to be used by the path.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="72f91-104">リンクされたサービスの URL から web ページへの相対 URL です。</span><span class="sxs-lookup"><span data-stu-id="72f91-104">The relative URL to the web page from the linked service URL.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
