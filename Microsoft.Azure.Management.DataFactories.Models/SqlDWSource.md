<Type Name="SqlDWSource" FullName="Microsoft.Azure.Management.DataFactories.Models.SqlDWSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="141e3-101">コピー アクティビティの SQL データ ウェアハウス ソース。</span><span class="sxs-lookup"><span data-stu-id="141e3-101">A copy activity SQL Data Warehouse source.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="SqlReaderQuery">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="141e3-102">SQL データ ウェアハウスのリーダー クエリです。</span><span class="sxs-lookup"><span data-stu-id="141e3-102">SQL data warehouse reader query.</span></span>
            </summary>
    ...
    <Member MemberName="SqlReaderStoredProcedureName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="141e3-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="141e3-103">Optional.</span></span> <span data-ttu-id="141e3-104">SQL データ ウェアハウス ソースのストアド プロシージャの名前。</span><span class="sxs-lookup"><span data-stu-id="141e3-104">Name of the stored procedure for a SQL Data Warehouse source.</span></span> <span data-ttu-id="141e3-105">これは、SqlReaderQuery と同時に使用できません。</span><span class="sxs-lookup"><span data-stu-id="141e3-105">This cannot be used at the same time as SqlReaderQuery.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StoredProcedureParameters">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="141e3-106">省略可能。</span><span class="sxs-lookup"><span data-stu-id="141e3-106">Optional.</span></span> <span data-ttu-id="141e3-107">値および種類のストアド プロシージャのパラメーターを設定します。</span><span class="sxs-lookup"><span data-stu-id="141e3-107">Value and type setting for stored procedure parameters.</span></span> <span data-ttu-id="141e3-108">例:"{Parameter1: {値:「1」、種類:"int"}}"。</span><span class="sxs-lookup"><span data-stu-id="141e3-108">Example: "{Parameter1: {value: "1", type: "int"}}".</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
