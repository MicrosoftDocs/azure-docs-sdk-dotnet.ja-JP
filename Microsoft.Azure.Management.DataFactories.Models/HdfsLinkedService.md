<Type Name="HdfsLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.HdfsLinkedService">
  ...
  <Docs>
    <summary>
            Hadoop 分散ファイル システム (HDFS) のデータ ソースのリンクされたサービス。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            必須。 HDFS への接続に使用される認証の種類です。 有効値は、: 匿名と Windows です。
            </summary>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            必須。 HDFS の URL はサービス エンドポイント、例:"http://myhostname:50070/webhdfs/v1"です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
