<Type Name="DataSliceRun" FullName="Microsoft.Azure.Management.DataFactories.Models.DataSliceRun">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DataSliceRun クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ActivityInputProperties">
      ...
      <Docs>
        <summary>
            省略可能。 アクティビティの入力プロパティがすべてのコンテナー
            </summary>
    ...
    <Member MemberName="ComputeClusterName">
      ...
      <Docs>
        <summary>
            省略可能。 HDInsight クラスターは、実行が処理されました。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="InputRunRecordReferences">
      ...
      <Docs>
        <summary>
            省略可能。 このデータ スライスを実行する入力されたデータ スライス実行の一覧。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OutputRunRecordReferences">
      ...
      <Docs>
        <summary>
            省略可能。 実行のこのデータ スライスを使用するデータ スライスの実行のリストとして入力します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            省略可能。 すべてのプロパティ/に対応するためのコンテナーでは、実行のアクティビティによって生成され、またはその他の同じアクティビティで使用できます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
