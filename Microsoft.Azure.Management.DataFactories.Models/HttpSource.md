<Type Name="HttpSource" FullName="Microsoft.Azure.Management.DataFactories.Models.HttpSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="be0e5-101">HTTP ファイルのコピー活動元。</span><span class="sxs-lookup"><span data-stu-id="be0e5-101">A copy activity source for an HTTP file.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="RequestTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="be0e5-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="be0e5-103">Optional.</span></span> <span data-ttu-id="be0e5-104">HTTP クライアントで、応答を取得するためのタイムアウトを指定します。</span><span class="sxs-lookup"><span data-stu-id="be0e5-104">Specifies the timeout for an HTTP client to get a response.</span></span> 
            </summary>
