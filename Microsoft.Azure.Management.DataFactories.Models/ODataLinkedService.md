<Type Name="ODataLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.ODataLinkedService">
  ...
  <Docs>
    <summary>
            リンクされているデータ プロトコル (OData) サービスを開きます。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Management.DataFactories.Models.ODataLinkedService" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.Management.DataFactories.Models.ODataLinkedService" />必須の引数を持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            必須。 OData サービスへの接続に使用する認証の種類です。 いずれかを指定する必要があります<see cref="T:Microsoft.Azure.Management.DataFactories.Models.ODataAuthenticationType" />です。 
            </summary>
    ...
    <Member MemberName="AuthorizedCredential">
      ...
      <Docs>
        <summary>
            省略可能。 OAuth では、あなたの代理としてのリソースにアクセスする ADF で使用できる資格情報を承認します。 各認証には一意を一度だけ使用することがあります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GatewayName">
      ...
      <Docs>
        <summary>
            省略可能。 Windows 認証の内部設置型ゲートウェイの名前。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
