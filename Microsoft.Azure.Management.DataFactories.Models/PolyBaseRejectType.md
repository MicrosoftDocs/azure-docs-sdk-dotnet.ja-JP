<Type Name="PolyBaseRejectType" FullName="Microsoft.Azure.Management.DataFactories.Models.PolyBaseRejectType">
  ...
  <Docs>
    <summary>
            PolyBase Reject 型です。 プロパティ<see cref="T:Microsoft.Azure.Management.DataFactories.Models.PolyBaseSettings" />です。
            RejectValue がリテラル値またはパーセントとして指定するかどうかを示します。
            </summary>
  ...
  <Members>
    <Member MemberName="Percentage">
      ...
      <Docs>
        <summary>
            PolyBase の設定で RejectValue プロパティがパーセンテージで指定を示します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            PolyBase の設定で RejectValue プロパティは、リテラル値として指定を示します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
