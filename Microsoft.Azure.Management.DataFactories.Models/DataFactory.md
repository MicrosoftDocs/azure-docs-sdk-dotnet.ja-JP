<Type Name="DataFactory" FullName="Microsoft.Azure.Management.DataFactories.Models.DataFactory">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DataFactory クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で DataFactory クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            省略可能。 データ ファクトリのリソース id です。  Id プロパティは、サーバーとクライアント側で読み取り専用で設定します。
            </summary>
