<Type Name="AmazonS3Dataset" FullName="Microsoft.Azure.Management.DataFactories.Models.AmazonS3Dataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AmazonS3Dataset" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.Management.DataFactories.Models.AmazonS3Dataset" />必須の引数を持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Compression">
      ...
      <Docs>
        <summary> 
            Amazon S3 オブジェクトで使用されるデータの圧縮方法。 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
