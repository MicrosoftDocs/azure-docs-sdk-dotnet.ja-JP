<Type Name="FileShareDataset" FullName="Microsoft.Azure.Management.DataFactories.Models.FileShareDataset">
  ...
  <Members>
    ...
    <Member MemberName="UseBinaryTransfer">
      ...
      <Docs>
        <summary>
            省略可能。 リンクされたサービスは、accociated 場合にのみ使用できます<see cref="T:Microsoft.Azure.Management.DataFactories.Models.FtpServerLinkedService" />です。
            True の場合、バイナリ モードでは、FTP サーバーからの送信中にデータ表現です。
            False の場合、FTP サーバーからの送信中にデータ表現は、ASCII モードでです。
            既定値は true です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
