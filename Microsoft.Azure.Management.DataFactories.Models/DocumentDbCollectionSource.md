<Type Name="DocumentDbCollectionSource" FullName="Microsoft.Azure.Management.DataFactories.Models.DocumentDbCollectionSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="82a4e-101">コピー アクティビティのデータベースのコレクションをドキュメント ソース。</span><span class="sxs-lookup"><span data-stu-id="82a4e-101">A copy activity Document Database Collection source.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="NestingSeparator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82a4e-102">入れ子になったプロパティの区切り記号。</span><span class="sxs-lookup"><span data-stu-id="82a4e-102">Nested properties separator.</span></span>
            </summary>
    ...
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="82a4e-103">ドキュメントのクエリ。</span><span class="sxs-lookup"><span data-stu-id="82a4e-103">Document query.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
