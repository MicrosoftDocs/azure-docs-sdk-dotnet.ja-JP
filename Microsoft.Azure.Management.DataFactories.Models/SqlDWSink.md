<Type Name="SqlDWSink" FullName="Microsoft.Azure.Management.DataFactories.Models.SqlDWSink">
  ...
  <Docs>
    <summary>
            コピー アクティビティ SQL データ ウェアハウスのシンク。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で SqlDWSink クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AllowPolyBase">
      ...
      <Docs>
        <summary>
            省略可能。 True の場合は、以下の条件をすべて満たしているときに、SQL データ ウェアハウスにデータをコピーする PolyBase を使用します。
            1. ソースがリンクされているサービスである必要があります<see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureStorageLinkedService" />です。
            2. ソース データセットである必要があります<see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureBlobDataset" />です。
            3. ソース データセットの形式にする必要があります<see cref="T:Microsoft.Azure.Management.DataFactories.Models.TextFormat" />です。
            5. ソース データセットの形式の EncodingName は"utf-8"である必要があります。
            6. ソース データセットの形式の RowDelimiter は"\n"である必要があります。
            7. NullValue のソースのデータセット形式にする必要があります<see cref="F:System.String.Empty" />です。
            8. ソース データセットの圧縮のみをサポート<see cref="T:Microsoft.Azure.Management.DataFactories.Models.GZipCompression" />と<see cref="T:Microsoft.Azure.Management.DataFactories.Models.DeflateCompression" />です。
            9. ソースである必要があります<see cref="T:Microsoft.Azure.Management.DataFactories.Models.BlobSource" />です。
            既定値は false です。
            </summary>
    ...
    <Member MemberName="PolyBaseSettings">
      ...
      <Docs>
        <summary>
            省略可能。 AllowPolyBase が true の場合は、PolyBase 関連の設定を指定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SliceIdentifierColumnName">
      ...
      <Docs>
        <summary>
            省略可能。 べき等なのでコピーをサポートするために、スライスの識別子情報の保存に使用される SQL 列の名前。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
