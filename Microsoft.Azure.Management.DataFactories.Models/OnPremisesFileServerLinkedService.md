<Type Name="OnPremisesFileServerLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.OnPremisesFileServerLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            OnPremisesFileSystemLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で OnPremisesFileSystemLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EncryptedCredential">
      ...
      <Docs>
        <summary>
            省略可能。 暗号化された資格情報をホスト、ユーザー Id とパスワードが含まれています。
            </summary>
