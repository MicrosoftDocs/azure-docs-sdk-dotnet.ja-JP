<Type Name="GatewayConnectionInfo" FullName="Microsoft.Azure.Management.DataFactories.Models.GatewayConnectionInfo">
  ...
  <Docs>
    <summary>
            ゲートウェイの接続情報を取得するためのデータ コントラクト。 読み取り専用と、サービス側では、クライアント側でそのすべてのプロパティ設定されます。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            GatewayConnectionInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
