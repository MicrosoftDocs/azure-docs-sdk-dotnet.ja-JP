<Type Name="SftpLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.SftpLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Management.DataFactories.Models.SftpLinkedService" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.Management.DataFactories.Models.SftpLinkedService" />必須の引数を持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            必須。 SFTP サーバーへの接続に使用する認証の種類。 基本認証または SshPublicKey 必要があります。 
            </summary>
    ...
    <Member MemberName="EncryptedCredential">
      ...
      <Docs>
        <summary>
            省略可能。 基本認証または SshPublicKey 認証の暗号化された資格情報です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HostKeyFingerprint">
      ...
      <Docs>
        <summary>
            省略可能。 ホストは、SFTP サーバーの指紋をキーします。
            SkipHostKeyValidation が false の場合は、HostKeyFingerprint を指定する必要があります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PassPhrase">
      ...
      <Docs>
        <summary>
            省略可能。 SSH 秘密キーが暗号化されている場合、SSH 秘密キーの暗号化を解除するパスワードです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            省略可能。 基本認証用の SFTP サーバーにログオンするパスワードです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            省略可能。 SFTP サーバーがクライアント接続のリッスンに使用する TCP ポート番号。 既定値は 22 です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrivateKeyContent">
      ...
      <Docs>
        <summary>
            省略可能。 SshPublicKey 認証用の SSH プライベートのキー コンテンツを Base64 にエンコードされます。
            SshPublicKey 認証でのコピーを内部設置型、PrivateKeyPath または PrivateKeyContent のいずれかを指定する必要があります。
            SSH 秘密キーは、OpenSSH 形式にする必要があります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrivateKeyPath">
      ...
      <Docs>
        <summary>
            省略可能。 SshPublicKey の認証に SSH 秘密キー ファイルのパス。 内部設置型のコピーに対してのみ有効です。
            SshPublicKey 認証でのコピーを内部設置型、PrivateKeyPath または PrivateKeyContent のいずれかを指定する必要があります。
            SSH 秘密キーは、OpenSSH 形式にする必要があります。
            </summary>
        <value>To be added.</value>
    ...
    <Member MemberName="SkipHostKeyValidation">
      ...
      <Docs>
        <summary>
            省略可能。 True の場合は、SSH ホスト キーの検証をスキップします。 既定値は false です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            省略可能。 SFTP サーバーにログオンするために使用するユーザー名。 EncryptedCredential が null の場合、そのことが必要です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
