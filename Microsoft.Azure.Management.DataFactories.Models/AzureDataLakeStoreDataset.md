<Type Name="AzureDataLakeStoreDataset" FullName="Microsoft.Azure.Management.DataFactories.Models.AzureDataLakeStoreDataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureDataLakeStoreDataset" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureDataLakeStoreDataset" />必須の引数を持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Compression">
      ...
      <Docs>
        <summary>
            省略可能。 データの圧縮方法は Azure Data Lake Store、その項目に使用します。
            </summary>
    ...
    <Member MemberName="FileName">
      ...
      <Docs>
        <summary>
            省略可能。 Azure Data Lake Store 内のファイルの名前です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FolderPath">
      ...
      <Docs>
        <summary>
            必須。 Azure Data Lake Store フォルダーへのパス。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
