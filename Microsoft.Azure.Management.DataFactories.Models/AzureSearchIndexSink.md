<Type Name="AzureSearchIndexSink" FullName="Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexSink">
  ...
  <Docs>
    <summary>
            Azure Search インデックスのコピー活動シンクです。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="WriteBehavior">
      ...
      <Docs>
        <summary>
            省略可能。 指定するドキュメント upsert Azure 検索インデックスを挿入する方法です。
            いずれかを指定する必要があります<see cref="T:Microsoft.Azure.Management.DataFactories.Models.AzureSearchIndexWriteBehavior" />です。 既定値は、値が指定されていない場合、'Merge' です。
            </summary>
