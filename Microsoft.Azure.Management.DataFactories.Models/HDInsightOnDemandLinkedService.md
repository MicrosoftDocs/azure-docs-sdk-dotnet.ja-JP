<Type Name="HDInsightOnDemandLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.HDInsightOnDemandLinkedService">
  ...
  <Docs>
    <summary>
            HDInsight linkedService のプロパティです。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で HDInsightOnDemandLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AdditionalLinkedServiceNames">
      ...
      <Docs>
        <summary>
            省略可能。 クラスターからアクセスできるようにする必要がある追加の Azure ストレージ アカウントを指定します。
            </summary>
    ...
    <Member MemberName="ClusterType">
      ...
      <Docs>
        <summary>
            取得または HDInsight クラスターのフレーバーを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HBaseConfiguration">
      ...
      <Docs>
        <summary>
            省略可能。 ユーザーは HBase 構成の既定値を上書きできます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HcatalogLinkedServiceName">
      ...
      <Docs>
        <summary>
            HCatalog データベースを指す Azure SQL のリンクされたサービスの名前。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HdfsConfiguration">
      ...
      <Docs>
        <summary>
            省略可能。 ユーザーは、HDFS 構成の既定値を上書きできます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HiveCustomLibrariesContainer">
      ...
      <Docs>
        <summary>
            省略可能。 ハイブで使用するためのカスタムの jar ファイルを含む blob コンテナーの名前。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MapReduceConfiguration">
      ...
      <Docs>
        <summary>
            省略可能。 ユーザーは MapReduce 構成の既定値を上書きできます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OozieConfiguration">
      ...
      <Docs>
        <summary>
            省略可能。 ユーザーは Oozie 構成の既定値を上書きできます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OsType">
      ...
      <Docs>
        <summary>
            取得またはクラスター ノードにインストールされているオペレーティング システムの種類を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SchemaGeneration">
      ...
      <Docs>
        <summary>
            入力のテーブルを生成する/変更するために使用して、HDInsight アクティビティのデータセットを出力するオプションを定義します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SparkConfiguration">
      ...
      <Docs>
        <summary>
            この HDInsight クラスターの Spark サービスの構成。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StormConfiguration">
      ...
      <Docs>
        <summary>
            省略可能。 ユーザーは Storm 構成の既定値を上書きできます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="YarnConfiguration">
      ...
      <Docs>
        <summary>
            省略可能。 ユーザーは YARN 構成の既定値を上書きできます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
