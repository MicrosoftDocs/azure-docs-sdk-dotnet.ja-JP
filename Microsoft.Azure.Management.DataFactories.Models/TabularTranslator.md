<Type Name="TabularTranslator" FullName="Microsoft.Azure.Management.DataFactories.Models.TabularTranslator">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="134ac-101">コピー アクティビティ テーブル トランスレーターです。</span><span class="sxs-lookup"><span data-stu-id="134ac-101">A copy activity tabular translator.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ColumnMappings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="134ac-102">列のマッピング。</span><span class="sxs-lookup"><span data-stu-id="134ac-102">Column mappings.</span></span>
            </summary>
