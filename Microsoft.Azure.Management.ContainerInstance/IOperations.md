<Type Name="IOperations" FullName="Microsoft.Azure.Management.ContainerInstance.IOperations">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="669cb-101">操作の操作です。</span><span class="sxs-lookup"><span data-stu-id="669cb-101">Operations operations.</span></span>
            </summary>
    ...
    <Member MemberName="ListWithHttpMessagesAsync">
      ...
      <Docs>
        <param name="customHeaders">
            <span data-ttu-id="669cb-102">追加されるヘッダーを要求します。</span><span class="sxs-lookup"><span data-stu-id="669cb-102">The headers that will be added to request.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="669cb-103">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="669cb-103">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="669cb-104">Azure のコンテナー インスタンスのサービスに対する操作を一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="669cb-104">List the operations for Azure Container Instance service.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.Azure.CloudException">
            <span data-ttu-id="669cb-105">操作には、無効な状態コードが返された場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="669cb-105">Thrown when the operation returned an invalid status code</span></span>
            </exception>
        <exception cref="T:Microsoft.Rest.SerializationException">
            <span data-ttu-id="669cb-106">応答をシリアル化を解除できない場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="669cb-106">Thrown when unable to deserialize the response</span></span>
            </exception>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="669cb-107">必須のパラメーターが null の場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="669cb-107">Thrown when a required parameter is null</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
