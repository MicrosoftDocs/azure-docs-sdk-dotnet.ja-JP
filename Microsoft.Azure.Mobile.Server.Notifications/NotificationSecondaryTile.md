<Type Name="NotificationSecondaryTile" FullName="Microsoft.Azure.Mobile.Server.Notifications.NotificationSecondaryTile">
  ...
  <Docs>
    <summary>
            <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationSecondaryTile" />で WNS セカンダリ タイルを登録するための情報が含まれています、<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationInstallation" />です。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Templates">
      ...
      <Docs>
        <summary>
            テンプレート名の辞書<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" />タイルを登録するオブジェクト。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
