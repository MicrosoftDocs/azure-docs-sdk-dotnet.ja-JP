<Type Name="MpnsMessage" FullName="Microsoft.Azure.Mobile.Server.Notifications.MpnsMessage">
  ...
  <Docs>
    <summary>
            によって使用される共通の基本クラス<see cref="T:Microsoft.Azure.Mobile.Server.MpnsPushMessage" />および関連クラスです。 
            </summary>
    <remarks>
            このクラスは、直接使用するためものではありません。によって使用されている<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.FlipTile" />、 <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.CycleTile" />、および<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.IconicTile" />です。
            </remarks>
  </Docs>
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="version">省略可能なバージョン、タイルの例。「2.0」、または null。</param>
        <param name="template">省略可能、テンプレートの名前。"FlipTile"、または null。</param>
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.MpnsMessage" />クラスに、指定された<paramref name="version" />と<paramref name="template" /></summary>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            このトーストまたはタイルに関連付けられたプロパティを取得します。
            </summary>
    ...
    <Member MemberName="Template">
      ...
      <Docs>
        <summary>
            取得またはなど、タイル、トーストのテンプレート名を設定"FlipTile"、または<c>null</c>テンプレート名が存在しない場合。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            バージョン取得または設定します、タイル、トーストの例。「2.0」、または<c>null</c>バージョンが存在しない場合。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
