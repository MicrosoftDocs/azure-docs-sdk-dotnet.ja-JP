<Type Name="NotificationInstallation" FullName="Microsoft.Azure.Mobile.Server.Notifications.NotificationInstallation">
  ...
  <Docs>
    <summary>
            <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationInstallation" />通知ハブを通じてプッシュ通知をデバイスのインストールを登録するための情報が含まれています。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Platform">
      ...
      <Docs>
        <summary>
            このインストールにプラットフォームです。 プラットフォームは、次の値のいずれかを指定する必要があります: wns、apns です。  
            ここで wns が「Windows プッシュ通知サービス」の略であり apns「Apple Push Notification サービス」。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PushChannel">
      ...
      <Docs>
        <summary>
            チャネル URI WNS; のインストールを登録する場合Apns 登録の場合は、デバイス トークン。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecondaryTiles">
      ...
      <Docs>
        <summary>
            セカンダリ タイル名の辞書<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationSecondaryTile" />のこのインストールに登録するオブジェクト。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Templates">
      ...
      <Docs>
        <summary>
            テンプレート名の辞書<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" />オブジェクト。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
