<Type Name="NotificationTemplate" FullName="Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate">
  ...
  <Docs>
    <summary>
            A<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" />を持つテンプレートを登録するための情報が含まれています、<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationInstallation" />です。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Body">
      ...
      <Docs>
        <summary>
            この通知のペイロード<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.NotificationTemplate" />です。
            </summary>
    ...
    <Member MemberName="Headers">
      ...
      <Docs>
        <summary>
            WNS の場合 (つまり、通知の種類を指定する値にヘッダー名のディクショナリ「X WNS 型」:「wns/トースト」) です。
            他のすべてのプラットフォームは、このプロパティは意味がなくなります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
