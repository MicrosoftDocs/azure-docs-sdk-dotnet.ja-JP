<Type Name="HiveJobSubmissionParameters" FullName="Microsoft.Azure.Management.HDInsight.Job.Models.HiveJobSubmissionParameters">
  ...
  <Docs>
    <summary>
            HDInsight Hive ジョブの定義を指定するパラメーターです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            HiveJobSubmissionParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="File">
      ...
      <Docs>
        <summary>
            省略可能。 取得または Hive ジョブを使用するクエリ ファイルを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            省略可能。 取得または Hive ジョブを使用するクエリを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
