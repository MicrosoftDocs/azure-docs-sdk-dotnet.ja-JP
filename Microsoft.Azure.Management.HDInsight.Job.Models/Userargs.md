<Type Name="Userargs" FullName="Microsoft.Azure.Management.HDInsight.Job.Models.Userargs">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a1fd5-101">取得またはユーザーの引数を含むオブジェクトを設定します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-101">Gets or sets the object containing the user arguments.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-102">Userargs クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-102">Initializes a new instance of the Userargs class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Arg">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-103">Optional.</span></span> <span data-ttu-id="a1fd5-104">取得またはユーザーによって定義されている引数のリストを設定します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-104">Gets or sets the list of args defined by the user.</span></span>
            </summary>
    ...
    <Member MemberName="Callback">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-105">省略可能。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-105">Optional.</span></span> <span data-ttu-id="a1fd5-106">取得または存在する場合に、コールバック URL を設定します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-106">Gets or sets the callback URL, if any.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Define">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-107">省略可能。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-107">Optional.</span></span> <span data-ttu-id="a1fd5-108">取得またはユーザーによって定義されたプロパティの定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-108">Gets or sets the define properties defined by the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Enablelog">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-109">省略可能。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-109">Optional.</span></span> <span data-ttu-id="a1fd5-110">かどうか、ユーザーは、ログを有効にします。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-110">Whether or not the user enabled logs.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Execute">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-111">省略可能。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-111">Optional.</span></span> <span data-ttu-id="a1fd5-112">取得またはユーザーによって定義されたクエリを設定します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-112">Gets or sets the query defined by the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="File">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-113">省略可能。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-113">Optional.</span></span> <span data-ttu-id="a1fd5-114">取得またはユーザーによって指定されたクエリ ファイルを設定します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-114">Gets or sets the query file provided by the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Files">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-115">省略可能。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-115">Optional.</span></span> <span data-ttu-id="a1fd5-116">取得またはユーザーによって定義されたファイルを設定します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-116">Gets or sets the files defined by the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Jar">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-117">省略可能。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-117">Optional.</span></span> <span data-ttu-id="a1fd5-118">取得またはユーザーによって提供される JAR ファイルを設定します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-118">Gets or sets the JAR file provided by the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Statusdir">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-119">省略可能。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-119">Optional.</span></span> <span data-ttu-id="a1fd5-120">取得またはユーザーによって定義された状態のディレクトリを設定します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-120">Gets or sets the status directory defined by the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a1fd5-121">省略可能。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-121">Optional.</span></span> <span data-ttu-id="a1fd5-122">取得またはユーザー名を設定します。</span><span class="sxs-lookup"><span data-stu-id="a1fd5-122">Gets or sets the username.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
