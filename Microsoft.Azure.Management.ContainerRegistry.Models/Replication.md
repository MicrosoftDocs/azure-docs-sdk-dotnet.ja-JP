  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="provisioningState">操作が呼び出された時点でレプリケーションのプロビジョニングの状態。 使用可能な値が含まれます: '作成中'、'更新'、'削除'、'成功'、'失敗'、'キャンセル'</param>
        <param name="status">操作が呼び出された時点で、レプリケーションのステータス。</param>
        <summary>
            レプリケーション クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            操作が呼び出された時点でレプリケーションのプロビジョニングの状態を取得します。 使用可能な値が含まれます: '作成中'、'更新'、'削除'、'成功'、'失敗'、'キャンセル'
            </summary>
