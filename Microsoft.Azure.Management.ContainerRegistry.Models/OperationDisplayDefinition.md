<Type Name="OperationDisplayDefinition" FullName="Microsoft.Azure.Management.ContainerRegistry.Models.OperationDisplayDefinition">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            OperationDisplayDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provider">リソース プロバイダー名: Microsoft.ContainerRegistry です。</param>
        <param name="resource">操作を実行するリソースです。</param>
        <param name="operation">ユーザーが実行できる操作。</param>
        <param name="description">操作の説明です。</param>
        <summary>
            OperationDisplayDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Provider">
      ...
      <Docs>
        <summary>
            リソース プロバイダー名取得または設定します。 Microsoft.ContainerRegistry です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
