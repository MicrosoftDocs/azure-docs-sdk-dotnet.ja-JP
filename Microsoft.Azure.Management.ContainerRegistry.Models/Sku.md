<Type Name="Sku" FullName="Microsoft.Azure.Management.ContainerRegistry.Models.Sku">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">コンテナー レジストリの SKU の名前。 レジストリの作成に必要です。 使用可能な値が含まれます: 'クラシック'、'Basic'、'Standard'、'Premium'</param>
        <param name="tier">SKU 名に基づいて SKU 層です。 使用可能な値が含まれます: 'クラシック'、'Basic'、'Standard'、'Premium'</param>
        <summary>
            Sku クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得またはコンテナー レジストリの SKU の名前を設定します。 レジストリの作成に必要です。 使用可能な値が含まれます: 'クラシック'、'Basic'、'Standard'、'Premium'
            </summary>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            SKU 名に基づいて SKU 層を取得します。 使用可能な値が含まれます: 'クラシック'、'Basic'、'Standard'、'Premium'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
