<Type Name="RegistryListCredentialsResult" FullName="Microsoft.Azure.Management.ContainerRegistry.Models.RegistryListCredentialsResult">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RegistryListCredentialsResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="username">コンテナー レジストリのユーザー名。</param>
        <param name="passwords">コンテナー レジストリのパスワードの一覧。</param>
        <summary>
            RegistryListCredentialsResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Passwords">
      ...
      <Docs>
        <summary>
            取得またはコンテナー レジストリのパスワードの一覧を設定します。
            </summary>
