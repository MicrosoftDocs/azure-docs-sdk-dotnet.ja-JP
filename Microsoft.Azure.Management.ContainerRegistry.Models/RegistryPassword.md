<Type Name="RegistryPassword" FullName="Microsoft.Azure.Management.ContainerRegistry.Models.RegistryPassword">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RegistryPassword クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">パスワードの名前です。 使用可能な値が含まれます: 'password'、'password2'</param>
        <param name="value">パスワードの値。</param>
        <summary>
            RegistryPassword クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得またはパスワードの名前を設定します。 使用可能な値が含まれます: 'password'、'password2'
            </summary>
