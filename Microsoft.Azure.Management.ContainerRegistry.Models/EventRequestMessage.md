<Type Name="EventRequestMessage" FullName="Microsoft.Azure.Management.ContainerRegistry.Models.EventRequestMessage">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="content">イベントの要求メッセージの内容。</param>
        <param name="headers">イベントの要求メッセージのヘッダー。</param>
        <param name="method">イベントの要求メッセージを送信するために使用する HTTP メソッド。</param>
        <param name="requestUri">イベントの要求メッセージの送信に使用する URI。</param>
    ...
    <Member MemberName="Method">
      ...
      <Docs>
        <summary>
            取得またはイベントの要求メッセージの送信に使用される HTTP メソッドを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestUri">
      ...
      <Docs>
        <summary>
            取得またはイベントの要求メッセージの送信に使用する URI を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
