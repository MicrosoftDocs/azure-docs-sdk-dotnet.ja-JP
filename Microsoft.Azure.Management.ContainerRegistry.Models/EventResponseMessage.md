<Type Name="EventResponseMessage" FullName="Microsoft.Azure.Management.ContainerRegistry.Models.EventResponseMessage">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            EventResponseMessage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="content">イベントの応答メッセージの内容。</param>
        <param name="headers">イベントの応答メッセージのヘッダー。</param>
        <param name="reasonPhrase">イベントの応答メッセージの理由の語句。</param>
        <param name="statusCode">イベントの応答メッセージのステータス コード。</param>
        <param name="version">HTTP メッセージのバージョン。</param>
        <summary>
            EventResponseMessage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="StatusCode">
      ...
      <Docs>
        <summary>
            取得またはイベントの応答メッセージのステータス コードを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
