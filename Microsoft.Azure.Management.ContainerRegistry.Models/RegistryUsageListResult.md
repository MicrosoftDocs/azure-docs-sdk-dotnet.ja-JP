<Type Name="RegistryUsageListResult" FullName="Microsoft.Azure.Management.ContainerRegistry.Models.RegistryUsageListResult">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RegistryUsageListResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">コンテナー レジストリ クォータ使用量の一覧。</param>
        <summary>
            RegistryUsageListResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            取得またはコンテナー レジストリ クォータ使用量の一覧を設定します。
            </summary>
