<Type Name="ApplicationGatewayHttpListenerInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewayHttpListenerInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ca636-101">Application gateway の http リスナー。</span><span class="sxs-lookup"><span data-stu-id="ca636-101">Http listener of an application gateway.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ca636-102">ApplicationGatewayHttpListenerInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ca636-102">Initializes a new instance of the ApplicationGatewayHttpListenerInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ca636-103">取得または設定、リソースを更新するたびに変化する一意の読み取り専用文字列。</span><span class="sxs-lookup"><span data-stu-id="ca636-103">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
    ...
    <Member MemberName="FrontendIPConfiguration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ca636-104">取得またはアプリケーション ゲートウェイのフロント エンド IP 構成のリソースを設定します。</span><span class="sxs-lookup"><span data-stu-id="ca636-104">Gets or sets frontend IP configuration resource of an application gateway.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FrontendPort">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ca636-105">取得またはアプリケーション ゲートウェイのフロント エンド ポート リソースを設定します。</span><span class="sxs-lookup"><span data-stu-id="ca636-105">Gets or sets frontend port resource of an application gateway.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HostName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ca636-106">取得または HTTP リスナーのホスト名を設定します。</span><span class="sxs-lookup"><span data-stu-id="ca636-106">Gets or sets host name of HTTP listener.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ca636-107">取得またはリソース グループ内で一意であるリソースの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="ca636-107">Gets or sets name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="ca636-108">この名前は、リソースへのアクセスに使用できます。</span><span class="sxs-lookup"><span data-stu-id="ca636-108">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Protocol">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ca636-109">プロトコル取得または設定します。</span><span class="sxs-lookup"><span data-stu-id="ca636-109">Gets or sets protocol.</span></span> <span data-ttu-id="ca636-110">使用可能な値が: 'Http' および 'Https' です。</span><span class="sxs-lookup"><span data-stu-id="ca636-110">Possible values are: 'Http' and 'Https'.</span></span>
            <span data-ttu-id="ca636-111">使用可能な値が含まれます 'Http'、'Https'。</span><span class="sxs-lookup"><span data-stu-id="ca636-111">Possible values include: 'Http', 'Https'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ca636-112">取得または HTTP リスナー リソースのプロビジョニング状態を設定します。</span><span class="sxs-lookup"><span data-stu-id="ca636-112">Gets or sets provisioning state of the HTTP listener resource.</span></span>
            <span data-ttu-id="ca636-113">使用可能な値が: '更新'、'削除' および '失敗' です。</span><span class="sxs-lookup"><span data-stu-id="ca636-113">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequireServerNameIndication">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ca636-114">取得または設定プロトコルが https である場合にのみ適用されます。</span><span class="sxs-lookup"><span data-stu-id="ca636-114">Gets or sets applicable only if protocol is https.</span></span> <span data-ttu-id="ca636-115">SNI をマルチホストを有効にします。</span><span class="sxs-lookup"><span data-stu-id="ca636-115">Enables SNI for multi-hosting.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SslCertificate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ca636-116">取得またはアプリケーション ゲートウェイの SSL 証明書のリソースを設定します。</span><span class="sxs-lookup"><span data-stu-id="ca636-116">Gets or sets SSL certificate resource of an application gateway.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
