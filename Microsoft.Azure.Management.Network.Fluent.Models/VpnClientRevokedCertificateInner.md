<Type Name="VpnClientRevokedCertificateInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.VpnClientRevokedCertificateInner">
  ...
  <Docs>
    <summary>
            VPN クライアントは、仮想ネットワーク ゲートウェイの証明書を失効します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VpnClientRevokedCertificateInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="thumbprint">取り消された VPN クライアント証明書の拇印。</param>
        <param name="provisioningState">VPN クライアントのプロビジョニングの状態には、証明書リソースが失効しています。 使用可能な値が: '更新'、'削除' および '失敗' です。</param>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            VPN クライアントが失効した証明書のリソースのプロビジョニングの状態を取得します。 使用可能な値が: '更新'、'削除' および '失敗' です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Thumbprint">
      ...
      <Docs>
        <summary>
            取得または取り消された VPN クライアント証明書の拇印を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
