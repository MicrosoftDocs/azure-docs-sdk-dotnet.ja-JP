<Type Name="VirtualNetworkGatewaySku" FullName="Microsoft.Azure.Management.Network.Fluent.Models.VirtualNetworkGatewaySku">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualNetworkGatewaySku クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">ゲートウェイ SKU の名前です。 使用可能な値が: 'Basic'、'HighPerformance'、'Standard'、および 'UltraPerformance' です。 使用可能な値が含まれます: 'Basic'、'HighPerformance'、'Standard'、'UltraPerformance'</param>
        <param name="tier">ゲートウェイ SKU 層です。 使用可能な値が: 'Basic'、'HighPerformance'、'Standard'、および 'UltraPerformance' です。 使用可能な値が含まれます: 'Basic'、'HighPerformance'、'Standard'、'UltraPerformance'</param>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得またはゲートウェイ SKU の名前を設定します。 使用可能な値が: 'Basic'、'HighPerformance'、'Standard'、および 'UltraPerformance' です。 使用可能な値が含まれます: 'Basic'、'HighPerformance'、'Standard'、'UltraPerformance'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            取得またはゲートウェイ SKU の層を設定します。 使用可能な値が: 'Basic'、'HighPerformance'、'Standard'、および 'UltraPerformance' です。 使用可能な値が含まれます: 'Basic'、'HighPerformance'、'Standard'、'UltraPerformance'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
