<Type Name="TroubleshootingDetails" FullName="Microsoft.Azure.Management.Network.Fluent.Models.TroubleshootingDetails">
  ...
  <Docs>
    <summary>
            指定されたリソースのトラブルシューティングの情報を得てきました。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">操作のトラブルシューティング、get の id。</param>
        <param name="reasonType">エラーの理由の種類。</param>
        <param name="summary">トラブルシューティングの概要です。</param>
        <param name="detail">結果のトラブルシューティングについて説明します。</param>
        <param name="recommendedActions">推奨される操作の一覧です。</param>
        <summary>
            TroubleshootingDetails クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Detail">
      ...
      <Docs>
        <summary>
            取得または結果のトラブルシューティングに関する詳細情報を設定します。
            </summary>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            Id、get の取得または設定操作のトラブルシューティングします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
