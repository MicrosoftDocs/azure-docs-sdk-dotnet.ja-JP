<Type Name="TroubleshootingResultInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.TroubleshootingResultInner">
  ...
  <Docs>
    <summary>
            指定されたリソースから得られた情報をトラブルシューティングします。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            TroubleshootingResultInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="startTime">トラブルシューティングの開始時刻です。</param>
        <param name="endTime">トラブルシューティングの終了時刻です。</param>
        <param name="code">トラブルシューティングの結果コード。</param>
        <param name="results">トラブルシューティングの情報です。</param>
        <summary>
            TroubleshootingResultInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
