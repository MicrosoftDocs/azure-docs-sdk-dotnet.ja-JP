<Type Name="ExpressRouteCircuitSku" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ExpressRouteCircuitSku">
  ...
  <Docs>
    <summary>
            ExpressRouteCircuit に SKU が含まれています。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ExpressRouteCircuitSku クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tier">SKU の階層。 値は、'Standard' または 'Premium' です。 使用可能な値が含まれます: 'Standard'、'Premium'</param>
        <param name="family">SKU ファミリ。 使用可能な値が: 'UnlimitedData' および 'MeteredData' です。 使用可能な値が含まれます: 'UnlimitedData'、'MeteredData'</param>
        <summary>
            ExpressRouteCircuitSku クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Family">
      ...
      <Docs>
        <summary>
            取得または SKU のファミリを設定します。 使用可能な値が: 'UnlimitedData' および 'MeteredData' です。 使用可能な値が含まれます: 'UnlimitedData'、'MeteredData'
            </summary>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            取得または SKU の層を設定します。 値は、'Standard' または 'Premium' です。 使用可能な値が含まれます: 'Standard'、'Premium'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
