<Type Name="ExpressRouteCircuitsArpTableListResultInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ExpressRouteCircuitsArpTableListResultInner">
  ...
  <Docs>
    <summary>
            Express Route 回線 API に関連付けられている ListArpTable の応答。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ExpressRouteCircuitsArpTableListResultInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">ARP テーブルの一覧を取得します。</param>
