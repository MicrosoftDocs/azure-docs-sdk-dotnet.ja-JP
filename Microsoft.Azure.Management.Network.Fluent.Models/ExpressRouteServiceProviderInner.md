<Type Name="ExpressRouteServiceProviderInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ExpressRouteServiceProviderInner">
  ...
  <Docs>
    <summary>
            ExpressRouteResourceProvider オブジェクトです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ExpressRouteServiceProviderInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="peeringLocations">ピアリングの場所の一覧を取得します。</param>
        <param name="bandwidthsOffered">提供される帯域幅を取得します。</param>
        <param name="provisioningState">リソースのプロビジョニングの状態を取得します。</param>
        <summary>
            ExpressRouteServiceProviderInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
