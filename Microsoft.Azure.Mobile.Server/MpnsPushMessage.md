<Type Name="MpnsPushMessage" FullName="Microsoft.Azure.Mobile.Server.MpnsPushMessage">
  ...
  <Docs>
    <summary>
            <see cref="T:Microsoft.Azure.Mobile.Server.MpnsPushMessage" />で Microsoft プッシュ通知サービスを対象とする通知のペイロードを生成するクラスを使用します。 使用して通知を送信できる、<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.PushClient" />クラスです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="toastOrTile">いずれかの<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.CycleTile" />、 <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.FlipTile" />、 <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.IconicTile" />、または<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.Toast" />です。</param>
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.Mobile.Server.MpnsPushMessage" />クラスに、指定された<paramref name="toastOrTile" />です。
            トーストまたはタイルできます<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.CycleTile" />、 <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.FlipTile" />、 <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.IconicTile" />、または<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.Toast" />(で定義されている、<c>通知</c>名前空間)。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Headers">
      ...
      <Docs>
        <summary>
            通知と共に Microsoft プッシュ通知サービスに送信される HTTP ヘッダーを追加します。
            </summary>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            特定の設定を取得または<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.MpnsMessage" />のこのインスタンス。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
            XML 表現を提供、<see cref="T:Microsoft.Azure.Mobile.Server.MpnsPushMessage" />インスタンス。
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="XmlPayload">
      ...
      <Docs>
        <summary>
            使用してプログラムで通知を作成する代わりに、 <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.CycleTile" />、 <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.FlipTile" /> <see cref="T:Microsoft.Azure.Mobile.Server.Notifications.IconicTile" />、または<see cref="T:Microsoft.Azure.Mobile.Server.Notifications.Toast" />(で定義されている、<c>通知</c>名前空間)、完全な XML を指定することは変更を加えず、通知ハブに送信される表現です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
