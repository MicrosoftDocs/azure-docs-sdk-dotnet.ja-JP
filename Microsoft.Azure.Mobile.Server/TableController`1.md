<Type Name="TableController&lt;TData&gt;" FullName="Microsoft.Azure.Mobile.Server.TableController&lt;TData&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="TData">エンティティの型。</typeparam>
    <summary>
            共通の<see cref="T:System.Web.Http.ApiController" />テーブル コント ローラーの抽象化します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Mobile.Server.TableController`1" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="domainManager"><see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />このコント ローラーにします。</param>
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.Mobile.Server.TableController`1" />クラスに、指定された<paramref name="domainManager" />です。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DeleteAsync">
      ...
      <Docs>
        ...
        <summary>
            バックエンド ストアからエンティティを削除するためのヘルパー メソッドを提供します。 によってスローされた例外を処理、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />し、適切な HTTP 応答にマッピングします。
            </summary>
        <returns>A<see cref="T:System.Threading.Tasks.Task`1" />によって実行される delete 操作を表す、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DomainManager">
      ...
      <Docs>
        <summary>
            取得または設定、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />バックエンド ストアにアクセスするために使用します。
            </summary>
    ...
    <Member MemberName="InsertAsync">
      ...
      <Docs>
        ...
        <summary>
            バックエンド ストアにエンティティを挿入するためのヘルパー メソッドを提供します。 モデル検証エラーだけでなくによってスローされる例外を処理、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />し、適切な HTTP 応答にマッピングします。
            </summary>
        <returns>A<see cref="T:System.Threading.Tasks.Task`1" />によって実行される挿入操作を表す、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Lookup">
      ...
      <Docs>
        <param name="id">To be added.</param>
        <summary>
            バックエンド ストア内のエンティティを検索するためのヘルパー メソッドを提供します。 によってスローされた例外を処理、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />し、適切な HTTP 応答にマッピングします。
            </summary>
        <returns><see cref="T:System.Web.Http.SingleResult`1" />によって返される、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            バックエンド ストアのクエリを実行するためのヘルパー メソッドを提供します。 によってスローされた例外を処理、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />し、適切な HTTP 応答にマッピングします。
            </summary>
        <returns><see cref="T:System.Linq.IQueryable`1" />によって返される、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ReplaceAsync">
      ...
      <Docs>
        ...
        <param name="item">To be added.</param>
        <summary>
            バックエンド ストア内のエンティティを置換するためのヘルパー メソッドを提供します。 モデル検証エラーだけでなくによってスローされる例外を処理、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />し、適切な HTTP 応答にマッピングします。
            </summary>
        <returns>A<see cref="T:System.Threading.Tasks.Task`1" />によって実行される置換操作を表す、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UndeleteAsync">
      ...
      <Docs>
        <param name="id">To be added.</param>
        <summary>
            バックエンド ストア内のエンティティを削除するためのヘルパー メソッドを提供します。 モデル検証エラーだけでなくによってスローされる例外を処理、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />し、適切な HTTP 応答にマッピングします。
            </summary>
        <returns>A<see cref="T:System.Threading.Tasks.Task`1" />によって実行される update 操作を表す、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UndeleteAsync">
      ...
      <Docs>
        ...
        <returns>A<see cref="T:System.Threading.Tasks.Task`1" />によって実行される削除の取り消し操作を表す、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UpdateAsync">
      ...
      <Docs>
        ...
        <param name="patch">To be added.</param>
        <summary>
            バックエンド ストア内のエンティティを更新するためのヘルパー メソッドを提供します。 モデル検証エラーだけでなくによってスローされる例外を処理、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />し、適切な HTTP 応答にマッピングします。
            </summary>
        <returns>A<see cref="T:System.Threading.Tasks.Task`1" />によって実行される update 操作を表す、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.IDomainManager`1" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
