<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGateway.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4c21a-101">リソース グループを指定できるようにアプリケーション ゲートウェイ定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="4c21a-101">The stage of an application gateway definition allowing to specify the resource group.</span></span>
            </summary>
