<Type Name="IDefinition" FullName="Microsoft.Azure.Management.Compute.Fluent.Snapshot.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7b044-101">管理対象のスナップショットの定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="7b044-101">The entirety of the managed snapshot definition.</span></span>
            </summary>
