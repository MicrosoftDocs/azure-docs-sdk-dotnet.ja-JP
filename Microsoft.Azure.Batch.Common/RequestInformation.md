<Type Name="RequestInformation" FullName="Microsoft.Azure.Batch.Common.RequestInformation">
  ...
  <Members>
    ...
    <Member MemberName="BatchError">
      ...
      <Docs>
        <summary>
            取得または発生した特定のエラーに関する詳細なメタデータを含むバッチのエラー情報を設定します。
            </summary>
    ...
    <Member MemberName="ClientRequestId">
      ...
      <Docs>
        <summary>
            取得または設定、クライアント要求 id。 クライアントによって設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HttpStatusCode">
      ...
      <Docs>
        <summary>
            ...
            HTTP 応答をことはありません (たとえば クライアント側のタイムアウト) 受信した場合は、このプロパティが null です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HttpStatusMessage">
      ...
      <Docs>
        <summary>
            取得または要求の HTTP ステータス メッセージを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
