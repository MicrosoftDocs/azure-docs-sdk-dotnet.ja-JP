<Type Name="IWithTemplate" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Deployment.Update.IWithTemplate">
  ...
  <Members>
    <Member MemberName="WithTemplate">
      ...
      <Docs>
        <param name="template">オブジェクト</param>
        <summary>
            オブジェクトとしてテンプレートを指定します。
            </summary>
    ...
    <Member MemberName="WithTemplate">
      ...
      <Docs>
        <param name="templateJson">templateJson JSON 文字列</param>
        <summary>
            JSON 文字列としてテンプレートを指定します。
            </summary>
        <returns>更新プログラムの展開の次のステージ</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WithTemplateLink">
      ...
      <Docs>
        <param name="uri">リモートのテンプレート ファイルの場所の uri</param>
        <param name="contentVersion">contentVersion テンプレート ファイルのバージョン</param>
        <summary>
            URL としてテンプレートを指定します。
            </summary>
        <returns>更新プログラムの展開の次のステージ</returns>
