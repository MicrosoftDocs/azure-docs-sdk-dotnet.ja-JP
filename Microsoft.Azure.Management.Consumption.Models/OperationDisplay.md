<Type Name="OperationDisplay" FullName="Microsoft.Azure.Management.Consumption.Models.OperationDisplay">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provider">サービス プロバイダー: Microsoft.Consumption です。</param>
        <param name="resource">操作が実行されるリソース: UsageDetail などです。</param>
    ...
    <Member MemberName="Provider">
      ...
      <Docs>
        <summary>
            サービス プロバイダーの取得: Microsoft.Consumption です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Resource">
      ...
      <Docs>
        <summary>
            操作が実行されるリソースを取得します。 UsageDetail、などです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
