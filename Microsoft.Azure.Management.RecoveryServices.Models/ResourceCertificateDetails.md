<Type Name="ResourceCertificateDetails" FullName="Microsoft.Azure.Management.RecoveryServices.Models.ResourceCertificateDetails">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ResourceCertificateDetails クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Certificate">
      ...
      <Docs>
        <summary>
            取得または base64 でエンコードされた証明書の生データ文字列を設定します。
            </summary>
