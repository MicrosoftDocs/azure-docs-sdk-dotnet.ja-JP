<Type Name="RawCertificateData" FullName="Microsoft.Azure.Management.RecoveryServices.Models.RawCertificateData">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RawCertificateData クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="authType">認証の種類を指定します。 使用可能な値が含まれます: '無効'、'ACS'、'AAD'、'AccessControlService'、'AzureActiveDirectory'</param>
        <param name="certificate">Base64 にエンコードされた証明書の生データ文字列</param>
        <summary>
            RawCertificateData クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AuthType">
      ...
      <Docs>
        <summary>
            取得または設定は、認証の種類を指定します。 使用可能な値が含まれます: '無効'、'ACS'、'AAD'、'AccessControlService'、'AzureActiveDirectory'
            </summary>
    ...
    <Member MemberName="Certificate">
      ...
      <Docs>
        <summary>
            Base64 でエンコードされた証明書の生データ文字列取得または設定
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
