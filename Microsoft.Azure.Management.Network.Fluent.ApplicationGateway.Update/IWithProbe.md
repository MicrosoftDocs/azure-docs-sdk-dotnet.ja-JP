<Type Name="IWithProbe" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGateway.Update.IWithProbe">
  ...
  <Docs>
    <summary>
            アプリケーション ゲートウェイの更新を許可するプローブの変更の段階です。
            </summary>
  ...
  <Members>
    <Member MemberName="DefineProbe">
      ...
      <Docs>
        <param name="name">プローブの一意の名前。</param>
        <summary>
            新しいプローブの定義を開始します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>プローブの定義の最初の段階です。</return>
      </Docs>
    </Member>
    <Member MemberName="UpdateProbe">
      ...
      <Docs>
        <param name="name">既存のプローブの名前。</param>
        <summary>
            既存のプローブの更新を開始します。
            </summary>
        <returns>To be added.</returns>
