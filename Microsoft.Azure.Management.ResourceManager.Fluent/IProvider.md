<Type Name="IProvider" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.IProvider">
  ...
  <Docs>
    <summary>
            Azure リソース プロバイダーの変更できないクライアント側表現。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="RegistrationState">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value>示す、プロバイダーの登録状態かどうかこの</value>
        <value>リソース プロバイダーが現在のサブスクリプションに登録されています。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
