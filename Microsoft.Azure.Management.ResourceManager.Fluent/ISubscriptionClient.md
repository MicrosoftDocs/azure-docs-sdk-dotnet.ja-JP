<Type Name="ISubscriptionClient" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.ISubscriptionClient">
  ...
  <Members>
    <Member MemberName="AcceptLanguage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe5fa-101">取得または応答の優先言語を設定します。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-101">Gets or sets the preferred language for the response.</span></span>
            </summary>
    ...
    <Member MemberName="ApiVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe5fa-102">クライアント Api のバージョン。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-102">Client Api Version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BaseUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe5fa-103">サービスのベース URI。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-103">The base URI of the service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Credentials">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe5fa-104">Azure に接続するクライアントに必要な資格情報です。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-104">Credentials needed for the client to connect to Azure.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DeserializationSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe5fa-105">取得または json に逆シリアル化の設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-105">Gets or sets json deserialization settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GenerateClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe5fa-106">設定すると、一意の x ms-クライアントの要求 id 値を true に生成され、各要求に含まれます。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-106">When set to true a unique x-ms-client-request-id value is generated and included in each request.</span></span> <span data-ttu-id="fe5fa-107">既定値は true です。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-107">Default is true.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LongRunningOperationRetryTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe5fa-108">取得または長時間実行される操作の秒単位の再試行タイムアウトを設定します。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-108">Gets or sets the retry timeout in seconds for Long Running Operations.</span></span> <span data-ttu-id="fe5fa-109">既定値は 30 です。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-109">Default value is 30.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SerializationSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe5fa-110">取得または json のシリアル化設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-110">Gets or sets json serialization settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subscriptions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe5fa-111">ISubscriptionsOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-111">Gets the ISubscriptionsOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tenants">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe5fa-112">ITenantsOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="fe5fa-112">Gets the ITenantsOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
