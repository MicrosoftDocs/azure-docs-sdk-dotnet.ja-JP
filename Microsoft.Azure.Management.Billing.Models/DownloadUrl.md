<Type Name="DownloadUrl" FullName="Microsoft.Azure.Management.Billing.Models.DownloadUrl">
  ...
  <Docs>
    <summary>
            PDF のダウンロードに使用することができますをセキュリティで保護された URL は、URL の有効期限が切れるまで請求書です。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DownloadUrl クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="expiryTime">このダウンロード URL が期限切れになる UTC 時間です。</param>
        <param name="url">PDF ファイルへの URL。</param>
        <summary>
            DownloadUrl クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ExpiryTime">
      ...
      <Docs>
        <summary>
            このダウンロード URL が期限切れになる utc 時間を取得します。
            </summary>
