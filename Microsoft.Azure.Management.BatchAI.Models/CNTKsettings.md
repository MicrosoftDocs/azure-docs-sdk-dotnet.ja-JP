<Type Name="CNTKsettings" FullName="Microsoft.Azure.Management.BatchAI.Models.CNTKsettings">
  ...
  <Docs>
    <summary>
            CNTK (Microsoft 認知 Toolkit aka) ジョブの設定を指定します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            CNTKsettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="languageType">CNTK (Microsoft 認知 Toolkit aka) ジョブを起動するのに使用する言語の種類を指定します。</param>
        ...
        <param name="commandLineArgs">Python スクリプトまたは CNTK.exe に渡される必要があるコマンドライン引数。</param>
    ...
    <Member MemberName="CommandLineArgs">
      ...
      <Docs>
        <summary>
            取得または python スクリプトまたは CNTK.exe に渡される必要があるコマンドライン引数を設定します。
            </summary>
    ...
    <Member MemberName="ConfigFilePath">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>
            このプロパティにすることができるかどうか、languageType は 'BrainScript' のみを指定します。
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="LanguageType">
      ...
      <Docs>
        <summary>
            取得または設定 CNTK (Microsoft 認知 Toolkit aka) ジョブを起動するのに使用する言語の種類を指定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            有効な値は、'BrainScript' または 'Python' です。
            </remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="PythonInterpreterPath">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>
            このプロパティにすることができるかどうか、languageType は 'Python' のみを指定します。
            </remarks>
      </Docs>
    </Member>
