<Type Name="InputDirectory" FullName="Microsoft.Azure.Management.BatchAI.Models.InputDirectory">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            InputDirectory クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">入力のディレクトリの id。</param>
        <param name="path">入力のディレクトリへのパス。</param>
        <summary>
            InputDirectory クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            取得または入力ディレクトリの id を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            AZ_BATCHAI_INPUT_id 環境変数として、ジョブの利用可能な場合もなります。 サービスは、次の環境変数も提供されます。 AZ_BATCHAI_PREV_OUTPUT_Name です。 以前のエラー、それ以外の場合は nothing に設定した後、ジョブが再試行されている場合は、変数の値が表示されます。
            </remarks>
      </Docs>
    </Member>
