<Type Name="JobPreparation" FullName="Microsoft.Azure.Management.BatchAI.Models.JobPreparation">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            JobPreparation クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="commandLine">実行するコマンドラインです。</param>
        <summary>
            JobPreparation クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CommandLine">
      ...
      <Docs>
        <summary>
            取得または実行するコマンドラインを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            ContainerSettings がジョブに指定されている場合、このコマンドラインはジョブと同じコンテナーで実行されます。 それ以外の場合、ノードで実行されます。
            </remarks>
      </Docs>
    </Member>
