  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="masterCommandLineArgs">マスターのタスクのコマンドライン引数を指定します。</param>
        <param name="pythonInterpreterPath">Python インタープリターへのパス。</param>
        <param name="workerCommandLineArgs">ワーカー タスクのコマンドライン引数を指定します。</param>
        <param name="parameterServerCommandLineArgs">パラメーターのサーバー タスクのコマンドライン引数を指定します。</param>
        <param name="workerCount">ワーカー タスクの数。</param>
        <param name="parameterServerCount">Parmeter サーバー タスクの数。</param>
        <summary>
            TensorFlowSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="MasterCommandLineArgs">
      ...
      <Docs>
        <summary>
            取得または設定は、マスターのタスクのコマンドライン引数を指定します。
            </summary>
    ...
    <Member MemberName="ParameterServerCommandLineArgs">
      ...
      <Docs>
        <summary>
            取得または設定は、パラメーターのサーバー タスクのコマンドライン引数を指定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            このプロパティは、1 台のコンピューターのトレーニングでは省略可能です。
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="ParameterServerCount">
      ...
      <Docs>
        <summary>
            取得またはサーバー タスク parmeter の数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            指定した場合、値を nodeCount 以下にする必要があります。 指定しない場合、既定値は 1 (このプロパティは 1 台のコンピューターのトレーニングには適用されません) 分散 TensorFlow トレーニング用にします。 このプロパティは、分散 TensorFlow トレーニングに対してのみ指定できます。
            </remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="WorkerCommandLineArgs">
      ...
      <Docs>
        <summary>
            取得または設定は、ワーカー タスクのコマンドライン引数を指定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            このプロパティは、1 台のコンピューターのトレーニングでは省略可能です。
    ...
    <Member MemberName="WorkerCount">
      ...
      <Docs>
        <summary>
            取得またはワーカー タスクの数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            値が以下にする必要があります、指定した場合 (nodeCount * numberOfGPUs VM あたり)。 指定しない場合、既定値は nodeCount になります。 このプロパティは、分散 TensorFlow トレーニングに対してのみ指定できます。
            </remarks>
      </Docs>
    </Member>
  </Members>
