<Type Name="SshConfiguration" FullName="Microsoft.Azure.Management.BatchAI.Models.SshConfiguration">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SshConfiguration クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="userAccountSettings">Vm のユーザー アカウントの設定です。</param>
        <param name="publicIPsToAllow">VM への SSH 接続を許可する発信元 IP 範囲の一覧です。</param>
        <summary>
            SshConfiguration クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="PublicIPsToAllow">
      ...
      <Docs>
        <summary>
            取得または VM への SSH 接続を許可する発信元 IP 範囲の一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            既定値は ' *' すべてのソース Ip の照合に使用できます。 指定できるパブリック Ip の最大数は、400 です。
            </remarks>
      </Docs>
    </Member>
