<Type Name="NodeStateCounts" FullName="Microsoft.Azure.Management.BatchAI.Models.NodeStateCounts">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            NodeStateCounts クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="idleNodeCount">アイドル状態でのコンピューティング ノードの数。</param>
        <param name="runningNodeCount">ジョブを実行しているコンピューティング ノードの数。</param>
        <param name="preparingNodeCount">準備されているコンピューティング ノードの数。</param>
        <param name="unusableNodeCount">これは使用できません。 計算ノードの数。</param>
        <param name="leavingNodeCount">クラスターを離脱はコンピューティング ノードの数。</param>
        <summary>
            NodeStateCounts クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IdleNodeCount">
      ...
      <Docs>
        <summary>
            取得またはアイドル状態にコンピューティング ノードの数を設定します。
            </summary>
    ...
    <Member MemberName="LeavingNodeCount">
      ...
      <Docs>
        <summary>
            取得またはクラスターに離職する人をコンピューティング ノードの数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PreparingNodeCount">
      ...
      <Docs>
        <summary>
            取得または準備されているコンピューティング ノードの数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RunningNodeCount">
      ...
      <Docs>
        <summary>
            取得またはジョブを実行しているコンピューティング ノードの数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UnusableNodeCount">
      ...
      <Docs>
        <summary>
            取得または使用されるコンピューティング ノードの数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
