<Type Name="JobPropertiesExecutionInfo" FullName="Microsoft.Azure.Management.BatchAI.Models.JobPropertiesExecutionInfo">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            JobPropertiesExecutionInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="startTime">ジョブが実行を開始された時刻。</param>
        <param name="endTime">ジョブが完了した時刻。</param>
        <param name="exitCode">ジョブの終了コード。</param>
        <param name="errors">ジョブの実行中に、サービスで検出されたさまざまなエラーの詳細が含まれます</param>
        <summary>
            JobPropertiesExecutionInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            取得またはジョブが完了した時刻を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            このプロパティはジョブが完了した状態の場合にのみ返されます。
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Errors">
      ...
      <Docs>
        <summary>
            取得または設定は、ジョブの実行中に、サービスで検出されたさまざまなエラーの詳細が含まれています
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            取得またはジョブが実行を開始された時刻を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            '実行中は、実行状態に対応しています。 ジョブが再起動した場合は再試行、ジョブが実行を開始された、最新の時間です。 このプロパティは、実行中または完了状態にあるジョブにのみ存在します。
            </remarks>
      </Docs>
    </Member>
  </Members>
