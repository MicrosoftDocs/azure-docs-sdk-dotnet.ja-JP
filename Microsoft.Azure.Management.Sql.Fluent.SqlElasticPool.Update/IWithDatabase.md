<Type Name="IWithDatabase" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlElasticPool.Update.IWithDatabase">
  ...
  <Docs>
    <summary>
            弾力性プール内にデータベースを追加する SQL 弾力性プール定義します。
            </summary>
  ...
  <Members>
    <Member MemberName="WithExistingDatabase">
      ...
      <Docs>
        <param name="database">SQL 弾力性プールに追加するデータベース インスタンス。</param>
        <summary>
            SQL 弾力性プールのデータベースを追加します。
            </summary>
    ...
    <Member MemberName="WithExistingDatabase">
      ...
      <Docs>
        <param name="databaseName">弾力性プールに追加する既存のデータベースの名前です。</param>
        <summary>
            SQL 弾力性プール内の既存のデータベースを追加します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>定義の次のステージ。</return>
    ...
    <Member MemberName="WithNewDatabase">
      ...
      <Docs>
        <param name="databaseName">弾力性プールに追加する新しいデータベースの名前。</param>
        <summary>
            SQL 弾力性プールに新しいデータベースを作成します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>定義の次のステージ。</return>
