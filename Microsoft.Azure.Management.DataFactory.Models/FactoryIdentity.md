<Type Name="FactoryIdentity" FullName="Microsoft.Azure.Management.DataFactory.Models.FactoryIdentity">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="principalId">Id のプリンシパル id。</param>
        <param name="tenantId">Id のクライアントのテナント id です。</param>
        <summary>
            FactoryIdentity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            Id の種類。 現在、唯一サポートされている型は 'SystemAssigned' です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
