<Type Name="AzureSearchLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureSearchLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7fc1c-101">Windows Azure Search サービスのリンクされたサービス。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-101">Linked service for Windows Azure Search Service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fc1c-102">AzureSearchLinkedService クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-102">Initializes a new instance of the AzureSearchLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="url"><span data-ttu-id="7fc1c-103">Azure Search サービスの URL です。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-103">URL for Azure Search service.</span></span> <span data-ttu-id="7fc1c-104">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-104">Type: string (or Expression with resultType string).</span></span></param>
        <param name="additionalProperties"><span data-ttu-id="7fc1c-105">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="7fc1c-105">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="connectVia"><span data-ttu-id="7fc1c-106">統合のランタイム参照。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-106">The integration runtime reference.</span></span></param>
        <param name="description"><span data-ttu-id="7fc1c-107">リンクされたサービスの説明。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-107">Linked service description.</span></span></param>
        <param name="key"><span data-ttu-id="7fc1c-108">Azure Search サービスの管理キー</span><span class="sxs-lookup"><span data-stu-id="7fc1c-108">Admin Key for Azure Search service</span></span></param>
        <param name="encryptedCredential"><span data-ttu-id="7fc1c-109">暗号化された資格情報の認証に使用します。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-109">The encrypted credential used for authentication.</span></span> <span data-ttu-id="7fc1c-110">資格情報は、統合ランタイム資格情報マネージャーを使用して暗号化されます。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-110">Credentials are encrypted using the integration runtime credential manager.</span></span> <span data-ttu-id="7fc1c-111">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-111">Type: string (or Expression with resultType string).</span></span></param>
        <summary>
            <span data-ttu-id="7fc1c-112">AzureSearchLinkedService クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-112">Initializes a new instance of the AzureSearchLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EncryptedCredential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fc1c-113">取得または認証に使用される暗号化された資格情報を設定します。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-113">Gets or sets the encrypted credential used for authentication.</span></span>
            <span data-ttu-id="7fc1c-114">資格情報は、統合ランタイム資格情報マネージャーを使用して暗号化されます。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-114">Credentials are encrypted using the integration runtime credential manager.</span></span> <span data-ttu-id="7fc1c-115">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-115">Type: string (or Expression with resultType string).</span></span>
            </summary>
    ...
    <Member MemberName="Key">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fc1c-116">取得または設定の管理の Azure Search サービスのキー</span><span class="sxs-lookup"><span data-stu-id="7fc1c-116">Gets or sets admin Key for Azure Search service</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fc1c-117">取得または Azure Search サービスの URL を設定します。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-117">Gets or sets URL for Azure Search service.</span></span> <span data-ttu-id="7fc1c-118">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-118">Type: string (or Expression with resultType string).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7fc1c-119">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-119">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="7fc1c-120">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="7fc1c-120">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
