<Type Name="PipelineRunQueryOrderBy" FullName="Microsoft.Azure.Management.DataFactory.Models.PipelineRunQueryOrderBy">
  ...
  <Docs>
    <summary>
            パイプラインの一覧のオプションを使用して注文を入力するオブジェクトが実行されます。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PipelineRunQueryOrderBy クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="orderBy">Order by 句に使用するパラメーターの名前。
            使用可能な値が含まれます: 'RunStart'、'RunEnd'</param>
        <param name="order">パラメーターの順序を並べ替えます。 使用可能な値が含まれます: 'ASC'、'DESC'</param>
        <summary>
            PipelineRunQueryOrderBy クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Order">
      ...
      <Docs>
        <summary>
            取得またはパラメーターの順序の並べ替えを設定します。 使用可能な値が含まれます: 'ASC'、'DESC'
            </summary>
    ...
    <Member MemberName="OrderBy">
      ...
      <Docs>
        <summary>
            取得または order by 句を使用するパラメーターの名前を設定します。 使用可能な値が含まれます: 'RunStart'、'RunEnd'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
