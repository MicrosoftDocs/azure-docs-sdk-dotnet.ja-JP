<Type Name="SqlServerStoredProcedureActivity" FullName="Microsoft.Azure.Management.DataFactory.Models.SqlServerStoredProcedureActivity">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SqlServerStoredProcedureActivity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="storedProcedureName">ストアド プロシージャの名前。 型: 文字列 (または式の resultType 文字列)。</param>
    ...
    <Member MemberName="StoredProcedureName">
      ...
      <Docs>
        <summary>
            取得またはストアド プロシージャの名前を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
