<Type Name="ScheduleTriggerRecurrence" FullName="Microsoft.Azure.Management.DataFactory.Models.ScheduleTriggerRecurrence">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ScheduleTriggerRecurrence クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="frequency">頻度です。 使用可能な値が含まれます: 'NotSpecified'、'Minute'、'Hour'、'Day'、'週'、'Month'、'Year'</param>
        <param name="interval">間隔です。</param>
        <param name="startTime">開始時刻です。</param>
        <param name="endTime">終了時刻。</param>
        <param name="timeZone">タイム ゾーン。</param>
        <param name="schedule">定期的なスケジュールします。</param>
        <summary>
            ScheduleTriggerRecurrence クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Frequency">
      ...
      <Docs>
        <summary>
            取得または頻度を設定します。 使用可能な値が含まれます: 'NotSpecified'、'Minute'、'Hour'、'Day'、'週'、'Month'、'Year'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
