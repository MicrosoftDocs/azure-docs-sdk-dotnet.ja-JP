<Type Name="OdbcLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.OdbcLinkedService">
  ...
  <Docs>
    <summary>
            Open Database Connectivity (ODBC) リンクされたサービス。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            OdbcLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="connectionString">接続文字列と同様の省略可能な非アクセス資格情報の部分には、資格情報が暗号化されています。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="authenticationType">ODBC データ ストアへの接続に使用される認証の種類です。 Anonymous と Basic のいずれかの値になります。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="credential">ドライバー固有のプロパティ値の形式で指定された接続文字列のアクセス資格情報の部分。</param>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            取得または ODBC データ ストアへの接続に使用する認証の種類を設定します。 Anonymous と Basic のいずれかの値になります。 型: 文字列 (または式の resultType 文字列)。
            </summary>
    ...
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            取得または省略可能な暗号化された資格情報と同様に、接続文字列のないアクセスの資格情報の部分を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Credential">
      ...
      <Docs>
        <summary>
            取得またはドライバーに固有のプロパティ値の形式で指定された接続文字列のアクセス資格情報の部分を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
