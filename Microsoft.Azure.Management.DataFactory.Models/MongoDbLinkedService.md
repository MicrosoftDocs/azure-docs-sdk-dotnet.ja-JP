<Type Name="MongoDbLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.MongoDbLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MongoDbLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="server">MongoDB サーバーの IP アドレスまたはサーバー名。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="databaseName">アクセスする MongoDB データベースの名前。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="authenticationType">MongoDB データベースへの接続に使用する認証の種類。 使用可能な値が含まれます: 'Basic'、'Anonymous'</param>
        <param name="username">認証のユーザー名。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="password">認証のパスワードです。</param>
        <param name="authSource">ユーザー名とパスワードを確認するデータベースです。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="port">MongoDB サーバーがクライアント接続をリッスンするように使用する TCP ポート番号。 既定値は、27017 です。 型: 整数 (または式と resultType 整数)、最小値。
            0.</param>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            取得または MongoDB データベースへの接続に使用する認証の種類を設定します。 使用可能な値が含まれます: 'Basic'、'Anonymous'
            </summary>
    ...
    <Member MemberName="AuthSource">
      ...
      <Docs>
        <summary>
            取得またはユーザー名とパスワードを確認するデータベースを設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseName">
      ...
      <Docs>
        <summary>
            取得または設定にアクセスする MongoDB データベースの名前。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            取得または MongoDB サーバーがクライアント接続をリッスンするように使用する TCP ポート番号を設定します。 既定値は、27017 です。 型: 整数 (または式と resultType 整数)、最小値: 0。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Server">
      ...
      <Docs>
        <summary>
            取得または MongoDB サーバーの IP アドレスまたはサーバー名を設定します。
