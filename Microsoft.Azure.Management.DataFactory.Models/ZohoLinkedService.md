<Type Name="ZohoLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.ZohoLinkedService">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="endpoint">Zoho サーバーのエンドポイント。 (つまり crm.zoho.com/crm/private)</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="accessToken">Zoho 認証のアクセス トークン。</param>
    ...
    <Member MemberName="Endpoint">
      ...
      <Docs>
        <summary>
            取得または Zoho サーバーのエンドポイントを設定します。 (つまり crm.zoho.com/crm/private)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
