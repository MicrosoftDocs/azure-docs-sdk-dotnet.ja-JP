<Type Name="ManagedIntegrationRuntimeNode" FullName="Microsoft.Azure.Management.DataFactory.Models.ManagedIntegrationRuntimeNode">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="nodeId">管理されている統合ランタイム ノード id。</param>
        <param name="status">管理されている統合ランタイム ノードの状態。
            使用可能な値が含まれます: ''、使用可能'、'リサイクル'、'を使用できません'</param>
        <param name="errors">この統合ランタイム ノードで発生したエラー。</param>
        <summary>
            ManagedIntegrationRuntimeNode クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Errors">
      ...
      <Docs>
        <summary>
            取得またはこの統合ランタイム ノードで発生したエラーを設定します。
            </summary>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            管理されている統合ランタイム ノードの状態を取得します。 使用可能な値が含まれます: ''、使用可能'、'リサイクル'、'を使用できません'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
