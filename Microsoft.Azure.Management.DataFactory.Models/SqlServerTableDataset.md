<Type Name="SqlServerTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.SqlServerTableDataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SqlServerTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">SQL Server のデータセットのテーブル名。
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            取得または SQL Server のデータセットのテーブル名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
