  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="sqlWriterStoredProcedureName">SQL ライター ストアド プロシージャの名前。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="sqlWriterTableType">SQL ライターのテーブル型です。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="preCopyScript">コピー前の SQL スクリプト。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="storedProcedureParameters">SQL ストアド プロシージャのパラメーターです。</param>
        <summary>
            SqlSink クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="SqlWriterStoredProcedureName">
      ...
      <Docs>
        <summary>
            取得または、SQL ライター ストアド プロシージャの名前を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SqlWriterTableType">
      ...
      <Docs>
        <summary>
            取得または、SQL ライター テーブル型を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StoredProcedureParameters">
      ...
      <Docs>
        <summary>
            取得または SQL ストアド プロシージャのパラメーターを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
