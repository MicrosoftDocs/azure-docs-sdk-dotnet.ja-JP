<Type Name="PipelineRunQueryResponse" FullName="Microsoft.Azure.Management.DataFactory.Models.PipelineRunQueryResponse">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PipelineRunQueryResponse クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">パイプラインの一覧を実行します。</param>
        <param name="continuationToken">任意の残りの結果が存在する場合、null それ以外の場合、結果の次のページを取得するための継続トークンです。</param>
        <summary>
            PipelineRunQueryResponse クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ContinuationToken">
      ...
      <Docs>
        <summary>
            取得または任意の残りの結果が存在する場合、null それ以外の場合、結果の次のページを取得するための継続トークンを設定します。
            </summary>
