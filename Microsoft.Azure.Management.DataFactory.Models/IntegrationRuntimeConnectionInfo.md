<Type Name="IntegrationRuntimeConnectionInfo" FullName="Microsoft.Azure.Management.DataFactory.Models.IntegrationRuntimeConnectionInfo">
  ...
  <Docs>
    <summary>
            内部設置型データを暗号化するための接続情報はソースの資格情報です。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="serviceToken">サービスで生成されたトークン。 呼び出し元は、統合ランタイムへの認証にこのトークンを使用します。</param>
        <param name="identityCertThumbprint">統合ランタイム SSL 証明書の拇印。 をクリックして-アプリケーションを使用して、サーバー検証を行うとします。</param>
        <param name="hostServiceUri">内部設置型の統合ランタイム ホスト URL。</param>
        <param name="version">統合ランタイムのバージョン。</param>
        <param name="publicKey">資格情報を統合ランタイムに転送するときに、資格情報を暗号化するための公開キー。</param>
        <param name="isIdentityCertExprired">Id 証明書が有効期限が切れているかどうか。</param>
        <summary>
            IntegrationRuntimeConnectionInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IdentityCertThumbprint">
      ...
      <Docs>
        <summary>
            統合ランタイムの SSL 証明書の拇印を取得します。 をクリックして-アプリケーションを使用して、サーバー検証を行うとします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicKey">
      ...
      <Docs>
        <summary>
            資格情報を統合ランタイムに転送するときに、資格情報を暗号化するための公開キーを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceToken">
      ...
      <Docs>
        <summary>
            サービスで生成されたトークンを取得します。 呼び出し元は、統合ランタイムへの認証にこのトークンを使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
