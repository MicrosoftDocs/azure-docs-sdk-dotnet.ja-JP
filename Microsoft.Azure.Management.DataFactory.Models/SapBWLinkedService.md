<Type Name="SapBWLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.SapBWLinkedService">
  ...
  <Docs>
    <summary>
            SAP Business Warehouse にリンクされたサービスを指定します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SapBWLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="server">SAP BW のインスタンスのホスト名です。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="systemNumber">BW システムのシステムの数。 (通常、2 桁の 10 進数文字列として表されます。)型: 文字列 (または式の resultType 文字列)。</param>
        <param name="clientId">BW システムへのクライアントのクライアント ID。
            (通常、3 桁 10 進数文字列として表される)型: 文字列 (または式の resultType 文字列)。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="userName">SAP BW サーバーにアクセスするユーザー名。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="password">SAP BW サーバーにアクセスするパスワードです。</param>
    ...
    <Member MemberName="ClientId">
      ...
      <Docs>
        <summary>
            取得または BW システムで、クライアントのクライアント ID を設定します。 (通常、3 桁 10 進数文字列として表される)型: 文字列 (または式の resultType 文字列)。
            </summary>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            取得または SAP BW サーバーにアクセスするためのパスワードを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Server">
      ...
      <Docs>
        <summary>
            取得または SAP BW インスタンスのホスト名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SystemNumber">
      ...
      <Docs>
        <summary>
            取得またはシステム BW システムの数を設定します。 (通常、2 桁の 10 進数文字列として表されます。)型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            取得または SAP BW サーバーにアクセスするユーザー名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
