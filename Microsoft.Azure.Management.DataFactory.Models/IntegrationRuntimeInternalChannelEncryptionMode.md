<Type Name="IntegrationRuntimeInternalChannelEncryptionMode" FullName="Microsoft.Azure.Management.DataFactory.Models.IntegrationRuntimeInternalChannelEncryptionMode">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="26f3a-101">IntegrationRuntimeInternalChannelEncryptionMode の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="26f3a-101">Defines values for IntegrationRuntimeInternalChannelEncryptionMode.</span></span>
            </summary>
