<Type Name="SapCloudForCustomerLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.SapCloudForCustomerLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SapCloudForCustomerLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="url">顧客の OData API 用クラウドの SAP の URL です。 たとえば、'[https://[tenantname].crm.ondemand.com/sap/c4c/odata/v1]'。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="username">基本認証のユーザー名。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="password">基本認証のパスワード。</param>
        <param name="encryptedCredential">暗号化された資格情報の認証に使用します。 資格情報は、統合ランタイム資格情報マネージャーを使用して暗号化されます。 EncryptedCredential またはユーザー名/パスワードのいずれかを指定する必要があります。 型: 文字列 (または式の resultType 文字列)。</param>
        <summary>
            SapCloudForCustomerLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EncryptedCredential">
      ...
      <Docs>
        <summary>
            ...
            資格情報は、統合ランタイム資格情報マネージャーを使用して暗号化されます。 EncryptedCredential またはユーザー名/パスワードのいずれかを指定する必要があります。 型: 文字列 (または式の resultType 文字列)。
            </summary>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            取得または顧客 OData API の SAP クラウドの URL を設定します。 たとえば、'[https://[tenantname].crm.ondemand.com/sap/c4c/odata/v1]'。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            取得または基本認証のユーザー名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
