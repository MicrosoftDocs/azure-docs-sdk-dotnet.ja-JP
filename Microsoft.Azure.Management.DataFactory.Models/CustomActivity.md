  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="command">カスタム アクティビティの種類のコマンド: 文字列 (または式の resultType 文字列)。</param>
        ...
        <param name="resourceLinkedService">リソースには、サービス参照の追加がリンクされています。</param>
        <param name="folderPath">ファイルの種類のリソースのフォルダーのパス: 文字列 (または式の resultType 文字列)。</param>
        <param name="referenceObjects">オブジェクトを参照</param>
        <param name="extendedProperties">ユーザーは、プロパティ バッグを定義します。 キーまたは使用できる値に制限はありません。 ユーザーは、カスタム アクティビティが使用して、定義されているコンテンツを解釈する全責任を指定します。</param>
        <summary>
            [Customactivity] クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Command">
      ...
      <Docs>
        <summary>
            取得またはカスタム アクティビティの種類のコマンドを設定します。 文字列 (または式の resultType 文字列)。
            </summary>
    ...
    <Member MemberName="ExtendedProperties">
      ...
      <Docs>
        <summary>
            取得またはユーザー定義されたプロパティ バッグを設定します。 キーまたは使用できる値に制限はありません。 ユーザーは、カスタム アクティビティが使用して、定義されているコンテンツを解釈する全責任を指定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FolderPath">
      ...
      <Docs>
        <summary>
            フォルダー パス リソース ファイルの種類を取得または設定します。 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceLinkedService">
      ...
      <Docs>
        <summary>
            取得またはリンクされているリソース サービス参照を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
