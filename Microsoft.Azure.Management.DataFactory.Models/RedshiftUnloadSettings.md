<Type Name="RedshiftUnloadSettings" FullName="Microsoft.Azure.Management.DataFactory.Models.RedshiftUnloadSettings">
  ...
  <Docs>
    <summary>
            Amazon Redshift からコピーするときに、中間の Amazon S3 に必要な Amazon S3 設定をアンロードします。 これにより、Amazon Redshift ソースからデータをまず S3 にアンロードし、する中間 S3 から対象となるシンクにコピーされます。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="s3LinkedServiceName">Amazon S3 の名前には、Amazon Redshift ソースからコピーするときに、アンロード操作に使用するサービスがリンクされています。</param>
        <param name="bucketName">Amazon Redshift ソースからアンロード データの格納に使用される中間 Amazon s3 バケット。 バケットは、Amazon Redshift ソースと同じリージョンにする必要があります。 型: 文字列 (または式の resultType 文字列)。</param>
        <summary>
            RedshiftUnloadSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BucketName">
      ...
      <Docs>
        <summary>
            取得またはアンロードされた Amazon Redshift ソースからデータを格納するために使用する中間の Amazon s3 バケットを設定します。 バケットは、Amazon Redshift ソースと同じリージョンにする必要があります。 型: 文字列 (または式の resultType 文字列)。
            </summary>
    ...
    <Member MemberName="S3LinkedServiceName">
      ...
      <Docs>
        <summary>
            取得または Amazon Redshift ソースからコピーするときに、アンロード操作に使用されるリンク Amazon S3 サービスの名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
