  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="identity">工場出荷時の管理されたサービスの id。</param>
        <param name="provisioningState">ファクトリのプロビジョニングの状態、例が成功しました。</param>
        <param name="createTime">ファクトリが ISO8601 の形式で作成された時刻。</param>
        <param name="version">工場出荷時のバージョンです。</param>
        <summary>
            ファクトリ クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CreateTime">
      ...
      <Docs>
        <summary>
            ファクトリが ISO8601 の形式で作成された日時を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Identity">
      ...
      <Docs>
        <summary>
            取得または工場出荷時の管理されたサービス id を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
