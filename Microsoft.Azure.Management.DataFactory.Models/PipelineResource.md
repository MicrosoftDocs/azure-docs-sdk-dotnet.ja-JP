<Type Name="PipelineResource" FullName="Microsoft.Azure.Management.DataFactory.Models.PipelineResource">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PipelineResource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="etag">Etag は、リソースの変更を識別します。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="description">パイプラインの説明です。</param>
        <param name="activities">パイプライン内のアクティビティの一覧です。</param>
        <param name="parameters">パイプラインのパラメーターの一覧です。</param>
        <param name="concurrency">パイプラインの同時実行の最大数。</param>
        <summary>
            PipelineResource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
