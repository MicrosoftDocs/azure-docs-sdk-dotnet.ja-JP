<Type Name="AzureDataLakeStoreDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureDataLakeStoreDataset">
  ...
  <Docs>
    <summary>
            Azure Data Lake Store データセットです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AzureDataLakeStoreDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="folderPath">Azure Data Lake Store フォルダーへのパス。 型: 文字列 (または式の resultType 文字列)。</param>
        ...
        <param name="fileName">Azure Data Lake Store 内のファイルの名前です。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="format">Data Lake Store の形式です。</param>
        <param name="compression">データの圧縮方法は Azure Data Lake Store、その項目に使用します。</param>
        <summary>
            AzureDataLakeStoreDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Compression">
      ...
      <Docs>
        <summary>
            取得または Azure Data Lake Store、その項目に使用するデータの圧縮方法を設定します。
            </summary>
    ...
    <Member MemberName="FileName">
      ...
      <Docs>
        <summary>
            取得または Azure Data Lake Store のファイルの名前を設定します。
    ...
    <Member MemberName="FolderPath">
      ...
      <Docs>
        <summary>
            取得または Azure Data Lake Store フォルダーへのパスを設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Format">
      ...
      <Docs>
        <summary>
            取得または Data Lake Store の形式を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
