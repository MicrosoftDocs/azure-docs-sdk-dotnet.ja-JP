<Type Name="IntegrationRuntimeReference" FullName="Microsoft.Azure.Management.DataFactory.Models.IntegrationRuntimeReference">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            IntegrationRuntimeReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="referenceName">参照の統合のランタイム名です。</param>
        <param name="parameters">統合ランタイムの引数。</param>
        <summary>
            IntegrationRuntimeReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
