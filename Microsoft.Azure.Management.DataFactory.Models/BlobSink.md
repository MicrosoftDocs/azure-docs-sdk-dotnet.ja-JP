  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="blobWriterOverwriteFiles">Blob のライター ファイルを上書きします。
            型: ブール値 (または式の resultType ブール値)。</param>
        <param name="blobWriterDateTimeFormat">Blob ライター日付/時刻形式。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="blobWriterAddHeader">Blob のライターでは、ヘッダーを追加します。 型: ブール値 (または式の resultType ブール値)。</param>
    ...
    <Member MemberName="BlobWriterAddHeader">
      ...
      <Docs>
        <summary>
            Blob のライターの設定を取得またはヘッダーを追加します。 型: ブール値 (または式の resultType ブール値)。
            </summary>
    ...
    <Member MemberName="BlobWriterDateTimeFormat">
      ...
      <Docs>
        <summary>
            取得または blob ライター日付/時刻形式を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BlobWriterOverwriteFiles">
      ...
      <Docs>
        <summary>
            取得またはライターがファイルを上書きする blob を設定します。 型: ブール値 (または式の resultType ブール値)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
