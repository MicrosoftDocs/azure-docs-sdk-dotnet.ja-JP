<Type Name="ParameterSpecification" FullName="Microsoft.Azure.Management.DataFactory.Models.ParameterSpecification">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ParameterSpecification クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="type">パラメーターの型。 使用可能な値が含まれます 'Object'、'String'、'Int'、'Float'、'Bool'、'Array'。</param>
        <param name="defaultValue">パラメーターの既定値です。</param>
        <summary>
            ParameterSpecification クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            取得またはパラメーターの型を設定します。 使用可能な値が含まれます 'Object'、'String'、'Int'、'Float'、'Bool'、'Array'。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
