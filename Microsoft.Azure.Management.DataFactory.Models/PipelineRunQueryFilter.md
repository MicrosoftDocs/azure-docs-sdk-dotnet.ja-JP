<Type Name="PipelineRunQueryFilter" FullName="Microsoft.Azure.Management.DataFactory.Models.PipelineRunQueryFilter">
  ...
  <Docs>
    <summary>
            パイプラインの実行を一覧表示するクエリのフィルター オプション。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PipelineRunQueryFilter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="operand">フィルターに使用するパラメーターの名前。
            使用可能な値が含まれます: 'PipelineName'、'Status'、'RunStart'、'RunEnd'</param>
        <param name="operatorProperty">フィルターに使用する演算子です。
            使用可能な値が含まれます 'Equals'、'In'、'ない' ' NotEquals'、。</param>
        <param name="values">フィルター値の一覧です。</param>
        <summary>
            PipelineRunQueryFilter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Operand">
      ...
      <Docs>
        <summary>
            取得またはフィルターを使用するパラメーターの名前を設定します。 使用可能な値が含まれます: 'PipelineName'、'Status'、'RunStart'、'RunEnd'
            </summary>
    ...
    <Member MemberName="OperatorProperty">
      ...
      <Docs>
        <summary>
            取得またはフィルターを使用する演算子を設定します。 使用可能な値が含まれます 'Equals'、'In'、'ない' ' NotEquals'、。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
