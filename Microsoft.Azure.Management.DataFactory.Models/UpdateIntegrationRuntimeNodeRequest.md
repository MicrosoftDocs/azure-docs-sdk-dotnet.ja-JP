<Type Name="UpdateIntegrationRuntimeNodeRequest" FullName="Microsoft.Azure.Management.DataFactory.Models.UpdateIntegrationRuntimeNodeRequest">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            UpdateIntegrationRuntimeNodeRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="concurrentJobsLimit">同時ジョブの数は、統合ランタイム ノードで実行を許可します。 1 ~ maxConcurrentJobs(inclusive) 値が許可されています。</param>
        <summary>
            UpdateIntegrationRuntimeNodeRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ConcurrentJobsLimit">
      ...
      <Docs>
        <summary>
            取得または設定が、統合ランタイム ノードで実行できる同時ジョブの数。 1 ~ maxConcurrentJobs(inclusive) 値が許可されています。
            </summary>
