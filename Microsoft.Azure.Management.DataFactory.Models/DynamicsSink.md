<Type Name="DynamicsSink" FullName="Microsoft.Azure.Management.DataFactory.Models.DynamicsSink">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DynamicsSink クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="ignoreNullValues">書き込み操作中に (フィールドを除くキー) の入力データセットから null 値を無視するかどうかを示すフラグ。 既定値は false です。 型: ブール値 (または式の resultType ブール値)。</param>
        <summary>
            DynamicsSink クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IgnoreNullValues">
      ...
      <Docs>
        <summary>
            中に入力データセット (を除くキー フィールド) から null 値を無視するかどうかを示すフラグを取得または設定は、操作を記述します。 既定値は false です。 型: ブール値 (または式の resultType ブール値)。
            </summary>
