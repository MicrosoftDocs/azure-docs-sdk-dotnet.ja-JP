<Type Name="OracleSource" FullName="Microsoft.Azure.Management.DataFactory.Models.OracleSource">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            OracleSource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="oracleReaderQuery">Oracle リーダー クエリです。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="queryTimeout">クエリのタイムアウト。 型: 文字列 (または式の resultType 文字列)、パターン: ((\d+)\.)? (\d\d):(60|([0-5][0-9])): (60 |([0-5][0-9])) です。</param>
        <summary>
            OracleSource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="OracleReaderQuery">
      ...
      <Docs>
        <summary>
            取得または oracle リーダーのクエリを設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
    ...
    <Member MemberName="QueryTimeout">
      ...
      <Docs>
        <summary>
            取得またはクエリのタイムアウトを設定します。 型: 文字列 (または式の resultType 文字列)、パターン: ((\d+)\.)? (\d\d):(60|([0-5][0-9])): (60 |([0-5][0-9])) です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
