<Type Name="FileSystemSink" FullName="Microsoft.Azure.Management.DataFactory.Models.FileSystemSink">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d7978-101">コピー アクティビティ ファイル システム シンクです。</span><span class="sxs-lookup"><span data-stu-id="d7978-101">A copy activity file system sink.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d7978-102">FileSystemSink クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="d7978-102">Initializes a new instance of the FileSystemSink class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="d7978-103">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="d7978-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="writeBatchSize"><span data-ttu-id="d7978-104">バッチ サイズを記述します。</span><span class="sxs-lookup"><span data-stu-id="d7978-104">Write batch size.</span></span> <span data-ttu-id="d7978-105">型: 整数 (または式と resultType 整数)、最小値: 0。</span><span class="sxs-lookup"><span data-stu-id="d7978-105">Type: integer (or Expression with resultType integer), minimum: 0.</span></span></param>
        <param name="writeBatchTimeout"><span data-ttu-id="d7978-106">バッチ タイムアウトを記述します。</span><span class="sxs-lookup"><span data-stu-id="d7978-106">Write batch timeout.</span></span> <span data-ttu-id="d7978-107">型: 文字列 (または式の resultType 文字列)、パターン: ((\d+)\.)? (\d\d):(60|([0-5][0-9])): (60 |([0-5][0-9])) です。</span><span class="sxs-lookup"><span data-stu-id="d7978-107">Type: string (or Expression with resultType string), pattern: ((\d+)\.)?(\d\d):(60|([0-5][0-9])):(60|([0-5][0-9])).</span></span></param>
        <param name="sinkRetryCount"><span data-ttu-id="d7978-108">再試行回数をシンクします。</span><span class="sxs-lookup"><span data-stu-id="d7978-108">Sink retry count.</span></span> <span data-ttu-id="d7978-109">型: 整数 (または式に整数の resultType)。</span><span class="sxs-lookup"><span data-stu-id="d7978-109">Type: integer (or Expression with resultType integer).</span></span></param>
        <param name="sinkRetryWait"><span data-ttu-id="d7978-110">再試行の待機をシンクします。</span><span class="sxs-lookup"><span data-stu-id="d7978-110">Sink retry wait.</span></span> <span data-ttu-id="d7978-111">型: 文字列 (または式の resultType 文字列)、パターン: ((\d+)\.)? (\d\d):(60|([0-5][0-9])): (60 |([0-5][0-9])) です。</span><span class="sxs-lookup"><span data-stu-id="d7978-111">Type: string (or Expression with resultType string), pattern: ((\d+)\.)?(\d\d):(60|([0-5][0-9])):(60|([0-5][0-9])).</span></span></param>
        <param name="copyBehavior"><span data-ttu-id="d7978-112">コピー シンクのコピー動作の型。</span><span class="sxs-lookup"><span data-stu-id="d7978-112">The type of copy behavior for copy sink.</span></span>
            <span data-ttu-id="d7978-113">使用可能な値が含まれます: 'PreserveHierarchy'、'FlattenHierarchy'、'MergeFiles'</span><span class="sxs-lookup"><span data-stu-id="d7978-113">Possible values include: 'PreserveHierarchy', 'FlattenHierarchy', 'MergeFiles'</span></span></param>
        <summary>
            <span data-ttu-id="d7978-114">FileSystemSink クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="d7978-114">Initializes a new instance of the FileSystemSink class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyBehavior">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d7978-115">取得またはコピー シンクのコピー動作の種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="d7978-115">Gets or sets the type of copy behavior for copy sink.</span></span> <span data-ttu-id="d7978-116">使用可能な値が含まれます: 'PreserveHierarchy'、'FlattenHierarchy'、'MergeFiles'</span><span class="sxs-lookup"><span data-stu-id="d7978-116">Possible values include: 'PreserveHierarchy', 'FlattenHierarchy', 'MergeFiles'</span></span>
            </summary>
