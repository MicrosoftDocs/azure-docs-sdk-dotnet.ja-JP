  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="vNetId">この統合ランタイムを参加させる、VNet の ID。</param>
        <param name="subnet">この統合ランタイムを参加させる、サブネットの名前。</param>
        <summary>
            IntegrationRuntimeVNetProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Subnet">
      ...
      <Docs>
        <summary>
            取得またはこの統合ランタイムを参加させる、サブネットの名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VNetId">
      ...
      <Docs>
        <summary>
            取得またはこの統合ランタイムを参加させる、VNet の ID を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
