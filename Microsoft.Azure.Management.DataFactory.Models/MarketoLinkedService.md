<Type Name="MarketoLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.MarketoLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MarketoLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="endpoint">Marketo サーバーのエンドポイント。 (つまり 123-ABC-321.mktorest.com)</param>
        <param name="clientId">クライアントの Marketo サービスの Id。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="clientSecret">Marketo サービスのクライアント シークレット。</param>
    ...
    <Member MemberName="ClientId">
      ...
      <Docs>
        <summary>
            取得またはクライアントの Marketo サービスの Id を設定します。
            </summary>
    ...
    <Member MemberName="ClientSecret">
      ...
      <Docs>
        <summary>
            取得または Marketo サービスのクライアント シークレットを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Endpoint">
      ...
      <Docs>
        <summary>
            取得または Marketo サーバーのエンドポイントを設定します。 (つまり 123-ABC-321.mktorest.com)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
