  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="dataset">GetMetadata アクティビティのデータセットの参照。</param>
        ...
        <param name="fieldList">データセットから取得するメタデータのフィールドです。</param>
        <summary>
            GetMetadataActivity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Dataset">
      ...
      <Docs>
        <summary>
            取得または getMetadata アクティビティのデータセットの参照を設定します。
            </summary>
    ...
    <Member MemberName="FieldList">
      ...
      <Docs>
        <summary>
            取得またはデータセットから取得するメタデータのフィールドを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
