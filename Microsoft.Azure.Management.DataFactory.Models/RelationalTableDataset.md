<Type Name="RelationalTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.RelationalTableDataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RelationalTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">リレーショナル テーブルの名前です。 型: 文字列 (または式の resultType 文字列)。</param>
        <summary>
            RelationalTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            取得またはリレーショナル テーブル名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
