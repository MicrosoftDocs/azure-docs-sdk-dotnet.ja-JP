<Type Name="DatasetReference" FullName="Microsoft.Azure.Management.DataFactory.Models.DatasetReference">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DatasetReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="referenceName">参照データセットの名前です。</param>
        <param name="parameters">データセットの引数。</param>
        <summary>
            DatasetReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
