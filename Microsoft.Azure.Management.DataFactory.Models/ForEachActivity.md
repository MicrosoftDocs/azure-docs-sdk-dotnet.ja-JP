<Type Name="ForEachActivity" FullName="Microsoft.Azure.Management.DataFactory.Models.ForEachActivity">
  ...
  <Docs>
    <summary>
            このアクティビティは、コレクションを反復処理するために使用し、特定のアクティビティを実行します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ForEachActivity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="items">反復処理するコレクション。</param>
        ...
        <param name="isSequential">順次または並列 (最大 20) に、ループを実行</param>
        <summary>
            ForEachActivity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
