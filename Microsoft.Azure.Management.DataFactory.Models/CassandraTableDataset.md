<Type Name="CassandraTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.CassandraTableDataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            CassandraTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">Cassandra データベースのテーブル名。
            型: 文字列 (または式の resultType 文字列)。</param>
        <param name="keyspace">Cassandra データベースのキースペースです。
            型: 文字列 (または式の resultType 文字列)。</param>
        <summary>
            CassandraTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
    ...
    <Member MemberName="Keyspace">
      ...
      <Docs>
        <summary>
            取得または Cassandra データベースのキースペースを設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            取得または Cassandra データベースのテーブル名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
