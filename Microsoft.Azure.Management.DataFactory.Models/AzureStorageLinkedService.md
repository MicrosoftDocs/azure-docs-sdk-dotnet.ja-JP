  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="connectionString">接続文字列。 SasUri プロパティで相互に排他的であります。</param>
        <param name="sasUri">Azure ストレージ リソースの SAS URI。 これは、connectionString プロパティで相互に排他的です。</param>
    ...
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            取得または接続文字列を設定します。 SasUri プロパティで相互に排他的であります。
            </summary>
    ...
    <Member MemberName="SasUri">
      ...
      <Docs>
        <summary>
            取得または Azure ストレージ リソースの SAS URI を設定します。 これは、connectionString プロパティで相互に排他的です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
