  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="authenticationType">接続に使用される AuthenticationType。 使用可能な値が含まれます: 'Basic'</param>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            取得または接続に使用する authenticationType を設定します。 使用可能な値が含まれます: 'Basic'
            </summary>
