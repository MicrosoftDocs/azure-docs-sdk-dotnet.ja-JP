<Type Name="PipelineRun" FullName="Microsoft.Azure.Management.DataFactory.Models.PipelineRun">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PipelineRun クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="runId">実行の識別子です。</param>
        <param name="pipelineName">パイプラインの名前です。</param>
        <param name="parameters">パラメーター名の完全または部分的な一覧で、パイプラインで使用される値のペアを実行します。</param>
        <param name="invokedBy">パイプラインの実行を開始するエンティティです。</param>
        <param name="lastUpdated">ISO8601 の形式でイベントを実行するパイプラインのタイムスタンプを最後に更新されます。</param>
        <param name="runStart">パイプラインの開始時刻は、ISO8601 の形式で実行します。</param>
        <param name="runEnd">パイプラインの終了時刻は、ISO8601 の形式で実行します。</param>
        <param name="durationInMs">パイプラインの期間を実行します。</param>
        <param name="status">パイプラインの状態を実行します。</param>
        <param name="message">パイプラインからメッセージを実行します。</param>
        <summary>
            PipelineRun クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="LastUpdated">
      ...
      <Docs>
        <summary>
            ISO8601 の形式でイベントを実行するパイプラインの最終更新タイムスタンプを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            パラメーター名、パイプラインの実行で使用される値のペアの完全または部分的な一覧を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RunEnd">
      ...
      <Docs>
        <summary>
            ISO8601 の形式で実行するパイプラインの終了時刻を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RunStart">
      ...
      <Docs>
        <summary>
            ISO8601 の形式で実行するパイプラインの開始時刻を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
