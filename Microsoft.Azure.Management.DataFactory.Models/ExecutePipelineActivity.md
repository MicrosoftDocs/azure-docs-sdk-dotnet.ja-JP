<Type Name="ExecutePipelineActivity" FullName="Microsoft.Azure.Management.DataFactory.Models.ExecutePipelineActivity">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ExecutePipelineActivity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="pipeline">パイプラインの参照。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="description">アクティビティの説明です。</param>
        <param name="dependsOn">アクティビティは、条件によって異なります。</param>
        <param name="parameters">パイプラインのパラメーターです。</param>
        <param name="waitOnCompletion">アクティビティの実行が完了に依存するパイプラインの実行を待つかどうかを定義します。 既定値は false です。</param>
        <summary>
            ExecutePipelineActivity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="WaitOnCompletion">
      ...
      <Docs>
        <summary>
            取得または設定は、アクティビティの実行が完了に依存するパイプラインの実行を待つかどうかを定義します。 既定値は false です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
