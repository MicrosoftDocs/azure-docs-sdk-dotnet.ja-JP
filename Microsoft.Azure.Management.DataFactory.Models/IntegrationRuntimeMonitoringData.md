<Type Name="IntegrationRuntimeMonitoringData" FullName="Microsoft.Azure.Management.DataFactory.Models.IntegrationRuntimeMonitoringData">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            IntegrationRuntimeMonitoringData クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">統合ランタイムの名前です。</param>
        <param name="nodes">統合ランタイム ノードがデータを監視します。</param>
        <summary>
            IntegrationRuntimeMonitoringData クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
