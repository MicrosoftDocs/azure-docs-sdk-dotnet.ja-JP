<Type Name="AzureSqlTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureSqlTableDataset">
  ...
  <Docs>
    <summary>
            Azure SQL Server データベース データセットです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AzureSqlTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">Azure SQL データベースのテーブル名。
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            取得または Azure SQL データベースのテーブル名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
