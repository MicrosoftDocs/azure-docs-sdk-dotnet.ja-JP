<Type Name="StagingSettings" FullName="Microsoft.Azure.Management.DataFactory.Models.StagingSettings">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            StagingSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="linkedServiceName">ステージングでは、サービス参照のリンクされています。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="path">中間のデータを格納するための記憶域へのパス。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="enableCompression">中間のステージングを使用してデータをコピーするときに、圧縮を使用するかどうかを指定します。 既定値は false です。 型: ブール値 (または式の resultType ブール値)。</param>
        <summary>
            StagingSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EnableCompression">
      ...
      <Docs>
        <summary>
            取得または設定は、中間のステージングを使用してデータをコピーするときに、圧縮を使用するかどうかを指定します。 既定値は false です。 型: ブール値 (または式の resultType ブール値)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LinkedServiceName">
      ...
      <Docs>
        <summary>
            取得またはリンクされたサービス参照のステージングを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
            取得または暫定的なデータを格納するためのストレージへのパスを設定します。
