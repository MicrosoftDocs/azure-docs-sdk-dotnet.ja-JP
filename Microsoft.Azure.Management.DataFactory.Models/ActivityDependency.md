<Type Name="ActivityDependency" FullName="Microsoft.Azure.Management.DataFactory.Models.ActivityDependency">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ActivityDependency クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="activity">アクティビティ名。</param>
        <param name="dependencyConditions">依存関係の場合は、一致条件です。</param>
