<Type Name="AzureMySqlTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureMySqlTableDataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AzureMySqlTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">Azure の MySQL データベースのテーブル名。 型: 文字列 (または式の resultType 文字列)。</param>
        <summary>
            AzureMySqlTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            取得または Azure の MySQL データベースのテーブル名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
