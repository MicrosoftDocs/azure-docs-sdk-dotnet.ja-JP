<Type Name="Dataset" FullName="Microsoft.Azure.Management.DataFactory.Models.Dataset">
  ...
  <Docs>
    <summary>
            テーブル、ファイル、フォルダー、ドキュメントなどのさまざまなデータ ストア内のデータを識別する Azure Data Factory 入れ子になったオブジェクトです。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Structure">
      ...
      <Docs>
        <summary>
            取得またはデータセットの構造を定義する列を設定します。
            型: 配列 (または配列の resultType を含む式)、itemType: DatasetDataElement です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
