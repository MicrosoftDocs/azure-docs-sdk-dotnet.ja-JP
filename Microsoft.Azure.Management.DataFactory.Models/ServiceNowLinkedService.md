<Type Name="ServiceNowLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.ServiceNowLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ServiceNowLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="endpoint">ServiceNow サーバーのエンドポイント。 (つまり ServiceNowData.com)</param>
        <param name="authenticationType">使用する認証の種類。
            使用可能な値が含まれます: 'Basic'、'OAuth2'</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="username">Basic および OAuth2 認証で ServiceNow サーバーへの接続に使用されるユーザー名。</param>
        <param name="password">Basic および OAuth2 認証のユーザー名に対応するパスワード。</param>
        <param name="clientId">OAuth2 認証にクライアント id。</param>
        <param name="clientSecret">OAuth2 認証のクライアント シークレット。</param>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            取得または使用する認証の種類を設定します。 使用可能な値が含まれます: 'Basic'、'OAuth2'
            </summary>
    ...
    <Member MemberName="ClientId">
      ...
      <Docs>
        <summary>
            取得または OAuth2 認証用のクライアント id を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ClientSecret">
      ...
      <Docs>
        <summary>
            取得または OAuth2 認証用のクライアント シークレットを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Endpoint">
      ...
      <Docs>
        <summary>
            取得または ServiceNow サーバーのエンドポイントを設定します。 (つまり ServiceNowData.com)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            取得または基本認証と OAuth2 認証のユーザー名に対応するパスワードを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            取得または Basic および OAuth2 認証 ServiceNow サーバーへの接続に使用するユーザー名を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
