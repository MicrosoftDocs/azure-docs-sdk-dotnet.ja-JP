<Type Name="PhoenixLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.PhoenixLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PhoenixLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="host">Phoenix サーバーの IP アドレスまたはホスト名。 (例: 192.168.222.160)</param>
        <param name="authenticationType">Phoenix サーバーへの接続に使用する認証メカニズム。 使用可能な値が含まれます 'Anonymous'、'UsernameAndPassword'、'WindowsAzureHDInsightService'。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="port">Phoenix サーバーがクライアント接続のリッスンに使用する TCP ポート。 既定値は 8765 です。</param>
        <param name="httpPath">Phoenix サーバーに対応する部分的な URL。 (つまり/gateway/sandbox/phoenix/version)。 WindowsAzureHDInsightService を使用する場合、既定値は hbasephoenix です。</param>
        <param name="username">Phoenix サーバーへの接続に使用されるユーザー名。</param>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            取得または Phoenix サーバーへの接続に使用される認証方式を設定します。 使用可能な値が含まれます 'Anonymous'、'UsernameAndPassword'、'WindowsAzureHDInsightService'。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            取得または Phoenix サーバーの IP アドレスまたはホスト名を設定します。
            (例: 192.168.222.160)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="HttpPath">
      ...
      <Docs>
        <summary>
            取得または Phoenix サーバーに対応する部分的な URL を設定します。
            (つまり/gateway/sandbox/phoenix/version)。 WindowsAzureHDInsightService を使用する場合、既定値は hbasephoenix です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            取得または Phoenix サーバーがクライアント接続のリッスンに使用される TCP ポートを設定します。 既定値は 8765 です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            取得または Phoenix サーバーへの接続に使用するユーザー名を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
