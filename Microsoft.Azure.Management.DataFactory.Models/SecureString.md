<Type Name="SecureString" FullName="Microsoft.Azure.Management.DataFactory.Models.SecureString">
  ...
  <Docs>
    <summary>
            Azure Data Factory セキュリティで保護された文字列の定義。 アスタリスクで文字列値をマスクする ' *' 中に Get またはリスト API を呼び出します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">セキュリティで保護された文字列の値です。</param>
        <summary>
            SecureString クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
