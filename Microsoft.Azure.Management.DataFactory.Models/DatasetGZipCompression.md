<Type Name="DatasetGZipCompression" FullName="Microsoft.Azure.Management.DataFactory.Models.DatasetGZipCompression">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DatasetGZipCompression クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="level">GZip 圧縮レベルです。 使用可能な値が含まれます: 'Optimal'、'Fastest'</param>
        <summary>
            DatasetGZipCompression クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            取得または GZip 圧縮レベルを設定します。 使用可能な値が含まれます: 'Optimal'、'Fastest'
            </summary>
