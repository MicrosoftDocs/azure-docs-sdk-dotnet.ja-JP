<Type Name="AzureMLWebServiceFile" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureMLWebServiceFile">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AzureMLWebServiceFile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="filePath">LinkedService で指定された Azure Blob ストレージ コンテナー名を含む相対ファイル パス。
            型: 文字列 (または式の resultType 文字列)。</param>
        <param name="linkedServiceName">Azure ML web サービスの入力/出力ファイルが配置されている、Azure ストレージ LinkedService への参照。</param>
        <summary>
            AzureMLWebServiceFile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="FilePath">
      ...
      <Docs>
        <summary>
            取得または、LinkedService で指定された Azure Blob ストレージ コンテナー名を含む、相対ファイル パスを設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
    ...
    <Member MemberName="LinkedServiceName">
      ...
      <Docs>
        <summary>
            取得または Azure ML web サービスの入力/出力ファイルが配置されている、Azure ストレージ LinkedService への参照を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
