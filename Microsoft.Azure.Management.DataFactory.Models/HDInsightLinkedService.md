<Type Name="HDInsightLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.HDInsightLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            HDInsightLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="clusterUri">HDInsight クラスター URI です。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="userName">HDInsight クラスターのユーザー名。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="password">HDInsight クラスターのパスワードです。</param>
        <param name="linkedServiceName">Azure Storage のリンクされたサービスの参照。</param>
        <param name="hcatalogLinkedServiceName">HCatalog データベースを指す、Azure SQL のリンクされたサービスへの参照。</param>
    ...
    <Member MemberName="ClusterUri">
      ...
      <Docs>
        <summary>
            取得または hDInsight クラスター URI を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
    ...
    <Member MemberName="HcatalogLinkedServiceName">
      ...
      <Docs>
        <summary>
            取得または HCatalog データベースを指している Azure SQL のリンクされたサービスへの参照を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            取得または hDInsight クラスターのパスワードを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            取得または hDInsight クラスターのユーザー名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
