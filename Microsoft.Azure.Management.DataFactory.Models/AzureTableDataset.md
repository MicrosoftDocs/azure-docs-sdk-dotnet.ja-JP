<Type Name="AzureTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureTableDataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AzureTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">Azure テーブル ストレージのテーブル名。
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            取得または Azure テーブル ストレージのテーブル名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
