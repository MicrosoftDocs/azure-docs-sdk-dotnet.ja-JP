<Type Name="ImpalaLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.ImpalaLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ImpalaLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="host">Impala サーバーの IP アドレスまたはホスト名です。 (例: 192.168.222.160)</param>
        <param name="authenticationType">使用する認証の種類。
            使用可能な値が含まれます 'Anonymous'、'SASLUsername'、'UsernameAndPassword'。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="port">クライアント接続をリッスンするように Impala サーバーが使用する TCP ポートです。 既定値は 21050 です。</param>
        <param name="username">Impala サーバーにアクセスするために使用するユーザー名。 既定値は anonymous です (SASLUsername を使用するとき)。</param>
        <param name="password">ユーザー名に対応するパスワード (UsernameAndPassword を使用するとき)。</param>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            取得または使用する認証の種類を設定します。 使用可能な値が含まれます 'Anonymous'、'SASLUsername'、'UsernameAndPassword'。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            取得または Impala サーバーの IP アドレスまたはホスト名を設定します。
            (例: 192.168.222.160)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            取得または UsernameAndPassword を使用する場合は、ユーザー名に対応するパスワードを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Port">
      ...
      <Docs>
        <summary>
            取得または Impala サーバーがクライアント接続のリッスンに使用される TCP ポートを設定します。 既定値は 21050 です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Username">
      ...
      <Docs>
        <summary>
            取得または Impala サーバーへのアクセスに使用するユーザー名を設定します。 既定値は anonymous です (SASLUsername を使用するとき)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
