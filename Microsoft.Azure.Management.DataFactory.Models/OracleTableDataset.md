<Type Name="OracleTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.OracleTableDataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            OracleTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">内部設置型 Oracle データベースのテーブル名。 型: 文字列 (または式の resultType 文字列)。</param>
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            取得または内部設置型 Oracle データベースのテーブル名を設定します。
