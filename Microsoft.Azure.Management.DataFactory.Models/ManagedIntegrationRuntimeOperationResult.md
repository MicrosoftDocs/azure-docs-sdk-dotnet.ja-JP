<Type Name="ManagedIntegrationRuntimeOperationResult" FullName="Microsoft.Azure.Management.DataFactory.Models.ManagedIntegrationRuntimeOperationResult">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ManagedIntegrationRuntimeOperationResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="type">操作の種類。 開始する、または停止できませんでした。</param>
        <param name="startTime">操作の開始時刻です。</param>
        <param name="result">操作の結果。</param>
        <param name="errorCode">エラー コード。</param>
        <param name="parameters">統合ランタイム エラー パラメーターを管理します。</param>
        <param name="activityId">操作要求のアクティビティ id。</param>
        <summary>
            ManagedIntegrationRuntimeOperationResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            操作の種類を取得します。 開始する、または停止できませんでした。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
