<Type Name="SquareLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.SquareLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SquareLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="host">Square インスタンスの URL。 (例: mystore.mysquare.com)</param>
        <param name="clientId">Square アプリケーションに関連付けられているクライアント ID。</param>
        <param name="redirectUri">Square アプリケーションのダッシュボードで割り当てられるリダイレクト URL。 (例: http://localhost:2500)</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="clientSecret">Square アプリケーションに関連付けられているクライアント シークレット。</param>
    ...
    <Member MemberName="ClientId">
      ...
      <Docs>
        <summary>
            取得または、正方形のアプリケーションに関連付けられたクライアント ID を設定します。
            </summary>
    ...
    <Member MemberName="ClientSecret">
      ...
      <Docs>
        <summary>
            取得または、正方形のアプリケーションに関連付けられたクライアント シークレットを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            取得または四角形のインスタンスの URL を設定します。 (例: mystore.mysquare.com)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RedirectUri">
      ...
      <Docs>
        <summary>
            取得または四角形のアプリケーションのダッシュ ボードに割り当てられているリダイレクト URL を設定します。 (例: http://localhost:2500)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
