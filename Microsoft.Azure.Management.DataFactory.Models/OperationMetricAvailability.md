<Type Name="OperationMetricAvailability" FullName="Microsoft.Azure.Management.DataFactory.Models.OperationMetricAvailability">
  ...
  <Docs>
    <summary>
            どのくらいの頻度が定義されたメトリックのデータができるようになります。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            OperationMetricAvailability クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="timeGrain">メトリックの粒度。</param>
        <param name="blobDuration">顧客のストレージ アカウントの 1 時間あたりに作成された blob です。</param>
        <summary>
            OperationMetricAvailability クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BlobDuration">
      ...
      <Docs>
        <summary>
            取得または顧客のストレージ アカウントの 1 時間あたりに作成された blob を設定します。
            </summary>
