<Type Name="DatasetZipDeflateCompression" FullName="Microsoft.Azure.Management.DataFactory.Models.DatasetZipDeflateCompression">
  ...
  <Docs>
    <summary>
            データセットで使用される ZipDeflate 圧縮メソッド。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DatasetZipDeflateCompression クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="level">ZipDeflate 圧縮レベルです。 使用可能な値が含まれます: 'Optimal'、'Fastest'</param>
        <summary>
            DatasetZipDeflateCompression クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            取得または ZipDeflate 圧縮レベルを設定します。 使用可能な値が含まれます: 'Optimal'、'Fastest'
            </summary>
