<Type Name="OperationServiceSpecification" FullName="Microsoft.Azure.Management.DataFactory.Models.OperationServiceSpecification">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            OperationServiceSpecification クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="logSpecifications">ログに関連する操作についての詳細。</param>
        <param name="metricSpecifications">メトリックに関連する操作についての詳細。</param>
        <summary>
            OperationServiceSpecification クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
