<Type Name="PaypalLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.PaypalLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PaypalLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="host">PayPal インスタンスの URL。 (つまり api.sandbox.paypal.com)</param>
        <param name="clientId">PayPal アプリケーションに関連付けられているクライアント ID。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="clientSecret">PayPal アプリケーションに関連付けられているクライアント シークレット。</param>
    ...
    <Member MemberName="ClientId">
      ...
      <Docs>
        <summary>
            取得または PayPal アプリケーションに関連付けられたクライアント ID を設定します。
            </summary>
    ...
    <Member MemberName="ClientSecret">
      ...
      <Docs>
        <summary>
            取得または PayPal アプリケーションに関連付けられたクライアント シークレットを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            取得または PayPal インスタンスの URL を設定します。 (つまり api.sandbox.paypal.com)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
