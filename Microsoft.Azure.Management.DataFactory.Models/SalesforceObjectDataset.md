<Type Name="SalesforceObjectDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.SalesforceObjectDataset">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SalesforceObjectDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="objectApiName">Salesforce オブジェクト API の名前。 型: 文字列 (または式の resultType 文字列)。</param>
        <summary>
            SalesforceObjectDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ObjectApiName">
      ...
      <Docs>
        <summary>
            取得または Salesforce オブジェクト API の名前を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
