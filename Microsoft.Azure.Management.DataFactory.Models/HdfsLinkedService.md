<Type Name="HdfsLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.HdfsLinkedService">
  ...
  <Docs>
    <summary>
            Hadoop 分散ファイル システム (HDFS) にリンクされたサービスを指定します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            HdfsLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="url">HDFS の URL はサービス エンドポイント、に対する http://myhostname:50070/webhdfs/v1 の例です。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="authenticationType">HDFS への接続に使用される認証の種類です。 指定できる値は: 匿名と Windows です。
        ...
        <param name="userName">Windows 認証のユーザー名。 型: 文字列 (または式の resultType 文字列)。</param>
        <param name="password">Windows 認証のパスワード。</param>
        <summary>
            HdfsLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AuthenticationType">
      ...
      <Docs>
        <summary>
            取得または、HDFS への接続に使用される認証の種類を設定します。
            指定できる値は: 匿名と Windows です。 型: 文字列 (または式の resultType 文字列)。
            </summary>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            取得または HDFS のサービス エンドポイントに対する http://myhostname:50070/webhdfs/v1 のなどの URL を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            取得または Windows 認証のユーザー名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
