<Type Name="AzureSqlDWTableDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureSqlDWTableDataset">
  ...
  <Docs>
    <summary>
            Azure SQL Data Warehouse のデータセットです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AzureSqlDWTableDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tableName">Azure SQL データ ウェアハウスのテーブル名。 型: 文字列 (または式の resultType 文字列)。</param>
    ...
    <Member MemberName="TableName">
      ...
      <Docs>
        <summary>
            取得または Azure SQL データ ウェアハウスのテーブル名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
