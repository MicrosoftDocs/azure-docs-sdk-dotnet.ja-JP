<Type Name="MagentoLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.MagentoLinkedService">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="host">Magento インスタンスの URL。 (つまり 192.168.222.110/magento3)</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="accessToken">Magento のアクセス トークン。</param>
    ...
    <Member MemberName="AccessToken">
      ...
      <Docs>
        <summary>
            取得または Magento からアクセス トークンを設定します。
            </summary>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            取得または Magento インスタンスの URL を設定します。 (つまり 192.168.222.110/magento3)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
