<Type Name="ODataResourceDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.ODataResourceDataset">
  ...
  <Docs>
    <summary>
            Open Data Protocol (OData) リソース データセットです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ODataResourceDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="path">OData のリソース パス。 型: 文字列 (または式の resultType 文字列)。</param>
        <summary>
            ODataResourceDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
            取得または OData リソース パスを設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
