<Type Name="DocumentDbCollectionDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.DocumentDbCollectionDataset">
  ...
  <Docs>
    <summary>
            Microsoft Azure ドキュメント データベース コレクション データセットです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DocumentDbCollectionDataset クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="collectionName">データベース コレクション名を文書化します。
    ...
    <Member MemberName="CollectionName">
      ...
      <Docs>
        <summary>
            取得またはドキュメント データベース コレクション名を設定します。 型: 文字列 (または式の resultType 文字列)。
            </summary>
