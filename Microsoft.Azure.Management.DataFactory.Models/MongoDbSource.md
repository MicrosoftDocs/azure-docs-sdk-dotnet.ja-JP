<Type Name="MongoDbSource" FullName="Microsoft.Azure.Management.DataFactory.Models.MongoDbSource">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MongoDbSource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="query">データベースのクエリ。 SQL 92 クエリ式にする必要があります。 型: 文字列 (または式の resultType 文字列)。</param>
        <summary>
            MongoDbSource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            取得またはデータベース クエリを設定します。 SQL 92 クエリ式にする必要があります。
