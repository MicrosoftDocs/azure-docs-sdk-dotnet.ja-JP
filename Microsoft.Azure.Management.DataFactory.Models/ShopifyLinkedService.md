<Type Name="ShopifyLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.ShopifyLinkedService">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ShopifyLinkedService クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="host">Shopify サーバーのエンドポイント。 (つまり mystore.myshopify.com)</param>
        <param name="additionalProperties">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</param>
        <param name="connectVia">統合のランタイム参照。</param>
        <param name="description">リンクされたサービスの説明。</param>
        <param name="accessToken">Shopify のデータへのアクセスに使用する API アクセス トークン。 トークンは、オフライン モードである場合に有効期限はありません。</param>
    ...
    <Member MemberName="AccessToken">
      ...
      <Docs>
        <summary>
            取得または Shopify のデータにアクセスするために使用できる API アクセス トークンを設定します。 トークンは、オフライン モードである場合に有効期限はありません。
            </summary>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            取得または Shopify サーバーのエンドポイントを設定します。 (つまり mystore.myshopify.com)
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
