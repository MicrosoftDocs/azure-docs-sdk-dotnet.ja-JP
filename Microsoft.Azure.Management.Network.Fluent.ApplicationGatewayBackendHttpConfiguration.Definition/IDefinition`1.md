<Type Name="IDefinition&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayBackendHttpConfiguration.Definition.IDefinition&lt;ReturnT&gt;">
  ...
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="57fde-101">この定義をアタッチした後に戻るには、親アプリケーション ゲートウェイ定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="57fde-101">The stage of the parent application gateway definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="57fde-102">アプリケーション ゲートウェイ バックエンド HTTP 構成の定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="57fde-102">The entirety of an application gateway backend HTTP configuration definition.</span></span>
            </summary>
