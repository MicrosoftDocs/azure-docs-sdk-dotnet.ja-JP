<Type Name="ConnectionEventArgs" FullName="Microsoft.Azure.Devices.Client.Transport.ConnectionEventArgs">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a86c5-101">DeviceClient に tranpsort から情報を渡すための接続イベントの引数</span><span class="sxs-lookup"><span data-stu-id="a86c5-101">Connection event arguments for passing information from tranpsort to DeviceClient</span></span>
            </summary>
