<Type Name="KeywordTokenizerV2" FullName="Microsoft.Azure.Search.Models.KeywordTokenizerV2">
  ...
  <Docs>
    <summary>
            1 つのトークンとして入力全体を出力します。 このトークナイザは、Apache Lucene を使用して実装されます。
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            KeywordTokenizerV2 クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="maxTokenLength">トークンの最大長。 既定値は
            256. トークンの最大長を超えては分割されます。 使用できる最大トークン長は、300 文字です。</param>
        <summary>
            KeywordTokenizerV2 クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="MaxTokenLength">
      ...
      <Docs>
        <summary>
            取得または最大トークン長を設定します。 既定値は 256 です。 トークンの最大長を超えては分割されます。 使用できる最大トークン長は、300 文字です。
            </summary>
