<Type Name="TagScoringFunction" FullName="Microsoft.Azure.Search.Models.TagScoringFunction">
  ...
  <Docs>
    <summary>
            指定されたタグのリストに一致する文字列値を持つドキュメントのスコアをブーストする関数を定義します。
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            TagScoringFunction クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="parameters">タグのスコア付け関数のパラメーター値。</param>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            取得またはタグのスコア付け関数のパラメーターの値を設定します。
            </summary>
