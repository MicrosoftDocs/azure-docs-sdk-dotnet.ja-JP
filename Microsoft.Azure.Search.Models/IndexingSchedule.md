<Type Name="IndexingSchedule" FullName="Microsoft.Azure.Search.Models.IndexingSchedule">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            IndexingSchedule クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="interval">インデクサー実行間の時間間隔。</param>
        <param name="startTime">インデクサーを開始する時刻を実行しています。</param>
        <summary>
            IndexingSchedule クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
