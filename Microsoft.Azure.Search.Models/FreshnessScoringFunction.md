<Type Name="FreshnessScoringFunction" FullName="Microsoft.Azure.Search.Models.FreshnessScoringFunction">
  ...
  <Docs>
    <summary>
            日付と時刻のフィールドの値に基づいてスコアをブーストする関数を定義します。
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            FreshnessScoringFunction クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="parameters">Freshness スコア付け関数のパラメーターの値。</param>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            取得または freshness スコア付け関数のパラメーターの値を設定します。
            </summary>
