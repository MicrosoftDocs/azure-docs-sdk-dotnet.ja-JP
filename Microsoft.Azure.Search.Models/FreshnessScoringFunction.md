<Type Name="FreshnessScoringFunction" FullName="Microsoft.Azure.Search.Models.FreshnessScoringFunction">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8549e-101">日付と時刻のフィールドの値に基づいてスコアをブーストする関数を定義します。</span><span class="sxs-lookup"><span data-stu-id="8549e-101">Defines a function that boosts scores based on the value of a date-time field.</span></span>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8549e-102">FreshnessScoringFunction クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="8549e-102">Initializes a new instance of the FreshnessScoringFunction class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="fieldName"><span data-ttu-id="8549e-103">スコア付け関数への入力として使用されるフィールドの名前。</span><span class="sxs-lookup"><span data-stu-id="8549e-103">The name of the field used as input to the scoring function.</span></span></param>
        <param name="boost"><span data-ttu-id="8549e-104">生のスコアの乗数。</span><span class="sxs-lookup"><span data-stu-id="8549e-104">A multiplier for the raw score.</span></span> <span data-ttu-id="8549e-105">解除する必要が正の数値 1.0 に等しくします。</span><span class="sxs-lookup"><span data-stu-id="8549e-105">Must be a positive number not equal to 1.0.</span></span></param>
        <param name="parameters"><span data-ttu-id="8549e-106">Freshness スコア付け関数のパラメーターの値。</span><span class="sxs-lookup"><span data-stu-id="8549e-106">Parameter values for the freshness scoring function.</span></span></param>
        <param name="interpolation"><span data-ttu-id="8549e-107">どのブースティングはするで補間ドキュメントのスコアを示す値既定値は「線形」です。</span><span class="sxs-lookup"><span data-stu-id="8549e-107">A value indicating how boosting will be interpolated across document scores; defaults to "Linear".</span></span> <span data-ttu-id="8549e-108">使用可能な値が含まれます: 'linear'、'定数'、'二次'、'対数'</span><span class="sxs-lookup"><span data-stu-id="8549e-108">Possible values include: 'linear', 'constant', 'quadratic', 'logarithmic'</span></span></param>
        <summary>
            <span data-ttu-id="8549e-109">FreshnessScoringFunction クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="8549e-109">Initializes a new instance of the FreshnessScoringFunction class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="8549e-110">FreshnessScoringFunction クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="8549e-110">Initializes a new instance of the FreshnessScoringFunction class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8549e-111">取得または freshness スコア付け関数のパラメーターの値を設定します。</span><span class="sxs-lookup"><span data-stu-id="8549e-111">Gets or sets parameter values for the freshness scoring function.</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8549e-112">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="8549e-112">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="8549e-113">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="8549e-113">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
