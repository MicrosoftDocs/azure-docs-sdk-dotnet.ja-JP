<Type Name="HighWaterMarkChangeDetectionPolicy" FullName="Microsoft.Azure.Search.Models.HighWaterMarkChangeDetectionPolicy">
  ...
  <Docs>
    <summary>
            ハイ ウォーターマークの列の値に基づいて変更をキャプチャするデータ変更検出ポリシーを定義します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            HighWaterMarkChangeDetectionPolicy クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="highWaterMarkColumnName">ハイ ウォーターマーク列の名前。</param>
        <summary>
            HighWaterMarkChangeDetectionPolicy クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="HighWaterMarkColumnName">
      ...
      <Docs>
        <summary>
            取得または high watermark 列の名前を設定します。
            </summary>
