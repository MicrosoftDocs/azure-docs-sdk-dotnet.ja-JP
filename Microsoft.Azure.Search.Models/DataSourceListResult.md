<Type Name="DataSourceListResult" FullName="Microsoft.Azure.Search.Models.DataSourceListResult">
  ...
  <Docs>
    <summary>
            データソースの一覧表示要求から応答します。 成功した場合は、すべてのデータ ソースの完全定義が含まれます。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DataSourceListResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="dataSources">Search サービスでデータ ソース。</param>
        <summary>
            DataSourceListResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
