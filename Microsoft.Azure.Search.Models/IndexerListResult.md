<Type Name="IndexerListResult" FullName="Microsoft.Azure.Search.Models.IndexerListResult">
  ...
  <Docs>
    <summary>
            インデクサーの一覧の要求から応答します。 成功した場合は、すべてのインデクサーの完全定義が含まれます。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            IndexerListResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="indexers">Search サービスのインデクサーです。</param>
        <summary>
            IndexerListResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
