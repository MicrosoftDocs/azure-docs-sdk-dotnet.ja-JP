<Type Name="MagnitudeScoringFunction" FullName="Microsoft.Azure.Search.Models.MagnitudeScoringFunction">
  ...
  <Docs>
    <summary>
            数値フィールドの大きさに基づくスコアをブーストする関数を定義します。
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MagnitudeScoringFunction クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="parameters">Magnitude スコア付け関数のパラメーターの値。</param>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            取得または magnitude スコア付け関数のパラメーターの値を設定します。
            </summary>
