<Type Name="DistanceScoringParameters" FullName="Microsoft.Azure.Search.Models.DistanceScoringParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DistanceScoringParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="referencePointParameter">パラメーターの名前は、参照場所を指定して検索クエリで渡されます。</param>
        <param name="boostingDistance">ブースト範囲が終了する参照位置からキロメートル単位の距離。</param>
        <summary>
            DistanceScoringParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BoostingDistance">
      ...
      <Docs>
        <summary>
            取得またはキロメートル単位でブースト範囲が終了する参照位置からの距離を設定します。
            </summary>
    ...
    <Member MemberName="ReferencePointParameter">
      ...
      <Docs>
        <summary>
            取得または参照の場所を指定する検索クエリで渡されるパラメーターの名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
