<Type Name="ShingleTokenFilter" FullName="Microsoft.Azure.Search.Models.ShingleTokenFilter">
  ...
  <Docs>
    <summary>
            1 つのトークンとトークンの組み合わせを作成します。 このトークンのフィルターは、Apache Lucene を使用して実装されます。
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ShingleTokenFilter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="maxShingleSize">うろこの最大サイズ。 既定値と最小値は 2 です。</param>
        <param name="minShingleSize">うろこの最小サイズです。 既定値と最小値は 2 です。 MaxShingleSize の値よりも小さい必要があります。</param>
        <param name="outputUnigrams">根だけでなく、出力ストリームが、入力トークン (unigram) を含めるかどうかを示す値。 既定値は true です。</param>
        <param name="outputUnigramsIfNoShingles">ありません根を使用できる場合も unigram を出力するかどうかを示す値。
            このプロパティは outputUnigrams が false に設定されている場合よりも優先されます。
            既定値は false です。</param>
        <param name="tokenSeparator">隣接するトークンを結合するときに使用して、うろこを形成する文字列。 既定値は 1 つのスペース ("") です。</param>
        <param name="filterToken">先の各位置に挿入する文字列には、トークンがありません。 既定では、アンダー スコア (「_ _」) です。</param>
        <summary>
            ShingleTokenFilter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="FilterToken">
      ...
      <Docs>
        <summary>
            取得または設定するトークンがありませんの位置ごとに挿入する文字列。 既定では、アンダー スコア (「_ _」) です。
            </summary>
    ...
    <Member MemberName="MinShingleSize">
      ...
      <Docs>
        <summary>
            取得またはうろこの最小サイズを設定します。 既定値と最小値
            2. MaxShingleSize の値よりも小さい必要があります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OutputUnigrams">
      ...
      <Docs>
        <summary>
            取得または根だけでなく、出力ストリームが、入力トークン (unigram) を含めるかどうかを示す値を設定します。 既定値は true です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OutputUnigramsIfNoShingles">
      ...
      <Docs>
        <summary>
            取得またはない根を使用できる場合も unigram を出力するかどうかを示す値を設定します。 このプロパティは outputUnigrams が false に設定されている場合よりも優先されます。 既定値は false です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TokenSeparator">
      ...
      <Docs>
        <summary>
            取得または設定を隣接するトークンを結合するときに使用して、うろこを形成する文字列。 既定値は 1 つのスペース ("") です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
