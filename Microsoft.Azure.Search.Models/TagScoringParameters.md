<Type Name="TagScoringParameters" FullName="Microsoft.Azure.Search.Models.TagScoringParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            TagScoringParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tagsParameter">パラメーターの名前は、対象のフィールドと比較するタグの一覧を指定する検索クエリで渡されます。</param>
        <summary>
            TagScoringParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TagsParameter">
      ...
      <Docs>
        <summary>
            取得または対象のフィールドと比較するタグの一覧を指定する検索クエリで渡されるパラメーターの名前を設定します。
            </summary>
