<Type Name="CorsOptions" FullName="Microsoft.Azure.Search.Models.CorsOptions">
  ...
  <Docs>
    <summary>
            インデックスのクロス オリジン リソース共有 (CORS) を制御するオプションを定義します。
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="allowedOrigins">どの JavaScript からコードがアクセスを許可する、インデックスにオリジンのリスト。 ://{プロトコル} のフォームのホストの一覧を含めることができる {完全修飾ドメイン-名} [: {ポート番号}]、または 1 つの ' *' (推奨しません) すべてのオリジンを許可します。</param>
        <param name="maxAgeInSeconds">ブラウザーが CORS プレフライト応答をキャッシュする期間です。 既定値は 5 分後です。</param>
        <summary>
            CorsOptions クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AllowedOrigins">
      ...
      <Docs>
        <summary>
            取得または元の JavaScript コードがアクセスを許可する、インデックスにオリジンのリストを設定します。 ://{プロトコル} のフォームのホストの一覧を含めることができる {完全修飾ドメイン-名} [: {ポート番号}]、または 1 つの ' *' (推奨しません) すべてのオリジンを許可します。
            </summary>
    ...
    <Member MemberName="MaxAgeInSeconds">
      ...
      <Docs>
        <summary>
            取得またはブラウザーが CORS プレフライト応答をキャッシュする期間を設定します。 既定値は 5 分後です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
