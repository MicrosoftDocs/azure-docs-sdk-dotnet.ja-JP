<Type Name="ReliableCollectionsActorStateProvider" FullName="Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider">
  ...
  <Docs>
    <summary>
      <see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" />現在プレビュー中です。
            実装を提供<see cref="T:Microsoft.ServiceFabric.Actors.Runtime.IActorStateProvider" />使用<see cref="T:Microsoft.ServiceFabric.Data.IReliableStateManager" />を保存し、アクターの状態を維持します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
          <see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" />現在プレビュー中です。
             ReliableCollectionsActorStateProvider クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="stateManagerConfig">
            A<see cref="T:Microsoft.ServiceFabric.Data.ReliableStateManagerConfiguration" />を説明する<see cref="T:Microsoft.ServiceFabric.Data.IReliableStateManager" />構成します。 
            </param>
        <summary>
          <see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" />現在プレビュー中です。
            ReliableCollectionsActorStateProvider クラスの新しいインスタンスを初期化します。
            with には、構成を指定します。 これは現在プレビュー段階です。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="actorStateDictionaryCount">
            数<see cref="T:Microsoft.ServiceFabric.Data.Collections.IReliableDictionary2`2" />状態のパーティション分割し、格納されているをアクターにします。
            </param>
        <param name="reminderDictionaryCount">
            数<see cref="T:Microsoft.ServiceFabric.Data.Collections.IReliableDictionary2`2" />間でどのアラームをパーティション分割し、保存されます。
            </param>
        <summary>
          <see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" />現在プレビュー中です。
            指定された構成で ReliableDictionaryActorStateProvider クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>
            値を<paramref name="actorStateDictionaryCount" />と<paramref name="reminderDictionaryCount" />を指定できます 1 度だけ最初のアクター サービスを作成するときにします。 その後変更することはできませんと<see cref="T:Microsoft.ServiceFabric.Actors.Runtime.ReliableCollectionsActorStateProvider" />最初の時間と異なる点は、任意の値は無視されます。
            </remarks>
      </Docs>
    </Member>
