<Type Name="ErrorMessage" FullName="Microsoft.Azure.Batch.Protocol.Models.ErrorMessage">
  ...
  <Docs>
    <summary>
            Azure Batch のエラー応答で受信したエラー メッセージ。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ErrorMessage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="lang">エラー メッセージの言語コード</param>
        <param name="value">メッセージのテキストです。</param>
        <summary>
            ErrorMessage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
