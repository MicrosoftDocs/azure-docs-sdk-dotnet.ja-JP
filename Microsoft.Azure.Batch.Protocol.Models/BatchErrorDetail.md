<Type Name="BatchErrorDetail" FullName="Microsoft.Azure.Batch.Protocol.Models.BatchErrorDetail">
  ...
  <Docs>
    <summary>
            Azure Batch のエラー応答に含まれる追加の情報の項目です。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="key">Value プロパティの意味を指定する識別子。</param>
        <param name="value">エラー応答に含まれている追加情報。</param>
        <summary>
            BatchErrorDetail クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Key">
      ...
      <Docs>
        <summary>
            取得または Value プロパティの意味を指定する識別子を設定します。
            </summary>
