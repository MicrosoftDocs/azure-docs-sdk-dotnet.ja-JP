  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="creationTime">ファイルの作成時刻。</param>
        <param name="contentType">ファイルのコンテンツの種類。</param>
        <param name="fileMode">8 進数形式でファイル モード属性です。</param>
        <summary>
            FileProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="FileMode">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>
            ファイル モードが Linux 計算ノード上のファイルに対してのみ返されます。
            </remarks>
      </Docs>
    </Member>
