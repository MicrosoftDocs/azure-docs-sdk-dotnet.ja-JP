<Type Name="JobScheduleStatistics" FullName="Microsoft.Azure.Batch.Protocol.Models.JobScheduleStatistics">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            JobScheduleStatistics クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="userCPUTime">ユーザー モード CPU 時間の合計 (すべてのコアとすべてのコンピューティング ノード間で合計) のスケジュール の下に作成されたすべてのジョブのすべてのタスクで使用します。</param>
        <param name="kernelCPUTime">カーネル モード CPU 時間の合計 (すべてのコアとすべてのコンピューティング ノード間で合計) のスケジュール の下に作成されたすべてのジョブのすべてのタスクで使用します。</param>
        <param name="wallClockTime">スケジュールの下に作成されたすべてのジョブ内のすべてのタスクの合計のウォール クロック時間。</param>
        <param name="readIOps">ディスクの合計数は、スケジュールで作成されたすべてのジョブ内のすべてのタスクで行われる操作を読み取る。</param>
        <param name="writeIOps">ディスクの合計数は、スケジュールで作成されたすべてのジョブ内のすべてのタスクで行われる操作を記述します。</param>
        <param name="readIOGiB">合計 gibibytes は、スケジュールで作成されたすべてのジョブ内のすべてのタスクでは、ディスクから読み取られます。</param>
        <param name="writeIOGiB">スケジュールで作成されたすべてのジョブのすべてのタスクによってディスクに書き込まれた合計 gibibytes です。</param>
        <param name="numSucceededTasks">スケジュールの下に作成されたジョブで指定された期間内に正常に完了したタスクの合計数。 終了コード 0 が返された場合、タスクが正常に完了します。</param>
        <param name="numFailedTasks">指定された期間のスケジュール の下に作成されたジョブの中に失敗したタスクの合計数。 終了コード 0 を返さずに、最大再試行回数が不足している場合、タスクが失敗します。</param>
        <param name="numTaskRetries">スケジュールで作成されたすべてのジョブのすべてのタスクで指定した時間の範囲の中に再試行回数の合計です。</param>
        <param name="waitTime">合計は、すべてのタスクのスケジュールで作成されたすべてのジョブに時間を待機します。 タスクの待機時間は、タスクの作成とタスクの実行の開始までの経過時間として定義されます。 (失敗したため、タスクが再試行された場合、待機時間は、最新のタスクの実行にかかる時間です。)</param>
        <summary>
            JobScheduleStatistics クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="KernelCPUTime">
      ...
      <Docs>
        <summary>
            取得またはカーネル モード CPU 時間の合計を設定 (すべてのコアとすべてのコンピューティング ノード間で合計) のスケジュール の下に作成されたすべてのジョブのすべてのタスクで使用します。
            </summary>
    ...
    <Member MemberName="NumFailedTasks">
      ...
      <Docs>
        <summary>
            取得または指定された期間のスケジュール の下に作成されたジョブの中に失敗したタスクの合計数を設定します。 終了コード 0 を返さずに、最大再試行回数が不足している場合、タスクが失敗します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NumSucceededTasks">
      ...
      <Docs>
        <summary>
            取得または指定された期間のスケジュール の下に作成されたジョブの中に正常に完了したタスクの合計数を設定します。 終了コード 0 が返された場合、タスクが正常に完了します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NumTaskRetries">
      ...
      <Docs>
        <summary>
            取得またはスケジュールで作成されたすべてのジョブ内のすべてのタスクで指定された期間中に再試行の合計数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadIOGiB">
      ...
      <Docs>
        <summary>
            取得またはスケジュールで作成されたすべてのジョブ内のすべてのタスクによってディスクから読み取られた合計 gibibytes を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadIOps">
      ...
      <Docs>
        <summary>
            取得または読み取り操作のスケジュールで作成されたすべてのジョブのすべてのタスクによって行われたディスクの合計数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserCPUTime">
      ...
      <Docs>
        <summary>
            取得または設定、ユーザー モード CPU 時間の合計 (すべてのコアとすべてのコンピューティング ノード間で合計) のスケジュール の下に作成されたすべてのジョブのすべてのタスクで使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WaitTime">
      ...
      <Docs>
        <summary>
            取得またはスケジュールで作成されたすべてのジョブのすべてのタスクの合計待機時間を設定します。 タスクの待機時間は、タスクの作成とタスクの実行の開始までの経過時間として定義されます。 (失敗したため、タスクが再試行された場合、待機時間は、最新のタスクの実行にかかる時間です。)
            </summary>
        <value>To be added.</value>
        <remarks>
            この値は、アカウントの有効期間の統計情報です。 で報告のみジョブの統計は含まれません。
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="WallClockTime">
      ...
      <Docs>
        <summary>
            取得またはスケジュールの下に作成されたすべてのジョブのすべてのタスクの合計のウォール クロック時間を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            ウォール クロック時間は、タスクが完了すると、コンピューティング ノードで実行されている開始されたときにからの経過時間 (または最後に統計が更新されました、そのタスクが完了していない場合)。
            タスクが再試行された場合は、すべてのタスク再試行のウォール クロック時間が含まれます。
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="WriteIOGiB">
      ...
      <Docs>
        <summary>
            取得またはスケジュールで作成されたすべてのジョブのすべてのタスクによってディスクに書き込まれた合計 gibibytes を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WriteIOps">
      ...
      <Docs>
        <summary>
            取得またはスケジュールで作成されたすべてのジョブのすべてのタスクによって行われたディスク書き込み操作の合計数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
