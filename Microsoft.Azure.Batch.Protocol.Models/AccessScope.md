<Type Name="AccessScope" FullName="Microsoft.Azure.Batch.Protocol.Models.AccessScope">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8b5e3-101">AccessScope の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="8b5e3-101">Defines values for AccessScope.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Job">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8b5e3-102">タスクを含むジョブのすべての操作を実行するへのアクセス許可を付与します。</span><span class="sxs-lookup"><span data-stu-id="8b5e3-102">Grants access to perform all operations on the job containing the task.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
