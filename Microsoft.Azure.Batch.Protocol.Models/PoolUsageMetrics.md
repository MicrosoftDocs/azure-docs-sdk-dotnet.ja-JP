<Type Name="PoolUsageMetrics" FullName="Microsoft.Azure.Batch.Protocol.Models.PoolUsageMetrics">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PoolUsageMetrics クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="poolId">このエントリであるメトリックが集計されて、プールの ID。</param>
        <param name="startTime">このエントリに含まれる集計範囲の開始時刻です。</param>
        <param name="endTime">このエントリに含まれる集計範囲の終了時刻。</param>
        <param name="vmSize">プール内の仮想マシンのサイズ。 プール内のすべての Vm は、同じサイズです。</param>
        <param name="totalCoreHours">この集計間隔の間に、プールで使用される合計コア時間。</param>
        <param name="dataIngressGiB">GiB で、この間隔中に、プールにクロス データ センター ネットワーク受信します。</param>
        <param name="dataEgressGiB">間のデータ センター ネットワーク送信 GiB で、この間隔の間にプールからです。</param>
        <summary>
            PoolUsageMetrics クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DataEgressGiB">
      ...
      <Docs>
        <summary>
            取得または設定間のデータ センター ネットワーク出口プール GiB で、この間隔中にします。
            </summary>
    ...
    <Member MemberName="DataIngressGiB">
      ...
      <Docs>
        <summary>
            取得または設定間のデータ センター ネットワーク受信プール GiB で、この間隔中にします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            取得または、このエントリに含まれる集計範囲の終了時刻を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PoolId">
      ...
      <Docs>
        <summary>
            取得またはメトリックが集計されて、プールの ID をこのエントリに設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            取得または、このエントリに含まれる集計範囲の開始時刻を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TotalCoreHours">
      ...
      <Docs>
        <summary>
            取得またはこの集計間隔の間に、プールで使用される合計コア時間を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
