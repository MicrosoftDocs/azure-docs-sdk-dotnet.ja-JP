<Type Name="JobListFromJobScheduleOptions" FullName="Microsoft.Azure.Batch.Protocol.Models.JobListFromJobScheduleOptions">
  ...
  <Docs>
    <summary>
            ListFromJobSchedule 操作に追加のパラメーターです。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="filter">OData $filter 句の場合です。 このフィルターを構築する方法については、https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-jobs-in-a-job-schedule を参照してください。</param>
    ...
    <Member MemberName="Filter">
      ...
      <Docs>
        <summary>
            取得または OData $filter 句を設定します。 このフィルターを構築する方法については、https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch#list-jobs-in-a-job-schedule を参照してください。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
