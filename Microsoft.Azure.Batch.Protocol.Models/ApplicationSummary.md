<Type Name="ApplicationSummary" FullName="Microsoft.Azure.Batch.Protocol.Models.ApplicationSummary">
  ...
  <Docs>
    <summary>
            Azure Batch アカウントに、アプリケーションの情報が含まれています。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ApplicationSummary クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="versions">アプリケーションの使用可能なバージョンの一覧。</param>
        <summary>
            ApplicationSummary クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Versions">
      ...
      <Docs>
        <summary>
            取得または使用可能なバージョンのアプリケーションの一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
