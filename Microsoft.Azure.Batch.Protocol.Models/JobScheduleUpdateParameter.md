<Type Name="JobScheduleUpdateParameter" FullName="Microsoft.Azure.Batch.Protocol.Models.JobScheduleUpdateParameter">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            JobScheduleUpdateParameter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="jobSpecification">このスケジュールを作成するジョブの詳細です。</param>
        <param name="metadata">メタデータとしてジョブのスケジュールに関連付けられている名前と値のペアの一覧。</param>
        <summary>
            JobScheduleUpdateParameter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="JobSpecification">
      ...
      <Docs>
        ...
        <remarks>
            更新プログラムでは、更新が行われた後に開始されたジョブのみに影響します。 現在アクティブなジョブは、古い指定で続行します。
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Metadata">
      ...
      <Docs>
        <summary>
            取得またはメタデータとしてジョブのスケジュールに関連付けられている名前と値のペアの一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            この要素を指定しないと、一覧が空の既定値になります実際には、既存のメタデータが削除されます。
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Schedule">
      ...
      <Docs>
        ...
        <value>To be added.</value>
        <remarks>
            この要素を指定しない場合と同じであるに渡す場合、既定のスケジュール: すぐに実行するのには、1 つのジョブがスケジュールされています。
            </remarks>
      </Docs>
    </Member>
