<Type Name="NodeFile" FullName="Microsoft.Azure.Batch.Protocol.Models.NodeFile">
  ...
  <Docs>
    <summary>
            コンピューティング ノードのファイルまたはディレクトリに関する情報。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">ファイルのパス。</param>
        <param name="url">ファイルの URL です。</param>
        <param name="isDirectory">かどうか、オブジェクトは、ディレクトリを表します。</param>
        <param name="properties">ファイルのプロパティ。</param>
        <summary>
            NodeFile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
