<Type Name="OutputFileUploadOptions" FullName="Microsoft.Azure.Batch.Protocol.Models.OutputFileUploadOptions">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            OutputFileUploadOptions クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="uploadCondition">ファイルまたはファイルのセットに、タスクが出力される条件をアップロードする必要があります。</param>
        <summary>
            OutputFileUploadOptions クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="UploadCondition">
      ...
      <Docs>
        <summary>
            取得または設定の条件をタスクの出力ファイルまたはファイルのセットをアップロードする必要があります。
            </summary>
        <value>To be added.</value>
        <remarks>
            既定値は、taskCompletion です。 使用可能な値が含まれます: 'taskSuccess'、'タスク失敗'、'taskCompletion'
            </remarks>
      </Docs>
    </Member>
