<Type Name="UpgradeRecommendedElasticPoolProperties" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.UpgradeRecommendedElasticPoolProperties">
  ...
  <Docs>
    <summary>
            Azure SQL 推奨弾力性プールのアップグレードされるプロパティを表します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            UpgradeRecommendedElasticPoolProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Azure SQL 推奨弾力性プールのアップグレード中の名前。</param>
        <param name="edition">Azure SQL 推奨弾力性プールのアップグレード中のターゲットのエディションです。 使用可能な値が含まれます: 'Basic'、'Standard'、'Premium'</param>
        <param name="dtu">Azure SQL 推奨弾力性プールのアップグレード中の DTU 保証します。</param>
        <param name="storageMb">記憶域の上限 (MB)、Azure SQL 推奨弾力性プールのアップグレード中です。</param>
        <param name="databaseDtuMin">Azure SQL 推奨弾力性プールのアップグレード中のデータベースの DTU 保証します。</param>
        <param name="databaseDtuMax">Azure SQL 推奨弾力性プールのアップグレード中のデータベースの DTU 上限です。</param>
        <param name="databaseCollection">Azure SQL 推奨弾力性プールのアップグレード中に格納するデータベース名のリスト。</param>
        <param name="includeAllDatabases">取得または Azure SQL 推奨弾力性プールに格納するすべてのデータベースがアップグレードされているかどうかを設定します。</param>
        <summary>
            UpgradeRecommendedElasticPoolProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DatabaseCollection">
      ...
      <Docs>
        <summary>
            取得または Azure SQL 推奨弾力性プールのアップグレード中に格納するデータベース名の一覧を設定します。
            </summary>
    ...
    <Member MemberName="DatabaseDtuMax">
      ...
      <Docs>
        <summary>
            取得または Azure SQL 推奨弾力性プールのアップグレード中のデータベースの DTU 上限を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseDtuMin">
      ...
      <Docs>
        <summary>
            取得または Azure SQL 推奨弾力性プールのアップグレード中のデータベースの DTU 保証を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Dtu">
      ...
      <Docs>
        <summary>
            取得または Azure SQL 推奨弾力性プールのアップグレード中の DTU 保証を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Edition">
      ...
      <Docs>
        <summary>
            取得または Azure SQL 推奨弾力性プールのアップグレード中、ターゲットのエディションを設定します。 使用可能な値が含まれます: 'Basic'、'Standard'、'Premium'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IncludeAllDatabases">
      ...
      <Docs>
        <summary>
            取得または Azure SQL 推奨弾力性プールに格納するすべてのデータベースがアップグレードされているかどうかを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得または Azure SQL 推奨弾力性プールのアップグレード中の名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageMb">
      ...
      <Docs>
        <summary>
            取得または MB で、Azure SQL 推奨弾力性プールのアップグレード中の記憶域の上限を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
