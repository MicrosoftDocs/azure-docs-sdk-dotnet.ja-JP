<Type Name="ServiceObjectiveInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.ServiceObjectiveInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ServiceObjectiveInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="serviceObjectiveName">サービス目標の名前。</param>
        <param name="isDefault">サービス レベル目標が既定のサービス目標かどうかを取得します。</param>
        <param name="isSystem">サービス レベル目標がシステムのサービス目標かどうかを取得します。</param>
        <param name="description">サービス レベル目標の説明です。</param>
        <param name="enabled">サービス レベル目標が有効になっているかどうかを取得します。</param>
        <summary>
            ServiceObjectiveInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IsDefault">
      ...
      <Docs>
        <summary>
            サービス レベル目標が既定のサービス目標かどうかを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsSystem">
      ...
      <Docs>
        <summary>
            サービス レベル目標がシステムのサービス目標かどうかを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
