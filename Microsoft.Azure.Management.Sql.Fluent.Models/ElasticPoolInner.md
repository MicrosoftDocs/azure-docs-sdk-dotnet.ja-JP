<Type Name="ElasticPoolInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.ElasticPoolInner">
  ...
  <Docs>
    <summary>
            Azure SQL Database の弾力性プールを表します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="creationDate">Azure SQL 弾力性プール (ISO8601 形式) の作成日。</param>
        <param name="state">Azure SQL 弾力性プールの状態。
            使用可能な値が含まれます: '作成中'、'準備完了'、'Disabled'</param>
        <param name="edition">Azure SQL 弾力性プールのエディションです。
            使用可能な値が含まれます: 'Basic'、'Standard'、'Premium'</param>
        ...
        <param name="databaseDtuMin">最小の DTU のすべての SQL Azure データベースのことが保証されます。</param>
        <param name="storageMB">Mb SQL Azure データベース弾力性プール記憶域の上限を取得します。</param>
        <summary>
            ElasticPoolInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CreationDate">
      ...
      <Docs>
        <summary>
            Azure SQL 弾力性プール (ISO8601 形式) の作成日を取得します。
            </summary>
    ...
    <Member MemberName="DatabaseDtuMax">
      ...
      <Docs>
        <summary>
            取得または 1 つの SQL Azure データベースが使用できる最大の DTU を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseDtuMin">
      ...
      <Docs>
        <summary>
            取得または設定の最小 DTU のすべての SQL Azure データベースのことが保証されます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Dtu">
      ...
      <Docs>
        <summary>
            取得または SQL Azure データベースの弾力性プールの合計の DTU の共有を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Edition">
      ...
      <Docs>
        <summary>
            取得または Azure SQL 弾力性プールのエディションを設定します。 使用可能な値が含まれます: 'Basic'、'Standard'、'Premium'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            Azure SQL 弾力性プールの状態を取得します。 使用可能な値が含まれます: '作成中'、'準備完了'、'Disabled'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageMB">
      ...
      <Docs>
        <summary>
            Mb SQL Azure データベース弾力性プール記憶域の上限を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
