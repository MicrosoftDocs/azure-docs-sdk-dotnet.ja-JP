<Type Name="RecommendedElasticPoolInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.RecommendedElasticPoolInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RecommendedElasticPoolInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="databaseEdition">Azure SQL 推奨弾力性プールのエディションです。 ElasticPoolEditions 列挙には、有効なすべてのエディションが含まれています。 使用可能な値が含まれます: 'Basic'、'Standard'、'Premium'</param>
        <param name="dtu">SQL Azure の DTU は、弾力性プールをお勧めします。</param>
        ...
        <param name="databases">このプール内の Azure SQL データベースの一覧。 展開されたプロパティ</param>
        <param name="metrics">Azure SQL データベースのサーバーに格納されていたの一覧。 展開されたプロパティ</param>
        <summary>
            RecommendedElasticPoolInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Databases">
      ...
      <Docs>
        <summary>
            このプール内には、Azure SQL データベースの一覧を取得します。 展開されたプロパティ
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Dtu">
      ...
      <Docs>
        <summary>
            取得または SQL Azure 推奨弾力性プールの DTU を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Metrics">
      ...
      <Docs>
        <summary>
            サーバーに格納されている Azure SQL データベースの一覧を取得します。 展開されたプロパティ
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
