<Type Name="TargetElasticPoolEditions" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.TargetElasticPoolEditions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8e760-101">TargetElasticPoolEditions の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="8e760-101">Defines values for TargetElasticPoolEditions.</span></span>
            </summary>
