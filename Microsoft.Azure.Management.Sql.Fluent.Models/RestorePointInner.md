<Type Name="RestorePointInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.RestorePointInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RestorePointInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="restorePointType">Azure SQL データベースの復元ポイントの復元ポイントの種類。 使用可能な値が含まれます: 'DISCRETE'、'CONTINUOUS'</param>
    ...
    <Member MemberName="RestorePointType">
      ...
      <Docs>
        <summary>
            Azure SQL データベースの復元ポイントの復元ポイントの種類を取得します。 使用可能な値が含まれます: 'DISCRETE'、'CONTINUOUS'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
