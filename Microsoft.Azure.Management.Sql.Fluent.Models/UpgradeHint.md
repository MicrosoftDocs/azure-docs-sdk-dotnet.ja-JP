<Type Name="UpgradeHint" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.UpgradeHint">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            UpgradeHint クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="targetServiceLevelObjective">アップグレードのヒントの TargetServiceLevelObjective します。</param>
        <param name="targetServiceLevelObjectiveId">アップグレードのヒントの TargetServiceLevelObjectiveId します。</param>
        <summary>
            UpgradeHint クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TargetServiceLevelObjective">
      ...
      <Docs>
        <summary>
            取得またはアップグレードのヒントの targetServiceLevelObjective を設定します。
            </summary>
    ...
    <Member MemberName="TargetServiceLevelObjectiveId">
      ...
      <Docs>
        <summary>
            取得またはアップグレードのヒントの targetServiceLevelObjectiveId を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
