<Type Name="ServerInner" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.ServerInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ServerInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="version">サーバーのバージョン。 使用可能な値が含まれます: '2.0'、'12.0'</param>
        <param name="administratorLogin">サーバーの管理者ユーザー名。 のみ指定できますと、サーバーが作成される (の作成が必要)。</param>
    ...
    <Member MemberName="AdministratorLogin">
      ...
      <Docs>
        <summary>
            取得またはサーバーの管理者のユーザー名を設定します。 のみ指定できますと、サーバーが作成される (の作成が必要)。
            </summary>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            取得またはサーバーのバージョンを設定します。 使用可能な値が含まれます: '2.0'、'12.0'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
