<Type Name="OperationStatusJobsExtendedInfo" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.OperationStatusJobsExtendedInfo">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="jobIds">保護されたアイテムに対して作成されたジョブの Id。</param>
        <param name="failedJobsError">対応するエラー コードと共にすべての失敗したジョブを格納します。</param>
        <summary>
            OperationStatusJobsExtendedInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="FailedJobsError">
      ...
      <Docs>
        <summary>
            取得または設定は、対応するエラー コードと共にすべての失敗したジョブを格納します。
            </summary>
    ...
    <Member MemberName="JobIds">
      ...
      <Docs>
        <summary>
            取得または保護されたアイテムに対して作成されたジョブの Id を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
