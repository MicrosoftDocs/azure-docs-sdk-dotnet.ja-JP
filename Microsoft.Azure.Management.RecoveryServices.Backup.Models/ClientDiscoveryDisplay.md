<Type Name="ClientDiscoveryDisplay" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.ClientDiscoveryDisplay">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provider">表示用のプロバイダーの名前</param>
        <param name="resource">リソースの種類の名前は表示目的</param>
        <param name="operation">表示のため、操作の名前</param>
        <param name="description">表示のため、操作の説明</param>
        <summary>
            ClientDiscoveryDisplay クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
