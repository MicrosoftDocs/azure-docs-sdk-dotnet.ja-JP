<Type Name="BMSRPQueryObject" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.BMSRPQueryObject">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            BMSRPQueryObject クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="startDate">この時間後に作成されたバックアップのコピー。</param>
        <param name="endDate">この時刻より前に作成されたバックアップのコピー。</param>
        <summary>
            BMSRPQueryObject クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="EndDate">
      ...
      <Docs>
        <summary>
            取得またはこの時刻より前に作成されたバックアップのコピーを設定します。
            </summary>
    ...
    <Member MemberName="StartDate">
      ...
      <Docs>
        <summary>
            取得または、この時間後に作成されたバックアップのコピーを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
