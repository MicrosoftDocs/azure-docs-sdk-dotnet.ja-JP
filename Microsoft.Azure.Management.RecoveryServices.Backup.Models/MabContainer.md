<Type Name="MabContainer" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.MabContainer">
  ...
  <Docs>
    <summary>
            項目を含むコンテナーは、MAB バックアップ エンジンを使用してをバックアップします。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MabContainer クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="canReRegister">コンテナーにもう一度を登録できます。</param>
        <param name="containerId">ContainerID は、コンテナーを表します。</param>
        <param name="protectedItemCount">このコンテナーにバックアップされた項目の数。</param>
        <param name="agentVersion">このコンテナーのエージェントのバージョン。</param>
        <param name="extendedInfo">このコンテナーの追加情報</param>
        <summary>
            MabContainer クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AgentVersion">
      ...
      <Docs>
        <summary>
            取得または、このコンテナーのエージェントのバージョンを設定します。
            </summary>
    ...
    <Member MemberName="ContainerId">
      ...
      <Docs>
        <summary>
            取得または containerID を表すコンテナーを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProtectedItemCount">
      ...
      <Docs>
        <summary>
            取得または、このコンテナーにバックアップする項目の数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
