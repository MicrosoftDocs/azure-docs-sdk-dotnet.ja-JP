<Type Name="BMSBackupSummariesQueryObject" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.BMSBackupSummariesQueryObject">
  ...
  <Docs>
    <summary>
            バックアップの概要をフェッチするパラメーターのクエリを実行します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            BMSBackupSummariesQueryObject クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="type">このコンテナーのバックアップの管理の種類。
            使用可能な値が含まれます: '無効'、'BackupProtectedItemCountSummary'、'BackupProtectionContainerCountSummary'</param>
        <summary>
            BMSBackupSummariesQueryObject クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            取得または、このコンテナーのバックアップの管理の種類を設定します。 使用可能な値が含まれます: '無効'、'BackupProtectedItemCountSummary'、'BackupProtectionContainerCountSummary'
            </summary>
