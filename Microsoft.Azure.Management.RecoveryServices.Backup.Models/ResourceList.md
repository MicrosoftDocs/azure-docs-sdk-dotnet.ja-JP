<Type Name="ResourceList" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.ResourceList">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ResourceList クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="nextLink">リソースの次のページをフェッチする uri。
            呼び出し ListNext() は、リソースの次のページをフェッチします。</param>
        <summary>
            ResourceList クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="NextLink">
      ...
      <Docs>
        <summary>
            取得またはリソースの次のページをフェッチする uri を設定します。 呼び出し ListNext() は、リソースの次のページをフェッチします。
            </summary>
