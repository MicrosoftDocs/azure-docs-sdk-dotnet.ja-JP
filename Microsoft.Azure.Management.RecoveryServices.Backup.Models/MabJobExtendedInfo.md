<Type Name="MabJobExtendedInfo" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.MabJobExtendedInfo">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MabJobExtendedInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tasksList">このジョブのタスクの一覧です。</param>
        <param name="propertyBag">ジョブのプロパティです。</param>
        <param name="dynamicErrorMessage">非ローカライズされたエラー メッセージがこのジョブを特定します。</param>
        <summary>
            MabJobExtendedInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DynamicErrorMessage">
      ...
      <Docs>
        <summary>
            取得または設定非ローカライズされたエラー メッセージをこのジョブを特定します。
            </summary>
