<Type Name="MabProtectionPolicy" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.MabProtectionPolicy">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MabProtectionPolicy クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="schedulePolicy">バックアップ ポリシーのバックアップのスケジュール。</param>
    ...
    <Member MemberName="SchedulePolicy">
      ...
      <Docs>
        <summary>
            取得またはバックアップ ポリシーのバックアップのスケジュールを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
