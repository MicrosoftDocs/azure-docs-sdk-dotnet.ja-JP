<Type Name="BackupManagementUsage" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.BackupManagementUsage">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            BackupManagementUsage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="unit">使用状況の単位です。 使用可能な値が含まれます: 'Count'、'バイト'、'秒数'、'%'、'CountPerSecond'、'BytesPerSecond'</param>
        <param name="quotaPeriod">使用状況クォータ期間。</param>
        <param name="nextResetTime">次に使用状況の時刻をリセットします。</param>
        <param name="currentValue">使用状況の現在の値。</param>
        <param name="limit">使用状況の制限。</param>
        <param name="name">使用法の名前です。</param>
        <summary>
            BackupManagementUsage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            取得または使用率の単位を設定します。 使用可能な値が含まれます: 'Count'、'バイト'、'秒数'、'%'、'CountPerSecond'、'BytesPerSecond'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
