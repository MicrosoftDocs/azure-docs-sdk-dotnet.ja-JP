<Type Name="AzureBackupServerContainer" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.AzureBackupServerContainer">
  ...
  <Docs>
    <summary>
            AzureBackupServer (DPMVenus) ワークロードに固有の保護のコンテナーです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AzureBackupServerContainer クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="canReRegister">コンテナーが再登録可能なかどうかを指定します。</param>
        <param name="containerId">コンテナーの ID。</param>
        <param name="protectedItemCount">BackupEngine で保護された項目の数</param>
        <param name="dpmAgentVersion">バックアップ エンジン エージェントのバージョン</param>
        <param name="dPMServers">コンテナーを保護する BackupEngines の一覧</param>
        <param name="upgradeAvailable">場合は、アップグレードの確認に使用できます</param>
        <param name="protectionStatus">コンテナーの状態を保護します。</param>
        <param name="extendedInfo">コンテナーの情報を拡張します。</param>
        <summary>
            AzureBackupServerContainer クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CanReRegister">
      ...
      <Docs>
        <summary>
            取得または設定は、コンテナーが再登録可能なかどうかを指定します。
            </summary>
    ...
    <Member MemberName="DpmAgentVersion">
      ...
      <Docs>
        <summary>
            取得または設定のバックアップ エンジン エージェントのバージョン
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DPMServers">
      ...
      <Docs>
        <summary>
            取得またはコンテナーを保護する BackupEngines の一覧の設定
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProtectedItemCount">
      ...
      <Docs>
        <summary>
            取得または設定の保護された項目の数、BackupEngine
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UpgradeAvailable">
      ...
      <Docs>
        <summary>
            取得または設定するかどうか確認は、使用可能なアップグレードします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
