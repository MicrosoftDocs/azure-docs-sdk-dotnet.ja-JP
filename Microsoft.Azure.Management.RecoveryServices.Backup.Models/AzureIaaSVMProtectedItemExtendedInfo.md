<Type Name="AzureIaaSVMProtectedItemExtendedInfo" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.AzureIaaSVMProtectedItemExtendedInfo">
  ...
  <Docs>
    <summary>
            Azure IaaS 仮想マシン バックアップ アイテムの特定の詳細についてはします。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AzureIaaSVMProtectedItemExtendedInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="oldestRecoveryPoint">このバックアップ項目の使用可能な最も古いバックアップ コピーは、します。</param>
        <param name="recoveryPointCount">このバックアップ アイテムのバックアップ コピーの数。</param>
        <param name="policyInconsistent">バックアップ項目に関連付けられているバックアップ ポリシーを一貫性のあるかどうかを指定します。</param>
        <summary>
            AzureIaaSVMProtectedItemExtendedInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="OldestRecoveryPoint">
      ...
      <Docs>
        <summary>
            取得またはこのバックアップ項目の使用可能な最も古いバックアップ コピーを設定します。
            </summary>
    ...
    <Member MemberName="PolicyInconsistent">
      ...
      <Docs>
        <summary>
            取得または設定は、バックアップの項目に関連付けられているバックアップ ポリシーに整合性がないかどうかを指定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecoveryPointCount">
      ...
      <Docs>
        <summary>
            取得またはこのバックアップ アイテムのバックアップ コピーの数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
