<Type Name="Response" FullName="Microsoft.Azure.Management.Monitor.Models.Response">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="timespan">データを取得した timespan です。 その値が連結された 2 つの datatimes から成るで区切られた '/' です。  これは、後で調整可能性があり、最初に要求内容から返されます。</param>
        <param name="value">コレクションの値。</param>
        <param name="cost">データの場合、クエリのコストを表す整数値。</param>
        <param name="interval">返されたメトリック データの間隔 (ウィンドウ サイズ)。  これは、後で調整可能性があり、最初に要求内容から返されます。  これがメタデータの要求が行われた場合に存在しません。</param>
        <summary>
            応答のクラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Cost">
      ...
      <Docs>
        <summary>
            取得またはデータの場合、クエリのコストを表す整数値を設定します。
            </summary>
    ...
    <Member MemberName="Interval">
      ...
      <Docs>
        <summary>
            間隔を設定します (ウィンドウ サイズ) で返されたメトリック データを取得またはします。  これは、後で調整可能性があり、最初に要求内容から返されます。  これがメタデータの要求が行われた場合に存在しません。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timespan">
      ...
      <Docs>
        <summary>
            取得またはデータを取得した値を設定します。 その値が連結された 2 つの datatimes から成るで区切られた '/' です。
            これは、後で調整可能性があり、最初に要求内容から返されます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
