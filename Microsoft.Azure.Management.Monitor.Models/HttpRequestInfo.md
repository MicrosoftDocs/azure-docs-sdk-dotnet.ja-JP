<Type Name="HttpRequestInfo" FullName="Microsoft.Azure.Management.Monitor.Models.HttpRequestInfo">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            HttpRequestInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="clientRequestId">クライアント要求 id。</param>
        <param name="clientIpAddress">クライアント Ip アドレス</param>
        <param name="method">Http 要求メソッド。</param>
