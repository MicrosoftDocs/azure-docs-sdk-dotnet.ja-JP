<Type Name="MetricDefinition" FullName="Microsoft.Azure.Management.Monitor.Models.MetricDefinition">
  ...
  <Docs>
    <summary>
            メトリック定義のクラスは、メトリックのメタデータを指定します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="isDimensionRequired">ディメンションが必要かどうかを示すフラグです。</param>
        <param name="resourceId">メトリックを生成するリソースのリソースの識別子です。</param>
        ...
        <param name="primaryAggregationType">表示の値を使用する方法を定義する主な集約型の値。 使用可能な値が含まれます 'None'、'Average'、'Count'、'最小'、'最大'、'Total'。</param>
        <param name="metricAvailabilities">照会する使用可能な集計間隔のコレクションです。</param>
        <param name="id">メトリックの定義のリソースの識別子。</param>
        <param name="dimensions">名前と、ディメンションの表示名がローカライズ可能な文字列など。</param>
        <summary>
            MetricDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Dimensions">
      ...
      <Docs>
        <summary>
            取得または設定の名前と、ディメンションの表示名がローカライズ可能な文字列など。
            </summary>
    ...
    <Member MemberName="IsDimensionRequired">
      ...
      <Docs>
        <summary>
            取得またはディメンションが必要かどうかを示すフラグを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrimaryAggregationType">
      ...
      <Docs>
        <summary>
            取得または表示の値を使用する方法を定義する主な集約型の値を設定します。 使用可能な値が含まれます 'None'、'Average'、'Count'、'最小'、'最大'、'Total'。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceId">
      ...
      <Docs>
        <summary>
            取得またはメトリックが生成されるリソースのリソース識別子を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
