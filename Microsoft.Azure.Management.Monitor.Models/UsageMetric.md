<Type Name="UsageMetric" FullName="Microsoft.Azure.Management.Monitor.Models.UsageMetric">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            UsageMetric クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">使用状況メトリック名と表示名。</param>
        <param name="currentValue">使用状況メトリックの現在の値。</param>
        <param name="id">使用状況メトリックの id。</param>
        <param name="limit">クォータは、使用状況メトリックを制限します。</param>
        <param name="unit">使用状況メトリックの単位です。</param>
        <param name="nextResetTime">次は、現在の値の時刻をリセットします。</param>
        <param name="quotaPeriod">値をリセットするまでにかかる時間。</param>
        <summary>
            UsageMetric クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
