<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.ServicePrincipal.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="261eb-101">変更可能なすべての設定を含む、サービス プリンシパルの更新操作のテンプレートです。</span><span class="sxs-lookup"><span data-stu-id="261eb-101">The template for a service principal update operation, containing all the settings that can be modified.</span></span>
            </summary>
