<Type Name="PartitionLoadInformation" FullName="System.Fabric.Query.PartitionLoadInformation">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
          <para><see cref="T:System.Fabric.Query.PartitionLoadInformation" /> クラスのインスタンスを初期化します。</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PartitionId">
      ...
      <Docs>
        <summary>
          <para>パーティション ID を取得します このコマンドは、パイプ処理の目的として使用できます。</para>
        </summary>
        <value>
    ...
    <Member MemberName="PrimaryLoadMetricReports">
      ...
      <Docs>
        <summary>
          <para>このパーティションの主な役割の負荷のレポートの一覧を取得します。</para>
        </summary>
        <value>
          <para>負荷の一覧は、このパーティションの主な役割を報告します。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SecondaryLoadMetricReports">
      ...
      <Docs>
        <summary>
          <para>このパーティションのセカンダリ ロールのロード レポートの一覧を取得します。</para>
        </summary>
        <value>
          <para>このパーティションのセカンダリ ロールのロードの一覧を報告します。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
