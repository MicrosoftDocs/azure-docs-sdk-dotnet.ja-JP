<Type Name="TestCommandStateFilter" FullName="System.Fabric.Query.TestCommandStateFilter">
  ...
  <Docs>
    <summary>
            これにより、GetTestCommandStatusListAsync() を呼び出すときに使用され、TestCommandState に使用するフィルターを示します。    <span data-ttu-id="7b7e1-102">複数のフィルター値を指定することがあります。</span><span class="sxs-lookup"><span data-stu-id="7b7e1-102">Multiple filter values may be specified.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="All">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7b7e1-103">TestCommandState でフィルター処理を行わないことを示します。</span><span class="sxs-lookup"><span data-stu-id="7b7e1-103">Indicates not to do any filtering on TestCommandState.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Cancelled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7b7e1-104">このフィルターには、テスト コマンドのキャンセルが選択されます。</span><span class="sxs-lookup"><span data-stu-id="7b7e1-104">This filter selects Cancelled test commands.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="CompletedSuccessfully">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7b7e1-105">このフィルターには、テスト コマンドの完了が選択されます。</span><span class="sxs-lookup"><span data-stu-id="7b7e1-105">This filter selects Completed test commands.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Default">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7b7e1-106">既定のフィルター。</span><span class="sxs-lookup"><span data-stu-id="7b7e1-106">The default filter.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Failed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7b7e1-107">このフィルターには、失敗したテスト コマンドが選択されます。</span><span class="sxs-lookup"><span data-stu-id="7b7e1-107">This filter selects Failed test commands.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="ForceCancelled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7b7e1-108">このフィルターは、ForceCancelled テスト コマンドを選択します。</span><span class="sxs-lookup"><span data-stu-id="7b7e1-108">This filter selects ForceCancelled test commands.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="RollingBack">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7b7e1-109">このフィルターは、ロールバックしていますテスト コマンドを選択します。</span><span class="sxs-lookup"><span data-stu-id="7b7e1-109">This filter selects RollingBack test commands.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Running">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7b7e1-110">このフィルターは、実行されているテスト コマンドを選択します。</span><span class="sxs-lookup"><span data-stu-id="7b7e1-110">This filter selects Running test commands.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
