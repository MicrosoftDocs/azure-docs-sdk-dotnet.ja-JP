<Type Name="DeployedCodePackageList" FullName="System.Fabric.Query.DeployedCodePackageList">
  ...
  <Docs>
    <summary>
      <para>このプロパティが false の場合にのみ変更可能なこのリストを表します。</para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="CopyTo">
      ...
      <Docs>
        ...
        <param name="arrayIndex">
          <para>コピーを開始するコピー先の配列内のインデックス。</para>
        </param>
        <summary>
    ...
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
          <para>取得または、この一覧内の項目の数を示す値を設定します。</para>
        </summary>
        <value>
    ...
    <Member MemberName="IsReadOnly">
      ...
      <Docs>
        <summary>
          <para>取得またはこのプロパティが false の場合にのみ、このリストを変更できるかどうかを示す値を設定します。</para>
        </summary>
        <value>
          <para>
            <languageKeyword>true</languageKeyword>一覧できるだけ変更後、それ以外の場合<languageKeyword>false</languageKeyword>です。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
