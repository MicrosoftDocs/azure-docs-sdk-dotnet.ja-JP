<Type Name="ServiceGroupMemberMemberList" FullName="System.Fabric.Query.ServiceGroupMemberMemberList">
  ...
  <Docs>
    <summary>
            サービス グループ メンバーのメンバー リストをサービス グループ メンバーのメンバーが含まれています。
            </summary>
  ...
  <Members>
    <Member MemberName="Add">
      ...
      <Docs>
        <param name="item">追加するサービス グループ メンバーのメンバー。</param>
        <summary>
            サービス グループのメンバーを追加します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Contains">
      ...
      <Docs>
        <param name="item">検索するサービス グループ メンバーのメンバー。</param>
        <summary>
            検索する場合、サービス グループ メンバーのメンバーが含まれています。
            </summary>
    ...
    <Member MemberName="CopyTo">
      ...
      <Docs>
        <param name="array">コピーされるサービス グループ メンバーのメンバー。</param>
        <param name="arrayIndex">コピーを開始するインデックス。</param>
        <summary>
            サービス グループのメンバーにコピーします。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            サービス グループ メンバーのメンバーの数。
            </summary>
        <value>サービス グループ メンバーのメンバーの数。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            サービス グループ メンバーの列挙子メンバーを取得します。
            </summary>
        <returns>サービス グループ メンバーのメンバーの列挙子。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IndexOf">
      ...
      <Docs>
        <param name="item">検索するサービス グループ メンバーのメンバー。</param>
        <summary>
            サービス グループのメンバーのインデックスを検索します。
            </summary>
        <returns>サービス グループのメンバーのインデックス。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Insert">
      ...
      <Docs>
        <param name="index">サービス グループのメンバーを挿入するインデックス。</param>
        <param name="item">挿入するサービス グループ メンバーのメンバー。</param>
        <summary>
            サービス グループのメンバーを挿入します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="index">サービス グループのメンバーへのアクセスのインデックス。</param>
        <summary>
            サービス グループのメンバーにアクセスします。
            </summary>
        <value>サービス グループのメンバーのインデックス。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Remove">
      ...
      <Docs>
        <param name="item">削除するサービス グループ メンバーのメンバー。</param>
        <summary>
            サービス グループのメンバーを削除します。
            </summary>
    ...
    <Member MemberName="RemoveAt">
      ...
      <Docs>
        <param name="index">削除するサービス グループのメンバーのインデックス。</param>
        <summary>
            サービス グループのメンバーを削除します。
            </summary>
        <remarks>To be added.</remarks>
