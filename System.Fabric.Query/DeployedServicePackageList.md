<Type Name="DeployedServicePackageList" FullName="System.Fabric.Query.DeployedServicePackageList">
  ...
  <Docs>
    <summary>
      <para>一覧を表す<see cref="T:System.Fabric.Query.DeployedServicePackage" />です。</para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="Contains">
      ...
      <Docs>
        ...
        <summary>
          <para>指定した項目が一覧にあるかどうかを示します。</para>
        </summary>
        <returns>
          <para>
    ...
    <Member MemberName="CopyTo">
      ...
      <Docs>
        <param name="array">
          <para>項目のコピー先は、リストからコピーします。</para>
        </param>
        <param name="arrayIndex">
          <para>コピーの開始位置とする <paramref name="array" /> のインデックス (0 から始まる)。</para>
        </param>
        <summary>
    ...
    <Member MemberName="Insert">
      ...
      <Docs>
        <param name="index">
          <para><paramref name="item" /> を挿入する位置の、0 から始まるインデックス。</para>
        </param>
        <param name="item">
          <para>挿入するオブジェクト。</para>
        </param>
        <summary>
    ...
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="index">
          <para>取得する項目の、0 から始まるインデックス。</para>
        </param>
        <summary>
          <para>指定したインデックス位置に項目を取得します。</para>
        </summary>
        <value>
