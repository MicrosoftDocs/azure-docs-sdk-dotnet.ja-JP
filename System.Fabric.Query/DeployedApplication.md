<Type Name="DeployedApplication" FullName="System.Fabric.Query.DeployedApplication">
  ...
  <Docs>
    <summary>
      <para>サービス ファブリック ノードで実行されているアプリケーションのサービス ホストのインスタンスについて説明します。</para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="DeployedApplicationStatus">
      ...
      <Docs>
        <summary>
          <para>展開済みアプリケーション インスタンスの状態を取得します。</para>
        </summary>
        <value>
          <para>展開済みアプリケーション インスタンスの状態。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="LogDirectory">
      ...
      <Docs>
        <summary>
          <para>展開済みアプリケーション インスタンスによって使用されるログ ディレクトリ パスを取得します。</para>
        </summary>
        <value>
          <para>展開済みアプリケーション インスタンスによって使用されるログ ディレクトリ パス。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TempDirectory">
      ...
      <Docs>
        <summary>
          <para>展開済みアプリケーション インスタンスによって使用される一時ディレクトリのパスを取得します。</para>
        </summary>
        <value>
          <para>展開済みアプリケーション インスタンスによって使用される一時ディレクトリのパス。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WorkDirectory">
      ...
      <Docs>
        <summary>
          <para>展開済みアプリケーションのインスタンスによって使用される作業ディレクトリ パスを取得します。</para>
        </summary>
        <value>
          <para>展開済みアプリケーション インスタンスによって使用される作業ディレクトリのパス。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
