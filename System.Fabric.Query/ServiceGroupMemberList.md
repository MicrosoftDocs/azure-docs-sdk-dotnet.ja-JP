<Type Name="ServiceGroupMemberList" FullName="System.Fabric.Query.ServiceGroupMemberList">
  ...
  <Docs>
    <summary>
            サービス グループのメンバーを含んでいる、サービス グループ メンバーの一覧です。
            </summary>
  ...
  <Members>
    <Member MemberName="Add">
      ...
      <Docs>
        <param name="item">サービス グループ メンバーを追加します。</param>
        <summary>
            サービス グループ メンバーを追加します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Contains">
      ...
      <Docs>
        <param name="item">検索するサービスのグループのメンバー。</param>
        <summary>
            場合に、検索サービス グループのメンバーが含まれています。
            </summary>
    ...
    <Member MemberName="CopyTo">
      ...
      <Docs>
        <param name="array">コピーするサービス グループのメンバーです。</param>
        <param name="arrayIndex">コピーを開始する配列のインデックス。</param>
        <summary>
            サービス グループのメンバーをコピーします。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            サービス グループのメンバーの列挙子を取得します。
            </summary>
        <returns>サービス グループのメンバーの列挙子。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IndexOf">
      ...
      <Docs>
        <param name="item">検索するサービスのグループのメンバー。</param>
        <summary>
            サービス グループ メンバーのインデックスを検索します。
            </summary>
        <returns>サービス グループ メンバーのインデックス。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Insert">
      ...
      <Docs>
        ...
        <param name="item">挿入するサービスのグループのメンバー。</param>
        <summary>
            サービス グループ メンバーを挿入します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="index">サービス グループ メンバーのインデックス。</param>
        <summary>
            サービス グループのメンバーにアクセスします。
            </summary>
        <value>サービス グループ メンバーのインデックス。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Remove">
      ...
      <Docs>
        <param name="item">サービス グループのメンバーは削除します。</param>
        <summary>
            サービス グループ メンバーを削除します。
            </summary>
    ...
    <Member MemberName="RemoveAt">
      ...
      <Docs>
        <param name="index">削除するサービス グループ メンバーのインデックス。</param>
        <summary>
            サービス グループ メンバーを削除します。
            </summary>
        <remarks>To be added.</remarks>
