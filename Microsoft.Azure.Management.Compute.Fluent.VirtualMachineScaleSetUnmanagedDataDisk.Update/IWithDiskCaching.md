<Type Name="IWithDiskCaching" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSetUnmanagedDataDisk.Update.IWithDiskCaching">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b5789-101">アンマネージ データ ディスクの更新を許可する型のキャッシュ ディスクの設定の段階です。</span><span class="sxs-lookup"><span data-stu-id="b5789-101">The stage of the unmanaged data disk update allowing to set the disk caching type.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithCaching">
      ...
      <Docs>
        <param name="cachingType"><span data-ttu-id="b5789-102">型のキャッシュ ディスク。</span><span class="sxs-lookup"><span data-stu-id="b5789-102">The disk caching type.</span></span> <span data-ttu-id="b5789-103">使用可能な値が含まれます。 'None'、'ReadOnly'、'ReadWrite' です。</span><span class="sxs-lookup"><span data-stu-id="b5789-103">Possible values include: 'None', 'ReadOnly', 'ReadWrite'.</span></span></param>
        <summary>
            <span data-ttu-id="b5789-104">アンマネージ データ ディスクの新しいキャッシュの種類を指定します。</span><span class="sxs-lookup"><span data-stu-id="b5789-104">Specifies the new caching type for the unmanaged data disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="b5789-105">アンマネージ データ ディスクの更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="b5789-105">The next stage of unmanaged data disk update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>