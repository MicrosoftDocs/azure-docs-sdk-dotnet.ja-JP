<Type Name="IAuthorizationRule&lt;RuleT&gt;" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.IAuthorizationRule&lt;RuleT&gt;">
  ...
  <Docs>
    <typeparam name="RuleT">特定の規則の種類。</typeparam>
    <summary>
            承認規則を表す型。
            </summary>
    <remarks>
  ...
  <Members>
    <Member MemberName="GetKeys">
      ...
      <Docs>
        ...
        <return>プライマリ、セカンダリ キーと接続文字列。</return>
      </Docs>
    </Member>
    <Member MemberName="GetKeysAsync">
      ...
      <Docs>
        ...
        <return>プライマリ、セカンダリ キーを出力ストリームと接続文字列。</return>
      </Docs>
    </Member>
    <Member MemberName="RegenerateKey">
      ...
      <Docs>
        <param name="policykey">再生成するキー。</param>
        <summary>
            プライマリまたはセカンダリ キーを再生成します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>プライマリ、セカンダリ キーと接続文字列。</return>
