<Type Name="IQueue" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.IQueue">
  ...
  <Members>
    ...
    <Member MemberName="AuthorizationRules">
      ...
      <Docs>
        <summary>
            Service Bus キューの承認規則を管理するエントリ ポイントを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DefaultMessageTtlDuration">
      ...
      <Docs>
        <summary>
            メッセージがキューに送信されたときから開始メッセージが切れるまでの期間を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsDeadLetteringEnabledForExpiredMessages">
      ...
      <Docs>
        <summary>
            取得では、このキューがメッセージの有効期限が切れるときに、配信不能サポートを持つかどうかを示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsDuplicateDetectionEnabled">
      ...
      <Docs>
        <summary>
            取得では、このキューが重複データ検出を必要かどうかを示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsExpressEnabled">
      ...
      <Docs>
        <summary>
            取得では、エクスプレス エンティティが有効になっているかどうかを示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsPartitioningEnabled">
      ...
      <Docs>
        <summary>
            取得では、キューが複数のメッセージ ブローカーにわたって分割するかどうかを示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsSessionEnabled">
      ...
      <Docs>
        <summary>
            取得では、キューがセッションをサポートするかどうかを示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaxSizeInMB">
      ...
      <Docs>
        <summary>
            メガバイト単位でキューに割り当てられたメモリの最大サイズを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ScheduledMessageCount">
      ...
      <Docs>
        <summary>
            まだ消費のために解放されてキューに送信されるメッセージの数を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
