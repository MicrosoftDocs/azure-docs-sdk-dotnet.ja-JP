<Type Name="NamespaceSku" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.NamespaceSku">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="sku">内部 sku モデル インスタンス。</param>
        <summary>
             SKU の Service Bus 名前空間を作成します。
             </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tier">Sku の層。</param>
        <summary>
             Service Bus 名前空間の sku を作成します。
             </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Sku の名前です。</param>
        <param name="tier">Sku の層。</param>
        <param name="capacity">Service Bus ホストに割り当てられたリソースの係数。</param>
        <summary>
             SKU の Service Bus 名前空間を作成します。
             </summary>
        <remarks>To be added.</remarks>
