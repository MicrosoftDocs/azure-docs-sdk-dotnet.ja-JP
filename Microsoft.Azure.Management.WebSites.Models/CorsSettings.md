<Type Name="CorsSettings" FullName="Microsoft.Azure.Management.WebSites.Models.CorsSettings">
  ...
  <Docs>
    <summary>
            アプリのクロス オリジン リソース共有 (CORS) 設定します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="allowedOrigins">クロス オリジン呼び出しを許可するかされるオリジンのリスト取得または設定 (例: http://example.com:12345)。 すべてを許可するには "*" を使用します。</param>
        <summary>
            CorsSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AllowedOrigins">
      ...
      <Docs>
        <summary>
            クロス オリジン呼び出しを許可するかされるオリジンのリスト取得または設定 (例: http://example.com:12345)。 すべてを許可するには "*" を使用します。
            </summary>
