  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="vnetResourceId">仮想ネットワークのリソース id です。</param>
        <param name="certThumbprint">クライアント証明書の拇印。</param>
        <param name="certBlob">ポイント対サイト VPN 接続の認証に使用する秘密キーの公開キーを含む証明書ファイル (.cer) blob です。</param>
        <param name="routes">この仮想ネットワーク接続で使用するルート。</param>
        <param name="resyncRequired">&lt;コード&gt;true&lt;/code&gt;は再同期が必要なそれ以外の場合は&lt;コード&gt;false&lt;/code&gt;です。</param>
        <param name="dnsServers">この仮想ネットワークで使用する DNS サーバー。 これには、IP アドレスのコンマ区切りの一覧があります。</param>
        <summary>
            VnetInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CertBlob">
      ...
      <Docs>
        <summary>
            取得またはポイント対サイト VPN 接続の認証に使用する秘密キーの公開キーを含む blob を証明書ファイル (.cer) を設定します。
            </summary>
    ...
    <Member MemberName="DnsServers">
      ...
      <Docs>
        <summary>
            取得または、この仮想ネットワークで使用する DNS サーバーを設定します。 これには、IP アドレスのコンマ区切りの一覧があります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResyncRequired">
      ...
      <Docs>
        <summary>
            取得&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; 再同期が必要な、それ以外の場合&amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
