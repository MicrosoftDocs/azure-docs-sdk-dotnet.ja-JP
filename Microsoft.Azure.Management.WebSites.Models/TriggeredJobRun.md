<Type Name="TriggeredJobRun" FullName="Microsoft.Azure.Management.WebSites.Models.TriggeredJobRun">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            TriggeredJobRun クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="triggeredJobRunId">ジョブの id。</param>
        <param name="triggeredJobRunName">ジョブ名です。</param>
        <param name="status">ジョブの状態。 使用可能な値が含まれます: 'は Success'、'失敗'、'Error'</param>
        <param name="startTime">開始時刻。</param>
        <param name="endTime">終了時刻です。</param>
        <param name="duration">ジョブの期間です。</param>
        <param name="outputUrl">出力 URL です。</param>
        <param name="errorUrl">エラー URL です。</param>
        <param name="url">ジョブの URL です。</param>
        <param name="jobName">ジョブ名です。</param>
        <param name="trigger">ジョブ トリガーします。</param>
        <summary>
            TriggeredJobRun クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            取得またはジョブの状態を設定します。 使用可能な値が含まれます: 'は Success'、'失敗'、'Error'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
