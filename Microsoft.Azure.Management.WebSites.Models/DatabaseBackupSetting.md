<Type Name="DatabaseBackupSetting" FullName="Microsoft.Azure.Management.WebSites.Models.DatabaseBackupSetting">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DatabaseBackupSetting クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="databaseType">データベースの種類 (例: SqlAzure/MySql)。
            使用可能な値が含まれます: 'SqlAzure'、'MySql'、'LocalMySql'、'PostgreSql'</param>
        <param name="name">To be added.</param>
        <param name="connectionStringName">SiteConfig.ConnectionStrings にリンクされている接続文字列名が含まれています。
            これは、復元中に使用では、接続文字列オプションを上書きします。</param>
        <param name="connectionString">バックアップがあるデータベースへの接続文字列を含むまたは復元します。 場合、復元する必要がありますの新しいデータベースに、内部データベース名は新しいです。</param>
        <summary>
            DatabaseBackupSetting クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            取得または設定がバックアップされているデータベースへの接続文字列が含まれています。 または復元します。 場合、復元する必要がありますの新しいデータベースに、内部データベース名は新しいです。
            </summary>
    ...
    <Member MemberName="ConnectionStringName">
      ...
      <Docs>
        <summary>
            取得または設定、SiteConfig.ConnectionStrings にリンクされている接続文字列名が含まれています。
            これは、復元中に使用では、接続文字列オプションを上書きします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseType">
      ...
      <Docs>
        <summary>
            取得または設定データベースの種類 (例: SqlAzure/MySql)。 使用可能な値が含まれます: 'SqlAzure'、'MySql'、'LocalMySql'、'PostgreSql'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
