<Type Name="MSDeployStatus" FullName="Microsoft.Azure.Management.WebSites.Models.MSDeployStatus">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MSDeployStatus クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="deployer">配置するユーザーのユーザー名</param>
        <param name="provisioningState">プロビジョニング状態。 使用可能な値が含まれます: '受け入れられたら'、'実行中'、'成功'、'失敗'、'キャンセル'</param>
        <param name="startTime">デプロイ操作の開始時刻</param>
        <param name="endTime">デプロイ操作の時間の終了時刻</param>
        <param name="complete">展開の操作が完了したかどうか</param>
        <summary>
            MSDeployStatus クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            プロビジョニングの状態を取得します。 使用可能な値が含まれます: '受け入れられたら'、'実行中'、'成功'、'失敗'、'キャンセル'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
