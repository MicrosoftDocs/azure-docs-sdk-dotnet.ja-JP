<Type Name="MSDeployLogEntry" FullName="Microsoft.Azure.Management.WebSites.Models.MSDeployLogEntry">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="time">ログ エントリのタイムスタンプ</param>
        <param name="type">ログ エントリの種類。 使用可能な値が含まれます: 'Message'、'Warning'、'Error'</param>
        <param name="message">ログ エントリ メッセージ</param>
        <summary>
            MSDeployLogEntry クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            エントリの種類のログを取得します。 使用可能な値が含まれます: 'Message'、'Warning'、'Error'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
