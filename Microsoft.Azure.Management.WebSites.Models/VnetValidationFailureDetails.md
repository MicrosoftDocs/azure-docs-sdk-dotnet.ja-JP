<Type Name="VnetValidationFailureDetails" FullName="Microsoft.Azure.Management.WebSites.Models.VnetValidationFailureDetails">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VnetValidationFailureDetails クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="failed">検証が失敗するかどうかを説明するフラグ。</param>
        <param name="failedTests">検証に失敗したテストの一覧。</param>
        <summary>
            VnetValidationFailureDetails クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Failed">
      ...
      <Docs>
        <summary>
            取得または検証に失敗したかどうかを説明するフラグを設定します。
            </summary>
