  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="usageName">クォータの名前です。</param>
        <param name="resourceName">クォータ リソースの名前です。</param>
        <param name="unit">クォータ リソースの測定単位です。</param>
        ...
        <param name="computeMode">この使用法に使用するモードを計算します。
            使用可能な値が含まれます: 'Shared'、'Dedicated'、'Dynamic'</param>
        <param name="siteMode">この使用法に使用するサイト モードです。</param>
        <summary>
            使用状況のクラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ComputeMode">
      ...
      <Docs>
        <summary>
            取得では、この使用法に使用するモードを計算します。 使用可能な値が含まれます: 'Shared'、'Dedicated'、'Dynamic'
            </summary>
