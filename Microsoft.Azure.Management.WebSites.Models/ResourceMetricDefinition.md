<Type Name="ResourceMetricDefinition" FullName="Microsoft.Azure.Management.WebSites.Models.ResourceMetricDefinition">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ResourceMetricDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="resourceMetricDefinitionName">メトリックの名前です。</param>
        ...
        <param name="resourceUri">リソース URI。</param>
        <param name="resourceMetricDefinitionId">リソースの ID</param>
