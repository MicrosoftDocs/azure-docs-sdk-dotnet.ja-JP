<Type Name="PublicCertificate" FullName="Microsoft.Azure.Management.WebSites.Models.PublicCertificate">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PublicCertificate クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="blob">パブリック証明書のバイト配列</param>
        <param name="publicCertificateLocation">パブリック証明書の場所。 使用可能な値が含まれます: 'CurrentUserMy'、'LocalMachineMy'、'Unknown'</param>
    ...
    <Member MemberName="PublicCertificateLocation">
      ...
      <Docs>
        <summary>
            取得またはパブリック証明書の場所を設定します。 使用可能な値が含まれます: 'CurrentUserMy'、'LocalMachineMy'、'Unknown'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
