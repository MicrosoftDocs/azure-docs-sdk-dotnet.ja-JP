<Type Name="RestoreResponse" FullName="Microsoft.Azure.Management.WebSites.Models.RestoreResponse">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RestoreResponse クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="operationId">サーバーが、復元プロセスを開始するときに、その特定の復元操作を識別する操作 ID を返します。</param>
        <summary>
            RestoreResponse クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="OperationId">
      ...
      <Docs>
        <summary>
            サーバー復元プロセスの開始時に取得して、その特定の復元操作を識別する操作 ID を返します。
            </summary>
