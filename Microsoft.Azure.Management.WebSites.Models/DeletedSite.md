<Type Name="DeletedSite" FullName="Microsoft.Azure.Management.WebSites.Models.DeletedSite">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">削除されたサイトの数値 id</param>
        <param name="deletedTimestamp">アプリが削除されたときの UTC 時間です。</param>
        <param name="subscription">削除されたサイトを含むサブスクリプション</param>
        <param name="resourceGroup">削除されたサイトが含まれているリソース グループ</param>
        <param name="name">削除されたサイトの名前</param>
        <param name="slot">削除されたサイトのスロット</param>
        <summary>
            DeletedSite クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ResourceGroup">
      ...
      <Docs>
        <summary>
            削除されたサイトが含まれているリソース グループを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
