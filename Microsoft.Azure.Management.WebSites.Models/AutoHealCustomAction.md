<Type Name="AutoHealCustomAction" FullName="Microsoft.Azure.Management.WebSites.Models.AutoHealCustomAction">
  ...
  <Docs>
    <summary>
            カスタム アクションを実行する自動修復ルールがトリガーされます。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AutoHealCustomAction クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="exe">実行する実行可能ファイル。</param>
        <param name="parameters">実行可能ファイルのパラメーターです。</param>
        <summary>
            AutoHealCustomAction クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
