<Type Name="TriggeredWebJob" FullName="Microsoft.Azure.Management.WebSites.Models.TriggeredWebJob">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            TriggeredWebJob クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="latestRun">最新のジョブ情報を実行します。</param>
        <param name="historyUrl">履歴の URL です。</param>
        <param name="schedulerLogsUrl">スケジューラのログの URL です。</param>
        <param name="triggeredWebJobName">ジョブ名です。 ARM リソース URI でジョブの識別子として使用されます。</param>
