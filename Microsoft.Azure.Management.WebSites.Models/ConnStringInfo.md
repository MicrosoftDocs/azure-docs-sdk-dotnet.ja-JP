<Type Name="ConnStringInfo" FullName="Microsoft.Azure.Management.WebSites.Models.ConnStringInfo">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">接続文字列の名前です。</param>
        <param name="connectionString">接続文字列値です。</param>
        <param name="type">データベースの種類。 使用可能な値が含まれます: 'MySql'、'SQLServer'、'SQLAzure'、'Custom'、'NotificationHub'、'ServiceBus'、'EventHub'、'ApiHub'、'DocDb'、'RedisCache'、'PostgreSQL'</param>
        <summary>
            ConnStringInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            取得またはデータベースの種類を設定します。 使用可能な値が含まれます: 'MySql'、'SQLServer'、'SQLAzure'、'Custom'、'NotificationHub'、'ServiceBus'、'EventHub'、'ApiHub'、'DocDb'、'RedisCache'、'PostgreSQL'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
