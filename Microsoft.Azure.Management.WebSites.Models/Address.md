<Type Name="Address" FullName="Microsoft.Azure.Management.WebSites.Models.Address">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="address1">アドレスの最初の行。</param>
        <param name="city">住所の市区町村。</param>
        <param name="country">住所の国。</param>
        <param name="postalCode">住所の郵便番号。</param>
        <param name="state">都道府県のアドレス。</param>
        <param name="address2">アドレスの 2 行目。
            省略可能。</param>
        <summary>
            アドレスのクラスの新しいインスタンスを初期化します。
            </summary>
