<Type Name="Recommendation" FullName="Microsoft.Azure.Management.WebSites.Models.Recommendation">
  ...
  <Docs>
    <summary>
            リコメンデーション エンジンによって生成された推奨設定の結果を表します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="creationTime">このインスタンスが作成されたときのタイムスタンプ。</param>
        <param name="recommendationId">推奨設定の各オブジェクトに関連付けられている GUID 値。</param>
        <param name="resourceId">完全 ARM リソース ID 文字列にこの推奨設定オブジェクトが関連付けられています。</param>
        <param name="resourceScope">この推奨事項が適用されるリソースの種類などのサブスクリプションの場合、サーバー ファームでは、サイトの名前です。
            使用可能な値が含まれます: 'ServerFarm'、'Subscription'、'web サイト'</param>
        <param name="ruleName">規則の一意の名前。</param>
        <param name="displayName">(が一意でない)、規則の UI の表示名。</param>
        <param name="message">推奨設定のテキストです。</param>
        <param name="level">この推奨設定に影響する重大度を示すレベルです。 使用可能な値が含まれます: '重大'、'警告'、'情報'、'NonUrgentSuggestion'</param>
        <param name="channels">この推奨事項が適用可能なチャネルのリストです。 使用可能な値が含まれます: '通知'、'Api'、'電子メール'、'Webhook'、'All'</param>
        <param name="tags">この推奨設定が属するカテゴリのタグの一覧。</param>
        <param name="actionName">このオブジェクトで推奨されたアクションの名前です。</param>
        <param name="startTime">(Utc) の推奨事項が参照する範囲の開始時刻。</param>
        <param name="endTime">(Utc) の推奨事項が参照する範囲の終了時刻です。</param>
        <param name="nextNotificationTime">Utc 形式でこの推奨事項を次に通知するときにします。 Null では、このことはありませんに通知されることされなくなります。</param>
        <param name="notificationExpirationTime">この通知の有効期限が切れたときの utc 日時。</param>
        <param name="notifiedTime">最後のタイムスタンプ (utc) のこのインスタンスが実際に通知を受け取った。 Null では、この推奨設定がまだ通知されていないことを意味します。</param>
        <param name="score">ルールによって測定されるメトリックの値。</param>
        <param name="isDynamic">これは、動的に追加された規則に関連付ける場合は true。</param>
        <param name="extensionName">場合は、ポータルの拡張機能の名前が存在します。</param>
        <param name="bladeName">ポータルのブレードへのディープ リンクします。</param>
        <param name="forwardLink">ルールに関連付けられている外部ドキュメントへのリンクを転送します。</param>
        <summary>
            推奨設定クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ActionName">
      ...
      <Docs>
        <summary>
            取得またはこのオブジェクトで推奨されたアクションの名前を設定します。
            </summary>
    ...
    <Member MemberName="Channels">
      ...
      <Docs>
        <summary>
            取得またはこの推奨事項が適用可能なチャネルのリストを設定します。
    ...
    <Member MemberName="CreationTime">
      ...
      <Docs>
        <summary>
            取得または、このインスタンスの作成時にタイムスタンプを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            取得または (が一意でない)、規則の UI の表示名を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            取得または (utc) の推奨事項が参照する範囲の終了時刻を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ForwardLink">
      ...
      <Docs>
        <summary>
            取得または転送リンクをルールに関連付けられている外部ドキュメントに設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            取得またはこの推奨設定に影響する重大度を示すレベルを設定します。 使用可能な値が含まれます: '重大'、'警告'、'情報'、'NonUrgentSuggestion'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NextNotificationTime">
      ...
      <Docs>
        <summary>
            取得または設定 (utc) でこの推奨事項を次に通知します。 Null では、このことはありませんに通知されることされなくなります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NotificationExpirationTime">
      ...
      <Docs>
        <summary>
            取得またはこの通知の有効期限が切れるときに、日付と時刻を UTC に設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NotifiedTime">
      ...
      <Docs>
        <summary>
            取得または最後のタイムスタンプをこのインスタンスが実際に通知を受け取った UTC に設定します。 Null では、この推奨設定がまだ通知されていないことを意味します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecommendationId">
      ...
      <Docs>
        <summary>
            取得または推奨設定の各オブジェクトに関連付けられている GUID 値を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceId">
      ...
      <Docs>
        <summary>
            取得またはこの推奨設定オブジェクトが関連付けられている完全な ARM リソース ID 文字列を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceScope">
      ...
      <Docs>
        <summary>
            取得またはこの推奨事項が適用されるリソースの種類などのサブスクリプションの場合、サーバー ファームでは、サイトの名前を設定します。 使用可能な値が含まれます: 'ServerFarm'、'Subscription'、'web サイト'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Score">
      ...
      <Docs>
        <summary>
            取得またはルールによって測定されるメトリックの値を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            取得または (utc) の推奨事項が参照する範囲の開始時刻を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            取得またはこの推奨設定が属するカテゴリのタグの一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
