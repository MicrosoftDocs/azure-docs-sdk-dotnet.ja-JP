  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="sourceControlName">名前またはソース コントロールの種類。</param>
        <param name="token">OAuth アクセス トークンです。</param>
        <param name="tokenSecret">OAuth アクセス トークン シークレット。</param>
        <param name="refreshToken">OAuth 更新トークンです。</param>
        <param name="expirationTime">OAuth トークンの有効期限。</param>
        <summary>
            SourceControl クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TokenSecret">
      ...
      <Docs>
        <summary>
            取得または oAuth アクセス トークン シークレットを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
