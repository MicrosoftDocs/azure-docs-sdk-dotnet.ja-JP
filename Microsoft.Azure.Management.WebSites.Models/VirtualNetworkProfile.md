<Type Name="VirtualNetworkProfile" FullName="Microsoft.Azure.Management.WebSites.Models.VirtualNetworkProfile">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualNetworkProfile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">仮想ネットワークのリソース id です。</param>
        <param name="name">(読み取り専用) の仮想ネットワークの名前です。</param>
        <param name="type">仮想ネットワーク (読み取り専用) のリソースの種類。</param>
        <param name="subnet">仮想ネットワーク内のサブネットです。</param>
        <summary>
            VirtualNetworkProfile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            (読み取り専用) は、仮想ネットワークのリソースの種類を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
