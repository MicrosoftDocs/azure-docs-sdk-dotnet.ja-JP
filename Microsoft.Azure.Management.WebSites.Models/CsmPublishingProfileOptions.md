<Type Name="CsmPublishingProfileOptions" FullName="Microsoft.Azure.Management.WebSites.Models.CsmPublishingProfileOptions">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            CsmPublishingProfileOptions クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="format">形式の名前。 有効な値: FileZilla3 WebDeploy - 既定の Ftp です。 使用可能な値が含まれます: 'FileZilla3'、'WebDeploy'、'Ftp'</param>
        <summary>
            CsmPublishingProfileOptions クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Format">
      ...
      <Docs>
        <summary>
            取得または形式の名前を設定します。 有効な値: FileZilla3 WebDeploy - 既定の Ftp です。 使用可能な値が含まれます: 'FileZilla3'、'WebDeploy'、'Ftp'
            </summary>
