  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="applicationLogs">アプリケーションでは、構成を記録します。</param>
        <param name="httpLogs">HTTP ログの構成。</param>
        <param name="failedRequestsTracing">失敗した要求トレースの構成。</param>
        <param name="detailedErrorMessages">詳細なエラー メッセージの構成。</param>
        <summary>
            SiteLogsConfig クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
