  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="capacity">現在、リソースに割り当てられているインスタンスの数。</param>
        <param name="skuCapacity">Min、max、および SKU の既定の小数点以下桁数の値。</param>
    ...
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            取得またはリソースに割り当てられているインスタンスの現在の数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
