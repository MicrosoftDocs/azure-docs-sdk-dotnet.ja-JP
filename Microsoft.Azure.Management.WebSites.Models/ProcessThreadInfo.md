  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="processThreadInfoId">展開の ARM 識別子です。</param>
        <param name="href">HRef の URI。</param>
        <param name="process">プロセス URI。</param>
        <param name="startAddress">開始アドレス。</param>
        <param name="currentPriority">現在のスレッド優先度です。</param>
        <param name="priorityLevel">スレッドの優先度レベル。</param>
        <param name="basePriority">基本の優先度です。</param>
        <param name="startTime">開始時刻。</param>
        <param name="totalProcessorTime">合計プロセッサ時間。</param>
        <param name="userProcessorTime">ユーザー プロセッサ時間。</param>
        <param name="priviledgedProcessorTime">特権プロセッサ時間。</param>
        <param name="state">スレッドの状態。</param>
        <param name="waitReason">理由を待機します。</param>
        <summary>
            ProcessThreadInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
