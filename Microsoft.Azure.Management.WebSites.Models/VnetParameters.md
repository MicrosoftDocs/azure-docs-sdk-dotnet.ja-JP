<Type Name="VnetParameters" FullName="Microsoft.Azure.Management.WebSites.Models.VnetParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VnetParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="vnetResourceGroup">検証対象の VNET のリソース グループ</param>
        <param name="vnetName">検証対象の VNET の名前</param>
        <param name="vnetSubnetName">検証に使用するサブネット名</param>
        <summary>
            VnetParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="VnetResourceGroup">
      ...
      <Docs>
        <summary>
            取得または設定の検証に使用する VNET のリソース グループ
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
