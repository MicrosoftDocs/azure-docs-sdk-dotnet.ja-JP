  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="baseAddress">ベース アドレス。 ARM リソース URI 内のモジュール識別子として使用されます。</param>
        <param name="fileName">ファイル名。</param>
        <param name="href">HRef の URI。</param>
        <param name="filePath">ファイルのパス。</param>
        <param name="moduleMemorySize">モジュールのメモリ サイズ。</param>
        <param name="fileVersion">ファイル バージョンです。</param>
        <param name="fileDescription">ファイルの説明。</param>
        <param name="product">製品名です。</param>
        <param name="productVersion">製品バージョンです。</param>
        <param name="isDebug">デバッグですか。</param>
        <param name="language">モジュールの言語 (ロケール) です。</param>
        <summary>
            ProcessModuleInfo クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BaseAddress">
      ...
      <Docs>
        <summary>
            取得またはベース アドレスを設定します。 ARM リソース URI 内のモジュール識別子として使用されます。
            </summary>
