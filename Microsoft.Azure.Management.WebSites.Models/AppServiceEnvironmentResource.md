<Type Name="AppServiceEnvironmentResource" FullName="Microsoft.Azure.Management.WebSites.Models.AppServiceEnvironmentResource">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AppServiceEnvironmentResource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="appServiceEnvironmentResourceName">App Service 環境の名前です。</param>
        <param name="appServiceEnvironmentResourceLocation">App Service 環境の場所。"West US"です。</param>
