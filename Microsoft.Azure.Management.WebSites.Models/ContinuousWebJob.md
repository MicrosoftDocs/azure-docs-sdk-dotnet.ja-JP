<Type Name="ContinuousWebJob" FullName="Microsoft.Azure.Management.WebSites.Models.ContinuousWebJob">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ContinuousWebJob クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="status">ジョブの状態。 使用可能な値が含まれます: '初期化'、'開始'、'実行中'、'PendingRestart'、'停止'</param>
        <param name="detailedStatus">詳細な状態です。</param>
        <param name="logUrl">ログの URL です。</param>
        <param name="continuousWebJobName">ジョブ名です。 ARM リソース URI でジョブの識別子として使用されます。</param>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            取得またはジョブの状態を設定します。 使用可能な値が含まれます: '初期化'、'開始'、'実行中'、'PendingRestart'、'停止'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
