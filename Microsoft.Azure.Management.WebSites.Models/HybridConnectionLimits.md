<Type Name="HybridConnectionLimits" FullName="Microsoft.Azure.Management.WebSites.Models.HybridConnectionLimits">
  ...
  <Docs>
    <summary>
            ハイブリッド接続は、コントラクトを制限します。 これはハイブリッド接続の計画の制限を返すために使用します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            HybridConnectionLimits クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="current">ハイブリッド接続の現在数。</param>
        <param name="maximum">許可されているハイブリッド接続の最大数。</param>
        <summary>
            HybridConnectionLimits クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
