  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="functionEnvelopeName">関数名。</param>
        <param name="functionAppId">関数アプリの id。</param>
        <param name="scriptRootPathHref">ルート パス URI のスクリプトを作成します。</param>
        <param name="scriptHref">スクリプト URI です。</param>
        <param name="configHref">構成の URI。</param>
        <param name="secretsFileHref">機密データ ファイルの URI。</param>
        <param name="href">関数の URI。</param>
        <param name="config">構成情報。</param>
        <param name="files">ファイルの一覧です。</param>
        <param name="testData">Azure ポータルを使用してテストするときに使用されるデータをテストします。</param>
        <summary>
            FunctionEnvelope クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="TestData">
      ...
      <Docs>
        <summary>
            取得または Azure ポータルを使用してテストするときに使用されるテスト データを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
