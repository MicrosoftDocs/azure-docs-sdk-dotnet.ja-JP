<Type Name="SBNamespaceUpdateParameters" FullName="Microsoft.Azure.Management.ServiceBus.Models.SBNamespaceUpdateParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SBNamespaceUpdateParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="sku">Sku のプロパティ</param>
        <param name="provisioningState">名前空間のプロビジョニング状態。</param>
        <param name="createdAt">名前空間が作成された時刻。</param>
        <param name="updatedAt">名前空間が更新された時刻。</param>
