<Type Name="CorrelationFilter" FullName="Microsoft.Azure.Management.ServiceBus.Models.CorrelationFilter">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dd4ae-101">相関関係のフィルター式を表します。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-101">Represents the correlation filter expression.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd4ae-102">CorrelationFilter クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-102">Initializes a new instance of the CorrelationFilter class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="correlationId"><span data-ttu-id="dd4ae-103">関連付けの識別子</span><span class="sxs-lookup"><span data-stu-id="dd4ae-103">Identifier of the correlation.</span></span></param>
        <param name="messageId"><span data-ttu-id="dd4ae-104">メッセージの識別子。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-104">Identifier of the message.</span></span></param>
        <param name="to"><span data-ttu-id="dd4ae-105">送信先アドレス</span><span class="sxs-lookup"><span data-stu-id="dd4ae-105">Address to send to.</span></span></param>
        <param name="replyTo"><span data-ttu-id="dd4ae-106">返信するキューのアドレス</span><span class="sxs-lookup"><span data-stu-id="dd4ae-106">Address of the queue to reply to.</span></span></param>
        <param name="label"><span data-ttu-id="dd4ae-107">アプリケーション固有のラベル。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-107">Application specific label.</span></span></param>
        <param name="sessionId"><span data-ttu-id="dd4ae-108">セッションの識別子です。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-108">Session identifier.</span></span></param>
        <param name="replyToSessionId"><span data-ttu-id="dd4ae-109">返信するセッション識別子です。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-109">Session identifier to reply to.</span></span></param>
        <param name="contentType"><span data-ttu-id="dd4ae-110">メッセージのコンテンツの種類。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-110">Content type of the message.</span></span></param>
        <param name="requiresPreprocessing"><span data-ttu-id="dd4ae-111">前処理を規則の操作が必要かどうかを示す値です。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-111">Value that indicates whether the rule action requires preprocessing.</span></span></param>
        <summary>
            <span data-ttu-id="dd4ae-112">CorrelationFilter クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-112">Initializes a new instance of the CorrelationFilter class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ContentType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd4ae-113">取得またはメッセージのコンテンツの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-113">Gets or sets content type of the message.</span></span>
            </summary>
    ...
    <Member MemberName="CorrelationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd4ae-114">取得または設定の相関関係の識別子。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-114">Gets or sets identifier of the correlation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Label">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd4ae-115">取得またはアプリケーション固有のラベルを設定します。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-115">Gets or sets application specific label.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MessageId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd4ae-116">取得またはメッセージの識別子を設定します。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-116">Gets or sets identifier of the message.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReplyTo">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd4ae-117">取得またはに返信するキューのアドレスを設定します。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-117">Gets or sets address of the queue to reply to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReplyToSessionId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd4ae-118">取得または設定に返信するセッション識別子。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-118">Gets or sets session identifier to reply to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequiresPreprocessing">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd4ae-119">取得またはプリプロセスを規則の操作が必要かどうかを示す値を設定します。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-119">Gets or sets value that indicates whether the rule action requires preprocessing.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SessionId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd4ae-120">取得またはセッション識別子を設定します。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-120">Gets or sets session identifier.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="To">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dd4ae-121">取得または送信するアドレスを設定します。</span><span class="sxs-lookup"><span data-stu-id="dd4ae-121">Gets or sets address to send to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
