<Type Name="SBSku" FullName="Microsoft.Azure.Management.ServiceBus.Models.SBSku">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">この SKU の名前です。 使用可能な値が含まれます: 'Basic'、'Standard'、'Premium'</param>
        <param name="tier">この特定の SKU の請求層です。
            使用可能な値が含まれます: 'Basic'、'Standard'、'Premium'</param>
        <param name="capacity">階層の指定したメッセージング単位です。
            Premium 階層では、容量に 1、2 および 4 を使用します。</param>
        <summary>
            SBSku クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            取得または層に対して指定したメッセージング ユニットを設定します。 Premium 階層では、容量に 1、2 および 4 を使用します。
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得またはこの SKU の名前を設定します。 使用可能な値が含まれます: 'Basic'、'Standard'、'Premium'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            取得またはこの特定の SKU の請求層を設定します。 使用可能な値が含まれます: 'Basic'、'Standard'、'Premium'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
