<Type Name="CheckNameAvailability" FullName="Microsoft.Azure.Management.ServiceBus.Models.CheckNameAvailability">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            CheckNameAvailability クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">名前空間の名前の可用性を確認する名前と名前空間の名前は、アルファベット、数字、およびハイフンのみを含めることができます。 名前空間は文字で始める必要があり、最後の文字または数字。</param>
        <summary>
            CheckNameAvailability クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            名前空間の名前の可用性を確認する名前と名前空間の名前には、のみを取得または設定は、文字、数字、およびハイフンです。
            名前空間は文字で始める必要があり、最後の文字または数字。
            </summary>
