<Type Name="FeedResponse&lt;T&gt;" FullName="Microsoft.Azure.Documents.Client.FeedResponse&lt;T&gt;">
  ...
  <Docs>
    ...
    <summary>
            Azure Cosmos DB サービスのメソッド (列挙操作) フィードで使用されるテンプレート クラスを表します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ContentLocation">
      ...
      <Docs>
        <summary>
            バーを取得、親のコンテンツの場所など、db/foo/colls/、Cosmos DB の Azure サービスからです。
            </summary>
    ...
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービスからの応答で返される項目数を取得します。
            </summary>
        <value>
            応答内の項目の数。
            </value>
    ...
    <Member MemberName="IsRUPerMinuteUsed">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB からの応答に関連付けられているフラグの要求単位 (Ru) からこのフィードの要求が処理されるかどうかをサービス/か、容量を分単位を取得します。
            </summary>
        <value>
    ...
    <Member MemberName="QueryMetrics">
      ...
      <Docs>
        <summary>
            取得<see cref="T:Microsoft.Azure.Documents.QueryMetrics" />Azure Cosmos DB サービスの個別のパーティションごとに
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TriggersUsage">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービスからコレクションのトリガーの現在の数を取得します。
            </summary>
        <value>
            現在のトリガーの数。
            </value>
