<Type Name="AccessCondition" FullName="Microsoft.Azure.Documents.Client.AccessCondition">
  ...
  <Docs>
    <summary>
            Azure Cosmos DB サービスの操作をするためのアクセス条件のセットを表します。
            </summary>
    ...
    <example>
            次の例では、DocumentClient で AccessCondition を使用する方法を示します。
  ...
  <Members>
    ...
    <Member MemberName="Condition">
      ...
      <Docs>
        <summary>
            取得または Azure Cosmos DB サービスの条件の値を設定します。
            </summary>
        <value>
            現在の状態の値です。 <see cref="T:Microsoft.Azure.Documents.Client.AccessConditionType" /> IfMatch IfNotMatch は、これは ETag と比較するためにあります。
            </value>
        <remarks>To be added.</remarks>
        <altmember cref="T:Microsoft.Azure.Documents.Resource" />
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            取得または Azure Cosmos DB サービスの条件の種類を設定します。
            </summary>
        <value>
