<Type Name="INSRecordSets" FullName="Microsoft.Azure.Management.Dns.Fluent.INSRecordSets">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="98ddf-101">Azure DNS ゾーンの NS レコードへのエントリ ポイントを設定します。</span><span class="sxs-lookup"><span data-stu-id="98ddf-101">Entry point to NS record sets in an Azure DNS zone.</span></span>
            </summary>
