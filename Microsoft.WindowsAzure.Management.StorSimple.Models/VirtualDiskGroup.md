<Type Name="VirtualDiskGroup" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.VirtualDiskGroup">
  ...
  <Docs>
    <summary>
            このクラスは、仮想ディスク グループ (ボリューム グループ) を表します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualDiskGroup クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で VirtualDiskGroup クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="InstanceId">
      ...
      <Docs>
        <summary>
            省略可能。 取得または設定、ボリューム グループのインスタンス id
            </summary>
    ...
    <Member MemberName="OperationInProgress">
      ...
      <Docs>
        <summary>
            省略可能。 取得または任意の操作が進行中かどうかを示す値を設定
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualDiskList">
      ...
      <Docs>
        <summary>
            必須。 取得またはボリューム グループに関連付けられているボリュームの一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
