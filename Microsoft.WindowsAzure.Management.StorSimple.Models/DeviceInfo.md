<Type Name="DeviceInfo" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.DeviceInfo">
  ...
  <Members>
    ...
    <Member MemberName="ACRCount">
      ...
      <Docs>
        <summary>
            必須。 カウントのアクセス制御レコード、デバイス上に存在します。
            </summary>
    ...
    <Member MemberName="CloudCredCount">
      ...
      <Docs>
        <summary>
            必須。 カウントの CloudCreds デバイス内に存在します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DataContainerCount">
      ...
      <Docs>
        <summary>
            必須。 カウントの DataContainers デバイス内に存在します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsConfigUpdated">
      ...
      <Docs>
        <summary>
            必須。 これは、そのデバイスが登録の投稿適切に構成されてを示します
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsVirtualApplianceInterimEntry">
      ...
      <Docs>
        <summary>
            必須。 これは、これがプロビジョニング中である仮想アプライアンスであることを示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
