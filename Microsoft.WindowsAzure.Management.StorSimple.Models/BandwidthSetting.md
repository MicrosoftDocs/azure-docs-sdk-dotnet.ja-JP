  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で BandwidthSetting クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreatedFromTemplateId">
      ...
      <Docs>
        <summary>
            必須。 取得または帯域幅の設定の作成元のテンプレートの id を設定します。
            </summary>
    ...
    <Member MemberName="InstanceId">
      ...
      <Docs>
        <summary>
            省略可能。 取得または帯域幅の設定のインスタンス id を設定
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationInProgress">
      ...
      <Docs>
        <summary>
            省略可能。 取得または実行中の操作があるかどうかを示す値を設定
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Schedules">
      ...
      <Docs>
        <summary>
            必須。 取得または帯域幅は現在の帯域幅設定を関連付けられているスケジュールを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VolumeCount">
      ...
      <Docs>
        <summary>
            省略可能。 取得または帯域幅の設定を適用するボリュームの数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
