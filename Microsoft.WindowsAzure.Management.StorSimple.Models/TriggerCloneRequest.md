<Type Name="TriggerCloneRequest" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.TriggerCloneRequest">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            TriggerCloneRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BackupSetId">
      ...
      <Docs>
        <summary>
            必須。 バックアップ セットの一部では、現在のスナップショットの id
            </summary>
    ...
    <Member MemberName="ReturnWorkflowId">
      ...
      <Docs>
        <summary>
            省略可能。 メソッドが、workflowId を返すかどうかを決定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SourceSnapshot">
      ...
      <Docs>
        <summary>
            必須。 クローンを作成するのには、バックアップからのスナップショット
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetACRIdList">
      ...
      <Docs>
        <summary>
            省略可能。 複製されたボリュームに追加する既存のアクセス制御レコードの一覧
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetACRList">
      ...
      <Docs>
        <summary>
            省略可能。 複製されたボリュームに追加する新しいアクセス制御レコードの一覧
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetDeviceId">
      ...
      <Docs>
        <summary>
            必須。 ターゲット デバイス id にボリュームを複製する必要があります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
