<Type Name="IWithPublicIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerPublicFrontend.Update.IWithPublicIPAddress">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5d3d6-101">既存のパブリック IP アドレスを指定できるようにパブリック フロント エンドの更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="5d3d6-101">The stage of a public frontend update allowing to specify an existing public IP address.</span></span>
            </summary>
