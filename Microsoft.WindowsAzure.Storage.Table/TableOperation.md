<Type Name="TableOperation" FullName="Microsoft.WindowsAzure.Storage.Table.TableOperation">
  ...
  <Members>
    <Member MemberName="Delete">
      ...
      <Docs>
        <param name="entity"><see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" />テーブルから削除するオブジェクト。</param>
        <summary>
            指定されたエンティティをテーブルから削除する新しいテーブル操作を作成します。
            </summary>
        <returns><see cref="T:Microsoft.WindowsAzure.Storage.Table.TableOperation" /> オブジェクト。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Insert">
      ...
      <Docs>
        <param name="entity"><see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" />テーブルに挿入するオブジェクト。</param>
        <summary>
    ...
    <Member MemberName="InsertOrMerge">
      ...
      <Docs>
        <param name="entity"><see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" />挿入またはマージするオブジェクト。</param>
        <summary>
    ...
    <Member MemberName="InsertOrReplace">
      ...
      <Docs>
        <param name="entity"><see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" />挿入または置換するオブジェクト。</param>
        <summary>
    ...
    <Member MemberName="Merge">
      ...
      <Docs>
        <param name="entity"><see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" />マージするオブジェクト。</param>
        <summary>
    ...
    <Member MemberName="Replace">
      ...
      <Docs>
        <param name="entity"><see cref="T:Microsoft.WindowsAzure.Storage.Table.ITableEntity" />置き換えられるオブジェクトです。</param>
        <summary>
    ...
    <Member MemberName="RotateEncryptionKey">
      ...
      <Docs>
        <param name="entity"><see cref="T:Microsoft.WindowsAzure.Storage.Table.KeyRotationEntity" />回転そのキーが存在するエンティティ。  "ExecuteQueryForKeyRotation()"呼び出しへの呼び出しの出力にする必要があります。</param>
        <summary>
