<Type Name="TableQuerySegment&lt;TElement&gt;" FullName="Microsoft.WindowsAzure.Storage.Table.TableQuerySegment&lt;TElement&gt;">
  ...
  <Members>
    ...
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.Table.TableQuerySegment`1" /> を反復処理する列挙子を返します。
            </summary>
        <returns>反復処理する列挙子、<see cref="T:Microsoft.WindowsAzure.Storage.Table.TableQuerySegment`1" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
