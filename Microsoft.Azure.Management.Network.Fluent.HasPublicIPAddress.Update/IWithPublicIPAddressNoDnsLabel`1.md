<Type Name="IWithPublicIPAddressNoDnsLabel&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasPublicIPAddress.Update.IWithPublicIPAddressNoDnsLabel&lt;ReturnT&gt;">
  ...
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="c7391-101">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c7391-101">The next stage of the definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="c7391-102">関連付けるパブリック IP アドレスでは、リソースの更新の許可するが、DNS リーフ ラベルを作成するのには許可しないの段階です。</span><span class="sxs-lookup"><span data-stu-id="c7391-102">The stage of the update allowing to associate the resource with a public IP address, but not allowing to create one with a DNS leaf label.</span></span>
            </summary>
