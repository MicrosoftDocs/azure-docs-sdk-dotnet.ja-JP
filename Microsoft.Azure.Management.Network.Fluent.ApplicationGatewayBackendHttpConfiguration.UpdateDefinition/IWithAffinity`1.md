<Type Name="IWithAffinity&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayBackendHttpConfiguration.UpdateDefinition.IWithAffinity&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="12374-101">この定義をアタッチした後に戻るには、親アプリケーション ゲートウェイ定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="12374-101">The stage of the parent application gateway definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="12374-102">アフィニティを有効または無効に cookie を許可するアプリケーション ゲートウェイ バックエンド HTTP 構成の段階に基づいています。</span><span class="sxs-lookup"><span data-stu-id="12374-102">The stage of an application gateway backend HTTP configuration allowing to enable or disable cookie based affinity.</span></span>
            </summary>
