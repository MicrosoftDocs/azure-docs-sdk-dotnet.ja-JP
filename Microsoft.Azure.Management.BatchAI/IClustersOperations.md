    ...
    <Member MemberName="BeginCreateWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="clusterName">
            指定されたリソース グループ内でクラスターの名前。
            クラスター名には、およびダッシュ (-) とアンダー スコア (_) 文字の英数字の組み合わせのみを含めることができます。 名前は、1 ~ 64 文字以内でなければなりません。
            </param>
        ...
        <summary>
            クラスターを追加します。 クラスターとは、コンピューティング ノードのコレクションです。
            同じクラスター上に複数のジョブを実行できます。
            </summary>
