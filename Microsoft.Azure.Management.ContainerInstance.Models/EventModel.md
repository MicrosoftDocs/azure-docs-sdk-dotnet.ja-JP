<Type Name="EventModel" FullName="Microsoft.Azure.Management.ContainerInstance.Models.EventModel">
  ...
  <Docs>
    <summary>
            コンテナーのグループまたはコンテナー インスタンス イベント。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="count">イベントの数。</param>
        <param name="firstTimestamp">最も早い日付時刻は、イベントを記録します。</param>
        <param name="lastTimestamp">最新のログに記録されたイベントの日付時刻。</param>
        <param name="name">イベントの名前です。</param>
        <param name="message">イベント メッセージ。</param>
    ...
    <Member MemberName="FirstTimestamp">
      ...
      <Docs>
        <summary>
            取得または最も古いログに記録されたイベントの日付/時刻を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastTimestamp">
      ...
      <Docs>
        <summary>
            取得または最新のログに記録されたイベントの日付/時刻を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
