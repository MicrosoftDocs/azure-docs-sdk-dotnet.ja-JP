<Type Name="ContainerNetworkProtocol" FullName="Microsoft.Azure.Management.ContainerInstance.Models.ContainerNetworkProtocol">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="296fd-101">ContainerNetworkProtocol の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="296fd-101">Defines values for ContainerNetworkProtocol.</span></span>
            </summary>
