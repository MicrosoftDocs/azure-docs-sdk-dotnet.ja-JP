<Type Name="ResourceRequests" FullName="Microsoft.Azure.Management.ContainerInstance.Models.ResourceRequests">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ResourceRequests クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="memoryInGB">このコンテナーのインスタンスの GB のメモリ要求。</param>
        <param name="cpu">このコンテナーのインスタンスの CPU 要求。</param>
        <summary>
            ResourceRequests クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Cpu">
      ...
      <Docs>
        <summary>
            取得または、このコンテナーのインスタンスの CPU 要求を設定します。
            </summary>
    ...
    <Member MemberName="MemoryInGB">
      ...
      <Docs>
        <summary>
            取得またはメモリ要求をこのコンテナーのインスタンスの GB に設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
