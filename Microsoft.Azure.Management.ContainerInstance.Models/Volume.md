<Type Name="Volume" FullName="Microsoft.Azure.Management.ContainerInstance.Models.Volume">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">ボリュームの名前。</param>
        <param name="azureFile">Azure ファイルのボリュームの名前。</param>
        <param name="emptyDir">空のディレクトリのボリューム。</param>
        <summary>
            ボリューム クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AzureFile">
      ...
      <Docs>
        <summary>
            取得または Azure ファイルのボリュームの名前を設定します。
            </summary>
