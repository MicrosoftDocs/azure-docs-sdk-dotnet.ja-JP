<Type Name="ResourceLimits" FullName="Microsoft.Azure.Management.ContainerInstance.Models.ResourceLimits">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ResourceLimits クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="memoryInGB">このコンテナーのインスタンスの GB のメモリの上限。</param>
        <param name="cpu">このコンテナーのインスタンスの CPU の制限。</param>
        <summary>
            ResourceLimits クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Cpu">
      ...
      <Docs>
        <summary>
            取得または、このコンテナーのインスタンスの CPU の制限を設定します。
            </summary>
    ...
    <Member MemberName="MemoryInGB">
      ...
      <Docs>
        <summary>
            取得または gb このコンテナーのインスタンスのメモリの制限を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
