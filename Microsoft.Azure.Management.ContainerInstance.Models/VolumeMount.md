<Type Name="VolumeMount" FullName="Microsoft.Azure.Management.ContainerInstance.Models.VolumeMount">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">ボリュームのマウントの名前。</param>
        <param name="mountPath">ボリュームのマウントされているコンテナー内のパス。 コロン (:) が含まれていない必要があります。</param>
        <param name="readOnlyProperty">ボリュームのマウントは読み取り専用であるかどうかを示すフラグ。</param>
        <summary>
            VolumeMount クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="MountPath">
      ...
      <Docs>
        <summary>
            取得またはボリュームのマウントされているコンテナー内のパスを設定します。 コロン (:) が含まれていない必要があります。
            </summary>
    ...
    <Member MemberName="ReadOnlyProperty">
      ...
      <Docs>
        <summary>
            取得またはボリュームのマウントは読み取り専用であるかどうかを示すフラグを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
