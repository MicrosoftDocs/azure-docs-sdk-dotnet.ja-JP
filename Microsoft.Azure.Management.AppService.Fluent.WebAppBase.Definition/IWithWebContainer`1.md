<Type Name="IWithWebContainer&lt;FluentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.WebAppBase.Definition.IWithWebContainer&lt;FluentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="FluentT"><span data-ttu-id="ec16f-101">リソースの型。</span><span class="sxs-lookup"><span data-stu-id="ec16f-101">The type of the resource.</span></span></typeparam>
    <summary>
            <span data-ttu-id="ec16f-102">Java web コンテナーを設定するように、web アプリ定義段階です。</span><span class="sxs-lookup"><span data-stu-id="ec16f-102">A web app definition stage allowing Java web container to be set.</span></span> <span data-ttu-id="ec16f-103">Java バージョンを指定した後に必要です。</span><span class="sxs-lookup"><span data-stu-id="ec16f-103">This is required after specifying Java version.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithWebContainer">
      ...
      <Docs>
        <param name="webContainer"><span data-ttu-id="ec16f-104">Java web コンテナーです。</span><span class="sxs-lookup"><span data-stu-id="ec16f-104">The Java web container.</span></span></param>
        <summary>
            <span data-ttu-id="ec16f-105">Java web コンテナーを指定します。</span><span class="sxs-lookup"><span data-stu-id="ec16f-105">Specifies the Java web container.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="ec16f-106">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="ec16f-106">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>