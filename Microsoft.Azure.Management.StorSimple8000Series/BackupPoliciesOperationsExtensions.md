    ...
    <Member MemberName="BackupNow">
      ...
      <Docs>
        ...
        <param name="backupType">
            バックアップの種類。 これには、cloudSnapshot または localSnapshot を指定できます。
            </param>
