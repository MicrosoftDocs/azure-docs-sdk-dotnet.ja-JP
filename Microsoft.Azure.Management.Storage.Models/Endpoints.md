<Type Name="Endpoints" FullName="Microsoft.Azure.Management.Storage.Models.Endpoints">
  ...
  <Docs>
    <summary>
            パブリック blob、キュー、またはテーブル オブジェクトを取得する際に使用される Uri。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="blob">Blob エンドポイントを取得します。</param>
        <param name="queue">キューのエンドポイントを取得します。</param>
        <param name="table">テーブルのエンドポイントを取得します。</param>
        <param name="file">ファイルのエンドポイントを取得します。</param>
        <summary>
            エンドポイント クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
