<Type Name="OperationDisplay" FullName="Microsoft.Azure.Management.Storage.Models.OperationDisplay">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provider">サービス プロバイダー: Microsoft 記憶域。</param>
        <param name="resource">操作が実行されるなどのリソースです。</param>
    ...
    <Member MemberName="Provider">
      ...
      <Docs>
        <summary>
            サービス プロバイダー取得または設定します。 Microsoft 記憶域。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
