<Type Name="ListAccountSasResponse" FullName="Microsoft.Azure.Management.Storage.Models.ListAccountSasResponse">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ListAccountSasResponse クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="accountSasToken">ストレージ アカウントの SAS の資格情報を一覧表示します。</param>
        <summary>
            ListAccountSasResponse クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AccountSasToken">
      ...
      <Docs>
        <summary>
            ストレージ アカウントの SAS の資格情報の一覧を取得します。
            </summary>
