<Type Name="MetricSpecification" FullName="Microsoft.Azure.Management.Storage.Models.MetricSpecification">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">メトリックの仕様の名前。</param>
        <param name="displayName">メトリックの仕様の名前を表示します。</param>
        <param name="displayDescription">メトリックの仕様の説明を表示します。</param>
        <param name="unit">単位は、バイトまたはカウントがあります。</param>
        <param name="dimensions">Blob の種類とアクセスのレベルなど、blob のサイズ。</param>
        <param name="aggregationType">集計の種類には、平均可能性があります。</param>
        <param name="fillGapWithZero">か 0 で塗りつぶしギャップを決定するプロパティです。</param>
        <param name="category">このメトリックの仕様が属しているカテゴリには、容量があります。</param>
        <param name="resourceIdDimensionNameOverride">アカウントのリソース id です。</param>
        <summary>
            MetricSpecification クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Category">
      ...
      <Docs>
        <summary>
            取得または設定に、このメトリックの仕様が属しているカテゴリの容量がある可能性があります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Dimensions">
      ...
      <Docs>
        <summary>
            取得または blob の種類とアクセスのレベルなど、blob のサイズを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FillGapWithZero">
      ...
      <Docs>
        <summary>
            取得またはか 0 で塗りつぶしギャップを決定するプロパティを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
