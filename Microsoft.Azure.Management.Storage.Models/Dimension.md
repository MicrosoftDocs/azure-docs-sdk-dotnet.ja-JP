<Type Name="Dimension" FullName="Microsoft.Azure.Management.Storage.Models.Dimension">
  ...
  <Docs>
    <summary>
            Blob のディメンションは、blob のタイプやアクセス層を possiblly あります。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">ディメンションの名前を表示します。</param>
        <param name="displayName">ディメンションの名前を表示します。</param>
        <summary>
            ディメンションのクラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
