<Type Name="ListServiceSasResponse" FullName="Microsoft.Azure.Management.Storage.Models.ListServiceSasResponse">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ListServiceSasResponse クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serviceSasToken">Speicific リソースのサービスの SAS 資格情報を一覧表示します。</param>
        <summary>
            ListServiceSasResponse クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ServiceSasToken">
      ...
      <Docs>
        <summary>
            Speicific リソースの一覧のサービス SAS の資格情報を取得します。
            </summary>
