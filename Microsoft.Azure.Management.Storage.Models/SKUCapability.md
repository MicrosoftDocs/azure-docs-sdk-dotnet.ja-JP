<Type Name="SKUCapability" FullName="Microsoft.Azure.Management.Storage.Models.SKUCapability">
  ...
  <Docs>
    <summary>
            ファイルの暗号化、ネットワーク acl、変更通知などを含む、指定した sku の機能の情報です。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SKUCapability クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">機能、指定した sku の機能の情報の名前は、ファイルの暗号化、ネットワーク acl、変更通知も含まれます。</param>
        <param name="value">特定の機能のことを示す文字列値を示しています。 可能性のある 'true' または 'false' です。</param>
        <summary>
            SKUCapability クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            機能、ファイルの暗号化、ネットワーク acl、変更通知などを含む、指定した sku の機能の情報の名前を取得します。
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            ことを示す文字列値という特定の機能を取得します。
            可能性のある 'true' または 'false' です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
