<Type Name="IWithExistingDatabase" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlDatabase.Definition.IWithExistingDatabase">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c6912-101">ステージを決定するか、既存のデータベースを使用するかどうか。</span><span class="sxs-lookup"><span data-stu-id="c6912-101">The stage to decide whether using existing database or not.</span></span>
            </summary>
