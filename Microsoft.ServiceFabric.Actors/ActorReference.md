<Type Name="ActorReference" FullName="Microsoft.ServiceFabric.Actors.ActorReference">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ActorReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ActorId">
      ...
      <Docs>
        <summary>
            取得または設定、<see cref="T:Microsoft.ServiceFabric.Actors.ActorId" />アクターのです。
            </summary>
        <value>
          <see cref="T:Microsoft.ServiceFabric.Actors.ActorId" />アクターです。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Bind">
      ...
      <Docs>
        <param name="actorInterfaceType">作成されたのアクター インターフェイス<see cref="T:Microsoft.ServiceFabric.Actors.Client.ActorProxy" />を実装します。</param>
        <summary>
            作成、<see cref="T:Microsoft.ServiceFabric.Actors.Client.ActorProxy" />を使用するアクターのアクターのインターフェイスを実装する、<see cref="M:Microsoft.ServiceFabric.Actors.Client.ActorProxyFactory.CreateActorProxy(System.Type,System.Uri,Microsoft.ServiceFabric.Actors.ActorId,System.String)" />メソッドです。
                </summary>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        <param name="actor">取得するアクター オブジェクト<see cref="T:Microsoft.ServiceFabric.Actors.ActorReference" />用です。</param>
        <summary>
            取得<see cref="T:Microsoft.ServiceFabric.Actors.ActorReference" />アクターのです。
            </summary>
        <returns>
          <see cref="T:Microsoft.ServiceFabric.Actors.ActorReference" />アクターのオブジェクトです。</returns>
        <remarks>アクターが null として渡された場合、null 値が返されます。</remarks>
      </Docs>
    </Member>
    <Member MemberName="ListenerName">
      ...
      <Docs>
        <summary>
            取得またはアクター サービスと通信するときに使用するアクター サービスで、リスナーの名前を設定します。
            </summary>
        <value>リスナーの名前</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceUri">
      ...
      <Docs>
        <summary>
            Service fabric クラスターのアクターをホストするアクター サービスの Uri を取得します。
            </summary>
        <value>Service fabric クラスターのアクターをホストするサービスの Uri。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
