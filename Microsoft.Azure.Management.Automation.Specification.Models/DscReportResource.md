<Type Name="DscReportResource" FullName="Microsoft.Azure.Management.Automation.Specification.Models.DscReportResource">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DscReportResource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DependsOn">
      ...
      <Docs>
        <summary>
            省略可能。 取得または、リソースに依存するリソースのリソース ナビゲーション値を設定します。
            </summary>
    ...
    <Member MemberName="ModuleVersion">
      ...
      <Docs>
        <summary>
            省略可能。 取得またはリソースのモジュールのバージョンを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
