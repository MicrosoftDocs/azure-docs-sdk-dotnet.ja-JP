<Type Name="Lease" FullName="Microsoft.ServiceBus.Messaging.Lease">
  ...
  <Interfaces />
  <Docs>
    <summary>パーティションの所有権情報が含まれています。</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><see cref="T:Microsoft.ServiceBus.Messaging.Lease" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="source">指定した<see cref="M:Microsoft.ServiceBus.Messaging.Lease.#ctor(Microsoft.ServiceBus.Messaging.Lease)" />インスタンスから、プロパティの値がコピーされます。</param>
        <summary>新しいインスタンスを初期化、 <see cref="T:Microsoft.ServiceBus.Messaging.Lease" /> 、指定したクラス<see cref="M:Microsoft.ServiceBus.Messaging.Lease.#ctor(Microsoft.ServiceBus.Messaging.Lease)" />参照と値。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Epoch">
      ...
      <Docs>
        <summary>取得または競合するノードの間でパーティションの最新の所有者を特定する使用できる値は、リースのエポック年を設定します。</summary>
        <value>リースのエポック年。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Equals">
      ...
      <Docs>
        ...
        <summary>このインスタンスが、指定したオブジェクトと等しいかどうかを判断します。</summary>
        <returns>このインスタンスが指定したオブジェクトと等しい場合は true。それ以外の場合は false です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="IsExpired">
      ...
      <Parameters />
      <Docs>
        <summary>リースの期限が切れているかどうかを判断します。</summary>
        <returns>リースの有効期限が切れて; 場合は true。それ以外の場合は false です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Offset">
      ...
      <Docs>
        <summary>取得またはストリーム内のオフセットの現在の値を設定します。</summary>
        <value>リースのオフセット。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Owner">
      ...
      <Docs>
        <summary>取得またはパーティションのホスト所有者を設定します。</summary>
        <value>パーティションのホストの所有者です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PartitionId">
      ...
      <Docs>
        <summary>このリースが属しているパーティションの ID を取得します。</summary>
    ...
    <Member MemberName="SequenceNumber">
      ...
      <Docs>
        <summary>取得またはストリームの最後のチェックポイントが設定されたシーケンス番号を設定します。</summary>
    ...
    <Member MemberName="Token">
      ...
      <Docs>
        <summary>取得またはホスト間で同時に管理リース トークンを設定します。 必要なすべてのリソースへの単一のアクセスを保証するためにこのトークンを使用することができます、<see cref="T:Microsoft.ServiceBus.Messaging.IEventProcessor" />オブジェクト。</summary>
        <value>リース トークンです。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
