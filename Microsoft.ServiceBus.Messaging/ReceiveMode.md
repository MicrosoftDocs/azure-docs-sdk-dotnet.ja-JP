<Type Name="ReceiveMode" FullName="Microsoft.ServiceBus.Messaging.ReceiveMode">
  ...
  <Docs>
    <summary>受信モードの値を列挙します。 <span data-ttu-id="4559f-102">既定では、 <see cref="F:Microsoft.ServiceBus.Messaging.ReceiveMode.PeekLock" />です。</span><span class="sxs-lookup"><span data-stu-id="4559f-102">The default is <see cref="F:Microsoft.ServiceBus.Messaging.ReceiveMode.PeekLock" />.</span></span></summary>
  ...
  <Members>
    <Member MemberName="PeekLock">
      ...
      <Docs>
        <summary><span data-ttu-id="4559f-103">PeekLock 受信モードを指定します。</span><span class="sxs-lookup"><span data-stu-id="4559f-103">Specifies the PeekLock receive mode.</span></span> <span data-ttu-id="4559f-104">これは、<see cref="T:Microsoft.ServiceBus.Messaging.ReceiveMode" /> の既定値です。</span><span class="sxs-lookup"><span data-stu-id="4559f-104">This is the default value for <see cref="T:Microsoft.ServiceBus.Messaging.ReceiveMode" />.</span></span></summary>
      </Docs>
    </Member>
    <Member MemberName="ReceiveAndDelete">
      ...
      <Docs>
        <summary><span data-ttu-id="4559f-105">ReceiveAndDelete 受信モードを指定します。</span><span class="sxs-lookup"><span data-stu-id="4559f-105">Specifies the ReceiveAndDelete receive mode.</span></span></summary>
      </Docs>
    </Member>
  </Members>
</Type>