<Type Name="LeaseLostException" FullName="Microsoft.ServiceBus.Messaging.LeaseLostException">
  ...
  <Interfaces />
  <Docs>
    <summary>サービスのリースが失われたときに発生する例外を表します。</summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary>既定値を使用して <see cref="T:Microsoft.ServiceBus.Messaging.LeaseLostException" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="lease">メッセージのリースです。</param>
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.ServiceBus.Messaging.LeaseLostException" />クラスの指定されたリースを使用します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="message">エラーに関連付けられているメッセージ。</param>
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.ServiceBus.Messaging.LeaseLostException" />クラスの指定したエラー メッセージを使用します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.ServiceBus.Messaging.LeaseLostException" />クラスの指定されたリースと、例外の原因となったエラーを使用します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="info">例外に関するシリアル化された情報です。</param>
        <param name="context">転送元または転送先に関するコンテキスト情報。</param>
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.ServiceBus.Messaging.LeaseLostException" />クラスの指定した情報とコンテキストを使用します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="message">エラーに関連付けられているメッセージ。</param>
        <param name="innerException">例外の原因となったエラー。</param>
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.ServiceBus.Messaging.LeaseLostException" />クラスを使用するエラー メッセージと内部例外を指定します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Lease">
      ...
      <Docs>
        <summary>取得またはサービス リースを設定します。</summary>
        <value>サービス リースします。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
