<Type Name="PairedNamespaceEventArgs" FullName="Microsoft.ServiceBus.Messaging.PairedNamespaceEventArgs">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="c0b56-101">Service bus のメッセージングのペアの名前空間に関連付けられているイベントの引数を表します。</span><span class="sxs-lookup"><span data-stu-id="c0b56-101">Represents the event arguments associated with paired namespace for the service bus messaging.</span></span></summary>
  ...
  <Members>
    <Member MemberName="Options">
      ...
      <Docs>
        <summary><span data-ttu-id="c0b56-102">取得または設定のオプションは、ペアの名前空間に関連付けられています。</span><span class="sxs-lookup"><span data-stu-id="c0b56-102">Gets or sets the options associated the paired namespace.</span></span></summary>
        <value><span data-ttu-id="c0b56-103">オプションには、ペアの名前空間が関連付けられています。</span><span class="sxs-lookup"><span data-stu-id="c0b56-103">The options associated the paired namespace.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
