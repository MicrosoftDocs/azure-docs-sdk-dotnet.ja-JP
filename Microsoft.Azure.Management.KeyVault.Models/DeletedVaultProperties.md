<Type Name="DeletedVaultProperties" FullName="Microsoft.Azure.Management.KeyVault.Models.DeletedVaultProperties">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="vaultId">元の資格情報コンテナーのリソース id です。</param>
        <param name="location">元の資格情報コンテナーの場所です。</param>
        <param name="deletionDate">削除された日です。</param>
        <param name="scheduledPurgeDate">スケジュールのパージされた日付。</param>
        <param name="tags">元の資格情報コンテナーのタグ。</param>
        <summary>
            DeletedVaultProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
