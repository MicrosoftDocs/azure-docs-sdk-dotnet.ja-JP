<Type Name="IOAuthOperations" FullName="Microsoft.Azure.Management.DataFactories.IOAuthOperations">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b1ec0-101">OAuth 承認のための操作です。</span><span class="sxs-lookup"><span data-stu-id="b1ec0-101">Operations for OAuth authorization.</span></span>
            </summary>
    ...
    <Member MemberName="GetAsync">
      ...
      <Docs>
        <param name="resourceGroupName">
            <span data-ttu-id="b1ec0-102">データ ファクトリのリソース グループ名。</span><span class="sxs-lookup"><span data-stu-id="b1ec0-102">The resource group name of the data factory.</span></span>
            </param>
        <param name="dataFactoryName">
            <span data-ttu-id="b1ec0-103">一意のデータ ファクトリのインスタンス名です。</span><span class="sxs-lookup"><span data-stu-id="b1ec0-103">A unique data factory instance name.</span></span>
            </param>
        <param name="linkedServiceType">
            <span data-ttu-id="b1ec0-104">OAuth の種類のリンクされたサービス。</span><span class="sxs-lookup"><span data-stu-id="b1ec0-104">The type of OAuth linked service.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="b1ec0-105">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="b1ec0-105">Cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="b1ec0-106">OAuth 認証セッションを取得します。</span><span class="sxs-lookup"><span data-stu-id="b1ec0-106">Gets an OAuth authorization session.</span></span>
            </summary>
        <returns>
            <span data-ttu-id="b1ec0-107">認証セッションの Get 操作応答します。</span><span class="sxs-lookup"><span data-stu-id="b1ec0-107">The Get authorization session operation response.</span></span>
            </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
