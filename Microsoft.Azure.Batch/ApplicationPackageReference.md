<Type Name="ApplicationPackageReference" FullName="Microsoft.Azure.Batch.ApplicationPackageReference">
  ...
  <Docs>
    <summary>
            コンピューティング ノードを展開するアプリケーション パッケージへの参照。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Batch.ApplicationPackageReference" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ApplicationId">
      ...
      <Docs>
        <summary>
            取得または計算ノードを展開するアプリケーションの id を設定します。
            </summary>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            取得または計算ノードを展開するアプリケーションのバージョンを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            指定しない場合、既定のバージョンのアプリケーション、アプリケーションの設定で定義されているは展開されます。 アプリケーション設定に既定のバージョンが定義されていない場合は、バージョンを指定する必要があります、<see cref="T:Microsoft.Azure.Batch.ApplicationPackageReference" />です。
            </remarks>
      </Docs>
    </Member>
  </Members>
