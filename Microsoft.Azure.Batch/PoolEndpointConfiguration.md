  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <see cref="T:Microsoft.Azure.Batch.PoolEndpointConfiguration" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="InboundNatPools">
      ...
      <Docs>
        <summary>
            個々 のコンピューティング ノードを外部からの特定のポートに対処するために使用する受信の NAT プールの一覧を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>
            Batch プールあたりの着信 NAT プールの最大数は 5 です。
            </remarks>
      </Docs>
    </Member>
  </Members>
