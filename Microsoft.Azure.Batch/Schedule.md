<Type Name="Schedule" FullName="Microsoft.Azure.Batch.Schedule">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Batch.Schedule" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DoNotRunAfter">
      ...
      <Docs>
        <summary>
            取得または設定するまでジョブはスケジュールされなくなりますこのジョブ スケジュール の下のウォール クロック時間。
            </summary>
    ...
    <Member MemberName="DoNotRunUntil">
      ...
      <Docs>
        <summary>
            取得または設定をこのジョブ スケジュール の下の最初のジョブをスケジュールする最早ウォール クロック時間
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecurrenceInterval">
      ...
      <Docs>
        <summary>
            取得またはジョブ スケジュール の下の 2 つの連続するジョブの開始時刻の時間間隔を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartWindow">
      ...
      <Docs>
        <summary>
            取得または設定するには、ジョブのスケジュールがスケジュールされる準備ができてからジョブを開始する時間のウィンドウ。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
