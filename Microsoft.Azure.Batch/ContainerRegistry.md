<Type Name="ContainerRegistry" FullName="Microsoft.Azure.Batch.ContainerRegistry">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="userName">レジストリのサーバーにログインするユーザー名。</param>
        <param name="registryServer">レジストリの URL です。</param>
        <param name="password">レジストリのサーバーへのログイン パスワードです。</param>
        <summary>
            <see cref="T:Microsoft.Azure.Batch.ContainerRegistry" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
