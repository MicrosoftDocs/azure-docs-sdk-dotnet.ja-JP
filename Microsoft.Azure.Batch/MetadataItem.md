<Type Name="MetadataItem" FullName="Microsoft.Azure.Batch.MetadataItem">
  ...
  <Docs>
    <summary>
            バッチ サービスのリソースに関連付けられている名前と値のペア。 バッチ サービスはこのメタデータに意味を割り当てませんこれは、ユーザー コードを使用するためだけです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><see cref="T:Microsoft.Azure.Batch.MetadataItem" /> の名前。</param>
        <param name="value"><see cref="T:Microsoft.Azure.Batch.MetadataItem" /> の値。</param>
        <summary>
            <see cref="T:Microsoft.Azure.Batch.MetadataItem" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Batch.MetadataItem" /> の名前を取得します。
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Batch.MetadataItem" /> の値を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
