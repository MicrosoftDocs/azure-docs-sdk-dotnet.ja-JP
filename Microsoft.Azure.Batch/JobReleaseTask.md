  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <see cref="T:Microsoft.Azure.Batch.JobReleaseTask" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="MaxWallClockTime">
      ...
      <Docs>
        <summary>
            取得または作成時から実行するタスクが許可されている時間の最大期間を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RetentionTime">
      ...
      <Docs>
        <summary>
            取得またはタスクの作業ディレクトリ内のファイルを保有する、実行が完了した時点からの期間を設定します。 この期間の後、タスクの作業ディレクトリは再利用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
