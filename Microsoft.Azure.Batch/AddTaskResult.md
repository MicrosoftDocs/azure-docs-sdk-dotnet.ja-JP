<Type Name="AddTaskResult" FullName="Microsoft.Azure.Batch.AddTaskResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="46b93-101">タスクのコレクションの一部として追加された 1 つのタスクの結果。</span><span class="sxs-lookup"><span data-stu-id="46b93-101">Result for a single task added as part of a collection of tasks.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Error">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46b93-102">タスクを追加しようとしました。 キャッチされたエラーを取得します。</span><span class="sxs-lookup"><span data-stu-id="46b93-102">Gets the error caught while attempting to add the task.</span></span>
            </summary>
    ...
    <Member MemberName="ETag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46b93-103">正常に追加されたタスクに関連付けられた ETag を取得します。</span><span class="sxs-lookup"><span data-stu-id="46b93-103">Gets an ETag associated with a successfully added task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastModified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46b93-104">正常に追加されたタスクに関連付けられている最終更新時刻を取得します。</span><span class="sxs-lookup"><span data-stu-id="46b93-104">Gets the last modified time associated with a successfully added task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46b93-105">正常に追加されたタスクの URL を取得します。</span><span class="sxs-lookup"><span data-stu-id="46b93-105">Gets the URL of a successfully added task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RetryCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46b93-106">このタスクのタスクの追加操作が再試行された回数を取得します。</span><span class="sxs-lookup"><span data-stu-id="46b93-106">Gets the number of times the Add Task operation was retried for this task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46b93-107">追加のタスクの要求の状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="46b93-107">Gets the status of the add task request.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Task">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46b93-108">タスクの詳細を取得します。</span><span class="sxs-lookup"><span data-stu-id="46b93-108">Gets details of the task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TaskId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46b93-109">この結果が適用されるタスクの id を取得します。</span><span class="sxs-lookup"><span data-stu-id="46b93-109">Gets the id of the task which this result applies to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46b93-110">現在のオブジェクトを表す文字列を返します。</span><span class="sxs-lookup"><span data-stu-id="46b93-110">Returns a string that represents the current object.</span></span>
            </summary>
        <returns><span data-ttu-id="46b93-111">現在のオブジェクトを表す文字列。</span><span class="sxs-lookup"><span data-stu-id="46b93-111">A string that represents the current object.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
