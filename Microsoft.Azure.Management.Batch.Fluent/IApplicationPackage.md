<Type Name="IApplicationPackage" FullName="Microsoft.Azure.Management.Batch.Fluent.IApplicationPackage">
  ...
  <Docs>
    <summary>
            Azure Batch のアプリケーション パッケージの変更できないクライアント側表現。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="LastActivationTime">
      ...
      <Docs>
        <summary>
            このアプリケーション パッケージがアクティブ化された最終時刻を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageUrl">
      ...
      <Docs>
        <summary>
            アプリケーションをアップロードするアプリケーション パッケージのストレージの URL を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageUrlExpiry">
      ...
      <Docs>
        <summary>
            アプリケーション パッケージのストレージの URL の有効期限を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
