<Type Name="PublicIPAddressesOperationsExtensions" FullName="Microsoft.Azure.Management.Network.PublicIPAddressesOperationsExtensions">
  ...
  <Docs>
    <summary>
            PublicIPAddressesOperations の拡張メソッド。
            </summary>
  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="parameters">
            作成または更新パブリック IP アドレスを操作に指定されたパラメーター。
            </param>
        <summary>
            作成するか、静的または動的なパブリック IP アドレスを更新します。
            </summary>
    ...
    <Member MemberName="BeginUpdateTags">
      ...
      <Docs>
        ...
        <param name="parameters">
            パブリック IP アドレス タグを更新する指定されたパラメーター。
            </param>
        <summary>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <summary>
            指定されたリソース グループ内の指定されたパブリック IP アドレスを取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListAll">
      ...
      <Docs>
        ...
        <summary>
            サブスクリプションのすべてのパブリック IP アドレスを取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListVirtualMachineScaleSetPublicIPAddresses">
      ...
      <Docs>
        ...
        <summary>
            仮想マシン スケール セット レベル上のすべてのパブリック IP アドレスに関する情報を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListVirtualMachineScaleSetVMPublicIPAddresses">
      ...
      <Docs>
        ...
        <summary>
            仮想マシン スケール セット内の仮想マシンの IP 構成内のすべてのパブリック IP アドレスに関する情報を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
