  ...
  <Members>
    ...
    <Member MemberName="BeginGeneratevpnclientpackage">
      ...
      <Docs>
        ...
        <param name="parameters">
            パラメーターは、VPN クライアント パッケージの操作を生成の仮想ネットワーク ゲートウェイを指定します。
            </param>
        <summary>
            指定されたリソース グループ内の仮想ネットワーク ゲートウェイのクライアントを P2S VPN クライアント パッケージを生成します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginGenerateVpnProfile">
      ...
      <Docs>
        ...
        <summary>
            指定されたリソース グループ内の仮想ネットワーク ゲートウェイのクライアントを P2S VPN プロファイルを生成します。 IKEV2 および radius ベースの認証に使用されます。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginGetVpnProfilePackageUrl">
      ...
      <Docs>
        ...
        <summary>
            事前生成済みの P2S クライアントは、指定されたリソース グループ内の仮想ネットワーク ゲートウェイの VPN プロファイルの取得。 まずを使用して生成する必要があるプロファイル generateVpnProfile です。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BeginUpdateTags">
      ...
      <Docs>
        ...
        <param name="parameters">
            仮想ネットワーク ゲートウェイのタグを更新する指定されたパラメーター。
            </param>
        <summary>
            仮想ネットワーク ゲートウェイのタグを更新します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SupportedVpnDevices">
      ...
      <Docs>
        ...
        <summary>
            サポートされている vpn デバイスの xml 形式の表記を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VpnDeviceConfigurationScript">
      ...
      <Docs>
        ...
        <param name="virtualNetworkGatewayConnectionName">
            構成スクリプトを生成する仮想ネットワーク ゲートウェイの接続の名前。
            </param>
        <param name="parameters">
            Generate vpn デバイス スクリプトの操作に渡されるパラメーター。
            </param>
        <summary>
            Vpn デバイス構成スクリプトの xml 形式の表記を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
