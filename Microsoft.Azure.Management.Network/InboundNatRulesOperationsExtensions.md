  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="inboundNatRuleParameters">
            作成する指定されたパラメーターまたは着信 nat ルールの操作を更新します。
            </param>
        <summary>
            作成またはロード バランサーの着信 nat ルールを更新します。
            </summary>
    ...
    <Member MemberName="BeginDelete">
      ...
      <Docs>
        ...
        <summary>
            指定されたロード バランサーの着信 nat ルールを削除します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <summary>
            指定されたロード バランサーの着信 nat ルールを取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="List">
      ...
      <Docs>
        ...
        <summary>
            ロード バランサーのすべての着信 nat ルールを取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
