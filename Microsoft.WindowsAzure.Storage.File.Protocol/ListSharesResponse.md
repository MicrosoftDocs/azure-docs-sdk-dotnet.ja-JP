<Type Name="ListSharesResponse" FullName="Microsoft.WindowsAzure.Storage.File.Protocol.ListSharesResponse">
  ...
  <Docs>
    <summary>
            一覧作成操作、共有からの応答を解析するためのメソッドを提供します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.File.Protocol.ListSharesResponse" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ParseXml">
      ...
      <Docs>
        <summary>
            共有の一覧作成操作の応答 XML を解析します。
            </summary>
        <returns>列挙可能なコレクション<see cref="T:Microsoft.WindowsAzure.Storage.File.Protocol.FileShareEntry" />オブジェクト。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Shares">
      ...
      <Docs>
        <summary>
            列挙可能なコレクションを取得<see cref="T:Microsoft.WindowsAzure.Storage.File.Protocol.FileShareEntry" />応答からのオブジェクト。
            </summary>
        <value>列挙可能なコレクション<see cref="T:Microsoft.WindowsAzure.Storage.File.Protocol.FileShareEntry" />オブジェクト。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
