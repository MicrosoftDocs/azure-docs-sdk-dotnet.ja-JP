<Type Name="ListFilesAndDirectoriesResponse" FullName="Microsoft.WindowsAzure.Storage.File.Protocol.ListFilesAndDirectoriesResponse">
  ...
  <Docs>
    <summary>
            ファイルの一覧作成操作からの応答を解析するためのメソッドを提供します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.File.Protocol.ListFilesAndDirectoriesResponse" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Files">
      ...
      <Docs>
        <summary>
            実装するオブジェクトの列挙可能なコレクションを取得<see cref="T:Microsoft.WindowsAzure.Storage.File.Protocol.IListFileEntry" />応答からです。
            </summary>
        <value>実装するオブジェクトの列挙可能なコレクション<see cref="T:Microsoft.WindowsAzure.Storage.File.Protocol.IListFileEntry" />です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ParseXml">
      ...
      <Docs>
        <summary>
            ファイルの一覧作成操作の応答に XML を解析します。
            </summary>
        <returns>実装するオブジェクトの列挙可能なコレクション<see cref="T:Microsoft.WindowsAzure.Storage.File.Protocol.IListFileEntry" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
