<Type Name="QueueEntry" FullName="Microsoft.WindowsAzure.Storage.Queue.Protocol.QueueEntry">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f3b05-101">操作を一覧表示するキューの XML 応答で返されるキュー項目を表します。</span><span class="sxs-lookup"><span data-stu-id="f3b05-101">Represents a queue item returned in the XML response for a queue listing operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Metadata">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f3b05-102">キューのユーザー定義メタデータを取得します。</span><span class="sxs-lookup"><span data-stu-id="f3b05-102">Gets the user-defined metadata for the queue.</span></span>
            </summary>
        <value><span data-ttu-id="f3b05-103">名前と値のペアのコレクションとしてのキューのメタデータ。</span><span class="sxs-lookup"><span data-stu-id="f3b05-103">The queue's metadata, as a collection of name-value pairs.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f3b05-104">キューの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="f3b05-104">Gets the name of the queue.</span></span>
            </summary>
        <value><span data-ttu-id="f3b05-105">キューの名前です。</span><span class="sxs-lookup"><span data-stu-id="f3b05-105">The queue's name.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Uri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f3b05-106">キューの URI を取得します。</span><span class="sxs-lookup"><span data-stu-id="f3b05-106">Gets the queue's URI.</span></span>
            </summary>
        <value><span data-ttu-id="f3b05-107">キューの絶対 URI です。</span><span class="sxs-lookup"><span data-stu-id="f3b05-107">The absolute URI to the queue.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
