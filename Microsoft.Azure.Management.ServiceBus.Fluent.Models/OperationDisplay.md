<Type Name="OperationDisplay" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Models.OperationDisplay">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3159b-101">操作を表すオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="3159b-101">The object that represents the operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3159b-102">OperationDisplay クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="3159b-102">Initializes a new instance of the OperationDisplay class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provider"><span data-ttu-id="3159b-103">サービス プロバイダー: Microsoft.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="3159b-103">Service provider: Microsoft.ServiceBus</span></span></param>
        <param name="resource"><span data-ttu-id="3159b-104">操作が実行されるリソース: 請求書などです。</span><span class="sxs-lookup"><span data-stu-id="3159b-104">Resource on which the operation is performed: Invoice, etc.</span></span></param>
        <param name="operation"><span data-ttu-id="3159b-105">操作の種類: 読み取り、書き込み、削除などです。</span><span class="sxs-lookup"><span data-stu-id="3159b-105">Operation type: Read, write, delete, etc.</span></span></param>
        <summary>
            <span data-ttu-id="3159b-106">OperationDisplay クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="3159b-106">Initializes a new instance of the OperationDisplay class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Operation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3159b-107">操作の種類を取得します。 読み取り、書き込み、削除などです。</span><span class="sxs-lookup"><span data-stu-id="3159b-107">Gets operation type: Read, write, delete, etc.</span></span>
            </summary>
    ...
    <Member MemberName="Provider">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3159b-108">サービス プロバイダーの取得: Microsoft.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="3159b-108">Gets service provider: Microsoft.ServiceBus</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Resource">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3159b-109">操作が実行されるリソースを取得: 請求書などです。</span><span class="sxs-lookup"><span data-stu-id="3159b-109">Gets resource on which the operation is performed: Invoice, etc.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
