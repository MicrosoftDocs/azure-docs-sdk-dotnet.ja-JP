<Type Name="IWithSrvRecordEntryOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Definition.IWithSrvRecordEntryOrAttachable&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="88e3f-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="88e3f-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="88e3f-102">SRV レコードのステージでは、定義を許可する追加の SRV レコードを追加またはレコードを親にセットのアタッチを設定します。</span><span class="sxs-lookup"><span data-stu-id="88e3f-102">The stage of the SRV record set definition allowing to add additional SRV records or attach the record set to the parent.</span></span>
            </summary>
