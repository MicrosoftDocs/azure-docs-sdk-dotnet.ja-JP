<Type Name="IWithAaaaRecordIPv6Address&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Definition.IWithAaaaRecordIPv6Address&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="a8148-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="a8148-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="a8148-102">AAAA レコードのステージでは、定義を最初の AAAA レコードを追加する許可を設定します。</span><span class="sxs-lookup"><span data-stu-id="a8148-102">The stage of the AAAA record set definition allowing to add first AAAA record.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithIPv6Address">
      ...
      <Docs>
        <param name="ipv6Address"><span data-ttu-id="a8148-103">IPv6 アドレス。</span><span class="sxs-lookup"><span data-stu-id="a8148-103">An IPv6 address.</span></span></param>
        <summary>
            <span data-ttu-id="a8148-104">このレコード セット内の指定された IPv6 アドレスを持つ AAAA レコードを作成します。</span><span class="sxs-lookup"><span data-stu-id="a8148-104">Creates an AAAA record with the provided IPv6 address in this record set.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="a8148-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="a8148-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>