<Type Name="FileRequestOptions" FullName="Microsoft.WindowsAzure.Storage.File.FileRequestOptions">
  ...
  <Docs>
    <summary>
            ファイル サービスに対する要求で指定できるタイムアウトと再試行のポリシーのオプションのセットを表します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.File.FileRequestOptions" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DisableContentMD5Validation">
      ...
      <Docs>
        <summary>
            取得またはファイルをダウンロードするときに、MD5 検証を無効にすることを示す値を設定します。
            </summary>
        <value>True を使用して、MD5 検証を無効にするにはMD5 検証を有効にする場合は false。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ParallelOperationThreadCount">
      ...
      <Docs>
        <summary>
            取得またはファイルのアップロード時に同時にアップロードできる範囲の数を設定します。
            </summary>
        <value>実行できる並列操作の数。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ServerTimeout">
      ...
      <Docs>
        ...
        <value>要求に対するサーバー タイムアウト間隔。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="StoreFileContentMD5">
      ...
      <Docs>
        <summary>
            取得または MD5 ハッシュが計算およびファイルのアップロード時に格納されていることを示す値を設定します。
            </summary>
        <value>True を使用して計算して; ファイルのアップロード時に MD5 ハッシュを保存するにはそれ以外の場合は false です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UseTransactionalMD5">
      ...
      <Docs>
        ...
        <value>使用して<c>true</c>を計算し、トランザクションの content MD5 の送信/検証するそれ以外の場合、 <c>false</c>です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
