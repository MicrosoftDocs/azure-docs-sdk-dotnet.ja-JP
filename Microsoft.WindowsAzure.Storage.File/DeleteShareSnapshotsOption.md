<Type Name="DeleteShareSnapshotsOption" FullName="Microsoft.WindowsAzure.Storage.File.DeleteShareSnapshotsOption">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="abe81-101">一連のオプションを説明するのでは、操作を削除します。</span><span class="sxs-lookup"><span data-stu-id="abe81-101">The set of options describing delete operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="IncludeSnapshots">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abe81-102">共有とそのスナップショットを削除します。</span><span class="sxs-lookup"><span data-stu-id="abe81-102">Delete the share and its snapshots.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abe81-103">共有をのみを削除します。</span><span class="sxs-lookup"><span data-stu-id="abe81-103">Delete the share only.</span></span> <span data-ttu-id="abe81-104">スナップショット共有の場合は、このオプションが、サービスからのエラーで発生します。</span><span class="sxs-lookup"><span data-stu-id="abe81-104">If the share has snapshots, this option will result in an error from the service.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
