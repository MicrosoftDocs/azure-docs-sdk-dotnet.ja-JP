<Type Name="SharedAccessFilePolicies" FullName="Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicies">
  ...
  <Docs>
    <summary>
            共有に対して定義されている共有アクセス ポリシーのコレクションを表します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Add">
      ...
      <Docs>
        <param name="item"><see cref="T:System.Collections.Generic.KeyValuePair`2" />キーを含むオブジェクト/<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />共有アクセス ポリシーのコレクションに追加する、ペアの値します。</param>
        <summary>
            指定したキーを追加/<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />に格納された値、 <see cref="T:System.Collections.Generic.KeyValuePair`2" />、共有アクセス ポリシーのコレクションにします。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Add">
      ...
      <Docs>
        <param name="key">キー、<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />を追加する値。</param>
        <param name="value"><see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />値のコレクションに追加する共有アクセス ポリシー。</param>
        <summary>
            指定したキーを追加し、<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />共有アクセス ポリシーのコレクションに値。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Clear">
      ...
      <Docs>
        <summary>
            すべてのキーを削除し、<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />共有アクセスのコレクションからの値。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Contains">
      ...
      <Docs>
        <param name="item">A<see cref="T:System.Collections.Generic.KeyValuePair`2" />キーを含むオブジェクトと<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />検索する値。</param>
        <summary>
            共有アクセス ポリシーのコレクションにキーが含まれるかどうかを判断し、 <see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" /> 、指定した値<see cref="T:System.Collections.Generic.KeyValuePair`2" />オブジェクト。
            </summary>
        <returns>
    ...
    <Member MemberName="CopyTo">
      ...
      <Docs>
        <param name="array">1 次元配列<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />共有アクセス ポリシーのコレクションからコピーされた要素の接続先として機能するオブジェクト。</param>
        <param name="arrayIndex">コピーの開始位置とする <paramref name="array" /> のインデックス (0 から始まる)。</param>
        <summary>
            キー内の各キーのコピー/<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />値のペア互換性のある 1 次元配列を対象となる配列の指定したインデックスから始まります。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            キーの数を取得/<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />共有アクセス ポリシーのコレクションに含まれるペアの値します。
            </summary>
        <value>キーの数/<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />共有アクセス ポリシーのコレクションに含まれるペアの値します。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="key">キーを含む文字列、<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />値を取得または設定します。</param>
        <summary>
            取得または設定、<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />指定されたキーに関連付けられている項目。
            </summary>
        <value><see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" /> 、指定したキーに関連付けられた項目または<c>null</c>キーが共有アクセス ポリシーのコレクションにない場合。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Remove">
      ...
      <Docs>
        <param name="item"><see cref="T:System.Collections.Generic.KeyValuePair`2" />キーを含むオブジェクトと<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />値、共有アクセス ポリシーのコレクションから削除します。</param>
        <summary>
            削除、<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />で指定された値、<see cref="T:System.Collections.Generic.KeyValuePair`2" />共有アクセス ポリシーのコレクションからのオブジェクト。
            </summary>
        <returns>
    ...
    <Member MemberName="Remove">
      ...
      <Docs>
        <param name="key">キーを含む文字列、<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />削除する項目。</param>
        <summary>
    ...
    <Member MemberName="TryGetValue">
      ...
      <Docs>
        ...
        <param name="value"><see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />を取得する項目。</param>
        <summary>
            取得、<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />指定されたキーに関連付けられている項目。 
            </summary>
        <returns><see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />項目; に関連付けられた、指定したキー、キーが見つかった場合、既定値をそれ以外の場合、<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />型です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Values">
      ...
      <Docs>
        ...
        <value>コレクション<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFilePolicy" />共有アクセス ポリシーのコレクション内の項目。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
