<Type Name="SharedAccessFileHeaders" FullName="Microsoft.WindowsAzure.Storage.File.SharedAccessFileHeaders">
  ...
  <Docs>
    <summary>
            SAS を使用してアクセスされたファイルを返すことができる省略可能なヘッダーを表します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFileHeaders" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="sharedAccessFileHeaders">一連の<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFileHeaders" />を複製します。</param>
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.WindowsAzure.Storage.File.SharedAccessFileHeaders" />クラスは、既存のインスタンスに基づいています。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CacheControl">
      ...
      <Docs>
        <summary>
            取得またはファイルに返される cache-control ヘッダーを設定します。
            </summary>
    ...
    <Member MemberName="ContentDisposition">
      ...
      <Docs>
        <summary>
            取得またはファイルに返される content-disposition ヘッダーを設定します。
            </summary>
    ...
    <Member MemberName="ContentEncoding">
      ...
      <Docs>
        <summary>
            取得またはファイルに返される content-encoding ヘッダーを設定します。
            </summary>
    ...
    <Member MemberName="ContentLanguage">
      ...
      <Docs>
        <summary>
            取得またはファイルに返される content-language ヘッダーを設定します。
            </summary>
    ...
    <Member MemberName="ContentType">
      ...
      <Docs>
        <summary>
            取得またはファイルに返される content-type ヘッダーを設定します。
            </summary>
