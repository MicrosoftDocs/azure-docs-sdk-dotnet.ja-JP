<Type Name="PolicySetDefinitionsOperationsExtensions" FullName="Microsoft.Azure.Management.ResourceManager.PolicySetDefinitionsOperationsExtensions">
  ...
  <Docs>
    <summary>
            PolicySetDefinitionsOperations の拡張メソッド。
            </summary>
  ...
  <Members>
    <Member MemberName="CreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="policySetDefinitionName">
            ポリシーの名前は、作成する定義を設定します。
            </param>
        <param name="parameters">
            ポリシーは、定義のプロパティを設定します。
            </param>
        <summary>
            作成するか、ポリシーのセットの定義を更新します。
            </summary>
    ...
    <Member MemberName="List">
      ...
      <Docs>
        ...
        <summary>
            すべてのポリシー セットのサブスクリプションの定義を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
