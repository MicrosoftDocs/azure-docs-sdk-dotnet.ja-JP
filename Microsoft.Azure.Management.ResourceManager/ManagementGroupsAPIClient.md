<Type Name="ManagementGroupsAPIClient" FullName="Microsoft.Azure.Management.ResourceManager.ManagementGroupsAPIClient">
  ...
  <Docs>
    <summary>
             Azure の管理グループの API は組織階層に複数のサブスクリプション/リソースの統合を有効にし、それらのリソースのアラートおよびレポートに、アクセス制御ポリシーを一元的に管理します。
  ...
  <Members>
    ...
    <Member MemberName="ApiVersion">
      ...
      <Docs>
        <summary>
            クライアント要求で使用する API のバージョンです。 現在のバージョンは、2017 年 1-08-31-プレビューです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
