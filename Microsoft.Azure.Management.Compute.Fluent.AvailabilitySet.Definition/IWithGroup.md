<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Compute.Fluent.AvailabilitySet.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0bbf8-101">可用性のステージでは、リソース グループを指定できるように定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="0bbf8-101">The stage of the availability set definition allowing to specify the resource group.</span></span>
            </summary>
