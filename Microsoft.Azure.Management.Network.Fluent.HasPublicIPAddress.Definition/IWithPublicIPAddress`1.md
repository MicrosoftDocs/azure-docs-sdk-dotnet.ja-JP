<Type Name="IWithPublicIPAddress&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasPublicIPAddress.Definition.IWithPublicIPAddress&lt;ReturnT&gt;">
  ...
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="87d5e-101">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="87d5e-101">The next stage of the definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="87d5e-102">関連付けるパブリック IP アドレス リソースを許可する、定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="87d5e-102">The stage of the definition allowing to associate the resource with a public IP address.</span></span>
            </summary>
