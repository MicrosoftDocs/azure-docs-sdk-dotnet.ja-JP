<Type Name="AclStatus" FullName="Microsoft.Azure.DataLake.Store.Acl.AclStatus">
  ...
  <Docs>
    <summary>
            ID、8 進数のアクセス許可、および sticky ビット (ディレクトリ) の場合のみ、所有者 ID の Acl エントリをカプセル化するクラスをグループ化します。
            </summary>
