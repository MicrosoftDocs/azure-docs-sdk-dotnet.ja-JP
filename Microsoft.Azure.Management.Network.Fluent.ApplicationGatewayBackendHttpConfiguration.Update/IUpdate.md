<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayBackendHttpConfiguration.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="561a1-101">アプリケーション ゲートウェイ バックエンド HTTP 設定の更新プログラム、アプリケーション ゲートウェイの更新プログラムの一部としての全体です。</span><span class="sxs-lookup"><span data-stu-id="561a1-101">The entirety of an application gateway backend HTTP configuration update as part of an application gateway update.</span></span>
            </summary>
