<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Compute.Fluent.Disk.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4943a-101">リソース グループを指定できるように、管理対象ディスク定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="4943a-101">The stage of a managed disk definition allowing to specify the resource group.</span></span>
            </summary>
