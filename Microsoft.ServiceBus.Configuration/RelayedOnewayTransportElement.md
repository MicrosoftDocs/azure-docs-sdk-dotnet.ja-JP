<Type Name="RelayedOnewayTransportElement" FullName="Microsoft.ServiceBus.Configuration.RelayedOnewayTransportElement">
  ...
  <Interfaces />
  <Docs>
    <summary>構成要素を表します、カスタム バインドに含めた場合、Azure Service Bus を通じて一方向のメッセージを転送するチャネルを指定します。 このクラスは継承できません。</summary>
  ...
  <Members>
    ...
    <Member MemberName="ApplyConfiguration">
      ...
      <Docs>
        ...
        <summary>この構成要素から指定されたバインド要素の設定を適用します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BindingElementType">
      ...
      <Docs>
        ...
        <value>返します、<see cref="T:System.Type" />型には、現在のインスタンスの型を格納しているの<see cref="T:Microsoft.ServiceBus.RelayedOnewayTransportBindingElement" />します。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionMode">
      ...
      <Docs>
        <summary>取得または一方向の接続モードを記述する XML 値を設定します。</summary>
        <value>返します、<see cref="T:Microsoft.ServiceBus.RelayedOnewayConnectionMode" />接続モードを格納しています。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="CopyFrom">
      ...
      <Docs>
        <param name="from"> コピー元となる構成要素。</param>
        <summary>現在のインスタンスに指定された構成要素から設定をコピーします。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ListenBacklog">
      ...
      <Docs>
        ...
        <value>保留可能なキュー内の接続要求の最大数です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="RelayClientAuthenticationType">
      ...
      <Docs>
        <summary>取得または、この構成要素で指定された認証の種類を記述する XML 値を設定します。</summary>
        <value>返します、<see cref="T:Microsoft.ServiceBus.RelayClientAuthenticationType" />に現在のインスタンスを適用するバインド要素によって使用される認証の種類を格納しています。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
