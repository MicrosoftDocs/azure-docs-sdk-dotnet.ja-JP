<Type Name="WebHttpRelaySecurityElement" FullName="Microsoft.ServiceBus.Configuration.WebHttpRelaySecurityElement">
  ...
  <Interfaces />
  <Docs>
    <summary>Azure Service Bus リレーを通じた Web HTTP サービスのセキュリティを構成する構成要素を表します。</summary>
  ...
  <Members>
    ...
    <Member MemberName="Mode">
      ...
      <Docs>
        <summary>取得または、バインディングによって使用されるセキュリティ モードを設定します。</summary>
        <value>返します、<see cref="T:Microsoft.ServiceBus.EndToEndWebHttpSecurityMode" />サービス エンドポイントで使用されるエンド ツー エンド HTTP セキュリティ モードを格納しています。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Transport">
      ...
      <Docs>
        <summary>HTTP 要求を受信するように構成するサービス エンドポイントのトランスポート レベルのセキュリティ設定を示す構成要素を取得します。</summary>
        <value>返します、<see cref="T:Microsoft.ServiceBus.Configuration.HttpRelayTransportSecurityElement" />セキュリティ設定を格納しています。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
