<Type Name="TcpRelayTransportSecurityElement" FullName="Microsoft.ServiceBus.Configuration.TcpRelayTransportSecurityElement">
  ...
  <Interfaces />
  <Docs>
    <summary>Azure Service Bus リレーを通じた TCP トランスポートのサービスのセキュリティを構成する構成要素を表します。</summary>
  ...
  <Members>
    ...
    <Member MemberName="ProtectionLevel">
      ...
      <Docs>
        <summary>取得または TCP リレーのトランスポート セキュリティ レベルを含む XML 値を設定します。</summary>
        <value>返します、<see cref="T:System.Net.Security.ProtectionLevel" />トランスポートのセキュリティ レベルを格納しています。 既定値は EncryptAndSign です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
