<Type Name="ApplicationGatewaySslPolicy" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewaySslPolicy">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="disabledSslProtocols">Ssl プロトコルを使用して、アプリケーション ゲートウェイでは無効にします。</param>
        <param name="policyType">Ssl ポリシーの種類。 使用可能な値が含まれます: '定義済み'、'Custom'</param>
        <param name="policyName">Ssl の名前には、ポリシーが定義されています。 使用可能な値が含まれます: 'AppGwSslPolicy20150501'、'AppGwSslPolicy20170401'、'AppGwSslPolicy20170401S'</param>
        <param name="cipherSuites">アプリケーション ゲートウェイを指定した順序で有効にする Ssl 暗号スイート。</param>
    ...
    <Member MemberName="CipherSuites">
      ...
      <Docs>
        <summary>
            取得またはアプリケーション ゲートウェイを指定した順序で有効にする ssl 暗号スイートを設定します。
            </summary>
    ...
    <Member MemberName="DisabledSslProtocols">
      ...
      <Docs>
        <summary>
            取得または設定 ssl プロトコルを使用してアプリケーション ゲートウェイでは無効にします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PolicyName">
      ...
      <Docs>
        <summary>
            取得または定義済みの Ssl ポリシーの名前を設定します。 使用可能な値が含まれます: 'AppGwSslPolicy20150501'、'AppGwSslPolicy20170401'、'AppGwSslPolicy20170401S'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PolicyType">
      ...
      <Docs>
        <summary>
            取得または Ssl ポリシーの種類を設定します。 使用可能な値が含まれます: '定義済み'、'Custom'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
