<Type Name="ExpressRouteCircuitArpTable" FullName="Microsoft.Azure.Management.Network.Models.ExpressRouteCircuitArpTable">
  ...
  <Docs>
    <summary>
            ARP テーブル、ExpressRouteCircuit に関連付けられています。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ExpressRouteCircuitArpTable クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="interfaceProperty">インターフェイス</param>
        <param name="ipAddress">IP アドレス。</param>
        <param name="macAddress">MAC アドレスです。</param>
        <summary>
            ExpressRouteCircuitArpTable クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
