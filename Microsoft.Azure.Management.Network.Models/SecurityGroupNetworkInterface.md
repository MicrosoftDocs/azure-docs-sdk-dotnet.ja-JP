<Type Name="SecurityGroupNetworkInterface" FullName="Microsoft.Azure.Management.Network.Models.SecurityGroupNetworkInterface">
  ...
  <Docs>
    <summary>
            ネットワーク インターフェイスと関連付けられているセキュリティの規則をすべてです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SecurityGroupNetworkInterface クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">ネットワーク インターフェイスの ID です。</param>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            取得またはネットワーク インターフェイスの ID を設定します。
            </summary>
