<Type Name="OperationDisplay" FullName="Microsoft.Azure.Management.Network.Models.OperationDisplay">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provider">サービス プロバイダー。 Microsoft ネットワークです。</param>
        <param name="resource">操作を実行するリソースです。</param>
        <param name="operation">操作の種類: 読み取り、取得、削除などです。</param>
    ...
    <Member MemberName="Provider">
      ...
      <Docs>
        <summary>
            サービス プロバイダー取得または設定します。 Microsoft ネットワークです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
