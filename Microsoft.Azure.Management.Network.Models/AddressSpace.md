<Type Name="AddressSpace" FullName="Microsoft.Azure.Management.Network.Models.AddressSpace">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AddressSpace クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="addressPrefixes">CIDR 表記法でこの仮想ネットワーク用に予約されたアドレス ブロックの一覧。</param>
        <summary>
            AddressSpace クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AddressPrefixes">
      ...
      <Docs>
        <summary>
            取得または CIDR 表記法でこの仮想ネットワーク用に予約されたアドレス ブロックの一覧を設定します。
            </summary>
