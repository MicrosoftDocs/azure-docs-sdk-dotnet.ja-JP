<Type Name="ConnectivitySource" FullName="Microsoft.Azure.Management.Network.Models.ConnectivitySource">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ConnectivitySource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resourceId">接続の確認を開始する元となるリソースの ID。</param>
        <param name="port">接続の確認の実行元の発信元ポートです。</param>
        <summary>
            ConnectivitySource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ResourceId">
      ...
      <Docs>
        <summary>
            取得または接続の確認を開始する元となるリソースの ID を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
