<Type Name="Availability" FullName="Microsoft.Azure.Management.Network.Models.Availability">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="timeGrain">可用性の時間グレインです。</param>
        <param name="retention">可用性の保有期間。</param>
        <param name="blobDuration">可用性の blob の期間です。</param>
        <summary>
            可用性クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
