<Type Name="VirtualNetworkGatewayConnectionListEntity" FullName="Microsoft.Azure.Management.Network.Models.VirtualNetworkGatewayConnectionListEntity">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualNetworkGatewayConnectionListEntity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="virtualNetworkGateway1">仮想ネットワーク ゲートウェイ リソースへの参照。</param>
        <param name="connectionType">ゲートウェイ接続の種類です。 使用可能な値が: 'Ipsec'、'Vnet2Vnet'、'ExpressRoute' および ' がない場合。
            使用可能な値が含まれます 'IPsec'、'Vnet2Vnet'、'ExpressRoute'、'がない場合'。</param>
        <param name="id">リソースの ID</param>
        <param name="name">リソース名。</param>
        <param name="type">リソースの種類。</param>
        <param name="location">リソースの場所。</param>
        <param name="tags">リソース タグ。</param>
        <param name="authorizationKey">AuthorizationKey です。</param>
        <param name="virtualNetworkGateway2">仮想ネットワーク ゲートウェイ リソースへの参照。</param>
        <param name="localNetworkGateway2">ローカル ネットワーク ゲートウェイ リソースへの参照。</param>
        <param name="routingWeight">ルーティングの太さ。</param>
        <param name="sharedKey">IPSec の共有キー。</param>
        <param name="connectionStatus">仮想ネットワーク ゲートウェイ接続の状態。 使用可能な値は 'Unknown'、'接続'、'接続' および 'NotConnected' です。 使用可能な値が含まれます: 'Unknown'、'接続'、'接続'、'NotConnected'</param>
        <param name="tunnelConnectionStatus">すべてのトンネルの接続のヘルス状態のコレクションです。</param>
        <param name="egressBytesTransferred">送信バイト数は、この接続で転送されます。</param>
        <param name="ingressBytesTransferred">受信バイト数は、この接続で転送されます。</param>
        <param name="peer">ピアリング リソースへの参照。</param>
        <param name="enableBgp">EnableBgp フラグ</param>
        <param name="usePolicyBasedTrafficSelectors">ポリシー ベースのトラフィックのセレクターを有効にします。</param>
        <param name="ipsecPolicies">この接続で考慮する IPSec ポリシーです。</param>
        <param name="resourceGuid">リソースの VirtualNetworkGatewayConnection リソース GUID プロパティです。</param>
        <param name="provisioningState">VirtualNetworkGatewayConnection リソースのプロビジョニングの状態。 使用可能な値が: '更新'、'削除' および '失敗' です。</param>
    ...
    <Member MemberName="ConnectionStatus">
      ...
      <Docs>
        <summary>
            仮想ネットワーク ゲートウェイ接続の状態を取得します。 使用可能な値は 'Unknown'、'接続'、'接続' および 'NotConnected' です。 使用可能な値が含まれます: 'Unknown'、'接続'、'接続'、'NotConnected'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ConnectionType">
      ...
      <Docs>
        <summary>
            取得またはゲートウェイ接続の種類を設定します。 使用可能な値が: 'Ipsec'、'Vnet2Vnet'、'ExpressRoute' および ' がない場合。 使用可能な値が含まれます 'IPsec'、'Vnet2Vnet'、'ExpressRoute'、'がない場合'。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IpsecPolicies">
      ...
      <Docs>
        <summary>
            取得またはこの接続で考慮する IPSec ポリシーを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LocalNetworkGateway2">
      ...
      <Docs>
        <summary>
            取得またはローカル ネットワーク ゲートウェイ リソースへの参照を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            VirtualNetworkGatewayConnection リソースのプロビジョニングの状態を取得します。 使用可能な値が: '更新'、'削除' および '失敗' です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceGuid">
      ...
      <Docs>
        <summary>
            取得またはリソース VirtualNetworkGatewayConnection リソースの GUID プロパティを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TunnelConnectionStatus">
      ...
      <Docs>
        <summary>
            すべてのトンネルの接続のヘルス状態のコレクションを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UsePolicyBasedTrafficSelectors">
      ...
      <Docs>
        <summary>
            取得または設定には、ポリシー ベースのトラフィックのセレクターが有効にします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualNetworkGateway1">
      ...
      <Docs>
        <summary>
            取得または仮想ネットワーク ゲートウェイ リソースへの参照を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
