<Type Name="VirtualNetworkUsage" FullName="Microsoft.Azure.Management.Network.Models.VirtualNetworkUsage">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualNetworkUsage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="currentValue">サブネットから使用される Ip の数を示します。</param>
        <param name="id">サブネットの識別子です。</param>
        <param name="limit">サブネットのサイズを示します。</param>
        <param name="name">使用状況の一般的なとローカライズされた値を表す名前です。</param>
        <param name="unit">使用状況の単位です。 'Count' を返します。</param>
        <summary>
            VirtualNetworkUsage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            使用状況の一般的なとローカライズされた値を表す名前を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
