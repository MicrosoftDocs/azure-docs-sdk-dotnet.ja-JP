<Type Name="ApplicationGatewaySku" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewaySku">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">アプリケーション ゲートウェイ SKU の名前。 使用可能な値が含まれます: 'Standard_Small'、'Standard_Medium'、'Standard_Large'、'WAF_Medium'、'WAF_Large'</param>
        <param name="tier">Application gateway の階層。 使用可能な値が含まれます: 'Standard'、'WAF'</param>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得またはアプリケーション ゲートウェイ SKU の名前を設定します。 使用可能な値が含まれます: 'Standard_Small'、'Standard_Medium'、'Standard_Large'、'WAF_Medium'、'WAF_Large'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            取得またはアプリケーション ゲートウェイの層を設定します。 使用可能な値が含まれます: 'Standard'、'WAF'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
