<Type Name="AvailableProvidersList" FullName="Microsoft.Azure.Management.Network.Models.AvailableProvidersList">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3b867-101">詳細と使用可能な国の一覧です。</span><span class="sxs-lookup"><span data-stu-id="3b867-101">List of available countries with details.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3b867-102">AvailableProvidersList クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="3b867-102">Initializes a new instance of the AvailableProvidersList class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="countries"><span data-ttu-id="3b867-103">利用可能な国の一覧です。</span><span class="sxs-lookup"><span data-stu-id="3b867-103">List of available countries.</span></span></param>
        <summary>
            <span data-ttu-id="3b867-104">AvailableProvidersList クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="3b867-104">Initializes a new instance of the AvailableProvidersList class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Countries">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3b867-105">取得または使用可能な国の一覧を設定します。</span><span class="sxs-lookup"><span data-stu-id="3b867-105">Gets or sets list of available countries.</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3b867-106">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="3b867-106">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="3b867-107">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="3b867-107">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
