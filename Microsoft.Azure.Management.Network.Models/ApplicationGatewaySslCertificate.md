<Type Name="ApplicationGatewaySslCertificate" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewaySslCertificate">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ApplicationGatewaySslCertificate クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="data">Base 64 でエンコードされた pfx の証明書です。 PUT 要求にのみ適用されます。</param>
        <param name="password">データで指定された pfx ファイルのパスワードです。
            PUT 要求でのみ適用されます。</param>
        <param name="publicCertData">Base 64 エンコードのデータで指定された pfx に対応するパブリック証明書データです。 GET 要求にのみ適用されます。</param>
        <param name="provisioningState">指定できる値は、SSL 証明書のリソースのプロビジョニング状態: '更新'、'削除' および '失敗' です。</param>
    ...
    <Member MemberName="Data">
      ...
      <Docs>
        <summary>
            取得または base 64 でエンコードされた pfx の証明書を設定します。 PUT 要求にのみ適用されます。
            </summary>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            取得またはデータに指定された pfx ファイルのパスワードを設定します。 PUT 要求でのみ適用されます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            SSL のプロビジョニング状態を取得または設定可能な値はリソースの証明書: '更新'、'削除' および '失敗' です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicCertData">
      ...
      <Docs>
        <summary>
            取得またはデータに指定された pfx に対応するデータを base 64 でエンコードされたパブリック証明書を設定します。 GET 要求にのみ適用されます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
