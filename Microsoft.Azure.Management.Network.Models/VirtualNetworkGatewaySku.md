<Type Name="VirtualNetworkGatewaySku" FullName="Microsoft.Azure.Management.Network.Models.VirtualNetworkGatewaySku">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">ゲートウェイ SKU の名前です。 使用可能な値が含まれます: 'Basic'、'HighPerformance'、'Standard'、'UltraPerformance'、'VpnGw1'、'VpnGw2'、'VpnGw3'</param>
        <param name="tier">ゲートウェイ SKU 層です。 使用可能な値が含まれます: 'Basic'、'HighPerformance'、'Standard'、'UltraPerformance'、'VpnGw1'、'VpnGw2'、'VpnGw3'</param>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得またはゲートウェイ SKU の名前を設定します。 使用可能な値が含まれます: 'Basic'、'HighPerformance'、'Standard'、'UltraPerformance'、'VpnGw1'、'VpnGw2'、'VpnGw3'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            取得またはゲートウェイ SKU の層を設定します。 使用可能な値が含まれます: 'Basic'、'HighPerformance'、'Standard'、'UltraPerformance'、'VpnGw1'、'VpnGw2'、'VpnGw3'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
