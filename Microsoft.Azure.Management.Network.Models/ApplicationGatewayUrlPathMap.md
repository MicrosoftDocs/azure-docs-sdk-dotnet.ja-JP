<Type Name="ApplicationGatewayUrlPathMap" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewayUrlPathMap">
  ...
  <Docs>
    <summary>
            UrlPathMaps は、PathBasedRouting のバックエンド マッピング情報を url パスを付けます。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="defaultBackendAddressPool">バックエンド アドレス プールの既定のリソース URL パス マップします。</param>
        <param name="defaultBackendHttpSettings">バックエンド http 設定の既定のリソース URL パス マップします。</param>
        <param name="defaultRedirectConfiguration">既定値 URL パスのマップの構成リソースをリダイレクトします。</param>
        <param name="pathRules">URL パスのマップのリソースのパスの規則。</param>
    ...
    <Member MemberName="DefaultBackendAddressPool">
      ...
      <Docs>
        <summary>
            取得または URL パスのマップの既定のバックエンド アドレス プールのリソースを設定します。
            </summary>
    ...
    <Member MemberName="DefaultBackendHttpSettings">
      ...
      <Docs>
        <summary>
            取得または URL パスのマップの既定のバックエンド http 設定のリソースを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DefaultRedirectConfiguration">
      ...
      <Docs>
        <summary>
            取得または URL パスのマップの既定のリダイレクトの構成リソースを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PathRules">
      ...
      <Docs>
        <summary>
            取得または URL パスのマップのリソースのパスの規則を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
