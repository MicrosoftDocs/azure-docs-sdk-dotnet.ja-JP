<Type Name="ApplicationGatewayBackendHttpSettings" FullName="Microsoft.Azure.Management.Network.Models.ApplicationGatewayBackendHttpSettings">
  ...
  <Docs>
    <summary>
            Application gateway のバックエンド アドレス プールの設定。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="cookieBasedAffinity">クッキー ベースの関係。 使用可能な値が含まれます: 'Enabled'、'Disabled'</param>
        <param name="requestTimeout">要求のタイムアウト (秒)。
            RequestTimeout 内で応答が受信されない場合、アプリケーション ゲートウェイでは、要求は失敗します。 使用可能な値は、1 秒 ~ 86400 秒です。</param>
        <param name="probe">アプリケーション ゲートウェイのリソースをプローブします。</param>
        <param name="authenticationCertificates">アプリケーション ゲートウェイの認証証明書への参照の配列。</param>
        <param name="connectionDraining">バックエンド http 設定リソースの接続がドレインします。</param>
        <param name="hostName">バックエンド サーバーに送信されるホスト ヘッダーです。</param>
        <param name="pickHostNameFromBackendAddress">ホスト ヘッダーを選択するかどうかは、バックエンド サーバーのホスト名から選択する必要があります。
            既定値は false です。</param>
        <param name="affinityCookieName">Affinity cookie を使用する cookie の名前。</param>
        <param name="probeEnabled">プローブが有効になっているかどうか。 既定値は false です。</param>
        <param name="path">すべての HTTP 要求のプレフィックスとして使用するパス。 Null では、パスはプレフィックスなしを意味します。 既定値は null です。</param>
    ...
    <Member MemberName="AffinityCookieName">
      ...
      <Docs>
        <summary>
            取得または affinity cookie を使用する cookie の名前を設定します。
            </summary>
    ...
    <Member MemberName="AuthenticationCertificates">
      ...
      <Docs>
        <summary>
            取得またはアプリケーション ゲートウェイの認証証明書への参照の配列を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ConnectionDraining">
      ...
      <Docs>
        <summary>
            取得またはバックエンド http 設定リソースの接続のドレインを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CookieBasedAffinity">
      ...
      <Docs>
        <summary>
            取得またはクッキー ベースのアフィニティを設定します。 使用可能な値が含まれます: 'Enabled'、'Disabled'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HostName">
      ...
      <Docs>
        <summary>
            取得またはバックエンド サーバーに送信されるホスト ヘッダーを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
            取得またはすべての HTTP 要求のプレフィックスとして使用するパスを設定します。 Null では、パスはプレフィックスなしを意味します。 既定値は null です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PickHostNameFromBackendAddress">
      ...
      <Docs>
        <summary>
            取得またはホストを選択する、バックエンド サーバーのホスト名からヘッダーを選択する必要があるかどうかを設定します。 既定値は false です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Probe">
      ...
      <Docs>
        <summary>
            取得またはアプリケーション ゲートウェイのプローブのリソースを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProbeEnabled">
      ...
      <Docs>
        <summary>
            取得またはプローブが有効になっているかどうかを設定します。 既定値は false です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestTimeout">
      ...
      <Docs>
        <summary>
            取得または要求のタイムアウトを秒単位で設定します。 RequestTimeout 内で応答が受信されない場合、アプリケーション ゲートウェイでは、要求は失敗します。
