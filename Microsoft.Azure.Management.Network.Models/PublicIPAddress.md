  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="sku">パブリック IP アドレスの SKU でします。</param>
        <param name="publicIPAllocationMethod">パブリック IP の割り当て方法です。 使用可能な値が: 'Static' と 'Dynamic' です。 使用可能な値が含まれます: 'Static'、'Dynamic'</param>
        <param name="publicIPAddressVersion">パブリック IP アドレスのバージョン。
            使用可能な値が: 'IPv4' および 'IPv6' です。 使用可能な値が含まれます: 'IPv4'、'IPv6'</param>
        <param name="ipConfiguration">パブリック IP アドレスに関連付けられている IP 構成します。</param>
        <param name="dnsSettings">パブリック IP アドレスに関連付けられている DNS レコードの FQDN。</param>
        <param name="ipAddress">パブリック IP アドレス リソースに関連付けられている IP アドレス。</param>
        <param name="idleTimeoutInMinutes">パブリック IP アドレスのアイドル タイムアウト。</param>
        <param name="resourceGuid">パブリック IP リソースの GUID プロパティのリソース。</param>
    ...
    <Member MemberName="DnsSettings">
      ...
      <Docs>
        <summary>
            取得またはパブリック IP アドレスに関連付けられている DNS レコードの FQDN を設定します。
            </summary>
    ...
    <Member MemberName="IpAddress">
      ...
      <Docs>
        <summary>
            取得またはパブリック IP アドレス リソースに関連付けられている IP アドレスを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IpConfiguration">
      ...
      <Docs>
        <summary>
            パブリック IP アドレスに関連付けられている IP の構成を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAddressVersion">
      ...
      <Docs>
        <summary>
            取得またはパブリック IP アドレスのバージョンを設定します。 使用可能な値が: 'IPv4' および 'IPv6' です。 使用可能な値が含まれます: 'IPv4'、'IPv6'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAllocationMethod">
      ...
      <Docs>
        <summary>
            取得またはパブリック IP の割り当て方法を設定します。 使用可能な値が: 'Static' と 'Dynamic' です。 使用可能な値が含まれます: 'Static'、'Dynamic'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceGuid">
      ...
      <Docs>
        <summary>
            取得またはリソースのパブリック IP リソースの GUID プロパティを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            取得または SKU のパブリック IP アドレスを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
