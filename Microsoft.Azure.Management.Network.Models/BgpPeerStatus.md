<Type Name="BgpPeerStatus" FullName="Microsoft.Azure.Management.Network.Models.BgpPeerStatus">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            BgpPeerStatus クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="localAddress">仮想ネットワーク ゲートウェイのローカル アドレス</param>
        <param name="neighbor">リモートの BGP ピア</param>
        <param name="asn">リモートの BGP ピアの自律システム番号</param>
        <param name="state">BGP ピアの状態。 使用可能な値が含まれます: 'Unknown'、'停止'、'アイドル'、'接続'、'接続'</param>
        <param name="connectedDuration">どのくらいの期間のピアリングされてが稼動してください。</param>
        <param name="routesReceived">このピアから学習したルートの数</param>
        <param name="messagesSent">BGP のメッセージ送信の数</param>
        <param name="messagesReceived">受信 BGP メッセージの数</param>
        <summary>
            BgpPeerStatus クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="LocalAddress">
      ...
      <Docs>
        <summary>
            仮想ネットワーク ゲートウェイのローカル アドレスを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            BGP ピアの状態を取得します。 使用可能な値が含まれます: 'Unknown'、'停止'、'アイドル'、'接続'、'接続'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
