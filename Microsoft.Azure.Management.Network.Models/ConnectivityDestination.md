<Type Name="ConnectivityDestination" FullName="Microsoft.Azure.Management.Network.Models.ConnectivityDestination">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ConnectivityDestination クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resourceId">接続試行の行われたリソースの ID。</param>
        <param name="address">IP アドレスまたは URI の接続が試行されたリソースが行われます。</param>
        <param name="port">接続の実行をチェックでポートです。</param>
        <summary>
            ConnectivityDestination クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Address">
      ...
      <Docs>
        <summary>
            取得または接続試行の行われたリソースの IP アドレスまたは URI を設定します。
            </summary>
