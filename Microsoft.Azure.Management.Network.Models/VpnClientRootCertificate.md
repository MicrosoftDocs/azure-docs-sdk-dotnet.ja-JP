<Type Name="VpnClientRootCertificate" FullName="Microsoft.Azure.Management.Network.Models.VpnClientRootCertificate">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VpnClientRootCertificate クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="publicCertData">証明書の公開データです。</param>
        <param name="id">リソースの ID</param>
        <param name="provisioningState">VPN クライアント ルート証明書リソースのプロビジョニングの状態。 使用可能な値が: '更新'、'削除' および '失敗' です。</param>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            VPN クライアント ルート証明書リソースのプロビジョニングの状態を取得します。 使用可能な値が: '更新'、'削除' および '失敗' です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
