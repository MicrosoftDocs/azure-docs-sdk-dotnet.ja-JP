<Type Name="IWithOSSettings" FullName="Microsoft.Azure.Management.Compute.Fluent.Disk.Update.IWithOSSettings">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="31048-101">OS の設定を指定できるように管理対象ディスクの更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="31048-101">The stage of the managed disk update allowing to specify OS settings.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithOSType">
      ...
      <Docs>
        <param name="osType"><span data-ttu-id="31048-102">オペレーティング システムの種類。</span><span class="sxs-lookup"><span data-stu-id="31048-102">Operating system type.</span></span></param>
        <summary>
            <span data-ttu-id="31048-103">オペレーティング システムを指定します。</span><span class="sxs-lookup"><span data-stu-id="31048-103">Specifies the operating system.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="31048-104">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="31048-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>