<Type Name="RemoteManagementSettings" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.RemoteManagementSettings">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RemoteManagementSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="remoteManagementMode">リモート管理モードです。
            使用可能な値が含まれます: 'Unknown'、'無効'、'HttpsEnabled'、'HttpsAndHttpEnabled'</param>
        <param name="remoteManagementCertificate">リモート管理証明書。</param>
        <summary>
            RemoteManagementSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="RemoteManagementMode">
      ...
      <Docs>
        <summary>
            取得またはリモート管理モードを設定します。 使用可能な値が含まれます: 'Unknown'、'無効'、'HttpsEnabled'、'HttpsAndHttpEnabled'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
