<Type Name="NicIPv4" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.NicIPv4">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="ipv4Address">ネットワーク アダプターの IPv4 アドレス。</param>
        <param name="ipv4Netmask">ネットワーク アダプターの IPv4 ネットマスク。</param>
        <param name="ipv4Gateway">ネットワーク アダプターの IPv4 ゲートウェイです。</param>
        <param name="controller0Ipv4Address">Controller0 の IPv4 アドレス。</param>
        <param name="controller1Ipv4Address">Controller1 の IPv4 アドレス。</param>
        <summary>
            NicIPv4 クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Controller0Ipv4Address">
      ...
      <Docs>
        <summary>
            取得または Controller0 の IPv4 アドレスを設定します。
            </summary>
    ...
    <Member MemberName="Controller1Ipv4Address">
      ...
      <Docs>
        <summary>
            取得または Controller1 の IPv4 アドレスを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Ipv4Address">
      ...
      <Docs>
        <summary>
            取得またはネットワーク アダプターの IPv4 アドレスを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Ipv4Gateway">
      ...
      <Docs>
        <summary>
            取得またはネットワーク アダプターの IPv4 ゲートウェイを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Ipv4Netmask">
      ...
      <Docs>
        <summary>
            取得またはネットワーク アダプターの IPv4 ネットマスクを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
