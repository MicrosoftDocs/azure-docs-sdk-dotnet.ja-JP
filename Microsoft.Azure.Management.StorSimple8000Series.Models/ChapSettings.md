<Type Name="ChapSettings" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.ChapSettings">
  ...
  <Docs>
    <summary>
            チャレンジ ハンドシェイク認証プロトコル (CHAP) 設定します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="initiatorUser">CHAP イニシエーター ユーザー。</param>
        <param name="initiatorSecret">CHAP イニシエーターのシークレット。</param>
        <param name="targetUser">CHAP ターゲット ユーザー。</param>
        <param name="targetSecret">ターゲットのシークレット。</param>
        <summary>
            ChapSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="InitiatorSecret">
      ...
      <Docs>
        <summary>
            取得または、CHAP イニシエーターのシークレットを設定します。
            </summary>
