<Type Name="WebproxySettings" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.WebproxySettings">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="authentication">認証の種類。 使用可能な値が含まれます: '無効'、'None'、'Basic'、'NTLM'</param>
        <param name="username">Webproxy ユーザー名。</param>
        <param name="connectionUri">接続 URI です。</param>
        <summary>
            WebproxySettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Authentication">
      ...
      <Docs>
        <summary>
            取得または認証の種類を設定します。 使用可能な値が含まれます: '無効'、'None'、'Basic'、'NTLM'
            </summary>
