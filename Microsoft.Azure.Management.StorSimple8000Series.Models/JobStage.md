<Type Name="JobStage" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.JobStage">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="stageStatus">ステージの状態。 使用可能な値が含まれます: '実行中'、'成功'、'失敗'、'キャンセル'</param>
        <param name="message">ジョブのステージのメッセージ。</param>
        <param name="detail">ステージの詳細。</param>
        <param name="errorCode">存在する場合、ステージのエラー コード。</param>
        <summary>
            JobStage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ErrorCode">
      ...
      <Docs>
        <summary>
            取得または存在する場合、ステージのエラー コードを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StageStatus">
      ...
      <Docs>
        <summary>
            取得またはステージの状態を設定します。 使用可能な値が含まれます: '実行中'、'成功'、'失敗'、'キャンセル'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
