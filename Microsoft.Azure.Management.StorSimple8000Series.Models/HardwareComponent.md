<Type Name="HardwareComponent" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.HardwareComponent">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="componentId">コンポーネントの id。</param>
        <param name="displayName">ハードウェア コンポーネントの表示名。</param>
        <param name="status">ハードウェア コンポーネントのステータス。 使用可能な値が含まれます: 'Unknown'、'NotPresent'、'PoweredOff'、'Ok'、'復旧中'、'警告'、'失敗'</param>
        <param name="statusDisplayName">ハードウェア コンポーネントのステータスの表示名。</param>
        <summary>
            HardwareComponent クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            取得またはハードウェア コンポーネントのステータスを設定します。 使用可能な値が含まれます: 'Unknown'、'NotPresent'、'PoweredOff'、'Ok'、'復旧中'、'警告'、'失敗'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StatusDisplayName">
      ...
      <Docs>
        <summary>
            取得またはハードウェア コンポーネントのステータスの表示名を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
