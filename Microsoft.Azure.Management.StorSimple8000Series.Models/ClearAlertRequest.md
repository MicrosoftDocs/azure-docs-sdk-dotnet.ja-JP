<Type Name="ClearAlertRequest" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.ClearAlertRequest">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ClearAlertRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="alerts">削除する警告 Id の一覧</param>
        <param name="resolutionMessage">アラートの消去中に解決メッセージ</param>
        <summary>
            ClearAlertRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
