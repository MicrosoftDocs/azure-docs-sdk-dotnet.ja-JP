<Type Name="BackupElement" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.BackupElement">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="elementId">Backup 要素を一意に識別するパス ID です。</param>
        <param name="elementName">Backup 要素の名前。</param>
        <param name="elementType">バックアップの要素の階層型。</param>
        <param name="sizeInBytes">サイズ (バイト単位)。</param>
        <param name="volumeName">ボリュームの名前。</param>
        <param name="volumeContainerId">ボリューム コンテナーのパス ID。</param>
    ...
    <Member MemberName="ElementId">
      ...
      <Docs>
        <summary>
            取得またはバックアップの要素を一意に識別するパス ID を設定します。
            </summary>
