<Type Name="SecuritySettings" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.SecuritySettings">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="remoteManagementSettings">デバイスのリモート管理の設定。</param>
        <param name="chapSettings">チャレンジ ハンドシェイク認証プロトコル (CHAP) 設定します。</param>
    ...
    <Member MemberName="ChapSettings">
      ...
      <Docs>
        <summary>
            取得またはチャレンジ ハンドシェイク認証プロトコル (CHAP) 設定を設定します。
            </summary>
