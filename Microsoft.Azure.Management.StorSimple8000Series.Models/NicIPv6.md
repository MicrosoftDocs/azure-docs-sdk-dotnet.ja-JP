<Type Name="NicIPv6" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.NicIPv6">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="ipv6Address">ネットワーク アダプターの IPv6 アドレス。</param>
        <param name="ipv6Prefix">ネットワーク アダプターの IPv6 プレフィックス。</param>
        <param name="ipv6Gateway">ネットワーク アダプターの IPv6 ゲートウェイです。</param>
        <param name="controller0Ipv6Address">Controller0 の IPv6 アドレス。</param>
        <param name="controller1Ipv6Address">Controller1 の IPv6 アドレス。</param>
        <summary>
            NicIPv6 クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Controller0Ipv6Address">
      ...
      <Docs>
        <summary>
            取得または Controller0 の IPv6 アドレスを設定します。
            </summary>
    ...
    <Member MemberName="Controller1Ipv6Address">
      ...
      <Docs>
        <summary>
            取得または Controller1 の IPv6 アドレスを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Ipv6Address">
      ...
      <Docs>
        <summary>
            取得またはネットワーク アダプターの IPv6 アドレスを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Ipv6Gateway">
      ...
      <Docs>
        <summary>
            取得またはネットワーク アダプターの IPv6 ゲートウェイを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Ipv6Prefix">
      ...
      <Docs>
        <summary>
            取得またはネットワーク アダプターの IPv6 プレフィックスを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
