<Type Name="MetricNameFilter" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.MetricNameFilter">
  ...
  <Docs>
    <summary>
            フィルター選択するメトリックの名前を指定するメトリックの名前フィルターです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MetricNameFilter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">フィルター選択されるメトリック名を指定します。
            たとえば、CloudStorageUsed です。 有効な値は、ListMetricDefinitions 呼び出しの"name"というフィールドに返されるものです。 唯一の 'Equality' 演算子については、このプロパティのサポートします。</param>
        <summary>
            MetricNameFilter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            取得または設定で、フィルター選択するメトリックの名前を指定します。 たとえば、CloudStorageUsed です。 有効な値は、ListMetricDefinitions 呼び出しの"name"というフィールドに返されるものです。 唯一の 'Equality' 演算子については、このプロパティのサポートします。
            </summary>
