<Type Name="CloudApplianceSettings" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.CloudApplianceSettings">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            CloudApplianceSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serviceDataEncryptionKey">サービス データ暗号化キー (DAK で暗号化された)。</param>
        <param name="channelIntegrityKey">(DAK で暗号化された) チャネル整合性キー。</param>
        <summary>
            CloudApplianceSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ChannelIntegrityKey">
      ...
      <Docs>
        <summary>
            取得または (DAK で暗号化された) チャネル整合性キーを設定します。
            </summary>
    ...
    <Member MemberName="ServiceDataEncryptionKey">
      ...
      <Docs>
        <summary>
            取得または (DAK で暗号化された)、サービス データ暗号化キーを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
