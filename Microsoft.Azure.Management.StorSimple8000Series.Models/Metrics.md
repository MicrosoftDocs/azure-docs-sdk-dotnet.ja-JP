<Type Name="Metrics" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.Metrics">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resourceId">メトリック ソースの ID。</param>
        <param name="startTime">メトリック データの開始時刻です。</param>
        <param name="endTime">メトリック データの終了時刻。</param>
        <param name="timeGrain">メトリック データの時間粒度。</param>
        <param name="primaryAggregation">メトリックの集計の種類。
            使用可能な値が含まれます: '平均'、'Last'、'最大'、'最小'、'None'、'Total'</param>
        <param name="name">メトリックの名前。</param>
        <param name="dimensions">メトリックのディメンションです。</param>
        <param name="unit">メトリック データの単位。 使用可能な値が含まれます: 'バイト'、'BytesPerSecond'、'Count'、'CountPerSecond'、'%'、"Seconds"</param>
        <param name="type">メトリック データの型。</param>
        <param name="values">メトリック データの一覧。</param>
        <summary>
            メトリック クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="PrimaryAggregation">
      ...
      <Docs>
        <summary>
            取得またはメトリックの集計の種類を設定します。 使用可能な値が含まれます: '平均'、'Last'、'最大'、'最小'、'None'、'Total'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            取得またはメトリック データの単位を設定します。 使用可能な値が含まれます: 'バイト'、'BytesPerSecond'、'Count'、'CountPerSecond'、'%'、"Seconds"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
