  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="unit">メトリックの単位です。 使用可能な値が含まれます: 'バイト'、'BytesPerSecond'、'Count'、'CountPerSecond'、'%'、"Seconds"</param>
        <param name="primaryAggregationType">メトリックの集計の種類。
            使用可能な値が含まれます: '平均'、'Last'、'最大'、'最小'、'None'、'Total'</param>
        <param name="resourceId">メトリック ソース id。</param>
        <param name="metricAvailabilities">使用可能なメトリック粒度。</param>
        <param name="dimensions">使用可能なメトリックのディメンションです。</param>
        <param name="category">メトリックのカテゴリ。</param>
        <param name="type">メトリック定義の型。</param>
        <summary>
            MetricDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            取得またはメトリックの単位を設定します。 使用可能な値が含まれます: 'バイト'、'BytesPerSecond'、'Count'、'CountPerSecond'、'%'、"Seconds"
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
