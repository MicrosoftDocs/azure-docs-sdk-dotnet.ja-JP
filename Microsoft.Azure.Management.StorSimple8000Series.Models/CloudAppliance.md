<Type Name="CloudAppliance" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.CloudAppliance">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            CloudAppliance クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="vnetRegion">仮想ネットワーク領域。</param>
        <param name="vnetName">仮想ネットワークの名前です。</param>
        <param name="isVnetDnsConfigured">か、DNS で使用される仮想ネットワークを構成するかどうかを示します。</param>
        <param name="isVnetExpressConfigured">か、高速のルートに使用される仮想ネットワークを構成するかどうかを示します。</param>
        ...
        <param name="vmType">仮想マシンの種類。</param>
        <param name="vmImageName">バーチャル マシンのイメージの名前。</param>
    ...
    <Member MemberName="IsVnetDnsConfigured">
      ...
      <Docs>
        <summary>
            取得または設定か、DNS で使用される仮想ネットワークを構成するかどうかを示します。
            </summary>
    ...
    <Member MemberName="IsVnetExpressConfigured">
      ...
      <Docs>
        <summary>
            取得または設定か、高速のルートに使用される仮想ネットワークを構成するかどうかを示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
