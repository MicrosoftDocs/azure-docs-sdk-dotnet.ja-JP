<Type Name="BandwidthSchedule" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.BandwidthSchedule">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="start">Schdule の開始時刻です。</param>
        <param name="stop">スケジュールの終了時刻。</param>
        <param name="rateInMbps">Mbps レートです。</param>
        <param name="days">このスケジュールは該当する場合、週の日です。</param>
        <summary>
            BandwidthSchedule クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Days">
      ...
      <Docs>
        <summary>
            取得または、このスケジュールは該当するときに曜日を設定します。
            </summary>
