<Type Name="DimensionFilter" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.DimensionFilter">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DimensionFilter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">ディメンション名を指定します。 たとえば、NetworkInterface です。 有効な値は、「ディメンション」フィールドに ListMetricDefinitions 呼び出しで指定されたものです。 唯一の 'Equality' 演算子については、このプロパティのサポートします。</param>
        <param name="values">ディメンションの値を指定します。 Data0 などです。
            有効な値は、ListMetricDefinitions 呼び出し内のフィールド「ディメンション」で返されるものです。 唯一の 'Equality' 演算子については、このプロパティのサポートします。</param>
        <summary>
            DimensionFilter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得または設定は、ディメンション名を指定します。 たとえば、NetworkInterface です。
            有効な値は、「ディメンション」フィールドに ListMetricDefinitions 呼び出しで指定されたものです。 唯一の 'Equality' 演算子については、このプロパティのサポートします。
            </summary>
    ...
    <Member MemberName="Values">
      ...
      <Docs>
        <summary>
            取得または設定は、ディメンションの値を指定します。 Data0 などです。 有効な値は、ListMetricDefinitions 呼び出し内のフィールド「ディメンション」で返されるものです。 唯一の 'Equality' 演算子については、このプロパティのサポートします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
