<Type Name="VolumeFailoverMetadata" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.VolumeFailoverMetadata">
  ...
  <Docs>
    <summary>
            メタデータを持つ有効なボリュームのクラウド スナップショット。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VolumeFailoverMetadata クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="volumeId">ボリュームのパス ID です。</param>
        <param name="volumeType">ボリュームの種類。 使用可能な値が含まれます: '階層型'、'アーカイブ'、'LocallyPinned'</param>
        <param name="sizeInBytes">スナップショットの取得時にバイトのボリュームのサイズ。</param>
        <param name="backupCreatedDate">スナップショットが作成された日付。</param>
        <param name="backupElementId">バックアップ セット内のこのボリュームのバックアップの要素のパス ID。</param>
        <param name="backupId">バックアップ セットのパス ID です。</param>
        <param name="backupPolicyId">バックアップ ポリシーを使用して、スナップショットの取得のパス ID。</param>
        <summary>
            VolumeFailoverMetadata クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BackupElementId">
      ...
      <Docs>
        <summary>
            取得またはバックアップ セット内のこのボリュームのバックアップ要素のパス ID を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BackupPolicyId">
      ...
      <Docs>
        <summary>
            取得またはスナップショットの取得を使用して、バックアップ ポリシーのパス ID を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SizeInBytes">
      ...
      <Docs>
        <summary>
            取得またはボリュームのサイズをバイトで、スナップショット取得時に設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
