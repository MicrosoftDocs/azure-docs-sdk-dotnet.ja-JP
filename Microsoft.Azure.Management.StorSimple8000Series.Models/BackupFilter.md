<Type Name="BackupFilter" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.BackupFilter">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            BackupFilter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="backupPolicyId">フィルター選択するのには、バックアップの backupPolicyId を指定します。 唯一の 'Equality' 演算子については、このプロパティのサポートします。</param>
        <param name="volumeId">フィルター選択するのには、バックアップの volumeId を指定します。 唯一の 'Equality' 演算子については、このプロパティのサポートします。</param>
        <param name="createdTime">フィルター選択するのには、バックアップの作成時刻を指定します。 のみ 'より大きいまたは等しい' および 'より小さいまたは等しいに' 演算子は、このプロパティに対してサポートされています。</param>
        <summary>
            BackupFilter クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BackupPolicyId">
      ...
      <Docs>
        <summary>
            取得または設定は、フィルター選択するのには、バックアップの backupPolicyId を指定します。 唯一の 'Equality' 演算子については、このプロパティのサポートします。
            </summary>
    ...
    <Member MemberName="CreatedTime">
      ...
      <Docs>
        <summary>
            取得または設定は、フィルター選択するのには、バックアップの作成時刻を指定します。 のみ 'より大きいまたは等しい' および 'より小さいまたは等しいに' 演算子は、このプロパティに対してサポートされています。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VolumeId">
      ...
      <Docs>
        <summary>
            取得または設定は、フィルター選択するのには、バックアップの volumeId を指定します。
            唯一の 'Equality' 演算子については、このプロパティのサポートします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
