<Type Name="ManagerIntrinsicSettings" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.ManagerIntrinsicSettings">
  ...
  <Docs>
    <summary>
            組み込み設定には、型の Storsimple Manager を示します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ManagerIntrinsicSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="type">StorSimple Manager の型。 使用可能な値が含まれます: 'GardaV1'、'HelsinkiV1'</param>
        <summary>
            ManagerIntrinsicSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            取得または型の StorSimple Manager を設定します。 使用可能な値が含まれます: 'GardaV1'、'HelsinkiV1'
            </summary>
