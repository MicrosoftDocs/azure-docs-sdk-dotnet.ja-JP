<Type Name="MetricData" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.MetricData">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MetricData クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="timeStamp">メトリック データのタイムスタンプ。</param>
        <param name="sum">タイムスタンプの時点ですべてのサンプルの合計。</param>
        <param name="count">タイムスタンプの時点ですべてのサンプルの数。</param>
        <param name="average">タイムスタンプの時点ですべてのサンプルの平均です。</param>
        <param name="minimum">タイムスタンプの時点ですべてのサンプルの最小値。</param>
        <param name="maximum">すべてのサンプルのタイムスタンプから最大値。</param>
        <summary>
            MetricData クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Average">
      ...
      <Docs>
        <summary>
            取得またはタイムスタンプからすべてのサンプルの平均値を設定します。
            </summary>
    ...
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            取得またはタイムスタンプからすべてのサンプルの数を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Maximum">
      ...
      <Docs>
        <summary>
            取得またはタイムスタンプからすべてのサンプルの最大値を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Minimum">
      ...
      <Docs>
        <summary>
            取得またはタイムスタンプからすべてのサンプルの最小値を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sum">
      ...
      <Docs>
        <summary>
            取得またはタイムスタンプからすべてのサンプルの合計を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
