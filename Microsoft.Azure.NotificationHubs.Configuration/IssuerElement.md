<Type Name="IssuerElement" FullName="Microsoft.Azure.NotificationHubs.Configuration.IssuerElement">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="fd77e-101">Windows Azure Service Bus のトークンの発行者を説明する構成要素。</span><span class="sxs-lookup"><span data-stu-id="fd77e-101">A configuration element that describes an issuer of a token for the Windows Azure Service Bus.</span></span></summary>
  ...
  <Members>
    <Member MemberName="Address">
      ...
      <Docs>
        <summary><span data-ttu-id="fd77e-102">取得またはトークンの発行者の URI アドレスを設定します。</span><span class="sxs-lookup"><span data-stu-id="fd77e-102">Gets or sets the URI address of the token issuer.</span></span></summary>
        <value><span data-ttu-id="fd77e-103">トークン発行者の URI アドレス。</span><span class="sxs-lookup"><span data-stu-id="fd77e-103">The URI address of the token issuer.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyFrom">
      ...
      <Docs>
        <param name="from"><span data-ttu-id="fd77e-104">コンテンツをコピーする構成要素。</span><span class="sxs-lookup"><span data-stu-id="fd77e-104">The configuration element to copy the contents from.</span></span></param>
        <summary><span data-ttu-id="fd77e-105">この構成要素に指定された構成要素の内容をコピーします。</span><span class="sxs-lookup"><span data-stu-id="fd77e-105">Copies the contents of the specified configuration element to this configuration element.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary><span data-ttu-id="fd77e-106">この構成要素に含まれるプロパティのコレクションを取得します。</span><span class="sxs-lookup"><span data-stu-id="fd77e-106">Gets the collection of properties contained in this configuration element.</span></span></summary>
        <value><span data-ttu-id="fd77e-107">この構成要素に含まれるプロパティのコレクション。</span><span class="sxs-lookup"><span data-stu-id="fd77e-107">The collection of properties contained in this configuration element.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
