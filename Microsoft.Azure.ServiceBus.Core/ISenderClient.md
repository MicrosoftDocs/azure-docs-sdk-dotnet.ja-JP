<Type Name="ISenderClient" FullName="Microsoft.Azure.ServiceBus.Core.ISenderClient">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="eb66e-101">異なるクライアント間で共通の送信機能を定義するインターフェイスです。</span><span class="sxs-lookup"><span data-stu-id="eb66e-101">Interface that defines common send functionality between different clients.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CancelScheduledMessageAsync">
      ...
      <Docs>
        <param name="sequenceNumber"><span data-ttu-id="eb66e-102"><see cref="P:Microsoft.Azure.ServiceBus.Message.SystemPropertiesCollection.SequenceNumber" />をキャンセルできるメッセージのです。</span><span class="sxs-lookup"><span data-stu-id="eb66e-102">The <see cref="P:Microsoft.Azure.ServiceBus.Message.SystemPropertiesCollection.SequenceNumber" /> of the message to be cancelled.</span></span></param>
        <summary>
            <span data-ttu-id="eb66e-103">スケジュールしたメッセージを取り消します。</span><span class="sxs-lookup"><span data-stu-id="eb66e-103">Cancels a message that was scheduled.</span></span>
            </summary>
        <returns><span data-ttu-id="eb66e-104">非同期操作</span><span class="sxs-lookup"><span data-stu-id="eb66e-104">An asynchronous operation</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ScheduleMessageAsync">
      ...
      <Docs>
        <param name="message"><span data-ttu-id="eb66e-105"><see cref="T:Microsoft.Azure.ServiceBus.Message" /></span><span class="sxs-lookup"><span data-stu-id="eb66e-105">The <see cref="T:Microsoft.Azure.ServiceBus.Message" /></span></span></param>
        <param name="scheduleEnqueueTimeUtc"><span data-ttu-id="eb66e-106">メッセージは、処理できるようにする UTC 時刻</span><span class="sxs-lookup"><span data-stu-id="eb66e-106">The UTC time that the message should be available for processing</span></span></param>
        <summary>
            <span data-ttu-id="eb66e-107">Service Bus に表示するメッセージをスケジュールします。</span><span class="sxs-lookup"><span data-stu-id="eb66e-107">Schedules a message to appear on Service Bus.</span></span>
            </summary>
        <returns><span data-ttu-id="eb66e-108">スケジュール設定されたメッセージのシーケンス番号。</span><span class="sxs-lookup"><span data-stu-id="eb66e-108">The sequence number of the message that was scheduled.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SendAsync">
      ...
      <Docs>
        <param name="message"><span data-ttu-id="eb66e-109"><see cref="T:Microsoft.Azure.ServiceBus.Message" /></span><span class="sxs-lookup"><span data-stu-id="eb66e-109">The <see cref="T:Microsoft.Azure.ServiceBus.Message" /></span></span></param>
        <summary>
            <span data-ttu-id="eb66e-110">Service Bus にメッセージを送信します。</span><span class="sxs-lookup"><span data-stu-id="eb66e-110">Sends a message to Service Bus.</span></span>
            </summary>
        <returns><span data-ttu-id="eb66e-111">非同期操作</span><span class="sxs-lookup"><span data-stu-id="eb66e-111">An asynchronous operation</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SendAsync">
      ...
      <Docs>
        <param name="messageList"><span data-ttu-id="eb66e-112">メッセージの一覧</span><span class="sxs-lookup"><span data-stu-id="eb66e-112">The list of messages</span></span></param>
        <summary>
            <span data-ttu-id="eb66e-113">Service Bus にメッセージの一覧を送信します。</span><span class="sxs-lookup"><span data-stu-id="eb66e-113">Sends a list of messages to Service Bus.</span></span>
            </summary>
        <returns><span data-ttu-id="eb66e-114">非同期操作</span><span class="sxs-lookup"><span data-stu-id="eb66e-114">An asynchronous operation</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
