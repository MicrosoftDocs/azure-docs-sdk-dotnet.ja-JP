<Type Name="MessageSender" FullName="Microsoft.Azure.ServiceBus.Core.MessageSender">
  ...
  <Docs>
    ...
    <remarks>これは、AMQP プロトコルを使用して、サービスと通信します。</remarks>
    <example>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="entityPath">エンティティのパスにこのセンダが接続する必要があります。</param>
        <param name="retryPolicy"><see cref="T:Microsoft.Azure.ServiceBus.RetryPolicy" /> Service Bus との通信に使用されます。 既定値は<see cref="P:Microsoft.Azure.ServiceBus.RetryPolicy.Default" /></param>
        <summary>
            新しい AMQP MessageSender を作成します。
            </summary>
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
            MessageSender のエンティティのパスを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RegisteredPlugins">
      ...
      <Docs>
        <summary>
            このセンダには、現在登録されているプラグインの一覧を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="RegisterPlugin">
      ...
      <Docs>
        ...
        <summary>
            登録、<see cref="T:Microsoft.Azure.ServiceBus.Core.ServiceBusPlugin" />このセンダーで使用します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="SendAsync">
      ...
      <Docs>
        <param name="message"><see cref="T:Microsoft.Azure.ServiceBus.Message" />を送信するには</param>
        <summary>
            定義に従ってエンティティにメッセージを送信<see cref="P:Microsoft.Azure.ServiceBus.Core.MessageSender.Path" />です。
            </summary>
        <returns>非同期操作</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SendAsync">
      ...
      <Docs>
        <param name="messageList"><see cref="T:System.Collections.Generic.IList`1" />を送信するには</param>
        <summary>
            定義に従ってエンティティにメッセージの一覧を送信<see cref="P:Microsoft.Azure.ServiceBus.Core.MessageSender.Path" />です。
            </summary>
        <returns>非同期操作</returns>
        <remarks>To be added.</remarks>
      </Docs>
