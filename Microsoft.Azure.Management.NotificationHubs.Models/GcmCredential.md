<Type Name="GcmCredential" FullName="Microsoft.Azure.Management.NotificationHubs.Models.GcmCredential">
  ...
  <Docs>
    <summary>
            NotificationHub GcmCredential の説明です。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            GcmCredential クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="gcmEndpoint">GCM エンドポイントです。</param>
