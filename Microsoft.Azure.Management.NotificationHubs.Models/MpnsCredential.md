<Type Name="MpnsCredential" FullName="Microsoft.Azure.Management.NotificationHubs.Models.MpnsCredential">
  ...
  <Docs>
    <summary>
            NotificationHub MpnsCredential の説明です。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MpnsCredential クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="certificateKey">この資格情報の証明書のキー。</param>
        <param name="thumbprint">Mpns 証明書の拇印</param>
        <summary>
            MpnsCredential クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
