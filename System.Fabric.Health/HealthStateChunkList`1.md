<Type Name="HealthStateChunkList&lt;T&gt;" FullName="System.Fabric.Health.HealthStateChunkList&lt;T&gt;">
  ...
  <Docs>
    <typeparam name="T">リスト内の項目の種類。</typeparam>
    <summary>
            ヘルス状態のチャンク項目の一覧を含むチャンク リストを表します。
            </summary>
    <remarks>
      <para>チャンクのリストは、メッセージを書き込める以上の結果を持つことができる可能性のあるクエリから取得されます。 一致するエントリだけが返されます。 一覧には、十分な領域があった場合に返された項目の合計数が含まれています。</para>
    </remarks>
  </Docs>
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            空のインスタンスを作成<see cref="T:System.Fabric.Health.HealthStateChunkList`1" />クラスです。
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="list">ページのリストを作成するために使用する項目を含む一覧です。</param>
        <summary>
            インスタンスを作成、<see cref="T:System.Fabric.Health.HealthStateChunkList`1" />別のリストの項目を持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Contains">
      ...
      <Docs>
        ...
        <returns>一覧には、特定の項目が含まれている場合は trueそれ以外の場合は false です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="IndexOf">
      ...
      <Docs>
        ...
        <returns>指定された項目をこの一覧内のインデックス。 </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="IsReadOnly">
      ...
      <Docs>
        <summary>
            取得またはリストを変更できるかどうかを示すフラグを設定します。
            </summary>
        <value>一覧を変更できるかどうかを示すフラグします。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Remove">
      ...
      <Docs>
        ...
        <returns>項目が削除された場合は true。それ以外の場合は false です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RemoveAt">
      ...
      <Docs>
        <param name="index">項目を削除するインデックス。</param>
        <summary>
    ...
    <Member MemberName="ToString">
      ...
      <Docs>
        ...
        <returns>チャンク リストの文字列形式。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TotalCount">
      ...
      <Docs>
        <summary>
            1 つまたは複数のメッセージで返される項目の合計数を取得します。
            </summary>
        <value>システムでは、返された現在のアイテムの利用可能なアイテムの合計数。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
