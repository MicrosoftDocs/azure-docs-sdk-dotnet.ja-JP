<Type Name="ApplicationHealthStateList" FullName="System.Fabric.Health.ApplicationHealthStateList">
  ...
  <Docs>
    <summary>
      <para>コレクションを表します<see cref="T:System.Fabric.Health.ApplicationHealthState" />をインデックスによって個別にアクセスできることができます。</para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="Contains">
      ...
      <Docs>
        ...
        <returns>
          <para>
            <languageKeyword>true</languageKeyword>項目が、それ以外の場合<languageKeyword>false</languageKeyword>です。</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Count">
      ...
      <Docs>
        ...
        <value>
          <para><see cref="T:System.Int32" />要素の数を表すです。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        ...
        <returns>
          <para><see cref="T:System.Collections.Generic.IEnumerator`1" />コレクションを反復処理するために使用できるオブジェクト。</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IndexOf">
      ...
      <Docs>
        ...
        <returns>
          <para><see cref="T:System.Int32" />コレクション内で見つかった、それ以外の場合は、項目のインデックスを表す-1 です。</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Item">
      ...
      <Docs>
        ...
        <value>
          <para>指定されたインデックス位置にある <see cref="T:System.Fabric.Health.ApplicationHealthState" />。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Remove">
      ...
      <Docs>
        ...
        <returns>
          <para>
            <languageKeyword>true</languageKeyword>した項目が削除された、それ以外の場合<languageKeyword>false</languageKeyword>です。</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        ...
        <returns>
          <para>コレクションを反復処理するために使用できる <see cref="T:System.Collections.IEnumerator" /> オブジェクト。</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
