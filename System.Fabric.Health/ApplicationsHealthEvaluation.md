<Type Name="ApplicationsHealthEvaluation" FullName="System.Fabric.Health.ApplicationsHealthEvaluation">
  ...
  <Docs>
    <summary>
      <para>現在の集計された正常性状態の影響を受ける各の異常なアプリケーションの正常性評価を含む、アプリケーションの正常性評価を表します。</para>
    </summary>
    <remarks>クラスターの集計された正常性状態がいずれかの場合、クラスターの正常性評価中にアプリケーション評価を返すことが<see cref="F:System.Fabric.Health.HealthState.Error" />または<see cref="F:System.Fabric.Health.HealthState.Warning" />です。</remarks>
  </Docs>
  <Members>
    ...
    <Member MemberName="TotalCount">
      ...
      <Docs>
        <summary>
          <para>Health store にアプリケーションの合計数を取得します。</para>
        </summary>
        <value>
          <para><see cref="T:System.Int64" />正常性ストアのアプリケーションの合計数を表すです。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UnhealthyEvaluations">
      ...
      <Docs>
        <summary>
          <para>集計された正常性状態を原因となった異常な評価の一覧を取得します。</para>
        </summary>
        <value>
          <para>一連の<see cref="T:System.Fabric.Health.HealthEvaluation" />現在集計された正常性状態を原因となった異常な評価を表すです。</para>
        </value>
        <remarks>
            すべての異常が含まれています<see cref="T:System.Fabric.Health.ApplicationHealthEvaluation" />集計された正常性の影響を受けることです。</remarks>
      </Docs>
    </Member>
  </Members>
</Type>