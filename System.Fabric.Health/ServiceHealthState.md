<Type Name="ServiceHealthState" FullName="System.Fabric.Health.ServiceHealthState">
  ...
  <Docs>
    <summary>
      <para>サービスの識別子とその集計された正常性状態を含むサービスのヘルス状態を表します。</para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
            サービスのヘルス状態について説明する文字列を作成します。
            </summary>
        <returns>説明の文字列、<see cref="T:System.Fabric.Health.ServiceHealthState" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
