<Type Name="ReplicasHealthEvaluation" FullName="System.Fabric.Health.ReplicasHealthEvaluation">
  ...
  <Docs>
    <summary>
      <para>現在の集計されたヘルス状態、影響を受ける異常な各レプリカの正常性評価を含む、レプリカの正常性評価を表します。
            いずれかのパーティションの正常性と、集計された正常性状態の評価が返されることが<see cref="F:System.Fabric.Health.HealthState.Error" />または<see cref="F:System.Fabric.Health.HealthState.Warning" />です。</para>
    </summary>
  ...
  <Members>
    <Member MemberName="MaxPercentUnhealthyReplicasPerPartition">
      ...
      <Docs>
        <summary>
          <para>許容される異常なレプリカからパーティションあたりの割合の最大値を取得、<see cref="T:System.Fabric.Health.ApplicationHealthPolicy" />です。</para>
        </summary>
        <value>
          <para>最大パーティションあたりの異常なレプリカの割合です。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TotalCount">
      ...
      <Docs>
        <summary>
          <para>Health store からパーティションのレプリカの合計数を取得します。</para>
        </summary>
        <value>
          <para>パーティション内のレプリカの合計数。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
      ...
      <Docs>
        <summary>
          <para>集計された正常性状態を原因となった異常な評価の一覧を取得します。
            すべての異常が含まれています<see cref="T:System.Fabric.Health.ReplicaHealthEvaluation" />集計された正常性の影響を受けることです。</para>
        </summary>
        <value>
