<Type Name="GroupAddMemberParametersInner" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.Models.GroupAddMemberParametersInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            GroupAddMemberParametersInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="url">"Https://graph.windows.net/0b1f9851-1bf0-433f-aec3-cb9272f093dc/directoryObjects/f260bbc4-c254-447b-94cf-293b5ec434dd"、"0b1f9851-1bf0-433f-aec3-cb9272f093dc"が、tenantId がなど、メンバー オブジェクトの URL と"f260bbc4-c254-447b-94cf-293b5ec434dd"は、(ユーザー、アプリケーション、servicePrincipal、グループ) を追加するメンバーの objectId です。</param>
        <summary>
            GroupAddMemberParametersInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            取得または tenantId を"0b1f9851-1bf0-433f-aec3-cb9272f093dc"がここでは"https://graph.windows.net/0b1f9851-1bf0-433f-aec3-cb9272f093dc/directoryObjects/f260bbc4-c254-447b-94cf-293b5ec434dd"などのオブジェクトの URL、メンバーを設定し、"f260bbc4-c254-447b-94cf-293b5ec434dd"は、(ユーザー、アプリケーション、servicePrincipal、グループ) を追加するメンバーの objectId です。
            </summary>
