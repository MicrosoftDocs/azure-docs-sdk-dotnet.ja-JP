<Type Name="CheckGroupMembershipResultInner" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.Models.CheckGroupMembershipResultInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            CheckGroupMembershipResultInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">指定されたユーザー、グループ、連絡先、またはサービス プリンシパルは、指定したグループで直接または推移的なメンバーシップを持っている場合は true。それ以外の場合は false です。</param>
        <summary>
            CheckGroupMembershipResultInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            取得または設定の指定されたユーザー、グループ、連絡先、またはサービス プリンシパルは、指定したグループで直接または推移的なメンバーシップを持っている場合は true。それ以外の場合は false です。
            </summary>
