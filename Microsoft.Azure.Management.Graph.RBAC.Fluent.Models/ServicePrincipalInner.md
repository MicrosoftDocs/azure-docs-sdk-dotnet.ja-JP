<Type Name="ServicePrincipalInner" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.Models.ServicePrincipalInner">
  ...
  <Docs>
    <summary>
            Active Directory サービス プリンシパル情報。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ServicePrincipalInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="displayName">サービス プリンシパルの表示名。</param>
        <param name="appId">アプリケーション ID。</param>
        <param name="servicePrincipalNames">サービス プリンシパル名のコレクション。</param>
        <summary>
            ServicePrincipalInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ServicePrincipalNames">
      ...
      <Docs>
        <summary>
            取得またはサービス プリンシパル名のコレクションを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
