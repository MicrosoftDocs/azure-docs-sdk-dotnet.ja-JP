<Type Name="UserCreateParametersInner" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.Models.UserCreateParametersInner">
  ...
  <Docs>
    <summary>
            新しい仕事や学校のアカウント ユーザーを作成するためのパラメーターを要求します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            UserCreateParametersInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ImmutableId">
      ...
      <Docs>
        <summary>
            この必須の設定を取得または使用するかどうか、フェデレーション ドメイン ユーザーの userPrincipalName (UPN) プロパティの新しいユーザー アカウントを作成するときに指定します。 内部設置型 Active Directory ユーザー アカウントを関連付ける Azure AD ユーザー オブジェクトに使用されます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserPrincipalName">
      ...
      <Docs>
        <summary>
            取得または設定のユーザー プリンシパル名 (someuser@contoso.com)。 テナントの確認済みドメインのいずれかでなければなりません。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
