<Type Name="PasswordProfile" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.Models.PasswordProfile">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PasswordProfile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="forceChangePasswordNextLogin">次回ログインのパスワードを強制するかどうかを変更します。</param>
        <summary>
            PasswordProfile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ForceChangePasswordNextLogin">
      ...
      <Docs>
        <summary>
            取得または、次回ログインのパスワード変更を強制するかどうかを設定します。
            </summary>
