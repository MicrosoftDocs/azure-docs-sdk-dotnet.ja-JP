<Type Name="ApplicationInner" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.Models.ApplicationInner">
  ...
  <Docs>
    <summary>
            Active Directory アプリケーションの情報です。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="appPermissions">アプリケーションのアクセス許可。</param>
        <param name="availableToOtherTenants">アプリケーションがかどうかは、他のテナントを使用できます。</param>
    ...
    <Member MemberName="AvailableToOtherTenants">
      ...
      <Docs>
        <summary>
            取得またはアプリケーションが他のテナントに使用できるかどうかを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
