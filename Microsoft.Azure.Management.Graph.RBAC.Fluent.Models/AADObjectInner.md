<Type Name="AADObjectInner" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.Models.AADObjectInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ea8d9-101">Active Directory オブジェクトのプロパティです。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-101">The properties of an Active Directory object.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-102">AADObjectInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-102">Initializes a new instance of the AADObjectInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-103">取得またはオブジェクトの表示名を設定します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-103">Gets or sets the display name of the object.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Mail">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-104">取得またはオブジェクトのプライマリ電子メール アドレスを設定します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-104">Gets or sets the primary email address of the object.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MailEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-105">取得または AAD オブジェクトでメールが有効かどうかを設定します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-105">Gets or sets whether the AAD object is mail-enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ObjectId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-106">取得またはオブジェクトの ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-106">Gets or sets the ID of the object.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ObjectType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-107">取得または AAD のオブジェクトの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-107">Gets or sets the type of AAD object.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecurityEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-108">取得または AAD のオブジェクトが、セキュリティが有効かどうかを設定します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-108">Gets or sets whether the AAD object is security-enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServicePrincipalNames">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-109">取得またはオブジェクトに関連付けられているサービス プリンシパル名のコレクションを設定します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-109">Gets or sets a collection of service principal names associated with the object.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SignInName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-110">取得またはオブジェクトのサインイン名を設定します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-110">Gets or sets the sign-in name of the object.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserPrincipalName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-111">取得またはオブジェクトのプリンシパル名を設定します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-111">Gets or sets the principal name of the object.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea8d9-112">取得またはオブジェクトのユーザーの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="ea8d9-112">Gets or sets the user type of the object.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
