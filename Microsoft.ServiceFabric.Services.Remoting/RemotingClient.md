<Type Name="RemotingClient" FullName="Microsoft.ServiceFabric.Services.Remoting.RemotingClient">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4fa0d-101">クライアントのリモート処理スタックを決定します。</span><span class="sxs-lookup"><span data-stu-id="4fa0d-101">Determines the remoting stack for client</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="V1Client">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4fa0d-102">作成時にこの選択は、V1 Client.V2、古い (すぐに推奨されていません) は、リモート処理スタックです。</span><span class="sxs-lookup"><span data-stu-id="4fa0d-102">This is selected to create V1 Client.V2 is a old(soon to be deprecated) Remoting Stack.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="V2Client">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4fa0d-103">作成時にこの選択は V2 Client.V2 は新しいリモート処理スタックです。</span><span class="sxs-lookup"><span data-stu-id="4fa0d-103">This is selected to create V2 Client.V2 is a new Remoting Stack.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
