<Type Name="AdditionalUnattendContent" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.AdditionalUnattendContent">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e0a69-101">追加の XML には、Windows セットアップで使用される、Unattend.xml ファイルに含めることのできる情報が書式設定されます。</span><span class="sxs-lookup"><span data-stu-id="e0a69-101">Additional XML formatted information that can be included in the Unattend.xml file, which is used by Windows Setup.</span></span> <span data-ttu-id="e0a69-102">内容は、名前、コンポーネント名、およびコンテンツが、適用するパスを設定して定義されます。</span><span class="sxs-lookup"><span data-stu-id="e0a69-102">Contents are defined by setting name, component name, and the pass in which the content is a applied.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0a69-103">AdditionalUnattendContent クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="e0a69-103">Initializes a new instance of the AdditionalUnattendContent class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="passName"><span data-ttu-id="e0a69-104">パスの名前。</span><span class="sxs-lookup"><span data-stu-id="e0a69-104">The pass name.</span></span> <span data-ttu-id="e0a69-105">現時点では、可能な値は、oobeSystem です。</span><span class="sxs-lookup"><span data-stu-id="e0a69-105">Currently, the only allowable value is oobeSystem.</span></span> <span data-ttu-id="e0a69-106">使用可能な値が含まれます: 'oobeSystem'</span><span class="sxs-lookup"><span data-stu-id="e0a69-106">Possible values include: 'oobeSystem'</span></span></param>
        <param name="componentName"><span data-ttu-id="e0a69-107">コンポーネントの名前。</span><span class="sxs-lookup"><span data-stu-id="e0a69-107">The component name.</span></span> <span data-ttu-id="e0a69-108">現時点では、可能な値は、Microsoft Windows シェル セットアップです。</span><span class="sxs-lookup"><span data-stu-id="e0a69-108">Currently, the only allowable value is Microsoft-Windows-Shell-Setup.</span></span> <span data-ttu-id="e0a69-109">使用可能な値が含まれます: ' Microsoft の Windows のシェルのセットアップ '</span><span class="sxs-lookup"><span data-stu-id="e0a69-109">Possible values include: 'Microsoft-Windows-Shell-Setup'</span></span></param>
        <param name="settingName"><span data-ttu-id="e0a69-110">名前 (例: FirstLogonCommands、AutoLogon) を設定します。</span><span class="sxs-lookup"><span data-stu-id="e0a69-110">Setting name (e.g. FirstLogonCommands, AutoLogon ).</span></span> <span data-ttu-id="e0a69-111">使用可能な値が含まれます '自動'、'FirstLogonCommands'。</span><span class="sxs-lookup"><span data-stu-id="e0a69-111">Possible values include: 'AutoLogon', 'FirstLogonCommands'</span></span></param>
        <param name="content"><span data-ttu-id="e0a69-112">XML 形式のコンテンツを指定したパスおよびコンポーネントの unattend.xml ファイルに追加されます。</span><span class="sxs-lookup"><span data-stu-id="e0a69-112">XML formatted content that is added to the unattend.xml file in the specified pass and component.</span></span> <span data-ttu-id="e0a69-113">XML では、4 KB 未満である必要があり、設定または挿入している機能のルート要素を含める必要があります。</span><span class="sxs-lookup"><span data-stu-id="e0a69-113">The XML must be less than 4 KB and must include the root element for the setting or feature that is being inserted.</span></span></param>
        <summary>
            <span data-ttu-id="e0a69-114">AdditionalUnattendContent クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="e0a69-114">Initializes a new instance of the AdditionalUnattendContent class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ComponentName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0a69-115">取得またはコンポーネントの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="e0a69-115">Gets or sets the component name.</span></span> <span data-ttu-id="e0a69-116">現時点では、可能な値は、Microsoft Windows シェル セットアップです。</span><span class="sxs-lookup"><span data-stu-id="e0a69-116">Currently, the only allowable value is Microsoft-Windows-Shell-Setup.</span></span> <span data-ttu-id="e0a69-117">使用可能な値が含まれます: ' Microsoft の Windows のシェルのセットアップ '</span><span class="sxs-lookup"><span data-stu-id="e0a69-117">Possible values include: 'Microsoft-Windows-Shell-Setup'</span></span>
            </summary>
    ...
    <Member MemberName="Content">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0a69-118">取得または XML 形式を指定したパスおよびコンポーネントの unattend.xml ファイルに追加されているコンテンツに設定します。</span><span class="sxs-lookup"><span data-stu-id="e0a69-118">Gets or sets XML formatted content that is added to the unattend.xml file in the specified pass and component.</span></span> <span data-ttu-id="e0a69-119">XML では、4 KB 未満である必要があり、設定または挿入している機能のルート要素を含める必要があります。</span><span class="sxs-lookup"><span data-stu-id="e0a69-119">The XML must be less than 4 KB and must include the root element for the setting or feature that is being inserted.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PassName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0a69-120">取得またはパスの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="e0a69-120">Gets or sets the pass name.</span></span> <span data-ttu-id="e0a69-121">現時点では、可能な値は、oobeSystem です。</span><span class="sxs-lookup"><span data-stu-id="e0a69-121">Currently, the only allowable value is oobeSystem.</span></span> <span data-ttu-id="e0a69-122">使用可能な値が含まれます: 'oobeSystem'</span><span class="sxs-lookup"><span data-stu-id="e0a69-122">Possible values include: 'oobeSystem'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SettingName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e0a69-123">取得または設定の名前 (例: FirstLogonCommands、AutoLogon) を設定します。</span><span class="sxs-lookup"><span data-stu-id="e0a69-123">Gets or sets setting name (e.g. FirstLogonCommands, AutoLogon ).</span></span>
            <span data-ttu-id="e0a69-124">使用可能な値が含まれます '自動'、'FirstLogonCommands'。</span><span class="sxs-lookup"><span data-stu-id="e0a69-124">Possible values include: 'AutoLogon', 'FirstLogonCommands'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
