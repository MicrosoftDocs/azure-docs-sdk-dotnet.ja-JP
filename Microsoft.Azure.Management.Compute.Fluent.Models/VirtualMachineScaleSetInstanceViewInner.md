<Type Name="VirtualMachineScaleSetInstanceViewInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineScaleSetInstanceViewInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualMachineScaleSetInstanceViewInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="virtualMachine">仮想マシンのスケールの概要をインスタンス ビューの状態を設定します。</param>
    ...
    <Member MemberName="VirtualMachine">
      ...
      <Docs>
        <summary>
            仮想マシン スケール セットの概要インスタンス ビューの状態を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
