<Type Name="DiskEncryptionSettings" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.DiskEncryptionSettings">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="diskEncryptionKey">Key Vault のシークレットをあるディスクの暗号化キー。</param>
        <param name="keyEncryptionKey">Key Vault のキーであるキーの暗号化キー。</param>
    ...
    <Member MemberName="DiskEncryptionKey">
      ...
      <Docs>
        <summary>
            取得または、Key Vault のシークレットをあるディスクの暗号化キーを設定します。
            </summary>
    ...
    <Member MemberName="KeyEncryptionKey">
      ...
      <Docs>
        <summary>
            取得または、Key Vault のキーであるキーの暗号化キーを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
