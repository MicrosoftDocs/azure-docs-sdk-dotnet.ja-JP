<Type Name="VirtualHardDisk" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualHardDisk">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualHardDisk クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="uri">仮想ハード ディスクの URI。 バーチャル ハード ディスクへの有効な URI でなければなりません。</param>
        <summary>
            VirtualHardDisk クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Uri">
      ...
      <Docs>
        <summary>
            取得またはバーチャル ハード_ディスクの URI を設定します。 バーチャル ハード ディスクへの有効な URI でなければなりません。
            </summary>
