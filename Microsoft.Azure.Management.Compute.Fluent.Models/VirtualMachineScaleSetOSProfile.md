<Type Name="VirtualMachineScaleSetOSProfile" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineScaleSetOSProfile">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="computerNamePrefix">コンピューター名のプレフィックス。</param>
        <param name="adminUsername">管理者のユーザー名。</param>
        <param name="adminPassword">管理者のユーザー パスワード。</param>
