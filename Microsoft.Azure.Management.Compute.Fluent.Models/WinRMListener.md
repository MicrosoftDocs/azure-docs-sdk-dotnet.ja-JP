<Type Name="WinRMListener" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.WinRMListener">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="protocol">WinRM リスナーで使用されるプロトコルです。
            Http と Https がサポートされます。 使用可能な値が含まれます 'Http'、'Https'。</param>
        <param name="certificateUrl">Https リスナーの KMS で証明書の URL。 Http リスナーを null にする必要があります。</param>
        <summary>
            WinRMListener クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CertificateUrl">
      ...
      <Docs>
        <summary>
            取得または KMS の Https リスナーを証明書の URL に設定します。 Http リスナーを null にする必要があります。
            </summary>
    ...
    <Member MemberName="Protocol">
      ...
      <Docs>
        <summary>
            取得または WinRM リスナーで使用されるプロトコルを設定します。 Http と Https がサポートされます。 使用可能な値が含まれます 'Http'、'Https'。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
