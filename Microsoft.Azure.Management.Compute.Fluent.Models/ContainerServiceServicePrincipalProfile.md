<Type Name="ContainerServiceServicePrincipalProfile" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.ContainerServiceServicePrincipalProfile">
  ...
  <Docs>
    <summary>
            Azure Api を操作するのに使用するクラスターのサービス プリンシパル id に関する情報です。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="clientId">サービス プリンシパルの ID です。</param>
        <param name="secret">サービス プリンシパルに関連付けられているシークレットのパスワード。</param>
        <summary>
            ContainerServiceServicePrincipalProfile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Secret">
      ...
      <Docs>
        <summary>
            取得またはサービス プリンシパルに関連付けられているシークレットのパスワードを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
