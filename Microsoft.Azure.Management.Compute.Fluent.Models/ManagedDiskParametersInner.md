<Type Name="ManagedDiskParametersInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.ManagedDiskParametersInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ManagedDiskParametersInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="storageAccountType">ストレージ アカウントの種類。 使用可能な値が含まれます: 'Standard_LRS'、'Premium_LRS'</param>
        <summary>
            ManagedDiskParametersInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="StorageAccountType">
      ...
      <Docs>
        <summary>
            取得またはストレージ アカウントの種類を設定します。 使用可能な値が含まれます: 'Standard_LRS'、'Premium_LRS'
            </summary>
