<Type Name="GrantAccessDataInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.GrantAccessDataInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            GrantAccessDataInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="access">使用可能な値が含まれます 'None'、'読み取り'。</param>
        <param name="durationInSeconds">SAS アクセスの有効期限が切れるまでの秒数の期間を時間です。</param>
        <summary>
            GrantAccessDataInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DurationInSeconds">
      ...
      <Docs>
        <summary>
            取得または SAS アクセスの有効期限が切れるまでの秒数時間の期間を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
