<Type Name="VirtualMachineCaptureParametersInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineCaptureParametersInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualMachineCaptureParametersInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="vhdPrefix">キャプチャした仮想ハード_ディスクの名前プレフィックスです。</param>
        <param name="destinationContainerName">移行先のコンテナー名。</param>
        <param name="overwriteVhds">移行先仮想ハード ディスクの競合が発生した場合に上書きするかどうかを指定します。</param>
        <summary>
            VirtualMachineCaptureParametersInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="OverwriteVhds">
      ...
      <Docs>
        <summary>
            取得または設定は、移行先仮想ハード ディスクの競合が発生した場合に上書きするかどうかを指定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VhdPrefix">
      ...
      <Docs>
        <summary>
            取得またはキャプチャした仮想ハード_ディスクの名前プレフィックスを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
