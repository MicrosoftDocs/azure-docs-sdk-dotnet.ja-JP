<Type Name="VirtualMachineExtensionInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineExtensionInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualMachineExtensionInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="virtualMachineExtensionType">拡張機能ハンドラーの型。</param>
        <param name="typeHandlerVersion">拡張機能ハンドラーのタイプのバージョン。</param>
        <param name="autoUpgradeMinorVersion">かどうかのマイナー バージョン間で、拡張機能ハンドラーを自動的にアップグレードする必要があります。</param>
        <param name="settings">Json 形式の拡張機能のパブリックに設定します。</param>
        <param name="protectedSettings">Json 形式の拡張機能の設定を保護します。</param>
    ...
    <Member MemberName="AutoUpgradeMinorVersion">
      ...
      <Docs>
        <summary>
            取得またはマイナー バージョン間で、拡張機能ハンドラーを自動的にアップグレードする必要があるかどうかを設定します。
            </summary>
    ...
    <Member MemberName="ProtectedSettings">
      ...
      <Docs>
        <summary>
            取得または json 形式を設定、拡張機能の設定を保護します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
