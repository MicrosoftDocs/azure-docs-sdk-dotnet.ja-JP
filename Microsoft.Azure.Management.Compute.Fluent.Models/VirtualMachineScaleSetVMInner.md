<Type Name="VirtualMachineScaleSetVMInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineScaleSetVMInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualMachineScaleSetVMInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="hardwareProfile">ハードウェア プロファイル。</param>
        <param name="storageProfile">ストレージ プロファイル。</param>
        <param name="osProfile">OS プロファイル。</param>
        <param name="networkProfile">ネットワーク プロファイル。</param>
        <param name="diagnosticsProfile">診断プロファイル。</param>
        <param name="availabilitySet">このバーチャル マシンが属しているをセットの参照を可用性の Id。</param>
        <param name="provisioningState">プロビジョニングの状態、応答でのみ表示されます。</param>
        <param name="licenseType">ライセンスの種類はの表示、独自のシナリオのライセンスを取得します。</param>
        <param name="plan">購入プラン VM Marketplace イメージから仮想マシンを展開するときにします。</param>
    ...
    <Member MemberName="AvailabilitySet">
      ...
      <Docs>
        <summary>
            取得または設定がこの仮想マシンが属する可用性の Id の参照を設定します。
            </summary>
    ...
    <Member MemberName="Plan">
      ...
      <Docs>
        <summary>
            取得または VM Marketplace イメージから仮想マシンを展開するときに、購入プランを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
