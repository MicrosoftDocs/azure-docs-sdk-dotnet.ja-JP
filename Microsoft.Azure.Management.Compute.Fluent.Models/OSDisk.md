  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="encryptionSettings">ディスク暗号化の設定。</param>
        <param name="name">ディスクの名前。</param>
        <param name="vhd">バーチャル ハード_ディスク。</param>
        <param name="image">送信元のユーザーは、バーチャル ハード_ディスクをイメージします。 仮想マシンに接続を使用する前に、バーチャル ハード_ディスクがコピーされます。 SourceImage を指定すると、セットアップ先の仮想ハード_ディスクが存在する必要があります。</param>
        <param name="caching">キャッシュの型。 使用可能な値が含まれます 'None'、'ReadOnly'、'ReadWrite'。</param>
        <param name="diskSizeGB">初期のディスク サイズを gb 単位、空のデータ ディスクと既存の OS とデータ ディスクのサイズ変更の目的の新しいサイズ。</param>
    ...
    <Member MemberName="DiskSizeGB">
      ...
      <Docs>
        <summary>
            取得または、初期のディスク サイズを gb 単位空のデータ ディスク、および既存の OS とデータ ディスクのサイズ変更の目的の新しいサイズを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Image">
      ...
      <Docs>
        <summary>
            取得または元のユーザー イメージ仮想ハード_ディスクを設定します。 仮想マシンに接続を使用する前に、バーチャル ハード_ディスクがコピーされます。 SourceImage を指定すると、セットアップ先の仮想ハード_ディスクが存在する必要があります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
