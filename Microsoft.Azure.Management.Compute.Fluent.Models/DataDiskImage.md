<Type Name="DataDiskImage" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.DataDiskImage">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DataDiskImage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="lun">データ ディスク LUN の数。 この値は、vm イメージ内のデータ ディスク イメージの識別に使用して、各データ ディスクに対して一意である必要がありますのでです。</param>
        <summary>
            DataDiskImage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Lun">
      ...
      <Docs>
        <summary>
            データ ディスクの LUN 数を取得します。 この値は、vm イメージ内のデータ ディスク イメージの識別に使用して、各データ ディスクに対して一意である必要がありますのでです。
            </summary>
