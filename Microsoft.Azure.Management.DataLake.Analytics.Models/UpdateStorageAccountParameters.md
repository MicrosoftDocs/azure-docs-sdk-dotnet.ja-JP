<Type Name="UpdateStorageAccountParameters" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.UpdateStorageAccountParameters">
  ...
  <Docs>
    <summary>
            Data Lake Analytics アカウントで更新されているストレージ アカウントのストレージ アカウントのパラメーターです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            UpdateStorageAccountParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="accessKey">接続するために使用されるこの Azure ストレージ アカウントに関連付けられている更新されたアクセス キー。</param>
    ...
    <Member MemberName="AccessKey">
      ...
      <Docs>
        <summary>
            取得またはそれへの接続に使用されるこの Azure ストレージ アカウントに関連付けられている更新されたアクセス キーを設定します。
            </summary>
