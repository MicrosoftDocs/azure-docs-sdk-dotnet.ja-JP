<Type Name="EntityId" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.EntityId">
  ...
  <Docs>
    <summary>
            Data Lake Analytics カタログ エンティティ識別子オブジェクト。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">このデータベース、スキーマとテーブルに関連付けられている外部テーブルの名前。</param>
        <param name="version">外部データ ソースのバージョン。</param>
        <summary>
            EntityId クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得またはこのデータベース、スキーマとテーブルに関連付けられている外部テーブルの名前を設定します。
            </summary>
