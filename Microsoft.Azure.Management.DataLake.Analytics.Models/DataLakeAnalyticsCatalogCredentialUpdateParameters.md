<Type Name="DataLakeAnalyticsCatalogCredentialUpdateParameters" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.DataLakeAnalyticsCatalogCredentialUpdateParameters">
  ...
  <Docs>
    <summary>
            Data Lake Analytics カタログの資格情報パラメーターを変更します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="password">資格情報と、データ ソースにアクセスできるユーザーの現在のパスワード。 要求者はアカウント所有者ではない場合、この機能が必要です。</param>
        <param name="newPassword">資格情報と、データ ソースにアクセスできるユーザーの新しいパスワード。</param>
    ...
    <Member MemberName="NewPassword">
      ...
      <Docs>
        <summary>
            取得またはデータ ソースに資格情報とアクセス権を持つユーザーの新しいパスワードを設定します。
            </summary>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            取得またはデータ ソースに資格情報とアクセス権を持つユーザーの現在のパスワードを設定します。 要求者はアカウント所有者ではない場合、この機能が必要です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
