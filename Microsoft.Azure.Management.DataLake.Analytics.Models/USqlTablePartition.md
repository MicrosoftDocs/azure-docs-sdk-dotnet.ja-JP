<Type Name="USqlTablePartition" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.USqlTablePartition">
  ...
  <Docs>
    <summary>
            Data Lake Analytics カタログ U-SQL テーブル パーティション アイテムです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            USqlTablePartition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="schemaName">このテーブルのパーティションとデータベースに関連付けられているスキーマの名前。</param>
        <param name="name">テーブルのパーティションの名前。</param>
        <param name="parentName">パーティションの親の Ddl オブジェクト。</param>
        <param name="indexId">このパーティションのインデックス ID です。</param>
        <param name="label">このパーティションに関連付けられているラベルの一覧です。</param>
        <param name="createDate">パーティションの作成日時</param>
        <summary>
            USqlTablePartition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IndexId">
      ...
      <Docs>
        <summary>
            取得またはこのパーティションのインデックス ID を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Label">
      ...
      <Docs>
        <summary>
            取得またはこのパーティションに関連付けられているラベルの一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ParentName">
      ...
      <Docs>
        <summary>
            取得またはパーティションの親の Ddl オブジェクトを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SchemaName">
      ...
      <Docs>
        <summary>
            取得またはこのテーブルのパーティションとデータベースに関連付けられているスキーマの名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
