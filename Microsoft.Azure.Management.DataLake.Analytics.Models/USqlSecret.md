<Type Name="USqlSecret" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.USqlSecret">
  ...
  <Docs>
    <summary>
            Data Lake Analytics カタログ U-SQL シークレット アイテムです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            USqlSecret クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="creationTime">資格情報オブジェクトの作成時間。 これは、シークレットに関する GET から返される情報のみです。</param>
    ...
    <Member MemberName="CreationTime">
      ...
      <Docs>
        <summary>
            取得または資格情報オブジェクトの作成時刻を設定します。 これは、シークレットに関する GET から返される情報のみです。
            </summary>
