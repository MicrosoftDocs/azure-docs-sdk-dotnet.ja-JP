<Type Name="USqlPackage" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.USqlPackage">
  ...
  <Docs>
    <summary>
            Data Lake Analytics カタログ U-SQL パッケージ項目。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            USqlPackage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="databaseName">パッケージを含むデータベースの名前。</param>
        <param name="schemaName">このパッケージとデータベースに関連付けられているスキーマの名前。</param>
        <param name="name">パッケージの名前。</param>
        <param name="definition">パッケージの定義。</param>
        <summary>
            USqlPackage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="SchemaName">
      ...
      <Docs>
        <summary>
            取得またはこのパッケージとデータベースに関連付けられているスキーマの名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
