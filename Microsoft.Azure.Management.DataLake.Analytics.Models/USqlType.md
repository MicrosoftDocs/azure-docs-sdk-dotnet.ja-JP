<Type Name="USqlType" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.USqlType">
  ...
  <Docs>
    <summary>
            Data Lake Analytics カタログ U-SQL 型項目。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="schemaName">このテーブルおよびデータベースに関連付けられているスキーマの名前。</param>
        <param name="name">この型の型の名前。</param>
        <param name="typeFamily">この型の型のファミリです。</param>
        <param name="cSharpName">C# でこの種類の名前。</param>
        <param name="fullCSharpName">完全修飾 (C#) 名前この型。</param>
        <param name="systemTypeId">この種類のシステム型の ID。</param>
        <param name="userTypeId">この種類のユーザーの種類の ID。</param>
        <param name="schemaId">この型のスキーマ ID です。</param>
        <param name="principalId">この種類のプリンシパル ID。</param>
        <param name="isNullable">かどうかはこのを許容する型を示すスイッチです。</param>
        <param name="isUserDefined">この型が定義されているユーザーであることを示すスイッチです。</param>
        <param name="isAssemblyType">かどうか、この型はアセンブリの種類を示すスイッチです。</param>
        <param name="isTableType">かどうか、この型は、テーブル型を示すスイッチです。</param>
        <param name="isComplexType">かどうか、この型は複合型を示すスイッチです。</param>
        <summary>
            USqlType クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IsAssemblyType">
      ...
      <Docs>
        <summary>
            取得または設定のかどうか、この型はアセンブリの種類を示すスイッチです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsNullable">
      ...
      <Docs>
        <summary>
            取得または設定のかどうかはこのを許容する型を示すスイッチです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsTableType">
      ...
      <Docs>
        <summary>
            取得または設定のかどうか、この型は、テーブル型を示すスイッチです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsUserDefined">
      ...
      <Docs>
        <summary>
            取得または設定、この型が定義されているユーザーであることを示すスイッチです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SchemaName">
      ...
      <Docs>
        <summary>
            取得またはこのテーブルおよびデータベースに関連付けられているスキーマの名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
