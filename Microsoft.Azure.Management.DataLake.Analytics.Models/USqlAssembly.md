<Type Name="USqlAssembly" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.USqlAssembly">
  ...
  <Docs>
    <summary>
            カタログ Data Lake Analytics U-SQL アセンブリ。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="clrName">CLR の名前。</param>
        <param name="isVisible">かどうかはこのアセンブリを表示するかを示すスイッチです。</param>
        <param name="isUserDefined">このアセンブリはユーザー定義かを示すスイッチです。</param>
        <param name="files">アセンブリに関連付けられているファイルの一覧</param>
        <param name="dependencies">アセンブリに関連付けられている依存関係の一覧</param>
        <summary>
            USqlAssembly クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Files">
      ...
      <Docs>
        <summary>
            取得またはアセンブリに関連付けられているファイルの一覧の設定
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsUserDefined">
      ...
      <Docs>
        <summary>
            取得またはこのアセンブリはユーザー定義かを示す、スイッチを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsVisible">
      ...
      <Docs>
        <summary>
            取得またはかどうかはこのアセンブリを表示するかを示す、スイッチを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
