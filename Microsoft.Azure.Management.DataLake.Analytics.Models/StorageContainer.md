<Type Name="StorageContainer" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.StorageContainer">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            StorageContainer クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">blob コンテナーの一意の識別子。</param>
        <param name="name">blob コンテナーの名前です。</param>
        <param name="type">blob コンテナーの型。</param>
        <param name="lastModifiedTime">最終更新時刻、blob コンテナー。</param>
        <summary>
            StorageContainer クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
