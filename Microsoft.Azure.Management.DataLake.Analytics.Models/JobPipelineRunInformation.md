<Type Name="JobPipelineRunInformation" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.JobPipelineRunInformation">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            JobPipelineRunInformation クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="runId">パイプラインの実行 (GUID) のインスタンスの実行の識別子です。</param>
        <param name="lastSubmitTime">このインスタンスが最後に送信された時刻。</param>
        <summary>
            JobPipelineRunInformation クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="RunId">
      ...
      <Docs>
        <summary>
            パイプラインの実行 (GUID) のインスタンスの実行の識別子を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
