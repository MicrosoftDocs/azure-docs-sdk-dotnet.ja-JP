<Type Name="USqlView" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.USqlView">
  ...
  <Docs>
    <summary>
            Data Lake Analytics カタログ U-SQL ビュー項目。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="schemaName">このビューとデータベースに関連付けられているスキーマの名前。</param>
        <param name="name">ビューの名前。</param>
        <param name="definition">ビューの定義済みのクエリ。</param>
        <summary>
            USqlView クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="SchemaName">
      ...
      <Docs>
        <summary>
            取得またはこのビューとデータベースに関連付けられているスキーマの名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
