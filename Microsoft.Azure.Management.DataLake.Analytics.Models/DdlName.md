<Type Name="DdlName" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.DdlName">
  ...
  <Docs>
    <summary>
            Data Lake Analytics DDL 名前アイテムです。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="firstPart">このデータベースとスキーマに関連付けられているテーブルの名前。</param>
        <param name="secondPart">このデータベースとスキーマに関連付けられているテーブルの名前。</param>
        <param name="thirdPart">このデータベースとスキーマに関連付けられているテーブルの名前。</param>
        <param name="server">このデータベースとスキーマに関連付けられているテーブルの名前。</param>
        <summary>
            DdlName クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
