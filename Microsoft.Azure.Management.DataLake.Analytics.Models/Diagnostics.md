<Type Name="Diagnostics" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.Diagnostics">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="columnNumber">エラーが発生した列です。</param>
        <param name="end">エラーの終了インデックスです。</param>
        <param name="lineNumber">エラーが発生した行番号。</param>
        <param name="message">エラー メッセージ。</param>
        <param name="severity">エラーの重大度。 使用可能な値が含まれます: 'Warning'、'Error'、'情報'、'SevereWarning'、'非推奨'、'UserWarning'</param>
        <param name="start">エラーの開始インデックス。</param>
        <summary>
            診断クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Severity">
      ...
      <Docs>
        <summary>
            エラーの重大度を取得します。 使用可能な値が含まれます: 'Warning'、'Error'、'情報'、'SevereWarning'、'非推奨'、'UserWarning'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
