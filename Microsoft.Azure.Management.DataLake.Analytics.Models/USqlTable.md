<Type Name="USqlTable" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.USqlTable">
  ...
  <Docs>
    <summary>
            Data Lake Analytics カタログ U-SQL テーブル項目。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            USqlTable クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="columnList">このテーブルの列の一覧</param>
        <param name="indexList">このテーブル内のインデックスの一覧</param>
        <param name="partitionKeyList">テーブル内のパーティション キーの一覧</param>
        <param name="externalTable">テーブルに関連付けられている外部テーブルです。</param>
        <param name="distributionInfo">テーブルの分布情報</param>
        <summary>
            USqlTable クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ExternalTable">
      ...
      <Docs>
        <summary>
            取得またはテーブルに関連付けられている外部テーブルを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
