<Type Name="USqlProcedure" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.USqlProcedure">
  ...
  <Docs>
    <summary>
            Data Lake Analytics カタログ U-SQL プロシージャ項目。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            USqlProcedure クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="schemaName">この手順とデータベースに関連付けられているスキーマの名前。</param>
        <param name="name">プロシージャの名前。</param>
        <param name="definition">プロシージャの定義済みのクエリ。</param>
        <summary>
            USqlProcedure クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="SchemaName">
      ...
      <Docs>
        <summary>
            取得または、この手順とデータベースに関連付けられているスキーマの名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
