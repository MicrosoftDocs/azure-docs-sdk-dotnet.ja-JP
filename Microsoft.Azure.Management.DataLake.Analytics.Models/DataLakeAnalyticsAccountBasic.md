<Type Name="DataLakeAnalyticsAccountBasic" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.DataLakeAnalyticsAccountBasic">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="28366-101">Data Lake Analytics アカウント オブジェクト、名前付きの Data Lake Analytics アカウントに関連付けられているすべての情報を格納します。</span><span class="sxs-lookup"><span data-stu-id="28366-101">A Data Lake Analytics account object, containing all information associated with the named Data Lake Analytics account.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28366-102">DataLakeAnalyticsAccountBasic クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="28366-102">Initializes a new instance of the DataLakeAnalyticsAccountBasic class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="28366-103">リソースの場所</span><span class="sxs-lookup"><span data-stu-id="28366-103">Resource location</span></span></param>
        <param name="id"><span data-ttu-id="28366-104">リソース Id</span><span class="sxs-lookup"><span data-stu-id="28366-104">Resource Id</span></span></param>
        <param name="name"><span data-ttu-id="28366-105">リソース名</span><span class="sxs-lookup"><span data-stu-id="28366-105">Resource name</span></span></param>
        <param name="type"><span data-ttu-id="28366-106">リソースの種類</span><span class="sxs-lookup"><span data-stu-id="28366-106">Resource type</span></span></param>
        <param name="tags"><span data-ttu-id="28366-107">リソース タグ</span><span class="sxs-lookup"><span data-stu-id="28366-107">Resource tags</span></span></param>
        <param name="provisioningState"><span data-ttu-id="28366-108">Data Lake Analytics アカウントのプロビジョニング状態。</span><span class="sxs-lookup"><span data-stu-id="28366-108">the provisioning status of the Data Lake Analytics account.</span></span> <span data-ttu-id="28366-109">使用可能な値が含まれます: '失敗'、'作成中'、'実行'、'成功'、'パッチ'、'一時停止中'、'再開'、'削除'、'Deleted'</span><span class="sxs-lookup"><span data-stu-id="28366-109">Possible values include: 'Failed', 'Creating', 'Running', 'Succeeded', 'Patching', 'Suspending', 'Resuming', 'Deleting', 'Deleted'</span></span></param>
        <param name="state"><span data-ttu-id="28366-110">Data Lake Analytics アカウントの状態。</span><span class="sxs-lookup"><span data-stu-id="28366-110">the state of the Data Lake Analytics account.</span></span>
            <span data-ttu-id="28366-111">使用可能な値が含まれます: 'Active'、'中断'</span><span class="sxs-lookup"><span data-stu-id="28366-111">Possible values include: 'Active', 'Suspended'</span></span></param>
        <param name="creationTime"><span data-ttu-id="28366-112">アカウントの作成時。</span><span class="sxs-lookup"><span data-stu-id="28366-112">the account creation time.</span></span></param>
        <param name="lastModifiedTime"><span data-ttu-id="28366-113">アカウントには、最終更新時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="28366-113">the account last modified time.</span></span></param>
        <param name="endpoint"><span data-ttu-id="28366-114">このアカウントの完全な CName エンドポイント。</span><span class="sxs-lookup"><span data-stu-id="28366-114">the full CName endpoint for this account.</span></span></param>
        <param name="accountId"><span data-ttu-id="28366-115">この Data Lake Analytics アカウントに関連付けられている一意の識別子。</span><span class="sxs-lookup"><span data-stu-id="28366-115">The unique identifier associated with this Data Lake Analytics account.</span></span></param>
        <summary>
            <span data-ttu-id="28366-116">DataLakeAnalyticsAccountBasic クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="28366-116">Initializes a new instance of the DataLakeAnalyticsAccountBasic class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AccountId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28366-117">この Data Lake Analytics アカウントに関連付けられている一意の識別子を取得します。</span><span class="sxs-lookup"><span data-stu-id="28366-117">Gets the unique identifier associated with this Data Lake Analytics account.</span></span>
            </summary>
    ...
    <Member MemberName="CreationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28366-118">アカウントの作成時間を取得します。</span><span class="sxs-lookup"><span data-stu-id="28366-118">Gets the account creation time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Endpoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28366-119">このアカウントに、完全な CName エンドポイントを取得します。</span><span class="sxs-lookup"><span data-stu-id="28366-119">Gets the full CName endpoint for this account.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastModifiedTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28366-120">アカウントの最終更新時刻を取得します。</span><span class="sxs-lookup"><span data-stu-id="28366-120">Gets the account last modified time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28366-121">Data Lake Analytics アカウントのプロビジョニング状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="28366-121">Gets the provisioning status of the Data Lake Analytics account.</span></span>
            <span data-ttu-id="28366-122">使用可能な値が含まれます: '失敗'、'作成中'、'実行'、'成功'、'パッチ'、'一時停止中'、'再開'、'削除'、'Deleted'</span><span class="sxs-lookup"><span data-stu-id="28366-122">Possible values include: 'Failed', 'Creating', 'Running', 'Succeeded', 'Patching', 'Suspending', 'Resuming', 'Deleting', 'Deleted'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28366-123">Data Lake Analytics アカウントの状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="28366-123">Gets the state of the Data Lake Analytics account.</span></span> <span data-ttu-id="28366-124">使用可能な値が含まれます: 'Active'、'中断'</span><span class="sxs-lookup"><span data-stu-id="28366-124">Possible values include: 'Active', 'Suspended'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="28366-125">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="28366-125">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="28366-126">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="28366-126">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
