<Type Name="USqlTableStatistics" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.USqlTableStatistics">
  ...
  <Docs>
    <summary>
            Data Lake Analytics カタログ U-SQL テーブルの統計情報項目。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            USqlTableStatistics クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="name">テーブルの統計情報の名前。</param>
        <param name="userStatName">ユーザーの統計情報の名前。</param>
        <param name="statDataPath">統計情報データへのパス。</param>
        <param name="createTime">統計の作成時間。</param>
        <param name="updateTime">前回の統計が更新されました。</param>
        <param name="isUserCreated">これらの統計が作成したユーザーを示すスイッチです。</param>
        <param name="isAutoCreated">これらの統計情報が自動的に作成されたかどうかを示すスイッチです。</param>
        <param name="hasFilter">これらの統計がフィルターを持つかどうかを示すスイッチです。</param>
        <param name="filterDefinition">統計情報のフィルターの定義。</param>
        <param name="colNames">これらの統計情報に関連付けられている列名の一覧。</param>
        <summary>
            USqlTableStatistics クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ColNames">
      ...
      <Docs>
        <summary>
            取得またはこれらの統計情報に関連付けられている列名の一覧を設定します。
            </summary>
    ...
    <Member MemberName="HasFilter">
      ...
      <Docs>
        <summary>
            取得またはこれらの統計がフィルターを持つかどうかを示す、スイッチを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsAutoCreated">
      ...
      <Docs>
        <summary>
            取得またはこれらの統計情報が自動的に作成されたかどうかを示す、スイッチを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsUserCreated">
      ...
      <Docs>
        <summary>
            取得または作成したユーザーがこれらの統計情報を示す、スイッチを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
