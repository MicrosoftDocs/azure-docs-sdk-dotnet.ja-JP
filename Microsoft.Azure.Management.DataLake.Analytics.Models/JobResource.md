  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="resourcePath">リソースへのパス。</param>
        <param name="type">ジョブ リソースの種類。 使用可能な値が含まれます: 'VertexResource'、'JobManagerResource'、'StatisticsResource'、'VertexResourceInUserFolder'、'JobManagerResourceInUserFolder'、'StatisticsResourceInUserFolder'</param>
        <summary>
            JobResource クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            取得または、ジョブ リソースの種類を設定します。 使用可能な値が含まれます: 'VertexResource'、'JobManagerResource'、'StatisticsResource'、'VertexResourceInUserFolder'、'JobManagerResourceInUserFolder'、'StatisticsResourceInUserFolder'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
