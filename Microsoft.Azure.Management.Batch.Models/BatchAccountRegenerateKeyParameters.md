<Type Name="BatchAccountRegenerateKeyParameters" FullName="Microsoft.Azure.Management.Batch.Models.BatchAccountRegenerateKeyParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            BatchAccountRegenerateKeyParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="keyName">アカウント キーを再生成の型。
            使用可能な値が含まれます 'Primary'、'セカンダリ'。</param>
        <summary>
            BatchAccountRegenerateKeyParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="KeyName">
      ...
      <Docs>
        <summary>
            取得または設定を再生成するアカウント キーの型。 使用可能な値が含まれます 'Primary'、'セカンダリ'。
            </summary>
