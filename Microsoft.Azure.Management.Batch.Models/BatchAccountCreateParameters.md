<Type Name="BatchAccountCreateParameters" FullName="Microsoft.Azure.Management.Batch.Models.BatchAccountCreateParameters">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location">アカウントを作成するための領域。</param>
        <param name="tags">アカウントに関連付けられているユーザーが指定したタグ。</param>
        <param name="autoStorage">自動ストレージ アカウントに関連するプロパティです。</param>
    ...
    <Member MemberName="AutoStorage">
      ...
      <Docs>
        <summary>
            取得または自動ストレージ アカウントに関連するプロパティを設定します。
            </summary>
    ...
    <Member MemberName="KeyVaultReference">
      ...
      <Docs>
        <summary>
            取得または Batch アカウントに関連付けられている Azure key vault への参照を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PoolAllocationMode">
      ...
      <Docs>
        <summary>
            取得またはバッチ アカウントのプールを作成するために使用する割り当てモードを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>
            プール割り当てモードでは、バッチ サービス API にクライアントが認証方法も影響します。 モードが BatchService の場合は、クライアントがアクセス キーまたは Azure Active Directory を使用してを認証することがあります。 モードが UserSubscription の場合は、クライアントは、Azure Active Directory を使用する必要があります。
            既定値は、BatchService です。 使用可能な値が含まれます: 'BatchService'、'UserSubscription'
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            取得またはアカウントに関連付けられているユーザーが指定したタグを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
