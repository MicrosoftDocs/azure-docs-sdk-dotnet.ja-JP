<Type Name="KeyVaultReference" FullName="Microsoft.Azure.Management.Batch.Models.KeyVaultReference">
  ...
  <Docs>
    <summary>
            Batch アカウントに関連付けられている Azure key vault を識別します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">Azure key vault のリソース ID は、Batch アカウントに関連付けられています。</param>
        <param name="url">Batch アカウントに関連付けられている Azure key vault の URL です。</param>
        <summary>
            KeyVaultReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            取得または Batch アカウントに関連付けられている Azure key vault のリソース ID を設定します。
            </summary>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            取得または Batch アカウントに関連付けられている Azure key vault の URL を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
