<Type Name="BatchAccount" FullName="Microsoft.Azure.Management.Batch.Models.BatchAccount">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            BatchAccount クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="location">リソースの場所です。</param>
        <param name="tags">リソースのタグ。</param>
        <param name="accountEndpoint">アカウントのエンドポイントをバッチ サービスと対話するために使用します。</param>
        <param name="provisioningState">リソースのプロビジョニング状態。 使用可能な値が含まれます: '無効'、'作成中'、'削除'、'成功'、'失敗'、'キャンセル'</param>
        <param name="poolAllocationMode">Batch アカウントのプールを作成するために使用する割り当てモード。</param>
        <param name="keyVaultReference">Batch アカウントに関連付けられている Azure key vault への参照。</param>
        <param name="autoStorage">プロパティと、Batch アカウントに関連付けられているすべての自動ストレージ アカウントの状態。</param>
        <param name="dedicatedCoreQuota">この Batch アカウント専用のコア クォータ。</param>
        <param name="lowPriorityCoreQuota">この Batch アカウントの優先度の低いコア クォータ。</param>
        <param name="poolQuota">この Batch アカウントのプール クォータ。</param>
        <param name="activeJobAndJobScheduleQuota">アクティブなジョブとジョブ スケジュールのこの Batch アカウントのクォータ。</param>
        <summary>
            BatchAccount クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AccountEndpoint">
      ...
      <Docs>
        <summary>
            バッチ サービスと対話するために使用するアカウントのエンドポイントを取得します。
            </summary>
    ...
    <Member MemberName="ActiveJobAndJobScheduleQuota">
      ...
      <Docs>
        <summary>
            この Batch アカウントのアクティブなジョブとジョブ スケジュールのクォータを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AutoStorage">
      ...
      <Docs>
        <summary>
            Batch アカウントに関連付けられているすべての自動ストレージ アカウントの状態とプロパティを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DedicatedCoreQuota">
      ...
      <Docs>
        <summary>
            この Batch アカウントの専用のコア クォータを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="KeyVaultReference">
      ...
      <Docs>
        <summary>
            Batch アカウントに関連付けられている Azure key vault への参照を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LowPriorityCoreQuota">
      ...
      <Docs>
        <summary>
            この Batch アカウントの優先度の低いコア クォータを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PoolAllocationMode">
      ...
      <Docs>
        <summary>
            Batch アカウントのプールを作成するために使用する割り当てモードを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>
            使用可能な値が含まれます: 'BatchService'、'UserSubscription'
            </remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            リソースのプロビジョニング状態を取得します。 使用可能な値が含まれます: '無効'、'作成中'、'削除'、'成功'、'失敗'、'キャンセル'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
