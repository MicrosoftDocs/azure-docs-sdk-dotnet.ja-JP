<Type Name="ActivateApplicationPackageParameters" FullName="Microsoft.Azure.Management.Batch.Models.ActivateApplicationPackageParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ActivateApplicationPackageParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="format">アプリケーション パッケージのバイナリ ファイルの形式です。</param>
        <summary>
            ActivateApplicationPackageParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Format">
      ...
      <Docs>
        <summary>
            取得またはアプリケーション パッケージのバイナリ ファイルの形式を設定します。
            </summary>
