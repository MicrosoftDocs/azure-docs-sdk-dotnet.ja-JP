<Type Name="PartitionReceiver" FullName="Microsoft.Azure.EventHubs.PartitionReceiver">
  ...
  <Docs>
    <summary>
            これは、EventHub パーティションからの受信の論理表現です。
            <para>PartitionReceiver が、ConsumerGroup に関連付けられている + パーティションの組み合わせ。エポックを作成する場合はベース PartitionReceiver (つまり PartitionReceiver.Epoch! = 0) ConsumerGroup + パーティションあたり 1 つ以上のアクティブな受信機を持つことはできませんコンボです。ConsumerGroup あたり複数の受信者を持てる + エポック以外の受信側との組み合わせをパーティションします。</para></summary>
  ...
  <Members>
    ...
    <Member MemberName="CloseAsync">
      ...
      <Docs>
        <summary>
            閉じに関連付けられているリソースを解放<see cref="T:Microsoft.Azure.EventHubs.PartitionReceiver" />です。
            </summary>
    ...
    <Member MemberName="Epoch">
      ...
      <Docs>
        <summary>
            この受信者は現在使用しているパーティションの所有権をエポック値を取得します。
            <para>値が null の場合この受信者は、エポックに基づいたレシーバーではありません。</para></summary>
        <value>この受信者は現在使用しているパーティションの所有権をエポック値。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EventHubClient">
      ...
      <Docs>
        <summary>
            この PartitionReceiver EventHubClient が作成されました。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PartitionId">
      ...
      <Docs>
        ...
        <value>この受信者がデータをフェッチは、パーティションを表す識別子</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrefetchCount">
      ...
      <Docs>
        <summary>
            受信側で構成されているプリフェッチ数を取得します。
            </summary>
        <value>イベントの数の上限この受信者は受信操作が保留されているかどうかに関係なくアクティブに受信します。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReceiveAsync">
      ...
      <Docs>
        ...
        <summary>
            受信のバッチ<see cref="T:Microsoft.Azure.EventHubs.EventData" />'s、EventHub からパーティションに分割
            </summary>
        <returns>タスクのバッチを生成する<see cref="T:Microsoft.Azure.EventHubs.EventData" />この受信者を作成するパーティションから。 EventData が存在しない場合、' null' を返します。</returns>
        <remarks>To be added.</remarks>
        <example>
            サンプル コード: 
            <code>
    ...
    <Member MemberName="ReceiveAsync">
      ...
      <Docs>
        ...
        <summary>
            受信のバッチ<see cref="T:Microsoft.Azure.EventHubs.EventData" />'s ごとに、待機時間を許可することで、EventHub パーティションから呼び出します。
            </summary>
        <returns>タスクのバッチを生成する<see cref="T:Microsoft.Azure.EventHubs.EventData" />この受信者を作成するパーティションから。 EventData が存在しない場合、' null' を返します。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RuntimeInfo">
      ...
      <Docs>
        <summary>
            ...
            設定を有効にするを参照してください<see cref="T:Microsoft.Azure.EventHubs.ReceiverOptions" />と<see cref="P:Microsoft.Azure.EventHubs.EventHubClient.EnableReceiverRuntimeMetric" /></summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="SetReceiveHandler">
      ...
      <Docs>
        <param name="receiveHandler"><see cref="T:Microsoft.Azure.EventHubs.IPartitionReceiveHandler" />イベントを処理するために使用します。</param>
        <summary>
            セット、<see cref="T:Microsoft.Azure.EventHubs.IPartitionReceiveHandler" />イベントを処理します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="StartOfStream">
      ...
      <Docs>
        <summary>
            これは、EventHub のパーティションのストリームの開始を表すために定義された定数です。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
