<Type Name="AsyncLock" FullName="Microsoft.Azure.EventHubs.AsyncLock">
  ...
  <Docs>
    <summary>
            Event Hubs の内部処理の非同期セマフォとして使用します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Dispose">
      ...
      <Docs>
        <summary>
            終了し、AsyncLock に関連付けられているすべてのリソースを解放します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="LockAsync">
      ...
      <Docs>
        <param name="cancellationToken"><see cref="T:System.Threading.CancellationToken" />ロック [キャンセル] を使用できます。</param>
        <summary>
            キャンセルできるロックの設定を使用して、<see cref="T:System.Threading.CancellationToken" />です。
            </summary>
        <returns>非同期操作</returns>
        <remarks>To be added.</remarks>
      </Docs>
