<Type Name="AzureActiveDirectoryTokenProvider" FullName="Microsoft.Azure.EventHubs.AzureActiveDirectoryTokenProvider">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5ff7f-101">Event Hubs の Azure Active Directory のトークン プロバイダーを表します。</span><span class="sxs-lookup"><span data-stu-id="5ff7f-101">Represents the Azure Active Directory token provider for the Event Hubs.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="GetTokenAsync">
      ...
      <Docs>
        <param name="appliesTo"><span data-ttu-id="5ff7f-102">アクセス トークンが適用される URI</span><span class="sxs-lookup"><span data-stu-id="5ff7f-102">The URI which the access token applies to</span></span></param>
        <param name="timeout"><span data-ttu-id="5ff7f-103">セキュリティ トークンを取得するメッセージのタイムアウト値を指定する時間間隔</span><span class="sxs-lookup"><span data-stu-id="5ff7f-103">The time span that specifies the timeout value for the message that gets the security token</span></span></param>
        <summary>
            <span data-ttu-id="5ff7f-104">取得、<see cref="T:Microsoft.Azure.EventHubs.SecurityToken" />指定された対象ユーザーと期間。</span><span class="sxs-lookup"><span data-stu-id="5ff7f-104">Gets a <see cref="T:Microsoft.Azure.EventHubs.SecurityToken" /> for the given audience and duration.</span></span>
            </summary>
        <returns>
