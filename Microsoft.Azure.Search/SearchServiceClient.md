<Type Name="SearchServiceClient" FullName="Microsoft.Azure.Search.SearchServiceClient">
  ...
  <Docs>
    <summary>
            管理し、インデックス、およびドキュメントのクエリを実行するだけでなく Azure Search サービスで他のリソースを管理するために使用するクライアント。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            SearchServiceClient クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
