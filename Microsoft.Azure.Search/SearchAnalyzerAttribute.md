<Type Name="SearchAnalyzerAttribute" FullName="Microsoft.Azure.Search.SearchAnalyzerAttribute">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="02c31-101">示します、<see cref="T:Microsoft.Azure.Search.Models.Field" />によって生成された<see cref="T:Microsoft.Azure.Search.FieldBuilder" />ターゲットのプロパティが含まれて、<see cref="P:Microsoft.Azure.Search.Models.Field.SearchAnalyzer" />プロパティを指定されたアナライザーに設定します。</span><span class="sxs-lookup"><span data-stu-id="02c31-101">Indicates that the <see cref="T:Microsoft.Azure.Search.Models.Field" /> generated by <see cref="T:Microsoft.Azure.Search.FieldBuilder" /> for the target property should have its <see cref="P:Microsoft.Azure.Search.Models.Field.SearchAnalyzer" /> property set to the specified analyzer.</span></span>
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="analyzerName">
            <span data-ttu-id="02c31-102">アナライザーの名前です。</span><span class="sxs-lookup"><span data-stu-id="02c31-102">The name of the analyzer.</span></span> <span data-ttu-id="02c31-103">内の名前のいずれかを使用して<see cref="T:Microsoft.Azure.Search.Models.AnalyzerName.AsString" />またはカスタム アナライザーの名前。</span><span class="sxs-lookup"><span data-stu-id="02c31-103">Use one of the names in <see cref="T:Microsoft.Azure.Search.Models.AnalyzerName.AsString" /> or the name of a custom analyzer.</span></span>
            </param>
        <summary>
            <span data-ttu-id="02c31-104">指定されたアナライザーを使用することを示します。</span><span class="sxs-lookup"><span data-stu-id="02c31-104">Indicates that the specified analyzer should be used.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
