<Type Name="SearchIndexClient" FullName="Microsoft.Azure.Search.SearchIndexClient">
  ...
  <Docs>
    <summary>
            Azure Search インデックスとアップロード、クエリに使用できるクライアントは、merge、またはドキュメントを削除します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="searchServiceName">必須。 Azure Search サービスの名前。</param>
        <param name="indexName">必須。 Azure Search インデックスの名前。</param>
        <param name="credentials">必須。 Azure Search サービスへの認証に使用される資格情報。
    ...
    <Member MemberName="SearchDnsSuffix">
      ...
      <Docs>
        <summary>
            Azure Search サービスの DNS サフィックス。 既定値は、&lt;name&gt;.search.windows.net です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
