<Type Name="Operation" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.Operation">
  ...
  <Docs>
    <summary>
            Stream Analytics の REST API 操作
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">この特定のオブジェクトで実行されている操作の名前。</param>
        <param name="display">この特定の操作のローカライズされた表示情報が含まれています/アクション。</param>
        <summary>
            Operation クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            取得には、この特定の操作のローカライズされた表示情報が含まれています。/アクション。
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            この特定のオブジェクトで実行されている操作の名前を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
