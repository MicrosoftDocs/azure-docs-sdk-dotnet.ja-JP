<Type Name="ResourceTestStatus" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.ResourceTestStatus">
  ...
  <Docs>
    <summary>
            該当する場合は、エラー情報と共にテスト操作の状態を説明します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ResourceTestStatus クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="status">テスト操作の状態。</param>
        <param name="error">発生したエラーをについて説明します。</param>
        <summary>
            ResourceTestStatus クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
