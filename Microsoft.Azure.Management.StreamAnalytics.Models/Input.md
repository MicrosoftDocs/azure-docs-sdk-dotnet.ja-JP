<Type Name="Input" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.Input">
  ...
  <Docs>
    <summary>
            名前付きの入力に関連付けられているすべての情報を含む入力オブジェクトです。 ストリーミング ジョブの下では、すべての入力が含まれています。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="properties">入力に関連付けられているプロパティです。 PUT (CreateOrReplace) 要求に必要です。</param>
        <summary>
            入力クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
