<Type Name="OperationDisplay" FullName="Microsoft.Azure.Management.StreamAnalytics.Models.OperationDisplay">
  ...
  <Docs>
    <summary>
            この特定の操作のローカライズされた表示情報が含まれています/アクション。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provider">リソース プロバイダーの名前のローカライズされた表示形式。</param>
        <param name="resource">このアクション/操作に関連するリソースの種類のローカライズされたわかりやすい形式です。</param>
        <param name="operation">操作のローカライズされた表示名。</param>
        <param name="description">操作のローカライズされたわかりやすい説明。</param>
        <summary>
            OperationDisplay クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Provider">
      ...
      <Docs>
        <summary>
            リソース プロバイダーの名前のローカライズされた表示形式を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Resource">
      ...
      <Docs>
        <summary>
            このアクション/操作に関連するリソースの種類のローカライズされた表示形式を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
