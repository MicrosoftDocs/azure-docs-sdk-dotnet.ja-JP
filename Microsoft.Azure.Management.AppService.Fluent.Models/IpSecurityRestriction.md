<Type Name="IpSecurityRestriction" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.IpSecurityRestriction">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            IpSecurityRestriction クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="ipAddress">セキュリティの制限の IP アドレスは有効です。</param>
        <param name="subnetMask">サブネット マスク、範囲の IP アドレス制限は無効です。</param>
        <summary>
            IpSecurityRestriction クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="IpAddress">
      ...
      <Docs>
        <summary>
            取得または IP アドレスに対して有効では、セキュリティ制限を設定します。
            </summary>
    ...
    <Member MemberName="SubnetMask">
      ...
      <Docs>
        <summary>
            取得または制限は有効範囲の IP アドレスのサブネット マスクを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
