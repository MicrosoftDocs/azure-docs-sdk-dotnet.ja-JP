<Type Name="StatusCodesBasedTrigger" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.StatusCodesBasedTrigger">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            StatusCodesBasedTrigger クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="status">HTTP 状態コード。</param>
        <param name="subStatus">副状態です。</param>
        <param name="win32Status">Win32 エラー コード。</param>
