<Type Name="TldLegalAgreement" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.TldLegalAgreement">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            TldLegalAgreement クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="agreementKey">アグリーメントの一意の識別子。</param>
        <param name="title">アグリーメントのタイトルです。</param>
        <param name="content">契約の詳細。</param>
        <param name="url">契約の詳細のコピーがホストされている URL です。</param>
        <summary>
            TldLegalAgreement クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            取得または契約の詳細のコピーがホストされている URL を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
