<Type Name="RestoreResponseInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.RestoreResponseInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4e954-101">アプリの復元要求の応答。</span><span class="sxs-lookup"><span data-stu-id="4e954-101">Response for an app restore request.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4e954-102">RestoreResponseInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="4e954-102">Initializes a new instance of the RestoreResponseInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="OperationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4e954-103">サーバー復元プロセスの開始時に取得して、その特定の復元操作を識別する操作 ID を返します。</span><span class="sxs-lookup"><span data-stu-id="4e954-103">Gets when server starts the restore process, it will return an operation ID identifying that particular restore operation.</span></span>
            </summary>
