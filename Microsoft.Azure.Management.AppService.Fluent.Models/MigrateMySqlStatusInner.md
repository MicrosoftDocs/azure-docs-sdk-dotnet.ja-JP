<Type Name="MigrateMySqlStatusInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.MigrateMySqlStatusInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a151e-101">MySQL の移行の状態です。</span><span class="sxs-lookup"><span data-stu-id="a151e-101">MySQL migration status.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a151e-102">MigrateMySqlStatusInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="a151e-102">Initializes a new instance of the MigrateMySqlStatusInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="LocalMySqlEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a151e-103">MySql が有効になっているアプリに web アプリがある場合は true します。</span><span class="sxs-lookup"><span data-stu-id="a151e-103">Gets true if the web app has in app MySql enabled</span></span>
            </summary>
    ...
    <Member MemberName="MigrationOperationStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a151e-104">移行タスクの状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="a151e-104">Gets status of the migration task.</span></span> <span data-ttu-id="a151e-105">使用可能な値が含まれます: '処理中'、'失敗'、'成功'、'TimedOut'、'作成済み</span><span class="sxs-lookup"><span data-stu-id="a151e-105">Possible values include: 'InProgress', 'Failed', 'Succeeded', 'TimedOut', 'Created'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a151e-106">移行タスクの操作 ID を取得します。</span><span class="sxs-lookup"><span data-stu-id="a151e-106">Gets operation ID for the migration task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
