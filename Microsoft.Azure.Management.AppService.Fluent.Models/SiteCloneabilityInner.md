<Type Name="SiteCloneabilityInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.SiteCloneabilityInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SiteCloneabilityInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="result">アプリの名前です。 使用可能な値が含まれます: '複製可能な'、'PartiallyCloneable'、'NotCloneable'</param>
        <param name="blockingFeatures">複製を禁止するアプリで有効になっている機能の一覧です。</param>
        <param name="unsupportedFeatures">ある非ブロッキングしますですが、複製できません。 アプリで有効になっている機能の一覧です。 クローンとして作成されたアプリ上に、この一覧にある機能に設定できませんが、アプリを複製まだことができます。</param>
        <param name="blockingCharacteristics">アプリケーションの特性をブロックの一覧です。</param>
        <summary>
            SiteCloneabilityInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="BlockingCharacteristics">
      ...
      <Docs>
        <summary>
            取得またはアプリケーションの特性をブロックの一覧を設定します。
            </summary>
    ...
    <Member MemberName="BlockingFeatures">
      ...
      <Docs>
        <summary>
            取得または複製を禁止するアプリで有効になっている機能の一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Result">
      ...
      <Docs>
        <summary>
            取得またはアプリの名前を設定します。 使用可能な値が含まれます: '複製可能な'、'PartiallyCloneable'、'NotCloneable'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UnsupportedFeatures">
      ...
      <Docs>
        <summary>
            取得またはアプリで有効にされている非ブロッキングしますですが、複製できません。 機能の一覧を設定します。 クローンとして作成されたアプリ上に、この一覧にある機能に設定できませんが、アプリを複製まだことができます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
