<Type Name="NetworkAccessControlEntry" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.NetworkAccessControlEntry">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="action">アクション オブジェクトです。 使用可能な値が含まれます: '許可'、'拒否'</param>
        <param name="description">説明。</param>
        <param name="order">優先順位の順序です。</param>
        <param name="remoteSubnet">リモート サブネットです。</param>
        <summary>
            NetworkAccessControlEntry クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Action">
      ...
      <Docs>
        <summary>
            取得またはアクション オブジェクトを設定します。 使用可能な値が含まれます: '許可'、'拒否'
            </summary>
