<Type Name="HostingEnvironmentDiagnosticsInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.HostingEnvironmentDiagnosticsInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            HostingEnvironmentDiagnosticsInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">診断の名前または識別子です。</param>
        <param name="diagnosicsOutput">出力を診断します。</param>
        <summary>
            HostingEnvironmentDiagnosticsInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
