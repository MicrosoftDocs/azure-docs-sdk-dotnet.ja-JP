<Type Name="SiteConfig" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.SiteConfig">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="560d3-101">App Service アプリの構成。</span><span class="sxs-lookup"><span data-stu-id="560d3-101">Configuration of an App Service app.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-102">SiteConfig クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="560d3-102">Initializes a new instance of the SiteConfig class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="numberOfWorkers"><span data-ttu-id="560d3-103">ワーカーの数。</span><span class="sxs-lookup"><span data-stu-id="560d3-103">Number of workers.</span></span></param>
        <param name="defaultDocuments"><span data-ttu-id="560d3-104">既定のドキュメントです。</span><span class="sxs-lookup"><span data-stu-id="560d3-104">Default documents.</span></span></param>
        <param name="netFrameworkVersion"><span data-ttu-id="560d3-105">.NET framework のバージョン。</span><span class="sxs-lookup"><span data-stu-id="560d3-105">.NET Framework version.</span></span></param>
        <param name="phpVersion"><span data-ttu-id="560d3-106">PHP のバージョンです。</span><span class="sxs-lookup"><span data-stu-id="560d3-106">Version of PHP.</span></span></param>
        <param name="pythonVersion"><span data-ttu-id="560d3-107">Python のバージョンです。</span><span class="sxs-lookup"><span data-stu-id="560d3-107">Version of Python.</span></span></param>
        <param name="nodeVersion"><span data-ttu-id="560d3-108">Node.js のバージョンです。</span><span class="sxs-lookup"><span data-stu-id="560d3-108">Version of Node.js.</span></span></param>
        <param name="linuxFxVersion"><span data-ttu-id="560d3-109">Linux アプリケーションのフレームワークとバージョン</span><span class="sxs-lookup"><span data-stu-id="560d3-109">Linux App Framework and version</span></span></param>
        <param name="requestTracingEnabled"><span data-ttu-id="560d3-110">&lt;コード&gt;true&lt;/code&gt;要求のトレースが有効になっている、それ以外の場合は&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="560d3-110">&lt;code&gt;true&lt;/code&gt; if request tracing is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="requestTracingExpirationTime"><span data-ttu-id="560d3-111">トレースの有効期限を要求します。</span><span class="sxs-lookup"><span data-stu-id="560d3-111">Request tracing expiration time.</span></span></param>
        <param name="remoteDebuggingEnabled"><span data-ttu-id="560d3-112">&lt;コード&gt;true&lt;/code&gt;場合は有効である、それ以外の場合は、リモート デバッグ&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="560d3-112">&lt;code&gt;true&lt;/code&gt; if remote debugging is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="remoteDebuggingVersion"><span data-ttu-id="560d3-113">リモート デバッグ バージョンです。</span><span class="sxs-lookup"><span data-stu-id="560d3-113">Remote debugging version.</span></span></param>
        <param name="httpLoggingEnabled"><span data-ttu-id="560d3-114">&lt;コード&gt;true&lt;/code&gt; HTTP ログ記録が有効になっている、それ以外の場合は&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="560d3-114">&lt;code&gt;true&lt;/code&gt; if HTTP logging is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="logsDirectorySizeLimit"><span data-ttu-id="560d3-115">HTTP では、ディレクトリ サイズの上限を記録します。</span><span class="sxs-lookup"><span data-stu-id="560d3-115">HTTP logs directory size limit.</span></span></param>
        <param name="detailedErrorLoggingEnabled"><span data-ttu-id="560d3-116">&lt;コード&gt;true&lt;/code&gt;詳細なエラーのログ記録が有効になっている、それ以外の場合は&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="560d3-116">&lt;code&gt;true&lt;/code&gt; if detailed error logging is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="publishingUsername"><span data-ttu-id="560d3-117">発行ユーザー名。</span><span class="sxs-lookup"><span data-stu-id="560d3-117">Publishing user name.</span></span></param>
        <param name="appSettings"><span data-ttu-id="560d3-118">アプリケーション設定。</span><span class="sxs-lookup"><span data-stu-id="560d3-118">Application settings.</span></span></param>
        <param name="connectionStrings"><span data-ttu-id="560d3-119">接続文字列です。</span><span class="sxs-lookup"><span data-stu-id="560d3-119">Connection strings.</span></span></param>
        <param name="machineKey"><span data-ttu-id="560d3-120">サイト MachineKey です。</span><span class="sxs-lookup"><span data-stu-id="560d3-120">Site MachineKey.</span></span></param>
        <param name="handlerMappings"><span data-ttu-id="560d3-121">ハンドラー マッピングします。</span><span class="sxs-lookup"><span data-stu-id="560d3-121">Handler mappings.</span></span></param>
        <param name="documentRoot"><span data-ttu-id="560d3-122">ドキュメントのルートです。</span><span class="sxs-lookup"><span data-stu-id="560d3-122">Document root.</span></span></param>
        <param name="scmType"><span data-ttu-id="560d3-123">SCM 型です。</span><span class="sxs-lookup"><span data-stu-id="560d3-123">SCM type.</span></span> <span data-ttu-id="560d3-124">使用可能な値が含まれます 'None'、'Dropbox'、'Tfs'、'LocalGit'、'GitHub'、'CodePlexGit'、'CodePlexHg'、'BitbucketGit'、'BitbucketHg'、'ExternalGit'、'ExternalHg'、'OneDrive'、'VSO'。</span><span class="sxs-lookup"><span data-stu-id="560d3-124">Possible values include: 'None', 'Dropbox', 'Tfs', 'LocalGit', 'GitHub', 'CodePlexGit', 'CodePlexHg', 'BitbucketGit', 'BitbucketHg', 'ExternalGit', 'ExternalHg', 'OneDrive', 'VSO'</span></span></param>
        <param name="use32BitWorkerProcess"><span data-ttu-id="560d3-125">&lt;コード&gt;true&lt;/code&gt; ; 32 ビット ワーカー プロセスを使用してそれ以外の場合、&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="560d3-125">&lt;code&gt;true&lt;/code&gt; to use 32-bit worker process; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="webSocketsEnabled"><span data-ttu-id="560d3-126">&lt;コード&gt;true&lt;/code&gt; WebSocket が有効になっている、それ以外の場合は&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="560d3-126">&lt;code&gt;true&lt;/code&gt; if WebSocket is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="alwaysOn"><span data-ttu-id="560d3-127">&lt;コード&gt;true&lt;/code&gt; Always On が有効になっている、それ以外の場合は&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="560d3-127">&lt;code&gt;true&lt;/code&gt; if Always On is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="javaVersion"><span data-ttu-id="560d3-128">Java バージョンです。</span><span class="sxs-lookup"><span data-stu-id="560d3-128">Java version.</span></span></param>
        <param name="javaContainer"><span data-ttu-id="560d3-129">Java コンテナーです。</span><span class="sxs-lookup"><span data-stu-id="560d3-129">Java container.</span></span></param>
        <param name="javaContainerVersion"><span data-ttu-id="560d3-130">コンテナーの Java バージョン。</span><span class="sxs-lookup"><span data-stu-id="560d3-130">Java container version.</span></span></param>
        <param name="appCommandLine"><span data-ttu-id="560d3-131">アプリのコマンド ラインを起動します。</span><span class="sxs-lookup"><span data-stu-id="560d3-131">App command line to launch.</span></span></param>
        <param name="managedPipelineMode"><span data-ttu-id="560d3-132">マネージ パイプライン モードです。</span><span class="sxs-lookup"><span data-stu-id="560d3-132">Managed pipeline mode.</span></span> <span data-ttu-id="560d3-133">使用可能な値が含まれます: '統合'、'Classic'</span><span class="sxs-lookup"><span data-stu-id="560d3-133">Possible values include: 'Integrated', 'Classic'</span></span></param>
        <param name="virtualApplications"><span data-ttu-id="560d3-134">仮想アプリケーション。</span><span class="sxs-lookup"><span data-stu-id="560d3-134">Virtual applications.</span></span></param>
        <param name="loadBalancing"><span data-ttu-id="560d3-135">サイトの負荷を分散します。</span><span class="sxs-lookup"><span data-stu-id="560d3-135">Site load balancing.</span></span> <span data-ttu-id="560d3-136">使用可能な値が含まれます: 'WeightedRoundRobin'、'LeastRequests'、'LeastResponseTime'、'WeightedTotalTraffic'、'RequestHash'</span><span class="sxs-lookup"><span data-stu-id="560d3-136">Possible values include: 'WeightedRoundRobin', 'LeastRequests', 'LeastResponseTime', 'WeightedTotalTraffic', 'RequestHash'</span></span></param>
        <param name="experiments"><span data-ttu-id="560d3-137">これは、polymophic 型の回避です。</span><span class="sxs-lookup"><span data-stu-id="560d3-137">This is work around for polymophic types.</span></span></param>
        <param name="limits"><span data-ttu-id="560d3-138">サイトの制限。</span><span class="sxs-lookup"><span data-stu-id="560d3-138">Site limits.</span></span></param>
        <param name="autoHealEnabled"><span data-ttu-id="560d3-139">&lt;コード&gt;true&lt;/code&gt;場合は自動修復が有効である、それ以外の場合、&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="560d3-139">&lt;code&gt;true&lt;/code&gt; if Auto Heal is enabled; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="autoHealRules"><span data-ttu-id="560d3-140">自動 Heal ルール。</span><span class="sxs-lookup"><span data-stu-id="560d3-140">Auto Heal rules.</span></span></param>
        <param name="tracingOptions"><span data-ttu-id="560d3-141">トレース オプション。</span><span class="sxs-lookup"><span data-stu-id="560d3-141">Tracing options.</span></span></param>
        <param name="vnetName"><span data-ttu-id="560d3-142">仮想ネットワーク名です。</span><span class="sxs-lookup"><span data-stu-id="560d3-142">Virtual Network name.</span></span></param>
        <param name="cors"><span data-ttu-id="560d3-143">クロス オリジン リソース共有 (CORS) の設定です。</span><span class="sxs-lookup"><span data-stu-id="560d3-143">Cross-Origin Resource Sharing (CORS) settings.</span></span></param>
        <param name="push"><span data-ttu-id="560d3-144">エンドポイントの設定をプッシュします。</span><span class="sxs-lookup"><span data-stu-id="560d3-144">Push endpoint settings.</span></span></param>
        <param name="apiDefinition"><span data-ttu-id="560d3-145">アプリの正式な API 定義に関する情報です。</span><span class="sxs-lookup"><span data-stu-id="560d3-145">Information about the formal API definition for the app.</span></span></param>
        <param name="autoSwapSlotName"><span data-ttu-id="560d3-146">自動スワップ スロットの名前です。</span><span class="sxs-lookup"><span data-stu-id="560d3-146">Auto-swap slot name.</span></span></param>
        <param name="localMySqlEnabled"><span data-ttu-id="560d3-147">&lt;コード&gt;true&lt;/code&gt;ローカル MySQL; を有効にするそれ以外の場合、&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="560d3-147">&lt;code&gt;true&lt;/code&gt; to enable local MySQL; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="ipSecurityRestrictions"><span data-ttu-id="560d3-148">IP セキュリティ制限します。</span><span class="sxs-lookup"><span data-stu-id="560d3-148">IP security restrictions.</span></span></param>
        <summary>
            <span data-ttu-id="560d3-149">SiteConfig クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="560d3-149">Initializes a new instance of the SiteConfig class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AlwaysOn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-150">取得または設定&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; Always On が有効になっている、それ以外の場合は&amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="560d3-150">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if Always On is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
    ...
    <Member MemberName="ApiDefinition">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-151">取得またはアプリの正式な API 定義に関する情報を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-151">Gets or sets information about the formal API definition for the app.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AppCommandLine">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-152">取得またはアプリを起動するコマンドラインを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-152">Gets or sets app command line to launch.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AppSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-153">取得またはアプリケーションの設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-153">Gets or sets application settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AutoHealEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-154">取得または設定&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; 場合は自動修復が有効である、それ以外の場合、 &amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="560d3-154">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if Auto Heal is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AutoHealRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-155">取得または自動 Heal ルールを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-155">Gets or sets auto Heal rules.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AutoSwapSlotName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-156">取得または自動スワップ スロット名を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-156">Gets or sets auto-swap slot name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ConnectionStrings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-157">取得または接続文字列を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-157">Gets or sets connection strings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Cors">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-158">取得またはクロス オリジン リソース共有 (CORS) の設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-158">Gets or sets cross-Origin Resource Sharing (CORS) settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DefaultDocuments">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-159">取得または既定のドキュメントを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-159">Gets or sets default documents.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DetailedErrorLoggingEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-160">取得または設定&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; 詳細なエラーのログ記録が有効になっている、それ以外の場合は&amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="560d3-160">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if detailed error logging is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DocumentRoot">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-161">取得またはドキュメントのルートを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-161">Gets or sets document root.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Experiments">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-162">取得または設定 polymophic 型の回避です。</span><span class="sxs-lookup"><span data-stu-id="560d3-162">Gets or sets this is work around for polymophic types.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HandlerMappings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-163">取得またはハンドラー マッピングを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-163">Gets or sets handler mappings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HttpLoggingEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-164">取得または設定&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; HTTP ログ記録が有効になっている、それ以外の場合は&amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="560d3-164">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if HTTP logging is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IpSecurityRestrictions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-165">取得または IP セキュリティ制限を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-165">Gets or sets IP security restrictions.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="JavaContainer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-166">取得または java コンテナーを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-166">Gets or sets java container.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="JavaContainerVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-167">取得またはコンテナーの java バージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-167">Gets or sets java container version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="JavaVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-168">取得または java バージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-168">Gets or sets java version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Limits">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-169">取得またはサイトの制限を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-169">Gets or sets site limits.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LinuxFxVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-170">取得または設定の linux アプリケーション フレームワークとバージョン</span><span class="sxs-lookup"><span data-stu-id="560d3-170">Gets or sets linux App Framework and version</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LoadBalancing">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-171">取得またはサイトの負荷分散を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-171">Gets or sets site load balancing.</span></span> <span data-ttu-id="560d3-172">使用可能な値が含まれます: 'WeightedRoundRobin'、'LeastRequests'、'LeastResponseTime'、'WeightedTotalTraffic'、'RequestHash'</span><span class="sxs-lookup"><span data-stu-id="560d3-172">Possible values include: 'WeightedRoundRobin', 'LeastRequests', 'LeastResponseTime', 'WeightedTotalTraffic', 'RequestHash'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LocalMySqlEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-173">取得または設定&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; ローカル MySQL; を有効にするそれ以外の場合、 &amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="560d3-173">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; to enable local MySQL; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LogsDirectorySizeLimit">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-174">取得または HTTP ログ ディレクトリのサイズ制限を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-174">Gets or sets HTTP logs directory size limit.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MachineKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-175">サイトの MachineKey を取得します。</span><span class="sxs-lookup"><span data-stu-id="560d3-175">Gets site MachineKey.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ManagedPipelineMode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-176">取得またはマネージ パイプライン モードを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-176">Gets or sets managed pipeline mode.</span></span> <span data-ttu-id="560d3-177">使用可能な値が含まれます: '統合'、'Classic'</span><span class="sxs-lookup"><span data-stu-id="560d3-177">Possible values include: 'Integrated', 'Classic'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetFrameworkVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-178">取得または .NET Framework のバージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-178">Gets or sets .NET Framework version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NodeVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-179">取得または Node.js のバージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-179">Gets or sets version of Node.js.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NumberOfWorkers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-180">取得またはワーカーの数を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-180">Gets or sets number of workers.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PhpVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-181">取得または PHP のバージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-181">Gets or sets version of PHP.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublishingUsername">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-182">取得または発行ユーザー名を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-182">Gets or sets publishing user name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Push">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-183">取得またはプッシュ エンドポイントの設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-183">Gets or sets push endpoint settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PythonVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-184">取得または Python のバージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-184">Gets or sets version of Python.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RemoteDebuggingEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-185">取得または設定&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; リモート デバッグが有効である、それ以外の場合、場合&amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="560d3-185">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if remote debugging is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RemoteDebuggingVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-186">取得またはリモートのデバッグ バージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-186">Gets or sets remote debugging version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestTracingEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-187">取得または設定&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; 要求のトレースが有効になっている、それ以外の場合は&amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="560d3-187">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if request tracing is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestTracingExpirationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-188">取得または要求のトレースの有効期限を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-188">Gets or sets request tracing expiration time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ScmType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-189">取得または SCM 型を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-189">Gets or sets SCM type.</span></span> <span data-ttu-id="560d3-190">使用可能な値が含まれます 'None'、'Dropbox'、'Tfs'、'LocalGit'、'GitHub'、'CodePlexGit'、'CodePlexHg'、'BitbucketGit'、'BitbucketHg'、'ExternalGit'、'ExternalHg'、'OneDrive'、'VSO'。</span><span class="sxs-lookup"><span data-stu-id="560d3-190">Possible values include: 'None', 'Dropbox', 'Tfs', 'LocalGit', 'GitHub', 'CodePlexGit', 'CodePlexHg', 'BitbucketGit', 'BitbucketHg', 'ExternalGit', 'ExternalHg', 'OneDrive', 'VSO'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TracingOptions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-191">取得またはトレース オプションを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-191">Gets or sets tracing options.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Use32BitWorkerProcess">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-192">取得または設定&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; 32 ビット ワーカー プロセスを使用してそれ以外の場合、 &amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="560d3-192">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; to use 32-bit worker process; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-193">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="560d3-193">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="560d3-194">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="560d3-194">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName="VirtualApplications">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-195">取得または、仮想アプリケーションを設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-195">Gets or sets virtual applications.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VnetName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-196">取得または仮想ネットワーク名を設定します。</span><span class="sxs-lookup"><span data-stu-id="560d3-196">Gets or sets virtual Network name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WebSocketsEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="560d3-197">取得または設定&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; WebSocket が有効になっている、それ以外の場合は&amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="560d3-197">Gets or sets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if WebSocket is enabled; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
