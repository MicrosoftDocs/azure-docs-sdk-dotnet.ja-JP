<Type Name="LegacyObjectsSupported" FullName="Microsoft.WindowsAzure.Management.StorSimple.Customization.Models.LegacyObjectsSupported">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="37bb8-101">パーサーでサポートされているレガシ オブジェクト</span><span class="sxs-lookup"><span data-stu-id="37bb8-101">Legacy objects supported by parser</span></span>
            </summary>
