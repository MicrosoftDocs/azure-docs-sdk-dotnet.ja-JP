<Type Name="IWithNumberOfProbes" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerHttpProbe.Update.IWithNumberOfProbes">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d68af-101">ステージ、HTTP プローブ更新できるようにするというエラーを確認する前に、失敗のプローブの数を変更します。</span><span class="sxs-lookup"><span data-stu-id="d68af-101">The stage of the HTTP probe update allowing to modify the number of unsuccessful probes before failure is determined.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithNumberOfProbes">
      ...
      <Docs>
        <param name="probes"><span data-ttu-id="d68af-102">プローブの数。</span><span class="sxs-lookup"><span data-stu-id="d68af-102">Number of probes.</span></span></param>
        <summary>
            <span data-ttu-id="d68af-103">エラーを確認する前に、失敗したプローブの数を指定します。</span><span class="sxs-lookup"><span data-stu-id="d68af-103">Specifies the number of unsuccessful probes before failure is determined.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="d68af-104">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="d68af-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>