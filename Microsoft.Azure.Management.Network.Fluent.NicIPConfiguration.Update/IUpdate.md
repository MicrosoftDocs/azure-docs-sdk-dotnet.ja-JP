<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.NicIPConfiguration.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4201a-101">ネットワーク インターフェイスの更新の一部としてネットワーク インターフェイス IP 構成の更新の全体です。</span><span class="sxs-lookup"><span data-stu-id="4201a-101">The entirety of a network interface IP configuration update as part of a network interface update.</span></span>
            </summary>
