<Type Name="IWithPublicIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.NicIPConfiguration.Update.IWithPublicIPAddress">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a4e60-101">ネットワーク インターフェイス IP 構成の更新を許可するパブリック IP アドレスを指定の段階です。</span><span class="sxs-lookup"><span data-stu-id="a4e60-101">The stage of the network interface IP configuration update allowing to specify public IP address.</span></span>
            </summary>
