<Type Name="IAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.ChildResourceActions.IAttachable&lt;ParentT&gt;">
  ...
  <Members>
    <Member MemberName="Attach">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7f309-101">この子オブジェクトの定義をその親の定義にアタッチします。</span><span class="sxs-lookup"><span data-stu-id="7f309-101">Attaches this child object's definition to its parent's definition.</span></span>
            </summary>
        <returns><span data-ttu-id="7f309-102">親オブジェクトの定義の次のステージ</span><span class="sxs-lookup"><span data-stu-id="7f309-102">the next stage of the parent object's definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
