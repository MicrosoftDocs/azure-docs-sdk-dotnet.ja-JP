<Type Name="OperationsExtensions" FullName="Microsoft.Azure.Management.Consumption.OperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5f2ec-101">操作の拡張メソッド。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-101">Extension methods for Operations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="List">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="5f2ec-102">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-102">The operations group for this extension method.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5f2ec-103">すべての利用可能な消費 REST API 操作の一覧を表示します。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-103">Lists all of the available consumption REST API operations.</span></span>
            </summary>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="5f2ec-104">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-104">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="5f2ec-105">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-105">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5f2ec-106">すべての利用可能な消費 REST API 操作の一覧を表示します。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-106">Lists all of the available consumption REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNext">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="5f2ec-107">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-107">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="5f2ec-108">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-108">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5f2ec-109">すべての利用可能な消費 REST API 操作の一覧を表示します。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-109">Lists all of the available consumption REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="5f2ec-110">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-110">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="5f2ec-111">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-111">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="5f2ec-112">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-112">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="5f2ec-113">すべての利用可能な消費 REST API 操作の一覧を表示します。</span><span class="sxs-lookup"><span data-stu-id="5f2ec-113">Lists all of the available consumption REST API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
