<Type Name="DiskEncryptionSettings" FullName="Microsoft.Azure.Management.Compute.Models.DiskEncryptionSettings">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DiskEncryptionSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="diskEncryptionKey">Key Vault のシークレットをあるディスクの暗号化キーの場所を指定します。</param>
        <param name="keyEncryptionKey">Key Vault にキーの暗号化キーの場所を指定します。</param>
        <param name="enabled">仮想マシンのディスクの暗号化を有効にするかどうかを指定します。</param>
        <summary>
            DiskEncryptionSettings クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DiskEncryptionKey">
      ...
      <Docs>
        <summary>
            取得または設定は、Key Vault のシークレットをあるディスクの暗号化キーの場所を指定します。
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            取得または設定は、仮想マシンのディスクの暗号化を有効にするかどうかを指定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="KeyEncryptionKey">
      ...
      <Docs>
        <summary>
            取得または設定は、Key Vault にキーの暗号化キーの場所を指定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
