<Type Name="ImageDiskReference" FullName="Microsoft.Azure.Management.Compute.Models.ImageDiskReference">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">プラットフォーム Imgage リポジトリまたはユーザーのイメージ参照を含む相対 uri。</param>
        <param name="lun">イメージのデータ ディスク、ディスクを作成する場合を使用するイメージ内のデータ ディスクのどれを示すインデックスです。 OS ディスクの場合は、このフィールドは null です。</param>
        <summary>
            ImageDiskReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            取得またはプラットフォーム Imgage リポジトリまたはユーザーのイメージ参照を含む相対 uri を設定します。
            </summary>
    ...
    <Member MemberName="Lun">
      ...
      <Docs>
        <summary>
            取得または設定の画像のデータ ディスクからディスクを作成する場合、これは、インデックスを使用するイメージのデータ ディスクのかを示します。 OS ディスクの場合は、このフィールドは null です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
