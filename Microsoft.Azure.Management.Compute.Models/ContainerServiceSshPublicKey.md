<Type Name="ContainerServiceSshPublicKey" FullName="Microsoft.Azure.Management.Compute.Models.ContainerServiceSshPublicKey">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ContainerServiceSshPublicKey クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="keyData">証明書の公開キーが SSH を通じて Vm での認証に使用します。 証明書は、ヘッダーの有無 PEM 形式である必要があります。</param>
        <summary>
            ContainerServiceSshPublicKey クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="KeyData">
      ...
      <Docs>
        <summary>
            取得または SSH を通じて Vm での認証に使用される証明書の公開キーを設定します。 証明書は、ヘッダーの有無 PEM 形式である必要があります。
            </summary>
