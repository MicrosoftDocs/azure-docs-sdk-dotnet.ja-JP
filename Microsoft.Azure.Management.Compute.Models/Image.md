<Type Name="Image" FullName="Microsoft.Azure.Management.Compute.Models.Image">
  ...
  <Docs>
    <summary>
            送信元のユーザーは、バーチャル ハード_ディスクをイメージします。 仮想マシンにアタッチされる前に、バーチャル ハード_ディスクがコピーされます。 SourceImage を指定すると、移行先の仮想ハード ドライブが存在しない必要があります。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="sourceVirtualMachine">ソース バーチャル マシン イメージを作成します。</param>
    ...
    <Member MemberName="SourceVirtualMachine">
      ...
      <Docs>
        <summary>
            取得またはイメージの作成元のソース バーチャル マシンを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
