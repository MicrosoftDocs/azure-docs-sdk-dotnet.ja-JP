<Type Name="VirtualMachineExtension" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineExtension">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualMachineExtension クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="forceUpdateTag">方法、拡張機能ハンドラーは、拡張機能の構成が変更されていない場合でも更新を適用する必要があります。</param>
        <param name="publisher">拡張機能ハンドラーのパブリッシャーの名前。</param>
        <param name="virtualMachineExtensionType">拡張機能の種類を指定しますたとえば"CustomScriptExtension"などです。</param>
        <param name="typeHandlerVersion">スクリプトのハンドラーのバージョンを指定します。</param>
        <param name="autoUpgradeMinorVersion">展開時に使用可能ないずれかがある場合に、拡張機能が新しいマイナー バージョンを使用するかどうかを示します。 展開した後ただし、拡張機能はアップグレードされませんマイナー バージョンしない限り、このプロパティを true に設定した場合でも、再展開します。</param>
        <param name="settings">Json 形式の拡張機能のパブリックに設定します。</param>
        <param name="protectedSettings">拡張機能には、protectedSettings または protectedSettingsFromKeyVault またはまったくない保護された設定のいずれかを含めることができます。</param>
        <param name="provisioningState">プロビジョニングの状態、応答でのみ表示されます。</param>
        <param name="instanceView">仮想マシン拡張機能のインスタンス ビュー。</param>
        <summary>
            VirtualMachineExtension クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AutoUpgradeMinorVersion">
      ...
      <Docs>
        <summary>
            取得または設定は、展開時に使用可能ないずれかがある場合に、拡張機能が新しいマイナー バージョンを使用するかどうかを示します。 展開した後ただし、拡張機能はアップグレードされませんマイナー バージョンしない限り、このプロパティを true に設定した場合でも、再展開します。
            </summary>
    ...
    <Member MemberName="ForceUpdateTag">
      ...
      <Docs>
        <summary>
            取得または設定方法、拡張機能ハンドラーを拡張機能の構成が変更されていない場合でも更新を適用する必要があります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="InstanceView">
      ...
      <Docs>
        <summary>
            取得または仮想マシン拡張機能のインスタンス ビューを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProtectedSettings">
      ...
      <Docs>
        <summary>
            取得または設定の拡張機能か protectedSettings protectedSettingsFromKeyVault かまったくない保護された設定に含めることができます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Publisher">
      ...
      <Docs>
        <summary>
            取得または拡張機能ハンドラーのパブリッシャーの名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TypeHandlerVersion">
      ...
      <Docs>
        <summary>
            取得または設定は、スクリプトのハンドラーのバージョンを指定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualMachineExtensionType">
      ...
      <Docs>
        <summary>
            取得または設定です。 拡張機能の種類を指定します。たとえば"CustomScriptExtension"などです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
