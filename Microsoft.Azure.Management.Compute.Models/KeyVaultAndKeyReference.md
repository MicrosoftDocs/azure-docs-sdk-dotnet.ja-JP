<Type Name="KeyVaultAndKeyReference" FullName="Microsoft.Azure.Management.Compute.Models.KeyVaultAndKeyReference">
  ...
  <Docs>
    <summary>
            Key Vault のキー Url KeK の資格情報コンテナーの id は、KeK は省略可能な暗号化キーのラップを解除するために使用が提供されている場合、
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            KeyVaultAndKeyReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="keyUrl">キーやシークレット KeyVault を指す Url</param>
        <summary>
            KeyVaultAndKeyReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
