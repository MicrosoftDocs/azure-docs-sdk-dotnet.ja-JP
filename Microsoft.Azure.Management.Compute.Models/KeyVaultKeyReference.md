<Type Name="KeyVaultKeyReference" FullName="Microsoft.Azure.Management.Compute.Models.KeyVaultKeyReference">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            KeyVaultKeyReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="keyUrl">Key Vault にキーの暗号化キーを参照する URL です。</param>
        <param name="sourceVault">キーを含む Key Vault の相対 URL です。</param>
        <summary>
            KeyVaultKeyReference クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="KeyUrl">
      ...
      <Docs>
        <summary>
            取得または、Key Vault にキーの暗号化キーを参照する URL を設定します。
            </summary>
    ...
    <Member MemberName="SourceVault">
      ...
      <Docs>
        <summary>
            取得またはキーを含む Key Vault の相対 URL を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
