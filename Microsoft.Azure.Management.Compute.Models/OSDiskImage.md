<Type Name="OSDiskImage" FullName="Microsoft.Azure.Management.Compute.Models.OSDiskImage">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            OSDiskImage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="operatingSystem">OsDiskImage のオペレーティング システム。 使用可能な値が含まれます 'Windows'、'Linux'。</param>
        <summary>
            OSDiskImage クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="OperatingSystem">
      ...
      <Docs>
        <summary>
            取得または、osDiskImage のオペレーティング システムを設定します。 使用可能な値が含まれます 'Windows'、'Linux'。
            </summary>
