<Type Name="ContainerServiceMasterProfile" FullName="Microsoft.Azure.Management.Compute.Models.ContainerServiceMasterProfile">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ContainerServiceMasterProfile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="dnsPrefix">マスターの FQDN の作成に使用する DNS プレフィックス。</param>
        <param name="count">コンテナー サービスのクラスターにマスター (Vm) の数です。 有効な値は 1、3、および 5 です。 既定値は 1 です。</param>
        <param name="fqdn">マスターの fdqn のサンプルです。</param>
        <summary>
            ContainerServiceMasterProfile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            取得またはコンテナー サービスのクラスターにマスター (Vm) の数を設定します。 有効な値は 1、3、および 5 です。 既定値は 1 です。
            </summary>
    ...
    <Member MemberName="DnsPrefix">
      ...
      <Docs>
        <summary>
            取得またはマスターに対応する FQDN を作成するために使用する DNS プレフィックスを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
