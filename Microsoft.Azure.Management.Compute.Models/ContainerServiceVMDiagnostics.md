<Type Name="ContainerServiceVMDiagnostics" FullName="Microsoft.Azure.Management.Compute.Models.ContainerServiceVMDiagnostics">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ContainerServiceVMDiagnostics クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="enabled">かどうか、VM の診断エージェントは、vm がプロビジョニングされます。</param>
        <param name="storageUri">診断の保存先ストレージ アカウントの URI。</param>
        <summary>
            ContainerServiceVMDiagnostics クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            取得または VM の診断エージェントは、VM でプロビジョニングされているかどうかを設定します。
            </summary>
    ...
    <Member MemberName="StorageUri">
      ...
      <Docs>
        <summary>
            診断の格納場所、ストレージ アカウントの URI を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
