<Type Name="VirtualMachineExtensionInstanceView" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineExtensionInstanceView">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualMachineExtensionInstanceView クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">仮想マシン拡張機能の名前。</param>
        ...
        <param name="substatuses">リソースの状態情報です。</param>
