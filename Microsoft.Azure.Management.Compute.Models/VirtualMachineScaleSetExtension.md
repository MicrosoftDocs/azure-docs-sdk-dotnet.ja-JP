<Type Name="VirtualMachineScaleSetExtension" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineScaleSetExtension">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            VirtualMachineScaleSetExtension クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="forceUpdateTag">値が指定された以前の値とは異なる場合、拡張機能ハンドラーは拡張機能の構成が変更されていない場合でも更新が強制されます。</param>
        <param name="publisher">拡張機能ハンドラーのパブリッシャーの名前。</param>
        <param name="type">拡張機能の種類を指定しますたとえば"CustomScriptExtension"などです。</param>
    ...
    <Member MemberName="ForceUpdateTag">
      ...
      <Docs>
        <summary>
            提供され、以前の値とは異なる場合、値を取得または設定、拡張機能ハンドラーが強制されるように拡張機能の構成が変更されていない場合でも更新できます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
