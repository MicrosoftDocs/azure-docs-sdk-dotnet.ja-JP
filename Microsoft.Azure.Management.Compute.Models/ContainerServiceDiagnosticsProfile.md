<Type Name="ContainerServiceDiagnosticsProfile" FullName="Microsoft.Azure.Management.Compute.Models.ContainerServiceDiagnosticsProfile">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ContainerServiceDiagnosticsProfile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="vmDiagnostics">コンテナー サービス VM の診断エージェントのプロファイル。</param>
        <summary>
            ContainerServiceDiagnosticsProfile クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="VmDiagnostics">
      ...
      <Docs>
        <summary>
            取得またはコンテナー サービス VM の診断エージェントのプロファイルを設定します。
            </summary>
