<Type Name="WindowsConfiguration" FullName="Microsoft.Azure.Management.Compute.Models.WindowsConfiguration">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="provisionVMAgent">バーチャル マシン エージェントが仮想マシンでプロビジョニングするかどうかを示します。
            &lt;ブラジル&gt;&lt;br&gt;既定の動作が true に設定するには、要求本文には、このプロパティが指定されていない、ときにします。  これにより、拡張機能を後で、VM に追加できるように、VM に VM エージェントがインストールされています。</param>
        <param name="enableAutomaticUpdates">自動更新の仮想マシンが有効になっているかどうかを示します。</param>
        <param name="timeZone">仮想マシンのタイム ゾーンを指定します。 例。「太平洋標準時」</param>
        <param name="additionalUnattendContent">追加 base 64 でエンコードされた XML 形式の情報は Windows セットアップで使用する Unattend.xml ファイルに含めることができるを指定します。</param>
        <param name="winRM">Windows Remote Management リスナーを指定します。 これにより、リモートの Windows PowerShell です。</param>
        <summary>
            WindowsConfiguration クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AdditionalUnattendContent">
      ...
      <Docs>
        <summary>
            取得または設定は、追加、base64 でエンコードされた XML 形式の情報は Windows セットアップで使用する Unattend.xml ファイルに含めることができるを指定します。
            </summary>
    ...
    <Member MemberName="EnableAutomaticUpdates">
      ...
      <Docs>
        <summary>
            取得または設定は、自動更新の仮想マシンが有効になっているかどうかを示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisionVMAgent">
      ...
      <Docs>
        <summary>
            取得または設定は、仮想マシン エージェントが仮想マシンでプロビジョニングするかどうかを示します。
            &amp;lt; br&amp;gt;&amp;lt; br&amp;gt;このプロパティは、要求本文に指定されていない、ときに既定の動作を true に設定を開始します。  これにより、拡張機能を後で、VM に追加できるように、VM に VM エージェントがインストールされています。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeZone">
      ...
      <Docs>
        <summary>
            取得または設定は、仮想マシンのタイム ゾーンを指定します。 例。「太平洋標準時」
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WinRM">
      ...
      <Docs>
        <summary>
            取得または設定は、Windows リモート管理のリスナーを指定します。
            これにより、リモートの Windows PowerShell です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
