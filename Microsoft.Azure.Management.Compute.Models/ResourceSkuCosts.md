<Type Name="ResourceSkuCosts" FullName="Microsoft.Azure.Management.Compute.Models.ResourceSkuCosts">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ResourceSkuCosts クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="meterID">Commerce から価格を照会するために使用します。</param>
        <param name="quantity">基本の従量制課金のコストを拡張するには、乗数が必要です。</param>
        <param name="extendedUnit">拡張単位を示すための不変性。</param>
        <summary>
            ResourceSkuCosts クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="MeterID">
      ...
      <Docs>
        <summary>
            Commerce から価格を照会するため使用されるを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Quantity">
      ...
      <Docs>
        <summary>
            乗数は基本の従量制課金のコストを拡張するために必要なを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
