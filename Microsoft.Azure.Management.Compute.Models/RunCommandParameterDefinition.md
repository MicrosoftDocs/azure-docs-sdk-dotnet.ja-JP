<Type Name="RunCommandParameterDefinition" FullName="Microsoft.Azure.Management.Compute.Models.RunCommandParameterDefinition">
  ...
  <Docs>
    <summary>
            Run コマンドのパラメーターのプロパティについて説明します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RunCommandParameterDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">Run コマンド パラメーターの名前。</param>
        <param name="type">Run コマンド パラメーターの型。</param>
        <param name="defaultValue">Run コマンド パラメーターの既定値です。</param>
        <param name="required">Run コマンドのパラメーターが必要です。</param>
        <summary>
            RunCommandParameterDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="DefaultValue">
      ...
      <Docs>
        <summary>
            取得または run コマンドのパラメーターの既定値を設定します。
            </summary>
