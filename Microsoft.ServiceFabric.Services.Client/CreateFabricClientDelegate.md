<Type Name="CreateFabricClientDelegate" FullName="Microsoft.ServiceFabric.Services.Client.CreateFabricClientDelegate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4549a-101">FabricClient オブジェクトを作成するデリゲートを表します。</span><span class="sxs-lookup"><span data-stu-id="4549a-101">Represents a delegate to create a FabricClient object.</span></span>
            </summary>
    <returns><span data-ttu-id="4549a-102">FabricClient</span><span class="sxs-lookup"><span data-stu-id="4549a-102">FabricClient</span></span></returns>
