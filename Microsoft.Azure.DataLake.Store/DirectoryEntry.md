  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="fullName">完全なパス</param>
        <param name="length">ファイルのサイズ</param>
        <param name="group">グループの所有者</param>
        <param name="user">ユーザーを所有者</param>
        <param name="lastAccessTime">1970 年 1/1/からのミリ秒として取得された最終アクセス日時</param>
        <param name="lastModifiedTime">1970 年 1/1/からのミリ秒として取得された最終更新時刻</param>
        <param name="type">ファイルまたはディレクトリ</param>
        <param name="permission">Unix スタイルのアクセス許可</param>
        <param name="hasAcl">Acl を設定するかどうか</param>
        <param name="expiryTime">1970 年 1/1/からのミリ秒として取得されたファイルの期限が切れる時刻</param>
        <summary>
            各プロパティを初期化するコンス トラクター
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
