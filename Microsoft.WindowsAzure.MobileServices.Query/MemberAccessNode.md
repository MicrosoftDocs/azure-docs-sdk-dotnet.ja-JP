<Type Name="MemberAccessNode" FullName="Microsoft.WindowsAzure.MobileServices.Query.MemberAccessNode">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="instance">メンバーがアクセスするインスタンス。</param>
        <param name="memberName">アクセスするメンバーの名前。</param>
        <summary>
            インスタンスを初期化します。<see cref="T:Microsoft.WindowsAzure.MobileServices.Query.MemberAccessNode" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
