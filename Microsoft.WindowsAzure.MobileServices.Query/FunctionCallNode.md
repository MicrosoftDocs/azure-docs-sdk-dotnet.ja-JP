<Type Name="FunctionCallNode" FullName="Microsoft.WindowsAzure.MobileServices.Query.FunctionCallNode">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">呼び出す関数の名前。</param>
        <param name="arguments">この関数呼び出しに対する引数のリスト。</param>
        <summary>
            インスタンスを初期化します。<see cref="T:Microsoft.WindowsAzure.MobileServices.Query.FunctionCallNode" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
