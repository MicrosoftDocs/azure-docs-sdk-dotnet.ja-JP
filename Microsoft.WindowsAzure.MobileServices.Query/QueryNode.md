<Type Name="QueryNode" FullName="Microsoft.WindowsAzure.MobileServices.Query.QueryNode">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6bccc-101">すべてのクエリ ノードの基本クラス。</span><span class="sxs-lookup"><span data-stu-id="6bccc-101">Base class for all query nodes.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Accept&lt;T&gt;">
      ...
      <Docs>
        <typeparam name="T"><span data-ttu-id="6bccc-102">ビジターがこのトークンにアクセスした後に戻る型。</span><span class="sxs-lookup"><span data-stu-id="6bccc-102">Type that the visitor will return after visiting this token.</span></span></typeparam>
        <param name="visitor"><span data-ttu-id="6bccc-103">ビジター インターフェイスの実装。</span><span class="sxs-lookup"><span data-stu-id="6bccc-103">An implementation of the visitor interface.</span></span></param>
        <summary>
            <span data-ttu-id="6bccc-104">QueryNode のツリーを QueryNodeVisitor を受け入れる</span><span class="sxs-lookup"><span data-stu-id="6bccc-104">Accept a QueryNodeVisitor that walks a tree of QueryNode</span></span>
            </summary>
        <returns><span data-ttu-id="6bccc-105">ビジターのパラメーターの型によって型が決まるオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="6bccc-105">An object whose type is determined by the type parameter of the visitor.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Kind">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6bccc-106">クエリ ノードの種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="6bccc-106">Gets the kind of the query node.</span></span>
            </summary>
