<Type Name="QueryBody" FullName="Microsoft.Azure.OperationalInsights.Models.QueryBody">
  ...
  <Docs>
    <summary>
            分析クエリ。 詳細については、[分析クエリの構文](https://azure.microsoft.com/documentation/articles/app-insights-analytics-reference/)
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            QueryBody クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="timespan">省略可能。 データをクエリする timespan です。 これは、ISO8601 時間、期間の値です。  この期間が他にも、クエリ式で指定されている、適用されます。</param>
        <param name="workspaces">クエリに含まれているワークスペースの一覧です。</param>
        <summary>
            QueryBody クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Timespan">
      ...
      <Docs>
        <summary>
            取得または設定オプション。 データをクエリする timespan です。 これは、ISO8601 時間、期間の値です。  この期間が他にも、クエリ式で指定されている、適用されます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Workspaces">
      ...
      <Docs>
        <summary>
            取得またはクエリに含まれているワークスペースの一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
