<Type Name="ErrorInfo" FullName="Microsoft.Azure.OperationalInsights.Models.ErrorInfo">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code">コンピューターの読み取り可能なエラー コード。</param>
        <param name="message">人間の判読しやすいエラー メッセージ。</param>
        <param name="details">エラーの詳細。</param>
        <param name="innererror">存在する場合の内部エラーの詳細。</param>
