  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="columns">このテーブルの列の一覧。</param>
        <param name="rows">このクエリの結果として得られる行です。</param>
        <summary>
            テーブル クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
