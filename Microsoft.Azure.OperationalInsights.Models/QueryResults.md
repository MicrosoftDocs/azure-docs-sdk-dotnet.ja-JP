<Type Name="QueryResults" FullName="Microsoft.Azure.OperationalInsights.Models.QueryResults">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tables">テーブル、列および行の一覧。</param>
        <summary>
            QueryResults クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Render">
      ...
      <Docs>
        <summary>
            要求された場合に、結果の情報視覚エフェクトにはが含まれています。 詳細については https://dev.loganalytics.io/documentation/Using-the-API/RequestOptions を参照してください。
            </summary>
    ...
    <Member MemberName="Statistics">
      ...
      <Docs>
        <summary>
            要求された場合に、クエリ統計情報が含まれています。 詳細については https://dev.loganalytics.io/documentation/Using-the-API/RequestOptions を参照してください。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
