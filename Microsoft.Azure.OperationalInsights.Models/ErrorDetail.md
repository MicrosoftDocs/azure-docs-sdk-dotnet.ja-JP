<Type Name="ErrorDetail" FullName="Microsoft.Azure.OperationalInsights.Models.ErrorDetail">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ErrorDetail クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code">エラーのコードです。</param>
        <param name="message">人間の判読しやすいエラー メッセージ。</param>
        <param name="target">要求でどのプロパティがエラーの原因を示します。</param>
        <param name="value">'Target' 内のどの値がエラーの原因を示します。</param>
        <param name="resources">エラーの原因がリソースを示します。</param>
    ...
    <Member MemberName="Target">
      ...
      <Docs>
        <summary>
            取得または設定は、要求でどのプロパティがエラーの原因を示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            取得または設定は、'target' 内のどの値がエラーの原因を示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
