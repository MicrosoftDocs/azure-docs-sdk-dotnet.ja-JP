<Type Name="ChangeFeedObserverContext" FullName="Microsoft.Azure.Documents.ChangeFeedProcessor.ChangeFeedObserverContext">
  ...
  <Docs>
    <summary>
            渡されるコンテキスト<see cref="T:Microsoft.Azure.Documents.ChangeFeedProcessor.IChangeFeedObserver" />イベント。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="FeedResponse">
      ...
      <Docs>
        <summary>
            基になるから応答を取得する<see cref="M:Microsoft.Azure.Documents.Linq.IDocumentQuery`1.ExecuteNextAsync(System.Threading.CancellationToken)" />呼び出します。
            </summary>
