<Type Name="TableServiceEntity" FullName="Microsoft.WindowsAzure.Storage.Table.DataServices.TableServiceEntity">
  ...
  <Docs>
    <summary>
            Windows Azure テーブル サービスでエンティティを表します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.Table.DataServices.TableServiceEntity" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="partitionKey">パーティション キーです。</param>
        <param name="rowKey">行キーです。</param>
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.Table.DataServices.TableServiceEntity" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="PartitionKey">
      ...
      <Docs>
        <summary>
            取得またはテーブル エンティティのパーティション キーを設定します。
            </summary>
        <value>パーティション キーです。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
