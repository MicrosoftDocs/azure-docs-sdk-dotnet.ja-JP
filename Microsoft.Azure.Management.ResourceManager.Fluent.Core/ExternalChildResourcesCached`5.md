  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しい ExternalChildResourcesCached を作成します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AddChildResource">
      ...
      <Docs>
        <param name="childResource">childResource 外部子リソース</param>
        <summary>
            外部の子リソースをコレクションに追加します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Collection">
      ...
      <Docs>
        <summary>To be added.</summary>
        <value>読み取り専用のディクショナリとしての子リソースのコレクションです。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="NewChildResource">
      ...
      <Docs>
        <param name="name">新しい子リソースの名前</param>
        <summary>
            新しい外部子リソース モデル インスタンスを取得します。
            </summary>
        <returns>新しい子リソース</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrepareDefine">
      ...
      <Docs>
        <param name="name">新しい子の外部リソースの名前</param>
        <summary>
            新しい子の外部リソースの定義を準備します。
            </summary>
        <returns>子リソース</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrepareDefine">
      ...
      <Docs>
        <param name="name">新しい子の外部リソースの名前</param>
        <param name="key">新しい子の外部リソースのキー</param>
        <summary>
            新しい子の外部リソースの定義を準備します。
            </summary>
        <returns>子リソース</returns>
    ...
    <Member MemberName="PrepareRemove">
      ...
      <Docs>
        <param name="name">外部の子リソースの名前</param>
        <summary>
            指定した名前削除するか、外部の子リソースをマークします。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrepareRemove">
      ...
      <Docs>
        <param name="name">外部の子リソースの名前</param>
        <param name="key">外部の子リソースのキー</param>
        <summary>
            指定した名前削除するか、外部の子リソースをマークします。
            </summary>
        <remarks>To be added.</remarks>
