  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しい ExternalChildResourcesNonCached を作成します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="PrepareDefine">
      ...
      <Docs>
        <param name="model">追跡するために、モデルの変更を作成します。</param>
        <summary>
            作成するには、外部の子リソースの特定のモデルを準備します。
            </summary>
        <returns>準備ができている外部の子リソースを作成します。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrepareRemove">
      ...
      <Docs>
        <param name="model">削除する子リソースを表すモデル</param>
        <summary>
            削除するには、外部の子リソースの特定のモデルを準備します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrepareUpdate">
      ...
      <Docs>
        <param name="model">更新プログラムの変更を追跡するためにモデル</param>
        <summary>
            更新プログラムを特定のモデルの外部の子リソースを準備します。
            </summary>
        <returns>更新プログラムの準備ができている子の外部リソース</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
