<Type Name="IWithPremiumAttach&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Cdn.Fluent.CdnEndpoint.Definition.IWithPremiumAttach&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="c934c-101">この定義をアタッチした後に戻るには、親 CDN プロファイル定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="c934c-101">The stage of the parent CDN profile definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="c934c-102">CDN プロファイル Premium Verizon エンドポイント定義の最終段階です。</span><span class="sxs-lookup"><span data-stu-id="c934c-102">The final stage of the CDN profile Premium Verizon endpoint definition.</span></span>
            <span data-ttu-id="c934c-103">この段階で、残りの省略可能な設定を指定することができます、または CDN プロファイルのエンドポイントの定義は、親 CDN プロファイル定義に関連付けることができます。</span><span class="sxs-lookup"><span data-stu-id="c934c-103">At this stage, any remaining optional settings can be specified, or the CDN profile endpoint definition can be attached to the parent CDN profile definition.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithCustomDomain">
      ...
      <Docs>
        <param name="hostName"><span data-ttu-id="c934c-104">カスタム ドメインのホスト名。</span><span class="sxs-lookup"><span data-stu-id="c934c-104">A custom domain host name.</span></span></param>
        <summary>
            <span data-ttu-id="c934c-105">新しい CDN エンドポイント用カスタム ドメインを追加します。</span><span class="sxs-lookup"><span data-stu-id="c934c-105">Adds a new CDN custom domain for the endpoint.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c934c-106">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c934c-106">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHostHeader">
      ...
      <Docs>
        <param name="hostHeader"><span data-ttu-id="c934c-107">ホスト ヘッダーです。</span><span class="sxs-lookup"><span data-stu-id="c934c-107">A host header.</span></span></param>
        <summary>
            <span data-ttu-id="c934c-108">ホスト ヘッダーを指定します。</span><span class="sxs-lookup"><span data-stu-id="c934c-108">Specifies the host header.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c934c-109">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c934c-109">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHttpAllowed">
      ...
      <Docs>
        <param name="httpAllowed"><span data-ttu-id="c934c-110">True の場合は、HTTP トラフィックが許可されます。</span><span class="sxs-lookup"><span data-stu-id="c934c-110">If true, then HTTP traffic will be allowed.</span></span></param>
        <summary>
            <span data-ttu-id="c934c-111">HTTP トラフィックが許可されたかどうかを指定します。</span><span class="sxs-lookup"><span data-stu-id="c934c-111">Specifies if HTTP traffic is allowed.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c934c-112">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c934c-112">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHttpPort">
      ...
      <Docs>
        <param name="httpPort"><span data-ttu-id="c934c-113">ポート番号です。</span><span class="sxs-lookup"><span data-stu-id="c934c-113">A port number.</span></span></param>
        <summary>
            <span data-ttu-id="c934c-114">HTTP トラフィック用のポートを指定します。</span><span class="sxs-lookup"><span data-stu-id="c934c-114">Specifies the port for HTTP traffic.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c934c-115">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c934c-115">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHttpsAllowed">
      ...
      <Docs>
        <param name="httpsAllowed"><span data-ttu-id="c934c-116">true の場合は、HTTPS トラフィックが許可されます。</span><span class="sxs-lookup"><span data-stu-id="c934c-116">If true then HTTPS traffic will be allowed.</span></span></param>
        <summary>
            <span data-ttu-id="c934c-117">HTTPS トラフィックが許可されたかどうかを指定します。</span><span class="sxs-lookup"><span data-stu-id="c934c-117">Specifies if HTTPS traffic is allowed.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c934c-118">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c934c-118">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHttpsPort">
      ...
      <Docs>
        <param name="httpsPort"><span data-ttu-id="c934c-119">ポート番号です。</span><span class="sxs-lookup"><span data-stu-id="c934c-119">A port number.</span></span></param>
        <summary>
            <span data-ttu-id="c934c-120">HTTPS トラフィック用のポートを指定します。</span><span class="sxs-lookup"><span data-stu-id="c934c-120">Specifies the port for HTTPS traffic.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c934c-121">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c934c-121">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithOriginPath">
      ...
      <Docs>
        <param name="originPath"><span data-ttu-id="c934c-122">配信元のパス。</span><span class="sxs-lookup"><span data-stu-id="c934c-122">An origin path.</span></span></param>
        <summary>
            <span data-ttu-id="c934c-123">配信元のパスを指定します。</span><span class="sxs-lookup"><span data-stu-id="c934c-123">Specifies the origin path.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c934c-124">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c934c-124">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>