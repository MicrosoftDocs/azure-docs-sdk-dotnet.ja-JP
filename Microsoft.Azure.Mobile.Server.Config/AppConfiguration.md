<Type Name="AppConfiguration" FullName="Microsoft.Azure.Mobile.Server.Config.AppConfiguration">
  ...
  <Docs>
    <summary>
            既定の抽象実装<see cref="T:Microsoft.Azure.Mobile.Server.Config.IAppConfiguration" />です。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.Azure.Mobile.Server.Config.AppConfiguration" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ConfigProviders">
      ...
      <Docs>
        <summary>
            取得の一覧に登録されている<see cref="T:Microsoft.Azure.Mobile.Server.Config.IMobileAppExtensionConfigProvider" />です。
            </summary>
