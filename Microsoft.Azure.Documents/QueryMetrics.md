<Type Name="QueryMetrics" FullName="Microsoft.Azure.Documents.QueryMetrics">
  ...
  <Docs>
    <summary>
            Azure Cosmos DB サービスのメトリックをクエリします。
            </summary>
  ...
  <Members>
    <Member MemberName="IndexHitRatio">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービスのクエリによって、インデックスのヒット率を取得します。
            </summary>
    ...
    <Member MemberName="op_Addition">
      ...
      <Docs>
        <param name="m1">最初の<see cref="T:Microsoft.Azure.Documents.QueryMetrics" />インスタンス</param>
        <param name="m2">2 番目<see cref="T:Microsoft.Azure.Documents.QueryMetrics" />インスタンス</param>
        <summary>
            指定した 2 つ追加<see cref="T:Microsoft.Azure.Documents.QueryMetrics" />インスタンス
            </summary>
        <returns>新しい<see cref="T:Microsoft.Azure.Documents.QueryMetrics" />2 つの和であるインスタンス<see cref="T:Microsoft.Azure.Documents.QueryMetrics" />インスタンス</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OutputDocumentCount">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービスのクエリによって返されるドキュメントの数を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="QueryEngineTimes">
      ...
      <Docs>
        <summary>
            取得、 <see cref="T:Microsoft.Azure.Documents.QueryEngineTimes" /> Azure Cosmos DB サービスのインスタンス。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="QueryPreparationTimes">
      ...
      <Docs>
        <summary>
            取得、 <see cref="T:Microsoft.Azure.Documents.QueryPreparationTimes" /> Azure Cosmos DB サービスのインスタンス。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Retries">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービス reties の数を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RetrievedDocumentCount">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービスのクエリ中に取得されたドキュメントの数を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RetrievedDocumentSize">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービスのクエリ中に、バイト単位で取得されたドキュメントのサイズを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
            取得、stringified <see cref="T:Microsoft.Azure.Documents.QueryMetrics" /> Azure Cosmos DB サービスのインスタンス。
            </summary>
    ...
    <Member MemberName="TotalTime">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービスのクエリの合計時間を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
