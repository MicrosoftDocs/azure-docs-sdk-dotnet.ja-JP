<Type Name="Error" FullName="Microsoft.Azure.Documents.Error">
  ...
  <Docs>
    <summary> 
            エラーをカプセル化。 関連する Azure Cosmos DB サービスの詳細。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            新しいインスタンスを初期化、 <see cref="T:Microsoft.Azure.Documents.Error" /> Azure Cosmos DB サービスのクラスです。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            取得または Azure Cosmos DB サービスのエラー コードの説明テキストを設定します。
            </summary>
        <value>エラー コードの説明のテキスト。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            取得または Azure Cosmos DB サービスのエラー メッセージを設定します。
            </summary>
