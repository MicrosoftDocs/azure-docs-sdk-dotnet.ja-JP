<Type Name="SqlParameterCollection" FullName="Microsoft.Azure.Documents.SqlParameterCollection">
  ...
  <Docs>
    <summary>
            関連付けられているパラメーターのコレクションを表します<see cref="T:Microsoft.Azure.Documents.SqlQuerySpec" />Cosmos DB の Azure サービスで使用するためです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービスの SqlParameterCollection クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化、 <see cref="T:Microsoft.Azure.Documents.SqlParameterCollection" /> Azure Cosmos DB サービスのクラスです。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Add">
      ...
      <Docs>
        ...
        <summary>
            Azure Cosmos DB コレクションに項目を追加します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Clear">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB コレクションからすべての項目を削除します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Contains">
      ...
      <Docs>
        ...
        <summary>
            Azure Cosmos DB コレクションに特定の値が含まれているかどうかを判断します。
            </summary>
        <returns>コレクションには、特定の値が含まれている場合は trueそれ以外の場合は false です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyTo">
      ...
      <Docs>
        ...
        <param name="arrayIndex">要素の追加を開始するインデックスの配列内の位置。</param>
        <summary>
            Azure Cosmos DB コレクションの要素をコピー、<see cref="T:System.Array" />特定の開始、<see cref="T:System.Array" />インデックス。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB コレクションに含まれる要素の数を取得します。
            </summary>
    ...
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB コレクションを反復処理する列挙子を返します。
            </summary>
    ...
    <Member MemberName="IndexOf">
      ...
      <Docs>
        ...
        <summary>
            Azure Cosmos DB コレクション内の特定の項目のインデックスを決定します。
            </summary>
        <returns>項目のインデックス値。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Insert">
      ...
      <Docs>
        <param name="index">要素の挿入を開始するインデックスの配列内の位置。</param>
        <param name="item">インデックスにコピーする項目。</param>
        <summary>
            Azure Cosmos DB コレクション内の指定したインデックス位置に項目を挿入します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsReadOnly">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB コレクションは読み取り専用であるかどうかを示す値を取得します。
            </summary>
        <value>コレクションが読み取り専用である場合は trueそれ以外の場合は false です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="index">インデックス内の位置。</param>
        <summary>
            取得または Azure Cosmos DB コレクション内の指定したインデックス位置の要素を設定します。
            </summary>
    ...
    <Member MemberName="Remove">
      ...
      <Docs>
        ...
        <summary>
            Azure Cosmos DB コレクションから、最初に見つかった特定のオブジェクトを削除します。
            </summary>
        <returns>最初の項目が削除された場合は true。それ以外の場合は false です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RemoveAt">
      ...
      <Docs>
        <param name="index">項目を削除、インデックス内の位置。</param>
        <summary>
            Azure Cosmos DB コレクションから指定したインデックス位置にある項目を削除します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
