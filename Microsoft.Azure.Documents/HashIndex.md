<Type Name="HashIndex" FullName="Microsoft.Azure.Documents.HashIndex">
  ...
  <Docs>
    <summary>
            Azure Cosmos DB サービスのハッシュ インデックス設定の詳細を表します。
            </summary>
    <remarks>
            ようにクエリを処理するために使用する: 選択 * docs d WHERE d.prop から 5 を = です。
            </remarks>
  </Docs>
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化、 <see cref="T:Microsoft.Azure.Documents.HashIndex" /> Azure Cosmos DB サービスのデータ型が指定したクラスです。
            </summary>
        <remarks>To be added.</remarks>
        <altmember cref="P:Microsoft.Azure.Documents.HashIndex.DataType" />
        <example>
            データ型を渡して HashIndex クラスのインスタンスを作成する例を次に示します。
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.Documents.HashIndex" />指定のデータ型と Azure Cosmos DB サービスの有効桁数を持つクラス。
            </summary>
        <remarks>To be added.</remarks>
        <altmember cref="P:Microsoft.Azure.Documents.HashIndex.DataType" />
        <example>
            データ型および有効桁数を渡します HashIndex クラスのインスタンスを作成する例を次に示します。
            <code language="c#"><![CDATA[
    ...
    <Member MemberName="Clone">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービスのハッシュ インデックスのコピーを作成します。
            </summary>
        <returns>ハッシュ インデックスの複製。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DataType">
      ...
      <Docs>
        ...
        <remarks>参照してください<a href="http://azure.microsoft.com/documentation/articles/documentdb-indexing-policies/#ConfigPolicy">コレクションのインデックス作成ポリシーをカスタマイズする</a>値の範囲は無効です。</remarks>
      </Docs>
    </Member>
