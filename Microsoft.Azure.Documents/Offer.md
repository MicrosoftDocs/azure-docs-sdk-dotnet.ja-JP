<Type Name="Offer" FullName="Microsoft.Azure.Documents.Offer">
  ...
  <Docs>
    <summary>
            Azure Cosmos DB サービスのリソース (コレクション) 用のプランを表します。
            </summary>
    <remarks>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービスのリソースのオファーを初期化します。
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            Azure Cosmos DB サービスの別のオファー オブジェクトから、リソースの購入プランを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OfferType">
      ...
      <Docs>
        <summary>
            取得または Azure Cosmos DB サービスのリソース提供 OfferType を設定します。
            </summary>
    ...
    <Member MemberName="OfferVersion">
      ...
      <Docs>
        <summary>
            取得または Azure Cosmos DB サービスでこのオファー リソースのバージョンを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceLink">
      ...
      <Docs>
        <summary>
            取得または Azure Cosmos DB サービスのリソースの提供に適用されるリソースの自己リンクを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
