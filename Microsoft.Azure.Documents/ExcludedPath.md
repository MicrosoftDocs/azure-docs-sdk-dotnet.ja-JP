<Type Name="ExcludedPath" FullName="Microsoft.Azure.Documents.ExcludedPath">
  ...
  <Docs>
    <summary> 
            Azure Cosmos DB サービスのデータをインデックス作成中に除外する JSON ドキュメント内のパスを指定します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            新しいインスタンスを初期化、 <see cref="T:Microsoft.Azure.Documents.ExcludedPath" /> Azure Cosmos DB サービスのクラスです。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Clone">
      ...
      <Docs>
        <summary>
            Azure Cosmos DB サービス エクスクルード パスのコピーを作成します。
            </summary>
        <returns>除外されるパスの複製。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
            取得または Azure Cosmos DB サービスでインデックス作成から除外するパスを設定します。
            </summary>
        <value>
            インデックス作成から除外するパス。
            </value>
