  ...
  <Members>
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <summary>
            プライマリおよびセカンダリ管理に指定された Azure Search サービスの API キーを取得します。
    ...
    <Member MemberName="Regenerate">
      ...
      <Docs>
        ...
        <param name="keyKind">
            再生成するキーを指定します。 有効な値には、'primary' および 'セカンダリ' が含まれます。 使用可能な値が含まれます 'primary'、'セカンダリ'。
            </param>
        <param name="searchManagementRequestOptions">
            操作の追加パラメーター
            </param>
