<Type Name="SearchManagementClient" FullName="Microsoft.Azure.Management.Search.SearchManagementClient">
  ...
  <Docs>
    <summary>
            Azure Search サービスと API キーを管理するために使用するクライアント。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ApiVersion">
      ...
      <Docs>
        <summary>
            各要求に対して使用する API のバージョン。 現在のバージョンは、2015-08-19 です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubscriptionId">
      ...
      <Docs>
        <summary>
            Microsoft Azure サブスクリプションの一意の識別子。 この値は、Azure リソース マネージャー API またはポータルから取得できます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
