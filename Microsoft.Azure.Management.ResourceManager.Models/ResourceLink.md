<Type Name="ResourceLink" FullName="Microsoft.Azure.Management.ResourceManager.Models.ResourceLink">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ResourceLink クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">リソースのリンクの完全修飾 ID です。</param>
        <param name="name">リソースのリンクの名前。</param>
        <param name="properties">リソース リンクのプロパティです。</param>
        <summary>
            ResourceLink クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
