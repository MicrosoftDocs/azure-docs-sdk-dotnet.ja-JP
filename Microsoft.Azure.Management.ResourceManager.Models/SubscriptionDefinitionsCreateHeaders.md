<Type Name="SubscriptionDefinitionsCreateHeaders" FullName="Microsoft.Azure.Management.ResourceManager.Models.SubscriptionDefinitionsCreateHeaders">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SubscriptionDefinitionsCreateHeaders クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location">非同期操作の状態を取得するには、この URL を取得します。</param>
    ...
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            取得または設定は、非同期操作の状態を取得するには、この URL を取得します。
            </summary>
