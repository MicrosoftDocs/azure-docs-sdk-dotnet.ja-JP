<Type Name="ErrorDetails" FullName="Microsoft.Azure.Management.ResourceManager.Models.ErrorDetails">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code">サーバーで定義されている一連のエラー コードの 1 つ。</param>
        <param name="message">エラーの人間が判読できる形式です。</param>
        <param name="target">(省略可能)エラーのターゲットです。</param>
        <summary>
            ErrorDetails クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            取得またはサーバーで定義されている一連のエラー コードのいずれかを設定します。
            </summary>
