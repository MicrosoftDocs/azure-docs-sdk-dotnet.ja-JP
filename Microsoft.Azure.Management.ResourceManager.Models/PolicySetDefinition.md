<Type Name="PolicySetDefinition" FullName="Microsoft.Azure.Management.ResourceManager.Models.PolicySetDefinition">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PolicySetDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="policyDefinitions">ポリシーの定義の参照の配列。</param>
        <param name="policyType">ポリシー定義の型。 使用可能な値は NotSpecified、ビルトイン、およびカスタムです。 使用可能な値が含まれます: 'NotSpecified'、'BuiltIn'、'Custom'</param>
        <param name="displayName">ポリシーの表示名は、定義を設定します。</param>
        <param name="description">ポリシーは、定義の説明を設定します。</param>
        <param name="metadata">ポリシーは、定義のメタデータを設定します。</param>
        <param name="parameters">ポリシーは、ポリシーの定義の参照で使用できる定義パラメーターを設定します。</param>
        <param name="id">ポリシーの ID は、定義を設定します。</param>
        <param name="name">ポリシーの名前は、定義を設定します。</param>
        <param name="type">リソース (Microsoft.Authorization/policySetDefinitions) の型。</param>
        <summary>
            PolicySetDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            取得またはポリシーの定義の参照で使用できるポリシー セット定義のパラメーターを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            リソース (Microsoft.Authorization/policySetDefinitions) の種類を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
