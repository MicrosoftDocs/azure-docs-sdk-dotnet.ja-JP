  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="correlationId">デプロイメントの相関 ID です。</param>
        <param name="timestamp">テンプレート デプロイのタイムスタンプです。</param>
        <param name="outputs">Deploymentoutput を表すキー/値ペア。</param>
        <param name="providers">展開に必要なリソース プロバイダーの一覧です。</param>
        <param name="dependencies">展開の依存関係の一覧。</param>
        <param name="template">テンプレートの内容。 Template と TemplateLink の 1 つのみを使用します。</param>
        <param name="templateLink">テンプレートを参照する URI。 Template と TemplateLink の 1 つのみを使用します。</param>
        <param name="parameters">デプロイ パラメーターです。 Parameters と ParametersLink の 1 つのみを使用します。</param>
        <param name="parametersLink">パラメーターを参照する URI。
            Parameters と ParametersLink の 1 つのみを使用します。</param>
        <param name="mode">配置モードです。 指定できる値は、増分バックアップと完全には。 使用可能な値が含まれます: '増分'、'完了'</param>
    ...
    <Member MemberName="Mode">
      ...
      <Docs>
        <summary>
            取得または配置モードを設定します。 指定できる値は、増分バックアップと完全には。 使用可能な値が含まれます: '増分'、'完了'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Outputs">
      ...
      <Docs>
        <summary>
            取得または deploymentoutput を表すキー/値ペアを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            取得またはデプロイのパラメーターを設定します。 Parameters と ParametersLink の 1 つのみを使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ParametersLink">
      ...
      <Docs>
        <summary>
            取得またはパラメーターを参照する URI を設定します。 Parameters と ParametersLink の 1 つのみを使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Providers">
      ...
      <Docs>
        <summary>
            取得または展開に必要なリソース プロバイダーの一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Template">
      ...
      <Docs>
        <summary>
            取得またはテンプレートの内容を設定します。 Template と TemplateLink の 1 つのみを使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TemplateLink">
      ...
      <Docs>
        <summary>
            取得またはテンプレートを参照する URI を設定します。 Template と TemplateLink の 1 つのみを使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
