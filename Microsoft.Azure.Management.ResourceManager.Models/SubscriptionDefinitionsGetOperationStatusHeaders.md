<Type Name="SubscriptionDefinitionsGetOperationStatusHeaders" FullName="Microsoft.Azure.Management.ResourceManager.Models.SubscriptionDefinitionsGetOperationStatusHeaders">
  ...
  <Docs>
    <summary>
            GetOperationStatus 操作のヘッダーを定義します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SubscriptionDefinitionsGetOperationStatusHeaders クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location">非同期操作のステータスを確認できる URL。</param>
        <param name="retryAfter">操作の状態をチェック中に使用する遅延の量。 値は秒単位で表されます。</param>
        <summary>
            SubscriptionDefinitionsGetOperationStatusHeaders クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            取得または非同期操作のステータスを確認できる URL を設定します。
            </summary>
    ...
    <Member MemberName="RetryAfter">
      ...
      <Docs>
        <summary>
            取得または操作の状態をチェック中に使用する遅延の時間を設定します。 値は秒単位で表されます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
