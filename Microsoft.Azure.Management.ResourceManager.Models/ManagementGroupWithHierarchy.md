<Type Name="ManagementGroupWithHierarchy" FullName="Microsoft.Azure.Management.ResourceManager.Models.ManagementGroupWithHierarchy">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ManagementGroupWithHierarchy クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">管理グループの ID。 例: 
            /providers/Microsoft.Management/managementGroups/20000000-0000-0000-0000-000000000000</param>
        <param name="type">リソースの型。 例: 
            /providers/Microsoft.Management/managementGroups</param>
        <param name="name">管理グループの名前。 例: 
            20000000-0000-0000-0000-000000000000</param>
        <param name="tenantId">管理グループに関連付けられている AAD テナント ID です。 例:  10000000-0000-0000-0000-000000000000</param>
        <param name="displayName">管理グループのフレンドリ名。</param>
    ...
    <Member MemberName="TenantId">
      ...
      <Docs>
        <summary>
            取得または管理グループに関連付けられている AAD テナント ID を設定します。 例:  10000000-0000-0000-0000-000000000000
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
