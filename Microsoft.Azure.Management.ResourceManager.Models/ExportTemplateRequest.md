<Type Name="ExportTemplateRequest" FullName="Microsoft.Azure.Management.ResourceManager.Models.ExportTemplateRequest">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ExportTemplateRequest クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resources">リソースの Id。 唯一サポートされている文字列が現在は ' *' (すべてのリソース)。 今後の更新は、特定のリソースのエクスポートをサポートします。</param>
    ...
    <Member MemberName="Resources">
      ...
      <Docs>
        <summary>
            取得またはリソースの Id を設定します。 唯一サポートされている文字列が現在は ' *' (すべてのリソース)。 今後の更新は、特定のリソースのエクスポートをサポートします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
