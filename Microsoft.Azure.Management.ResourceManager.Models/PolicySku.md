<Type Name="PolicySku" FullName="Microsoft.Azure.Management.ResourceManager.Models.PolicySku">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PolicySku クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">ポリシーの sku の名前。 使用可能な値は、A0 A1 です。</param>
        <param name="tier">ポリシーの sku 層です。 指定できる値は、無償版および標準はします。</param>
        <summary>
            PolicySku クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得またはポリシー sku の名前を設定します。 使用可能な値は、A0 A1 です。
            </summary>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            取得またはポリシー sku 層を設定します。 指定できる値は、無償版および標準はします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
