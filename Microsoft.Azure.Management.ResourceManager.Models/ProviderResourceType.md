  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="locations">このリソースの種類を作成できる場所のコレクション。</param>
        <param name="aliases">このリソースの種類でサポートされているエイリアスです。</param>
        <param name="apiVersions">API のバージョン。</param>
    ...
    <Member MemberName="Aliases">
      ...
      <Docs>
        <summary>
            取得またはこのリソースの種類でサポートされているエイリアスを設定します。
            </summary>
    ...
    <Member MemberName="Locations">
      ...
      <Docs>
        <summary>
            取得またはこのリソースの種類を作成できる場所の場所のコレクションを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
