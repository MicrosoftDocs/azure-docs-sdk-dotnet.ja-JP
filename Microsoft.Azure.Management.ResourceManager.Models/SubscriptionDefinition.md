<Type Name="SubscriptionDefinition" FullName="Microsoft.Azure.Management.ResourceManager.Models.SubscriptionDefinition">
  ...
  <Docs>
    <summary>
            サブスクリプション定義は、サブスクリプションを作成するために使用します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SubscriptionDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="subscriptionId">サブスクリプションの ID。</param>
        <param name="subscriptionDisplayName">サブスクリプションの表示名。</param>
        <param name="offerType">サブスクリプションのオファーの種類。 たとえば、MS して-0017-p (EnterpriseAgreement) と MS して-0148-p (EnterpriseAgreement devTest) のとおりです。</param>
        <param name="etag">サブスクリプション定義の etag。</param>
        <summary>
            SubscriptionDefinition クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            取得またはサブスクリプションの定義の etag を設定します。
            </summary>
    ...
    <Member MemberName="OfferType">
      ...
      <Docs>
        <summary>
            取得またはサブスクリプションのオファーの種類を設定します。 たとえば、MS して-0017-p (EnterpriseAgreement) と MS して-0148-p (EnterpriseAgreement devTest) のとおりです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
