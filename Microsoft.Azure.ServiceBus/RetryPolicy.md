<Type Name="RetryPolicy" FullName="Microsoft.Azure.ServiceBus.RetryPolicy">
  ...
  <Members>
    ...
    <Member MemberName="Default">
      ...
      <Docs>
        <summary>
            既定の再試行ポリシーを返します<see cref="T:Microsoft.Azure.ServiceBus.RetryExponential" />です。
            </summary>
    ...
    <Member MemberName="RunOperation">
      ...
      <Docs>
        <param name="operation">A<see cref="T:System.Func`2" />を実行します。</param>
        <param name="operationTimeout">すべての操作のタイムアウト。</param>
        <summary>
            実行、 <see cref="T:System.Func`2" />、現在の RetryPolicy を使用します。
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerBusyExceptionMessage">
      ...
      <Docs>
        <summary>
            サーバーのビジー状態でエラーが返されるときに、例外メッセージを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
