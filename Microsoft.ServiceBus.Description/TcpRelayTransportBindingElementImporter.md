<Type Name="TcpRelayTransportBindingElementImporter" FullName="Microsoft.ServiceBus.Description.TcpRelayTransportBindingElementImporter">
  ...
  <Docs>
    <summary>WSDL コントラクトとポリシー アサーションを Azure サービス バス TcpRelayTransport バインディングにマップします。</summary>
  ...
  <Members>
    ...
    <Member MemberName="System.ServiceModel.Description.IPolicyImportExtension.ImportPolicy">
      ...
      <Docs>
        <param name="importer">使用中の MetadataImporter オブジェクト。</param>
        <param name="context">インポートできる、両方のポリシー アサーションを含む PolicyConversionContext とバインド要素をバインディング要素を実装することができますの追加先のコレクション。</param>
        <summary>
            カスタム ポリシー アサーションをインポートし、実装するバインド要素を追加
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="System.ServiceModel.Description.IWsdlImportExtension.BeforeImport">
      ...
      <Docs>
        <param name="wsdlDocuments">インポートする WSDL ドキュメントのコレクション。</param>
        <param name="xmlSchemas">インポートする XML スキーマ ドキュメントのコレクション。</param>
        <param name="policy">インポートするポリシー アサーションのコレクション。</param>
        <summary>
