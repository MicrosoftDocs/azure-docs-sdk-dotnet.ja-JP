<Type Name="IWithPermissions" FullName="Microsoft.Azure.Management.KeyVault.Fluent.AccessPolicy.Update.IWithPermissions">
  ...
  <Docs>
    <summary>
            アクセス ポリシーは、ステージを追加または削除するアクセス許可を更新します。
            </summary>
  ...
  <Members>
    <Member MemberName="AllowKeyAllPermissions">
      ...
      <Docs>
        ...
        <returns>アクセス ポリシーの更新の次のステージ</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="DisallowKeyAllPermissions">
      ...
      <Docs>
        <summary>
            キーにアクセスする AD id のすべての権限を取り消します。
            </summary>
        <returns>アクセス ポリシーの更新の次のステージ</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisallowKeyPermissions">
      ...
      <Docs>
        <param name="permissions">アクセス許可を失効させる権限の一覧</param>
        <summary>
            キーにアクセスする AD id の権限の一覧を取り消してください。
            </summary>
        <returns>アクセス ポリシーの更新の次のステージ</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisallowSecretAllPermissions">
      ...
      <Docs>
        <summary>
            機密情報にアクセスする AD id のすべての権限を取り消します。
            </summary>
        <returns>アクセス ポリシーの更新の次のステージ</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisallowSecretPermissions">
      ...
      <Docs>
        <param name="permissions">アクセス許可を失効させる権限の一覧</param>
        <summary>
            機密情報にアクセスする AD id の権限の一覧を取り消してください。
            </summary>
        <returns>アクセス ポリシーの更新の次のステージ</returns>
        <remarks>To be added.</remarks>
      </Docs>
