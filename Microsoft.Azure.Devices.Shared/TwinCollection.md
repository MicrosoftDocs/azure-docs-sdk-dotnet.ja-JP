<Type Name="TwinCollection" FullName="Microsoft.Azure.Devices.Shared.TwinCollection">
  ...
  <Docs>
    <summary>
            プロパティのコレクションを表します<see cref="T:Microsoft.Azure.Devices.Shared.Twin" /></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            インスタンスを作成<see cref="T:Microsoft.Azure.Devices.Shared.TwinCollection" />です。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="twinJson">JSON フラグメントが対になったデータを格納します。</param>
        <summary>
            作成、<see cref="T:Microsoft.Azure.Devices.Shared.TwinCollection" />は JSON フラグメントを本文として使用します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="twinJson">JSON フラグメントが対になったデータを格納します。</param>
        <param name="metadataJson">メタデータを含む JSON フラグメントです。</param>
        <summary>
            作成、<see cref="T:Microsoft.Azure.Devices.Shared.TwinCollection" />本文とメタデータのフラグメントによって指定された JSON を使用します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Contains">
      ...
      <Docs>
        <param name="propertyName">検索するプロパティ</param>
        <summary>
            指定したプロパティが存在するかどうかを決定します。
            </summary>
        <returns>指定したプロパティが存在する場合は trueそれ以外の場合は false</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ToJson">
      ...
      <Docs>
        <param name="formatting">省略可能。 出力の JSON 文字列の書式設定します。</param>
        <summary>
            JSON 文字列として、TwinProperties を取得します。
            </summary>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            バージョンを取得します<see cref="T:Microsoft.Azure.Devices.Shared.TwinCollection" /></summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
