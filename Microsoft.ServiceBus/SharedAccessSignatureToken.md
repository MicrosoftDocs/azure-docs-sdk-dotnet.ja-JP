  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.ServiceBus.SharedAccessSignatureToken" />トークン文字列を指定しています。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.ServiceBus.SharedAccessSignatureToken" />指定したトークン文字列と有効期限を持つクラス。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="tokenString">トークン文字列。</param>
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.ServiceBus.SharedAccessSignatureToken" />クラスを指定した識別子とトークン文字列を使用します。 </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>新しいインスタンスを初期化、<see cref="T:Microsoft.ServiceBus.SharedAccessSignatureToken" />したトークン文字列の指定された、有効期限および対象ユーザー。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
