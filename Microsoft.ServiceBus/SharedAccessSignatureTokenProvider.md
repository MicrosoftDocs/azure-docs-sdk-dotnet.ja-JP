  ...
  <Members>
    ...
    <Member MemberName="GetPublisherSharedAccessSignature">
      ...
      <Docs>
        ...
        <summary />
        <returns>To be added.</returns>
        <remarks>このメソッドは、UTF8 エンコーディングが使用されていると想定します。</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetSharedAccessSignature">
      ...
      <Docs>
        ...
        <param name="sharedAccessKey">SAS キーの名前。</param>
        <param name="resource">リソースです。</param>
        <param name="tokenTimeToLive">トークンの TTL 値です。</param>
        <summary>指定したキー名、SAS キー、リソース、およびトークンの有効期間に関連付けられている共有アクセス署名を返します。</summary>
