<Type Name="IWithDefaultMessageTTL" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Subscription.Definition.IWithDefaultMessageTTL">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9731b-101">メッセージの TTL の既定値を定義できるように、サブスクリプション定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="9731b-101">The stage of the subscription definition allowing to define default TTL for messages.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithDefaultMessageTTL">
      ...
      <Docs>
        <param name="ttl"><span data-ttu-id="9731b-102">ライブの期間を時間です。</span><span class="sxs-lookup"><span data-stu-id="9731b-102">Time to live duration.</span></span></param>
        <summary>
            <span data-ttu-id="9731b-103">メッセージが切れるまでの期間を指定します。</span><span class="sxs-lookup"><span data-stu-id="9731b-103">Specifies the duration after which the message expires.</span></span>
            <span data-ttu-id="9731b-104">注: これが明示的にオーバーライドされない限り、既定の ttl は無期限 (TimeSpan.Max)。</span><span class="sxs-lookup"><span data-stu-id="9731b-104">Note: unless it is explicitly overridden the default ttl is infinite (TimeSpan.Max).</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9731b-105">サブスクリプション定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="9731b-105">The next stage of subscription definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>