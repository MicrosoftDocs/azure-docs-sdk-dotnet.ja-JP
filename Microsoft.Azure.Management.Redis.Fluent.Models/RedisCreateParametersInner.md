<Type Name="RedisCreateParametersInner" FullName="Microsoft.Azure.Management.Redis.Fluent.Models.RedisCreateParametersInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dbf47-101">パラメーターは、Redis 作成操作に指定します。</span><span class="sxs-lookup"><span data-stu-id="dbf47-101">Parameters supplied to the Create Redis operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dbf47-102">RedisCreateParametersInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="dbf47-102">Initializes a new instance of the RedisCreateParametersInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="sku"><span data-ttu-id="dbf47-103">展開する Redis cache の SKU。</span><span class="sxs-lookup"><span data-stu-id="dbf47-103">The SKU of the Redis cache to deploy.</span></span></param>
        <param name="location">To be added.</param>
        <param name="id">To be added.</param>
        <param name="name">To be added.</param>
        <param name="type">To be added.</param>
        <param name="tags">To be added.</param>
        <param name="redisConfiguration"><span data-ttu-id="dbf47-104">すべては Redis の設定です。</span><span class="sxs-lookup"><span data-stu-id="dbf47-104">All Redis Settings.</span></span> <span data-ttu-id="dbf47-105">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span><span class="sxs-lookup"><span data-stu-id="dbf47-105">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span></span></param>
        <param name="enableNonSslPort"><span data-ttu-id="dbf47-106">指定するかどうか、非 ssl Redis サーバーのポート (6379) が有効になっています。</span><span class="sxs-lookup"><span data-stu-id="dbf47-106">Specifies whether the non-ssl Redis server port (6379) is enabled.</span></span></param>
        <param name="tenantSettings"><span data-ttu-id="dbf47-107">tenantSettings</span><span class="sxs-lookup"><span data-stu-id="dbf47-107">tenantSettings</span></span></param>
        <param name="shardCount"><span data-ttu-id="dbf47-108">Premium クラスター キャッシュを作成するシャードの数。</span><span class="sxs-lookup"><span data-stu-id="dbf47-108">The number of shards to be created on a Premium Cluster Cache.</span></span></param>
        <param name="subnetId"><span data-ttu-id="dbf47-109">Redis cache を展開する仮想ネットワークのサブネットの完全なリソース ID。</span><span class="sxs-lookup"><span data-stu-id="dbf47-109">The full resource ID of a subnet in a virtual network to deploy the Redis cache in.</span></span> <span data-ttu-id="dbf47-110">たとえばの形式:/subscriptions/{subid} 必要な {resourcegroupname}/Microsoft です。{ネットワーク |ClassicNetwork}/VirtualNetworks、vnet1、サブネット/subnet1</span><span class="sxs-lookup"><span data-stu-id="dbf47-110">Example format: /subscriptions/{subid}/resourceGroups/{resourceGroupName}/Microsoft.{Network|ClassicNetwork}/VirtualNetworks/vnet1/subnets/subnet1</span></span></param>
        <param name="staticIP"><span data-ttu-id="dbf47-111">静的 IP アドレスです。</span><span class="sxs-lookup"><span data-stu-id="dbf47-111">Static IP address.</span></span> <span data-ttu-id="dbf47-112">既存の Azure 仮想ネットワーク内 Redis cache を展開するときに必要です。</span><span class="sxs-lookup"><span data-stu-id="dbf47-112">Required when deploying a Redis cache inside an existing Azure Virtual Network.</span></span></param>
        <summary>
            <span data-ttu-id="dbf47-113">RedisCreateParametersInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="dbf47-113">Initializes a new instance of the RedisCreateParametersInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EnableNonSslPort">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dbf47-114">取得または設定を指定するかどうか、非 ssl Redis サーバーのポート (6379) を有効にします。</span><span class="sxs-lookup"><span data-stu-id="dbf47-114">Gets or sets specifies whether the non-ssl Redis server port (6379) is enabled.</span></span>
            </summary>
    ...
    <Member MemberName="RedisConfiguration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dbf47-115">取得または Redis のすべての設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="dbf47-115">Gets or sets all Redis Settings.</span></span> <span data-ttu-id="dbf47-116">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span><span class="sxs-lookup"><span data-stu-id="dbf47-116">Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ShardCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dbf47-117">取得または Premium クラスター キャッシュを作成するシャードの数を設定します。</span><span class="sxs-lookup"><span data-stu-id="dbf47-117">Gets or sets the number of shards to be created on a Premium Cluster Cache.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dbf47-118">取得または設定を展開する Redis cache の SKU。</span><span class="sxs-lookup"><span data-stu-id="dbf47-118">Gets or sets the SKU of the Redis cache to deploy.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StaticIP">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dbf47-119">取得または静的 IP アドレスを設定します。</span><span class="sxs-lookup"><span data-stu-id="dbf47-119">Gets or sets static IP address.</span></span> <span data-ttu-id="dbf47-120">既存の Azure 仮想ネットワーク内 Redis cache を展開するときに必要です。</span><span class="sxs-lookup"><span data-stu-id="dbf47-120">Required when deploying a Redis cache inside an existing Azure Virtual Network.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubnetId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dbf47-121">取得またはで Redis cache を展開する仮想ネットワーク内のサブネットの完全なリソース ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="dbf47-121">Gets or sets the full resource ID of a subnet in a virtual network to deploy the Redis cache in.</span></span> <span data-ttu-id="dbf47-122">たとえばの形式:/subscriptions/{subid} 必要な {resourcegroupname}/Microsoft です。{ネットワーク |ClassicNetwork}/VirtualNetworks、vnet1、サブネット/subnet1</span><span class="sxs-lookup"><span data-stu-id="dbf47-122">Example format: /subscriptions/{subid}/resourceGroups/{resourceGroupName}/Microsoft.{Network|ClassicNetwork}/VirtualNetworks/vnet1/subnets/subnet1</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TenantSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dbf47-123">取得または設定 tenantSettings</span><span class="sxs-lookup"><span data-stu-id="dbf47-123">Gets or sets tenantSettings</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dbf47-124">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="dbf47-124">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="dbf47-125">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="dbf47-125">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
