<Type Name="SharedKeyTableCanonicalizer" FullName="Microsoft.WindowsAzure.Storage.Core.Auth.SharedKeyTableCanonicalizer">
  ...
  <Docs>
    <summary>
            テーブル サービスの共有キー認証スキームで署名するための適切な標準形式に HTTP 要求データを変換するカノニカライザーを表します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Instance">
      ...
      <Docs>
        <summary>
            静的インスタンスを取得、<see cref="T:Microsoft.WindowsAzure.Storage.Core.Auth.SharedKeyTableCanonicalizer" />オブジェクト。
            </summary>
