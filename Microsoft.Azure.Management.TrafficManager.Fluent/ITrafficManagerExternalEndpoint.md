<Type Name="ITrafficManagerExternalEndpoint" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.ITrafficManagerExternalEndpoint">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="884bf-101">Azure traffic manager プロファイルの外部エンドポイントの変更できないクライアント側表現。</span><span class="sxs-lookup"><span data-stu-id="884bf-101">An immutable client-side representation of an Azure traffic manager profile external endpoint.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Fqdn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884bf-102">外部エンドポイントの完全修飾 DNS 名を取得します。</span><span class="sxs-lookup"><span data-stu-id="884bf-102">Gets the fully qualified DNS name of the external endpoint.</span></span>
            </summary>
    ...
    <Member MemberName="SourceTrafficLocation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884bf-103">エンドポイントを処理するトラフィックの場所を取得します。</span><span class="sxs-lookup"><span data-stu-id="884bf-103">Gets the location of the traffic that the endpoint handles.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
