<Type Name="ITrafficManagerNestedProfileEndpoint" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.ITrafficManagerNestedProfileEndpoint">
  ...
  <Docs>
    <summary>
            Azure traffic manager プロファイルの変更できないクライアント側表現には、プロファイルのエンドポイントが入れ子になった。
            </summary>
  ...
  <Members>
    <Member MemberName="MinimumChildEndpointCount">
      ...
      <Docs>
        <summary>
            オンラインで正常であると入れ子になったプロファイルを検討する子エンドポイントの数を取得します。
            </summary>
    ...
    <Member MemberName="NestedProfileId">
      ...
      <Docs>
        <summary>
            取得、入れ子になった traffic manager プロファイル リソース id です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
