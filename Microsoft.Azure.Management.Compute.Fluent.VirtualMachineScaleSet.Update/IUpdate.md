<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="013e5-101">仮想マシンのスケールの全体は、更新プログラムを設定します。</span><span class="sxs-lookup"><span data-stu-id="013e5-101">The entirety of the virtual machine scale set update.</span></span>
            </summary>
