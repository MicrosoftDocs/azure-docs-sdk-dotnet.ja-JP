  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdateAsync">
      ...
      <Docs>
        ...
        <param name="elasticPoolName">
            処理するには、Azure SQL 弾力性プールの名前 (更新または作成) します。
            </param>
        ...
        <summary>
            新しい Azure SQL 弾力性プールを作成するか、既存の Azure SQL 弾力性プールを更新します。
            </summary>
    ...
    <Member MemberName="DeleteAsync">
      ...
      <Docs>
        ...
        <param name="elasticPoolName">
            削除するには、Azure SQL 弾力性プールの名前。
            </param>
        <param name="cancellationToken">
            キャンセル トークン。
            </param>
        <summary>
            Azure SQL 弾力性プールを削除します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetDatabaseAsync">
      ...
      <Docs>
        ...
        <summary>
            Azure SQL 弾力性プール内で Azure SQL データベースに関する情報を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListActivityAsync">
      ...
      <Docs>
        ...
        <param name="elasticPoolName">
            現在のアクティビティを取得する対象の Azure SQL 弾力性プールの名前。
            </param>
        <param name="cancellationToken">
            キャンセル トークン。
            </param>
        <summary>
            Azure SQL 弾力性プールのアクティビティに関する情報を返します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListDatabaseActivityAsync">
      ...
      <Docs>
        ...
        <summary>
            Azure SQL 弾力性プール内での Azure SQL データベースの利用状況に関する情報を返します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListDatabasesAsync">
      ...
      <Docs>
        ...
        <summary>
            Azure SQL 弾力性プール内での Azure SQL データベースに関する情報を返します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
