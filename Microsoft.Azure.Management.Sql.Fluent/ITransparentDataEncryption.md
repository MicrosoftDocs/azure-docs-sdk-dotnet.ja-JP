<Type Name="ITransparentDataEncryption" FullName="Microsoft.Azure.Management.Sql.Fluent.ITransparentDataEncryption">
  ...
  <Docs>
    <summary>
            Azure SQL データベースの TransparentDataEncryption の変更できないクライアント側表現。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ListActivities">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return>Azure SQL データベース透過的なデータ暗号化のアクティビティ。</return>
      </Docs>
    </Member>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            Azure SQL データベース透過的なデータ暗号化の状態を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UpdateStatus">
      ...
      <Docs>
        <param name="transparentDataEncryptionState">設定するデータの暗号化の状態です。</param>
        <summary>
            透過的なデータ暗号化の状態の状態を更新します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>ModifyState 後に新しい暗号化の設定。</return>
      </Docs>
    </Member>
  </Members>
</Type>