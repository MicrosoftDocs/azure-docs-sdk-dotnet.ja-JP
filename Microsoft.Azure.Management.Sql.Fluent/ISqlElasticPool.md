<Type Name="ISqlElasticPool" FullName="Microsoft.Azure.Management.Sql.Fluent.ISqlElasticPool">
  ...
  <Docs>
    <summary>
            Azure SQL ElasticPool の変更できないクライアント側表現。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="DatabaseDtuMax">
      ...
      <Docs>
        <summary>
            1 つの SQL Azure データベースが使用できる最大の DTU を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseDtuMin">
      ...
      <Docs>
        <summary>
            すべての SQL Azure データベースのことが保証されます最小 DTU を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Dtu">
      ...
      <Docs>
        <summary>
            SQL Azure データベースの弾力性プールの共有の DTU の合計を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetDatabase">
      ...
      <Docs>
        <param name="databaseName">検索するデータベースの名前です。</param>
        <summary>
            弾力性プール内の特定のデータベースを取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>弾力性プール内の特定のデータベースに関する情報。</return>
      </Docs>
    </Member>
    <Member MemberName="ListActivities">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>弾力性プールのアクティビティに関する情報。</return>
      </Docs>
    </Member>
    <Member MemberName="ListDatabaseActivities">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>弾力性プール データベースのアクティビティに関する情報。</return>
      </Docs>
    </Member>
    <Member MemberName="ListDatabases">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>弾力性プール内のデータベースに関する情報。</return>
      </Docs>
    </Member>
    <Member MemberName="SqlServerName">
      ...
      <Docs>
        <summary>
            この弾力性プールが所属する SQL Server の名前を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
