<Type Name="ISqlElasticPool" FullName="Microsoft.Azure.Management.Sql.Fluent.ISqlElasticPool">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="44d99-101">Azure SQL ElasticPool の変更できないクライアント側表現。</span><span class="sxs-lookup"><span data-stu-id="44d99-101">An immutable client-side representation of an Azure SQL ElasticPool.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CreationDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44d99-102">Azure SQL 弾力性プールの作成日を取得します。</span><span class="sxs-lookup"><span data-stu-id="44d99-102">Gets the creation date of the Azure SQL Elastic Pool.</span></span>
            </summary>
    ...
    <Member MemberName="DatabaseDtuMax">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44d99-103">1 つの SQL Azure データベースが使用できる最大の DTU を取得します。</span><span class="sxs-lookup"><span data-stu-id="44d99-103">Gets the maximum DTU any one SQL Azure database can consume.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DatabaseDtuMin">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44d99-104">すべての SQL Azure データベースのことが保証されます最小 DTU を取得します。</span><span class="sxs-lookup"><span data-stu-id="44d99-104">Gets the minimum DTU all SQL Azure Databases are guaranteed.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Delete">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44d99-105">弾力性プールをサーバーから削除します。</span><span class="sxs-lookup"><span data-stu-id="44d99-105">Deletes the elastic pool from the server.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Dtu">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44d99-106">SQL Azure データベースの弾力性プールの共有の DTU の合計を取得します。</span><span class="sxs-lookup"><span data-stu-id="44d99-106">Gets The total shared DTU for the SQL Azure Database Elastic Pool.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Edition">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44d99-107">Azure SQL 弾力性プールのエディションを取得します。</span><span class="sxs-lookup"><span data-stu-id="44d99-107">Gets the edition of Azure SQL Elastic Pool.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetDatabase">
      ...
      <Docs>
        <param name="databaseName"><span data-ttu-id="44d99-108">検索するデータベースの名前です。</span><span class="sxs-lookup"><span data-stu-id="44d99-108">Name of the database to look into.</span></span></param>
        <summary>
            <span data-ttu-id="44d99-109">弾力性プール内の特定のデータベースを取得します。</span><span class="sxs-lookup"><span data-stu-id="44d99-109">Gets the specific database in the elastic pool.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="44d99-110">弾力性プール内の特定のデータベースに関する情報。</span><span class="sxs-lookup"><span data-stu-id="44d99-110">The information about specific database in elastic pool.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListActivities">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="44d99-111">弾力性プールのアクティビティに関する情報。</span><span class="sxs-lookup"><span data-stu-id="44d99-111">The information about elastic pool activities.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListDatabaseActivities">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="44d99-112">弾力性プール データベースのアクティビティに関する情報。</span><span class="sxs-lookup"><span data-stu-id="44d99-112">The information about elastic pool database activities.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListDatabases">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="44d99-113">弾力性プール内のデータベースに関する情報。</span><span class="sxs-lookup"><span data-stu-id="44d99-113">The information about databases in elastic pool.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="SqlServerName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44d99-114">この弾力性プールが所属する SQL Server の名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="44d99-114">Gets name of the SQL Server to which this elastic pool belongs.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44d99-115">Azure SQL 弾力性プールの状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="44d99-115">Gets the state of the Azure SQL Elastic Pool.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageMB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="44d99-116">Mb SQL Azure データベース弾力性プール記憶域の上限を取得します。</span><span class="sxs-lookup"><span data-stu-id="44d99-116">Gets the storage limit for the SQL Azure Database Elastic Pool in MB.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
