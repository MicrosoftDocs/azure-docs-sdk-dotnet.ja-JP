<Type Name="ISqlFirewallRule" FullName="Microsoft.Azure.Management.Sql.Fluent.ISqlFirewallRule">
  ...
  <Docs>
    <summary>
            Azure SQL Server FirewallRule の変更できないクライアント側表現。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="EndIPAddress">
      ...
      <Docs>
        <summary>
            Azure SQL Server のファイアウォール ルールの (IPv4 形式) で終了 IP アドレスを取得します。
            </summary>
    ...
    <Member MemberName="Kind">
      ...
      <Docs>
        <summary>
            このファイアウォール規則を含む SQL Server の種類を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Region">
      ...
      <Docs>
        <summary>
            このファイアウォール規則を含む SQL Server の領域を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SqlServerName">
      ...
      <Docs>
        <summary>
            このファイアウォール規則が所属する SQL Server の名前を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartIPAddress">
      ...
      <Docs>
        <summary>
            Azure SQL Server のファイアウォール ルールの (IPv4 形式) で、開始 IP アドレスを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
