<Type Name="IWithDtu" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlElasticPool.Definition.IWithDtu">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b523c-101">弾力性プールの共有の DTU の数を設定するように SQL 弾力性プール定義します。</span><span class="sxs-lookup"><span data-stu-id="b523c-101">The SQL Elastic Pool definition to set the number of shared DTU for elastic pool.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithDtu">
      ...
      <Docs>
        <param name="dtu"><span data-ttu-id="b523c-102">合計では、SQL Azure データベースの弾力性プールの DTU が共有されます。</span><span class="sxs-lookup"><span data-stu-id="b523c-102">Total shared DTU for the SQL Azure Database Elastic Pool.</span></span></param>
        <summary>
            <span data-ttu-id="b523c-103">SQL Azure データベースの弾力性プールの合計の DTU の共有を設定します。</span><span class="sxs-lookup"><span data-stu-id="b523c-103">Sets the total shared DTU for the SQL Azure Database Elastic Pool.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="b523c-104">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="b523c-104">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>