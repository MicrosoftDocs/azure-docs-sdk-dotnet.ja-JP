<Type Name="ConnectionCreateOrUpdateProperties" FullName="Microsoft.Azure.Management.Automation.Models.ConnectionCreateOrUpdateProperties">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ConnectionCreateOrUpdateProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で ConnectionCreateOrUpdateProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="FieldDefinitionValues">
      ...
      <Docs>
        <summary>
            省略可能。 取得または接続のフィールド定義のプロパティを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
