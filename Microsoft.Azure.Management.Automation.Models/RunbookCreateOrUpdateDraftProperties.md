<Type Name="RunbookCreateOrUpdateDraftProperties" FullName="Microsoft.Azure.Management.Automation.Models.RunbookCreateOrUpdateDraftProperties">
  ...
  <Docs>
    <summary>
            作成または更新 dratft runbook のプロパティに指定するパラメーターです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RunbookCreateOrUpdateDraftProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で RunbookCreateOrUpdateDraftProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Draft">
      ...
      <Docs>
        <summary>
            必須。 取得またはドラフト runbook のプロパティを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LogActivityTrace">
      ...
      <Docs>
        <summary>
            省略可能。 取得または runbook のアクティビティ レベルのトレース オプションを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
