<Type Name="DscConfigurationCreateOrUpdateParameters" FullName="Microsoft.Azure.Management.Automation.Models.DscConfigurationCreateOrUpdateParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DscConfigurationCreateOrUpdateParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で DscConfigurationCreateOrUpdateParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            必須。 取得または設定の構成を作成またはプロパティを更新します。
            </summary>
