<Type Name="JobStreamListParameters" FullName="Microsoft.Azure.Management.Automation.Models.JobStreamListParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            JobStreamListParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Time">
      ...
      <Docs>
        <summary>
            省略可能。 時間フィルターを使用すると、この時刻より後に作成されたストリーム レコードを取得できます。 値は、datetime 形式の文字列に UTC ISO 8601 形式で定義されているようにする必要があります。 たとえば、2014-09-25T17:49:17.2252204Z
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
