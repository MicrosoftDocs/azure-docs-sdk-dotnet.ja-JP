<Type Name="RunbookCreateOrUpdateProperties" FullName="Microsoft.Azure.Management.Automation.Models.RunbookCreateOrUpdateProperties">
  ...
  <Docs>
    <summary>
            Runbook の作成または更新のプロパティに指定するパラメーターです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            RunbookCreateOrUpdateProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で RunbookCreateOrUpdateProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="PublishContentLink">
      ...
      <Docs>
        <summary>
            必須。 取得または公開された runbook のコンテンツのリンクを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
