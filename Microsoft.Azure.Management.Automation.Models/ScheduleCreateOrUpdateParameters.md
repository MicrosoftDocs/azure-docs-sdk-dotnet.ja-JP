<Type Name="ScheduleCreateOrUpdateParameters" FullName="Microsoft.Azure.Management.Automation.Models.ScheduleCreateOrUpdateParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ScheduleCreateOrUpdateParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で ScheduleCreateOrUpdateParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConvertTimesFromTimeZone">
      ...
      <Docs>
        <summary>
            省略可能。 時間が指定されましたが、指定されたタイム ゾーンで指定された場合は true。 時刻は UTC である場合は false。
            </summary>
