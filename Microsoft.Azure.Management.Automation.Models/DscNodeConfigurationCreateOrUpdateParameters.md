<Type Name="DscNodeConfigurationCreateOrUpdateParameters" FullName="Microsoft.Azure.Management.Automation.Models.DscNodeConfigurationCreateOrUpdateParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            DscNodeConfigurationCreateOrUpdateParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で DscNodeConfigurationCreateOrUpdateParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="IncrementNodeConfigurationBuild">
      ...
      <Docs>
        <summary>
            省略可能。 場合に、新しいビルドの設定を取得または NodeConfiguration のバージョンが必要です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
