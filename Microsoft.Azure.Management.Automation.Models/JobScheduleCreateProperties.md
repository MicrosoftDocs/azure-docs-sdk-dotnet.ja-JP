<Type Name="JobScheduleCreateProperties" FullName="Microsoft.Azure.Management.Automation.Models.JobScheduleCreateProperties">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            JobScheduleCreateProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で JobScheduleCreateProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="RunOn">
      ...
      <Docs>
        <summary>
            省略可能。 取得またはスケジュールされたジョブを実行するハイブリッド worker グループを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
