<Type Name="StoreOperationsBatchCompletedEvent" FullName="Microsoft.WindowsAzure.MobileServices.Sync.StoreOperationsBatchCompletedEvent">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2a016-101">ローカル ストアに対して、操作のバッチが完了したときにパブリッシュされているモバイル サービスのイベントです。</span><span class="sxs-lookup"><span data-stu-id="2a016-101">A mobile service event that is published when an operations batch against the local store is completed.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Batch">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a016-102">操作のバッチ インスタンス。</span><span class="sxs-lookup"><span data-stu-id="2a016-102">The operations batch instance.</span></span>
            </summary>
    ...
    <Member MemberName="EventName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a016-103">ストアの操作のバッチには、イベント名が完了しました。</span><span class="sxs-lookup"><span data-stu-id="2a016-103">The store operation batch completed event name.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a016-104">イベントの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="2a016-104">Gets the event name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
