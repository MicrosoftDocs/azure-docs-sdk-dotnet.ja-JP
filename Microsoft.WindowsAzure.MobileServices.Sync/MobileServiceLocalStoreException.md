  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="innerException"> 現在の例外または null 参照の原因となった例外</param>
        <summary>
            インスタンスを初期化します。<see cref="T:Microsoft.WindowsAzure.MobileServices.Sync.MobileServiceLocalStoreException" /></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
