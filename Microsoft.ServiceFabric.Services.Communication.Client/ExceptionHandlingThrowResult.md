<Type Name="ExceptionHandlingThrowResult" FullName="Microsoft.ServiceFabric.Services.Communication.Client.ExceptionHandlingThrowResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f9225-101">クライアントからサービスへの要求を再試行できない場合、結果を処理する例外を示す</span><span class="sxs-lookup"><span data-stu-id="f9225-101">Specifies the exception handling result when the request from client to service cannot be retried</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ExceptionToThrow">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f9225-102">この例外は、クライアントがスローされます。</span><span class="sxs-lookup"><span data-stu-id="f9225-102">The exception that should be thrown to the client.</span></span>
            </summary>
        <value><span data-ttu-id="f9225-103">例外をスローするには</span><span class="sxs-lookup"><span data-stu-id="f9225-103">Exception to throw</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
