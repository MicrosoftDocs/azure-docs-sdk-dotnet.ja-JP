<Type Name="IVirtualMachineScaleSet" FullName="Microsoft.Azure.Management.Compute.Fluent.IVirtualMachineScaleSet">
  ...
  <Docs>
    <summary>
            Azure の仮想マシン スケールの変更できないクライアント側表現を設定します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ComputerNamePrefix">
      ...
      <Docs>
        <summary>
            スケール セット内の仮想マシン名のプレフィックスを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Deallocate">
      ...
      <Docs>
        <summary>
            スケール セット内の仮想マシンをシャット ダウンし、コンピューティング リソースを解放します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DeallocateAsync">
      ...
      <Docs>
        ...
        <summary>
            スケール セット内の仮想マシンをシャット ダウンし、非同期的に、コンピューティング リソースを解放します。
            </summary>
    ...
    <Member MemberName="GetNetworkInterfaceByInstanceId">
      ...
      <Docs>
        <param name="instanceId">仮想マシン スケール セット vm インスタンスの id。</param>
    ...
    <Member MemberName="GetPrimaryInternalLoadBalancer">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <throws>IOException IO の例外。</throws>
        <return>
            スケールには、仮想マシンのプライマリ ネットワーク インターフェイスに関連付けられている内部ロード バランサーを設定します。
            </return>
      </Docs>
    </Member>
    <Member MemberName="GetPrimaryInternetFacingLoadBalancer">
      ...
      <Docs>
        ...
        <throws>IOException IO の例外。</throws>
        <return>
            スケールには、仮想マシンのプライマリ ネットワーク インターフェイスに関連付けられたインターネットに接続するロード バランサーを設定します。
            </return>
      </Docs>
    </Member>
    ...
    <Member MemberName="IsManagedDiskEnabled">
      ...
      <Docs>
        <summary>
            仮想マシン スケール セットのディスク (os、データ) ため管理されているディスクが使用される場合は true を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListAvailableSkus">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return>
            特定の SKU に許可されている最小値と最大の仮想マシン インスタンスを含む、仮想マシン スケール セットの使用可能な Sku をします。
            </return>
      </Docs>
    </Member>
    <Member MemberName="ListNetworkInterfaces">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>スケール セット内のすべての仮想マシン インスタンスに関連付けられているネットワーク インターフェイスです。</return>
      </Docs>
    </Member>
    <Member MemberName="ListNetworkInterfacesByInstanceId">
      ...
      <Docs>
        <param name="virtualMachineInstanceId">インスタンス ID。</param>
        <summary>
    ...
    <Member MemberName="ListPrimaryInternalLoadBalancerBackends">
      ...
      <Docs>
        ...
        <throws>IOException IO の例外。</throws>
        <return>
            仮想マシン スケール セット内のプライマリ ネットワーク インターフェイスに関連付けられている内部ロード バランサーのバックエンドです。
            </return>
      </Docs>
    </Member>
    <Member MemberName="ListPrimaryInternalLoadBalancerInboundNatPools">
      ...
      <Docs>
        ...
        <throws>IOException IO の例外。</throws>
        <return>
            存在する場合は、仮想マシン スケール セット内のプライマリ ネットワーク インターフェイスに関連付けられている内部ロード バランサーの着信 NAT プールします。
            </return>
      </Docs>
    </Member>
    <Member MemberName="ListPrimaryInternetFacingLoadBalancerBackends">
      ...
      <Docs>
        ...
        <throws>IOException IO の例外。</throws>
        <return>
            スケールには、仮想マシンのプライマリ ネットワーク インターフェイスに関連付けられたインターネットに接続するロード バランサーのバックエンドを設定します。
            </return>
      </Docs>
    </Member>
    <Member MemberName="ListPrimaryInternetFacingLoadBalancerInboundNatPools">
      ...
      <Docs>
        ...
        <throws>IOException IO の例外。</throws>
        <return>
            インターネットに接続されたはロード バランサーの着信 NAT プールが仮想マシン スケール セット内のプライマリ ネットワーク インターフェイスに関連付けられたです。
            </return>
      </Docs>
    </Member>
    ...
    <Member MemberName="OverProvisionEnabled">
      ...
      <Docs>
        <summary>
            経由でのプロビジョニングが有効な場合、仮想マシンは、false のそれ以外の場合は true。 を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PowerOffAsync">
      ...
      <Docs>
        <param name="cancellationToken">To be added.</param>
        <summary>
            電源オフ (停止) スケールには、仮想マシンを非同期的に設定します。
            </summary>
        <returns>To be added.</returns>
        <remarks>
            (ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです。)。
    ...
    <Member MemberName="PrimaryPublicIPAddressIds">
      ...
      <Docs>
        <summary>
            IOException IO の例外を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
        <return>
            スケール セットの主要なインターネットに接続するロード バランサーに関連付けられているパブリック IP アドレスの Id の一覧を取得します。
            </return>
      </Docs>
    </Member>
    <Member MemberName="Reimage">
      ...
      <Docs>
        <summary>
            再イメージ (インストールされているオペレーティング システムのバージョンを更新する) スケール セット内の仮想マシン。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReimageAsync">
      ...
      <Docs>
        <param name="cancellationToken">To be added.</param>
        <summary>
            再イメージ (インストールされているオペレーティング システムのバージョンを更新する) スケールには、仮想マシンを非同期的に設定します。
            </summary>
        <returns>To be added.</returns>
        <remarks>
            (ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです。)。
    ...
    <Member MemberName="VirtualMachines">
      ...
      <Docs>
        <summary>
            仮想マシン スケール セット内のインスタンスを管理するエントリ ポイントを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
