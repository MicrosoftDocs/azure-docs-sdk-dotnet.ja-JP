<Type Name="IVirtualMachineExtensionImageType" FullName="Microsoft.Azure.Management.Compute.Fluent.IVirtualMachineExtensionImageType">
  ...
  <Docs>
    <summary>
            Azure の仮想マシン拡張機能のイメージの種類の変更できないクライアント側表現。
            </summary>
  ...
  <Members>
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            仮想マシン拡張機能のイメージの種類のリソース ID を取得します。
            </summary>
    ...
    <Member MemberName="RegionName">
      ...
      <Docs>
        <summary>
            どの仮想マシン イメージの種類の拡張機能が利用可能な領域を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Versions">
      ...
      <Docs>
        <summary>
            仮想マシン イメージの拡張機能のバージョンがこの種類で利用できるを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
