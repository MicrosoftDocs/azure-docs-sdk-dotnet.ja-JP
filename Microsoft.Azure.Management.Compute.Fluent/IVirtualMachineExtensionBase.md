<Type Name="IVirtualMachineExtensionBase" FullName="Microsoft.Azure.Management.Compute.Fluent.IVirtualMachineExtensionBase">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="aab24-101">仮想マシンに関連付けられている拡張機能の変更できないクライアント側表現。</span><span class="sxs-lookup"><span data-stu-id="aab24-101">An immutable client-side representation of an extension associated with virtual machine.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AutoUpgradeMinorVersionEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aab24-102">この拡張機能に基づいている拡張機能のイメージの場合は、新しいマイナー バージョンを公開するときに自動的にアップグレードするこの拡張機能が構成されている場合は true を取得します。</span><span class="sxs-lookup"><span data-stu-id="aab24-102">Gets true if this extension is configured to upgrade automatically when a new minor version of the extension image that this extension based on is published.</span></span>
            </summary>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aab24-103">仮想マシンの拡張機能のプロビジョニングの状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="aab24-103">Gets the provisioning state of the virtual machine extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aab24-104">キー値のペアとして、仮想マシン拡張機能のパブリック、設定を取得します。</span><span class="sxs-lookup"><span data-stu-id="aab24-104">Gets the public settings of the virtual machine extension as key value pairs.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicSettingsAsJsonString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aab24-105">JSON 文字列として仮想マシンの拡張機能のパブリック、設定を取得します。</span><span class="sxs-lookup"><span data-stu-id="aab24-105">Gets the public settings of the virtual machine extension as a JSON string.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublisherName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aab24-106">この拡張機能が作成された仮想マシン拡張機能のイメージのパブリッシャーの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="aab24-106">Gets the publisher name of the virtual machine extension image this extension is created from.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aab24-107">この仮想マシンの拡張機能のタグを取得します。</span><span class="sxs-lookup"><span data-stu-id="aab24-107">Gets the tags for this virtual machine extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TypeName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aab24-108">この拡張機能が作成された仮想マシン拡張機能のイメージの型名を取得します。</span><span class="sxs-lookup"><span data-stu-id="aab24-108">Gets the type name of the virtual machine extension image this extension is created from.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VersionName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aab24-109">この拡張機能が作成された仮想マシン拡張機能のイメージのバージョン名を取得します。</span><span class="sxs-lookup"><span data-stu-id="aab24-109">Gets the version name of the virtual machine extension image this extension is created from.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
