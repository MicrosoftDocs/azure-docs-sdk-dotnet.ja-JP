<Type Name="ISnapshot" FullName="Microsoft.Azure.Management.Compute.Fluent.ISnapshot">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fed65-101">Azure の不変のクライアント側表現は、スナップショットを管理します。</span><span class="sxs-lookup"><span data-stu-id="fed65-101">An immutable client-side representation of an Azure managed snapshot.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CreationMethod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fed65-102">スナップショットの作成方法を取得します。</span><span class="sxs-lookup"><span data-stu-id="fed65-102">Gets the snapshot creation method.</span></span>
            </summary>
    ...
    <Member MemberName="GrantAccess">
      ...
      <Docs>
        <param name="accessDurationInSeconds"><span data-ttu-id="fed65-103">秒単位でアクセス期間です。</span><span class="sxs-lookup"><span data-stu-id="fed65-103">The access duration in seconds.</span></span></param>
        <summary>
            <span data-ttu-id="fed65-104">スナップショットへのアクセスを許可します。</span><span class="sxs-lookup"><span data-stu-id="fed65-104">Grants access to the snapshot.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="fed65-105">読み取り専用 SAS URI のスナップショットにします。</span><span class="sxs-lookup"><span data-stu-id="fed65-105">The read-only SAS URI to the snapshot.</span></span></return>
      </Docs>
    </Member>
    ...
    <Member MemberName="OSType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fed65-106">指定したスナップショットには、オペレーティング システムの種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="fed65-106">Gets the type of operating system in the snapshot.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RevokeAccess">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fed65-107">スナップショットにアクセス権を取り消します。</span><span class="sxs-lookup"><span data-stu-id="fed65-107">Revoke access granted to the snapshot.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="SizeInGB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fed65-108">GB のディスクのサイズを取得します。</span><span class="sxs-lookup"><span data-stu-id="fed65-108">Gets disk size in GB.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fed65-109">スナップショットの SKU の種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="fed65-109">Gets the snapshot SKU type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Source">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fed65-110">スナップショットの作成元のソースの詳細を取得します。</span><span class="sxs-lookup"><span data-stu-id="fed65-110">Gets the details of the source from which snapshot is created.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
