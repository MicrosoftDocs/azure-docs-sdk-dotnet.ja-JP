<Type Name="ISnapshot" FullName="Microsoft.Azure.Management.Compute.Fluent.ISnapshot">
  ...
  <Docs>
    <summary>
            Azure の不変のクライアント側表現は、スナップショットを管理します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="GrantAccess">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return>読み取り専用 SAS URI のスナップショットにします。</return>
      </Docs>
    </Member>
    ...
    <Member MemberName="OSType">
      ...
      <Docs>
        <summary>
            指定したスナップショットには、オペレーティング システムの種類を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
