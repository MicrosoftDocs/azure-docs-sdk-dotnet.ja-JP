<Type Name="IVirtualMachineCustomImage" FullName="Microsoft.Azure.Management.Compute.Fluent.IVirtualMachineCustomImage">
  ...
  <Docs>
    <summary>
            Azure の仮想マシンのカスタム イメージの変更できないクライアント側表現。
            </summary>
  ...
  <Members>
    <Member MemberName="DataDiskImages">
      ...
      <Docs>
        <summary>
            ディスクの LUN でインデックス付けされた、このイメージにデータ ディスク イメージを取得します。
            </summary>
    ...
    <Member MemberName="IsCreatedFromVirtualMachine">
      ...
      <Docs>
        <summary>
            このイメージは、仮想マシンのキャプチャによって作成された場合は true を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OSDiskImage">
      ...
      <Docs>
        <summary>
            このイメージにオペレーティング システムのディスク イメージを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SourceVirtualMachineId">
      ...
      <Docs>
        <summary>
            このイメージは、その仮想マシンをキャプチャして作成した場合は、仮想マシンの ID を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
