<Type Name="IVirtualMachineOffer" FullName="Microsoft.Azure.Management.Compute.Fluent.IVirtualMachineOffer">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b13dd-101">仮想マシン イメージのオファーを表します。</span><span class="sxs-lookup"><span data-stu-id="b13dd-101">Represents a virtual machine image offer.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Publisher">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b13dd-102">この仮想マシンのイメージ パッケージの発行元を取得します。</span><span class="sxs-lookup"><span data-stu-id="b13dd-102">Gets the publisher of this virtual machine image offer.</span></span>
            </summary>
    ...
    <Member MemberName="Region">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b13dd-103">この仮想マシン イメージのプランが格納されている領域を取得します。</span><span class="sxs-lookup"><span data-stu-id="b13dd-103">Gets the region where this virtual machine image offer is available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Skus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b13dd-104">このプランで使用可能な Sku の仮想マシン イメージを取得します。</span><span class="sxs-lookup"><span data-stu-id="b13dd-104">Gets virtual machine image SKUs available in this offer.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
