<Type Name="IVirtualMachineImages" FullName="Microsoft.Azure.Management.Compute.Fluent.IVirtualMachineImages">
  ...
  <Docs>
    <summary>
            仮想マシン イメージの管理 API へのエントリ ポイントです。
            </summary>
  ...
  <Members>
    <Member MemberName="GetImage">
      ...
      <Docs>
        ...
        <param name="publisherName">パブリッシャーの名前です。</param>
        <param name="offerName">名前を提供します。</param>
        <param name="skuName">SKU の名前です。</param>
        ...
        <remarks>To be added.</remarks>
        <return>バーチャル マシンのイメージです。</return>
      </Docs>
    </Member>
    <Member MemberName="GetImage">
    ...
    <Member MemberName="Publishers">
      ...
      <Docs>
        <summary>
            仮想マシン イメージのパブリッシャーへのエントリ ポイントを取得します。
            </summary>
