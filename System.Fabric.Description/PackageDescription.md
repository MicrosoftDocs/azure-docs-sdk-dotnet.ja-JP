<Type Name="PackageDescription" FullName="System.Fabric.Description.PackageDescription">
  ...
  <Docs>
    <summary>
      <para>すべてのパッケージの説明の基本クラスを表します。</para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="Path">
      ...
      <Docs>
        <summary>
          <para>パッケージへのパスを取得します。</para>
        </summary>
        <value>
          <para>パッケージへのパス。</para>
        </value>
        <remarks>このプロパティは今後使用しません。
            パス プロパティを使用して<see cref="T:System.Fabric.CodePackage" />、<see cref="T:System.Fabric.ConfigurationPackage" />または<see cref="T:System.Fabric.DataPackage" />型です。</remarks>
      </Docs>
    </Member>
