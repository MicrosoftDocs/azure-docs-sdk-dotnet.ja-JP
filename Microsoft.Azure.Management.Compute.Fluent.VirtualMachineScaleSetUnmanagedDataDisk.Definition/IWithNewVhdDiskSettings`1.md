<Type Name="IWithNewVhdDiskSettings&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSetUnmanagedDataDisk.Definition.IWithNewVhdDiskSettings&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="895a4-101">この定義をアタッチした後に戻るに親の定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="895a4-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="895a4-102">により、ステージは、新しい VHD に基づき、管理されていないディスクを構成します。</span><span class="sxs-lookup"><span data-stu-id="895a4-102">The stage that allows configure the unmanaged disk based on new VHD.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithCaching">
      ...
      <Docs>
        <param name="cachingType"><span data-ttu-id="895a4-103">型のキャッシュ ディスク。</span><span class="sxs-lookup"><span data-stu-id="895a4-103">The disk caching type.</span></span> <span data-ttu-id="895a4-104">使用可能な値が含まれます。 'None'、'ReadOnly'、'ReadWrite' です。</span><span class="sxs-lookup"><span data-stu-id="895a4-104">Possible values include: 'None', 'ReadOnly', 'ReadWrite'.</span></span></param>
        <summary>
            <span data-ttu-id="895a4-105">アンマネージ データ ディスクのキャッシュの種類を指定します。</span><span class="sxs-lookup"><span data-stu-id="895a4-105">Specifies the caching type for the unmanaged data disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="895a4-106">アンマネージ データ ディスクの定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="895a4-106">The next stage of unmanaged data disk definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithLun">
      ...
      <Docs>
        <param name="lun"><span data-ttu-id="895a4-107">論理ユニットの数です。</span><span class="sxs-lookup"><span data-stu-id="895a4-107">The logical unit number.</span></span></param>
        <summary>
            <span data-ttu-id="895a4-108">アンマネージ データ ディスクの論理ユニット番号を指定します。</span><span class="sxs-lookup"><span data-stu-id="895a4-108">Specifies the logical unit number for the unmanaged data disk.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="895a4-109">アンマネージ データ ディスクの定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="895a4-109">The next stage of unmanaged data disk definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>