<Type Name="BatchLocationQuotaInner" FullName="Microsoft.Azure.Management.Batch.Fluent.Models.BatchLocationQuotaInner">
  ...
  <Docs>
    <summary>
            クォータは、特定のサブスクリプションのバッチ処理領域に関連付けられています。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            BatchLocationQuotaInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="accountQuota">指定した領域で、サブスクリプションで作成されるバッチ アカウントの数。</param>
        <summary>
            BatchLocationQuotaInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="AccountQuota">
      ...
      <Docs>
        <summary>
            取得または指定した領域で、サブスクリプションで作成されるバッチ アカウントの数を設定します。
            </summary>
