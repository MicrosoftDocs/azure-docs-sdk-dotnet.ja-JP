  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="keyName">
            処理されるサーバー キーの名前 (更新または作成した)。 'Vault_key_version' の形式にするには、キー名が必要です。 たとえば、keyId が https://YourVaultName.vault.azure.net/keys/YourKeyName/01234567890123456789012345678901 の場合は、サーバーのキー名形式でなければなりません: YourVaultName_YourKeyName_01234567890123456789012345678901
            </param>
