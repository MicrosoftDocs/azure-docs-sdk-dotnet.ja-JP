<Type Name="BackupLongTermRetentionVaultsOperationsExtensions" FullName="Microsoft.Azure.Management.Sql.BackupLongTermRetentionVaultsOperationsExtensions">
  ...
  <Docs>
    <summary>
            BackupLongTermRetentionVaultsOperations の拡張メソッド。
            </summary>
  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="parameters">
            バックアップの長期的な保存の資格情報コンテナーを更新する必須パラメーター
            </param>
        <summary>
            サーバー バックアップの長期的な保有期間資格情報コンテナーを更新します。
            </summary>
    ...
    <Member MemberName="Get">
      ...
      <Docs>
        ...
        <summary>
            サーバー バックアップの長期的な保有期間資格情報コンテナーを取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
