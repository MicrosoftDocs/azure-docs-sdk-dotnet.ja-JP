<Type Name="NodeTypeDescription" FullName="Microsoft.Azure.Management.ServiceFabric.Models.NodeTypeDescription">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="870d4-101">ノードの型を記述、クラスターでは、各ノードの種類は、クラスター内のノードのサブツール セットを表します。</span><span class="sxs-lookup"><span data-stu-id="870d4-101">Describes a node type in the cluster, each node type represents sub set of nodes in the cluster</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-102">NodeTypeDescription クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="870d4-102">Initializes a new instance of the NodeTypeDescription class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="870d4-103">ノードの種類の名前</span><span class="sxs-lookup"><span data-stu-id="870d4-103">Name of the node type</span></span></param>
        <param name="clientConnectionEndpointPort"><span data-ttu-id="870d4-104">TCP クラスター管理用エンドポイント ポート</span><span class="sxs-lookup"><span data-stu-id="870d4-104">The TCP cluster management endpoint port</span></span></param>
        <param name="httpGatewayEndpointPort"><span data-ttu-id="870d4-105">HTTP クラスター管理用エンドポイント ポート</span><span class="sxs-lookup"><span data-stu-id="870d4-105">The HTTP cluster management endpoint port</span></span></param>
        <param name="isPrimary"><span data-ttu-id="870d4-106">これを主ノード型としてマークします。</span><span class="sxs-lookup"><span data-stu-id="870d4-106">Mark this as the primary node type</span></span></param>
        <param name="vmInstanceCount"><span data-ttu-id="870d4-107">ノードの種類のノード インスタンスの数</span><span class="sxs-lookup"><span data-stu-id="870d4-107">The number of node instances in the node type</span></span></param>
        <param name="placementProperties"><span data-ttu-id="870d4-108">特定のサービス (ワークロード) を実行する場所を示すために使用できるノードの種類のノードに適用される配置タグ</span><span class="sxs-lookup"><span data-stu-id="870d4-108">The placement tags applied to nodes in the node type, which can be used to indicate where certain services (workload) should run</span></span></param>
        <param name="capacities"><span data-ttu-id="870d4-109">ノードの種類のノードに適用される容量タグ、クラスター リソース マネージャーを使用してこれらのタグがノード a のリソースの量を理解するには</span><span class="sxs-lookup"><span data-stu-id="870d4-109">The capacity tags applied to the nodes in the node type, the cluster resource manager uses these tags to understand how much of a resource a node has</span></span></param>
        <param name="durabilityLevel"><span data-ttu-id="870d4-110">Nodetype の持続性のレベルです。</span><span class="sxs-lookup"><span data-stu-id="870d4-110">Nodetype durability Level.</span></span> <span data-ttu-id="870d4-111">使用可能な値が含まれます: 'ブロンズ'、'銀色'、'Gold'</span><span class="sxs-lookup"><span data-stu-id="870d4-111">Possible values include: 'Bronze', 'Silver', 'Gold'</span></span></param>
        <param name="applicationPorts"><span data-ttu-id="870d4-112">アプリケーションで使用されるポート</span><span class="sxs-lookup"><span data-stu-id="870d4-112">Ports used by applications</span></span></param>
        <param name="ephemeralPorts"><span data-ttu-id="870d4-113">システムによって割り当てアプリケーション ポート</span><span class="sxs-lookup"><span data-stu-id="870d4-113">System assgined application ports</span></span></param>
        <param name="reverseProxyEndpointPort"><span data-ttu-id="870d4-114">リバース プロキシによって使用されるエンドポイント</span><span class="sxs-lookup"><span data-stu-id="870d4-114">Endpoint used by reverse proxy</span></span></param>
        <summary>
            <span data-ttu-id="870d4-115">NodeTypeDescription クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="870d4-115">Initializes a new instance of the NodeTypeDescription class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ApplicationPorts">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-116">取得またはアプリケーションで使用されるポートの設定</span><span class="sxs-lookup"><span data-stu-id="870d4-116">Gets or sets ports used by applications</span></span>
            </summary>
    ...
    <Member MemberName="Capacities">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-117">取得または設定容量タグ ノードに適用、ノードの種類のクラスター リソース マネージャーで使用してこれらのタグがノード a のリソースの量を理解するには</span><span class="sxs-lookup"><span data-stu-id="870d4-117">Gets or sets the capacity tags applied to the nodes in the node type, the cluster resource manager uses these tags to understand how much of a resource a node has</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ClientConnectionEndpointPort">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-118">取得または TCP のクラスター管理用エンドポイント ポートを設定</span><span class="sxs-lookup"><span data-stu-id="870d4-118">Gets or sets the TCP cluster management endpoint port</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DurabilityLevel">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-119">取得または nodetype の持続性のレベルを設定します。</span><span class="sxs-lookup"><span data-stu-id="870d4-119">Gets or sets nodetype durability Level.</span></span> <span data-ttu-id="870d4-120">使用可能な値が含まれます: 'ブロンズ'、'銀色'、'Gold'</span><span class="sxs-lookup"><span data-stu-id="870d4-120">Possible values include: 'Bronze', 'Silver', 'Gold'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EphemeralPorts">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-121">取得またはシステムによって割り当てアプリケーション ポートの設定</span><span class="sxs-lookup"><span data-stu-id="870d4-121">Gets or sets system assgined application ports</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HttpGatewayEndpointPort">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-122">取得またはクラスター管理用エンドポイント ポートを HTTP に設定</span><span class="sxs-lookup"><span data-stu-id="870d4-122">Gets or sets the HTTP cluster management endpoint port</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsPrimary">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-123">取得または設定はこの主ノード型としてマークします。</span><span class="sxs-lookup"><span data-stu-id="870d4-123">Gets or sets mark this as the primary node type</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-124">取得または設定 ノードの種類の名前</span><span class="sxs-lookup"><span data-stu-id="870d4-124">Gets or sets name of the node type</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PlacementProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-125">取得または設定の特定のサービス (ワークロード) を実行する場所を示すために使用できるノードの種類のノードに適用される配置タグ</span><span class="sxs-lookup"><span data-stu-id="870d4-125">Gets or sets the placement tags applied to nodes in the node type, which can be used to indicate where certain services (workload) should run</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReverseProxyEndpointPort">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-126">取得またはリバース プロキシによって使用されるエンドポイントの設定</span><span class="sxs-lookup"><span data-stu-id="870d4-126">Gets or sets endpoint used by reverse proxy</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-127">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="870d4-127">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="870d4-128">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="870d4-128">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName="VmInstanceCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="870d4-129">取得またはノードの種類のノード インスタンスの数を設定</span><span class="sxs-lookup"><span data-stu-id="870d4-129">Gets or sets the number of node instances in the node type</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
