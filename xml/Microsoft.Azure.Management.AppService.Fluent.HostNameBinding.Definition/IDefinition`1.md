<Type Name="IDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.HostNameBinding.Definition.IDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="99171-101">最終的な Attachable.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="99171-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="99171-102">ホスト名バインド定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="99171-102">The entirety of a hostname binding definition.</span></span>
            </summary>
