<Type Name="Column" FullName="Microsoft.Azure.OperationalInsights.Models.Column">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b1d48-101">テーブルの列です。</span><span class="sxs-lookup"><span data-stu-id="b1d48-101">A table column.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="b1d48-102">テーブル内の列です。</span><span class="sxs-lookup"><span data-stu-id="b1d48-102">A column in a table.</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b1d48-103">列のクラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b1d48-103">Initializes a new instance of the Column class.</span></span>
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="b1d48-104">この列の名前。</span><span class="sxs-lookup"><span data-stu-id="b1d48-104">The name of this column.</span></span></param>
        <param name="type"><span data-ttu-id="b1d48-105">この列のデータ型。</span><span class="sxs-lookup"><span data-stu-id="b1d48-105">The data type of this column.</span></span></param>
        <summary>
            <span data-ttu-id="b1d48-106">列のクラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b1d48-106">Initializes a new instance of the Column class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b1d48-107">取得またはこの列の名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="b1d48-107">Gets or sets the name of this column.</span></span>
            </summary>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b1d48-108">取得またはこの列のデータ型を設定します。</span><span class="sxs-lookup"><span data-stu-id="b1d48-108">Gets or sets the data type of this column.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
