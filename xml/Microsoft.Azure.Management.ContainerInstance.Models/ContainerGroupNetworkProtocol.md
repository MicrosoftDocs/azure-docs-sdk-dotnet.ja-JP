<Type Name="ContainerGroupNetworkProtocol" FullName="Microsoft.Azure.Management.ContainerInstance.Models.ContainerGroupNetworkProtocol">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e2f69-101">ContainerGroupNetworkProtocol の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="e2f69-101">Defines values for ContainerGroupNetworkProtocol.</span></span>
            </summary>
