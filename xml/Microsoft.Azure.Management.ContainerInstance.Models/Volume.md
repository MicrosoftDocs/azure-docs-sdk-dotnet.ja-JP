<Type Name="Volume" FullName="Microsoft.Azure.Management.ContainerInstance.Models.Volume">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="94cca-101">ボリュームのプロパティです。</span><span class="sxs-lookup"><span data-stu-id="94cca-101">The properties of the volume.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="94cca-102">ボリューム クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="94cca-102">Initializes a new instance of the Volume class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="94cca-103">ボリュームの名前。</span><span class="sxs-lookup"><span data-stu-id="94cca-103">The name of the volume.</span></span></param>
        <param name="azureFile"><span data-ttu-id="94cca-104">Azure ファイルのボリュームの名前。</span><span class="sxs-lookup"><span data-stu-id="94cca-104">The name of the Azure File volume.</span></span></param>
        <param name="emptyDir"><span data-ttu-id="94cca-105">空のディレクトリのボリューム。</span><span class="sxs-lookup"><span data-stu-id="94cca-105">The empty directory volume.</span></span></param>
        <summary>
            <span data-ttu-id="94cca-106">ボリューム クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="94cca-106">Initializes a new instance of the Volume class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AzureFile">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="94cca-107">取得または Azure ファイルのボリュームの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="94cca-107">Gets or sets the name of the Azure File volume.</span></span>
            </summary>
    ...
    <Member MemberName="EmptyDir">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="94cca-108">取得または空のディレクトリのボリュームを設定します。</span><span class="sxs-lookup"><span data-stu-id="94cca-108">Gets or sets the empty directory volume.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="94cca-109">取得またはボリュームの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="94cca-109">Gets or sets the name of the volume.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="94cca-110">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="94cca-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="94cca-111">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="94cca-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
