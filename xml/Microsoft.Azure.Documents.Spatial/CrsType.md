<Type Name="CrsType" FullName="Microsoft.Azure.Documents.Spatial.CrsType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="23c4f-101">Cosmos DB の Azure サービスで参照システムの調整の種類。</span><span class="sxs-lookup"><span data-stu-id="23c4f-101">Type of Coordinate Reference System in the Azure Cosmos DB service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Linked">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="23c4f-102">リファレンス システムの座標は、リンクによって指定されます。</span><span class="sxs-lookup"><span data-stu-id="23c4f-102">Coordinate Reference System is specified by link.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Named">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="23c4f-103">リファレンス システムの座標は、名前によって指定されます。</span><span class="sxs-lookup"><span data-stu-id="23c4f-103">Coordinate Reference System is specified by name.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Unspecified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="23c4f-104">リファレンス システムの調整はできます geometry の想定されません。</span><span class="sxs-lookup"><span data-stu-id="23c4f-104">No Coordinate Reference System can be assumed for a geometry.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
