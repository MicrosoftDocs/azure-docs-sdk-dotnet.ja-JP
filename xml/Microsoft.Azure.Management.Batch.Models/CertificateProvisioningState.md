<Type Name="CertificateProvisioningState" FullName="Microsoft.Azure.Management.Batch.Models.CertificateProvisioningState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="277c7-101">CertificateProvisioningState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="277c7-101">Defines values for CertificateProvisioningState.</span></span>
            </summary>
