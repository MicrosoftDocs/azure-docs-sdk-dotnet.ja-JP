<Type Name="BatchAccountDeleteHeaders" FullName="Microsoft.Azure.Management.Batch.Models.BatchAccountDeleteHeaders">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="53ebd-101">削除操作のヘッダーを定義します。</span><span class="sxs-lookup"><span data-stu-id="53ebd-101">Defines headers for Delete operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="53ebd-102">BatchAccountDeleteHeaders クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="53ebd-102">Initializes a new instance of the BatchAccountDeleteHeaders class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="53ebd-103">非同期操作の状態を確認するために使用されたリソースの URL です。</span><span class="sxs-lookup"><span data-stu-id="53ebd-103">The URL of the resource used to check the status of the asynchronous operation.</span></span></param>
        <param name="retryAfter"><span data-ttu-id="53ebd-104">非同期操作の状態を確認するための推奨されています。</span><span class="sxs-lookup"><span data-stu-id="53ebd-104">Suggested delay to check the status of the asynchronous operation.</span></span> <span data-ttu-id="53ebd-105">値は、遅延時間を秒単位で指定する整数です。</span><span class="sxs-lookup"><span data-stu-id="53ebd-105">The value is an integer that specifies the delay in seconds.</span></span></param>
        <summary>
            <span data-ttu-id="53ebd-106">BatchAccountDeleteHeaders クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="53ebd-106">Initializes a new instance of the BatchAccountDeleteHeaders class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="53ebd-107">取得または非同期操作の状態を確認するために使用されたリソースの URL を設定します。</span><span class="sxs-lookup"><span data-stu-id="53ebd-107">Gets or sets the URL of the resource used to check the status of the asynchronous operation.</span></span>
            </summary>
    ...
    <Member MemberName="RetryAfter">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="53ebd-108">取得または非同期操作の状態を確認する推奨の遅延を設定します。</span><span class="sxs-lookup"><span data-stu-id="53ebd-108">Gets or sets suggested delay to check the status of the asynchronous operation.</span></span> <span data-ttu-id="53ebd-109">値は、遅延時間を秒単位で指定する整数です。</span><span class="sxs-lookup"><span data-stu-id="53ebd-109">The value is an integer that specifies the delay in seconds.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
