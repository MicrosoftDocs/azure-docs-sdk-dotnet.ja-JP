<Type Name="CertificateFormat" FullName="Microsoft.Azure.Management.Batch.Models.CertificateFormat">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="03ada-101">CertificateFormat の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="03ada-101">Defines values for CertificateFormat.</span></span>
            </summary>
