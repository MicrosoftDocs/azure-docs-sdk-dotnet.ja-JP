<Type Name="CertificateStoreLocation" FullName="Microsoft.Azure.Management.Batch.Models.CertificateStoreLocation">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="568b5-101">CertificateStoreLocation の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="568b5-101">Defines values for CertificateStoreLocation.</span></span>
            </summary>
