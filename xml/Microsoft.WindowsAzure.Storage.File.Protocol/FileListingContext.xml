<Type Name="FileListingContext" FullName="Microsoft.WindowsAzure.Storage.File.Protocol.FileListingContext">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b52ed-101">ファイルの一覧作成操作のパラメーターのセットを提供します。</span><span class="sxs-lookup"><span data-stu-id="b52ed-101">Provides a set of parameters for a file listing operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="maxResults"><span data-ttu-id="b52ed-102">返される結果の最大数。</span><span class="sxs-lookup"><span data-stu-id="b52ed-102">The maximum number of results to return.</span></span></param>
        <summary>
            <span data-ttu-id="b52ed-103"><see cref="T:Microsoft.WindowsAzure.Storage.File.Protocol.FileListingContext" /> クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b52ed-103">Initializes a new instance of the <see cref="T:Microsoft.WindowsAzure.Storage.File.Protocol.FileListingContext" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
