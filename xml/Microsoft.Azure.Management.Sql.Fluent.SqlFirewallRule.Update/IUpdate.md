<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlFirewallRule.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e473e-101">変更可能なすべての設定を含む、SqlFirewallRule の更新操作のテンプレートです。</span><span class="sxs-lookup"><span data-stu-id="e473e-101">The template for a SqlFirewallRule update operation, containing all the settings that can be modified.</span></span>
            </summary>
