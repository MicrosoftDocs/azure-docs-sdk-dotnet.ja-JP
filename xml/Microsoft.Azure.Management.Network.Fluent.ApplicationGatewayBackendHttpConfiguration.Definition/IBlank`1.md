<Type Name="IBlank&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayBackendHttpConfiguration.Definition.IBlank&lt;ReturnT&gt;">
  ...
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="bdfc3-101">この定義をアタッチした後に戻るには、親アプリケーション ゲートウェイ定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="bdfc3-101">The stage of the parent application gateway definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="bdfc3-102">アプリケーション ゲートウェイ バックエンド HTTP 構成の最初の段階です。</span><span class="sxs-lookup"><span data-stu-id="bdfc3-102">The first stage of an application gateway backend HTTP configuration.</span></span>
            </summary>
