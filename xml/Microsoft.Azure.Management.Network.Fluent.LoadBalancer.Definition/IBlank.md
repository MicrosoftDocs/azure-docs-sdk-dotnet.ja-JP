<Type Name="IBlank" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancer.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cba22-101">ロード バランサーの定義の最初の段階です。</span><span class="sxs-lookup"><span data-stu-id="cba22-101">The first stage of a load balancer definition.</span></span>
            </summary>
