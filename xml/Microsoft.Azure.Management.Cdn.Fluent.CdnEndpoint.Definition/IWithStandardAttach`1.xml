<Type Name="IWithStandardAttach&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Cdn.Fluent.CdnEndpoint.Definition.IWithStandardAttach&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="324d8-101">この定義をアタッチした後に戻るには、親 CDN プロファイル定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="324d8-101">The stage of the parent CDN profile definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="324d8-102">CDN プロファイル標準 Akamai や標準 Verizon のエンドポイント定義の最終段階です。</span><span class="sxs-lookup"><span data-stu-id="324d8-102">The final stage of the CDN profile Standard Akamai or Standard Verizon endpoint definition.</span></span>
            <span data-ttu-id="324d8-103">この段階で、残りの省略可能な設定を指定することができます、または CDN プロファイルのエンドポイントの定義は、親 CDN プロファイル定義に関連付けることができます。</span><span class="sxs-lookup"><span data-stu-id="324d8-103">At this stage, any remaining optional settings can be specified, or the CDN profile endpoint definition can be attached to the parent CDN profile definition.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithCompressionEnabled">
      ...
      <Docs>
        <param name="compressionEnabled"><span data-ttu-id="324d8-104">True の場合は、圧縮が有効なります。</span><span class="sxs-lookup"><span data-stu-id="324d8-104">If true then compression will be enabled.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-105">圧縮状態を設定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-105">Sets the compression state.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-106">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-106">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    ...
    <Member MemberName="WithContentTypeToCompress">
      ...
      <Docs>
        <param name="contentTypeToCompress"><span data-ttu-id="324d8-107">一覧に追加するコンテンツの種類。</span><span class="sxs-lookup"><span data-stu-id="324d8-107">A content type to compress to add to the list.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-108">圧縮するコンテンツの種類を 1 つを指定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-108">Specifies a single content type to compress.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-109">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-109">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithCustomDomain">
      ...
      <Docs>
        <param name="hostName"><span data-ttu-id="324d8-110">カスタム ドメインのホスト名。</span><span class="sxs-lookup"><span data-stu-id="324d8-110">A custom domain host name.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-111">新しい CDN エンドポイント内でカスタム ドメインを追加します。</span><span class="sxs-lookup"><span data-stu-id="324d8-111">Adds a new CDN custom domain within an endpoint.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-112">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-112">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithGeoFilter">
      ...
      <Docs>
        <param name="relativePath"><span data-ttu-id="324d8-113">相対パス。</span><span class="sxs-lookup"><span data-stu-id="324d8-113">A relative path.</span></span></param>
        <param name="action"><span data-ttu-id="324d8-114">地理的フィルター アクション。</span><span class="sxs-lookup"><span data-stu-id="324d8-114">A geo filter action.</span></span></param>
        <param name="countryCode"><span data-ttu-id="324d8-115">ISO 2 文字の国コードです。</span><span class="sxs-lookup"><span data-stu-id="324d8-115">An ISO 2 letter country code.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-116">地理的フィルター リストに 1 つのエントリを追加します。</span><span class="sxs-lookup"><span data-stu-id="324d8-116">Adds a single entry to the geo filters list.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-117">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-117">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithGeoFilter">
      ...
      <Docs>
        <param name="relativePath"><span data-ttu-id="324d8-118">相対パス。</span><span class="sxs-lookup"><span data-stu-id="324d8-118">A relative path.</span></span></param>
        <param name="action"><span data-ttu-id="324d8-119">アクションの値。</span><span class="sxs-lookup"><span data-stu-id="324d8-119">An action value.</span></span></param>
        <param name="countryCodes"><span data-ttu-id="324d8-120">ISO 2 文字の国コードの一覧。</span><span class="sxs-lookup"><span data-stu-id="324d8-120">A list of the ISO 2 letter country codes.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-121">一覧については、指定された国 geo フィルター一覧を設定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-121">Sets the geo filters list for the specified countries list.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>
            <span data-ttu-id="324d8-122">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです。)。</span><span class="sxs-lookup"><span data-stu-id="324d8-122">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
        <return><span data-ttu-id="324d8-123">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-123">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithGeoFilters">
      ...
      <Docs>
        <param name="geoFilters"><span data-ttu-id="324d8-124">地理的を設定する ボックスの一覧がフィルター処理します。</span><span class="sxs-lookup"><span data-stu-id="324d8-124">The Geo filters list to set.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-125">地理的フィルター一覧を設定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-125">Sets the geo filters list.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>
            <span data-ttu-id="324d8-126">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです。)。</span><span class="sxs-lookup"><span data-stu-id="324d8-126">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
        <return><span data-ttu-id="324d8-127">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-127">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHostHeader">
      ...
      <Docs>
        <param name="hostHeader"><span data-ttu-id="324d8-128">ホスト ヘッダーです。</span><span class="sxs-lookup"><span data-stu-id="324d8-128">A host header.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-129">ホスト ヘッダーを指定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-129">Specifies the host header.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-130">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-130">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHttpAllowed">
      ...
      <Docs>
        <param name="httpAllowed"><span data-ttu-id="324d8-131">true の場合は、HTTP トラフィックが許可されます。</span><span class="sxs-lookup"><span data-stu-id="324d8-131">If true then HTTP traffic will be allowed.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-132">HTTP トラフィックが許可されたかどうかを指定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-132">Specifies if HTTP traffic is allowed.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-133">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-133">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHttpPort">
      ...
      <Docs>
        <param name="httpPort"><span data-ttu-id="324d8-134">ポート番号です。</span><span class="sxs-lookup"><span data-stu-id="324d8-134">A port number.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-135">HTTP トラフィック用のポートを指定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-135">Specifies the port for HTTP traffic.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-136">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-136">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHttpsAllowed">
      ...
      <Docs>
        <param name="httpsAllowed"><span data-ttu-id="324d8-137">場合は Https トラフィックを true に設定が許可されます。</span><span class="sxs-lookup"><span data-stu-id="324d8-137">If set to true Https traffic will be allowed.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-138">HTTPS トラフィックが許可されたかどうかを指定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-138">Specifies if HTTPS traffic is allowed.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-139">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-139">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHttpsPort">
      ...
      <Docs>
        <param name="httpsPort"><span data-ttu-id="324d8-140">HTTPS ポート番号です。</span><span class="sxs-lookup"><span data-stu-id="324d8-140">HTTPS port number.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-141">HTTPS トラフィック用のポートを指定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-141">Specifies the port for HTTPS traffic.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-142">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-142">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithOriginPath">
      ...
      <Docs>
        <param name="originPath"><span data-ttu-id="324d8-143">配信元のパス。</span><span class="sxs-lookup"><span data-stu-id="324d8-143">An origin path.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-144">配信元のパスを指定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-144">Specifies the origin path.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-145">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-145">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithQueryStringCachingBehavior">
      ...
      <Docs>
        <param name="cachingBehavior"><span data-ttu-id="324d8-146">クエリ文字列のキャッシュの動作の値を設定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-146">The query string caching behavior value to set.</span></span></param>
        <summary>
            <span data-ttu-id="324d8-147">クエリ文字列のキャッシュ動作を設定します。</span><span class="sxs-lookup"><span data-stu-id="324d8-147">Sets the query string caching behavior.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="324d8-148">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="324d8-148">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>