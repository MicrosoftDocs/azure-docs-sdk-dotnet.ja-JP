<Type Name="SharedKeyTableCanonicalizer" FullName="Microsoft.WindowsAzure.Storage.Core.Auth.SharedKeyTableCanonicalizer">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="45184-101">テーブル サービスの共有キー認証スキームで署名するための適切な標準形式に HTTP 要求データを変換するカノニカライザーを表します。</span><span class="sxs-lookup"><span data-stu-id="45184-101">Represents a canonicalizer that converts HTTP request data into a standard form appropriate for signing via the Shared Key authentication scheme for the Table service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AuthorizationScheme">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="45184-102">正規化に使用する認証スキームを取得します。</span><span class="sxs-lookup"><span data-stu-id="45184-102">Gets the authorization scheme used for canonicalization.</span></span>
            </summary>
        <value><span data-ttu-id="45184-103">正規化に使用する認証スキームです。</span><span class="sxs-lookup"><span data-stu-id="45184-103">The authorization scheme used for canonicalization.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CanonicalizeHttpRequest">
      ...
      <Docs>
        <param name="request"><span data-ttu-id="45184-104">HTTP 要求に署名する必要があります。</span><span class="sxs-lookup"><span data-stu-id="45184-104">The HTTP request that needs to be signed.</span></span></param>
        <param name="accountName"><span data-ttu-id="45184-105">HTTP 要求にアクセスするストレージ アカウントの名前。</span><span class="sxs-lookup"><span data-stu-id="45184-105">The name of the storage account that the HTTP request will access.</span></span></param>
        <summary>
            <span data-ttu-id="45184-106">指定された HTTP 要求データを署名するための適切な標準形式に変換します。</span><span class="sxs-lookup"><span data-stu-id="45184-106">Converts the specified HTTP request data into a standard form appropriate for signing.</span></span>
            </summary>
        <returns><span data-ttu-id="45184-107">署名するための適切な標準形式の HTTP 要求データを含む正規化文字列です。</span><span class="sxs-lookup"><span data-stu-id="45184-107">The canonicalized string containing the HTTP request data in a standard form appropriate for signing.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Instance">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="45184-108">静的インスタンスを取得、<see cref="T:Microsoft.WindowsAzure.Storage.Core.Auth.SharedKeyTableCanonicalizer" />オブジェクト。</span><span class="sxs-lookup"><span data-stu-id="45184-108">Gets a static instance of the <see cref="T:Microsoft.WindowsAzure.Storage.Core.Auth.SharedKeyTableCanonicalizer" /> object.</span></span>
            </summary>
        <value><span data-ttu-id="45184-109">クラスの静的なインスタンス。</span><span class="sxs-lookup"><span data-stu-id="45184-109">The static instance of the class.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
