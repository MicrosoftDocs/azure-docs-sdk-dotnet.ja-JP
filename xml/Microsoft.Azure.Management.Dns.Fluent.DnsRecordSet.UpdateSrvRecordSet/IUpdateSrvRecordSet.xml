<Type Name="IUpdateSrvRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateSrvRecordSet.IUpdateSrvRecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="01ec8-101">SRV レコードの全体は、親 DNS ゾーンの更新プログラムの一部として更新を設定します。</span><span class="sxs-lookup"><span data-stu-id="01ec8-101">The entirety of a SRV record set update as a part of parent DNS zone update.</span></span>
            </summary>
