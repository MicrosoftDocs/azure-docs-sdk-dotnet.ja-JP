<Type Name="PowerState" FullName="Microsoft.Azure.Management.Compute.Fluent.PowerState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e9ca1-101">PowerState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="e9ca1-101">Define values for PowerState</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Deallocated">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e9ca1-102">PowerState の PowerState/割り当て解除された静的な値。</span><span class="sxs-lookup"><span data-stu-id="e9ca1-102">Static value PowerState/deallocated for PowerState.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Deallocating">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e9ca1-103">静的な値が PowerState の PowerState/割り当て解除します。</span><span class="sxs-lookup"><span data-stu-id="e9ca1-103">Static value PowerState/deallocating for PowerState.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="FromInstanceView">
      ...
      <Docs>
        <param name="virtualMachineInstanceView"><span data-ttu-id="e9ca1-104">仮想マシン インスタンス ビュー</span><span class="sxs-lookup"><span data-stu-id="e9ca1-104">the virtual machine instance view</span></span></param>
        <summary>
            <span data-ttu-id="e9ca1-105">電源の状態に対応する仮想マシン インスタンス ビューの状態エントリから PowerState のインスタンスを作成します。</span><span class="sxs-lookup"><span data-stu-id="e9ca1-105">Creates an instance of PowerState from the virtual machine instance view status entry corresponding to the power state.</span></span>
            </summary>
        <returns><span data-ttu-id="e9ca1-106">PowerState</span><span class="sxs-lookup"><span data-stu-id="e9ca1-106">the PowerState</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Running">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e9ca1-107">静的な値の PowerState PowerState/実行中です。</span><span class="sxs-lookup"><span data-stu-id="e9ca1-107">Static value PowerState/running for PowerState.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Starting">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e9ca1-108">静的な値が PowerState for PowerState/以降します。</span><span class="sxs-lookup"><span data-stu-id="e9ca1-108">Static value PowerState/starting for PowerState.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Stopped">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e9ca1-109">静的な値が PowerState の PowerState/が停止しました。</span><span class="sxs-lookup"><span data-stu-id="e9ca1-109">Static value PowerState/stopped for PowerState.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Unknown">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e9ca1-110">静的な値の PowerState PowerState/不明。</span><span class="sxs-lookup"><span data-stu-id="e9ca1-110">Static value PowerState/unknown for PowerState.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
