<Type Name="IVirtualMachineScaleSetUnmanagedDataDisk" FullName="Microsoft.Azure.Management.Compute.Fluent.IVirtualMachineScaleSetUnmanagedDataDisk">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fef83-101">スケール セットのアンマネージ データ ディスクの定義と更新プログラムの段階について説明します。</span><span class="sxs-lookup"><span data-stu-id="fef83-101">Describes definition and update stages of unmanaged data disk of a scale set.</span></span>
            </summary>
