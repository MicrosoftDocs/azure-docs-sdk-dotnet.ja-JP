<Type Name="VirtualMachineSizesOperationsExtensions" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineSizesOperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="82536-101">VirtualMachineSizesOperations の拡張メソッド。</span><span class="sxs-lookup"><span data-stu-id="82536-101">Extension methods for VirtualMachineSizesOperations.</span></span>
            </summary>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="82536-102">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="82536-102">The operations group for this extension method.</span></span>
            </param>
        <param name="location">
            <span data-ttu-id="82536-103">どの仮想マシンのサイズと場所は、クエリを実行します。</span><span class="sxs-lookup"><span data-stu-id="82536-103">The location upon which virtual-machine-sizes is queried.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="82536-104">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="82536-104">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="82536-105">場所でサブスクリプションのすべての利用可能な仮想マシンのサイズを一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="82536-105">Lists all available virtual machine sizes for a subscription in a location.</span></span>
            </summary>
