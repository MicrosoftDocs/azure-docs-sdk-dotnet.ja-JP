<Type Name="IVirtualMachinePublisher" FullName="Microsoft.Azure.Management.Compute.Fluent.IVirtualMachinePublisher">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="60962-101">仮想マシン イメージのパブリッシャーを表します。</span><span class="sxs-lookup"><span data-stu-id="60962-101">Represents a virtual machine image publisher.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ExtensionTypes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="60962-102">このパブリッシャーから仮想マシン イメージの拡張を取得します。</span><span class="sxs-lookup"><span data-stu-id="60962-102">Gets the virtual machine image extensions from this publisher.</span></span>
            </summary>
    ...
    <Member MemberName="Offers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="60962-103">このパブリッシャーからのオファーを取得します。</span><span class="sxs-lookup"><span data-stu-id="60962-103">Gets the offers from this publisher.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Region">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="60962-104">このパブリッシャーからの仮想マシン イメージが使用可能な地域を取得します。</span><span class="sxs-lookup"><span data-stu-id="60962-104">Gets the region where virtual machine images from this publisher are available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
