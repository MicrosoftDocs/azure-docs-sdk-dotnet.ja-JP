<Type Name="ConnectionType" FullName="Microsoft.Azure.Devices.Client.Transport.ConnectionType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5e073-101">DeviceClientConnectionStatusManager でサポートされている接続の種類</span><span class="sxs-lookup"><span data-stu-id="5e073-101">Connection types supported by DeviceClientConnectionStatusManager</span></span>
            </summary>
