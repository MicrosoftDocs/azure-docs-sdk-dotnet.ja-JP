<Type Name="ConnectionStatusChangeResult" FullName="Microsoft.Azure.Devices.Client.Transport.ConnectionStatusChangeResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d1d36-101">接続の状態を変更する DeviceClient でサポートされる結果</span><span class="sxs-lookup"><span data-stu-id="d1d36-101">Connection status change result supported by DeviceClient</span></span>
            </summary>
