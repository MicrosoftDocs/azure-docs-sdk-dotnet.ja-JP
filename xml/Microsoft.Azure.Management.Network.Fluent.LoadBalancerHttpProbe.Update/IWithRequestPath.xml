<Type Name="IWithRequestPath" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerHttpProbe.Update.IWithRequestPath">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1c787-101">HTTP プローブのステージでは、パスを変更する、HTTP 要求を監視するプローブの許可を更新します。</span><span class="sxs-lookup"><span data-stu-id="1c787-101">The stage of the HTTP probe update allowing to modify the HTTP request path for the probe to monitor.</span></span>
            </summary>
