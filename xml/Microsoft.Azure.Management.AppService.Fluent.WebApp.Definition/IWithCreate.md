<Type Name="IWithCreate" FullName="Microsoft.Azure.Management.AppService.Fluent.WebApp.Definition.IWithCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="27f43-101">新しい web アプリを作成するための十分な入力でサイト定義を指定する省略可能な追加の入力を公開する、クラウドでの展開スロット/です。</span><span class="sxs-lookup"><span data-stu-id="27f43-101">A site definition with sufficient inputs to create a new web app / deployments slot in the cloud, but exposing additional optional inputs to specify.</span></span>
            </summary>
