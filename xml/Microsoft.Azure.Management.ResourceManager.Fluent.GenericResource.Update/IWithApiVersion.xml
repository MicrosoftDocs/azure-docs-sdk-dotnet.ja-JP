<Type Name="IWithApiVersion" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.GenericResource.Update.IWithApiVersion">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="95463-101">汎用リソース用のテンプレートは、リソース プロバイダー API のバージョンを指定するための操作を更新します。</span><span class="sxs-lookup"><span data-stu-id="95463-101">The template for a generic resource update operation for specifying the resource provider API version.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithApiVersion">
      ...
      <Docs>
        <param name="apiVersion"><span data-ttu-id="95463-102">apiVersion API バージョン</span><span class="sxs-lookup"><span data-stu-id="95463-102">apiVersion the API version</span></span></param>
        <summary>
            <span data-ttu-id="95463-103">リソース プロバイダーの API バージョンを指定します。</span><span class="sxs-lookup"><span data-stu-id="95463-103">Specifies the API version of the resource provider.</span></span>
            </summary>
        <returns><span data-ttu-id="95463-104">汎用リソース更新の次のステージ</span><span class="sxs-lookup"><span data-stu-id="95463-104">the next stage of the generic resource update</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
