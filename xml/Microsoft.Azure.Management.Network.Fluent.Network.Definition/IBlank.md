<Type Name="IBlank" FullName="Microsoft.Azure.Management.Network.Fluent.Network.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ac38c-101">仮想ネットワーク定義の最初の段階です。</span><span class="sxs-lookup"><span data-stu-id="ac38c-101">The first stage of a virtual network definition.</span></span>
            </summary>
