<Type Name="IDefinition" FullName="Microsoft.Azure.Management.Network.Fluent.Network.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fda2f-101">仮想ネットワーク定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="fda2f-101">The entirety of the virtual network definition.</span></span>
            </summary>
