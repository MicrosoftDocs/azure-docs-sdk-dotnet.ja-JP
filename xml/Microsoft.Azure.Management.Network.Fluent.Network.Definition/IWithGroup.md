<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Network.Fluent.Network.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5e2cd-101">リソース グループを指定できるように、仮想ネットワーク定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="5e2cd-101">The stage of the virtual network definition allowing to specify the resource group.</span></span>
            </summary>
