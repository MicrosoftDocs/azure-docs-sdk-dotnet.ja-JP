<Type Name="IDefinitionWithNewVhd&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineUnmanagedDataDisk.DefinitionWithNewVhd.IDefinitionWithNewVhd&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="c8ebf-101">この定義をアタッチした後に戻るに親の定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="c8ebf-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="c8ebf-102">仮想マシンのスケールのアンマネージ データ ディスクの全体は、定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="c8ebf-102">The entirety of a unmanaged data disk of a virtual machine scale set definition.</span></span>
            </summary>
