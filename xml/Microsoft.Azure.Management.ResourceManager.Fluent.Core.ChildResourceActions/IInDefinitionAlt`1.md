<Type Name="IInDefinitionAlt&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.ChildResourceActions.IInDefinitionAlt&lt;ParentT&gt;">
  ...
  <Members>
    <Member MemberName="Attach">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27a67-101">子の定義を親のリソース定義にアタッチします。</span><span class="sxs-lookup"><span data-stu-id="27a67-101">Attaches the child definition to the parent resource definition.</span></span>
            </summary>
        <returns><span data-ttu-id="27a67-102">親の定義の次のステージ</span><span class="sxs-lookup"><span data-stu-id="27a67-102">the next stage of the parent definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
