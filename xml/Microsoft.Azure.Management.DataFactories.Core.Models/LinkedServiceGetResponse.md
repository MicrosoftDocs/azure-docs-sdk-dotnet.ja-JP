<Type Name="LinkedServiceGetResponse" FullName="Microsoft.Azure.Management.DataFactories.Core.Models.LinkedServiceGetResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1adcb-101">Get データ ファクトリ linkedService 操作応答です。</span><span class="sxs-lookup"><span data-stu-id="1adcb-101">The Get data factory linkedService operation response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1adcb-102">LinkedServiceGetResponse クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="1adcb-102">Initializes a new instance of the LinkedServiceGetResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="LinkedService">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1adcb-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="1adcb-103">Optional.</span></span> <span data-ttu-id="1adcb-104">データ ファクトリの linkedService インスタンス。</span><span class="sxs-lookup"><span data-stu-id="1adcb-104">The data factory linkedService instance.</span></span>
            </summary>
