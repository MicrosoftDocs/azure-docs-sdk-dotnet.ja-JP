<Type Name="DirectoryEntryType" FullName="Microsoft.Azure.DataLake.Store.DirectoryEntryType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="12fba-101">ディレクトリ エントリの 2 つの型を含む列挙型</span><span class="sxs-lookup"><span data-stu-id="12fba-101">Enum containing two types of directory entry</span></span>
            </summary>
