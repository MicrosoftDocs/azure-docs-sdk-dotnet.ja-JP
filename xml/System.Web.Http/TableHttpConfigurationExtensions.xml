<Type Name="TableHttpConfigurationExtensions" FullName="System.Web.Http.TableHttpConfigurationExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ecc74-101">拡張メソッドを<see cref="T:System.Web.Http.HttpConfiguration" />促進、バックエンドで使用されるテーブルに関連するクラスを取得します。</span><span class="sxs-lookup"><span data-stu-id="ecc74-101">Extension methods for <see cref="T:System.Web.Http.HttpConfiguration" /> facilitating getting the Table-related classes used by the backend.</span></span>
            </summary>
