<Type Name="IManagementLinkClient" FullName="Microsoft.Azure.Management.ResourceManager.IManagementLinkClient">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="34a1a-101">Azure リソースは、論理的な関係を形成するために互いをリンクすることができます。</span><span class="sxs-lookup"><span data-stu-id="34a1a-101">Azure resources can be linked together to form logical relationships.</span></span>
            <span data-ttu-id="34a1a-102">異なるリソース グループに属しているリソースの間にリンクを確立することができます。</span><span class="sxs-lookup"><span data-stu-id="34a1a-102">You can establish links between resources belonging to different resource groups.</span></span> <span data-ttu-id="34a1a-103">ただし、すべてのリンクされたリソースは、同じサブスクリプションに属していなければなりません。</span><span class="sxs-lookup"><span data-stu-id="34a1a-103">However, all the linked resources must belong to the same subscription.</span></span> <span data-ttu-id="34a1a-104">各リソースは、そのリソース以外の 50 のリソースにリンクできます。</span><span class="sxs-lookup"><span data-stu-id="34a1a-104">Each resource can be linked to 50 other resources.</span></span>
            <span data-ttu-id="34a1a-105">リンクされたリソースを削除または移動する場合、リンクの所有者は、残りのリンクをクリーンアップする必要があります。</span><span class="sxs-lookup"><span data-stu-id="34a1a-105">If any of the linked resources are deleted or moved, the link owner must clean up the remaining link.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AcceptLanguage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34a1a-106">取得または応答の優先言語を設定します。</span><span class="sxs-lookup"><span data-stu-id="34a1a-106">Gets or sets the preferred language for the response.</span></span>
            </summary>
    ...
    <Member MemberName="ApiVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34a1a-107">操作に使用する API バージョン。</span><span class="sxs-lookup"><span data-stu-id="34a1a-107">The API version to use for the operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BaseUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34a1a-108">サービスのベース URI。</span><span class="sxs-lookup"><span data-stu-id="34a1a-108">The base URI of the service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Credentials">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34a1a-109">Azure に接続するクライアントに必要な資格情報です。</span><span class="sxs-lookup"><span data-stu-id="34a1a-109">Credentials needed for the client to connect to Azure.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DeserializationSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34a1a-110">取得または json に逆シリアル化の設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="34a1a-110">Gets or sets json deserialization settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GenerateClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34a1a-111">設定すると、一意の x ms-クライアントの要求 id 値を true に生成され、各要求に含まれます。</span><span class="sxs-lookup"><span data-stu-id="34a1a-111">When set to true a unique x-ms-client-request-id value is generated and included in each request.</span></span> <span data-ttu-id="34a1a-112">既定値は true です。</span><span class="sxs-lookup"><span data-stu-id="34a1a-112">Default is true.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LongRunningOperationRetryTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34a1a-113">取得または長時間実行される操作の秒単位の再試行タイムアウトを設定します。</span><span class="sxs-lookup"><span data-stu-id="34a1a-113">Gets or sets the retry timeout in seconds for Long Running Operations.</span></span> <span data-ttu-id="34a1a-114">既定値は 30 です。</span><span class="sxs-lookup"><span data-stu-id="34a1a-114">Default value is 30.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceLinks">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34a1a-115">IResourceLinksOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="34a1a-115">Gets the IResourceLinksOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SerializationSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34a1a-116">取得または json のシリアル化設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="34a1a-116">Gets or sets json serialization settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubscriptionId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34a1a-117">ターゲット サブスクリプションの ID。</span><span class="sxs-lookup"><span data-stu-id="34a1a-117">The ID of the target subscription.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
