<Type Name="IsFacetableAttribute" FullName="Microsoft.Azure.Search.IsFacetableAttribute">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ba16b-101">このフィールドのファセットを行うことがあることを示します。</span><span class="sxs-lookup"><span data-stu-id="ba16b-101">Indicates that it is possible to facet on this field.</span></span> <span data-ttu-id="ba16b-102">地理的座標フィールドに対しては無効です。</span><span class="sxs-lookup"><span data-stu-id="ba16b-102">Not valid for geo-point fields.</span></span>
            </summary>
