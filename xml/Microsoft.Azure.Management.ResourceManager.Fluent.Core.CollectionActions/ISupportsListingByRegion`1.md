<Type Name="ISupportsListingByRegion&lt;T&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsListingByRegion&lt;T&gt;">
  ...
  <Members>
    <Member MemberName="ListByRegion">
      ...
      <Docs>
        <param name="region"><span data-ttu-id="bc4fc-101">選択した Azure リージョンの領域</span><span class="sxs-lookup"><span data-stu-id="bc4fc-101">region the selected Azure region</span></span></param>
        <summary>
            <span data-ttu-id="bc4fc-102">指定した領域で、指定した型のすべてのリソースを一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="bc4fc-102">Lists all the resources of the specified type in the specified region.</span></span>
            </summary>
        <returns><span data-ttu-id="bc4fc-103">リソースの一覧</span><span class="sxs-lookup"><span data-stu-id="bc4fc-103">list of resources</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ListByRegion">
      ...
      <Docs>
        <param name="regionName"><span data-ttu-id="bc4fc-104">regionName Azure の地域の名前</span><span class="sxs-lookup"><span data-stu-id="bc4fc-104">regionName the name of an Azure region</span></span></param>
        <summary>
            <span data-ttu-id="bc4fc-105">指定した領域で、指定した型のすべてのリソースを一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="bc4fc-105">List all the resources of the specified type in the specified region.</span></span>
            </summary>
        <returns><span data-ttu-id="bc4fc-106">リソースの一覧</span><span class="sxs-lookup"><span data-stu-id="bc4fc-106">list of resources</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
