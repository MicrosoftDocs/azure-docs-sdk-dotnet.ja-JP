<Type Name="ISupportsDeletingById" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.CollectionActions.ISupportsDeletingById">
  ...
  <Members>
    <Member MemberName="DeleteById">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="b1627-101">削除するリソースの id、リソース ID</span><span class="sxs-lookup"><span data-stu-id="b1627-101">id the resource ID of the resource to delete</span></span></param>
        <summary>
            <span data-ttu-id="b1627-102">リソースの ID で識別して、Azure からリソースを削除します。</span><span class="sxs-lookup"><span data-stu-id="b1627-102">Deletes a resource from Azure, identifying it by its resource ID.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DeleteByIdAsync">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="b1627-103">削除するリソースの id、リソース ID</span><span class="sxs-lookup"><span data-stu-id="b1627-103">id the resource ID of the resource to delete</span></span></param>
        <param name="cancellationToken"><span data-ttu-id="b1627-104">cancellationToken はキャンセル トークン</span><span class="sxs-lookup"><span data-stu-id="b1627-104">cancellationToken the cancellation token</span></span></param>
        <summary>
            <span data-ttu-id="b1627-105">リソースの ID で識別して、Azure からリソースを削除します。</span><span class="sxs-lookup"><span data-stu-id="b1627-105">Deletes a resource from Azure, identifying it by its resource ID.</span></span>
            </summary>
