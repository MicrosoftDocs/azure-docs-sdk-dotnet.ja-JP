<Type Name="TransportType" FullName="Microsoft.Azure.NotificationHubs.Messaging.TransportType">
  ...
  <Docs>
    <summary><span data-ttu-id="c2a21-101">メッセージのトランスポートの種類を列挙します。</span><span class="sxs-lookup"><span data-stu-id="c2a21-101">Enumerates the messaging transport type.</span></span></summary>
  ...
  <Members>
    <Member MemberName="Amqp">
      ...
      <Docs>
        <summary><span data-ttu-id="c2a21-102">高度なメッセージ キュー プロトコル トランスポートの型。</span><span class="sxs-lookup"><span data-stu-id="c2a21-102">The advanced message queuing protocol transport type.</span></span></summary>
      </Docs>
    </Member>
    <Member MemberName="NetMessaging">
      ...
      <Docs>
        <summary><span data-ttu-id="c2a21-103">ネットワークのメッセージング トランスポート種類。</span><span class="sxs-lookup"><span data-stu-id="c2a21-103">The network messaging transport type.</span></span></summary>
      </Docs>
    </Member>
  </Members>
</Type>