<Type Name="CertificateListNextBatchRequest" FullName="Microsoft.Azure.Batch.Protocol.BatchRequests.CertificateListNextBatchRequest">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="21ddb-101"><see cref="T:Microsoft.Azure.Batch.Protocol.IBatchRequest" /> CertificateListNext 操作します。</span><span class="sxs-lookup"><span data-stu-id="21ddb-101">An <see cref="T:Microsoft.Azure.Batch.Protocol.IBatchRequest" /> for the CertificateListNext operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serviceClient"><span data-ttu-id="21ddb-102">サービスを使用するクライアント。</span><span class="sxs-lookup"><span data-stu-id="21ddb-102">The service client to use.</span></span></param>
        <param name="cancellationToken"><span data-ttu-id="21ddb-103">A<see cref="T:System.Threading.CancellationToken" />要求の有効期間を制御します。</span><span class="sxs-lookup"><span data-stu-id="21ddb-103">A <see cref="T:System.Threading.CancellationToken" /> controlling the request lifetime.</span></span></param>
        <summary>
            <span data-ttu-id="21ddb-104"><see cref="T:Microsoft.Azure.Batch.Protocol.BatchRequests.CertificateListNextBatchRequest" /> クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="21ddb-104">Initializes a new instance of the <see cref="T:Microsoft.Azure.Batch.Protocol.BatchRequests.CertificateListNextBatchRequest" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
