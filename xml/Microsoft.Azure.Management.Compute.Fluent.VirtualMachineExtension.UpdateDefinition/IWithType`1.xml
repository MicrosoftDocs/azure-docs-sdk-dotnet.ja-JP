<Type Name="IWithType&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineExtension.UpdateDefinition.IWithType&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="04180-101">この定義をアタッチした後に戻るに親の更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="04180-101">The stage of the parent update to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="04180-102">仮想マシン拡張機能のイメージの種類を指定できるように仮想マシン拡張機能の定義のステージは、この拡張機能に基づいています。</span><span class="sxs-lookup"><span data-stu-id="04180-102">The stage of the virtual machine extension definition allowing to specify the type of the virtual machine extension image this extension is based on.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithType">
      ...
      <Docs>
        <param name="extensionImageTypeName"><span data-ttu-id="04180-103">イメージの種類の名前。</span><span class="sxs-lookup"><span data-stu-id="04180-103">The image type name.</span></span></param>
        <summary>
            <span data-ttu-id="04180-104">仮想マシン拡張機能のイメージの種類を指定します。</span><span class="sxs-lookup"><span data-stu-id="04180-104">Specifies the type of the virtual machine extension image.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="04180-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="04180-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>