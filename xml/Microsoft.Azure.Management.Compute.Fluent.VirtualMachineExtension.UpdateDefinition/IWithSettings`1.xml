<Type Name="IWithSettings&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineExtension.UpdateDefinition.IWithSettings&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="0b272-101">この定義をアタッチした後に戻るに親の更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="0b272-101">The stage of the parent update to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="0b272-102">パブリックおよびプライベートの設定を指定できるように仮想マシン拡張機能の定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="0b272-102">The stage of the virtual machine extension definition allowing to specify the public and private settings.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithProtectedSetting">
      ...
      <Docs>
        <param name="key"><span data-ttu-id="0b272-103">プライベート設定のエントリのキー。</span><span class="sxs-lookup"><span data-stu-id="0b272-103">The key of a private settings entry.</span></span></param>
        <param name="value"><span data-ttu-id="0b272-104">プライベート設定のエントリの値。</span><span class="sxs-lookup"><span data-stu-id="0b272-104">The value of the private settings entry.</span></span></param>
        <summary>
            <span data-ttu-id="0b272-105">プライベート設定のエントリを指定します。</span><span class="sxs-lookup"><span data-stu-id="0b272-105">Specifies a private settings entry.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="0b272-106">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="0b272-106">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithProtectedSettings">
      ...
      <Docs>
        <param name="settings"><span data-ttu-id="0b272-107">プライベート設定します。</span><span class="sxs-lookup"><span data-stu-id="0b272-107">The private settings.</span></span></param>
        <summary>
            <span data-ttu-id="0b272-108">プライベート設定を指定します。</span><span class="sxs-lookup"><span data-stu-id="0b272-108">Specifies private settings.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="0b272-109">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="0b272-109">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithPublicSetting">
      ...
      <Docs>
        <param name="key"><span data-ttu-id="0b272-110">公開設定のエントリのキー。</span><span class="sxs-lookup"><span data-stu-id="0b272-110">The key of a public settings entry.</span></span></param>
        <param name="value"><span data-ttu-id="0b272-111">公開設定のエントリの値。</span><span class="sxs-lookup"><span data-stu-id="0b272-111">The value of the public settings entry.</span></span></param>
        <summary>
            <span data-ttu-id="0b272-112">公開設定のエントリを指定します。</span><span class="sxs-lookup"><span data-stu-id="0b272-112">Specifies a public settings entry.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="0b272-113">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="0b272-113">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithPublicSettings">
      ...
      <Docs>
        <param name="settings"><span data-ttu-id="0b272-114">公開設定。</span><span class="sxs-lookup"><span data-stu-id="0b272-114">The public settings.</span></span></param>
        <summary>
            <span data-ttu-id="0b272-115">公開設定を指定します。</span><span class="sxs-lookup"><span data-stu-id="0b272-115">Specifies public settings.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="0b272-116">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="0b272-116">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>