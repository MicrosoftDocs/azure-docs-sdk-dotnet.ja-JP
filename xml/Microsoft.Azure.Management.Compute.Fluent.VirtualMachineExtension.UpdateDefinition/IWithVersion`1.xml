<Type Name="IWithVersion&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineExtension.UpdateDefinition.IWithVersion&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="d3e1b-101">この定義をアタッチした後に戻るに親の更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="d3e1b-101">The stage of the parent update to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="d3e1b-102">仮想マシン拡張機能のバージョンの種類を指定できるように仮想マシン拡張機能の定義のステージは、この拡張機能に基づいています。</span><span class="sxs-lookup"><span data-stu-id="d3e1b-102">The stage of the virtual machine extension definition allowing to specify the type of the virtual machine extension version this extension is based on.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithVersion">
      ...
      <Docs>
        <param name="extensionImageVersionName"><span data-ttu-id="d3e1b-103">バージョン名。</span><span class="sxs-lookup"><span data-stu-id="d3e1b-103">The version name.</span></span></param>
        <summary>
            <span data-ttu-id="d3e1b-104">仮想マシン イメージの拡張機能のバージョンを指定します。</span><span class="sxs-lookup"><span data-stu-id="d3e1b-104">Specifies the version of the virtual machine image extension.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="d3e1b-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="d3e1b-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>