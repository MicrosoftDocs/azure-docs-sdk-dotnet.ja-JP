<Type Name="IWithImageOrPublisher&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineExtension.UpdateDefinition.IWithImageOrPublisher&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="311fd-101">この定義をアタッチした後に戻るに親の更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="311fd-101">The stage of the parent update to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="311fd-102">拡張機能のイメージを指定または仮想マシン拡張機能のパブリッシャーの名前を指定できるように仮想マシンの拡張機能の段階です。</span><span class="sxs-lookup"><span data-stu-id="311fd-102">The stage of the virtual machine extension allowing to specify extension image or specify name of the virtual machine extension publisher.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithImage">
      ...
      <Docs>
        <param name="image"><span data-ttu-id="311fd-103">イメージです。</span><span class="sxs-lookup"><span data-stu-id="311fd-103">The image.</span></span></param>
        <summary>
            <span data-ttu-id="311fd-104">使用する仮想マシン拡張機能のイメージを指定します。</span><span class="sxs-lookup"><span data-stu-id="311fd-104">Specifies the virtual machine extension image to use.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="311fd-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="311fd-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>