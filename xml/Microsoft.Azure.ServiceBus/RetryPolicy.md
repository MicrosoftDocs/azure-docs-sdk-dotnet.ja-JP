<Type Name="RetryPolicy" FullName="Microsoft.Azure.ServiceBus.RetryPolicy">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d96c1-101">メッセージング操作を再試行するための抽象化を表します。</span><span class="sxs-lookup"><span data-stu-id="d96c1-101">Represents an abstraction for retrying messaging operations.</span></span> <span data-ttu-id="d96c1-102">ユーザーは、このクラスを実装する必要があり、代わりにする必要がありますを使用して、指定した実装のいずれか。</span><span class="sxs-lookup"><span data-stu-id="d96c1-102">Users should not implement this class, and instead should use one of the provided implementations.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Default">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d96c1-103">既定の再試行ポリシーを返します<see cref="T:Microsoft.Azure.ServiceBus.RetryExponential" />です。</span><span class="sxs-lookup"><span data-stu-id="d96c1-103">Returns the default retry policy, <see cref="T:Microsoft.Azure.ServiceBus.RetryExponential" />.</span></span>
            </summary>
    ...
    <Member MemberName="IsRetryableException">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="d96c1-104">例外を再試行できるかどうかを判断します。</span><span class="sxs-lookup"><span data-stu-id="d96c1-104">Determines whether or not the exception can be retried.</span></span>
            </summary>
        <returns><span data-ttu-id="d96c1-105">操作を再試行できるかどうかを示すブール値。</span><span class="sxs-lookup"><span data-stu-id="d96c1-105">A bool indicating whether or not the operation can be retried.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsServerBusy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d96c1-106">サーバーがビジー状態のエラーを返したかどうかを判断します。</span><span class="sxs-lookup"><span data-stu-id="d96c1-106">Determines whether or not the server returned a busy error.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RunOperation">
      ...
      <Docs>
        <param name="operation"><span data-ttu-id="d96c1-107">A<see cref="T:System.Func`2" />を実行します。</span><span class="sxs-lookup"><span data-stu-id="d96c1-107">A <see cref="T:System.Func`2" /> to be executed.</span></span></param>
        <param name="operationTimeout"><span data-ttu-id="d96c1-108">すべての操作のタイムアウト。</span><span class="sxs-lookup"><span data-stu-id="d96c1-108">The timeout for the entire operation.</span></span></param>
        <summary>
            <span data-ttu-id="d96c1-109">実行、 <see cref="T:System.Func`2" />、現在の RetryPolicy を使用します。</span><span class="sxs-lookup"><span data-stu-id="d96c1-109">Runs a <see cref="T:System.Func`2" />, using the current RetryPolicy.</span></span>
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerBusyExceptionMessage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d96c1-110">サーバーのビジー状態でエラーが返されるときに、例外メッセージを取得します。</span><span class="sxs-lookup"><span data-stu-id="d96c1-110">Gets the exception message when a server busy error is returned.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
