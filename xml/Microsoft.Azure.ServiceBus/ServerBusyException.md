<Type Name="ServerBusyException" FullName="Microsoft.Azure.ServiceBus.ServerBusyException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5543b-101">サーバーがビジー状態である場合にスローされる例外。</span><span class="sxs-lookup"><span data-stu-id="5543b-101">The exception that is thrown when a server is busy.</span></span>  <span data-ttu-id="5543b-102">呼び出し元は、しばらく待つし、操作をやり直してください必要があります。</span><span class="sxs-lookup"><span data-stu-id="5543b-102">Callers should wait a while and retry the operation.</span></span>
            </summary>
