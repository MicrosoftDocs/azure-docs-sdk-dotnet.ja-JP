<Type Name="IWithNewPublicIPAddressNoDnsLabel&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasPublicIPAddress.Update.IWithNewPublicIPAddressNoDnsLabel&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="1a571-101">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="1a571-101">The next stage of the definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="1a571-102">関連付ける新しいパブリック IP アドレス リソースを許可する更新プログラムの段階です。</span><span class="sxs-lookup"><span data-stu-id="1a571-102">The stage of the update allowing to associate the resource with a new public IP address.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithNewPublicIPAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1a571-103">同じリージョンと、リソースとグループに新しいパブリック IP アドレスを作成し、リソースに関連付けます。</span><span class="sxs-lookup"><span data-stu-id="1a571-103">Creates a new public IP address in the same region and group as the resource and associates it with the resource.</span></span>
            <span data-ttu-id="1a571-104">内部名とパブリック IP アドレスの DNS ラベルは、リソース名から派生します。</span><span class="sxs-lookup"><span data-stu-id="1a571-104">The internal name and DNS label for the public IP address will be derived from the resource's name.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="1a571-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="1a571-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithNewPublicIPAddress">
      ...
      <Docs>
        <param name="creatable"><span data-ttu-id="1a571-106">新しいパブリック IP の作成可能な定義です。</span><span class="sxs-lookup"><span data-stu-id="1a571-106">A creatable definition for a new public IP.</span></span></param>
        <summary>
            <span data-ttu-id="1a571-107">リソースに関連付ける新しいパブリック IP アドレスを作成します。</span><span class="sxs-lookup"><span data-stu-id="1a571-107">Creates a new public IP address to associate with the resource.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="1a571-108">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="1a571-108">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>