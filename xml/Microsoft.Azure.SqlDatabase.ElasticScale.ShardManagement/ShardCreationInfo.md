<Type Name="ShardCreationInfo" FullName="Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.ShardCreationInfo">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="08ba6-101">作成するための引数、<see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.Shard" />です。</span><span class="sxs-lookup"><span data-stu-id="08ba6-101">Arguments used to create a <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.Shard" />.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="08ba6-102">シャードの場所です。</span><span class="sxs-lookup"><span data-stu-id="08ba6-102">Location of the shard.</span></span></param>
        <summary>
            <span data-ttu-id="08ba6-103">作成するための引数、<see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.Shard" />です。</span><span class="sxs-lookup"><span data-stu-id="08ba6-103">Arguments used to create a <see cref="T:Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.Shard" />.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="08ba6-104">シャードの場所を取得します。</span><span class="sxs-lookup"><span data-stu-id="08ba6-104">Gets Location of the shard.</span></span>
            </summary>
