<Type Name="LinkedServiceCreateOrUpdateResponse" FullName="Microsoft.Azure.Management.DataFactories.Models.LinkedServiceCreateOrUpdateResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="31694-101">作成または更新データ ファクトリ linkedService 操作応答です。</span><span class="sxs-lookup"><span data-stu-id="31694-101">The create or update data factory linkedService operation response.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="LinkedService">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31694-102">省略可能。</span><span class="sxs-lookup"><span data-stu-id="31694-102">Optional.</span></span> <span data-ttu-id="31694-103">データ ファクトリの linkedService インスタンス。</span><span class="sxs-lookup"><span data-stu-id="31694-103">The data factory linkedService instance.</span></span>
            </summary>
    ...
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31694-104">省略可能。</span><span class="sxs-lookup"><span data-stu-id="31694-104">Optional.</span></span> <span data-ttu-id="31694-105">取得要求の場所の url。</span><span class="sxs-lookup"><span data-stu-id="31694-105">The location url for the get request.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31694-106">省略可能。</span><span class="sxs-lookup"><span data-stu-id="31694-106">Optional.</span></span> <span data-ttu-id="31694-107">操作の状態。</span><span class="sxs-lookup"><span data-stu-id="31694-107">Status of the operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
