<Type Name="OnPremisesSqlServerLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.OnPremisesSqlServerLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cef0c-101">内部設置型 SQL server データベース。</span><span class="sxs-lookup"><span data-stu-id="cef0c-101">An on-premises SQL server database.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cef0c-102">OnPremisesSqlLinkedService クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="cef0c-102">Initializes a new instance of the OnPremisesSqlLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="cef0c-103">必須の引数で OnPremisesSqlLinkedService クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="cef0c-103">Initializes a new instance of the OnPremisesSqlLinkedService class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cef0c-104">必須。</span><span class="sxs-lookup"><span data-stu-id="cef0c-104">Required.</span></span> <span data-ttu-id="cef0c-105">接続文字列。</span><span class="sxs-lookup"><span data-stu-id="cef0c-105">The connection string.</span></span>
            </summary>
    ...
    <Member MemberName="GatewayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cef0c-106">必須。</span><span class="sxs-lookup"><span data-stu-id="cef0c-106">Required.</span></span> <span data-ttu-id="cef0c-107">オンプレミス ゲートウェイの名前です。</span><span class="sxs-lookup"><span data-stu-id="cef0c-107">The on-premises gateway name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cef0c-108">省略可能。</span><span class="sxs-lookup"><span data-stu-id="cef0c-108">Optional.</span></span> <span data-ttu-id="cef0c-109">内部設置型 Windows 認証のパスワード。</span><span class="sxs-lookup"><span data-stu-id="cef0c-109">The on-premises Windows authentication password.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cef0c-110">省略可能。</span><span class="sxs-lookup"><span data-stu-id="cef0c-110">Optional.</span></span> <span data-ttu-id="cef0c-111">内部設置型 Windows 認証ユーザー名。</span><span class="sxs-lookup"><span data-stu-id="cef0c-111">The on-premises Windows authentication user name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
