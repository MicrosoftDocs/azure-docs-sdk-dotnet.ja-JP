<Type Name="DocumentDbCollectionSink" FullName="Microsoft.Azure.Management.DataFactories.Models.DocumentDbCollectionSink">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="50e2e-101">コピー アクティビティのドキュメント、データベース コレクション シンクです。</span><span class="sxs-lookup"><span data-stu-id="50e2e-101">A copy activity Document Database Collection sink.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="NestingSeparator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="50e2e-102">入れ子になったプロパティの区切り記号。</span><span class="sxs-lookup"><span data-stu-id="50e2e-102">Nested properties separator.</span></span>
            </summary>
