<Type Name="OnPremisesFileServerLinkedService" FullName="Microsoft.Azure.Management.DataFactories.Models.OnPremisesFileServerLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bbc00-101">内部設置型ファイル システム リンクされたサービスの場合は。</span><span class="sxs-lookup"><span data-stu-id="bbc00-101">An on-premises file system Linked Service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bbc00-102">OnPremisesFileSystemLinkedService クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="bbc00-102">Initializes a new instance of the OnPremisesFileSystemLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="bbc00-103">必須の引数で OnPremisesFileSystemLinkedService クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="bbc00-103">Initializes a new instance of the OnPremisesFileSystemLinkedService class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EncryptedCredential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bbc00-104">省略可能。</span><span class="sxs-lookup"><span data-stu-id="bbc00-104">Optional.</span></span> <span data-ttu-id="bbc00-105">暗号化された資格情報をホスト、ユーザー Id とパスワードが含まれています。</span><span class="sxs-lookup"><span data-stu-id="bbc00-105">Encrypted credential which contains host, userId and password.</span></span>
            </summary>
    ...
    <Member MemberName="GatewayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bbc00-106">必須。</span><span class="sxs-lookup"><span data-stu-id="bbc00-106">Required.</span></span> <span data-ttu-id="bbc00-107">オンプレミス ゲートウェイの名前です。</span><span class="sxs-lookup"><span data-stu-id="bbc00-107">The on-premises gateway name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Host">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bbc00-108">必須。</span><span class="sxs-lookup"><span data-stu-id="bbc00-108">Required.</span></span> <span data-ttu-id="bbc00-109">サーバーのホスト名です。</span><span class="sxs-lookup"><span data-stu-id="bbc00-109">Host name of the server.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bbc00-110">省略可能。</span><span class="sxs-lookup"><span data-stu-id="bbc00-110">Optional.</span></span> <span data-ttu-id="bbc00-111">サーバーにログオンするパスワードです。</span><span class="sxs-lookup"><span data-stu-id="bbc00-111">Password to logon the server.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bbc00-112">省略可能。</span><span class="sxs-lookup"><span data-stu-id="bbc00-112">Optional.</span></span> <span data-ttu-id="bbc00-113">サーバーにログオンするユーザー Id。</span><span class="sxs-lookup"><span data-stu-id="bbc00-113">UserID to logon the server.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
