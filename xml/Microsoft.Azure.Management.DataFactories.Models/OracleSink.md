<Type Name="OracleSink" FullName="Microsoft.Azure.Management.DataFactories.Models.OracleSink">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d50b3-101">コピー アクティビティ Oracle シンクです。</span><span class="sxs-lookup"><span data-stu-id="d50b3-101">A copy activity Oracle sink.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d50b3-102">OracleSink クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="d50b3-102">Initializes a new instance of the OracleSink class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="d50b3-103">必須の引数で OracleSink クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="d50b3-103">Initializes a new instance of the OracleSink class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OracleWriterStoredProcedureName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d50b3-104">Oracle ライター ストアド プロシージャの名前。</span><span class="sxs-lookup"><span data-stu-id="d50b3-104">Oracle writer stored procedure name.</span></span>
            </summary>
    ...
    <Member MemberName="OracleWriterTableType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d50b3-105">Oracle ライター テーブルの型。</span><span class="sxs-lookup"><span data-stu-id="d50b3-105">Oracle writer table type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
