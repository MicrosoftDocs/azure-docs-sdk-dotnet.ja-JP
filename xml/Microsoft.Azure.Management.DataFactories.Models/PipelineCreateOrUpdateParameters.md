<Type Name="PipelineCreateOrUpdateParameters" FullName="Microsoft.Azure.Management.DataFactories.Models.PipelineCreateOrUpdateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8cabb-101">作成または更新するパイプラインを指定するパラメーターです。</span><span class="sxs-lookup"><span data-stu-id="8cabb-101">Parameters specifying the pipeline to be created or updated.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Pipeline">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8cabb-102">パイプラインのインスタンス。</span><span class="sxs-lookup"><span data-stu-id="8cabb-102">The pipeline instance.</span></span>
            </summary>
