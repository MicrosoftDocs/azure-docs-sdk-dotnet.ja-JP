<Type Name="DataSliceListParameters" FullName="Microsoft.Azure.Management.DataFactories.Models.DataSliceListParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5cc88-101">リストのデータのフィルターを指定するパラメーターは、操作をスライスします。</span><span class="sxs-lookup"><span data-stu-id="5cc88-101">Parameters specifying the filters for the list data slices operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5cc88-102">DataSliceListParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="5cc88-102">Initializes a new instance of the DataSliceListParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="5cc88-103">必須の引数で DataSliceListParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="5cc88-103">Initializes a new instance of the DataSliceListParameters class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DataSliceRangeEndTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5cc88-104">必須。</span><span class="sxs-lookup"><span data-stu-id="5cc88-104">Required.</span></span> <span data-ttu-id="5cc88-105">データは、ラウンド トリップの ISO 8601 形式で範囲の終了時刻をスライスします。</span><span class="sxs-lookup"><span data-stu-id="5cc88-105">The data slice range end time in round-trip ISO 8601 format.</span></span>
            </summary>
    ...
    <Member MemberName="DataSliceRangeStartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5cc88-106">必須。</span><span class="sxs-lookup"><span data-stu-id="5cc88-106">Required.</span></span> <span data-ttu-id="5cc88-107">データ スライスの範囲は、ラウンド トリップの ISO 8601 形式で時刻を起動します。</span><span class="sxs-lookup"><span data-stu-id="5cc88-107">The data slice range start time in round-trip ISO 8601 format.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
