<Type Name="AzureTableSink" FullName="Microsoft.Azure.Management.DataFactories.Models.AzureTableSink">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="eb0db-101">コピー アクティビティの Azure テーブル シンクです。</span><span class="sxs-lookup"><span data-stu-id="eb0db-101">A copy activity Azure table sink.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="AzureTableDefaultPartitionKeyValue">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb0db-102">Azure テーブル既定のパーティション キー値。</span><span class="sxs-lookup"><span data-stu-id="eb0db-102">Azure table default partition key value.</span></span>
            </summary>
    ...
    <Member MemberName="AzureTableInsertType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb0db-103">Azure テーブルは、型を挿入します。</span><span class="sxs-lookup"><span data-stu-id="eb0db-103">Azure table insert type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AzureTablePartitionKeyName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb0db-104">Azure テーブルのパーティションのキーの名前。</span><span class="sxs-lookup"><span data-stu-id="eb0db-104">Azure table partition key name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AzureTableRowKeyName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eb0db-105">Azure テーブルの行のキーの名前。</span><span class="sxs-lookup"><span data-stu-id="eb0db-105">Azure table row key name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
