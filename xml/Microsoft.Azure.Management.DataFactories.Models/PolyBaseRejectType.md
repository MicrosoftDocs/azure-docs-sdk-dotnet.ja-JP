<Type Name="PolyBaseRejectType" FullName="Microsoft.Azure.Management.DataFactories.Models.PolyBaseRejectType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d3d45-101">PolyBase Reject 型です。</span><span class="sxs-lookup"><span data-stu-id="d3d45-101">PolyBase Reject Type.</span></span> <span data-ttu-id="d3d45-102">プロパティ<see cref="T:Microsoft.Azure.Management.DataFactories.Models.PolyBaseSettings" />です。</span><span class="sxs-lookup"><span data-stu-id="d3d45-102">A property of <see cref="T:Microsoft.Azure.Management.DataFactories.Models.PolyBaseSettings" />.</span></span>
            <span data-ttu-id="d3d45-103">RejectValue がリテラル値またはパーセントとして指定するかどうかを示します。</span><span class="sxs-lookup"><span data-stu-id="d3d45-103">Indicates whether RejectValue is specified as a literal value or a percentage.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Percentage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d3d45-104">PolyBase の設定で RejectValue プロパティがパーセンテージで指定を示します。</span><span class="sxs-lookup"><span data-stu-id="d3d45-104">Indicates the RejectValue property in PolyBase settings is specified as a percentage.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d3d45-105">PolyBase の設定で RejectValue プロパティは、リテラル値として指定を示します。</span><span class="sxs-lookup"><span data-stu-id="d3d45-105">Indicates the RejectValue property in PolyBase settings is specified as a literal value.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
