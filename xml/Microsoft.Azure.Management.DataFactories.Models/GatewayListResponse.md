<Type Name="GatewayListResponse" FullName="Microsoft.Azure.Management.DataFactories.Models.GatewayListResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="abe48-101">一覧データ ファクトリ ゲートウェイ操作の応答。</span><span class="sxs-lookup"><span data-stu-id="abe48-101">The List data factory gateways operation response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abe48-102">GatewayListResponse クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="abe48-102">Initializes a new instance of the GatewayListResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Gateways">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abe48-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="abe48-103">Optional.</span></span> <span data-ttu-id="abe48-104">データ ファクトリのゲートウェイの情報の一覧です。</span><span class="sxs-lookup"><span data-stu-id="abe48-104">List of data factory gateway information.</span></span>
            </summary>
    ...
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abe48-105">ゲートウェイのシーケンスを取得します。</span><span class="sxs-lookup"><span data-stu-id="abe48-105">Gets the sequence of Gateways.</span></span>
            </summary>
    ...
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abe48-106">ゲートウェイのシーケンスを取得します。</span><span class="sxs-lookup"><span data-stu-id="abe48-106">Gets the sequence of Gateways.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
