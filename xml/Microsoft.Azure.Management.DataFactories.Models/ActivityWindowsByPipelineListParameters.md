<Type Name="ActivityWindowsByPipelineListParameters" FullName="Microsoft.Azure.Management.DataFactories.Models.ActivityWindowsByPipelineListParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ea90e-101">アクティビティの windows のリストのパラメーターをフィルター処理します。</span><span class="sxs-lookup"><span data-stu-id="ea90e-101">Filter parameters for the activity windows list.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea90e-102">ActivityWindowsByPipelineListParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ea90e-102">Initializes a new instance of the ActivityWindowsByPipelineListParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="ea90e-103">必須の引数で ActivityWindowsByPipelineListParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ea90e-103">Initializes a new instance of the ActivityWindowsByPipelineListParameters class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PipelineName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea90e-104">必須。</span><span class="sxs-lookup"><span data-stu-id="ea90e-104">Required.</span></span> <span data-ttu-id="ea90e-105">パイプラインの名前です。</span><span class="sxs-lookup"><span data-stu-id="ea90e-105">The pipeline name.</span></span>
            </summary>
