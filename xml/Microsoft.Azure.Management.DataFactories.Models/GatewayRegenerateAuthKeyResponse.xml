<Type Name="GatewayRegenerateAuthKeyResponse" FullName="Microsoft.Azure.Management.DataFactories.Models.GatewayRegenerateAuthKeyResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8bab3-101">再生成のゲートウェイ認証キー操作応答です。</span><span class="sxs-lookup"><span data-stu-id="8bab3-101">The regenerate gateway auth key operation response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8bab3-102">GatewayRegenerateAuthKeyResponse クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="8bab3-102">Initializes a new instance of the GatewayRegenerateAuthKeyResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Key1">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8bab3-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="8bab3-103">Optional.</span></span> <span data-ttu-id="8bab3-104">ゲートウェイを再生成された認証キー 1 です。</span><span class="sxs-lookup"><span data-stu-id="8bab3-104">Regenerated gateway auth key 1.</span></span>
            </summary>
    ...
    <Member MemberName="Key2">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8bab3-105">省略可能。</span><span class="sxs-lookup"><span data-stu-id="8bab3-105">Optional.</span></span> <span data-ttu-id="8bab3-106">ゲートウェイを再生成された認証キー 2 です。</span><span class="sxs-lookup"><span data-stu-id="8bab3-106">Regenerated gateway auth key 2.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
