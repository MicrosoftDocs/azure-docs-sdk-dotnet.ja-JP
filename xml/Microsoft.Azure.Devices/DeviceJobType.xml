<Type Name="DeviceJobType" FullName="Microsoft.Azure.Devices.DeviceJobType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="34f2c-101">DeviceJob 型</span><span class="sxs-lookup"><span data-stu-id="34f2c-101">DeviceJob type</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ScheduleDeviceMethod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34f2c-102">スケジュールのジョブの種類を直接要求</span><span class="sxs-lookup"><span data-stu-id="34f2c-102">Schedule direct request job type</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="ScheduleUpdateTwin">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="34f2c-103">スケジュール更新ツイン ジョブの種類</span><span class="sxs-lookup"><span data-stu-id="34f2c-103">Schedule update twin job type</span></span>
            </summary>
      </Docs>
    </Member>
