<Type Name="FeedbackReceiver&lt;T&gt;" FullName="Microsoft.Azure.Devices.FeedbackReceiver&lt;T&gt;">
  ...
  <Docs>
    ...
    <summary>
            <span data-ttu-id="9fcf3-101">サービスが実行に使用できるメソッドを含む受信操作のフィードバックします。</span><span class="sxs-lookup"><span data-stu-id="9fcf3-101">Contains methods that services can use to perform feedback receive operations.</span></span>
            </summary>
