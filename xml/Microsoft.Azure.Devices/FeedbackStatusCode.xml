<Type Name="FeedbackStatusCode" FullName="Microsoft.Azure.Devices.FeedbackStatusCode">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0d967-101">デバイスに送信されたコマンドに関するさまざまなフィードバック状態コードを指定します。</span><span class="sxs-lookup"><span data-stu-id="0d967-101">Specifies the various feedback status codes for a command sent to a device.</span></span>
            </summary>
