<Type Name="IServicePrincipal" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.IServicePrincipal">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c67fd-101">Azure AD サービス プリンシパルの変更できないクライアント側表現。</span><span class="sxs-lookup"><span data-stu-id="c67fd-101">An immutable client-side representation of an Azure AD service principal.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="c67fd-102">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです。)。</span><span class="sxs-lookup"><span data-stu-id="c67fd-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    ...
    <Member MemberName="ServicePrincipalNames">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c67fd-103">名前の一覧を取得します。</span><span class="sxs-lookup"><span data-stu-id="c67fd-103">Gets the list of names.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
