<Type Name="GraphRbacManager" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.GraphRbacManager">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1e246-101">エントリは、Azure Graoh RBAC の管理 をポイントします。</span><span class="sxs-lookup"><span data-stu-id="1e246-101">Entry point to Azure Graoh RBAC management.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="1e246-102">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです)。</span><span class="sxs-lookup"><span data-stu-id="1e246-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.)</span></span>
            </remarks>
  </Docs>
  <Members>
