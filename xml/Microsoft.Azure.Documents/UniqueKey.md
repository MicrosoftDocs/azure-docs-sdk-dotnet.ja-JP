<Type Name="UniqueKey" FullName="Microsoft.Azure.Documents.UniqueKey">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3d424-101">一意のキーが Azure Cosmos DB サービスのコレクション内のドキュメントに一意性制約を適用を表します。</span><span class="sxs-lookup"><span data-stu-id="3d424-101">Represents a unique key on that enforces uniqueness constraint on documents in the collection in the Azure Cosmos DB service.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Paths">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3d424-102">取得または設定、パスは、一連を Cosmos DB の Azure サービス内の各ドキュメントに対して一意である必要があります。</span><span class="sxs-lookup"><span data-stu-id="3d424-102">Gets or sets the paths, a set of which must be unique for each document in the Azure Cosmos DB service.</span></span>
            </summary>
        <value>
            <span data-ttu-id="3d424-103">一意性を適用するパス。</span><span class="sxs-lookup"><span data-stu-id="3d424-103">The paths to enforce uniqueness on.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
