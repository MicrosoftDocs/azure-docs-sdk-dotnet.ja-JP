<Type Name="QueryPreparationTimes" FullName="Microsoft.Azure.Documents.QueryPreparationTimes">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="acd13-101">準備のメトリックを Cosmos DB の Azure サービスでのクエリを実行します。</span><span class="sxs-lookup"><span data-stu-id="acd13-101">Query preparation metrics in the Azure Cosmos DB service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CompileTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="acd13-102">Azure Cosmos DB サービスのクエリのコンパイル時間を取得します。</span><span class="sxs-lookup"><span data-stu-id="acd13-102">Gets the query compile time in the Azure Cosmos DB service.</span></span> 
            </summary>
    ...
    <Member MemberName="LogicalPlanBuildTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="acd13-103">Azure Cosmos DB サービスのクエリの論理プラン ビルド時間を取得します。</span><span class="sxs-lookup"><span data-stu-id="acd13-103">Gets the query logical plan build time in the Azure Cosmos DB service.</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PhysicalPlanBuildTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="acd13-104">Azure Cosmos DB サービスのクエリ プランの物理的なビルド時間を取得します。</span><span class="sxs-lookup"><span data-stu-id="acd13-104">Gets the query physical plan build time in the Azure Cosmos DB service.</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="QueryOptimizationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="acd13-105">Azure Cosmos DB サービスのクエリの最適化の時間を取得します。</span><span class="sxs-lookup"><span data-stu-id="acd13-105">Gets the query optimization time in the Azure Cosmos DB service.</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
