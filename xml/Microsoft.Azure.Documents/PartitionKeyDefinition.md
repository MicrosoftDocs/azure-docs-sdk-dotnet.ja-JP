<Type Name="PartitionKeyDefinition" FullName="Microsoft.Azure.Documents.PartitionKeyDefinition">
  ...
  <Docs>
    <summary> 
            <span data-ttu-id="971bf-101">Azure Cosmos DB サービスのパーティション キーの定義の特定のパスを指定します。</span><span class="sxs-lookup"><span data-stu-id="971bf-101">Specifies a partition key definition for a particular path in the Azure Cosmos DB service.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Paths">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="971bf-102">取得または Azure Cosmos DB サービスのパーティション分割するへのパスを設定します。</span><span class="sxs-lookup"><span data-stu-id="971bf-102">Gets or sets the paths to be partitioned in the Azure Cosmos DB service.</span></span>
            </summary>
        <value>
            <span data-ttu-id="971bf-103">パーティションを設定するパス。</span><span class="sxs-lookup"><span data-stu-id="971bf-103">The path to be partitioned.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
