<Type Name="RecommendedIndexActions" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.RecommendedIndexActions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7f14b-101">RecommendedIndexActions の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="7f14b-101">Defines values for RecommendedIndexActions.</span></span>
            </summary>
