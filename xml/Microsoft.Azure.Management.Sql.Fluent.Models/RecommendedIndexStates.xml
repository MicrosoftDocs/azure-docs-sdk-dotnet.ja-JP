<Type Name="RecommendedIndexStates" FullName="Microsoft.Azure.Management.Sql.Fluent.Models.RecommendedIndexStates">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bab78-101">RecommendedIndexStates の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="bab78-101">Defines values for RecommendedIndexStates.</span></span>
            </summary>
