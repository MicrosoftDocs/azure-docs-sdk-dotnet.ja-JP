<Type Name="CheckpointFrequency" FullName="Microsoft.Azure.Documents.ChangeFeedProcessor.CheckpointFrequency">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0f6c5-101">リース イベントの頻度を指定します。</span><span class="sxs-lookup"><span data-stu-id="0f6c5-101">Specifies the frequency of lease event.</span></span> <span data-ttu-id="0f6c5-102">イベントがトリガーされる条件のいずれかが満たされます。</span><span class="sxs-lookup"><span data-stu-id="0f6c5-102">The event will trigger when either of conditions is satisfied.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ProcessedDocumentCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0f6c5-103">取得またはチェックポイントをすべて指定されたドキュメント数を指定する値を設定します。</span><span class="sxs-lookup"><span data-stu-id="0f6c5-103">Gets or sets the value that specifies to checkpoint every specified number of docs.</span></span>
            </summary>
    ...
    <Member MemberName="TimeInterval">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0f6c5-104">取得またはチェックポイントをすべて指定した時間間隔を指定する値を設定します。</span><span class="sxs-lookup"><span data-stu-id="0f6c5-104">Gets or sets the value that specifies to checkpoint every specified time interval.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
