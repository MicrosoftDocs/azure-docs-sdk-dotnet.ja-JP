<Type Name="IWithDatabaseDtuMax" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlElasticPool.Update.IWithDatabaseDtuMax">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6e97d-101">SQL 弾力性プール定義を 1 つのデータベースの最大 DTU を設定します。</span><span class="sxs-lookup"><span data-stu-id="6e97d-101">The SQL Elastic Pool definition to set the maximum DTU for one database.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithDatabaseDtuMax">
      ...
      <Docs>
        <param name="databaseDtuMax"><span data-ttu-id="6e97d-102">最大の DTU の 1 つの SQL Azure データベースを使用できます。</span><span class="sxs-lookup"><span data-stu-id="6e97d-102">Maximum DTU any one SQL Azure Database can consume.</span></span></param>
        <summary>
            <span data-ttu-id="6e97d-103">いずれかの SQL Azure データベースが使用できる最大の DTU を設定します。</span><span class="sxs-lookup"><span data-stu-id="6e97d-103">Sets the maximum DTU any one SQL Azure Database can consume.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="6e97d-104">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="6e97d-104">The next stage of definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>