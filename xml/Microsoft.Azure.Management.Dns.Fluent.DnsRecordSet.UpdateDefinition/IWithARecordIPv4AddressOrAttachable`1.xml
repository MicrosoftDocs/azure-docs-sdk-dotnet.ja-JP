<Type Name="IWithARecordIPv4AddressOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateDefinition.IWithARecordIPv4AddressOrAttachable&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="ced5a-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="ced5a-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="ced5a-102">A レコードのステージでは、レコード セットを追加できるように定義が追加または、レコード セットの親にアタッチします。</span><span class="sxs-lookup"><span data-stu-id="ced5a-102">The stage of the A record set definition allowing to add additional A records or attach the record set to the parent.</span></span>
            </summary>
