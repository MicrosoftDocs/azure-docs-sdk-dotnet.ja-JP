<Type Name="IWithMXRecordMailExchangeOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateDefinition.IWithMXRecordMailExchangeOrAttachable&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="86485-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="86485-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="86485-102">MX レコードのステージでは、他の MX レコードを追加またはレコード セットの親にアタッチできるように定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="86485-102">The stage of the MX record set definition allowing to add additional MX records or attach the record set to the parent.</span></span>
            </summary>
