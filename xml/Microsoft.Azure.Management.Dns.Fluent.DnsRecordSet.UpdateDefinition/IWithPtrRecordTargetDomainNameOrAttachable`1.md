<Type Name="IWithPtrRecordTargetDomainNameOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateDefinition.IWithPtrRecordTargetDomainNameOrAttachable&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="eb9b2-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="eb9b2-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="eb9b2-102">PTR レコードのステージでは、追加の PTR レコードを追加またはレコード セットの親にアタッチできるように定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="eb9b2-102">The stage of the PTR record set definition allowing to add additional PTR records or attach the record set to the parent.</span></span>
            </summary>
