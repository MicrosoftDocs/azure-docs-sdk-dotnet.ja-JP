<Type Name="IWithMetadata&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateDefinition.IWithMetadata&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="c38d6-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="c38d6-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="c38d6-102">レコードのステージでは、メタデータを指定できるように定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="c38d6-102">The stage of the record set definition allowing to specify metadata.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithMetadata">
      ...
      <Docs>
        <param name="key"><span data-ttu-id="c38d6-103">メタデータのキー。</span><span class="sxs-lookup"><span data-stu-id="c38d6-103">The key for the metadata.</span></span></param>
        <param name="value"><span data-ttu-id="c38d6-104">メタデータの値です。</span><span class="sxs-lookup"><span data-stu-id="c38d6-104">The value for the metadata.</span></span></param>
        <summary>
            <span data-ttu-id="c38d6-105">リソースにタグを追加します。</span><span class="sxs-lookup"><span data-stu-id="c38d6-105">Adds a tag to the resource.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c38d6-106">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c38d6-106">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>