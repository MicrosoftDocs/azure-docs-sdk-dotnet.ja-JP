<Type Name="ChaosStatus" FullName="System.Fabric.Chaos.DataStructures.ChaosStatus">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="0d2b1-101">Chaos が現在実行中のタスクを表します。</span><span class="sxs-lookup"><span data-stu-id="0d2b1-101">Represents the task that Chaos is presently executing.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="0d2b1-102">現在のタスクが有効ではないことを示します。</span><span class="sxs-lookup"><span data-stu-id="0d2b1-102">Indicates that the current task is invalid.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Running">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="0d2b1-103">Chaos がエラーを発生させることの一部としてアクションを実行していることを示します。</span><span class="sxs-lookup"><span data-stu-id="0d2b1-103">Indicates that Chaos is executing actions as part of fault inducing.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Stopped">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="0d2b1-104">今すぐ検証する場合は、クラスターが安定し、正常な状態、Chaos にエラーを発生させることが完了したことを示します。</span><span class="sxs-lookup"><span data-stu-id="0d2b1-104">Indicates that Chaos has finished inducing faults and now it is validating if the Cluster is stable and healthy.</span></span></para>
        </summary>
      </Docs>
    </Member>
  </Members>
