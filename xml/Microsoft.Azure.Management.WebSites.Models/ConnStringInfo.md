<Type Name="ConnStringInfo" FullName="Microsoft.Azure.Management.WebSites.Models.ConnStringInfo">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="229da-101">データベース接続文字列の情報です。</span><span class="sxs-lookup"><span data-stu-id="229da-101">Database connection string information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="229da-102">ConnStringInfo クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="229da-102">Initializes a new instance of the ConnStringInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="229da-103">接続文字列の名前です。</span><span class="sxs-lookup"><span data-stu-id="229da-103">Name of connection string.</span></span></param>
        <param name="connectionString"><span data-ttu-id="229da-104">接続文字列値です。</span><span class="sxs-lookup"><span data-stu-id="229da-104">Connection string value.</span></span></param>
        <param name="type"><span data-ttu-id="229da-105">データベースの種類。</span><span class="sxs-lookup"><span data-stu-id="229da-105">Type of database.</span></span> <span data-ttu-id="229da-106">使用可能な値が含まれます: 'MySql'、'SQLServer'、'SQLAzure'、'Custom'、'NotificationHub'、'ServiceBus'、'EventHub'、'ApiHub'、'DocDb'、'RedisCache'、'PostgreSQL'</span><span class="sxs-lookup"><span data-stu-id="229da-106">Possible values include: 'MySql', 'SQLServer', 'SQLAzure', 'Custom', 'NotificationHub', 'ServiceBus', 'EventHub', 'ApiHub', 'DocDb', 'RedisCache', 'PostgreSQL'</span></span></param>
        <summary>
            <span data-ttu-id="229da-107">ConnStringInfo クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="229da-107">Initializes a new instance of the ConnStringInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="229da-108">取得または接続文字列の値を設定します。</span><span class="sxs-lookup"><span data-stu-id="229da-108">Gets or sets connection string value.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="229da-109">取得または接続文字列の名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="229da-109">Gets or sets name of connection string.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="229da-110">取得またはデータベースの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="229da-110">Gets or sets type of database.</span></span> <span data-ttu-id="229da-111">使用可能な値が含まれます: 'MySql'、'SQLServer'、'SQLAzure'、'Custom'、'NotificationHub'、'ServiceBus'、'EventHub'、'ApiHub'、'DocDb'、'RedisCache'、'PostgreSQL'</span><span class="sxs-lookup"><span data-stu-id="229da-111">Possible values include: 'MySql', 'SQLServer', 'SQLAzure', 'Custom', 'NotificationHub', 'ServiceBus', 'EventHub', 'ApiHub', 'DocDb', 'RedisCache', 'PostgreSQL'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
