<Type Name="ContinuousWebJobStatus" FullName="Microsoft.Azure.Management.WebSites.Models.ContinuousWebJobStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1cd57-101">ContinuousWebJobStatus の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="1cd57-101">Defines values for ContinuousWebJobStatus.</span></span>
            </summary>
