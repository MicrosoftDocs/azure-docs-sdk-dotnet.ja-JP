<Type Name="CustomHostnameAnalysisResult" FullName="Microsoft.Azure.Management.WebSites.Models.CustomHostnameAnalysisResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ab4d8-101">カスタム ドメインの分析。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-101">Custom domain analysis.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-102">CustomHostnameAnalysisResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-102">Initializes a new instance of the CustomHostnameAnalysisResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="ab4d8-103">リソース id です。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-103">Resource Id.</span></span></param>
        <param name="name"><span data-ttu-id="ab4d8-104">リソースの名前です。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-104">Resource Name.</span></span></param>
        <param name="kind"><span data-ttu-id="ab4d8-105">リソースの種類。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-105">Kind of resource.</span></span></param>
        <param name="type"><span data-ttu-id="ab4d8-106">リソースの種類。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-106">Resource type.</span></span></param>
        <param name="isHostnameAlreadyVerified"><span data-ttu-id="ab4d8-107">&lt;コード&gt;true&lt;/code&gt;ホスト名であることを確認、それ以外の場合&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-107">&lt;code&gt;true&lt;/code&gt; if hostname is already verified; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="customDomainVerificationTest"><span data-ttu-id="ab4d8-108">DNS の確認は、結果をテストします。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-108">DNS verification test result.</span></span> <span data-ttu-id="ab4d8-109">使用可能な値が含まれます: '成功'、'失敗'、'スキップ'</span><span class="sxs-lookup"><span data-stu-id="ab4d8-109">Possible values include: 'Passed', 'Failed', 'Skipped'</span></span></param>
        <param name="customDomainVerificationFailureInfo"><span data-ttu-id="ab4d8-110">DNS の確認が失敗した場合の生のエラーに関する情報。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-110">Raw failure information if DNS verification fails.</span></span></param>
        <param name="hasConflictOnScaleUnit"><span data-ttu-id="ab4d8-111">&lt;コード&gt;true&lt;/code&gt; ; スケール ユニットに競合がある場合は、それ以外の場合、&lt;コード&gt;false&lt;/code&gt;。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-111">&lt;code&gt;true&lt;/code&gt; if there is a conflict on a scale unit; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="hasConflictAcrossSubscription"><span data-ttu-id="ab4d8-112">&lt;コード&gt;true&lt;/code&gt;サブスクリプション間で競合がある場合は、それ以外の場合、&lt;コード&gt;false&lt;/code&gt;です。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-112">&lt;code&gt;true&lt;/code&gt; if htere is a conflict across subscriptions; otherwise, &lt;code&gt;false&lt;/code&gt;.</span></span></param>
        <param name="conflictingAppResourceId"><span data-ttu-id="ab4d8-113">同じサブスクリプション内にある場合、スケール ユニットで競合しているアプリの名前です。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-113">Name of the conflicting app on scale unit if it's within the same subscription.</span></span></param>
        <param name="cNameRecords"><span data-ttu-id="ab4d8-114">CName レコードのコント ローラーは、このホスト名を確認できます。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-114">CName records controller can see for this hostname.</span></span></param>
        <param name="txtRecords"><span data-ttu-id="ab4d8-115">TXT レコードのコント ローラーは、このホスト名を確認できます。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-115">TXT records controller can see for this hostname.</span></span></param>
        <param name="aRecords"><span data-ttu-id="ab4d8-116">レコードのコント ローラーは、このホスト名を確認できます。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-116">A records controller can see for this hostname.</span></span></param>
        <param name="alternateCNameRecords"><span data-ttu-id="ab4d8-117">代替の CName レコードのコント ローラーは、このホスト名を確認できます。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-117">Alternate CName records controller can see for this hostname.</span></span></param>
        <param name="alternateTxtRecords"><span data-ttu-id="ab4d8-118">代替の TXT レコードのコント ローラーは、このホスト名を確認できます。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-118">Alternate TXT records controller can see for this hostname.</span></span></param>
        <summary>
            <span data-ttu-id="ab4d8-119">CustomHostnameAnalysisResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-119">Initializes a new instance of the CustomHostnameAnalysisResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AlternateCNameRecords">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-120">取得または設定の代替の CName レコードのコント ローラーをこのホスト名を参照してください。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-120">Gets or sets alternate CName records controller can see for this hostname.</span></span>
            </summary>
    ...
    <Member MemberName="AlternateTxtRecords">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-121">取得または設定の代替の TXT レコードをこのホスト名のコント ローラーを確認できます。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-121">Gets or sets alternate TXT records controller can see for this hostname.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ARecords">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-122">取得または設定の a レコードをこのホスト名のコント ローラーを確認できます。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-122">Gets or sets a records controller can see for this hostname.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CNameRecords">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-123">取得または設定の cName レコードをこのホスト名のコント ローラーを確認できます。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-123">Gets or sets cName records controller can see for this hostname.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ConflictingAppResourceId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-124">同じサブスクリプション内にある場合は、スケール ユニットの競合しているアプリの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-124">Gets name of the conflicting app on scale unit if it's within the same subscription.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CustomDomainVerificationFailureInfo">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-125">DNS の確認が失敗した場合は、生のエラーに関する情報を取得します。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-125">Gets raw failure information if DNS verification fails.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CustomDomainVerificationTest">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-126">DNS の検証テストの結果を取得します。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-126">Gets DNS verification test result.</span></span> <span data-ttu-id="ab4d8-127">使用可能な値が含まれます: '成功'、'失敗'、'スキップ'</span><span class="sxs-lookup"><span data-stu-id="ab4d8-127">Possible values include: 'Passed', 'Failed', 'Skipped'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HasConflictAcrossSubscription">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-128">取得&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; サブスクリプション間で競合がある場合は、それ以外の場合、 &amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-128">Gets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if htere is a conflict across subscriptions; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HasConflictOnScaleUnit">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-129">取得&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; スケール ユニットに競合がある場合は、それ以外の場合、 &amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-129">Gets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if there is a conflict on a scale unit; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsHostnameAlreadyVerified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-130">取得&amp;lt; コード&amp;gt 以外の場合は true。&amp;lt;/code&amp;gt; のホスト名はが既に検証済み、それ以外の場合&amp;lt; コード&amp;gt 以外の場合は false&amp;lt;/code&amp;gt;。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-130">Gets &amp;lt;code&amp;gt;true&amp;lt;/code&amp;gt; if hostname is already verified; otherwise, &amp;lt;code&amp;gt;false&amp;lt;/code&amp;gt;.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TxtRecords">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab4d8-131">取得または設定 TXT レコードをこのホスト名のコント ローラーを確認できます。</span><span class="sxs-lookup"><span data-stu-id="ab4d8-131">Gets or sets TXT records controller can see for this hostname.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
