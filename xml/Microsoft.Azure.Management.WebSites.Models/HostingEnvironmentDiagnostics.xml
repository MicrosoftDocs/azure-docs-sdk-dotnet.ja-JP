<Type Name="HostingEnvironmentDiagnostics" FullName="Microsoft.Azure.Management.WebSites.Models.HostingEnvironmentDiagnostics">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d5ba8-101">App Service 環境を診断します。</span><span class="sxs-lookup"><span data-stu-id="d5ba8-101">Diagnostics for an App Service Environment.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5ba8-102">HostingEnvironmentDiagnostics クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="d5ba8-102">Initializes a new instance of the HostingEnvironmentDiagnostics class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="d5ba8-103">診断の名前または識別子です。</span><span class="sxs-lookup"><span data-stu-id="d5ba8-103">Name/identifier of the diagnostics.</span></span></param>
        <param name="diagnosicsOutput"><span data-ttu-id="d5ba8-104">出力を診断します。</span><span class="sxs-lookup"><span data-stu-id="d5ba8-104">Diagnostics output.</span></span></param>
        <summary>
            <span data-ttu-id="d5ba8-105">HostingEnvironmentDiagnostics クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="d5ba8-105">Initializes a new instance of the HostingEnvironmentDiagnostics class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DiagnosicsOutput">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5ba8-106">取得または診断の出力を設定します。</span><span class="sxs-lookup"><span data-stu-id="d5ba8-106">Gets or sets diagnostics output.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d5ba8-107">取得または診断の名前と識別子を設定します。</span><span class="sxs-lookup"><span data-stu-id="d5ba8-107">Gets or sets name/identifier of the diagnostics.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
