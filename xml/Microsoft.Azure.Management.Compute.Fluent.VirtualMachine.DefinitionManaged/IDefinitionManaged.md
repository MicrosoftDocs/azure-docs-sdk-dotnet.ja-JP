<Type Name="IDefinitionManaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.DefinitionManaged.IDefinitionManaged">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a29b3-101">仮想マシンの定義を管理対象ディスク全体に基づいています。</span><span class="sxs-lookup"><span data-stu-id="a29b3-101">The entirety of the managed disk based virtual machine definition.</span></span>
            </summary>
