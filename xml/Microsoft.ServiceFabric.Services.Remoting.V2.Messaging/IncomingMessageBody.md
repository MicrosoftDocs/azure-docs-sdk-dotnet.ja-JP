<Type Name="IncomingMessageBody" FullName="Microsoft.ServiceFabric.Services.Remoting.V2.Messaging.IncomingMessageBody">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1e9a7-101">シリアル化されたメッセージの本文で受信接続から受信します。</span><span class="sxs-lookup"><span data-stu-id="1e9a7-101">Serialized Message Body received from an incoming connection.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="1e9a7-102">受信したストリームと、着信メッセージの本文を作成します。</span><span class="sxs-lookup"><span data-stu-id="1e9a7-102">Creates an incoming Message Body with the received stream .</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Dispose">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1e9a7-103">受信バッファー ストリームが破棄します。</span><span class="sxs-lookup"><span data-stu-id="1e9a7-103">Dispose the Received Buffer stream</span></span> 
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetReceivedBuffer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1e9a7-104">受信バッファー ストリームを返す</span><span class="sxs-lookup"><span data-stu-id="1e9a7-104">Return the Received Buffer Stream</span></span> 
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetSendBuffers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1e9a7-105">これは、この実装は使用されません。</span><span class="sxs-lookup"><span data-stu-id="1e9a7-105">This is not used for this implementation</span></span>
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
