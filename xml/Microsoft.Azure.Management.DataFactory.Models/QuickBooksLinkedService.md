<Type Name="QuickBooksLinkedService" FullName="Microsoft.Azure.Management.DataFactory.Models.QuickBooksLinkedService">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0d5b3-101">QuickBooks サーバーにリンクされたサービスを指定します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-101">QuickBooks server linked service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d5b3-102">QuickBooksLinkedService クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-102">Initializes a new instance of the QuickBooksLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="endpoint"><span data-ttu-id="0d5b3-103">QuickBooks サーバーのエンドポイント。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-103">The endpoint of the QuickBooks server.</span></span> <span data-ttu-id="0d5b3-104">(つまり quickbooks.api.intuit.com)</span><span class="sxs-lookup"><span data-stu-id="0d5b3-104">(i.e. quickbooks.api.intuit.com)</span></span></param>
        <param name="companyId"><span data-ttu-id="0d5b3-105">承認する QuickBooks の会社の会社 ID。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-105">The company ID of the QuickBooks company to authorize.</span></span></param>
        <param name="additionalProperties"><span data-ttu-id="0d5b3-106">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="0d5b3-106">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="connectVia"><span data-ttu-id="0d5b3-107">統合のランタイム参照。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-107">The integration runtime reference.</span></span></param>
        <param name="description"><span data-ttu-id="0d5b3-108">リンクされたサービスの説明。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-108">Linked service description.</span></span></param>
        <param name="accessToken"><span data-ttu-id="0d5b3-109">OAuth 1.0 認証のアクセス トークン。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-109">The access token for OAuth 1.0 authentication.</span></span></param>
        <param name="accessTokenSecret"><span data-ttu-id="0d5b3-110">OAuth 1.0 認証のアクセス トークン シークレット。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-110">The access token secret for OAuth 1.0 authentication.</span></span></param>
        <param name="useEncryptedEndpoints"><span data-ttu-id="0d5b3-111">データ ソースのエンドポイントが HTTPS を使用して暗号化されるかどうかを指定します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-111">Specifies whether the data source endpoints are encrypted using HTTPS.</span></span> <span data-ttu-id="0d5b3-112">既定値は true です。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-112">The default value is true.</span></span></param>
        <param name="encryptedCredential"><span data-ttu-id="0d5b3-113">暗号化された資格情報の認証に使用します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-113">The encrypted credential used for authentication.</span></span> <span data-ttu-id="0d5b3-114">資格情報は、統合ランタイム資格情報マネージャーを使用して暗号化されます。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-114">Credentials are encrypted using the integration runtime credential manager.</span></span> <span data-ttu-id="0d5b3-115">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-115">Type: string (or Expression with resultType string).</span></span></param>
        <summary>
            <span data-ttu-id="0d5b3-116">QuickBooksLinkedService クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-116">Initializes a new instance of the QuickBooksLinkedService class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AccessToken">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d5b3-117">取得または OAuth 1.0 認証アクセス トークンを設定します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-117">Gets or sets the access token for OAuth 1.0 authentication.</span></span>
            </summary>
    ...
    <Member MemberName="AccessTokenSecret">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d5b3-118">取得または OAuth 1.0 認証アクセス トークン シークレットを設定します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-118">Gets or sets the access token secret for OAuth 1.0 authentication.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CompanyId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d5b3-119">取得または承認するために QuickBooks 会社の企業 ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-119">Gets or sets the company ID of the QuickBooks company to authorize.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EncryptedCredential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d5b3-120">取得または認証に使用される暗号化された資格情報を設定します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-120">Gets or sets the encrypted credential used for authentication.</span></span>
            <span data-ttu-id="0d5b3-121">資格情報は、統合ランタイム資格情報マネージャーを使用して暗号化されます。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-121">Credentials are encrypted using the integration runtime credential manager.</span></span> <span data-ttu-id="0d5b3-122">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-122">Type: string (or Expression with resultType string).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Endpoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d5b3-123">取得または QuickBooks サーバーのエンドポイントを設定します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-123">Gets or sets the endpoint of the QuickBooks server.</span></span> <span data-ttu-id="0d5b3-124">(つまり quickbooks.api.intuit.com)</span><span class="sxs-lookup"><span data-stu-id="0d5b3-124">(i.e. quickbooks.api.intuit.com)</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UseEncryptedEndpoints">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d5b3-125">取得または設定は、データ ソースのエンドポイントは HTTPS を使用して暗号化するかどうかを指定します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-125">Gets or sets specifies whether the data source endpoints are encrypted using HTTPS.</span></span> <span data-ttu-id="0d5b3-126">既定値は true です。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-126">The default value is true.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0d5b3-127">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-127">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="0d5b3-128">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="0d5b3-128">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
