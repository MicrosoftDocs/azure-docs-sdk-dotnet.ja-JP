<Type Name="AmazonRedshiftSource" FullName="Microsoft.Azure.Management.DataFactory.Models.AmazonRedshiftSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dde97-101">Amazon Redshift ソースのコピー活動元。</span><span class="sxs-lookup"><span data-stu-id="dde97-101">A copy activity source for Amazon Redshift Source.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dde97-102">AmazonRedshiftSource クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="dde97-102">Initializes a new instance of the AmazonRedshiftSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="dde97-103">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="dde97-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="sourceRetryCount"><span data-ttu-id="dde97-104">ソースの再試行回数です。</span><span class="sxs-lookup"><span data-stu-id="dde97-104">Source retry count.</span></span> <span data-ttu-id="dde97-105">型: 整数 (または式に整数の resultType)。</span><span class="sxs-lookup"><span data-stu-id="dde97-105">Type: integer (or Expression with resultType integer).</span></span></param>
        <param name="sourceRetryWait"><span data-ttu-id="dde97-106">ソースの再試行の待機です。</span><span class="sxs-lookup"><span data-stu-id="dde97-106">Source retry wait.</span></span> <span data-ttu-id="dde97-107">型: 文字列 (または式の resultType 文字列)、パターン: ((\d+)\.)? (\d\d):(60|([0-5][0-9])): (60 |([0-5][0-9])) です。</span><span class="sxs-lookup"><span data-stu-id="dde97-107">Type: string (or Expression with resultType string), pattern: ((\d+)\.)?(\d\d):(60|([0-5][0-9])):(60|([0-5][0-9])).</span></span></param>
        <param name="query"><span data-ttu-id="dde97-108">データベースのクエリ。</span><span class="sxs-lookup"><span data-stu-id="dde97-108">Database query.</span></span> <span data-ttu-id="dde97-109">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="dde97-109">Type: string (or Expression with resultType string).</span></span></param>
        <param name="redshiftUnloadSettings"><span data-ttu-id="dde97-110">Amazon Redshift からコピーするときに、中間の Amazon S3 に必要な Amazon S3 設定をアンロードします。</span><span class="sxs-lookup"><span data-stu-id="dde97-110">The Amazon S3 settings needed for the interim Amazon S3 when copying from Amazon Redshift with unload.</span></span> <span data-ttu-id="dde97-111">これにより、Amazon Redshift ソースからデータをまず S3 にアンロードし、する中間 S3 から対象となるシンクにコピーされます。</span><span class="sxs-lookup"><span data-stu-id="dde97-111">With this, data from Amazon Redshift source will be unloaded into S3 first and then copied into the targeted sink from the interim S3.</span></span></param>
        <summary>
            <span data-ttu-id="dde97-112">AmazonRedshiftSource クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="dde97-112">Initializes a new instance of the AmazonRedshiftSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dde97-113">取得またはデータベース クエリを設定します。</span><span class="sxs-lookup"><span data-stu-id="dde97-113">Gets or sets database query.</span></span> <span data-ttu-id="dde97-114">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="dde97-114">Type: string (or Expression with resultType string).</span></span>
            </summary>
    ...
    <Member MemberName="RedshiftUnloadSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dde97-115">取得またはアンロードで Amazon Redshift からコピーするときに、中間の Amazon S3 に必要な Amazon S3 設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="dde97-115">Gets or sets the Amazon S3 settings needed for the interim Amazon S3 when copying from Amazon Redshift with unload.</span></span> <span data-ttu-id="dde97-116">これにより、Amazon Redshift ソースからデータをまず S3 にアンロードし、する中間 S3 から対象となるシンクにコピーされます。</span><span class="sxs-lookup"><span data-stu-id="dde97-116">With this, data from Amazon Redshift source will be unloaded into S3 first and then copied into the targeted sink from the interim S3.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dde97-117">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="dde97-117">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="dde97-118">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="dde97-118">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
