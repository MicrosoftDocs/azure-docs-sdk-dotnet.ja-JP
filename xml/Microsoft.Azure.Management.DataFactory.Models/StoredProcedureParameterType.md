<Type Name="StoredProcedureParameterType" FullName="Microsoft.Azure.Management.DataFactory.Models.StoredProcedureParameterType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="eeedc-101">StoredProcedureParameterType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="eeedc-101">Defines values for StoredProcedureParameterType.</span></span>
            </summary>
