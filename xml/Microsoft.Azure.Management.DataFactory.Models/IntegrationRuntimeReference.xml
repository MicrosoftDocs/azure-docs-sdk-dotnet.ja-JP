<Type Name="IntegrationRuntimeReference" FullName="Microsoft.Azure.Management.DataFactory.Models.IntegrationRuntimeReference">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b024d-101">統合ランタイム参照の種類。</span><span class="sxs-lookup"><span data-stu-id="b024d-101">Integration runtime reference type.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b024d-102">IntegrationRuntimeReference クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b024d-102">Initializes a new instance of the IntegrationRuntimeReference class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="referenceName"><span data-ttu-id="b024d-103">参照の統合のランタイム名です。</span><span class="sxs-lookup"><span data-stu-id="b024d-103">Reference integration runtime name.</span></span></param>
        <param name="parameters"><span data-ttu-id="b024d-104">統合ランタイムの引数。</span><span class="sxs-lookup"><span data-stu-id="b024d-104">Arguments for integration runtime.</span></span></param>
        <summary>
            <span data-ttu-id="b024d-105">IntegrationRuntimeReference クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b024d-105">Initializes a new instance of the IntegrationRuntimeReference class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b024d-106">取得または統合ランタイムの引数を設定します。</span><span class="sxs-lookup"><span data-stu-id="b024d-106">Gets or sets arguments for integration runtime.</span></span>
            </summary>
    ...
    <Member MemberName="ReferenceName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b024d-107">取得または参照統合ランタイム名を設定します。</span><span class="sxs-lookup"><span data-stu-id="b024d-107">Gets or sets reference integration runtime name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b024d-108">統合ランタイムの型。</span><span class="sxs-lookup"><span data-stu-id="b024d-108">Type of integration runtime.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b024d-109">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="b024d-109">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="b024d-110">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="b024d-110">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
