<Type Name="SapCloudForCustomerSink" FullName="Microsoft.Azure.Management.DataFactory.Models.SapCloudForCustomerSink">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="79806-101">顧客シンクのコピー アクティビティ SAP クラウド。</span><span class="sxs-lookup"><span data-stu-id="79806-101">A copy activity SAP Cloud for Customer sink.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="79806-102">SapCloudForCustomerSink クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="79806-102">Initializes a new instance of the SapCloudForCustomerSink class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="79806-103">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="79806-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="writeBatchSize"><span data-ttu-id="79806-104">バッチ サイズを記述します。</span><span class="sxs-lookup"><span data-stu-id="79806-104">Write batch size.</span></span> <span data-ttu-id="79806-105">型: 整数 (または式と resultType 整数)、最小値: 0。</span><span class="sxs-lookup"><span data-stu-id="79806-105">Type: integer (or Expression with resultType integer), minimum: 0.</span></span></param>
        <param name="writeBatchTimeout"><span data-ttu-id="79806-106">バッチ タイムアウトを記述します。</span><span class="sxs-lookup"><span data-stu-id="79806-106">Write batch timeout.</span></span> <span data-ttu-id="79806-107">型: 文字列 (または式の resultType 文字列)、パターン: ((\d+)\.)? (\d\d):(60|([0-5][0-9])): (60 |([0-5][0-9])) です。</span><span class="sxs-lookup"><span data-stu-id="79806-107">Type: string (or Expression with resultType string), pattern: ((\d+)\.)?(\d\d):(60|([0-5][0-9])):(60|([0-5][0-9])).</span></span></param>
        <param name="sinkRetryCount"><span data-ttu-id="79806-108">再試行回数をシンクします。</span><span class="sxs-lookup"><span data-stu-id="79806-108">Sink retry count.</span></span> <span data-ttu-id="79806-109">型: 整数 (または式に整数の resultType)。</span><span class="sxs-lookup"><span data-stu-id="79806-109">Type: integer (or Expression with resultType integer).</span></span></param>
        <param name="sinkRetryWait"><span data-ttu-id="79806-110">再試行の待機をシンクします。</span><span class="sxs-lookup"><span data-stu-id="79806-110">Sink retry wait.</span></span> <span data-ttu-id="79806-111">型: 文字列 (または式の resultType 文字列)、パターン: ((\d+)\.)? (\d\d):(60|([0-5][0-9])): (60 |([0-5][0-9])) です。</span><span class="sxs-lookup"><span data-stu-id="79806-111">Type: string (or Expression with resultType string), pattern: ((\d+)\.)?(\d\d):(60|([0-5][0-9])):(60|([0-5][0-9])).</span></span></param>
        <param name="writeBehavior"><span data-ttu-id="79806-112">操作の書き込み動作。</span><span class="sxs-lookup"><span data-stu-id="79806-112">The write behavior for the operation.</span></span>
            <span data-ttu-id="79806-113">既定値は、'Insert' です。</span><span class="sxs-lookup"><span data-stu-id="79806-113">Default is 'Insert'.</span></span> <span data-ttu-id="79806-114">使用可能な値が含まれます: 'Insert'、'Update'</span><span class="sxs-lookup"><span data-stu-id="79806-114">Possible values include: 'Insert', 'Update'</span></span></param>
        <summary>
            <span data-ttu-id="79806-115">SapCloudForCustomerSink クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="79806-115">Initializes a new instance of the SapCloudForCustomerSink class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WriteBehavior">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="79806-116">取得または書き込みの操作の動作を設定します。</span><span class="sxs-lookup"><span data-stu-id="79806-116">Gets or sets the write behavior for the operation.</span></span> <span data-ttu-id="79806-117">既定値は、'Insert' です。</span><span class="sxs-lookup"><span data-stu-id="79806-117">Default is 'Insert'.</span></span> <span data-ttu-id="79806-118">使用可能な値が含まれます: 'Insert'、'Update'</span><span class="sxs-lookup"><span data-stu-id="79806-118">Possible values include: 'Insert', 'Update'</span></span>
            </summary>
