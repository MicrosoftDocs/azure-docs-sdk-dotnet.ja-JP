<Type Name="IntegrationRuntimeAuthKeyName" FullName="Microsoft.Azure.Management.DataFactory.Models.IntegrationRuntimeAuthKeyName">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9198d-101">IntegrationRuntimeAuthKeyName の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="9198d-101">Defines values for IntegrationRuntimeAuthKeyName.</span></span>
            </summary>
