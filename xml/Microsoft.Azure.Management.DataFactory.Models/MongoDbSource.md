<Type Name="MongoDbSource" FullName="Microsoft.Azure.Management.DataFactory.Models.MongoDbSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="267b8-101">MongoDB データベースのコピー活動元。</span><span class="sxs-lookup"><span data-stu-id="267b8-101">A copy activity source for a MongoDB database.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="267b8-102">MongoDbSource クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="267b8-102">Initializes a new instance of the MongoDbSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="267b8-103">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="267b8-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="sourceRetryCount"><span data-ttu-id="267b8-104">ソースの再試行回数です。</span><span class="sxs-lookup"><span data-stu-id="267b8-104">Source retry count.</span></span> <span data-ttu-id="267b8-105">型: 整数 (または式に整数の resultType)。</span><span class="sxs-lookup"><span data-stu-id="267b8-105">Type: integer (or Expression with resultType integer).</span></span></param>
        <param name="sourceRetryWait"><span data-ttu-id="267b8-106">ソースの再試行の待機です。</span><span class="sxs-lookup"><span data-stu-id="267b8-106">Source retry wait.</span></span> <span data-ttu-id="267b8-107">型: 文字列 (または式の resultType 文字列)、パターン: ((\d+)\.)? (\d\d):(60|([0-5][0-9])): (60 |([0-5][0-9])) です。</span><span class="sxs-lookup"><span data-stu-id="267b8-107">Type: string (or Expression with resultType string), pattern: ((\d+)\.)?(\d\d):(60|([0-5][0-9])):(60|([0-5][0-9])).</span></span></param>
        <param name="query"><span data-ttu-id="267b8-108">データベースのクエリ。</span><span class="sxs-lookup"><span data-stu-id="267b8-108">Database query.</span></span> <span data-ttu-id="267b8-109">SQL 92 クエリ式にする必要があります。</span><span class="sxs-lookup"><span data-stu-id="267b8-109">Should be a SQL-92 query expression.</span></span> <span data-ttu-id="267b8-110">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="267b8-110">Type: string (or Expression with resultType string).</span></span></param>
        <summary>
            <span data-ttu-id="267b8-111">MongoDbSource クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="267b8-111">Initializes a new instance of the MongoDbSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="267b8-112">取得またはデータベース クエリを設定します。</span><span class="sxs-lookup"><span data-stu-id="267b8-112">Gets or sets database query.</span></span> <span data-ttu-id="267b8-113">SQL 92 クエリ式にする必要があります。</span><span class="sxs-lookup"><span data-stu-id="267b8-113">Should be a SQL-92 query expression.</span></span>
            <span data-ttu-id="267b8-114">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="267b8-114">Type: string (or Expression with resultType string).</span></span>
            </summary>
