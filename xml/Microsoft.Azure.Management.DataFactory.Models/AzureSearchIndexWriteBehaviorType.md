<Type Name="AzureSearchIndexWriteBehaviorType" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureSearchIndexWriteBehaviorType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="640a5-101">AzureSearchIndexWriteBehaviorType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="640a5-101">Defines values for AzureSearchIndexWriteBehaviorType.</span></span>
            </summary>
