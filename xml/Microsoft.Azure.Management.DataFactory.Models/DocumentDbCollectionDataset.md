<Type Name="DocumentDbCollectionDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.DocumentDbCollectionDataset">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b180a-101">Microsoft Azure ドキュメント データベース コレクション データセットです。</span><span class="sxs-lookup"><span data-stu-id="b180a-101">Microsoft Azure Document Database Collection dataset.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b180a-102">DocumentDbCollectionDataset クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b180a-102">Initializes a new instance of the DocumentDbCollectionDataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="linkedServiceName"><span data-ttu-id="b180a-103">リンクされたサービスの参照。</span><span class="sxs-lookup"><span data-stu-id="b180a-103">Linked service reference.</span></span></param>
        <param name="collectionName"><span data-ttu-id="b180a-104">データベース コレクション名を文書化します。</span><span class="sxs-lookup"><span data-stu-id="b180a-104">Document Database collection name.</span></span>
            <span data-ttu-id="b180a-105">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="b180a-105">Type: string (or Expression with resultType string).</span></span></param>
        <param name="additionalProperties"><span data-ttu-id="b180a-106">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="b180a-106">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="description"><span data-ttu-id="b180a-107">データセットの説明。</span><span class="sxs-lookup"><span data-stu-id="b180a-107">Dataset description.</span></span></param>
        <param name="structure"><span data-ttu-id="b180a-108">データセットの構造を定義する列。</span><span class="sxs-lookup"><span data-stu-id="b180a-108">Columns that define the structure of the dataset.</span></span> <span data-ttu-id="b180a-109">型: 配列 (または配列の resultType を含む式)、itemType: DatasetDataElement です。</span><span class="sxs-lookup"><span data-stu-id="b180a-109">Type: array (or Expression with resultType array), itemType: DatasetDataElement.</span></span></param>
        <param name="parameters"><span data-ttu-id="b180a-110">データセットのパラメーターです。</span><span class="sxs-lookup"><span data-stu-id="b180a-110">Parameters for dataset.</span></span></param>
        <summary>
            <span data-ttu-id="b180a-111">DocumentDbCollectionDataset クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b180a-111">Initializes a new instance of the DocumentDbCollectionDataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CollectionName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b180a-112">取得またはドキュメント データベース コレクション名を設定します。</span><span class="sxs-lookup"><span data-stu-id="b180a-112">Gets or sets document Database collection name.</span></span> <span data-ttu-id="b180a-113">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="b180a-113">Type: string (or Expression with resultType string).</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b180a-114">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="b180a-114">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="b180a-115">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="b180a-115">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
