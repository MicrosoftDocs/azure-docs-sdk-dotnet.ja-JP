<Type Name="IntegrationRuntimeVNetProperties" FullName="Microsoft.Azure.Management.DataFactory.Models.IntegrationRuntimeVNetProperties">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b9fbe-101">管理されている統合ランタイムの VNet プロパティです。</span><span class="sxs-lookup"><span data-stu-id="b9fbe-101">VNet properties for managed integration runtime.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b9fbe-102">IntegrationRuntimeVNetProperties クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b9fbe-102">Initializes a new instance of the IntegrationRuntimeVNetProperties class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="b9fbe-103">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="b9fbe-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="vNetId"><span data-ttu-id="b9fbe-104">この統合ランタイムを参加させる、VNet の ID。</span><span class="sxs-lookup"><span data-stu-id="b9fbe-104">The ID of the VNet that this integration runtime will join.</span></span></param>
        <param name="subnet"><span data-ttu-id="b9fbe-105">この統合ランタイムを参加させる、サブネットの名前。</span><span class="sxs-lookup"><span data-stu-id="b9fbe-105">The name of the subnet this integration runtime will join.</span></span></param>
        <summary>
            <span data-ttu-id="b9fbe-106">IntegrationRuntimeVNetProperties クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b9fbe-106">Initializes a new instance of the IntegrationRuntimeVNetProperties class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AdditionalProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b9fbe-107">メッセージから一致しないプロパティを取得または設定は、このコレクションを逆シリアル化</span><span class="sxs-lookup"><span data-stu-id="b9fbe-107">Gets or sets unmatched properties from the message are deserialized this collection</span></span>
            </summary>
    ...
    <Member MemberName="Subnet">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b9fbe-108">取得またはこの統合ランタイムを参加させる、サブネットの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="b9fbe-108">Gets or sets the name of the subnet this integration runtime will join.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VNetId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b9fbe-109">取得またはこの統合ランタイムを参加させる、VNet の ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="b9fbe-109">Gets or sets the ID of the VNet that this integration runtime will join.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
