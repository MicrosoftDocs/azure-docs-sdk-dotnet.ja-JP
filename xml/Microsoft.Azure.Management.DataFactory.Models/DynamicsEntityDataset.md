<Type Name="DynamicsEntityDataset" FullName="Microsoft.Azure.Management.DataFactory.Models.DynamicsEntityDataset">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6ecdd-101">Dynamics エンティティ データセットです。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-101">The Dynamics entity dataset.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ecdd-102">DynamicsEntityDataset クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-102">Initializes a new instance of the DynamicsEntityDataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="linkedServiceName"><span data-ttu-id="6ecdd-103">リンクされたサービスの参照。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-103">Linked service reference.</span></span></param>
        <param name="additionalProperties"><span data-ttu-id="6ecdd-104">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="6ecdd-104">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="description"><span data-ttu-id="6ecdd-105">データセットの説明。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-105">Dataset description.</span></span></param>
        <param name="structure"><span data-ttu-id="6ecdd-106">データセットの構造を定義する列。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-106">Columns that define the structure of the dataset.</span></span> <span data-ttu-id="6ecdd-107">型: 配列 (または配列の resultType を含む式)、itemType: DatasetDataElement です。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-107">Type: array (or Expression with resultType array), itemType: DatasetDataElement.</span></span></param>
        <param name="parameters"><span data-ttu-id="6ecdd-108">データセットのパラメーターです。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-108">Parameters for dataset.</span></span></param>
        <param name="entityName"><span data-ttu-id="6ecdd-109">エンティティの論理名。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-109">The logical name of the entity.</span></span> <span data-ttu-id="6ecdd-110">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-110">Type: string (or Expression with resultType string).</span></span></param>
        <summary>
            <span data-ttu-id="6ecdd-111">DynamicsEntityDataset クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-111">Initializes a new instance of the DynamicsEntityDataset class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EntityName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ecdd-112">取得またはエンティティの論理名を設定します。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-112">Gets or sets the logical name of the entity.</span></span> <span data-ttu-id="6ecdd-113">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-113">Type: string (or Expression with resultType string).</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ecdd-114">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-114">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="6ecdd-115">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="6ecdd-115">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
