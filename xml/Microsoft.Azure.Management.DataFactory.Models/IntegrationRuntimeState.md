<Type Name="IntegrationRuntimeState" FullName="Microsoft.Azure.Management.DataFactory.Models.IntegrationRuntimeState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1a3a7-101">IntegrationRuntimeState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="1a3a7-101">Defines values for IntegrationRuntimeState.</span></span>
            </summary>
