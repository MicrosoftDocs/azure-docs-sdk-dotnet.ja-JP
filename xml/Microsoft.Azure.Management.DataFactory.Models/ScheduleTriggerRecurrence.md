<Type Name="ScheduleTriggerRecurrence" FullName="Microsoft.Azure.Management.DataFactory.Models.ScheduleTriggerRecurrence">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="86ab0-101">トリガーの繰り返しがワークフロー。</span><span class="sxs-lookup"><span data-stu-id="86ab0-101">The workflow trigger recurrence.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="86ab0-102">ScheduleTriggerRecurrence クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="86ab0-102">Initializes a new instance of the ScheduleTriggerRecurrence class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="86ab0-103">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="86ab0-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="frequency"><span data-ttu-id="86ab0-104">頻度です。</span><span class="sxs-lookup"><span data-stu-id="86ab0-104">The frequency.</span></span> <span data-ttu-id="86ab0-105">使用可能な値が含まれます: 'NotSpecified'、'Minute'、'Hour'、'Day'、'週'、'Month'、'Year'</span><span class="sxs-lookup"><span data-stu-id="86ab0-105">Possible values include: 'NotSpecified', 'Minute', 'Hour', 'Day', 'Week', 'Month', 'Year'</span></span></param>
        <param name="interval"><span data-ttu-id="86ab0-106">間隔です。</span><span class="sxs-lookup"><span data-stu-id="86ab0-106">The interval.</span></span></param>
        <param name="startTime"><span data-ttu-id="86ab0-107">開始時刻です。</span><span class="sxs-lookup"><span data-stu-id="86ab0-107">The start time.</span></span></param>
        <param name="endTime"><span data-ttu-id="86ab0-108">終了時刻。</span><span class="sxs-lookup"><span data-stu-id="86ab0-108">The end time.</span></span></param>
        <param name="timeZone"><span data-ttu-id="86ab0-109">タイム ゾーン。</span><span class="sxs-lookup"><span data-stu-id="86ab0-109">The time zone.</span></span></param>
        <param name="schedule"><span data-ttu-id="86ab0-110">定期的なスケジュールします。</span><span class="sxs-lookup"><span data-stu-id="86ab0-110">The recurrence schedule.</span></span></param>
        <summary>
            <span data-ttu-id="86ab0-111">ScheduleTriggerRecurrence クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="86ab0-111">Initializes a new instance of the ScheduleTriggerRecurrence class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AdditionalProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="86ab0-112">メッセージから一致しないプロパティを取得または設定は、このコレクションを逆シリアル化</span><span class="sxs-lookup"><span data-stu-id="86ab0-112">Gets or sets unmatched properties from the message are deserialized this collection</span></span>
            </summary>
    ...
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="86ab0-113">取得または終了時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="86ab0-113">Gets or sets the end time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Frequency">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="86ab0-114">取得または頻度を設定します。</span><span class="sxs-lookup"><span data-stu-id="86ab0-114">Gets or sets the frequency.</span></span> <span data-ttu-id="86ab0-115">使用可能な値が含まれます: 'NotSpecified'、'Minute'、'Hour'、'Day'、'週'、'Month'、'Year'</span><span class="sxs-lookup"><span data-stu-id="86ab0-115">Possible values include: 'NotSpecified', 'Minute', 'Hour', 'Day', 'Week', 'Month', 'Year'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Interval">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="86ab0-116">取得または間隔を設定します。</span><span class="sxs-lookup"><span data-stu-id="86ab0-116">Gets or sets the interval.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Schedule">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="86ab0-117">取得または定期的なスケジュールを設定します。</span><span class="sxs-lookup"><span data-stu-id="86ab0-117">Gets or sets the recurrence schedule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="86ab0-118">取得または開始時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="86ab0-118">Gets or sets the start time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeZone">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="86ab0-119">取得またはタイム ゾーンを設定します。</span><span class="sxs-lookup"><span data-stu-id="86ab0-119">Gets or sets the time zone.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
