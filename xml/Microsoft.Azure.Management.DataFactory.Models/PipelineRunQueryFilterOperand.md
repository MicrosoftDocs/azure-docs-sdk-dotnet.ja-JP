<Type Name="PipelineRunQueryFilterOperand" FullName="Microsoft.Azure.Management.DataFactory.Models.PipelineRunQueryFilterOperand">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="05b69-101">PipelineRunQueryFilterOperand の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="05b69-101">Defines values for PipelineRunQueryFilterOperand.</span></span>
            </summary>
