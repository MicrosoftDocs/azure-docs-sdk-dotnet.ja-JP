<Type Name="AzureMySqlSource" FullName="Microsoft.Azure.Management.DataFactory.Models.AzureMySqlSource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="05e8f-101">コピー アクティビティの Azure の MySQL ソース。</span><span class="sxs-lookup"><span data-stu-id="05e8f-101">A copy activity Azure MySQL source.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="05e8f-102">AzureMySqlSource クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="05e8f-102">Initializes a new instance of the AzureMySqlSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="05e8f-103">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="05e8f-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="sourceRetryCount"><span data-ttu-id="05e8f-104">ソースの再試行回数です。</span><span class="sxs-lookup"><span data-stu-id="05e8f-104">Source retry count.</span></span> <span data-ttu-id="05e8f-105">型: 整数 (または式に整数の resultType)。</span><span class="sxs-lookup"><span data-stu-id="05e8f-105">Type: integer (or Expression with resultType integer).</span></span></param>
        <param name="sourceRetryWait"><span data-ttu-id="05e8f-106">ソースの再試行の待機です。</span><span class="sxs-lookup"><span data-stu-id="05e8f-106">Source retry wait.</span></span> <span data-ttu-id="05e8f-107">型: 文字列 (または式の resultType 文字列)、パターン: ((\d+)\.)? (\d\d):(60|([0-5][0-9])): (60 |([0-5][0-9])) です。</span><span class="sxs-lookup"><span data-stu-id="05e8f-107">Type: string (or Expression with resultType string), pattern: ((\d+)\.)?(\d\d):(60|([0-5][0-9])):(60|([0-5][0-9])).</span></span></param>
        <param name="query"><span data-ttu-id="05e8f-108">データベースのクエリ。</span><span class="sxs-lookup"><span data-stu-id="05e8f-108">Database query.</span></span> <span data-ttu-id="05e8f-109">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="05e8f-109">Type: string (or Expression with resultType string).</span></span></param>
        <summary>
            <span data-ttu-id="05e8f-110">AzureMySqlSource クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="05e8f-110">Initializes a new instance of the AzureMySqlSource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Query">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="05e8f-111">取得またはデータベース クエリを設定します。</span><span class="sxs-lookup"><span data-stu-id="05e8f-111">Gets or sets database query.</span></span> <span data-ttu-id="05e8f-112">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="05e8f-112">Type: string (or Expression with resultType string).</span></span>
            </summary>
