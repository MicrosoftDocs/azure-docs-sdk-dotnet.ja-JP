<Type Name="OrcFormat" FullName="Microsoft.Azure.Management.DataFactory.Models.OrcFormat">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8b523-101">最適化行式 (ORC) 形式で格納されているデータ。</span><span class="sxs-lookup"><span data-stu-id="8b523-101">The data stored in Optimized Row Columnar (ORC) format.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8b523-102">OrcFormat クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="8b523-102">Initializes a new instance of the OrcFormat class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="additionalProperties"><span data-ttu-id="8b523-103">メッセージから一致しないプロパティを逆シリアル化は、このコレクション</span><span class="sxs-lookup"><span data-stu-id="8b523-103">Unmatched properties from the message are deserialized this collection</span></span></param>
        <param name="serializer"><span data-ttu-id="8b523-104">シリアライザー。</span><span class="sxs-lookup"><span data-stu-id="8b523-104">Serializer.</span></span> <span data-ttu-id="8b523-105">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="8b523-105">Type: string (or Expression with resultType string).</span></span></param>
        <param name="deserializer"><span data-ttu-id="8b523-106">デシリアライザー。</span><span class="sxs-lookup"><span data-stu-id="8b523-106">Deserializer.</span></span> <span data-ttu-id="8b523-107">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="8b523-107">Type: string (or Expression with resultType string).</span></span></param>
        <summary>
            <span data-ttu-id="8b523-108">OrcFormat クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="8b523-108">Initializes a new instance of the OrcFormat class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
