<Type Name="HiveThriftTransportProtocol" FullName="Microsoft.Azure.Management.DataFactory.Models.HiveThriftTransportProtocol">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8e18e-101">HiveThriftTransportProtocol の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="8e18e-101">Defines values for HiveThriftTransportProtocol.</span></span>
            </summary>
