<Type Name="DistcpSettings" FullName="Microsoft.Azure.Management.DataFactory.Models.DistcpSettings">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c8d26-101">Distcp 設定します。</span><span class="sxs-lookup"><span data-stu-id="c8d26-101">Distcp settings.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8d26-102">DistcpSettings クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c8d26-102">Initializes a new instance of the DistcpSettings class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resourceManagerEndpoint"><span data-ttu-id="c8d26-103">Yarn ResourceManager エンドポイントを指定します。</span><span class="sxs-lookup"><span data-stu-id="c8d26-103">Specifies the Yarn ResourceManager endpoint.</span></span> <span data-ttu-id="c8d26-104">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="c8d26-104">Type: string (or Expression with resultType string).</span></span></param>
        <param name="tempScriptPath"><span data-ttu-id="c8d26-105">一時 Distcp コマンド スクリプトを格納するために使用する既存のフォルダー パスを指定します。</span><span class="sxs-lookup"><span data-stu-id="c8d26-105">Specifies an existing folder path which will be used to store temp Distcp command script.</span></span> <span data-ttu-id="c8d26-106">このスクリプト ファイルは ADF によって生成され、コピー ジョブ完了後に削除されます。</span><span class="sxs-lookup"><span data-stu-id="c8d26-106">The script file is generated by ADF and will be removed after Copy job finished.</span></span> <span data-ttu-id="c8d26-107">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="c8d26-107">Type: string (or Expression with resultType string).</span></span></param>
        <param name="distcpOptions"><span data-ttu-id="c8d26-108">Distcp オプションを指定します。</span><span class="sxs-lookup"><span data-stu-id="c8d26-108">Specifies the Distcp options.</span></span> <span data-ttu-id="c8d26-109">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="c8d26-109">Type: string (or Expression with resultType string).</span></span></param>
        <summary>
            <span data-ttu-id="c8d26-110">DistcpSettings クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c8d26-110">Initializes a new instance of the DistcpSettings class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DistcpOptions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8d26-111">取得または設定は、Distcp オプションを指定します。</span><span class="sxs-lookup"><span data-stu-id="c8d26-111">Gets or sets specifies the Distcp options.</span></span> <span data-ttu-id="c8d26-112">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="c8d26-112">Type: string (or Expression with resultType string).</span></span>
            </summary>
    ...
    <Member MemberName="ResourceManagerEndpoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8d26-113">取得または設定は、Yarn ResourceManager エンドポイントを指定します。</span><span class="sxs-lookup"><span data-stu-id="c8d26-113">Gets or sets specifies the Yarn ResourceManager endpoint.</span></span> <span data-ttu-id="c8d26-114">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="c8d26-114">Type: string (or Expression with resultType string).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TempScriptPath">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8d26-115">取得または設定は、一時 Distcp コマンド スクリプトを格納するために使用する既存のフォルダー パスを指定します。</span><span class="sxs-lookup"><span data-stu-id="c8d26-115">Gets or sets specifies an existing folder path which will be used to store temp Distcp command script.</span></span> <span data-ttu-id="c8d26-116">このスクリプト ファイルは ADF によって生成され、コピー ジョブ完了後に削除されます。</span><span class="sxs-lookup"><span data-stu-id="c8d26-116">The script file is generated by ADF and will be removed after Copy job finished.</span></span> <span data-ttu-id="c8d26-117">型: 文字列 (または式の resultType 文字列)。</span><span class="sxs-lookup"><span data-stu-id="c8d26-117">Type: string (or Expression with resultType string).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c8d26-118">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="c8d26-118">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="c8d26-119">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="c8d26-119">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
