<Type Name="JsonWebKeyOperation" FullName="Microsoft.Azure.KeyVault.WebKey.JsonWebKeyOperation">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cc1f1-101">サポートされている JsonWebKey 操作</span><span class="sxs-lookup"><span data-stu-id="cc1f1-101">Supported JsonWebKey operations</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AllOperations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cc1f1-102">すべての操作名。</span><span class="sxs-lookup"><span data-stu-id="cc1f1-102">All operations names.</span></span>
            </summary>
