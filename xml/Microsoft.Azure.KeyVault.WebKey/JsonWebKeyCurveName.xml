<Type Name="JsonWebKeyCurveName" FullName="Microsoft.Azure.KeyVault.WebKey.JsonWebKeyCurveName">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3070e-101">楕円曲線暗号 (ECC) 曲線名。</span><span class="sxs-lookup"><span data-stu-id="3070e-101">Elliptic Curve Cryptography (ECC) curve names.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AllCurves">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3070e-102">Ec の範囲のすべての曲線</span><span class="sxs-lookup"><span data-stu-id="3070e-102">All curves for EC.</span></span> <span data-ttu-id="3070e-103">複製を使用して、FxCop の違反を避けることを</span><span class="sxs-lookup"><span data-stu-id="3070e-103">Use clone to avoid FxCop violation</span></span>
            </summary>
    ...
    <Member MemberName="GetKeyParameterSize">
      ...
      <Docs>
        <param name="curve"><span data-ttu-id="3070e-104">曲線では、キー パラメーターのサイズが必要です。</span><span class="sxs-lookup"><span data-stu-id="3070e-104">The curve for which key parameter size is required.</span></span></param>
        <summary>
            <span data-ttu-id="3070e-105">曲線がサポートされていない場合は、必要なサイズ (バイト単位) の各キー パラメーター (X、Y、および D)、または-1 を返します。</span><span class="sxs-lookup"><span data-stu-id="3070e-105">Returns the required size, in bytes, of each key parameters (X, Y and D), or -1 if the curve is unsupported.</span></span> 
            </summary>
        <returns />
        <remarks>To be added.</remarks>
      </Docs>
