<Type Name="IWithProtocol&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayProbe.UpdateDefinition.IWithProtocol&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="6858d-101">この定義をアタッチした後に戻るには、親アプリケーション ゲートウェイ定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="6858d-101">The stage of the parent application gateway definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="6858d-102">アプリケーション ゲートウェイ プローブ定義できるようにするプローブのプロトコルを指定の段階です。</span><span class="sxs-lookup"><span data-stu-id="6858d-102">Stage of an application gateway probe definition allowing to specify the protocol of the probe.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithHttp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6858d-103">プローブ プロトコルとして HTTP を指定します。</span><span class="sxs-lookup"><span data-stu-id="6858d-103">Specifies HTTP as the probe protocol.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="6858d-104">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="6858d-104">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithHttps">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6858d-105">プローブ プロトコルとして HTTPS を指定します。</span><span class="sxs-lookup"><span data-stu-id="6858d-105">Specifies HTTPS as the probe protocol.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="6858d-106">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="6858d-106">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>