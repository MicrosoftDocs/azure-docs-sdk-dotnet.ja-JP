<Type Name="PurgeParameters" FullName="Microsoft.Azure.Management.Cdn.Fluent.Models.PurgeParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="03ffc-101">コンテンツの消去に必要なパラメーターです。</span><span class="sxs-lookup"><span data-stu-id="03ffc-101">Parameters required for content purge.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="03ffc-102">PurgeParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="03ffc-102">Initializes a new instance of the PurgeParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="contentPaths"><span data-ttu-id="03ffc-103">消去するコンテンツへのパス。</span><span class="sxs-lookup"><span data-stu-id="03ffc-103">The path to the content to be purged.</span></span>
            <span data-ttu-id="03ffc-104">ファイル パスまたはワイルド カード ディレクトリを記述できます。</span><span class="sxs-lookup"><span data-stu-id="03ffc-104">Can describe a file path or a wild card directory.</span></span></param>
        <summary>
            <span data-ttu-id="03ffc-105">PurgeParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="03ffc-105">Initializes a new instance of the PurgeParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ContentPaths">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="03ffc-106">取得または消去するコンテンツへのパスを設定します。</span><span class="sxs-lookup"><span data-stu-id="03ffc-106">Gets or sets the path to the content to be purged.</span></span> <span data-ttu-id="03ffc-107">ファイル パスまたはワイルド カード ディレクトリを記述できます。</span><span class="sxs-lookup"><span data-stu-id="03ffc-107">Can describe a file path or a wild card directory.</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="03ffc-108">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="03ffc-108">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="03ffc-109">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="03ffc-109">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
