<Type Name="CustomHttpsProvisioningState" FullName="Microsoft.Azure.Management.Cdn.Fluent.Models.CustomHttpsProvisioningState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="68d8a-101">CustomHttpsProvisioningState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="68d8a-101">Defines values for CustomHttpsProvisioningState.</span></span>
            </summary>
