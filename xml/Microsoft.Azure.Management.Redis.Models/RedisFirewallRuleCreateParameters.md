<Type Name="RedisFirewallRuleCreateParameters" FullName="Microsoft.Azure.Management.Redis.Models.RedisFirewallRuleCreateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="21ca1-101">上のファイアウォール ルールを作成するために必要なパラメーターは redis キャッシュです。</span><span class="sxs-lookup"><span data-stu-id="21ca1-101">Parameters required for creating a firewall rule on redis cache.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="21ca1-102">RedisFirewallRuleCreateParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="21ca1-102">Initializes a new instance of the RedisFirewallRuleCreateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="startIP"><span data-ttu-id="21ca1-103">範囲に含まれる最下位の IP アドレス</span><span class="sxs-lookup"><span data-stu-id="21ca1-103">lowest IP address included in the range</span></span></param>
        <param name="endIP"><span data-ttu-id="21ca1-104">範囲に含まれる最上位の IP アドレス</span><span class="sxs-lookup"><span data-stu-id="21ca1-104">highest IP address included in the range</span></span></param>
        <summary>
            <span data-ttu-id="21ca1-105">RedisFirewallRuleCreateParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="21ca1-105">Initializes a new instance of the RedisFirewallRuleCreateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EndIP">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="21ca1-106">取得または設定の範囲に含まれる最上位の IP アドレス</span><span class="sxs-lookup"><span data-stu-id="21ca1-106">Gets or sets highest IP address included in the range</span></span>
            </summary>
    ...
    <Member MemberName="StartIP">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="21ca1-107">取得または設定の範囲に含まれる最下位の IP アドレス</span><span class="sxs-lookup"><span data-stu-id="21ca1-107">Gets or sets lowest IP address included in the range</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="21ca1-108">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="21ca1-108">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="21ca1-109">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="21ca1-109">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
