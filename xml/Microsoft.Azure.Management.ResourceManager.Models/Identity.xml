<Type Name="Identity" FullName="Microsoft.Azure.Management.ResourceManager.Models.Identity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fe00e-101">リソースの id です。</span><span class="sxs-lookup"><span data-stu-id="fe00e-101">Identity for the resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe00e-102">Id クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="fe00e-102">Initializes a new instance of the Identity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="principalId"><span data-ttu-id="fe00e-103">リソース id のプリンシパル ID。</span><span class="sxs-lookup"><span data-stu-id="fe00e-103">The principal ID of resource identity.</span></span></param>
        <param name="tenantId"><span data-ttu-id="fe00e-104">リソースのテナント ID。</span><span class="sxs-lookup"><span data-stu-id="fe00e-104">The tenant ID of resource.</span></span></param>
        <param name="type"><span data-ttu-id="fe00e-105">Id の種類。</span><span class="sxs-lookup"><span data-stu-id="fe00e-105">The identity type.</span></span> <span data-ttu-id="fe00e-106">使用可能な値が含まれます: 'SystemAssigned'</span><span class="sxs-lookup"><span data-stu-id="fe00e-106">Possible values include: 'SystemAssigned'</span></span></param>
        <summary>
            <span data-ttu-id="fe00e-107">Id クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="fe00e-107">Initializes a new instance of the Identity class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrincipalId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe00e-108">リソース id のプリンシパル ID を取得します。</span><span class="sxs-lookup"><span data-stu-id="fe00e-108">Gets the principal ID of resource identity.</span></span>
            </summary>
    ...
    <Member MemberName="TenantId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe00e-109">リソースのテナント ID を取得します。</span><span class="sxs-lookup"><span data-stu-id="fe00e-109">Gets the tenant ID of resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fe00e-110">取得または id の種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="fe00e-110">Gets or sets the identity type.</span></span> <span data-ttu-id="fe00e-111">使用可能な値が含まれます: 'SystemAssigned'</span><span class="sxs-lookup"><span data-stu-id="fe00e-111">Possible values include: 'SystemAssigned'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
