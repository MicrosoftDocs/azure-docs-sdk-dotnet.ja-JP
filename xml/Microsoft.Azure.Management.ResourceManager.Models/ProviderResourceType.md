<Type Name="ProviderResourceType" FullName="Microsoft.Azure.Management.ResourceManager.Models.ProviderResourceType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="747cb-101">リソース プロバイダーによって管理されるリソースの種類。</span><span class="sxs-lookup"><span data-stu-id="747cb-101">Resource type managed by the resource provider.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="747cb-102">ProviderResourceType クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="747cb-102">Initializes a new instance of the ProviderResourceType class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resourceType"><span data-ttu-id="747cb-103">リソースの種類。</span><span class="sxs-lookup"><span data-stu-id="747cb-103">The resource type.</span></span></param>
        <param name="locations"><span data-ttu-id="747cb-104">このリソースの種類を作成できる場所のコレクション。</span><span class="sxs-lookup"><span data-stu-id="747cb-104">The collection of locations where this resource type can be created.</span></span></param>
        <param name="aliases"><span data-ttu-id="747cb-105">このリソースの種類でサポートされているエイリアスです。</span><span class="sxs-lookup"><span data-stu-id="747cb-105">The aliases that are supported by this resource type.</span></span></param>
        <param name="apiVersions"><span data-ttu-id="747cb-106">API のバージョン。</span><span class="sxs-lookup"><span data-stu-id="747cb-106">The API version.</span></span></param>
        <param name="properties"><span data-ttu-id="747cb-107">プロパティ。</span><span class="sxs-lookup"><span data-stu-id="747cb-107">The properties.</span></span></param>
        <summary>
            <span data-ttu-id="747cb-108">ProviderResourceType クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="747cb-108">Initializes a new instance of the ProviderResourceType class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Aliases">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="747cb-109">取得またはこのリソースの種類でサポートされているエイリアスを設定します。</span><span class="sxs-lookup"><span data-stu-id="747cb-109">Gets or sets the aliases that are supported by this resource type.</span></span>
            </summary>
    ...
    <Member MemberName="ApiVersions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="747cb-110">取得または API のバージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="747cb-110">Gets or sets the API version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Locations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="747cb-111">取得またはこのリソースの種類を作成できる場所の場所のコレクションを設定します。</span><span class="sxs-lookup"><span data-stu-id="747cb-111">Gets or sets the collection of locations where this resource type can be created.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="747cb-112">取得またはプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="747cb-112">Gets or sets the properties.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="747cb-113">取得またはリソースの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="747cb-113">Gets or sets the resource type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
