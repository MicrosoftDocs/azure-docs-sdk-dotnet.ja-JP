<Type Name="IBlank" FullName="Microsoft.Azure.Management.Compute.Fluent.AvailabilitySet.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="661dc-101">可用性の最初の段階では、定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="661dc-101">The first stage of an availability set definition.</span></span>
            </summary>
