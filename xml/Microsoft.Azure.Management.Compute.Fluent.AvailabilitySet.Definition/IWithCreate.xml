<Type Name="IWithCreate" FullName="Microsoft.Azure.Management.Compute.Fluent.AvailabilitySet.Definition.IWithCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ad3eb-101">可用性のステージは、セットの定義を作成するリソースの最低限必要な入力すべてにはが含まれていますが、指定する省略可能なその他の設定も可能です。</span><span class="sxs-lookup"><span data-stu-id="ad3eb-101">The stage of an availability set definition which contains all the minimum required inputs for the resource to be created but also allows for any other optional settings to be specified.</span></span>
            </summary>
