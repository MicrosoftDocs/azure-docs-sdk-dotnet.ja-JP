<Type Name="IDefinition" FullName="Microsoft.Azure.Management.Compute.Fluent.AvailabilitySet.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a6c5b-101">可用性セットに関連するすべての定義のコンテナー インターフェイスです。</span><span class="sxs-lookup"><span data-stu-id="a6c5b-101">Container interface for all the definitions related to an availability set.</span></span>
            </summary>
