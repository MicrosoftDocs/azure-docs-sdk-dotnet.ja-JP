<Type Name="IBackUpOperations" FullName="Microsoft.Azure.Management.BackupServices.IBackUpOperations">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="44d81-101">Azure Backup の拡張機能のバックアップ操作の定義。</span><span class="sxs-lookup"><span data-stu-id="44d81-101">Definition of BackUp operations for the Azure Backup extension.</span></span>
            </summary>
    ...
    <Member MemberName="TriggerBackUpAsync">
      ...
      <Docs>
        ...
        <param name="customRequestHeaders">
            <span data-ttu-id="44d81-102">ヘッダーのパラメーターを要求します。</span><span class="sxs-lookup"><span data-stu-id="44d81-102">Request header parameters.</span></span>
            </param>
        <param name="containerName">To be added.</param>
        <param name="itemName">To be added.</param>
        <param name="cancellationToken">
            <span data-ttu-id="44d81-103">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="44d81-103">Cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="44d81-104">バックアップ、AzureBackUpItem です。</span><span class="sxs-lookup"><span data-stu-id="44d81-104">BackUp the AzureBackUpItem.</span></span>
            </summary>
        <returns>
            <span data-ttu-id="44d81-105">操作の応答の定義。</span><span class="sxs-lookup"><span data-stu-id="44d81-105">The definition of a Operation Response.</span></span>
            </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
