<Type Name="IBackupServicesManagementClient" FullName="Microsoft.Azure.Management.BackupServices.IBackupServicesManagementClient">
  ...
  <Members>
    <Member MemberName="ApiVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-101">API のバージョンを取得します。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-101">Gets the API version.</span></span>
            </summary>
    ...
    <Member MemberName="BackUp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-102">Azure Backup の拡張機能のバックアップ操作の定義。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-102">Definition of BackUp operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BaseUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-103">すべてのクラウド サービス要求のベースとして使用する URI を取得します。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-103">Gets the URI used as the base for all cloud service requests.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Container">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-104">Azure Backup の拡張機能のコンテナーの操作の定義。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-104">Definition of Container operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Credentials">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-105">Microsoft Azure サブスクリプションを一意に識別するサブスクリプション資格情報を取得します。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-105">Gets subscription credentials which uniquely identify Microsoft Azure subscription.</span></span> <span data-ttu-id="2a4c9-106">サブスクリプション ID では、すべてのサービス呼び出しの URI の一部を形成します。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-106">The subscription ID forms part of the URI for every service call.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CSMProtectionPolicy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-107">Azure Backup の拡張機能の保護ポリシーの操作の定義。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-107">Definition of Protection Policy operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DataSource">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-108">Azure Backup の拡張機能の操作をデータ ソースの定義。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-108">Definition of DataSource operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Job">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-109">Azure バックアップ用拡張子に対してジョブ操作の定義。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-109">Definition of Job operations for Azure backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LongRunningOperationInitialTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-110">取得または長時間実行される操作の初期タイムアウトを設定します。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-110">Gets or sets the initial timeout for Long Running Operations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LongRunningOperationRetryTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-111">取得または長時間実行される操作の再試行タイムアウトを設定します。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-111">Gets or sets the retry timeout for Long Running Operations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-112">Azure Backup の拡張機能のワークフロー操作の定義。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-112">Definition of Workflow operation for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProtectableObject">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-113">Azure Backup の拡張機能の保護可能な ObjectOperation 操作の定義。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-113">Definition of Protectable ObjectOperation operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecoveryPoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-114">Azure Backup の拡張機能の回復ポイントの操作の定義。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-114">Definition of Recovery Point operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Restore">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2a4c9-115">Azure Backup の拡張機能の復元操作の定義。</span><span class="sxs-lookup"><span data-stu-id="2a4c9-115">Definition of Restore operations for the Azure Backup extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
