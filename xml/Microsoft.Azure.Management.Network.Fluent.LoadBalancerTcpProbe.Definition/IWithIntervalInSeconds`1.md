<Type Name="IWithIntervalInSeconds&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerTcpProbe.Definition.IWithIntervalInSeconds&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="382ef-101">親リソースの種類。</span><span class="sxs-lookup"><span data-stu-id="382ef-101">The parent resource type.</span></span></typeparam>
    <summary>
            <span data-ttu-id="382ef-102">TCP のステージでは、プローブの期間を指定できるように定義をプローブします。</span><span class="sxs-lookup"><span data-stu-id="382ef-102">The stage of the TCP probe definition allowing to specify the probe interval.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithIntervalInSeconds">
      ...
      <Docs>
        <param name="seconds"><span data-ttu-id="382ef-103">秒数。</span><span class="sxs-lookup"><span data-stu-id="382ef-103">Number of seconds.</span></span></param>
        <summary>
            <span data-ttu-id="382ef-104">秒単位でのプローブの間隔を指定します。</span><span class="sxs-lookup"><span data-stu-id="382ef-104">Specifies the interval between probes, in seconds.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="382ef-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="382ef-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>