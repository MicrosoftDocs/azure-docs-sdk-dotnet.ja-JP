<Type Name="IUpdate" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.ServiceBusNamespace.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="37704-101">変更可能なすべての設定を含む、Service Bus 名前空間の更新操作のテンプレートです。</span><span class="sxs-lookup"><span data-stu-id="37704-101">The template for a Service Bus namespace update operation, containing all the settings that can be modified.</span></span>
            </summary>
