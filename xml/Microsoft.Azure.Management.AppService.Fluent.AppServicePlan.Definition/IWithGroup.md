<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.AppService.Fluent.AppServicePlan.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8522d-101">リソース グループを設定するを許可するアプリ サービスのプラン定義します。</span><span class="sxs-lookup"><span data-stu-id="8522d-101">An app service plan definition allowing resource group to be set.</span></span>
            </summary>
