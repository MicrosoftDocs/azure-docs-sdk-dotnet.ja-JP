<Type Name="EncryptionProvisioningState" FullName="Microsoft.Azure.Management.DataLake.Store.Models.EncryptionProvisioningState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d9ad3-101">EncryptionProvisioningState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="d9ad3-101">Defines values for EncryptionProvisioningState.</span></span>
            </summary>
