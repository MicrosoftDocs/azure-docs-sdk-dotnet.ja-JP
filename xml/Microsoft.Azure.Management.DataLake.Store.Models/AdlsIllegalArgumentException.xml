<Type Name="AdlsIllegalArgumentException" FullName="Microsoft.Azure.Management.DataLake.Store.Models.AdlsIllegalArgumentException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c3f8e-101">1 つ以上の引数が正しいことを示す WebHDFS 例外がスローされます。</span><span class="sxs-lookup"><span data-stu-id="c3f8e-101">A WebHDFS exception thrown indicating that one more arguments is incorrect.</span></span> <span data-ttu-id="c3f8e-102">エラー応答コード 400 (bad request) を返される場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="c3f8e-102">Thrown when a 400 error response code is returned (bad request).</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3f8e-103">AdlsIllegalArgumentException クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c3f8e-103">Initializes a new instance of the AdlsIllegalArgumentException class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="javaClassName"><span data-ttu-id="c3f8e-104">フル パッケージのクラス名 'java.lang.IllegalArgumentException' など、スローされる例外。</span><span class="sxs-lookup"><span data-stu-id="c3f8e-104">the full class package name for the exception thrown, such as 'java.lang.IllegalArgumentException'.</span></span></param>
        <param name="message"><span data-ttu-id="c3f8e-105">など、スローされた例外に関連付けられたメッセージ ' webhdfs パラメーター「アクセス許可」に無効な値:...' です。</span><span class="sxs-lookup"><span data-stu-id="c3f8e-105">the message associated with the exception that was thrown, such as 'Invalid value for webhdfs parameter "permission":...'.</span></span></param>
        <summary>
            <span data-ttu-id="c3f8e-106">AdlsIllegalArgumentException クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c3f8e-106">Initializes a new instance of the AdlsIllegalArgumentException class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
