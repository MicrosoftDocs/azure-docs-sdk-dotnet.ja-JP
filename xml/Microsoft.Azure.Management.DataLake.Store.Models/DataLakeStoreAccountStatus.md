<Type Name="DataLakeStoreAccountStatus" FullName="Microsoft.Azure.Management.DataLake.Store.Models.DataLakeStoreAccountStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8c5a8-101">DataLakeStoreAccountStatus の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="8c5a8-101">Defines values for DataLakeStoreAccountStatus.</span></span>
            </summary>
