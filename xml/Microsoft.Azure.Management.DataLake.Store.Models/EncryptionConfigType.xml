<Type Name="EncryptionConfigType" FullName="Microsoft.Azure.Management.DataLake.Store.Models.EncryptionConfigType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f2c43-101">EncryptionConfigType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="f2c43-101">Defines values for EncryptionConfigType.</span></span>
            </summary>
