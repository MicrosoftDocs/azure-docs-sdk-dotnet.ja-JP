<Type Name="AdlsThrottledException" FullName="Microsoft.Azure.Management.DataLake.Store.Models.AdlsThrottledException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="24f66-101">要求が調整されていることを示すスローされる WebHDFS 例外。</span><span class="sxs-lookup"><span data-stu-id="24f66-101">A WebHDFS exception thrown indicating that the request is being throttled.</span></span> <span data-ttu-id="24f66-102">要求またはサイズがこのエラーを軽減するのに役立つ要求の数を減らすことです。</span><span class="sxs-lookup"><span data-stu-id="24f66-102">Reducing the number of requests or request size helps to mitigate this error.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="24f66-103">AdlsThrottledException クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="24f66-103">Initializes a new instance of the AdlsThrottledException class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="javaClassName"><span data-ttu-id="24f66-104">フル パッケージのクラス名 'java.lang.IllegalArgumentException' など、スローされる例外。</span><span class="sxs-lookup"><span data-stu-id="24f66-104">the full class package name for the exception thrown, such as 'java.lang.IllegalArgumentException'.</span></span></param>
        <param name="message"><span data-ttu-id="24f66-105">など、スローされた例外に関連付けられたメッセージ ' webhdfs パラメーター「アクセス許可」に無効な値:...' です。</span><span class="sxs-lookup"><span data-stu-id="24f66-105">the message associated with the exception that was thrown, such as 'Invalid value for webhdfs parameter "permission":...'.</span></span></param>
        <summary>
            <span data-ttu-id="24f66-106">AdlsThrottledException クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="24f66-106">Initializes a new instance of the AdlsThrottledException class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
