<Type Name="ExpiryOptionType" FullName="Microsoft.Azure.Management.DataLake.Store.Models.ExpiryOptionType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7a6ef-101">ExpiryOptionType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="7a6ef-101">Defines values for ExpiryOptionType.</span></span>
            </summary>
