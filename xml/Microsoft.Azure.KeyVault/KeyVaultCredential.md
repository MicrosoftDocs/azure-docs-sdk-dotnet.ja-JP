<Type Name="KeyVaultCredential" FullName="Microsoft.Azure.KeyVault.KeyVaultCredential">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9a9bf-101">Key Vault の資格情報クラスを実装します。<see cref="T:Microsoft.Rest.ServiceClientCredentials" /></span><span class="sxs-lookup"><span data-stu-id="9a9bf-101">The Key Vault credential class that implements <see cref="T:Microsoft.Rest.ServiceClientCredentials" /></span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="authenticationCallback"> <span data-ttu-id="9a9bf-102">認証コールバック。</span><span class="sxs-lookup"><span data-stu-id="9a9bf-102">the authentication callback.</span></span> </param>
        <summary>
            <span data-ttu-id="9a9bf-103">コンストラクターです。</span><span class="sxs-lookup"><span data-stu-id="9a9bf-103">Constructor.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnAuthenticate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9a9bf-104">認証コールバック</span><span class="sxs-lookup"><span data-stu-id="9a9bf-104">The authentication callback</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Token">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9a9bf-105">ベアラー トークン</span><span class="sxs-lookup"><span data-stu-id="9a9bf-105">Bearer token</span></span>
            </summary>
