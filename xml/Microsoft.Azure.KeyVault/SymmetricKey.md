<Type Name="SymmetricKey" FullName="Microsoft.Azure.KeyVault.SymmetricKey">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fd4d8-101">単純な対称キー</span><span class="sxs-lookup"><span data-stu-id="fd4d8-101">A simple Symmetric Key</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fd4d8-102">既定のコンストラクター</span><span class="sxs-lookup"><span data-stu-id="fd4d8-102">Default constructor</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="fd4d8-103">使用するキー識別子</span><span class="sxs-lookup"><span data-stu-id="fd4d8-103">The key identifier to use</span></span></param>
        <summary>
            <span data-ttu-id="fd4d8-104">コンストラクターです。</span><span class="sxs-lookup"><span data-stu-id="fd4d8-104">Constructor.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="fd4d8-105">キー識別子</span><span class="sxs-lookup"><span data-stu-id="fd4d8-105">The key identifier</span></span></param>
        <param name="keyBytes"><span data-ttu-id="fd4d8-106">キー マテリアル</span><span class="sxs-lookup"><span data-stu-id="fd4d8-106">The key material</span></span></param>
        <summary>
            <span data-ttu-id="fd4d8-107">コンストラクター</span><span class="sxs-lookup"><span data-stu-id="fd4d8-107">Constructor</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="fd4d8-108">使用するキー識別子</span><span class="sxs-lookup"><span data-stu-id="fd4d8-108">The key identifier to use</span></span></param>
        <param name="keySize"><span data-ttu-id="fd4d8-109">キーのサイズ (バイト単位)</span><span class="sxs-lookup"><span data-stu-id="fd4d8-109">The key size in bytes</span></span></param>
        <summary>
            <span data-ttu-id="fd4d8-110">コンストラクター</span><span class="sxs-lookup"><span data-stu-id="fd4d8-110">Constructor</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
