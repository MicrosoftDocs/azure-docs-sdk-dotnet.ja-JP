<Type Name="EcKey" FullName="Microsoft.Azure.KeyVault.EcKey">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="27cef-101">楕円曲線キー。</span><span class="sxs-lookup"><span data-stu-id="27cef-101">An elliptic curve key.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27cef-102">コンス トラクターは、GUID 識別子を持つ P-256 キーを作成します。</span><span class="sxs-lookup"><span data-stu-id="27cef-102">Constructor, creates a P-256 key with a GUID identifier.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="27cef-103">使用するキー識別子</span><span class="sxs-lookup"><span data-stu-id="27cef-103">The key identifier to use</span></span></param>
        <summary>
            <span data-ttu-id="27cef-104">コンス トラクターでは、P-256 キーを作成します。</span><span class="sxs-lookup"><span data-stu-id="27cef-104">Constructor, creates a P-256 key.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="27cef-105">使用するキー識別子</span><span class="sxs-lookup"><span data-stu-id="27cef-105">The key identifier to use</span></span></param>
        <param name="ecdsa"><span data-ttu-id="27cef-106">キーの ECDsa オブジェクト</span><span class="sxs-lookup"><span data-stu-id="27cef-106">The ECDsa object for the key</span></span></param>
        <summary>
            <span data-ttu-id="27cef-107">コンストラクターです。</span><span class="sxs-lookup"><span data-stu-id="27cef-107">Constructor.</span></span>
            </summary>
        <remarks><span data-ttu-id="27cef-108">ECDsa IDisposable、このクラスは ECDsa オブジェクトへの参照を保持するが、破棄はありませんは、オブジェクトがこのコンス トラクターの呼び出し元がこのパラメーターの有効期間を担当します。</span><span class="sxs-lookup"><span data-stu-id="27cef-108">The ECDsa object is IDisposable, this class will hold a reference to the ECDsa object but will not dispose it, the caller of this constructor is responsible for the lifetime of this parameter.</span></span></remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="27cef-109">使用するキー識別子</span><span class="sxs-lookup"><span data-stu-id="27cef-109">The key identifier to use</span></span></param>
        <param name="curve"><span data-ttu-id="27cef-110">楕円曲線を使用するの名前</span><span class="sxs-lookup"><span data-stu-id="27cef-110">The name of elliptic curve to use</span></span></param>
        <summary>
            <span data-ttu-id="27cef-111">コンストラクターです。</span><span class="sxs-lookup"><span data-stu-id="27cef-111">Constructor.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kid"><span data-ttu-id="27cef-112">使用するキー識別子</span><span class="sxs-lookup"><span data-stu-id="27cef-112">The key identifier to use</span></span></param>
        <param name="curve"><span data-ttu-id="27cef-113">楕円曲線; を使用するの名前サポートされる値は、このクラスに示す定数です。</span><span class="sxs-lookup"><span data-stu-id="27cef-113">The name of elliptic curve to use; supported values are constants described in this class.</span></span></param>
        <param name="x"><span data-ttu-id="27cef-114">公開ポイント フィールド X の値。</span><span class="sxs-lookup"><span data-stu-id="27cef-114">The value of public point field X.</span></span></param>
        <param name="y"><span data-ttu-id="27cef-115">公開ポイント フィールド Y の値。</span><span class="sxs-lookup"><span data-stu-id="27cef-115">The value of public point field Y.</span></span></param>
        <param name="d"><span data-ttu-id="27cef-116">D. 秘密キーの値Null の場合は、公開キーの操作のみが許可されます。</span><span class="sxs-lookup"><span data-stu-id="27cef-116">The value of private key D. If null, only the public key operations will be allowed.</span></span></param>
        <summary>
            <span data-ttu-id="27cef-117">コンストラクター</span><span class="sxs-lookup"><span data-stu-id="27cef-117">Constructor</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Kid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="27cef-118">キー識別子</span><span class="sxs-lookup"><span data-stu-id="27cef-118">Key Identifier</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
