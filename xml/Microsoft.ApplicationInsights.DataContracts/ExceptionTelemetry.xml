<Type Name="ExceptionTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.ExceptionTelemetry">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8f297-101">テレメトリの種類の例外を追跡するために使用します。</span><span class="sxs-lookup"><span data-stu-id="8f297-101">Telemetry type used to track exceptions.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-102">新しいインスタンスを初期化、<see cref="T:Microsoft.ApplicationInsights.DataContracts.ExceptionTelemetry" />空のプロパティを持つクラス。</span><span class="sxs-lookup"><span data-stu-id="8f297-102">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.ExceptionTelemetry" /> class with empty properties.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="exception"><span data-ttu-id="8f297-103">例外のインスタンス。</span><span class="sxs-lookup"><span data-stu-id="8f297-103">Exception instance.</span></span></param>
        <summary>
            <span data-ttu-id="8f297-104">新しいインスタンスを初期化、<see cref="T:Microsoft.ApplicationInsights.DataContracts.ExceptionTelemetry" />空のプロパティを持つクラス。</span><span class="sxs-lookup"><span data-stu-id="8f297-104">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.ExceptionTelemetry" /> class with empty properties.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Context">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-105">現在の製品利用統計情報項目に関連付けられているコンテキストを取得します。</span><span class="sxs-lookup"><span data-stu-id="8f297-105">Gets the context associated with the current telemetry item.</span></span>
            </summary>
    ...
    <Member MemberName="Exception">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-106">これによって追跡される元の例外の設定を取得または<see cref="T:Microsoft.ApplicationInsights.Channel.ITelemetry" />です。</span><span class="sxs-lookup"><span data-stu-id="8f297-106">Gets or sets the original exception tracked by this <see cref="T:Microsoft.ApplicationInsights.Channel.ITelemetry" />.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HandledAt">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-107">取得または設定が示された値は、例外が処理されます。</span><span class="sxs-lookup"><span data-stu-id="8f297-107">Gets or sets the value indicated where the exception was handled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-108">取得または ExceptionTelemetry メッセージを設定します。</span><span class="sxs-lookup"><span data-stu-id="8f297-108">Gets or sets ExceptionTelemetry message.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Metrics">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-109">アプリケーション定義の例外のメトリックのディクショナリを取得します。</span><span class="sxs-lookup"><span data-stu-id="8f297-109">Gets a dictionary of application-defined exception metrics.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Microsoft.ApplicationInsights.Channel.ITelemetry.Sanitize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-110">機能では、制約に基づくプロパティです。</span><span class="sxs-lookup"><span data-stu-id="8f297-110">Sanitizes the properties based on constraints.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Microsoft.ApplicationInsights.DataContracts.ISupportSampling.SamplingPercentage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-111">取得または (0 と 100) の間のデータのサンプリング比率を設定します。</span><span class="sxs-lookup"><span data-stu-id="8f297-111">Gets or sets data sampling percentage (between 0 and 100).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-112">アプリケーションで定義されたプロパティの名前と値がこの例外に関する追加情報を提供するディクショナリを取得します。</span><span class="sxs-lookup"><span data-stu-id="8f297-112">Gets a dictionary of application-defined property names and values providing additional information about this exception.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sequence">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-113">取得または製品利用統計情報アイテムの絶対順序を定義する値を設定します。</span><span class="sxs-lookup"><span data-stu-id="8f297-113">Gets or sets the value that defines absolute order of the telemetry item.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SeverityLevel">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-114">取得または例外の重大度レベルを設定します。</span><span class="sxs-lookup"><span data-stu-id="8f297-114">Gets or sets Exception severity level.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timestamp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8f297-115">取得または日付と時刻の製品利用統計情報が記録されるタイミングを設定します。</span><span class="sxs-lookup"><span data-stu-id="8f297-115">Gets or sets date and time when telemetry was recorded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
