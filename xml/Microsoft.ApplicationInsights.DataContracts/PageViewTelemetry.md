<Type Name="PageViewTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bd403-101">製品利用統計情報の種類がページ ビューを追跡するために使用します。</span><span class="sxs-lookup"><span data-stu-id="bd403-101">Telemetry type used to track page views.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="bd403-102">インスタンスを渡すことによって、アプリケーションに Application Insights で表示したページに関する情報を送信することができます、<see cref="T:Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry" />クラスを<see cref="M:Microsoft.ApplicationInsights.TelemetryClient.TrackPageView(Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry)" />メソッドです。</span><span class="sxs-lookup"><span data-stu-id="bd403-102">You can send information about pages viewed by your application to Application Insights by passing an instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry" /> class to the <see cref="M:Microsoft.ApplicationInsights.TelemetryClient.TrackPageView(Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry)" /> method.</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-103"><see cref="T:Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry" /> クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="bd403-103">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry" /> class.</span></span>
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="bd403-104"><see cref="T:Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry" /> を指定して、<paramref name="pageName" /> クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="bd403-104">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry" /> class with the specified <paramref name="pageName" />.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentException"><span data-ttu-id="bd403-105"><paramref name="pageName" /> Null または空の文字列です。</span><span class="sxs-lookup"><span data-stu-id="bd403-105">The <paramref name="pageName" /> is null or empty string.</span></span></exception>
      </Docs>
    </Member>
    <Member MemberName="Context">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-106">現在の製品利用統計情報項目に関連付けられているコンテキストを取得します。</span><span class="sxs-lookup"><span data-stu-id="bd403-106">Gets the context associated with the current telemetry item.</span></span>
            </summary>
    ...
    <Member MemberName="Duration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-107">取得またはページの表示期間を設定します。</span><span class="sxs-lookup"><span data-stu-id="bd403-107">Gets or sets the page view duration.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Metrics">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-108">定義済みのカスタム メトリックのディクショナリを取得します。</span><span class="sxs-lookup"><span data-stu-id="bd403-108">Gets a dictionary of custom defined metrics.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Microsoft.ApplicationInsights.Channel.ITelemetry.Sanitize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-109">機能では、制約に基づくプロパティです。</span><span class="sxs-lookup"><span data-stu-id="bd403-109">Sanitizes the properties based on constraints.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Microsoft.ApplicationInsights.DataContracts.ISupportSampling.SamplingPercentage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-110">取得または (0 と 100) の間のデータのサンプリング比率を設定します。</span><span class="sxs-lookup"><span data-stu-id="bd403-110">Gets or sets data sampling percentage (between 0 and 100).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-111">取得またはメトリックの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="bd403-111">Gets or sets the name of the metric.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-112">アプリケーションで定義されたプロパティの名前と値のこのページ ビューに関する追加情報を提供するディクショナリを取得します。</span><span class="sxs-lookup"><span data-stu-id="bd403-112">Gets a dictionary of application-defined property names and values providing additional information about this page view.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sequence">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-113">取得または製品利用統計情報アイテムの絶対順序を定義する値を設定します。</span><span class="sxs-lookup"><span data-stu-id="bd403-113">Gets or sets the value that defines absolute order of the telemetry item.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timestamp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-114">取得またはイベントが記録されたときの日時を設定します。</span><span class="sxs-lookup"><span data-stu-id="bd403-114">Gets or sets date and time when event was recorded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bd403-115">取得またはページの表示を Uri を設定します。</span><span class="sxs-lookup"><span data-stu-id="bd403-115">Gets or sets the page view Uri.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
