<Type Name="AvailabilityTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.AvailabilityTelemetry">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f17f7-101">テレメトリの種類の可用性テストの結果を得るために使用します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-101">Telemetry type used for availability test results.</span></span>
            <span data-ttu-id="f17f7-102">一度におよびメッセージと必要に応じていくつか追加のメタデータが含まれています。</span><span class="sxs-lookup"><span data-stu-id="f17f7-102">Contains a time and message and optionally some additional metadata.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-103">新しいインスタンスを初期化、<see cref="T:Microsoft.ApplicationInsights.DataContracts.AvailabilityTelemetry" />空のプロパティを持つクラス。</span><span class="sxs-lookup"><span data-stu-id="f17f7-103">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.AvailabilityTelemetry" /> class with empty properties.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="f17f7-104">新しいインスタンスを初期化、<see cref="T:Microsoft.ApplicationInsights.DataContracts.AvailabilityTelemetry" />空のプロパティを持つクラス。</span><span class="sxs-lookup"><span data-stu-id="f17f7-104">Initializes a new instance of the <see cref="T:Microsoft.ApplicationInsights.DataContracts.AvailabilityTelemetry" /> class with empty properties.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Context">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-105">現在の製品利用統計情報項目に関連付けられているコンテキストを取得します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-105">Gets the context associated with the current telemetry item.</span></span>
            </summary>
    ...
    <Member MemberName="Duration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-106">取得または可用性テストの継続時間を設定します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-106">Gets or sets availability test duration.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-107">取得またはテストの実行 id を設定します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-107">Gets or sets the test run id.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-108">エラー メッセージを取得または設定します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-108">Gets or sets the error message.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Metrics">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-109">アプリケーション定義のイベントのメトリックのディクショナリを取得します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-109">Gets a dictionary of application-defined event metrics.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Microsoft.ApplicationInsights.Channel.ITelemetry.Sanitize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-110">機能では、制約に基づくプロパティです。</span><span class="sxs-lookup"><span data-stu-id="f17f7-110">Sanitizes the properties based on constraints.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-111">取得またはテストの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-111">Gets or sets the test name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-112">アプリケーションで定義されたプロパティの名前と値がこの可用性テストの実行に関する追加情報を提供するディクショナリを取得します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-112">Gets a dictionary of application-defined property names and values providing additional information about this availability test run.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RunLocation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-113">取得または可用性テストが実行された場所を設定します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-113">Gets or sets location where availability test was run.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sequence">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-114">取得または製品利用統計情報アイテムの絶対順序を定義する値を設定します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-114">Gets or sets the value that defines absolute order of the telemetry item.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Success">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-115">取得または可用性テストが正常に終了したかどうかを示す値を設定します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-115">Gets or sets a value indicating whether the availability test was successful or not.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Timestamp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f17f7-116">取得または日付と時刻の製品利用統計情報が記録されるタイミングを設定します。</span><span class="sxs-lookup"><span data-stu-id="f17f7-116">Gets or sets date and time when telemetry was recorded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
