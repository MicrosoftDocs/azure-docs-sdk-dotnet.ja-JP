<Type Name="StatePersistenceAttribute" FullName="Microsoft.ServiceFabric.Actors.Runtime.StatePersistenceAttribute">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2184e-101">(メモリ内にのみ) が、永続化または格納されないすべてのアクターの状態を volatile にする必要があるかどうかを示します。</span><span class="sxs-lookup"><span data-stu-id="2184e-101">Indicates whether the actor state should be volatile (in-memory only), persisted, or not stored at all.</span></span>
            <span data-ttu-id="2184e-102">この属性に指定されたストアの種類は、アクター サービスで使用される状態プロバイダーの種類に一致する必要があります。</span><span class="sxs-lookup"><span data-stu-id="2184e-102">The store type given to this attribute must match the type of state provider used in the actor service.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="2184e-103">StatePersistence 属性が派生クラスによって継承されない、各アクター型は、その StatePersistence を提供する必要がありますアクター型、StatePersistence 属性が指定されていない場合は、レベル アクターの状態がレプリケートされたかに書き込まれるディスクです。</span><span class="sxs-lookup"><span data-stu-id="2184e-103">The StatePersistence attribute is not inherited by derived class, each Actor type must provide its StatePersistence level, If an Actor type doesn't specify a StatePersistence attribute, actor state is not replicated or written to disk.</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="statePersistence"><span data-ttu-id="2184e-104">アクター サービス用のアクター状態の格納方法を示します。</span><span class="sxs-lookup"><span data-stu-id="2184e-104">Indicates how actor state is stored for an actor service.</span></span></param>
        <summary>
            <span data-ttu-id="2184e-105"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.StatePersistenceAttribute" /> のインスタンスを作成します。</span><span class="sxs-lookup"><span data-stu-id="2184e-105">Creates an instance of <see cref="T:Microsoft.ServiceFabric.Actors.Runtime.StatePersistenceAttribute" /></span></span></summary>
    ...
    <Member MemberName="StatePersistence">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2184e-106">取得または設定の種類を表す列挙型にアクターは、使用するストアを状態します。</span><span class="sxs-lookup"><span data-stu-id="2184e-106">Get or sets the enum representing type of state store to use for the actor.</span></span>
            </summary>
        <value>
          <span data-ttu-id="2184e-107"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.StatePersistence" />アクターに使用する状態ストアの種類を表すです。</span><span class="sxs-lookup"><span data-stu-id="2184e-107"><see cref="T:Microsoft.ServiceFabric.Actors.Runtime.StatePersistence" /> representing type of state store to use for the actor.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
