<Type Name="PoolStatistics" FullName="Microsoft.Azure.Batch.PoolStatistics">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4428a-101">プールの有効期間の使用効率とリソース使用状況の統計を格納します。</span><span class="sxs-lookup"><span data-stu-id="4428a-101">Contains utilization and resource usage statistics for the lifetime of a pool.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="LastUpdateTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4428a-102">これで、統計の最終更新時刻を取得します。</span><span class="sxs-lookup"><span data-stu-id="4428a-102">Gets the time at which the statistics were last updated.</span></span> <span data-ttu-id="4428a-103">すべての統計情報は間の範囲に制限されて<see cref="P:Microsoft.Azure.Batch.PoolStatistics.StartTime" />とこの値。</span><span class="sxs-lookup"><span data-stu-id="4428a-103">All statistics are limited to the range between <see cref="P:Microsoft.Azure.Batch.PoolStatistics.StartTime" /> and this value.</span></span>
            </summary>
    ...
    <Member MemberName="ResourceStatistics">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4428a-104">平均 CPU 使用率など、プール内のコンピューティング ノードでリソース消費量に関連する統計情報を取得します。</span><span class="sxs-lookup"><span data-stu-id="4428a-104">Gets statistics related to resource consumption by compute nodes in the pool, such as average CPU utilization.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4428a-105">統計情報の時間範囲の開始時刻を取得します。</span><span class="sxs-lookup"><span data-stu-id="4428a-105">Gets the start time of the time range covered by the statistics.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4428a-106">統計情報の URL を取得します。</span><span class="sxs-lookup"><span data-stu-id="4428a-106">Gets the URL for the statistics.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UsageStatistics">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4428a-107">コア時間使用量など、プールの使用率に関連する統計情報を取得します。</span><span class="sxs-lookup"><span data-stu-id="4428a-107">Gets statistics related to pool usage, such as the amount of core-time used.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
