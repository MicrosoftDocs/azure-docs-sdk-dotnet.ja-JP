<Type Name="Schedule" FullName="Microsoft.Azure.Batch.Schedule">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1c905-101">スケジュール。</span><span class="sxs-lookup"><span data-stu-id="1c905-101">A schedule.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1c905-102"><see cref="T:Microsoft.Azure.Batch.Schedule" /> クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="1c905-102">Initializes a new instance of the <see cref="T:Microsoft.Azure.Batch.Schedule" /> class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DoNotRunAfter">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1c905-103">取得または設定するまでジョブはスケジュールされなくなりますこのジョブ スケジュール の下のウォール クロック時間。</span><span class="sxs-lookup"><span data-stu-id="1c905-103">Gets or sets the wall clock time after which no job will be scheduled under this job schedule.</span></span>
            </summary>
    ...
    <Member MemberName="DoNotRunUntil">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1c905-104">取得または設定をこのジョブ スケジュール の下の最初のジョブをスケジュールする最早ウォール クロック時間</span><span class="sxs-lookup"><span data-stu-id="1c905-104">Gets or sets the earliest wall clock time at which to schedule the first job under this job schedule</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecurrenceInterval">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1c905-105">取得またはジョブ スケジュール の下の 2 つの連続するジョブの開始時刻の時間間隔を設定します。</span><span class="sxs-lookup"><span data-stu-id="1c905-105">Gets or sets the time interval between the start times of two successive jobs under the job schedule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartWindow">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1c905-106">取得または設定するには、ジョブのスケジュールがスケジュールされる準備ができてからジョブを開始する時間のウィンドウ。</span><span class="sxs-lookup"><span data-stu-id="1c905-106">Gets or sets the window of time within which a job must be started from the time the job schedule is ready to be scheduled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
