<Type Name="ComputeNodeEndpointConfiguration" FullName="Microsoft.Azure.Batch.ComputeNodeEndpointConfiguration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="35161-101">コンピューティング ノードのエンドポイント構成。</span><span class="sxs-lookup"><span data-stu-id="35161-101">The endpoint configuration for the compute node.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="InboundEndpoints">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="35161-102">コンピューティング ノード上でアクセス可能な受信エンドポイントの一覧を取得します。</span><span class="sxs-lookup"><span data-stu-id="35161-102">Gets the list of inbound endpoints that are accessible on the compute node.</span></span>
            </summary>
