<Type Name="IDefinition" FullName="Microsoft.Azure.Management.Network.Fluent.NetworkInterface.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="05460-101">ネットワーク インターフェイスの定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="05460-101">The entirety of the network interface definition.</span></span>
            </summary>
