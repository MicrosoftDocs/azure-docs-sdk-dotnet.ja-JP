<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Compute.Fluent.Snapshot.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="873e5-101">リソース グループを指定できるようにマネージ スナップショット定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="873e5-101">The stage of the managed snapshot definition allowing to specify the resource group.</span></span>
            </summary>
