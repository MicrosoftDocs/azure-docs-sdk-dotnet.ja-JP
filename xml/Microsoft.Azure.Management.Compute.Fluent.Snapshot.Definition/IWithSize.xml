<Type Name="IWithSize" FullName="Microsoft.Azure.Management.Compute.Fluent.Snapshot.Definition.IWithSize">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b9292-101">サイズを指定できるように、管理されているスナップショットの段階です。</span><span class="sxs-lookup"><span data-stu-id="b9292-101">The stage of the managed snapshot allowing to specify the size.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithSizeInGB">
      ...
      <Docs>
        <param name="sizeInGB"><span data-ttu-id="b9292-102">GB のディスク サイズです。</span><span class="sxs-lookup"><span data-stu-id="b9292-102">The disk size in GB.</span></span></param>
        <summary>
            <span data-ttu-id="b9292-103">ディスクのサイズを指定します。</span><span class="sxs-lookup"><span data-stu-id="b9292-103">Specifies the disk size.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="b9292-104">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="b9292-104">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>