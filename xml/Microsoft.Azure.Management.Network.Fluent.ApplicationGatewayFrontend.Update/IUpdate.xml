<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayFrontend.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f1b91-101">アプリケーション ゲートウェイの更新プログラムの一部としてアプリケーション ゲートウェイ フロント エンドの更新プログラムの全体です。</span><span class="sxs-lookup"><span data-stu-id="f1b91-101">The entirety of an application gateway frontend update as part of an application gateway update.</span></span>
            </summary>
