<Type Name="IWithBackendPort&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasBackendPort.Update.IWithBackendPort&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="a7edd-101">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="a7edd-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="a7edd-102">バックエンド ポートを変更できるように更新プログラムの段階です。</span><span class="sxs-lookup"><span data-stu-id="a7edd-102">The stage of an update allowing to modify the backend port.</span></span>
            </summary>
