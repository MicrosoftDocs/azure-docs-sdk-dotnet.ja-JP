<Type Name="ICustomImageDataDisk" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineCustomImage.ICustomImageDataDisk">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c8437-101">データの変更できないクライアント側表現はディスクのイメージ リソース内のイメージです。</span><span class="sxs-lookup"><span data-stu-id="c8437-101">An immutable client-side representation of a data disk image in an image resource.</span></span>
            </summary>
