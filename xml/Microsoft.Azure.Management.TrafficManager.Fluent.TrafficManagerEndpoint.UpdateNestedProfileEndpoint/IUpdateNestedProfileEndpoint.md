<Type Name="IUpdateNestedProfileEndpoint" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficManagerEndpoint.UpdateNestedProfileEndpoint.IUpdateNestedProfileEndpoint">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a7a51-101">親 traffic manager プロファイルのプロファイルの更新の一部として、入れ子になったプロファイル エンドポイントの更新の全体です。</span><span class="sxs-lookup"><span data-stu-id="a7a51-101">The entirety of a nested profile endpoint update as a part of parent traffic manager profile profile update.</span></span>
            </summary>
