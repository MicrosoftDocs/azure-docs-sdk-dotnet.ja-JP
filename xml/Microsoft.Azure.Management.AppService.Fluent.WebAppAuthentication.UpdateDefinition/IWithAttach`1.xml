<Type Name="IWithAttach&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.WebAppAuthentication.UpdateDefinition.IWithAttach&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="bb7ca-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="bb7ca-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="bb7ca-102">Web アプリの認証の定義の最終段階です。</span><span class="sxs-lookup"><span data-stu-id="bb7ca-102">The final stage of the web app authentication definition.</span></span>
            <span data-ttu-id="bb7ca-103">この段階で、残りの省略可能な設定を指定することができます、または WithAttach.attach() を使用して、親 web アプリの更新に web アプリの認証の定義をアタッチできます。</span><span class="sxs-lookup"><span data-stu-id="bb7ca-103">At this stage, any remaining optional settings can be specified, or the web app authentication definition can be attached to the parent web app update using  WithAttach.attach().</span></span>
            </summary>
