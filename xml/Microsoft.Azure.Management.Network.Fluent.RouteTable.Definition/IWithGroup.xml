<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Network.Fluent.RouteTable.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="154de-101">リソース グループを指定できるように、ルート テーブル定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="154de-101">The stage of a route table definition allowing to specify the resource group.</span></span>
            </summary>
