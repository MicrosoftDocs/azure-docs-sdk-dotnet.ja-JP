<Type Name="IWithRoute" FullName="Microsoft.Azure.Management.Network.Fluent.RouteTable.Definition.IWithRoute">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e318f-101">ルートを追加できるように、ルート テーブル定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="e318f-101">The stage of the route table definition allowing to add routes.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="DefineRoute">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="e318f-102">ルートの名前。</span><span class="sxs-lookup"><span data-stu-id="e318f-102">The name of the route.</span></span></param>
        <summary>
            <span data-ttu-id="e318f-103">ルート テーブルに追加する新しいルートの定義を開始します。</span><span class="sxs-lookup"><span data-stu-id="e318f-103">Begins the definition of a new route to add to the route table.</span></span>
            <span data-ttu-id="e318f-104">定義は、Route.DefinitionStages.WithAttach.attach() への呼び出しで完了する必要があります。</span><span class="sxs-lookup"><span data-stu-id="e318f-104">The definition must be completed with a call to  Route.DefinitionStages.WithAttach.attach().</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="e318f-105">定義の最初の段階です。</span><span class="sxs-lookup"><span data-stu-id="e318f-105">The first stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithRoute">
      ...
      <Docs>
        <param name="destinationAddressPrefix"><span data-ttu-id="e318f-106">送信先アドレス プレフィックス、CIDR 表記法のルートに適用するので表されます。</span><span class="sxs-lookup"><span data-stu-id="e318f-106">The destination address prefix, expressed in the CIDR notation, for the route to apply to.</span></span></param>
        <param name="nextHop"><span data-ttu-id="e318f-107">次のホップの種類。</span><span class="sxs-lookup"><span data-stu-id="e318f-107">The next hop type.</span></span></param>
        <summary>
            <span data-ttu-id="e318f-108">非仮想アプライアンスのルートを作成します。</span><span class="sxs-lookup"><span data-stu-id="e318f-108">Creates a non-virtual appliance route.</span></span>
            <span data-ttu-id="e318f-109">名前が自動的に生成されます。</span><span class="sxs-lookup"><span data-stu-id="e318f-109">The name is generated automatically.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="e318f-110">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="e318f-110">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithRouteViaVirtualAppliance">
      ...
      <Docs>
        <param name="destinationAddressPrefix"><span data-ttu-id="e318f-111">送信先アドレス プレフィックス、CIDR 表記法のルートに適用するので表されます。</span><span class="sxs-lookup"><span data-stu-id="e318f-111">The destination address prefix, expressed in the CIDR notation, for the route to apply to.</span></span></param>
        <param name="ipAddress"><span data-ttu-id="e318f-112">通過するトラフィックをルーティングする仮想アプライアンスの IP アドレス。</span><span class="sxs-lookup"><span data-stu-id="e318f-112">The IP address of the virtual appliance to route the traffic through.</span></span></param>
        <summary>
            <span data-ttu-id="e318f-113">仮想アプライアンス経由でのルートを作成します。</span><span class="sxs-lookup"><span data-stu-id="e318f-113">Creates a route via a virtual appliance.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="e318f-114">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="e318f-114">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>