<Type Name="ITelemetryChannel" FullName="Microsoft.ApplicationInsights.Channel.ITelemetryChannel">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="efb58-101">Application insights にテレメトリを送信するための通信チャネルを表します。</span><span class="sxs-lookup"><span data-stu-id="efb58-101">Represents a communication channel for sending telemetry to application insights.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="DeveloperMode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="efb58-102">取得または、このチャネルが開発者モードであるかどうかを示す値を設定します。</span><span class="sxs-lookup"><span data-stu-id="efb58-102">Gets or sets a value indicating whether this channel is in developer mode.</span></span>
            </summary>
    ...
    <Member MemberName="EndpointAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="efb58-103">取得またはチャネルのエンドポイント アドレスを設定します。</span><span class="sxs-lookup"><span data-stu-id="efb58-103">Gets or sets the endpoint address of the channel.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Flush">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="efb58-104">メモリ内のバッファーをフラッシュします。</span><span class="sxs-lookup"><span data-stu-id="efb58-104">Flushes the in-memory buffer.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Send">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="efb58-105">チャネルを通じて ITelemetry のインスタンスに送信します。</span><span class="sxs-lookup"><span data-stu-id="efb58-105">Sends an instance of ITelemetry through the channel.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
