<Type Name="IWithPublicIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGateway.Definition.IWithPublicIPAddress">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2760e-101">パブリック IP アドレスを持つ新しいインターネットに接続するフロント エンドの追加を許可するアプリケーション ゲートウェイ定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="2760e-101">The stage of an application gateway definition allowing to add a new Internet-facing frontend with a public IP address.</span></span>
            </summary>
