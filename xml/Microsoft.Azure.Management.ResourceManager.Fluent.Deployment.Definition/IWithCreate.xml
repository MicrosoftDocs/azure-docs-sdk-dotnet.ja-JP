<Type Name="IWithCreate" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Deployment.Definition.IWithCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ad2a6-101">新しい展開には、クラウドが指定する省略可能な追加の入力を公開することで、新しい展開を作成するための十分な入力での定義がします。</span><span class="sxs-lookup"><span data-stu-id="ad2a6-101">A deployment definition with sufficient inputs to create a new deployment in the cloud, but exposing additional optional inputs to specify.</span></span>
            </summary>
