<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerInboundNatPool.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="22698-101">ロード バランサーの更新の一部としての受信の NAT プール全体を更新します。</span><span class="sxs-lookup"><span data-stu-id="22698-101">The entirety of an inbound NAT pool update as part of a load balancer update.</span></span>
            </summary>
