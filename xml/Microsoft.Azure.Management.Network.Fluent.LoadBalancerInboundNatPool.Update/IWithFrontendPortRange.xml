<Type Name="IWithFrontendPortRange" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerInboundNatPool.Update.IWithFrontendPortRange">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c449d-101">フロント エンド ポート範囲を指定できるように着信 NAT プール更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="c449d-101">The stage of an inbound NAT pool update allowing to specify the frontend port range.</span></span>
            </summary>
