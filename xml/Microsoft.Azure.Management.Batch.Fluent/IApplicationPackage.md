<Type Name="IApplicationPackage" FullName="Microsoft.Azure.Management.Batch.Fluent.IApplicationPackage">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="938de-101">Azure Batch のアプリケーション パッケージの変更できないクライアント側表現。</span><span class="sxs-lookup"><span data-stu-id="938de-101">An immutable client-side representation of an Azure Batch application package.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Delete">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="938de-102">アプリケーション パッケージを削除します。</span><span class="sxs-lookup"><span data-stu-id="938de-102">Deletes the application package.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Format">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="938de-103">アプリケーション パッケージの形式を取得します。</span><span class="sxs-lookup"><span data-stu-id="938de-103">Gets the format of the application package.</span></span>
            </summary>
    ...
    <Member MemberName="LastActivationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="938de-104">このアプリケーション パッケージがアクティブ化された最終時刻を取得します。</span><span class="sxs-lookup"><span data-stu-id="938de-104">Gets the last time this application package was activated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="938de-105">アプリケーション パッケージの状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="938de-105">Gets the state of the application package.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageUrl">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="938de-106">アプリケーションをアップロードするアプリケーション パッケージのストレージの URL を取得します。</span><span class="sxs-lookup"><span data-stu-id="938de-106">Gets the storage URL of the application package where teh application should be uploaded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StorageUrlExpiry">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="938de-107">アプリケーション パッケージのストレージの URL の有効期限を取得します。</span><span class="sxs-lookup"><span data-stu-id="938de-107">Gets the expiry of the storage URL for the application package.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
