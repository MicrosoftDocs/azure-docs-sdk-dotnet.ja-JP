<Type Name="IBatchAccounts" FullName="Microsoft.Azure.Management.Batch.Fluent.IBatchAccounts">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="04aeb-101">Azure Batch アカウントの管理 API へのエントリ ポイントです。</span><span class="sxs-lookup"><span data-stu-id="04aeb-101">Entry point to Azure Batch account management API.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="GetBatchAccountQuotaByLocation">
      ...
      <Docs>
        <param name="region"><span data-ttu-id="04aeb-102">Azure のリージョン。</span><span class="sxs-lookup"><span data-stu-id="04aeb-102">An Azure region.</span></span></param>
        <summary>
            <span data-ttu-id="04aeb-103">指定された地域に作成できる Batch アカウントの数を検索します。</span><span class="sxs-lookup"><span data-stu-id="04aeb-103">Looks up the number of Batch accounts that can be created in the specified region.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="04aeb-104">指定された地域に作成できる Batch アカウントの数。</span><span class="sxs-lookup"><span data-stu-id="04aeb-104">The number of Batch accounts that can be created in the specified region.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>