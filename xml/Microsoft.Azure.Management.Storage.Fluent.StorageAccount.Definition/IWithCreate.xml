<Type Name="IWithCreate" FullName="Microsoft.Azure.Management.Storage.Fluent.StorageAccount.Definition.IWithCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="30518-101">ストレージ アカウントには、クラウドが指定する省略可能な追加の入力を公開することで新しいストレージ アカウントを作成するための十分な入力での定義が表示されます。</span><span class="sxs-lookup"><span data-stu-id="30518-101">A storage account definition with sufficient inputs to create a new storage account in the cloud, but exposing additional optional inputs to specify.</span></span>
            </summary>
