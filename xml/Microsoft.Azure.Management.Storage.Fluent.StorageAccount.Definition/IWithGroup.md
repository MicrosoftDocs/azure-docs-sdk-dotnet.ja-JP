<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Storage.Fluent.StorageAccount.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3d0c2-101">リソース グループを設定できるようにストレージ アカウント定義します。</span><span class="sxs-lookup"><span data-stu-id="3d0c2-101">A storage account definition allowing resource group to be set.</span></span>
            </summary>
