<Type Name="BatchAccountInner" FullName="Microsoft.Azure.Management.Batch.Fluent.Models.BatchAccountInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2c9a6-101">Azure Batch アカウントの情報が含まれています。</span><span class="sxs-lookup"><span data-stu-id="2c9a6-101">Contains information about an Azure Batch account.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c9a6-102">BatchAccountInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="2c9a6-102">Initializes a new instance of the BatchAccountInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="AccountEndpoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c9a6-103">バッチ サービスと対話するこのアカウントによって使用されるエンドポイントを取得します。</span><span class="sxs-lookup"><span data-stu-id="2c9a6-103">Gets the endpoint used by this account to interact with the Batch services.</span></span>
            </summary>
    ...
    <Member MemberName="ActiveJobAndJobScheduleQuota">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c9a6-104">取得またはアクティブなジョブとジョブ スケジュールのこの Batch アカウントのクォータを設定します。</span><span class="sxs-lookup"><span data-stu-id="2c9a6-104">Gets or sets the active job and job schedule quota for this Batch account.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AutoStorage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c9a6-105">取得またはアカウントに関連付けられているすべての自動ストレージ アカウントの状態とプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="2c9a6-105">Gets or sets the properties and status of any auto storage account associated with the account.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PoolQuota">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c9a6-106">取得またはこの Batch アカウントのプール クォータを設定します。</span><span class="sxs-lookup"><span data-stu-id="2c9a6-106">Gets or sets the pool quota for this Batch account.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c9a6-107">取得またはリソースのプロビジョニング状態を設定します。</span><span class="sxs-lookup"><span data-stu-id="2c9a6-107">Gets or sets the provisioned state of the resource.</span></span> <span data-ttu-id="2c9a6-108">使用可能な値が含まれます: '無効'、'作成中'、'削除'、'成功'、'失敗'、'キャンセル'</span><span class="sxs-lookup"><span data-stu-id="2c9a6-108">Possible values include: 'Invalid', 'Creating', 'Deleting', 'Succeeded', 'Failed', 'Cancelled'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2c9a6-109">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="2c9a6-109">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="2c9a6-110">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="2c9a6-110">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
