<Type Name="IWithSslCertificate&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasSslCertificate.Update.IWithSslCertificate&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="a40ed-101">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="a40ed-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="a40ed-102">それに関連付ける SSL 証明書を指定できるようにリソース更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="a40ed-102">The stage of a resource update allowing to specify the SSL certificate to associate with it.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithSslCertificate">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="a40ed-103">このアプリケーション ゲートウェイに関連付けられている既存の SSL 証明書の名前。</span><span class="sxs-lookup"><span data-stu-id="a40ed-103">The name of an existing SSL certificate associated with this application gateway.</span></span></param>
        <summary>
            <span data-ttu-id="a40ed-104">このリソースに関連付ける SSL 証明書を指定します。</span><span class="sxs-lookup"><span data-stu-id="a40ed-104">Specifies an SSL certificate to associate with this resource.</span></span>
            <span data-ttu-id="a40ed-105">証明書がまだ存在しない場合は、親のリソースの更新で定義する必要があります。</span><span class="sxs-lookup"><span data-stu-id="a40ed-105">If the certificate does not exist yet, it must be defined in the parent resource update.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="a40ed-106">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="a40ed-106">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithSslCertificateFromPfxFile">
      ...
      <Docs>
        <param name="pfxFile"><span data-ttu-id="a40ed-107">既存の PFX ファイルです。</span><span class="sxs-lookup"><span data-stu-id="a40ed-107">An existing PFX file.</span></span></param>
        <summary>
            <span data-ttu-id="a40ed-108">このリソースに関連付けるから SSL 証明書をインポートする PFX ファイルを指定します。</span><span class="sxs-lookup"><span data-stu-id="a40ed-108">Specifies the PFX file to import the SSL certificate from to associate with this resource.</span></span>
            <span data-ttu-id="a40ed-109">自動生成の名前を使用して、証明書の名前です。</span><span class="sxs-lookup"><span data-stu-id="a40ed-109">The certificate will be named using an auto-generated name.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <throws><span data-ttu-id="a40ed-110">指定されたファイルに関する問題がある場合に io 例外。</span><span class="sxs-lookup"><span data-stu-id="a40ed-110">IOException when there are issues with the provided file.</span></span></throws>
        <return><span data-ttu-id="a40ed-111">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="a40ed-111">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>