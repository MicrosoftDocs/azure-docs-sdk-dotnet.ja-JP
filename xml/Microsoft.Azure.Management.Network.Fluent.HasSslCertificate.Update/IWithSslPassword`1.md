<Type Name="IWithSslPassword&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasSslCertificate.Update.IWithSslPassword&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="4a6c4-101">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="4a6c4-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="4a6c4-102">インポートした SSL 証明書の秘密キーのパスワードを指定できるようにリソース更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="4a6c4-102">The stage of a resource update allowing to specify the password for the private key of the imported SSL certificate.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithSslCertificatePassword">
      ...
      <Docs>
        <param name="password"><span data-ttu-id="4a6c4-103">インポートされた PFX ファイルのパスワードです。</span><span class="sxs-lookup"><span data-stu-id="4a6c4-103">The password of the imported PFX file.</span></span></param>
        <summary>
            <span data-ttu-id="4a6c4-104">インポートした SSL 証明書の秘密キーを含む指定された PFX ファイルのパスワードを指定します。</span><span class="sxs-lookup"><span data-stu-id="4a6c4-104">Specifies the password for the specified PFX file containing the private key of the imported SSL certificate.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="4a6c4-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="4a6c4-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>