<Type Name="HybridRunbookWorkerGroupGetResponse" FullName="Microsoft.Azure.Management.Automation.Models.HybridRunbookWorkerGroupGetResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="abc3a-101">Get ハイブリッド runbook worker グループの操作の応答モデル。</span><span class="sxs-lookup"><span data-stu-id="abc3a-101">The response model for the get hybrid runbook worker group operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abc3a-102">HybridRunbookWorkerGroupGetResponse クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="abc3a-102">Initializes a new instance of the HybridRunbookWorkerGroupGetResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="HybridRunbookWorkerGroup">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="abc3a-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="abc3a-103">Optional.</span></span> <span data-ttu-id="abc3a-104">取得または hybrid runbook worker グループを設定します。</span><span class="sxs-lookup"><span data-stu-id="abc3a-104">Gets or sets a hybrid runbook worker group.</span></span>
            </summary>
