<Type Name="CredentialGetResponse" FullName="Microsoft.Azure.Management.Automation.Models.CredentialGetResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="eef86-101">資格情報の取得操作の応答モデル。</span><span class="sxs-lookup"><span data-stu-id="eef86-101">The response model for the get credential operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eef86-102">CredentialGetResponse クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="eef86-102">Initializes a new instance of the CredentialGetResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Credential">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eef86-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="eef86-103">Optional.</span></span> <span data-ttu-id="eef86-104">取得または資格情報を設定します。</span><span class="sxs-lookup"><span data-stu-id="eef86-104">Gets or sets a credential.</span></span>
            </summary>
