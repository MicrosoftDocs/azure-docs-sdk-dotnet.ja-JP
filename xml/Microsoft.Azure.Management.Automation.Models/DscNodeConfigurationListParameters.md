<Type Name="DscNodeConfigurationListParameters" FullName="Microsoft.Azure.Management.Automation.Models.DscNodeConfigurationListParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="35f34-101">一覧のノードの構成操作に指定するパラメーターです。</span><span class="sxs-lookup"><span data-stu-id="35f34-101">The parameters supplied to the list node configuration operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="35f34-102">DscNodeConfigurationListParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="35f34-102">Initializes a new instance of the DscNodeConfigurationListParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConfigurationName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="35f34-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="35f34-103">Optional.</span></span> <span data-ttu-id="35f34-104">取得または構成の名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="35f34-104">Gets or sets the configuration name.</span></span>
            </summary>
