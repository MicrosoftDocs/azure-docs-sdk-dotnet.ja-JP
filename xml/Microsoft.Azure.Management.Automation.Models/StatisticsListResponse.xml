<Type Name="StatisticsListResponse" FullName="Microsoft.Azure.Management.Automation.Models.StatisticsListResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e52ca-101">一覧の統計情報の操作の応答モデル。</span><span class="sxs-lookup"><span data-stu-id="e52ca-101">The response model for the list statistics operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e52ca-102">StatisticsListResponse クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="e52ca-102">Initializes a new instance of the StatisticsListResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e52ca-103">一連の統計情報を取得します。</span><span class="sxs-lookup"><span data-stu-id="e52ca-103">Gets the sequence of Statistics.</span></span>
            </summary>
    ...
    <Member MemberName="Statistics">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e52ca-104">省略可能。</span><span class="sxs-lookup"><span data-stu-id="e52ca-104">Optional.</span></span> <span data-ttu-id="e52ca-105">取得または統計の一覧を設定します。</span><span class="sxs-lookup"><span data-stu-id="e52ca-105">Gets or sets a list of statistics.</span></span>
            </summary>
    ...
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e52ca-106">一連の統計情報を取得します。</span><span class="sxs-lookup"><span data-stu-id="e52ca-106">Gets the sequence of Statistics.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
