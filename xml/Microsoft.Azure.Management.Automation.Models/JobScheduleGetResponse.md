<Type Name="JobScheduleGetResponse" FullName="Microsoft.Azure.Management.Automation.Models.JobScheduleGetResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c3b17-101">ジョブ スケジュールの取得操作の応答モデル。</span><span class="sxs-lookup"><span data-stu-id="c3b17-101">The response model for the get job schedule operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3b17-102">JobScheduleGetResponse クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c3b17-102">Initializes a new instance of the JobScheduleGetResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="JobSchedule">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c3b17-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="c3b17-103">Optional.</span></span> <span data-ttu-id="c3b17-104">取得またはジョブのスケジュールを設定します。</span><span class="sxs-lookup"><span data-stu-id="c3b17-104">Gets or sets a job schedule.</span></span>
            </summary>
