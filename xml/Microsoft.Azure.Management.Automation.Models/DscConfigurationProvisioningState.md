<Type Name="DscConfigurationProvisioningState" FullName="Microsoft.Azure.Management.Automation.Models.DscConfigurationProvisioningState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a2201-101">構成操作の状態を準備しています。</span><span class="sxs-lookup"><span data-stu-id="a2201-101">Provisioning state of the configuration operation.</span></span>
            </summary>
