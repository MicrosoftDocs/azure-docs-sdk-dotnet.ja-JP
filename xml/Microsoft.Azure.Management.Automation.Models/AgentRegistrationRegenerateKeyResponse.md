<Type Name="AgentRegistrationRegenerateKeyResponse" FullName="Microsoft.Azure.Management.Automation.Models.AgentRegistrationRegenerateKeyResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fd2b8-101">エージェント登録キーの応答モデルは、操作を再生成します。</span><span class="sxs-lookup"><span data-stu-id="fd2b8-101">The response model for the agent registration key regenerate operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fd2b8-102">AgentRegistrationRegenerateKeyResponse クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="fd2b8-102">Initializes a new instance of the AgentRegistrationRegenerateKeyResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AgentRegistration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fd2b8-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="fd2b8-103">Optional.</span></span> <span data-ttu-id="fd2b8-104">取得またはエージェント登録情報を設定します。</span><span class="sxs-lookup"><span data-stu-id="fd2b8-104">Gets or sets agent registration information.</span></span>
            </summary>
