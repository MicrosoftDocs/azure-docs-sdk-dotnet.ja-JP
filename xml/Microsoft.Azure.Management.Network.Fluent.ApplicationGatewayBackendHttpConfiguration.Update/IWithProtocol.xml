<Type Name="IWithProtocol" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayBackendHttpConfiguration.Update.IWithProtocol">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dae6e-101">プロトコルを指定できるようにする、アプリケーション ゲートウェイ バックエンド HTTP 構成の段階です。</span><span class="sxs-lookup"><span data-stu-id="dae6e-101">The stage of an application gateway backend HTTP configuration allowing to specify the protocol.</span></span>
            </summary>
