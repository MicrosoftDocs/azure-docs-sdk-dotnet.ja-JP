<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.ServiceBusNamespace.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3f20c-101">リソース グループを指定できるように Service Bus 名前空間の定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="3f20c-101">The stage of the Service Bus namespace definition allowing to specify the resource group.</span></span>
            </summary>
