<Type Name="OperationsExtensions" FullName="Microsoft.Azure.Management.BatchAI.OperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b1448-101">操作の拡張メソッド。</span><span class="sxs-lookup"><span data-stu-id="b1448-101">Extension methods for Operations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="List">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="b1448-102">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="b1448-102">The operations group for this extension method.</span></span>
            </param>
        <summary>
            <span data-ttu-id="b1448-103">Microsoft.BatchAI プロバイダーの使用可能な操作を一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="b1448-103">Lists available operations for the Microsoft.BatchAI provider.</span></span>
            </summary>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="b1448-104">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="b1448-104">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="b1448-105">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="b1448-105">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="b1448-106">Microsoft.BatchAI プロバイダーの使用可能な操作を一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="b1448-106">Lists available operations for the Microsoft.BatchAI provider.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNext">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="b1448-107">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="b1448-107">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="b1448-108">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="b1448-108">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <summary>
            <span data-ttu-id="b1448-109">Microsoft.BatchAI プロバイダーの使用可能な操作を一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="b1448-109">Lists available operations for the Microsoft.BatchAI provider.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="b1448-110">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="b1448-110">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="b1448-111">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="b1448-111">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="b1448-112">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="b1448-112">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="b1448-113">Microsoft.BatchAI プロバイダーの使用可能な操作を一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="b1448-113">Lists available operations for the Microsoft.BatchAI provider.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
