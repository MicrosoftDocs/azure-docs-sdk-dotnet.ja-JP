<Type Name="IUpdateSoaRecord" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateSoaRecord.IUpdateSoaRecord">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3a6b4-101">SOA の全体は、親 DNS ゾーンの更新プログラムの一部として更新を記録します。</span><span class="sxs-lookup"><span data-stu-id="3a6b4-101">The entirety of a SOA record update as a part of parent DNS zone update.</span></span>
            </summary>
