<Type Name="FailoverGroupUpdate" FullName="Microsoft.Azure.Management.Sql.Models.FailoverGroupUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="738c1-101">グループのフェールオーバーでは、要求を更新します。</span><span class="sxs-lookup"><span data-stu-id="738c1-101">A failover group update request.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="738c1-102">FailoverGroupUpdate クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="738c1-102">Initializes a new instance of the FailoverGroupUpdate class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="readWriteEndpoint"><span data-ttu-id="738c1-103">フェールオーバー グループ インスタンスのエンドポイントを読み取り/書き込みです。</span><span class="sxs-lookup"><span data-stu-id="738c1-103">Read-write endpoint of the failover group instance.</span></span></param>
        <param name="readOnlyEndpoint"><span data-ttu-id="738c1-104">フェールオーバー グループ インスタンスのエンドポイントを読み取り専用です。</span><span class="sxs-lookup"><span data-stu-id="738c1-104">Read-only endpoint of the failover group instance.</span></span></param>
        <param name="databases"><span data-ttu-id="738c1-105">フェールオーバー グループ内のデータベースの一覧です。</span><span class="sxs-lookup"><span data-stu-id="738c1-105">List of databases in the failover group.</span></span></param>
        <param name="tags"><span data-ttu-id="738c1-106">リソース タグ。</span><span class="sxs-lookup"><span data-stu-id="738c1-106">Resource tags.</span></span></param>
        <summary>
            <span data-ttu-id="738c1-107">FailoverGroupUpdate クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="738c1-107">Initializes a new instance of the FailoverGroupUpdate class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Databases">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="738c1-108">取得またはフェールオーバー グループ内のデータベースの一覧を設定します。</span><span class="sxs-lookup"><span data-stu-id="738c1-108">Gets or sets list of databases in the failover group.</span></span>
            </summary>
    ...
    <Member MemberName="ReadOnlyEndpoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="738c1-109">取得またはフェールオーバー グループ インスタンスの読み取り専用のエンドポイントを設定します。</span><span class="sxs-lookup"><span data-stu-id="738c1-109">Gets or sets read-only endpoint of the failover group instance.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReadWriteEndpoint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="738c1-110">取得またはフェールオーバー グループ インスタンスの読み取り/書き込みのエンドポイントを設定します。</span><span class="sxs-lookup"><span data-stu-id="738c1-110">Gets or sets read-write endpoint of the failover group instance.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="738c1-111">取得またはリソース タグを設定します。</span><span class="sxs-lookup"><span data-stu-id="738c1-111">Gets or sets resource tags.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="738c1-112">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="738c1-112">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="738c1-113">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="738c1-113">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
