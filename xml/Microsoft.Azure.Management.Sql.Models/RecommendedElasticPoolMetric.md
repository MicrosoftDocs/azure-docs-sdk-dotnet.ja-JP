<Type Name="RecommendedElasticPoolMetric" FullName="Microsoft.Azure.Management.Sql.Models.RecommendedElasticPoolMetric">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0b84f-101">表すには、弾力性プールのメトリックがお勧めします。</span><span class="sxs-lookup"><span data-stu-id="0b84f-101">Represents recommended elastic pool metric.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b84f-102">RecommendedElasticPoolMetric クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="0b84f-102">Initializes a new instance of the RecommendedElasticPoolMetric class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="dateTime"><span data-ttu-id="0b84f-103">メトリック (ISO8601 形式) の時刻。</span><span class="sxs-lookup"><span data-stu-id="0b84f-103">The time of metric (ISO8601 format).</span></span></param>
        <param name="dtu"><span data-ttu-id="0b84f-104">取得または Dtu (データベース トランザクション ユニット数) を設定します。</span><span class="sxs-lookup"><span data-stu-id="0b84f-104">Gets or sets the DTUs (Database Transaction Units).</span></span> <span data-ttu-id="0b84f-105">Https://azure.microsoft.com/documentation/articles/sql-database-what-is-a-dtu/を参照してください。</span><span class="sxs-lookup"><span data-stu-id="0b84f-105">See https://azure.microsoft.com/documentation/articles/sql-database-what-is-a-dtu/</span></span></param>
        <param name="sizeGB"><span data-ttu-id="0b84f-106">取得またはギガバイト単位でサイズを設定します。</span><span class="sxs-lookup"><span data-stu-id="0b84f-106">Gets or sets size in gigabytes.</span></span></param>
        <summary>
            <span data-ttu-id="0b84f-107">RecommendedElasticPoolMetric クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="0b84f-107">Initializes a new instance of the RecommendedElasticPoolMetric class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DateTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b84f-108">取得またはメトリック (ISO8601 形式) の時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="0b84f-108">Gets or sets the time of metric (ISO8601 format).</span></span>
            </summary>
    ...
    <Member MemberName="Dtu">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b84f-109">取得または Dtu (データベース トランザクション ユニット数) を設定します。</span><span class="sxs-lookup"><span data-stu-id="0b84f-109">Gets or sets the DTUs (Database Transaction Units).</span></span> <span data-ttu-id="0b84f-110">Https://azure.microsoft.com/documentation/articles/sql-database-what-is-a-dtu/を参照してください。</span><span class="sxs-lookup"><span data-stu-id="0b84f-110">See https://azure.microsoft.com/documentation/articles/sql-database-what-is-a-dtu/</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SizeGB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b84f-111">取得またはギガバイト単位でサイズを設定します。</span><span class="sxs-lookup"><span data-stu-id="0b84f-111">Gets or sets size in gigabytes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
