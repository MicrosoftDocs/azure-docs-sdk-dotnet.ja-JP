<Type Name="SyncMemberState" FullName="Microsoft.Azure.Management.Sql.Models.SyncMemberState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="43b0a-101">SyncMemberState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="43b0a-101">Defines values for SyncMemberState.</span></span>
            </summary>
