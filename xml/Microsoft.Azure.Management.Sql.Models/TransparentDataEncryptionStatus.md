<Type Name="TransparentDataEncryptionStatus" FullName="Microsoft.Azure.Management.Sql.Models.TransparentDataEncryptionStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="eee52-101">TransparentDataEncryptionStatus の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="eee52-101">Defines values for TransparentDataEncryptionStatus.</span></span>
            </summary>
