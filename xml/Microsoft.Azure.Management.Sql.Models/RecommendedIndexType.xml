<Type Name="RecommendedIndexType" FullName="Microsoft.Azure.Management.Sql.Models.RecommendedIndexType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="efc28-101">RecommendedIndexType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="efc28-101">Defines values for RecommendedIndexType.</span></span>
            </summary>
