<Type Name="CheckNameAvailabilityReason" FullName="Microsoft.Azure.Management.Sql.Models.CheckNameAvailabilityReason">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e4f20-101">CheckNameAvailabilityReason の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="e4f20-101">Defines values for CheckNameAvailabilityReason.</span></span>
            </summary>
