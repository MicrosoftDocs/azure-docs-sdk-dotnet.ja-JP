<Type Name="FailoverGroupReplicationRole" FullName="Microsoft.Azure.Management.Sql.Models.FailoverGroupReplicationRole">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="47481-101">FailoverGroupReplicationRole の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="47481-101">Defines values for FailoverGroupReplicationRole.</span></span>
            </summary>
