<Type Name="Operation" FullName="Microsoft.Azure.Management.IotHub.Models.Operation">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c826e-101">IoT Hub の REST API の操作</span><span class="sxs-lookup"><span data-stu-id="c826e-101">IoT Hub REST API operation</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c826e-102">Operation クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c826e-102">Initializes a new instance of the Operation class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="c826e-103">操作名: {プロバイダー}/{リソース}/{読み取り | 書き込み | アクション | 削除}</span><span class="sxs-lookup"><span data-stu-id="c826e-103">Operation name: {provider}/{resource}/{read | write | action | delete}</span></span></param>
        <param name="display"><span data-ttu-id="c826e-104">操作を表すオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="c826e-104">The object that represents the operation.</span></span></param>
        <summary>
            <span data-ttu-id="c826e-105">Operation クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c826e-105">Initializes a new instance of the Operation class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Display">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c826e-106">取得または設定の操作を表すオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="c826e-106">Gets or sets the object that represents the operation.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c826e-107">操作の名前を取得: {プロバイダー}/{リソース}/{読み取り | 書き込み | アクション | を削除}</span><span class="sxs-lookup"><span data-stu-id="c826e-107">Gets operation name: {provider}/{resource}/{read | write | action | delete}</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
