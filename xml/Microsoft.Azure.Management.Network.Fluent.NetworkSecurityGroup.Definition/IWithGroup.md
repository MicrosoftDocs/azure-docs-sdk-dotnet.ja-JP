<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Network.Fluent.NetworkSecurityGroup.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f5a34-101">リソース グループを指定できるように段階です。</span><span class="sxs-lookup"><span data-stu-id="f5a34-101">The stage allowing to specify the resource group.</span></span>
            </summary>
