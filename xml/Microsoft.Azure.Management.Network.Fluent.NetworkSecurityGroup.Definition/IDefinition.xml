<Type Name="IDefinition" FullName="Microsoft.Azure.Management.Network.Fluent.NetworkSecurityGroup.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0bd0f-101">ネットワーク セキュリティ グループ定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="0bd0f-101">The entirety of the network security group definition.</span></span>
            </summary>
