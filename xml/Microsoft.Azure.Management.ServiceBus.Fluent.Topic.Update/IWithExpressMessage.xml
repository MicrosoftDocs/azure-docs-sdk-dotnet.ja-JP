<Type Name="IWithExpressMessage" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Topic.Update.IWithExpressMessage">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5dd7d-101">いずれかとしてマークするを許可するトピックの定義のステージでは、regular または express のメッセージを保持します。</span><span class="sxs-lookup"><span data-stu-id="5dd7d-101">The stage of the topic definition allowing to mark it as either holding regular or express messages.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithExpressMessage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5dd7d-102">このトピック内のメッセージがある高速ためしばらくの間メッセージング ストアに格納する前にメモリにキャッシュすることができますを指定します。</span><span class="sxs-lookup"><span data-stu-id="5dd7d-102">Specifies that messages in this topic are express hence they can be cached in memory for some time before storing it in messaging store.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="5dd7d-103">トピックの更新の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="5dd7d-103">The next stage of topic update.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithoutExpressMessage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5dd7d-104">このトピック内のメッセージがないこと express ためそれらをメモリにキャッシュするかを指定します。</span><span class="sxs-lookup"><span data-stu-id="5dd7d-104">Specifies that messages in this topic are not express hence they should be cached in memory.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="5dd7d-105">トピックの更新の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="5dd7d-105">The next stage of topic update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>