<Type Name="IDefinitionUnmanaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.DefinitionUnmanaged.IDefinitionUnmanaged">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="da0b2-101">仮想マシンの定義をアンマネージ ディスク全体に基づいています。</span><span class="sxs-lookup"><span data-stu-id="da0b2-101">The entirety of the unmanaged disk based virtual machine definition.</span></span>
            </summary>
