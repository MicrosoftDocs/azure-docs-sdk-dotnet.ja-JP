<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.PublicIPAddress.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2c2f8-101">すべての更新プログラムのコンテナー インターフェイスです。</span><span class="sxs-lookup"><span data-stu-id="2c2f8-101">Container interface for all the updates.</span></span>
            <span data-ttu-id="2c2f8-102">Update.apply() を使用して、Azure のリソースに変更を適用します。</span><span class="sxs-lookup"><span data-stu-id="2c2f8-102">Use  Update.apply() to apply the changes to the resource in Azure.</span></span>
            </summary>
