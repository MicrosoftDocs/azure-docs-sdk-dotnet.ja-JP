<Type Name="IWithSession" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Queue.Definition.IWithSession">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6fd68-101">セッションのサポートを有効にできるように、キューの定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="6fd68-101">The stage of the queue definition allowing to enable session support.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithSession">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6fd68-102">キューのセッションのサポートを有効にすることを指定します。</span><span class="sxs-lookup"><span data-stu-id="6fd68-102">Specifies that session support should be enabled for the queue.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="6fd68-103">キュー定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="6fd68-103">The next stage of queue definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>