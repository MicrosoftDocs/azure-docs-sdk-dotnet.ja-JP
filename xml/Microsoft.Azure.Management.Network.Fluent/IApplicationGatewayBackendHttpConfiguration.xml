<Type Name="IApplicationGatewayBackendHttpConfiguration" FullName="Microsoft.Azure.Management.Network.Fluent.IApplicationGatewayBackendHttpConfiguration">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bad33-101">Application gateway のバックエンド HTTP 構成の変更できないクライアント側表現。</span><span class="sxs-lookup"><span data-stu-id="bad33-101">An immutable client-side representation of an application gateway's backend HTTP configuration.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="bad33-102">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです。)。</span><span class="sxs-lookup"><span data-stu-id="bad33-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="CookieBasedAffinity">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bad33-103">Cookie ベースのアフィニティ (スティッキー セッション) 場合は true。 取得が有効になってそれ以外の場合は false です。</span><span class="sxs-lookup"><span data-stu-id="bad33-103">Gets true if cookie based affinity (sticky sessions) is enabled, else false.</span></span>
            </summary>
    ...
    <Member MemberName="RequestTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bad33-104">HTTP 要求のタイムアウトを秒単位で取得します。</span><span class="sxs-lookup"><span data-stu-id="bad33-104">Gets HTTP request timeout in seconds.</span></span> <span data-ttu-id="bad33-105">指定した時間内に応答を受信しない場合、要求は失敗します。</span><span class="sxs-lookup"><span data-stu-id="bad33-105">Requests will fail if no response is received within the specified time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
