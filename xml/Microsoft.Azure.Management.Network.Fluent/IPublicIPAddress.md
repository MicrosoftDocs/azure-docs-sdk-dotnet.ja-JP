<Type Name="IPublicIPAddress" FullName="Microsoft.Azure.Management.Network.Fluent.IPublicIPAddress">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d876b-101">パブリック IP アドレス。</span><span class="sxs-lookup"><span data-stu-id="d876b-101">Public IP address.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Fqdn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d876b-102">割り当てられた FQDN (完全修飾ドメイン名) を取得します。</span><span class="sxs-lookup"><span data-stu-id="d876b-102">Gets the assigned FQDN (fully qualified domain name).</span></span>
            </summary>
    ...
    <Member MemberName="GetAssignedLoadBalancerFrontend">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="d876b-103">ロード バランサー パブリック フロント エンドにこのパブリック IP アドレスが割り当てられています。</span><span class="sxs-lookup"><span data-stu-id="d876b-103">The load balancer public frontend that this public IP address is assigned to.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="GetAssignedNetworkInterfaceIPConfiguration">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="d876b-104">ネットワーク インターフェイス IP 構成をこのパブリック IP アドレスが割り当てられます。</span><span class="sxs-lookup"><span data-stu-id="d876b-104">The network interface IP configuration that this public IP address is assigned to.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="HasAssignedLoadBalancer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d876b-105">このパブリック IP アドレスがロード バランサーに割り当てられている場合は true を取得します。</span><span class="sxs-lookup"><span data-stu-id="d876b-105">Gets true if this public IP address is assigned to a load balancer.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HasAssignedNetworkInterface">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d876b-106">このパブリック IP アドレスがネットワーク インターフェイスに割り当てられている場合は true を取得します。</span><span class="sxs-lookup"><span data-stu-id="d876b-106">Gets true if this public IP address is assigned to a network interface.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IdleTimeoutInMinutes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d876b-107">分単位でアイドル状態の接続タイムアウトの設定を取得します。</span><span class="sxs-lookup"><span data-stu-id="d876b-107">Gets the idle connection timeout setting (in minutes).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IPAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d876b-108">割り当てられた IP アドレスを取得します。</span><span class="sxs-lookup"><span data-stu-id="d876b-108">Gets the assigned IP address.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IPAllocationMethod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d876b-109">IP アドレスの割り当て方法 (静的/動的) を取得します。</span><span class="sxs-lookup"><span data-stu-id="d876b-109">Gets the IP address allocation method (Static/Dynamic).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LeafDomainLabel">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d876b-110">割り当てられているリーフ ドメイン ラベルを取得します。</span><span class="sxs-lookup"><span data-stu-id="d876b-110">Gets the assigned leaf domain label.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReverseFqdn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d876b-111">存在する場合は、割り当て済みの逆引き FQDN を取得します。</span><span class="sxs-lookup"><span data-stu-id="d876b-111">Gets the assigned reverse FQDN, if any.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d876b-112">パブリック IP アドレス、IP のバージョンを取得します。</span><span class="sxs-lookup"><span data-stu-id="d876b-112">Gets the IP version of the public IP address.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
