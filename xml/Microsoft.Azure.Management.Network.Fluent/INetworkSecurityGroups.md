<Type Name="INetworkSecurityGroups" FullName="Microsoft.Azure.Management.Network.Fluent.INetworkSecurityGroups">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e64de-101">エントリは、ネットワーク セキュリティ グループの管理 をポイントします。</span><span class="sxs-lookup"><span data-stu-id="e64de-101">Entry point to network security group management.</span></span>
            </summary>
