<Type Name="INetworkSecurityRule" FullName="Microsoft.Azure.Management.Network.Fluent.INetworkSecurityRule">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="eeb1c-101">ネットワーク セキュリティ グループのネットワーク セキュリティ ルール。</span><span class="sxs-lookup"><span data-stu-id="eeb1c-101">A network security rule in a network security group.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Access">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eeb1c-102">ルールを適用するアクセスの種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="eeb1c-102">Gets the type of access the rule enforces.</span></span>
            </summary>
    ...
    <Member MemberName="Description">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eeb1c-103">セキュリティの規則のユーザー定義の説明を取得します。</span><span class="sxs-lookup"><span data-stu-id="eeb1c-103">Gets the user-defined description of the security rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DestinationAddressPrefix">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eeb1c-104">規則を適用、CIDR 表記を使用する形式で表される、宛先アドレス プレフィックスを取得:"###. ###. ###. #, ##0.00;($#/"、および"""any"ことを意味します。</span><span class="sxs-lookup"><span data-stu-id="eeb1c-104">Gets the destination address prefix the rule applies to, expressed using the CIDR notation in the format: "###.###.###.###/##", and "" means "any".</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DestinationPortRange">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eeb1c-105">「#、##」の形式で、規則が適用される宛先ポート範囲の取得場所""いずれかのことを意味します。</span><span class="sxs-lookup"><span data-stu-id="eeb1c-105">Gets the destination port range that the rule applies to, in the format "##-##", where "" means any.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Direction">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eeb1c-106">ネットワーク セキュリティ ルールを適用するネットワーク トラフィックの方向を取得します。</span><span class="sxs-lookup"><span data-stu-id="eeb1c-106">Gets the direction of the network traffic that the network security rule applies to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Priority">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eeb1c-107">この規則を適用するに基づいてこのルールの優先順位番号が相対的にこのネットワーク セキュリティ グループに指定されたその他のルールの優先順位番号を取得します。</span><span class="sxs-lookup"><span data-stu-id="eeb1c-107">Gets the priority number of this rule based on which this rule will be applied relative to the priority numbers of any other rules specified for this network security group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Protocol">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eeb1c-108">規則を適用するネットワーク プロトコルを取得します。</span><span class="sxs-lookup"><span data-stu-id="eeb1c-108">Gets the network protocol the rule applies to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SourceAddressPrefix">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eeb1c-109">規則を適用、CIDR 表記を使用する形式で表されるソース アドレス プレフィックスを取得:"###. ###. ###. #, ##0.00;($#/"、および"""any"ことを意味します。</span><span class="sxs-lookup"><span data-stu-id="eeb1c-109">Gets the source address prefix the rule applies to, expressed using the CIDR notation in the format: "###.###.###.###/##", and "" means "any".</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SourcePortRange">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="eeb1c-110">「#、##」の形式で、規則が適用されるソース ポート範囲を取得、"""any"ことを意味します。</span><span class="sxs-lookup"><span data-stu-id="eeb1c-110">Gets the source port range that the rule applies to, in the format "##-##", where "" means "any".</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
