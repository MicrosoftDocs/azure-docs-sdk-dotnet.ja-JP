<Type Name="NetworkManager" FullName="Microsoft.Azure.Management.Network.Fluent.NetworkManager">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ff4d2-101">エントリは、Azure のネットワーク管理 をポイントします。</span><span class="sxs-lookup"><span data-stu-id="ff4d2-101">Entry point to Azure networking management.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ApplicationGateways">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff4d2-102">エントリは、アプリケーション ゲートウェイの管理 をポイントします。</span><span class="sxs-lookup"><span data-stu-id="ff4d2-102">Entry point to application gateway management.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>
            <span data-ttu-id="ff4d2-103">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです)。</span><span class="sxs-lookup"><span data-stu-id="ff4d2-103">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.)</span></span>
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="Authenticate">
      ...
      <Docs>
        <param name="credentials"><span data-ttu-id="ff4d2-104">使用する資格情報</span><span class="sxs-lookup"><span data-stu-id="ff4d2-104">the credentials to use</span></span></param>
        <param name="subscriptionId"><span data-ttu-id="ff4d2-105">サブスクリプションの UUID</span><span class="sxs-lookup"><span data-stu-id="ff4d2-105">the subscription UUID</span></span></param>
        <summary>
            <span data-ttu-id="ff4d2-106">記憶域リソースの管理 API エントリ ポイントを公開する NetworkManager のインスタンスを作成します。</span><span class="sxs-lookup"><span data-stu-id="ff4d2-106">Creates an instance of NetworkManager that exposes storage resource management API entry points.</span></span>
            </summary>
        <returns><span data-ttu-id="ff4d2-107">NetworkManager</span><span class="sxs-lookup"><span data-stu-id="ff4d2-107">the NetworkManager</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Authenticate">
      ...
      <Docs>
        <param name="restClient"><span data-ttu-id="ff4d2-108">API 呼び出しに使用する RestClient です。</span><span class="sxs-lookup"><span data-stu-id="ff4d2-108">the RestClient to be used for API calls.</span></span></param>
        <param name="subscriptionId"><span data-ttu-id="ff4d2-109">サブスクリプションの UUID</span><span class="sxs-lookup"><span data-stu-id="ff4d2-109">the subscription UUID</span></span></param>
        <summary>
            <span data-ttu-id="ff4d2-110">記憶域リソースの管理 API エントリ ポイントを公開する NetworkManager のインスタンスを作成します。</span><span class="sxs-lookup"><span data-stu-id="ff4d2-110">Creates an instance of NetworkManager that exposes storage resource management API entry points.</span></span>
            </summary>
        <returns><span data-ttu-id="ff4d2-111">NetworkManager</span><span class="sxs-lookup"><span data-stu-id="ff4d2-111">the NetworkManager</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Configure">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff4d2-112">NetworkManager をオプションの構成を作成するために使用する構成可能なインスタンスを取得します。</span><span class="sxs-lookup"><span data-stu-id="ff4d2-112">Get a Configurable instance that can be used to create NetworkManager with optional configuration.</span></span>
            </summary>
        <returns><span data-ttu-id="ff4d2-113">インスタンスの構成を許可します。</span><span class="sxs-lookup"><span data-stu-id="ff4d2-113">the instance allowing configurations</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="LoadBalancers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff4d2-114">ロード バランサー管理へのエントリ ポイントを返します</span><span class="sxs-lookup"><span data-stu-id="ff4d2-114">returns entry point to load balancer management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>
            <span data-ttu-id="ff4d2-115">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです)。</span><span class="sxs-lookup"><span data-stu-id="ff4d2-115">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.)</span></span>
            </remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="NetworkInterfaces">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff4d2-116">エントリは、ネットワーク インターフェイスの管理 をポイントします。</span><span class="sxs-lookup"><span data-stu-id="ff4d2-116">Entry point to network interface management.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Networks">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff4d2-117">仮想ネットワークの管理にエントリ ポイントを返す</span><span class="sxs-lookup"><span data-stu-id="ff4d2-117">return entry point to virtual network management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetworkSecurityGroups">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff4d2-118">ネットワーク セキュリティ グループの管理にエントリ ポイントを返す</span><span class="sxs-lookup"><span data-stu-id="ff4d2-118">return entry point to network security group management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAddresses">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff4d2-119">パブリック IP アドレスを管理するエントリ ポイントを返す</span><span class="sxs-lookup"><span data-stu-id="ff4d2-119">return entry point to public IP address management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RouteTables">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ff4d2-120">テーブルの管理をルーティングするエントリ ポイントを返す</span><span class="sxs-lookup"><span data-stu-id="ff4d2-120">return entry point to route table management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
