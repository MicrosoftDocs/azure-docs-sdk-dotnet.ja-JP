<Type Name="ExpressRouteServiceProvidersOperationsExtensions" FullName="Microsoft.Azure.Management.Network.Fluent.ExpressRouteServiceProvidersOperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a818c-101">ExpressRouteServiceProvidersOperations の拡張メソッド。</span><span class="sxs-lookup"><span data-stu-id="a818c-101">Extension methods for ExpressRouteServiceProvidersOperations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="a818c-102">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="a818c-102">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="a818c-103">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="a818c-103">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="a818c-104">使用可能なすべての express route サービス プロバイダーを取得します。</span><span class="sxs-lookup"><span data-stu-id="a818c-104">Gets all the available express route service providers.</span></span>
            </summary>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="a818c-105">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="a818c-105">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="a818c-106">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="a818c-106">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="a818c-107">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="a818c-107">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="a818c-108">使用可能なすべての express route サービス プロバイダーを取得します。</span><span class="sxs-lookup"><span data-stu-id="a818c-108">Gets all the available express route service providers.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
