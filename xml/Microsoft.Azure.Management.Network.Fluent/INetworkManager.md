<Type Name="INetworkManager" FullName="Microsoft.Azure.Management.Network.Fluent.INetworkManager">
  ...
  <Members>
    <Member MemberName="ApplicationGateways">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a6b58-101">エントリは、アプリケーション ゲートウェイの管理 をポイントします。</span><span class="sxs-lookup"><span data-stu-id="a6b58-101">Entry point to application gateway management.</span></span>
            </summary>
    ...
    <Member MemberName="LoadBalancers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a6b58-102">ロード バランサー管理へのエントリ ポイントを返す</span><span class="sxs-lookup"><span data-stu-id="a6b58-102">return entry point to load balancer management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetworkInterfaces">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a6b58-103">ネットワーク インターフェイスの管理に対するエントリ ポイントを返す</span><span class="sxs-lookup"><span data-stu-id="a6b58-103">return entry point to network interface management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Networks">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a6b58-104">仮想ネットワークの管理にエントリ ポイントを返す</span><span class="sxs-lookup"><span data-stu-id="a6b58-104">return entry point to virtual network management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetworkSecurityGroups">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a6b58-105">ネットワーク セキュリティ グループの管理にエントリ ポイントを返す</span><span class="sxs-lookup"><span data-stu-id="a6b58-105">return entry point to network security group management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAddresses">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a6b58-106">パブリック IP アドレスを管理するエントリ ポイントを返す</span><span class="sxs-lookup"><span data-stu-id="a6b58-106">return entry point to public IP address management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RouteTables">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a6b58-107">ルート テーブルの管理へのエントリ ポイント</span><span class="sxs-lookup"><span data-stu-id="a6b58-107">Entry point to route table management</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
