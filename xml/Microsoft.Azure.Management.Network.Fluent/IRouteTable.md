<Type Name="IRouteTable" FullName="Microsoft.Azure.Management.Network.Fluent.IRouteTable">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9078c-101">ルート テーブルの管理のエントリ ポイント。</span><span class="sxs-lookup"><span data-stu-id="9078c-101">Entry point for route table management.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Routes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9078c-102">このルート テーブルのルートを取得します。</span><span class="sxs-lookup"><span data-stu-id="9078c-102">Gets the routes of this route table.</span></span>
            </summary>
