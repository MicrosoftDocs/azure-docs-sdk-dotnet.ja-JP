<Type Name="IHasCookieBasedAffinity" FullName="Microsoft.Azure.Management.Network.Fluent.IHasCookieBasedAffinity">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="aa406-101">アフィニティを cookie をサポートするモデルの機能を表すインターフェイスに基づいています。</span><span class="sxs-lookup"><span data-stu-id="aa406-101">An interface representing a model's ability to support cookie based affinity.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CookieBasedAffinity">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aa406-102">ネットワーク トラフィックに送信されるバックエンド ポート番号を取得します。</span><span class="sxs-lookup"><span data-stu-id="aa406-102">Gets the backend port number the network traffic is sent to.</span></span>
            </summary>
