<Type Name="IHasAssociatedSubnets" FullName="Microsoft.Azure.Management.Network.Fluent.IHasAssociatedSubnets">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="848ab-101">関連付けられているサブネットのリストを参照するモデルの機能を表すインターフェイスです。</span><span class="sxs-lookup"><span data-stu-id="848ab-101">An interface representing a model's ability to reference a list of associated subnets.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ListAssociatedSubnets">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="848ab-102">このリソースに関連付けられているサブネットの一覧です。</span><span class="sxs-lookup"><span data-stu-id="848ab-102">List of subnets associated with this resource.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>