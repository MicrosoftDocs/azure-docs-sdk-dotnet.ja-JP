<Type Name="FacetResults" FullName="Microsoft.Azure.Search.Models.FacetResults">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a3f35-101">ファセット化フィールド バケットのコレクションとして編成、ファセット クエリのすべての結果が含まれています。</span><span class="sxs-lookup"><span data-stu-id="a3f35-101">Contains all the results of a facet query, organized as a collection of buckets for each faceted field.</span></span>
            </summary>
