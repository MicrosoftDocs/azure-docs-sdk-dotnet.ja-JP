<Type Name="KeywordTokenizer" FullName="Microsoft.Azure.Search.Models.KeywordTokenizer">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="de8ca-101">1 つのトークンとして入力全体を出力します。</span><span class="sxs-lookup"><span data-stu-id="de8ca-101">Emits the entire input as a single token.</span></span> <span data-ttu-id="de8ca-102">このトークナイザは、Apache Lucene を使用して実装されます。</span><span class="sxs-lookup"><span data-stu-id="de8ca-102">This tokenizer is implemented using Apache Lucene.</span></span>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de8ca-103">KeywordTokenizer クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="de8ca-103">Initializes a new instance of the KeywordTokenizer class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="de8ca-104">KeywordTokenizer クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="de8ca-104">Initializes a new instance of the KeywordTokenizer class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BufferSize">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de8ca-105">取得または読み取りバッファーのサイズをバイト単位で設定します。</span><span class="sxs-lookup"><span data-stu-id="de8ca-105">Gets or sets the read buffer size in bytes.</span></span> <span data-ttu-id="de8ca-106">既定値は 256 です。</span><span class="sxs-lookup"><span data-stu-id="de8ca-106">Default is 256.</span></span>
            </summary>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de8ca-107">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="de8ca-107">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="de8ca-108">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="de8ca-108">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
