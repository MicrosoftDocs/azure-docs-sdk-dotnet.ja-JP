<Type Name="DocumentSuggestResult" FullName="Microsoft.Azure.Search.Models.DocumentSuggestResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="92d9d-101">提案クエリを含む応答は、Azure Search インデックスから結果します。</span><span class="sxs-lookup"><span data-stu-id="92d9d-101">Response containing suggestion query results from an Azure Search index.</span></span>
            </summary>
