<Type Name="EdgeNGramTokenFilterV2" FullName="Microsoft.Azure.Search.Models.EdgeNGramTokenFilterV2">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="79baf-101">N-gram の前面または入力トークンの背面から指定されたサイズが生成されます。</span><span class="sxs-lookup"><span data-stu-id="79baf-101">Generates n-grams of the given size(s) starting from the front or the back of an input token.</span></span> <span data-ttu-id="79baf-102">このトークンのフィルターは、Apache Lucene を使用して実装されます。</span><span class="sxs-lookup"><span data-stu-id="79baf-102">This token filter is implemented using Apache Lucene.</span></span>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="79baf-103">EdgeNGramTokenFilterV2 クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="79baf-103">Initializes a new instance of the EdgeNGramTokenFilterV2 class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="79baf-104">トークンのフィルターの名前。</span><span class="sxs-lookup"><span data-stu-id="79baf-104">The name of the token filter.</span></span> <span data-ttu-id="79baf-105">文字、数字、スペース、ダッシュまたはアンダー スコア、だけ開始されますが、および文字の英数字で終わるのみを含める必要があり、128 文字に制限されます。</span><span class="sxs-lookup"><span data-stu-id="79baf-105">It must only contain letters, digits, spaces, dashes or underscores, can only start and end with alphanumeric characters, and is limited to 128 characters.</span></span></param>
        <param name="minGram"><span data-ttu-id="79baf-106">最小 n グラム長。</span><span class="sxs-lookup"><span data-stu-id="79baf-106">The minimum n-gram length.</span></span> <span data-ttu-id="79baf-107">既定値は 1 です。</span><span class="sxs-lookup"><span data-stu-id="79baf-107">Default is 1.</span></span>
            <span data-ttu-id="79baf-108">最大値は、300 です。</span><span class="sxs-lookup"><span data-stu-id="79baf-108">Maximum is 300.</span></span> <span data-ttu-id="79baf-109">MaxGram の値よりも小さい必要があります。</span><span class="sxs-lookup"><span data-stu-id="79baf-109">Must be less than the value of maxGram.</span></span></param>
        <param name="maxGram"><span data-ttu-id="79baf-110">N グラムの最大長。</span><span class="sxs-lookup"><span data-stu-id="79baf-110">The maximum n-gram length.</span></span> <span data-ttu-id="79baf-111">既定値は 2 です。</span><span class="sxs-lookup"><span data-stu-id="79baf-111">Default is 2.</span></span>
            <span data-ttu-id="79baf-112">最大値は、300 です。</span><span class="sxs-lookup"><span data-stu-id="79baf-112">Maximum is 300.</span></span></param>
        <param name="side"><span data-ttu-id="79baf-113">入力のどちら側 n グラムはから生成するかを指定します。</span><span class="sxs-lookup"><span data-stu-id="79baf-113">Specifies which side of the input the n-gram should be generated from.</span></span> <span data-ttu-id="79baf-114">既定値は"front"です。</span><span class="sxs-lookup"><span data-stu-id="79baf-114">Default is "front".</span></span> <span data-ttu-id="79baf-115">使用可能な値が含まれます: 'フロント'、'back'</span><span class="sxs-lookup"><span data-stu-id="79baf-115">Possible values include: 'front', 'back'</span></span></param>
        <summary>
            <span data-ttu-id="79baf-116">EdgeNGramTokenFilterV2 クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="79baf-116">Initializes a new instance of the EdgeNGramTokenFilterV2 class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="MaxGram">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="79baf-117">取得または n グラムの最大の長さを設定します。</span><span class="sxs-lookup"><span data-stu-id="79baf-117">Gets or sets the maximum n-gram length.</span></span> <span data-ttu-id="79baf-118">既定値は 2 です。</span><span class="sxs-lookup"><span data-stu-id="79baf-118">Default is 2.</span></span> <span data-ttu-id="79baf-119">最大値は</span><span class="sxs-lookup"><span data-stu-id="79baf-119">Maximum is</span></span>
            300.
            </summary>
    ...
    <Member MemberName="MinGram">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="79baf-120">取得または n グラムの最小の長さを設定します。</span><span class="sxs-lookup"><span data-stu-id="79baf-120">Gets or sets the minimum n-gram length.</span></span> <span data-ttu-id="79baf-121">既定値は 1 です。</span><span class="sxs-lookup"><span data-stu-id="79baf-121">Default is 1.</span></span> <span data-ttu-id="79baf-122">最大値は</span><span class="sxs-lookup"><span data-stu-id="79baf-122">Maximum is</span></span>
            300. <span data-ttu-id="79baf-123">MaxGram の値よりも小さい必要があります。</span><span class="sxs-lookup"><span data-stu-id="79baf-123">Must be less than the value of maxGram.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Side">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="79baf-124">取得または設定は、入力のどちら側 n グラムはから生成するかを指定します。</span><span class="sxs-lookup"><span data-stu-id="79baf-124">Gets or sets specifies which side of the input the n-gram should be generated from.</span></span> <span data-ttu-id="79baf-125">既定値は"front"です。</span><span class="sxs-lookup"><span data-stu-id="79baf-125">Default is "front".</span></span> <span data-ttu-id="79baf-126">使用可能な値が含まれます: 'フロント'、'back'</span><span class="sxs-lookup"><span data-stu-id="79baf-126">Possible values include: 'front', 'back'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="79baf-127">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="79baf-127">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="79baf-128">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="79baf-128">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
