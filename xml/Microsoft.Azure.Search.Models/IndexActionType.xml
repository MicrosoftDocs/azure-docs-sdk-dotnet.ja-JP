<Type Name="IndexActionType" FullName="Microsoft.Azure.Search.Models.IndexActionType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="afc3f-101">IndexActionType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="afc3f-101">Defines values for IndexActionType.</span></span>
            </summary>
