<Type Name="DocumentSuggestResult&lt;T&gt;" FullName="Microsoft.Azure.Search.Models.DocumentSuggestResult&lt;T&gt;">
  ...
  <Docs>
    <typeparam name="T">
            <span data-ttu-id="707d2-101">インデックス スキーマにマップされる CLR 型。</span><span class="sxs-lookup"><span data-stu-id="707d2-101">The CLR type that maps to the index schema.</span></span> <span data-ttu-id="707d2-102">この型のインスタンスは、インデックスからドキュメントとして取得できます。</span><span class="sxs-lookup"><span data-stu-id="707d2-102">Instances of this type can be retrieved as documents from the index.</span></span>
            </typeparam>
    <summary>
            <span data-ttu-id="707d2-103">提案クエリを含む応答は、Azure Search インデックスから結果します。</span><span class="sxs-lookup"><span data-stu-id="707d2-103">Response containing suggestion query results from an Azure Search index.</span></span>
            </summary>
