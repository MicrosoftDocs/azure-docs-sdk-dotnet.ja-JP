<Type Name="IWithHostName&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasHostName.Update.IWithHostName&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="8fdf0-101">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="8fdf0-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="8fdf0-102">ホスト名を指定できるようにする更新プログラムの段階です。</span><span class="sxs-lookup"><span data-stu-id="8fdf0-102">The stage of an update allowing to specify a host name.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithHostName">
      ...
      <Docs>
        <param name="hostName"><span data-ttu-id="8fdf0-103">既存のホスト名です。</span><span class="sxs-lookup"><span data-stu-id="8fdf0-103">An existing host name.</span></span></param>
        <summary>
            <span data-ttu-id="8fdf0-104">ホスト名を指定します。</span><span class="sxs-lookup"><span data-stu-id="8fdf0-104">Specifies the host name.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="8fdf0-105">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="8fdf0-105">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>