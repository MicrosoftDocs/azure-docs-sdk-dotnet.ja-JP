<Type Name="IWithLoadDistribution&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.UpdateDefinition.IWithLoadDistribution&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="64923-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="64923-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="64923-102">負荷分散できるように、負荷配分を指定するルールの定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="64923-102">The stage of a load balancing rule definition allowing to specify the load distribution.</span></span>
            </summary>
