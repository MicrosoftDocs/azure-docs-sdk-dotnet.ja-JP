<Type Name="IWithDefaultMessageTTL" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Queue.Update.IWithDefaultMessageTTL">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="67c4c-101">メッセージの TTL の既定値を定義できるように、キューの定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="67c4c-101">The stage of the queue definition allowing to define default TTL for messages.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithDefaultMessageTTL">
      ...
      <Docs>
        <param name="ttl"><span data-ttu-id="67c4c-102">ライブの期間を時間です。</span><span class="sxs-lookup"><span data-stu-id="67c4c-102">Time to live duration.</span></span></param>
        <summary>
            <span data-ttu-id="67c4c-103">メッセージが切れるまでの期間を指定します。</span><span class="sxs-lookup"><span data-stu-id="67c4c-103">Specifies the duration after which the message expires.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="67c4c-104">キュー更新の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="67c4c-104">The next stage of queue update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>