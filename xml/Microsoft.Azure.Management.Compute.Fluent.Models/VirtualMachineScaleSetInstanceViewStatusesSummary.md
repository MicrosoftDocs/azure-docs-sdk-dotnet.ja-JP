<Type Name="VirtualMachineScaleSetInstanceViewStatusesSummary" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineScaleSetInstanceViewStatusesSummary">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d9144-101">仮想マシンのスケールの仮想マシンの概要をインスタンス ビューの状態を設定します。</span><span class="sxs-lookup"><span data-stu-id="d9144-101">Instance view statuses summary for virtual machines of a virtual machine scale set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d9144-102">VirtualMachineScaleSetInstanceViewStatusesSummary クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="d9144-102">Initializes a new instance of the VirtualMachineScaleSetInstanceViewStatusesSummary class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="statusesSummary"><span data-ttu-id="d9144-103">拡張機能の情報です。</span><span class="sxs-lookup"><span data-stu-id="d9144-103">The extensions information.</span></span></param>
        <summary>
            <span data-ttu-id="d9144-104">VirtualMachineScaleSetInstanceViewStatusesSummary クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="d9144-104">Initializes a new instance of the VirtualMachineScaleSetInstanceViewStatusesSummary class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="StatusesSummary">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d9144-105">拡張機能の情報を取得します。</span><span class="sxs-lookup"><span data-stu-id="d9144-105">Gets the extensions information.</span></span>
            </summary>
