<Type Name="Sku" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.Sku">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2f2ff-101">仮想マシン スケール セットの sku をについて説明します。</span><span class="sxs-lookup"><span data-stu-id="2f2ff-101">Describes a virtual machine scale set sku.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2f2ff-102">Sku クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="2f2ff-102">Initializes a new instance of the Sku class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="2f2ff-103">Sku の名前です。</span><span class="sxs-lookup"><span data-stu-id="2f2ff-103">The sku name.</span></span></param>
        <param name="tier"><span data-ttu-id="2f2ff-104">Sku の層。</span><span class="sxs-lookup"><span data-stu-id="2f2ff-104">The sku tier.</span></span></param>
        <param name="capacity"><span data-ttu-id="2f2ff-105">Sku 容量。</span><span class="sxs-lookup"><span data-stu-id="2f2ff-105">The sku capacity.</span></span></param>
        <summary>
            <span data-ttu-id="2f2ff-106">Sku クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="2f2ff-106">Initializes a new instance of the Sku class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2f2ff-107">取得または sku 容量を設定します。</span><span class="sxs-lookup"><span data-stu-id="2f2ff-107">Gets or sets the sku capacity.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2f2ff-108">取得または sku の名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="2f2ff-108">Gets or sets the sku name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2f2ff-109">取得または sku の層を設定します。</span><span class="sxs-lookup"><span data-stu-id="2f2ff-109">Gets or sets the sku tier.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
