<Type Name="ImageDataDisk" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.ImageDataDisk">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="08979-101">データ ディスクをについて説明します。</span><span class="sxs-lookup"><span data-stu-id="08979-101">Describes a data disk.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="08979-102">ImageDataDisk クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="08979-102">Initializes a new instance of the ImageDataDisk class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="BlobUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="08979-103">取得またはバーチャル ハード_ディスクを設定します。</span><span class="sxs-lookup"><span data-stu-id="08979-103">Gets or sets the Virtual Hard Disk.</span></span>
            </summary>
    ...
    <Member MemberName="Caching">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="08979-104">取得またはキャッシュの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="08979-104">Gets or sets the caching type.</span></span> <span data-ttu-id="08979-105">使用可能な値が含まれます 'None'、'ReadOnly'、'ReadWrite'。</span><span class="sxs-lookup"><span data-stu-id="08979-105">Possible values include: 'None', 'ReadOnly', 'ReadWrite'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DiskSizeGB">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="08979-106">取得または空のデータ ディスクの場合は、GB、初期のディスク サイズと既存の OS とデータ ディスクの新しいサイズを設定します。</span><span class="sxs-lookup"><span data-stu-id="08979-106">Gets or sets the initial disk size in GB for blank data disks, and the new desired size for existing OS and Data disks.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Lun">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="08979-107">取得または論理ユニット番号を設定します。</span><span class="sxs-lookup"><span data-stu-id="08979-107">Gets or sets the logical unit number.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ManagedDisk">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="08979-108">取得または、managedDisk を設定します。</span><span class="sxs-lookup"><span data-stu-id="08979-108">Gets or sets the managedDisk.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Snapshot">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="08979-109">取得またはスナップショットを設定します。</span><span class="sxs-lookup"><span data-stu-id="08979-109">Gets or sets the snapshot.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="08979-110">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="08979-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="08979-111">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="08979-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
