<Type Name="VirtualMachineScaleSetNetworkProfile" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineScaleSetNetworkProfile">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="331b0-101">仮想マシン スケール セットのネットワーク プロファイルを説明します。</span><span class="sxs-lookup"><span data-stu-id="331b0-101">Describes a virtual machine scale set network profile.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="331b0-102">VirtualMachineScaleSetNetworkProfile クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="331b0-102">Initializes a new instance of the VirtualMachineScaleSetNetworkProfile class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="networkInterfaceConfigurations"><span data-ttu-id="331b0-103">ネットワークの構成の一覧。</span><span class="sxs-lookup"><span data-stu-id="331b0-103">The list of network configurations.</span></span></param>
        <summary>
            <span data-ttu-id="331b0-104">VirtualMachineScaleSetNetworkProfile クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="331b0-104">Initializes a new instance of the VirtualMachineScaleSetNetworkProfile class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NetworkInterfaceConfigurations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="331b0-105">取得またはネットワーク構成の一覧を設定します。</span><span class="sxs-lookup"><span data-stu-id="331b0-105">Gets or sets the list of network configurations.</span></span>
            </summary>
