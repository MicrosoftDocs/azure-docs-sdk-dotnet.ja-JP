<Type Name="VirtualMachineExtensionInner" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineExtensionInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="55a18-101">仮想マシンの拡張機能をについて説明します。</span><span class="sxs-lookup"><span data-stu-id="55a18-101">Describes a Virtual Machine Extension.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="55a18-102">VirtualMachineExtensionInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="55a18-102">Initializes a new instance of the VirtualMachineExtensionInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="forceUpdateTag"><span data-ttu-id="55a18-103">方法、拡張機能ハンドラーは、拡張機能の構成が変更されていない場合でも更新を適用する必要があります。</span><span class="sxs-lookup"><span data-stu-id="55a18-103">How the extension handler should be forced to update even if the extension configuration has not changed.</span></span></param>
        <param name="publisher"><span data-ttu-id="55a18-104">拡張機能ハンドラーのパブリッシャーの名前。</span><span class="sxs-lookup"><span data-stu-id="55a18-104">The name of the extension handler publisher.</span></span></param>
        <param name="virtualMachineExtensionType"><span data-ttu-id="55a18-105">拡張機能ハンドラーの型。</span><span class="sxs-lookup"><span data-stu-id="55a18-105">The type of the extension handler.</span></span></param>
        <param name="typeHandlerVersion"><span data-ttu-id="55a18-106">拡張機能ハンドラーのタイプのバージョン。</span><span class="sxs-lookup"><span data-stu-id="55a18-106">The type version of the extension handler.</span></span></param>
        <param name="autoUpgradeMinorVersion"><span data-ttu-id="55a18-107">かどうかのマイナー バージョン間で、拡張機能ハンドラーを自動的にアップグレードする必要があります。</span><span class="sxs-lookup"><span data-stu-id="55a18-107">Whether the extension handler should be automatically upgraded across minor versions.</span></span></param>
        <param name="settings"><span data-ttu-id="55a18-108">Json 形式の拡張機能のパブリックに設定します。</span><span class="sxs-lookup"><span data-stu-id="55a18-108">Json formatted public settings for the extension.</span></span></param>
        <param name="protectedSettings"><span data-ttu-id="55a18-109">Json 形式の拡張機能の設定を保護します。</span><span class="sxs-lookup"><span data-stu-id="55a18-109">Json formatted protected settings for the extension.</span></span></param>
        <param name="provisioningState"><span data-ttu-id="55a18-110">プロビジョニングの状態、応答でのみ表示されます。</span><span class="sxs-lookup"><span data-stu-id="55a18-110">The provisioning state, which only appears in the response.</span></span></param>
        <param name="instanceView"><span data-ttu-id="55a18-111">仮想マシン拡張機能のインスタンス ビュー。</span><span class="sxs-lookup"><span data-stu-id="55a18-111">The virtual machine extension instance view.</span></span></param>
        <summary>
            <span data-ttu-id="55a18-112">VirtualMachineExtensionInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="55a18-112">Initializes a new instance of the VirtualMachineExtensionInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AutoUpgradeMinorVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="55a18-113">取得またはマイナー バージョン間で、拡張機能ハンドラーを自動的にアップグレードする必要があるかどうかを設定します。</span><span class="sxs-lookup"><span data-stu-id="55a18-113">Gets or sets whether the extension handler should be automatically upgraded across minor versions.</span></span>
            </summary>
    ...
    <Member MemberName="ForceUpdateTag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="55a18-114">取得または設定方法、拡張機能ハンドラーを拡張機能の構成が変更されていない場合でも更新を適用する必要があります。</span><span class="sxs-lookup"><span data-stu-id="55a18-114">Gets or sets how the extension handler should be forced to update even if the extension configuration has not changed.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="InstanceView">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="55a18-115">取得または仮想マシン拡張機能のインスタンス ビューを設定します。</span><span class="sxs-lookup"><span data-stu-id="55a18-115">Gets or sets the virtual machine extension instance view.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProtectedSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="55a18-116">取得または json 形式を設定、拡張機能の設定を保護します。</span><span class="sxs-lookup"><span data-stu-id="55a18-116">Gets or sets json formatted protected settings for the extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="55a18-117">応答でのみ表示されます、プロビジョニングの状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="55a18-117">Gets the provisioning state, which only appears in the response.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Publisher">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="55a18-118">取得または拡張機能ハンドラーのパブリッシャーの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="55a18-118">Gets or sets the name of the extension handler publisher.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Settings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="55a18-119">取得または拡張機能の json 形式の公開設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="55a18-119">Gets or sets json formatted public settings for the extension.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TypeHandlerVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="55a18-120">取得または拡張機能ハンドラーの種類のバージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="55a18-120">Gets or sets the type version of the extension handler.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualMachineExtensionType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="55a18-121">取得または拡張機能ハンドラーの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="55a18-121">Gets or sets the type of the extension handler.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
