<Type Name="VirtualMachineScaleSetSku" FullName="Microsoft.Azure.Management.Compute.Fluent.Models.VirtualMachineScaleSetSku">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a77c5-101">使用可能な仮想マシン スケール セット sku をについて説明します。</span><span class="sxs-lookup"><span data-stu-id="a77c5-101">Describes an available virtual machine scale set sku.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a77c5-102">VirtualMachineScaleSetSku クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="a77c5-102">Initializes a new instance of the VirtualMachineScaleSetSku class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resourceType"><span data-ttu-id="a77c5-103">Sku のリソースの種類に適用されます。</span><span class="sxs-lookup"><span data-stu-id="a77c5-103">The type of resource the sku applies to.</span></span></param>
        <param name="sku"><span data-ttu-id="a77c5-104">Sku。</span><span class="sxs-lookup"><span data-stu-id="a77c5-104">The Sku.</span></span></param>
        <param name="capacity"><span data-ttu-id="a77c5-105">拡大縮小に関する情報を使用できます。</span><span class="sxs-lookup"><span data-stu-id="a77c5-105">Available scaling information.</span></span></param>
        <summary>
            <span data-ttu-id="a77c5-106">VirtualMachineScaleSetSku クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="a77c5-106">Initializes a new instance of the VirtualMachineScaleSetSku class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a77c5-107">使用可能な拡大縮小に関する情報を取得します。</span><span class="sxs-lookup"><span data-stu-id="a77c5-107">Gets available scaling information.</span></span>
            </summary>
    ...
    <Member MemberName="ResourceType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a77c5-108">Sku の対象リソースの種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="a77c5-108">Gets the type of resource the sku applies to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a77c5-109">Sku を取得します。</span><span class="sxs-lookup"><span data-stu-id="a77c5-109">Gets the Sku.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
