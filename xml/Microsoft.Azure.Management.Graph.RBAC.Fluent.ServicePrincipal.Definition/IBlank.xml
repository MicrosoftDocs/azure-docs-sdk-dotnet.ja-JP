<Type Name="IBlank" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.ServicePrincipal.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="07457-101">サービス プリンシパルの定義の最初の段階です。</span><span class="sxs-lookup"><span data-stu-id="07457-101">The first stage of the service principal definition.</span></span>
            </summary>
