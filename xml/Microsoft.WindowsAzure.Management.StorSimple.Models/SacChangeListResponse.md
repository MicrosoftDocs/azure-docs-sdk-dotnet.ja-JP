<Type Name="SacChangeListResponse" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.SacChangeListResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="99590-101">デバイスに関する素晴らしい情報</span><span class="sxs-lookup"><span data-stu-id="99590-101">Awesome Info about Device</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99590-102">SacChangeListResponse クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="99590-102">Initializes a new instance of the SacChangeListResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Added">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99590-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="99590-103">Optional.</span></span> <span data-ttu-id="99590-104">追加のストレージ アカウントの資格情報の一覧</span><span class="sxs-lookup"><span data-stu-id="99590-104">List of storage account credentials to add</span></span>
            </summary>
    ...
    <Member MemberName="Deleted">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99590-105">省略可能。</span><span class="sxs-lookup"><span data-stu-id="99590-105">Optional.</span></span> <span data-ttu-id="99590-106">削除されたストレージ アカウントの資格情報</span><span class="sxs-lookup"><span data-stu-id="99590-106">Deleted storage account credentials</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99590-107">追加のシーケンスを取得します。</span><span class="sxs-lookup"><span data-stu-id="99590-107">Gets the sequence of Added.</span></span>
            </summary>
    ...
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99590-108">追加のシーケンスを取得します。</span><span class="sxs-lookup"><span data-stu-id="99590-108">Gets the sequence of Added.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Updated">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99590-109">省略可能。</span><span class="sxs-lookup"><span data-stu-id="99590-109">Optional.</span></span> <span data-ttu-id="99590-110">更新するストレージ アカウントの資格情報の一覧</span><span class="sxs-lookup"><span data-stu-id="99590-110">List of storage account credentials to update</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
