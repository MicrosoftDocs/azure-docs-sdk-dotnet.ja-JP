<Type Name="VirtualDisk" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.VirtualDisk">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="884f0-101">仮想ディスクに関する情報</span><span class="sxs-lookup"><span data-stu-id="884f0-101">Info about the virtual disk</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-102">VirtualDisk クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="884f0-102">Initializes a new instance of the VirtualDisk class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AccessType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-103">必須。</span><span class="sxs-lookup"><span data-stu-id="884f0-103">Required.</span></span> <span data-ttu-id="884f0-104">AccessType</span><span class="sxs-lookup"><span data-stu-id="884f0-104">AccessType</span></span>
            </summary>
    ...
    <Member MemberName="AcrIdList">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-105">省略可能。</span><span class="sxs-lookup"><span data-stu-id="884f0-105">Optional.</span></span> <span data-ttu-id="884f0-106">参照先の ACR Id の一覧</span><span class="sxs-lookup"><span data-stu-id="884f0-106">List of referenced ACR Ids</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AcrList">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-107">必須。</span><span class="sxs-lookup"><span data-stu-id="884f0-107">Required.</span></span> <span data-ttu-id="884f0-108">アクセス制御レコードの一覧</span><span class="sxs-lookup"><span data-stu-id="884f0-108">List of access control record</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AppType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-109">必須。</span><span class="sxs-lookup"><span data-stu-id="884f0-109">Required.</span></span> <span data-ttu-id="884f0-110">プライマリまたはアーカイブ済みのボリューム。</span><span class="sxs-lookup"><span data-stu-id="884f0-110">Primary or Archived volume.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DataContainer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-111">必須。</span><span class="sxs-lookup"><span data-stu-id="884f0-111">Required.</span></span> <span data-ttu-id="884f0-112">対応するデータ コンテナー</span><span class="sxs-lookup"><span data-stu-id="884f0-112">Corresponding Data Container</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DataContainerId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-113">省略可能。</span><span class="sxs-lookup"><span data-stu-id="884f0-113">Optional.</span></span> <span data-ttu-id="884f0-114">ディスクのデータ コンテナーの Id</span><span class="sxs-lookup"><span data-stu-id="884f0-114">Data Container Id for the disk</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="InstanceId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-115">省略可能。</span><span class="sxs-lookup"><span data-stu-id="884f0-115">Optional.</span></span> <span data-ttu-id="884f0-116">インスタンス識別子</span><span class="sxs-lookup"><span data-stu-id="884f0-116">The instance identifier</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="InternalInstanceId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-117">省略可能。</span><span class="sxs-lookup"><span data-stu-id="884f0-117">Optional.</span></span> <span data-ttu-id="884f0-118">仮想ディスクの内部のインスタンス Id</span><span class="sxs-lookup"><span data-stu-id="884f0-118">Internal Instance Id for the virtual disk</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsBackupEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-119">省略可能。</span><span class="sxs-lookup"><span data-stu-id="884f0-119">Optional.</span></span> <span data-ttu-id="884f0-120">True の場合は、この仮想ディスクは、バックアップ ポリシーの一部</span><span class="sxs-lookup"><span data-stu-id="884f0-120">True if this virtual disk is part of any backup policy</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsDefaultBackupEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-121">必須。</span><span class="sxs-lookup"><span data-stu-id="884f0-121">Required.</span></span> <span data-ttu-id="884f0-122">既定のバックアップが有効になっている場合は true。</span><span class="sxs-lookup"><span data-stu-id="884f0-122">True if default backup is enabled</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsMonitoringEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-123">省略可能。</span><span class="sxs-lookup"><span data-stu-id="884f0-123">Optional.</span></span> <span data-ttu-id="884f0-124">仮想ディスクの監視が有効になっている場合は true。</span><span class="sxs-lookup"><span data-stu-id="884f0-124">True if monitoring is enabled for the virtual disk</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-125">必須。</span><span class="sxs-lookup"><span data-stu-id="884f0-125">Required.</span></span> <span data-ttu-id="884f0-126">エンティティの名前</span><span class="sxs-lookup"><span data-stu-id="884f0-126">The name of the entity</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Online">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-127">必須。</span><span class="sxs-lookup"><span data-stu-id="884f0-127">Required.</span></span> <span data-ttu-id="884f0-128">仮想ディスクがオンラインの場合は true。</span><span class="sxs-lookup"><span data-stu-id="884f0-128">True if the virtual disk is online</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationInProgress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-129">省略可能。</span><span class="sxs-lookup"><span data-stu-id="884f0-129">Optional.</span></span> <span data-ttu-id="884f0-130">実行中を操作します。</span><span class="sxs-lookup"><span data-stu-id="884f0-130">Is operation in progress</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SizeInBytes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-131">必須。</span><span class="sxs-lookup"><span data-stu-id="884f0-131">Required.</span></span> <span data-ttu-id="884f0-132">仮想ディスクのサイズ</span><span class="sxs-lookup"><span data-stu-id="884f0-132">Size of Virtual Disk</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VSN">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="884f0-133">省略可能。</span><span class="sxs-lookup"><span data-stu-id="884f0-133">Optional.</span></span> <span data-ttu-id="884f0-134">仮想ディスクの仮想のシリアル番号</span><span class="sxs-lookup"><span data-stu-id="884f0-134">Virtual Serial Number of the virtual disk</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
