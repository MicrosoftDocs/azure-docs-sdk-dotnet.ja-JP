<Type Name="MigrationPlanStatus" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.MigrationPlanStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1b03d-101">移行計画のステータス</span><span class="sxs-lookup"><span data-stu-id="1b03d-101">Status of the migration plan</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Completed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1b03d-102">状態は、移行計画の見積もりが完了したことを示します</span><span class="sxs-lookup"><span data-stu-id="1b03d-102">Status indicates the estimation of migration plan has completed</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Failed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1b03d-103">状態は、移行計画の推定が失敗したことを示します</span><span class="sxs-lookup"><span data-stu-id="1b03d-103">Status indicates the estimation of migration plan has failed</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="InProgress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1b03d-104">移行計画の推定が進行中で状態を示します</span><span class="sxs-lookup"><span data-stu-id="1b03d-104">Status indicates the estimation of migration plan is in progress</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Invalid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1b03d-105">状態が無効です。</span><span class="sxs-lookup"><span data-stu-id="1b03d-105">Status is Invalid</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="NotStarted">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1b03d-106">状態は、移行計画の推定値がまだ開始されていないことを示します</span><span class="sxs-lookup"><span data-stu-id="1b03d-106">Status indicates the estimation of migration plan has not yet started</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
