<Type Name="VirtualDiskGroup" FullName="Microsoft.WindowsAzure.Management.StorSimple.Models.VirtualDiskGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cc93c-101">このクラスは、仮想ディスク グループ (ボリューム グループ) を表します。</span><span class="sxs-lookup"><span data-stu-id="cc93c-101">This class represents virtual disk group (volume group).</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cc93c-102">VirtualDiskGroup クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="cc93c-102">Initializes a new instance of the VirtualDiskGroup class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="cc93c-103">必須の引数で VirtualDiskGroup クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="cc93c-103">Initializes a new instance of the VirtualDiskGroup class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="InstanceId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cc93c-104">省略可能。</span><span class="sxs-lookup"><span data-stu-id="cc93c-104">Optional.</span></span> <span data-ttu-id="cc93c-105">取得または設定、ボリューム グループのインスタンス id</span><span class="sxs-lookup"><span data-stu-id="cc93c-105">Gets or sets the instance id of the volume group</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cc93c-106">必須。</span><span class="sxs-lookup"><span data-stu-id="cc93c-106">Required.</span></span> <span data-ttu-id="cc93c-107">取得またはボリューム グループの名前を設定</span><span class="sxs-lookup"><span data-stu-id="cc93c-107">Gets or sets the name of the volume group</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OperationInProgress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cc93c-108">省略可能。</span><span class="sxs-lookup"><span data-stu-id="cc93c-108">Optional.</span></span> <span data-ttu-id="cc93c-109">取得または任意の操作が進行中かどうかを示す値を設定</span><span class="sxs-lookup"><span data-stu-id="cc93c-109">Gets or sets a value indicating whether any operation is in progress or not</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualDiskList">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="cc93c-110">必須。</span><span class="sxs-lookup"><span data-stu-id="cc93c-110">Required.</span></span> <span data-ttu-id="cc93c-111">取得またはボリューム グループに関連付けられているボリュームの一覧を設定します。</span><span class="sxs-lookup"><span data-stu-id="cc93c-111">Gets or sets list of volumes associated with the volume group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
