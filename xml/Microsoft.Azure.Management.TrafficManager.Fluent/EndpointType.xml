<Type Name="EndpointType" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.EndpointType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3fbe3-101">可能なエンドポイントの種類が Traffic manager プロファイルではサポートされています。</span><span class="sxs-lookup"><span data-stu-id="3fbe3-101">Possible endpoint types supported in a Traffic manager profile.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="LocalName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3fbe3-102">エンドポイントの種類のローカル名を取得します。</span><span class="sxs-lookup"><span data-stu-id="3fbe3-102">Gets the local name of the endpoint type.</span></span>
            </summary>
