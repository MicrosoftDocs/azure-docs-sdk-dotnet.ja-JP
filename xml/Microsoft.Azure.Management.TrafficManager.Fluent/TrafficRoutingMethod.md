<Type Name="TrafficRoutingMethod" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficRoutingMethod">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d55b2-101">Traffic manager プロファイルでサポートされる可能なルーティング メソッドです。</span><span class="sxs-lookup"><span data-stu-id="d55b2-101">Possible routing methods supported by Traffic manager profile.</span></span>
            </summary>
