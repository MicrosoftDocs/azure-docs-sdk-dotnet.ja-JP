<Type Name="OperationsExtensions" FullName="Microsoft.Azure.Management.Storage.OperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4c526-101">操作の拡張メソッド。</span><span class="sxs-lookup"><span data-stu-id="4c526-101">Extension methods for Operations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="List">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="4c526-102">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="4c526-102">The operations group for this extension method.</span></span>
            </param>
        <summary>
            <span data-ttu-id="4c526-103">すべての利用可能な記憶域の Rest API 操作の一覧を表示します。</span><span class="sxs-lookup"><span data-stu-id="4c526-103">Lists all of the available Storage Rest API operations.</span></span>
            </summary>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="4c526-104">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="4c526-104">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="4c526-105">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="4c526-105">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="4c526-106">すべての利用可能な記憶域の Rest API 操作の一覧を表示します。</span><span class="sxs-lookup"><span data-stu-id="4c526-106">Lists all of the available Storage Rest API operations.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
