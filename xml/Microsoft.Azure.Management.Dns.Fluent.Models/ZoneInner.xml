<Type Name="ZoneInner" FullName="Microsoft.Azure.Management.Dns.Fluent.Models.ZoneInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="66f4b-101">DNS ゾーンをについて説明します。</span><span class="sxs-lookup"><span data-stu-id="66f4b-101">Describes a DNS zone.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="66f4b-102">ZoneInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="66f4b-102">Initializes a new instance of the ZoneInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="etag"><span data-ttu-id="66f4b-103">ゾーンの etag です。</span><span class="sxs-lookup"><span data-stu-id="66f4b-103">The etag of the zone.</span></span></param>
        <param name="maxNumberOfRecordSets"><span data-ttu-id="66f4b-104">この DNS ゾーンに作成できるレコードのセットの最大数。</span><span class="sxs-lookup"><span data-stu-id="66f4b-104">The maximum number of record sets that can be created in this DNS zone.</span></span>  <span data-ttu-id="66f4b-105">これは読み取り専用プロパティであり、この値を設定しようとするとは無視されます。</span><span class="sxs-lookup"><span data-stu-id="66f4b-105">This is a read-only property and any attempt to set this value will be ignored.</span></span></param>
        <param name="numberOfRecordSets"><span data-ttu-id="66f4b-106">現在のレコードの数は、この DNS ゾーンに設定します。</span><span class="sxs-lookup"><span data-stu-id="66f4b-106">The current number of record sets in this DNS zone.</span></span>  <span data-ttu-id="66f4b-107">これは読み取り専用プロパティであり、この値を設定しようとするとは無視されます。</span><span class="sxs-lookup"><span data-stu-id="66f4b-107">This is a read-only property and any attempt to set this value will be ignored.</span></span></param>
        <param name="nameServers"><span data-ttu-id="66f4b-108">この DNS ゾーンのネーム サーバー。</span><span class="sxs-lookup"><span data-stu-id="66f4b-108">The name servers for this DNS zone.</span></span> <span data-ttu-id="66f4b-109">これは読み取り専用プロパティであり、この値を設定しようとするとは無視されます。</span><span class="sxs-lookup"><span data-stu-id="66f4b-109">This is a read-only property and any attempt to set this value will be ignored.</span></span></param>
        <summary>
            <span data-ttu-id="66f4b-110">ZoneInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="66f4b-110">Initializes a new instance of the ZoneInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="66f4b-111">取得またはゾーンの etag を設定します。</span><span class="sxs-lookup"><span data-stu-id="66f4b-111">Gets or sets the etag of the zone.</span></span>
            </summary>
    ...
    <Member MemberName="MaxNumberOfRecordSets">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="66f4b-112">取得またはこの DNS ゾーンに作成できるレコードのセットの最大数を設定します。</span><span class="sxs-lookup"><span data-stu-id="66f4b-112">Gets or sets the maximum number of record sets that can be created in this DNS zone.</span></span>  <span data-ttu-id="66f4b-113">これは読み取り専用プロパティであり、この値を設定しようとするとは無視されます。</span><span class="sxs-lookup"><span data-stu-id="66f4b-113">This is a read-only property and any attempt to set this value will be ignored.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NameServers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="66f4b-114">この DNS ゾーンのネーム サーバーを取得します。</span><span class="sxs-lookup"><span data-stu-id="66f4b-114">Gets the name servers for this DNS zone.</span></span> <span data-ttu-id="66f4b-115">これは読み取り専用プロパティであり、この値を設定しようとするとは無視されます。</span><span class="sxs-lookup"><span data-stu-id="66f4b-115">This is a read-only property and any attempt to set this value will be ignored.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NumberOfRecordSets">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="66f4b-116">取得またはこの DNS ゾーンにレコード セットの現在の数を設定します。</span><span class="sxs-lookup"><span data-stu-id="66f4b-116">Gets or sets the current number of record sets in this DNS zone.</span></span>
            <span data-ttu-id="66f4b-117">これは読み取り専用プロパティであり、この値を設定しようとするとは無視されます。</span><span class="sxs-lookup"><span data-stu-id="66f4b-117">This is a read-only property and any attempt to set this value will be ignored.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
