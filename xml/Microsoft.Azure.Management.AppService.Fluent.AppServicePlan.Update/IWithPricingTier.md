<Type Name="IWithPricingTier" FullName="Microsoft.Azure.Management.AppService.Fluent.AppServicePlan.Update.IWithPricingTier">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="595a2-101">価格レベルを設定するを許可するアプリ サービスの計画定義します。</span><span class="sxs-lookup"><span data-stu-id="595a2-101">An app service plan definition allowing pricing tier to be set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithPricingTier">
      ...
      <Docs>
        <param name="pricingTier"><span data-ttu-id="595a2-102">価格レベル列挙型。</span><span class="sxs-lookup"><span data-stu-id="595a2-102">The pricing tier enum.</span></span></param>
        <summary>
            <span data-ttu-id="595a2-103">App service プランの価格レベルを指定します。</span><span class="sxs-lookup"><span data-stu-id="595a2-103">Specifies the pricing tier for the app service plan.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="595a2-104">App service プランの次のステージを更新します。</span><span class="sxs-lookup"><span data-stu-id="595a2-104">The next stage of the app service plan update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>