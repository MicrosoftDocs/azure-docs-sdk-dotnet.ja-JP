<Type Name="AzureCredentials" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Authentication.AzureCredentials">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="eff66-101">Azure に fluent 管理クライアントを認証するための資格情報。</span><span class="sxs-lookup"><span data-stu-id="eff66-101">Credentials used for authenticating a fluent management client to Azure.</span></span>
            </summary>
