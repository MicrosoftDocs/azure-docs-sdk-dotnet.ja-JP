<Type Name="ExternalChildResourcesNonCached&lt;FluentModelTImpl,IFluentModelT,InnerModelT,IParentT,ParentImplT&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.ExternalChildResourcesNonCached&lt;FluentModelTImpl,IFluentModelT,InnerModelT,IParentT,ParentImplT&gt;">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="parent"><span data-ttu-id="1f7ec-101">親の Azure リソース</span><span class="sxs-lookup"><span data-stu-id="1f7ec-101">the parent Azure resource</span></span></param>
        <param name="childResourceName"><span data-ttu-id="1f7ec-102">子リソース名</span><span class="sxs-lookup"><span data-stu-id="1f7ec-102">the child resource name</span></span></param>
        <summary>
            <span data-ttu-id="1f7ec-103">新しい ExternalChildResourcesNonCached を作成します。</span><span class="sxs-lookup"><span data-stu-id="1f7ec-103">Creates a new ExternalChildResourcesNonCached.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="PrepareDefine">
      ...
      <Docs>
        <param name="model"><span data-ttu-id="1f7ec-104">追跡するために、モデルの変更を作成します。</span><span class="sxs-lookup"><span data-stu-id="1f7ec-104">the model to track create changes</span></span></param>
        <summary>
            <span data-ttu-id="1f7ec-105">作成するには、外部の子リソースの特定のモデルを準備します。</span><span class="sxs-lookup"><span data-stu-id="1f7ec-105">Prepare a given model of an external child resource for create.</span></span>
            </summary>
        <returns><span data-ttu-id="1f7ec-106">準備ができている外部の子リソースを作成します。</span><span class="sxs-lookup"><span data-stu-id="1f7ec-106">the external child resource prepared for create</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrepareRemove">
      ...
      <Docs>
        <param name="model"><span data-ttu-id="1f7ec-107">削除する子リソースを表すモデル</span><span class="sxs-lookup"><span data-stu-id="1f7ec-107">the model representing child resource to remove</span></span></param>
        <summary>
            <span data-ttu-id="1f7ec-108">削除するには、外部の子リソースの特定のモデルを準備します。</span><span class="sxs-lookup"><span data-stu-id="1f7ec-108">Prepare a given model of an external child resource for remove.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrepareUpdate">
      ...
      <Docs>
        <param name="model"><span data-ttu-id="1f7ec-109">更新プログラムの変更を追跡するためにモデル</span><span class="sxs-lookup"><span data-stu-id="1f7ec-109">the model to track update changes</span></span></param>
        <summary>
            <span data-ttu-id="1f7ec-110">更新プログラムを特定のモデルの外部の子リソースを準備します。</span><span class="sxs-lookup"><span data-stu-id="1f7ec-110">Prepare a given model of an external child resource for update.</span></span>
            </summary>
        <returns><span data-ttu-id="1f7ec-111">更新プログラムの準備ができている子の外部リソース</span><span class="sxs-lookup"><span data-stu-id="1f7ec-111">the external child resource prepared for update</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
