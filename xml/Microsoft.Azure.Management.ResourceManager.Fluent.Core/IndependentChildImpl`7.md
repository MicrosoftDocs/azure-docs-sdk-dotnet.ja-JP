<Type Name="IndependentChildImpl&lt;IFluentResourceT,FluentParentModelT,InnerResourceT,FluentResourceT,IResourceT,IUpdatableT,ManagerT&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.IndependentChildImpl&lt;IFluentResourceT,FluentParentModelT,InnerResourceT,FluentResourceT,IResourceT,IUpdatableT,ManagerT&gt;">
  ...
  <Docs>
    ...
    <summary>
             <span data-ttu-id="4b63c-101">できる CRUDed 個別に親リソースから子リソースの実装です。</span><span class="sxs-lookup"><span data-stu-id="4b63c-101">Implementation for the child resource which can be CRUDed independently from the parent resource.</span></span>
             <span data-ttu-id="4b63c-102">(内部使用のみ)。</span><span class="sxs-lookup"><span data-stu-id="4b63c-102">(internal use only).</span></span>
             </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="4b63c-103">リソースの名前。</span><span class="sxs-lookup"><span data-stu-id="4b63c-103">The name of the resource.</span></span></param>
        <param name="innerObject"><span data-ttu-id="4b63c-104">内部オブジェクトです。</span><span class="sxs-lookup"><span data-stu-id="4b63c-104">The inner object.</span></span></param>
        <param name="manager">To be added.</param>
        <summary>
             <span data-ttu-id="4b63c-105">IndependentChildResourceImpl の新しいインスタンスを作成します。</span><span class="sxs-lookup"><span data-stu-id="4b63c-105">Creates a new instance of IndependentChildResourceImpl.</span></span>
             </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="IsInCreateMode">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return>
          <span data-ttu-id="4b63c-106"><tt>true</tt>かどうか現在では定義.モードを作成します。</span><span class="sxs-lookup"><span data-stu-id="4b63c-106"><tt>true</tt> if currently in define..create mode.</span></span></return>
      </Docs>
    </Member>
