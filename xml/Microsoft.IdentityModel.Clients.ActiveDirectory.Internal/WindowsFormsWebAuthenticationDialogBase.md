<Type Name="WindowsFormsWebAuthenticationDialogBase" FullName="Microsoft.IdentityModel.Clients.ActiveDirectory.Internal.WindowsFormsWebAuthenticationDialogBase">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6cb48-101">Web フォームの基本クラス</span><span class="sxs-lookup"><span data-stu-id="6cb48-101">Base class for web form</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="WebBrowser">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6cb48-102">ダイアログ ボックスで使用される Web ブラウザー コントロールを取得します。</span><span class="sxs-lookup"><span data-stu-id="6cb48-102">Gets Web Browser control used by the dialog.</span></span>
            </summary>
