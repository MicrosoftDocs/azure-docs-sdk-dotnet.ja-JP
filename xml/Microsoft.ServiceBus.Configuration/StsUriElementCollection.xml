<Type Name="StsUriElementCollection" FullName="Microsoft.ServiceBus.Configuration.StsUriElementCollection">
  ...
  <Docs>
    <summary><span data-ttu-id="8dab1-101">セキュリティ トークン サービスの URI の要素のコレクションを表します。</span><span class="sxs-lookup"><span data-stu-id="8dab1-101">Represents a URI element collection for the Security Token Service.</span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="8dab1-102"><see cref="T:Microsoft.ServiceBus.Configuration.StsUriElementCollection" /> クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="8dab1-102">Initializes a new instance of the <see cref="T:Microsoft.ServiceBus.Configuration.StsUriElementCollection" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Addresses">
      ...
      <Docs>
        <summary><span data-ttu-id="8dab1-103">コレクション内の要素のアドレスを取得します。</span><span class="sxs-lookup"><span data-stu-id="8dab1-103">Gets the addresses of the element in the collection.</span></span></summary>
        <value><span data-ttu-id="8dab1-104">コレクション内の要素のアドレス。</span><span class="sxs-lookup"><span data-stu-id="8dab1-104">The addresses of the element in the collection.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
