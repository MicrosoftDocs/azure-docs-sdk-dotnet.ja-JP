<Type Name="AddressConfigurationElementCollection" FullName="Microsoft.ServiceBus.Configuration.AddressConfigurationElementCollection">
  ...
  <Docs>
    <summary><span data-ttu-id="5ca6e-101">アドレスの構成内の要素のコレクションを表します。</span><span class="sxs-lookup"><span data-stu-id="5ca6e-101">Represents a collection of elements in address configuration.</span></span></summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="5ca6e-102"><see cref="T:Microsoft.ServiceBus.Configuration.AddressConfigurationElementCollection" /> クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="5ca6e-102">Initializes a new instance of the <see cref="T:Microsoft.ServiceBus.Configuration.AddressConfigurationElementCollection" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Addresses">
      ...
      <Docs>
        <summary><span data-ttu-id="5ca6e-103">コレクション内の要素のアドレスを取得します。</span><span class="sxs-lookup"><span data-stu-id="5ca6e-103">Gets the addresses of the elements in the collection.</span></span></summary>
        <value><span data-ttu-id="5ca6e-104">コレクション内の要素のアドレス。</span><span class="sxs-lookup"><span data-stu-id="5ca6e-104">The addresses of the elements in the collection.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
