<Type Name="IWithCreate" FullName="Microsoft.Azure.Management.AppService.Fluent.FunctionApp.Definition.IWithCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ec21b-101">関数アプリケーションには、アプリを作成する、新しい関数で、クラウドを指定する省略可能な追加の入力を公開するための十分な入力での定義が表示されます。</span><span class="sxs-lookup"><span data-stu-id="ec21b-101">A function app definition with sufficient inputs to create a new function app in the cloud, but exposing additional optional inputs to specify.</span></span>
            </summary>
