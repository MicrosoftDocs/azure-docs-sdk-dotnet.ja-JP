<Type Name="TableErrorCodeStrings" FullName="Microsoft.WindowsAzure.Storage.Table.Protocol.TableErrorCodeStrings">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8ed69-101">エラーは、Microsoft Azure テーブル サービスに固有のコードの文字列を提供します。</span><span class="sxs-lookup"><span data-stu-id="8ed69-101">Provides error code strings that are specific to the Microsoft Azure Table service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="BatchOperationNotSupported">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-102">バッチ操作は、この操作の種類はサポートされません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-102">Batch operations are not supported for this operation type.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DuplicateKeyPropertySpecified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-103">重複するキー プロパティが指定されました。</span><span class="sxs-lookup"><span data-stu-id="8ed69-103">A duplicate key property was specified.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DuplicatePropertiesSpecified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-104">プロパティが複数回指定されています。</span><span class="sxs-lookup"><span data-stu-id="8ed69-104">A property is specified more than once.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EntityAlreadyExists">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-105">指定されたエンティティが既に存在します。</span><span class="sxs-lookup"><span data-stu-id="8ed69-105">The specified entity already exists.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EntityNotFound">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-106">指定されたエンティティが見つかりませんでした。</span><span class="sxs-lookup"><span data-stu-id="8ed69-106">The specified entity was not found.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="EntityTooLarge">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-107">エンティティは、許容される最大サイズを超えています。</span><span class="sxs-lookup"><span data-stu-id="8ed69-107">The entity is larger than the maximum size permitted.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="HostInformationNotPresent">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-108">必要なホスト情報は、要求内に存在ではありません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-108">The required host information is not present in the request.</span></span> <span data-ttu-id="8ed69-109">空でないホスト ヘッダーを送信するか、要求ラインで絶対 URI を含める必要があります。</span><span class="sxs-lookup"><span data-stu-id="8ed69-109">You must send a non-empty Host header or include the absolute URI in the request line.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="InvalidValueType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-110">1 つまたは複数の値の型が無効です。</span><span class="sxs-lookup"><span data-stu-id="8ed69-110">One or more value types are invalid.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="JsonFormatNotSupported">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-111">JSON 形式はサポートされていません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-111">JSON format is not supported.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="MethodNotAllowed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-112">指定したメソッドを指定することはできません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-112">The specified method is not allowed.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NotImplemented">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-113">指定された操作はまだ実装されていません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-113">The specified operation is not yet implemented.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OperatorInvalid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-114">1 つまたは複数の指定した演算子が無効です。</span><span class="sxs-lookup"><span data-stu-id="8ed69-114">One or more specified operators are invalid.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PartitionKeyNotSpecified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-115">パーティション キーは指定されませんでした。</span><span class="sxs-lookup"><span data-stu-id="8ed69-115">The partition key was not specified.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PartitionKeyPropertyCannotBeUpdated">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-116">パーティションのキー プロパティを更新することはできません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-116">The partition key property cannot be updated.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PrimaryKeyPropertyIsInvalidType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-117">主キーのプロパティの型が正しくありません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-117">The type of the primary key property is invalid.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PropertiesNeedValue">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-118">すべてのプロパティの値が必要です。</span><span class="sxs-lookup"><span data-stu-id="8ed69-118">All properties must have values.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PropertyNameInvalid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-119">プロパティ名が正しくありません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-119">The property name is invalid.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PropertyNameTooLong">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-120">プロパティ名は、許容最大長を超えています。</span><span class="sxs-lookup"><span data-stu-id="8ed69-120">The property name exceeds the maximum allowed length.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PropertyValueTooLarge">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-121">プロパティの値は、許容される最大サイズを超えています。</span><span class="sxs-lookup"><span data-stu-id="8ed69-121">The property value is larger than the maximum size permitted.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TableAlreadyExists">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-122">指定したテーブルが既に存在します。</span><span class="sxs-lookup"><span data-stu-id="8ed69-122">The specified table already exists.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TableBeingDeleted">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-123">指定したテーブルを削除しています。</span><span class="sxs-lookup"><span data-stu-id="8ed69-123">The specified table is being deleted.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TableHasNoProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-124">指定されたテーブルには、プロパティがありません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-124">The specified table has no properties.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TableHasNoSuchProperty">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-125">指定したテーブルには、このようなプロパティがありません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-125">The specified table has no such property.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TableNotFound">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-126">指定されたテーブルは見つかりませんでした。</span><span class="sxs-lookup"><span data-stu-id="8ed69-126">The specified table was not found.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TableServerOutOfMemory">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-127">テーブル サービスのサーバーは、メモリ不足です。</span><span class="sxs-lookup"><span data-stu-id="8ed69-127">The Table service server is out of memory.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TooManyProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-128">エンティティには、許可されているその他のプロパティが含まれています。</span><span class="sxs-lookup"><span data-stu-id="8ed69-128">The entity contains more properties than allowed.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UpdateConditionNotSatisfied">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-129">指定した更新プログラムの条件が満たされていません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-129">The specified update condition was not satisfied.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="XMethodIncorrectCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-130">複数の X-HTTP メソッドを指定します。</span><span class="sxs-lookup"><span data-stu-id="8ed69-130">More than one X-HTTP-Method is specified.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="XMethodIncorrectValue">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-131">指定された X-HTTP のメソッドが正しくありません。</span><span class="sxs-lookup"><span data-stu-id="8ed69-131">The specified X-HTTP-Method is invalid.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="XMethodNotUsingPost">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="8ed69-132">要求は、POST 以外の HTTP 動詞と X HTTP メソッドを使用します。</span><span class="sxs-lookup"><span data-stu-id="8ed69-132">The request uses X-HTTP-Method with an HTTP verb other than POST.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
