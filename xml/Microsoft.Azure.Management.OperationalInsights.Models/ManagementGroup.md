<Type Name="ManagementGroup" FullName="Microsoft.Azure.Management.OperationalInsights.Models.ManagementGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5ea81-101">ワークスペースに接続されている管理グループ</span><span class="sxs-lookup"><span data-stu-id="5ea81-101">A management group that is connected to a workspace</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5ea81-102">ManagementGroup クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-102">Initializes a new instance of the ManagementGroup class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="serverCount"><span data-ttu-id="5ea81-103">サーバーの数は、管理グループに接続します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-103">The number of servers connected to the management group.</span></span></param>
        <param name="isGateway"><span data-ttu-id="5ea81-104">取得または管理グループがゲートウェイであるかどうかを示す値を設定します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-104">Gets or sets a value indicating whether the management group is a gateway.</span></span></param>
        <param name="name"><span data-ttu-id="5ea81-105">管理グループの名前。</span><span class="sxs-lookup"><span data-stu-id="5ea81-105">The name of the management group.</span></span></param>
        <param name="id"><span data-ttu-id="5ea81-106">管理グループの一意の ID。</span><span class="sxs-lookup"><span data-stu-id="5ea81-106">The unique ID of the management group.</span></span></param>
        <param name="created"><span data-ttu-id="5ea81-107">管理グループが作成された日時。</span><span class="sxs-lookup"><span data-stu-id="5ea81-107">The datetime that the management group was created.</span></span></param>
        <param name="dataReceived"><span data-ttu-id="5ea81-108">管理グループがデータを受信しました最終日時。</span><span class="sxs-lookup"><span data-stu-id="5ea81-108">The last datetime that the management group received data.</span></span></param>
        <param name="version"><span data-ttu-id="5ea81-109">管理グループが管理している System Center のバージョン。</span><span class="sxs-lookup"><span data-stu-id="5ea81-109">The version of System Center that is managing the management group.</span></span></param>
        <param name="sku"><span data-ttu-id="5ea81-110">SKU の System Center 管理グループが管理しています。</span><span class="sxs-lookup"><span data-stu-id="5ea81-110">The SKU of System Center that is managing the management group.</span></span></param>
        <summary>
            <span data-ttu-id="5ea81-111">ManagementGroup クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-111">Initializes a new instance of the ManagementGroup class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Created">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5ea81-112">取得または管理グループが作成された日付と時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-112">Gets or sets the datetime that the management group was created.</span></span>
            </summary>
    ...
    <Member MemberName="DataReceived">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5ea81-113">取得または管理グループがデータを受信する最後の datetime を設定します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-113">Gets or sets the last datetime that the management group received data.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5ea81-114">取得または管理グループの一意の ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-114">Gets or sets the unique ID of the management group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IsGateway">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5ea81-115">取得または管理グループがゲートウェイであるかどうかを示す値を設定します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-115">Gets or sets a value indicating whether the management group is a gateway.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5ea81-116">取得または管理グループの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-116">Gets or sets the name of the management group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServerCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5ea81-117">取得または管理グループに接続されているサーバーの数を設定します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-117">Gets or sets the number of servers connected to the management group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Sku">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5ea81-118">取得または設定、SKU の System Center 管理グループが管理しています。</span><span class="sxs-lookup"><span data-stu-id="5ea81-118">Gets or sets the SKU of System Center that is managing the management group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5ea81-119">取得または管理グループが管理している System Center のバージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="5ea81-119">Gets or sets the version of System Center that is managing the management group.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
