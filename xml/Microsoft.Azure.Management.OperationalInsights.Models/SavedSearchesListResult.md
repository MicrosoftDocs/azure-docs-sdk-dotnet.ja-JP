<Type Name="SavedSearchesListResult" FullName="Microsoft.Azure.Management.OperationalInsights.Models.SavedSearchesListResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="01d88-101">保存された検索操作の応答。</span><span class="sxs-lookup"><span data-stu-id="01d88-101">The saved search operation response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="01d88-102">SavedSearchesListResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="01d88-102">Initializes a new instance of the SavedSearchesListResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="metadata"><span data-ttu-id="01d88-103">検索結果からのメタデータ。</span><span class="sxs-lookup"><span data-stu-id="01d88-103">The metadata from search results.</span></span></param>
        <param name="value"><span data-ttu-id="01d88-104">結果の値の配列。</span><span class="sxs-lookup"><span data-stu-id="01d88-104">The array of result values.</span></span></param>
        <summary>
            <span data-ttu-id="01d88-105">SavedSearchesListResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="01d88-105">Initializes a new instance of the SavedSearchesListResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Metadata">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="01d88-106">取得または検索結果からメタデータを設定します。</span><span class="sxs-lookup"><span data-stu-id="01d88-106">Gets or sets the metadata from search results.</span></span>
            </summary>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="01d88-107">取得または結果の値の配列を設定します。</span><span class="sxs-lookup"><span data-stu-id="01d88-107">Gets or sets the array of result values.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
