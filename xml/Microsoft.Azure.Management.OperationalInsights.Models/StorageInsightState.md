<Type Name="StorageInsightState" FullName="Microsoft.Azure.Management.OperationalInsights.Models.StorageInsightState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="200bf-101">StorageInsightState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="200bf-101">Defines values for StorageInsightState.</span></span>
            </summary>
