<Type Name="IWithFloatingIP" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerInboundNatRule.Update.IWithFloatingIP">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a08ac-101">フローティング IP を有効にするかどうかを指定するを許可する受信の NAT ルール更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="a08ac-101">The stage of an inbound NAT rule update allowing to specify whether floating IP should be enabled.</span></span>
            </summary>
