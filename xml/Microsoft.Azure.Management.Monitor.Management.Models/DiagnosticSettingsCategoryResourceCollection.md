<Type Name="DiagnosticSettingsCategoryResourceCollection" FullName="Microsoft.Azure.Management.Monitor.Management.Models.DiagnosticSettingsCategoryResourceCollection">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="00b0a-101">診断設定カテゴリのリソースのコレクションを表します。</span><span class="sxs-lookup"><span data-stu-id="00b0a-101">Represents a collection of diagnostic setting category resources.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="00b0a-102">DiagnosticSettingsCategoryResourceCollection クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="00b0a-102">Initializes a new instance of the DiagnosticSettingsCategoryResourceCollection class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="00b0a-103">診断設定のカテゴリのリソースのコレクション。</span><span class="sxs-lookup"><span data-stu-id="00b0a-103">The collection of diagnostic settings category resources.</span></span></param>
        <summary>
            <span data-ttu-id="00b0a-104">DiagnosticSettingsCategoryResourceCollection クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="00b0a-104">Initializes a new instance of the DiagnosticSettingsCategoryResourceCollection class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="00b0a-105">取得またはカテゴリのリソースの診断設定のコレクションを設定します。</span><span class="sxs-lookup"><span data-stu-id="00b0a-105">Gets or sets the collection of diagnostic settings category resources.</span></span>
            </summary>
