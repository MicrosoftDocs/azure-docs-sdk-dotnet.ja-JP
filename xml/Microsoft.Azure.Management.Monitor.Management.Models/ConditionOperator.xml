<Type Name="ConditionOperator" FullName="Microsoft.Azure.Management.Monitor.Management.Models.ConditionOperator">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="419f7-101">ConditionOperator の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="419f7-101">Defines values for ConditionOperator.</span></span>
            </summary>
