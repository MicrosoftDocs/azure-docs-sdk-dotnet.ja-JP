<Type Name="TimeAggregationType" FullName="Microsoft.Azure.Management.Monitor.Management.Models.TimeAggregationType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2d887-101">TimeAggregationType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="2d887-101">Defines values for TimeAggregationType.</span></span>
            </summary>
