<Type Name="MetricStatisticType" FullName="Microsoft.Azure.Management.Monitor.Management.Models.MetricStatisticType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d6af2-101">MetricStatisticType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="d6af2-101">Defines values for MetricStatisticType.</span></span>
            </summary>
