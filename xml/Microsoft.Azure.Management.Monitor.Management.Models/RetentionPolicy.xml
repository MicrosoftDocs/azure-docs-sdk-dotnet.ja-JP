<Type Name="RetentionPolicy" FullName="Microsoft.Azure.Management.Monitor.Management.Models.RetentionPolicy">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bdb4d-101">ログの保持ポリシーを指定します。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-101">Specifies the retention policy for the log.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bdb4d-102">RetentionPolicy クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-102">Initializes a new instance of the RetentionPolicy class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="enabled"><span data-ttu-id="bdb4d-103">保持ポリシーが有効になっているかどうかを示す値。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-103">a value indicating whether the retention policy is enabled.</span></span></param>
        <param name="days"><span data-ttu-id="bdb4d-104">日以内に、保有期間の日数の数。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-104">the number of days for the retention in days.</span></span> <span data-ttu-id="bdb4d-105">値 0 は、イベントを無期限に保持されます。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-105">A value of 0 will retain the events indefinitely.</span></span></param>
        <summary>
            <span data-ttu-id="bdb4d-106">RetentionPolicy クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-106">Initializes a new instance of the RetentionPolicy class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Days">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bdb4d-107">取得または日数で、保有期間の日数を設定します。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-107">Gets or sets the number of days for the retention in days.</span></span> <span data-ttu-id="bdb4d-108">値 0 は、イベントを無期限に保持されます。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-108">A value of 0 will retain the events indefinitely.</span></span>
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bdb4d-109">取得または保持ポリシーが有効になっているかどうかを示す値を設定します。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-109">Gets or sets a value indicating whether the retention policy is enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bdb4d-110">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="bdb4d-111">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="bdb4d-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
