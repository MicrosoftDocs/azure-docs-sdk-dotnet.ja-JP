<Type Name="IWithSettings&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSetExtension.Definition.IWithSettings&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="50eb4-101">この定義をアタッチした後に戻るに親の定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="50eb4-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="50eb4-102">仮想マシンのスケールのステージでは、パブリックおよびプライベートの設定を指定できるように拡張機能の定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="50eb4-102">The stage of a virtual machine scale set extension definition allowing to specify the public and private settings.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithProtectedSetting">
      ...
      <Docs>
        <param name="key"><span data-ttu-id="50eb4-103">プライベート設定のエントリのキー。</span><span class="sxs-lookup"><span data-stu-id="50eb4-103">The key of a private settings entry.</span></span></param>
        <param name="value"><span data-ttu-id="50eb4-104">プライベート設定のエントリの値。</span><span class="sxs-lookup"><span data-stu-id="50eb4-104">The value of the private settings entry.</span></span></param>
        <summary>
            <span data-ttu-id="50eb4-105">プライベート設定のエントリを指定します。</span><span class="sxs-lookup"><span data-stu-id="50eb4-105">Specifies a private settings entry.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="50eb4-106">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="50eb4-106">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithProtectedSettings">
      ...
      <Docs>
        <param name="settings"><span data-ttu-id="50eb4-107">プライベート設定します。</span><span class="sxs-lookup"><span data-stu-id="50eb4-107">The private settings.</span></span></param>
        <summary>
            <span data-ttu-id="50eb4-108">プライベート設定を指定します。</span><span class="sxs-lookup"><span data-stu-id="50eb4-108">Specifies private settings.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="50eb4-109">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="50eb4-109">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithPublicSetting">
      ...
      <Docs>
        <param name="key"><span data-ttu-id="50eb4-110">公開設定のエントリのキー。</span><span class="sxs-lookup"><span data-stu-id="50eb4-110">The key of a public settings entry.</span></span></param>
        <param name="value"><span data-ttu-id="50eb4-111">公開設定のエントリの値。</span><span class="sxs-lookup"><span data-stu-id="50eb4-111">The value of the public settings entry.</span></span></param>
        <summary>
            <span data-ttu-id="50eb4-112">公開設定のエントリを指定します。</span><span class="sxs-lookup"><span data-stu-id="50eb4-112">Specifies a public settings entry.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="50eb4-113">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="50eb4-113">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithPublicSettings">
      ...
      <Docs>
        <param name="settings"><span data-ttu-id="50eb4-114">公開設定。</span><span class="sxs-lookup"><span data-stu-id="50eb4-114">The public settings.</span></span></param>
        <summary>
            <span data-ttu-id="50eb4-115">公開設定を指定します。</span><span class="sxs-lookup"><span data-stu-id="50eb4-115">Specifies public settings.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="50eb4-116">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="50eb4-116">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>