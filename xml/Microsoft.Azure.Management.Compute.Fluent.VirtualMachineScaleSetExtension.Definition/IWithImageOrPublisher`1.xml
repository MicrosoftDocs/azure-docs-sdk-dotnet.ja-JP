<Type Name="IWithImageOrPublisher&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSetExtension.Definition.IWithImageOrPublisher&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="5cf75-101">この定義をアタッチした後に戻るに親の定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="5cf75-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="5cf75-102">仮想マシン スケール セット拡張機能定義できるようにする拡張イメージを指定するか、仮想マシンのスケールの名前を指定のステージでは、拡張機能のパブリッシャーを設定します。</span><span class="sxs-lookup"><span data-stu-id="5cf75-102">The stage of a virtual machines scale set extension definition allowing to specify an extension image or specify name of the virtual machine scale set extension publisher.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithImage">
      ...
      <Docs>
        <param name="image"><span data-ttu-id="5cf75-103">拡張イメージです。</span><span class="sxs-lookup"><span data-stu-id="5cf75-103">An extension image.</span></span></param>
        <summary>
            <span data-ttu-id="5cf75-104">仮想マシンのスケール設定を使用する拡張機能のイメージを指定します。</span><span class="sxs-lookup"><span data-stu-id="5cf75-104">Specifies the virtual machine scale set extension image to use.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="5cf75-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="5cf75-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>