<Type Name="IWithListenOrSendOrManage&lt;T&gt;" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.AuthorizationRule.Update.IWithListenOrSendOrManage&lt;T&gt;">
  ...
  <Docs>
    <typeparam name="T"><span data-ttu-id="42396-101">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="42396-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="42396-102">Service Bus 承認ルールの更新を許可する、リッスンを有効にするのステージでは、送信またはポリシーを管理します。</span><span class="sxs-lookup"><span data-stu-id="42396-102">The stage of the Service Bus authorization rule update allowing to enable listen, send or manage policy.</span></span>
            </summary>
