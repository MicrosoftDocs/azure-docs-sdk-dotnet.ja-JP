<Type Name="IWithCreate" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.ActiveDirectoryGroup.Definition.IWithCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="462bc-101">AD でグループの定義で、クラウドを指定する省略可能な追加の入力を公開する新しいグループを作成するための十分な入力でします。</span><span class="sxs-lookup"><span data-stu-id="462bc-101">An AD group definition with sufficient inputs to create a new group in the cloud, but exposing additional optional inputs to specify.</span></span>
            </summary>
