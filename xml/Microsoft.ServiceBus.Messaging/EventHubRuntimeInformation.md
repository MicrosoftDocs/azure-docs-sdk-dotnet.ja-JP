<Type Name="EventHubRuntimeInformation" FullName="Microsoft.ServiceBus.Messaging.EventHubRuntimeInformation">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="3a205-101">作成するために必要な Event Hubs ランタイム情報を返します<see cref="T:Microsoft.ServiceBus.Messaging.EventHubSender" />または<see cref="T:Microsoft.ServiceBus.Messaging.EventHubReceiver" />オブジェクト。</span><span class="sxs-lookup"><span data-stu-id="3a205-101">Returns Event Hubs runtime information, which is required for creating <see cref="T:Microsoft.ServiceBus.Messaging.EventHubSender" /> or <see cref="T:Microsoft.ServiceBus.Messaging.EventHubReceiver" /> objects.</span></span></summary>
  ...
  <Members>
    ...
    <Member MemberName="CreatedAt">
      ...
      <Docs>
        <summary><span data-ttu-id="3a205-102">取得または Event Hub の作成時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="3a205-102">Gets or sets the time at which the Event Hub was created.</span></span></summary>
        <value><span data-ttu-id="3a205-103"><see cref="T:System.DateTime" /> を返します。</span><span class="sxs-lookup"><span data-stu-id="3a205-103">Returns <see cref="T:System.DateTime" />.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PartitionCount">
      ...
      <Docs>
        <summary><span data-ttu-id="3a205-104">取得または Event Hub のパーティションの数を設定します。</span><span class="sxs-lookup"><span data-stu-id="3a205-104">Gets or sets the number of partitions in an Event Hub.</span></span></summary>
        <value><span data-ttu-id="3a205-105"><see cref="T:System.Int32" /> を返します。</span><span class="sxs-lookup"><span data-stu-id="3a205-105">Returns <see cref="T:System.Int32" />.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PartitionIds">
      ...
      <Docs>
        <summary><span data-ttu-id="3a205-106">取得または Event Hub のパーティション ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="3a205-106">Gets or sets the partition ID for an Event Hub.</span></span></summary>
        <value><span data-ttu-id="3a205-107"><see cref="T:System.String" /> を返します。</span><span class="sxs-lookup"><span data-stu-id="3a205-107">Returns <see cref="T:System.String" />.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Path">
      ...
      <Docs>
        <summary><span data-ttu-id="3a205-108">取得または Event Hub へのパスを設定します。</span><span class="sxs-lookup"><span data-stu-id="3a205-108">Gets or sets the path to the Event Hub.</span></span></summary>
        <value><span data-ttu-id="3a205-109"><see cref="T:System.String" /> を返します。</span><span class="sxs-lookup"><span data-stu-id="3a205-109">Returns <see cref="T:System.String" />.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
