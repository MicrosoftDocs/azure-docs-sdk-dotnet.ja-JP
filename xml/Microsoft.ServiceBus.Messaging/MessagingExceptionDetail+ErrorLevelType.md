<Type Name="MessagingExceptionDetail+ErrorLevelType" FullName="Microsoft.ServiceBus.Messaging.MessagingExceptionDetail+ErrorLevelType">
  ...
  <Docs>
    <summary><span data-ttu-id="e393f-101">メッセージングの通信のエラー レベルの種類を列挙します。</span><span class="sxs-lookup"><span data-stu-id="e393f-101">Enumerates the types of error level for the messaging communication.</span></span></summary>
