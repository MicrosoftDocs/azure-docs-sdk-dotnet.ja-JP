<Type Name="IWithAaaaRecordIPv6AddressOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Definition.IWithAaaaRecordIPv6AddressOrAttachable&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="851dc-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="851dc-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="851dc-102">AAAA レコードのステージでは、追加の AAAA レコードを追加またはレコード セットの親にアタッチできるように定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="851dc-102">The stage of the AAAA record set definition allowing to add additional AAAA records or attach the record set to the parent.</span></span>
            </summary>
