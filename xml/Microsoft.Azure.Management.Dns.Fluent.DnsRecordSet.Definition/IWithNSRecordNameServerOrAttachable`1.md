<Type Name="IWithNSRecordNameServerOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Definition.IWithNSRecordNameServerOrAttachable&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="e27c6-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="e27c6-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="e27c6-102">NS レコード セットの定義を許可する追加の NS レコードを追加またはレコードのアタッチのステージは、親を設定します。</span><span class="sxs-lookup"><span data-stu-id="e27c6-102">The stage of the NS record set definition allowing to add additional NS records or attach the record set to the parent.</span></span>
            </summary>
