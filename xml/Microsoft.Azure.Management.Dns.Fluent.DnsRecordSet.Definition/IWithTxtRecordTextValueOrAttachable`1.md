<Type Name="IWithTxtRecordTextValueOrAttachable&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.Definition.IWithTxtRecordTextValueOrAttachable&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="5f90d-101">WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="5f90d-101">The return type of  WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="5f90d-102">TXT レコードのステージでは、追加の TXT レコードを追加またはレコードを親にセットをアタッチできるように定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="5f90d-102">The stage of the TXT record set definition allowing to add additional TXT records or attach the record set to the parent.</span></span>
            </summary>
