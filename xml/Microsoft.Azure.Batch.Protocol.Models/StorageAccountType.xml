<Type Name="StorageAccountType" FullName="Microsoft.Azure.Batch.Protocol.Models.StorageAccountType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7017e-101">StorageAccountType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="7017e-101">Defines values for StorageAccountType.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="PremiumLRS">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7017e-102">データ ディスクには、premium ローカル冗長ストレージを使用する必要があります。</span><span class="sxs-lookup"><span data-stu-id="7017e-102">The data disk should use premium locally redundant storage.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="StandardLRS">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="7017e-103">データ ディスクには、標準のローカル冗長ストレージを使用する必要があります。</span><span class="sxs-lookup"><span data-stu-id="7017e-103">The data disk should use standard locally redundant storage.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
