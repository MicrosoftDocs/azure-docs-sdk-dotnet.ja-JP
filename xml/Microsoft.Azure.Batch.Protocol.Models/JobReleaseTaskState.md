<Type Name="JobReleaseTaskState" FullName="Microsoft.Azure.Batch.Protocol.Models.JobReleaseTaskState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fdcc9-101">JobReleaseTaskState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="fdcc9-101">Defines values for JobReleaseTaskState.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Running">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fdcc9-103">(再試行を含む)、タスクは実行中です。</span><span class="sxs-lookup"><span data-stu-id="fdcc9-103">The task is currently running (including retrying).</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
