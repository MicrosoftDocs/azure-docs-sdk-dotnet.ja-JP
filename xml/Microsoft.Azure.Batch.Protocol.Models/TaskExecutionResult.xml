<Type Name="TaskExecutionResult" FullName="Microsoft.Azure.Batch.Protocol.Models.TaskExecutionResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="26c15-101">TaskExecutionResult の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="26c15-101">Defines values for TaskExecutionResult.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Failure">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="26c15-102">タスクの処理中にエラーが発生しました。</span><span class="sxs-lookup"><span data-stu-id="26c15-102">There was an error during processing of the task.</span></span> <span data-ttu-id="26c15-103">タスク処理が開始タスク プロセスの実行中、またはタスク プロセスの終了後に、エラーが発生します。</span><span class="sxs-lookup"><span data-stu-id="26c15-103">The failure may have occurred before the task process was launched, while the task process was executing, or after the task process exited.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Success">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="26c15-104">タスクが正常に実行します。</span><span class="sxs-lookup"><span data-stu-id="26c15-104">The task ran successfully.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
