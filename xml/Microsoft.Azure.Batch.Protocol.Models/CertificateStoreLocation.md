<Type Name="CertificateStoreLocation" FullName="Microsoft.Azure.Batch.Protocol.Models.CertificateStoreLocation">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3bb0b-101">CertificateStoreLocation の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="3bb0b-101">Defines values for CertificateStoreLocation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CurrentUser">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3bb0b-102">証明書は、CurrentUser 証明書ストアにインストールする必要があります。</span><span class="sxs-lookup"><span data-stu-id="3bb0b-102">Certificates should be installed to the CurrentUser certificate store.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="LocalMachine">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3bb0b-103">証明書は LocalMachine 証明書ストアにインストールする必要があります。</span><span class="sxs-lookup"><span data-stu-id="3bb0b-103">Certificates should be installed to the LocalMachine certificate store.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
