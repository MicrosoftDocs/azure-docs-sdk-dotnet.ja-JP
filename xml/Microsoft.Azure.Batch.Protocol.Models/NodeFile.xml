<Type Name="NodeFile" FullName="Microsoft.Azure.Batch.Protocol.Models.NodeFile">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="52e19-101">コンピューティング ノードのファイルまたはディレクトリに関する情報。</span><span class="sxs-lookup"><span data-stu-id="52e19-101">Information about a file or directory on a compute node.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52e19-102">NodeFile クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="52e19-102">Initializes a new instance of the NodeFile class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="52e19-103">ファイルのパス。</span><span class="sxs-lookup"><span data-stu-id="52e19-103">The file path.</span></span></param>
        <param name="url"><span data-ttu-id="52e19-104">ファイルの URL です。</span><span class="sxs-lookup"><span data-stu-id="52e19-104">The URL of the file.</span></span></param>
        <param name="isDirectory"><span data-ttu-id="52e19-105">かどうか、オブジェクトは、ディレクトリを表します。</span><span class="sxs-lookup"><span data-stu-id="52e19-105">Whether the object represents a directory.</span></span></param>
        <param name="properties"><span data-ttu-id="52e19-106">ファイルのプロパティ。</span><span class="sxs-lookup"><span data-stu-id="52e19-106">The file properties.</span></span></param>
        <summary>
            <span data-ttu-id="52e19-107">NodeFile クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="52e19-107">Initializes a new instance of the NodeFile class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsDirectory">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52e19-108">取得またはオブジェクトがディレクトリを表すかどうかを設定します。</span><span class="sxs-lookup"><span data-stu-id="52e19-108">Gets or sets whether the object represents a directory.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52e19-109">取得またはファイルのパスを設定します。</span><span class="sxs-lookup"><span data-stu-id="52e19-109">Gets or sets the file path.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52e19-110">取得またはファイルのプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="52e19-110">Gets or sets the file properties.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Url">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52e19-111">取得またはファイルの URL を設定します。</span><span class="sxs-lookup"><span data-stu-id="52e19-111">Gets or sets the URL of the file.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="52e19-112">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="52e19-112">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="52e19-113">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="52e19-113">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
