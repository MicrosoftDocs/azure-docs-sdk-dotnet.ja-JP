<Type Name="JobPreparationTaskState" FullName="Microsoft.Azure.Batch.Protocol.Models.JobPreparationTaskState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="04e0b-101">JobPreparationTaskState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="04e0b-101">Defines values for JobPreparationTaskState.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Completed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04e0b-102">タスクは終了コード 0 で終了しましたまたはタスクで、再試行の制限が使い果たさか、バッチ サービスは (リソース ファイルのダウンロード エラー) などのタスクの準備のエラーによりタスクを開始できませんでした。</span><span class="sxs-lookup"><span data-stu-id="04e0b-102">The task has exited with exit code 0, or the task has exhausted its retry limit, or the Batch service was unable to start the task due to task preparation errors (such as resource file download failures).</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Running">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="04e0b-103">(再試行を含む)、タスクは実行中です。</span><span class="sxs-lookup"><span data-stu-id="04e0b-103">The task is currently running (including retrying).</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
