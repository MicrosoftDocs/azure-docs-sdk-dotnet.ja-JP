<Type Name="CachingType" FullName="Microsoft.Azure.Batch.Protocol.Models.CachingType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="48bf4-101">CachingType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="48bf4-101">Defines values for CachingType.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48bf4-102">ディスクのキャッシュ モードを指定することは無効です。</span><span class="sxs-lookup"><span data-stu-id="48bf4-102">The caching mode for the disk is not enabled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="ReadOnly">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48bf4-103">ディスクのキャッシュ モードは読み取り専用です。</span><span class="sxs-lookup"><span data-stu-id="48bf4-103">The caching mode for the disk is read only.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="ReadWrite">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48bf4-104">ディスクのキャッシュ モードは読み書きします。</span><span class="sxs-lookup"><span data-stu-id="48bf4-104">The caching mode for the disk is read and write.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
