<Type Name="FileGetPropertiesFromComputeNodeHeaders" FullName="Microsoft.Azure.Batch.Protocol.Models.FileGetPropertiesFromComputeNodeHeaders">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="58b45-101">GetPropertiesFromComputeNode 操作のヘッダーを定義します。</span><span class="sxs-lookup"><span data-stu-id="58b45-101">Defines headers for GetPropertiesFromComputeNode operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-102">FileGetPropertiesFromComputeNodeHeaders クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="58b45-102">Initializes a new instance of the FileGetPropertiesFromComputeNodeHeaders class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="clientRequestId"><span data-ttu-id="58b45-103">クライアント要求 id 要求時にクライアントによって指定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-103">The client-request-id provided by the client during the request.</span></span> <span data-ttu-id="58b45-104">これが返されますの戻り値クライアント要求 id パラメーターを設定した場合にのみ true に設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-104">This will be returned only if the return-client-request-id parameter was set to true.</span></span></param>
        <param name="requestId"><span data-ttu-id="58b45-105">バッチ サービスに対して行った要求に対して一意の識別子。</span><span class="sxs-lookup"><span data-stu-id="58b45-105">A unique identifier for the request that was made to the Batch service.</span></span> <span data-ttu-id="58b45-106">要求の形式が正しいにもかかわらず要求が常に失敗する場合は、この値を使用して Microsoft にエラーを報告することができます。</span><span class="sxs-lookup"><span data-stu-id="58b45-106">If a request is consistently failing and you have verified that the request is properly formulated, you may use this value to report the error to Microsoft.</span></span> <span data-ttu-id="58b45-107">レポートでは、値を含める、この要求 ID のおおよその時間、要求が行われたことを対象となる要求が行われた、Batch アカウントおよびアカウントに配置する地域。</span><span class="sxs-lookup"><span data-stu-id="58b45-107">In your report, include the value of this request ID, the approximate time that the request was made, the Batch account against which the request was made, and the region that account resides in.</span></span></param>
        <param name="eTag"><span data-ttu-id="58b45-108">ETag HTTP 応答ヘッダー。</span><span class="sxs-lookup"><span data-stu-id="58b45-108">The ETag HTTP response header.</span></span> <span data-ttu-id="58b45-109">これは、不透明な文字列です。</span><span class="sxs-lookup"><span data-stu-id="58b45-109">This is an opaque string.</span></span> <span data-ttu-id="58b45-110">要求間でリソースが変更されたかどうかを検出するために使用できます。</span><span class="sxs-lookup"><span data-stu-id="58b45-110">You can use it to detect whether the resource has changed between requests.</span></span> <span data-ttu-id="58b45-111">具体的には、いずれかの場合-変更のため、場合の未変更の状態のため、If-match または [なし]-If-match ヘッダーに ETag を渡すことができます。</span><span class="sxs-lookup"><span data-stu-id="58b45-111">In particular, you can pass the ETag to one of the If-Modified-Since, If-Unmodified-Since, If-Match or If-None-Match headers.</span></span></param>
        <param name="lastModified"><span data-ttu-id="58b45-112">リソースの最終更新日時。</span><span class="sxs-lookup"><span data-stu-id="58b45-112">The time at which the resource was last modified.</span></span></param>
        <param name="ocpCreationTime"><span data-ttu-id="58b45-113">ファイルの作成時刻。</span><span class="sxs-lookup"><span data-stu-id="58b45-113">The file creation time.</span></span></param>
        <param name="ocpBatchFileIsdirectory"><span data-ttu-id="58b45-114">かどうか、オブジェクトは、ディレクトリを表します。</span><span class="sxs-lookup"><span data-stu-id="58b45-114">Whether the object represents a directory.</span></span></param>
        <param name="ocpBatchFileUrl"><span data-ttu-id="58b45-115">ファイルの URL です。</span><span class="sxs-lookup"><span data-stu-id="58b45-115">The URL of the file.</span></span></param>
        <param name="ocpBatchFileMode"><span data-ttu-id="58b45-116">8 進数形式でファイル モード属性です。</span><span class="sxs-lookup"><span data-stu-id="58b45-116">The file mode attribute in octal format.</span></span></param>
        <param name="contentType"><span data-ttu-id="58b45-117">ファイルのコンテンツの種類。</span><span class="sxs-lookup"><span data-stu-id="58b45-117">The content type of the file.</span></span></param>
        <param name="contentLength"><span data-ttu-id="58b45-118">ファイルの長さ。</span><span class="sxs-lookup"><span data-stu-id="58b45-118">The length of the file.</span></span></param>
        <summary>
            <span data-ttu-id="58b45-119">FileGetPropertiesFromComputeNodeHeaders クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="58b45-119">Initializes a new instance of the FileGetPropertiesFromComputeNodeHeaders class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-120">取得または要求時に、クライアントによって提供される、クライアントの要求の id を設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-120">Gets or sets the client-request-id provided by the client during the request.</span></span> <span data-ttu-id="58b45-121">これが返されますの戻り値クライアント要求 id パラメーターを設定した場合にのみ true に設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-121">This will be returned only if the return-client-request-id parameter was set to true.</span></span>
            </summary>
    ...
    <Member MemberName="ContentLength">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-122">取得またはファイルの長さを設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-122">Gets or sets the length of the file.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ContentType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-123">取得またはファイルのコンテンツの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-123">Gets or sets the content type of the file.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ETag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-124">取得または ETag HTTP 応答ヘッダーを設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-124">Gets or sets the ETag HTTP response header.</span></span> <span data-ttu-id="58b45-125">これは、不透明な文字列です。</span><span class="sxs-lookup"><span data-stu-id="58b45-125">This is an opaque string.</span></span> <span data-ttu-id="58b45-126">要求間でリソースが変更されたかどうかを検出するために使用できます。</span><span class="sxs-lookup"><span data-stu-id="58b45-126">You can use it to detect whether the resource has changed between requests.</span></span> <span data-ttu-id="58b45-127">具体的には、いずれかの場合-変更のため、場合の未変更の状態のため、If-match または [なし]-If-match ヘッダーに ETag を渡すことができます。</span><span class="sxs-lookup"><span data-stu-id="58b45-127">In particular, you can pass the ETag to one of the If-Modified-Since, If-Unmodified-Since, If-Match or If-None-Match headers.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastModified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-128">取得またはリソースが最後に変更された時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-128">Gets or sets the time at which the resource was last modified.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OcpBatchFileIsdirectory">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-129">取得またはオブジェクトがディレクトリを表すかどうかを設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-129">Gets or sets whether the object represents a directory.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OcpBatchFileMode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-130">取得または 8 進数形式でファイル モード属性を設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-130">Gets or sets the file mode attribute in octal format.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OcpBatchFileUrl">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-131">取得またはファイルの URL を設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-131">Gets or sets the URL of the file.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="OcpCreationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-132">取得またはファイル作成時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="58b45-132">Gets or sets the file creation time.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="58b45-133">取得または設定が、バッチ サービスに行われた要求の一意の識別子。</span><span class="sxs-lookup"><span data-stu-id="58b45-133">Gets or sets a unique identifier for the request that was made to the Batch service.</span></span> <span data-ttu-id="58b45-134">要求の形式が正しいにもかかわらず要求が常に失敗する場合は、この値を使用して Microsoft にエラーを報告することができます。</span><span class="sxs-lookup"><span data-stu-id="58b45-134">If a request is consistently failing and you have verified that the request is properly formulated, you may use this value to report the error to Microsoft.</span></span> <span data-ttu-id="58b45-135">レポートでは、値を含める、この要求 ID のおおよその時間、要求が行われたことを対象となる要求が行われた、Batch アカウントおよびアカウントに配置する地域。</span><span class="sxs-lookup"><span data-stu-id="58b45-135">In your report, include the value of this request ID, the approximate time that the request was made, the Batch account against which the request was made, and the region that account resides in.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
