<Type Name="TaskInformation" FullName="Microsoft.Azure.Batch.Protocol.Models.TaskInformation">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="46161-101">コンピューティング ノードで実行されているタスクに関する情報。</span><span class="sxs-lookup"><span data-stu-id="46161-101">Information about a task running on a compute node.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46161-102">TaskInformation クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="46161-102">Initializes a new instance of the TaskInformation class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="taskState"><span data-ttu-id="46161-103">タスクの現在の状態。</span><span class="sxs-lookup"><span data-stu-id="46161-103">The current state of the task.</span></span></param>
        <param name="taskUrl"><span data-ttu-id="46161-104">タスクの URL です。</span><span class="sxs-lookup"><span data-stu-id="46161-104">The URL of the task.</span></span></param>
        <param name="jobId"><span data-ttu-id="46161-105">タスクが属しているジョブの ID。</span><span class="sxs-lookup"><span data-stu-id="46161-105">The ID of the job to which the task belongs.</span></span></param>
        <param name="taskId"><span data-ttu-id="46161-106">タスクの ID。</span><span class="sxs-lookup"><span data-stu-id="46161-106">The ID of the task.</span></span></param>
        <param name="subtaskId"><span data-ttu-id="46161-107">サブタスクの場合は、タスクは、複数インスタンスのタスクの ID。</span><span class="sxs-lookup"><span data-stu-id="46161-107">The ID of the subtask if the task is a multi-instance task.</span></span></param>
        <param name="executionInfo"><span data-ttu-id="46161-108">タスクの実行に関する情報です。</span><span class="sxs-lookup"><span data-stu-id="46161-108">Information about the execution of the task.</span></span></param>
        <summary>
            <span data-ttu-id="46161-109">TaskInformation クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="46161-109">Initializes a new instance of the TaskInformation class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ExecutionInfo">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46161-110">取得またはタスクの実行に関する情報を設定します。</span><span class="sxs-lookup"><span data-stu-id="46161-110">Gets or sets information about the execution of the task.</span></span>
            </summary>
    ...
    <Member MemberName="JobId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46161-111">取得またはタスクが属しているジョブの ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="46161-111">Gets or sets the ID of the job to which the task belongs.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubtaskId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46161-112">取得または場合は、タスクは、マルチ インスタンス タスク、サブタスクの ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="46161-112">Gets or sets the ID of the subtask if the task is a multi-instance task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TaskId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46161-113">取得またはタスクの ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="46161-113">Gets or sets the ID of the task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TaskState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46161-114">取得またはタスクの現在の状態を設定します。</span><span class="sxs-lookup"><span data-stu-id="46161-114">Gets or sets the current state of the task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>
            <span data-ttu-id="46161-115">使用可能な値が含まれます: 'active'、'準備'、'実行中'、'完了'</span><span class="sxs-lookup"><span data-stu-id="46161-115">Possible values include: 'active', 'preparing', 'running', 'completed'</span></span>
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="TaskUrl">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46161-116">取得またはタスクの URL を設定します。</span><span class="sxs-lookup"><span data-stu-id="46161-116">Gets or sets the URL of the task.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46161-117">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="46161-117">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="46161-118">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="46161-118">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
