<Type Name="Ecdsa256" FullName="Microsoft.Azure.KeyVault.Cryptography.Algorithms.Ecdsa256">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="127d8-101">ジェネリックの 256 ビット曲線 ECDSA を表します。</span><span class="sxs-lookup"><span data-stu-id="127d8-101">Represents ECDSA with a generic 256 bit curve.</span></span>
            </summary>
