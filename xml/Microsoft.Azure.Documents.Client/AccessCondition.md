<Type Name="AccessCondition" FullName="Microsoft.Azure.Documents.Client.AccessCondition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4a7ae-101">Azure Cosmos DB サービスの操作をするためのアクセス条件のセットを表します。</span><span class="sxs-lookup"><span data-stu-id="4a7ae-101">Represents a set of access conditions to be used for operations in the Azure Cosmos DB service.</span></span>
            </summary>
    ...
    <example>
            <span data-ttu-id="4a7ae-102">次の例では、DocumentClient で AccessCondition を使用する方法を示します。</span><span class="sxs-lookup"><span data-stu-id="4a7ae-102">The following example shows how to use AccessCondition with DocumentClient.</span></span>
  ...
  <Members>
    ...
    <Member MemberName="Condition">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4a7ae-103">取得または Azure Cosmos DB サービスの条件の値を設定します。</span><span class="sxs-lookup"><span data-stu-id="4a7ae-103">Gets or sets the value of the condition in the Azure Cosmos DB service.</span></span>
            </summary>
        <value>
            <span data-ttu-id="4a7ae-104">現在の状態の値です。</span><span class="sxs-lookup"><span data-stu-id="4a7ae-104">The value of the condition.</span></span> <span data-ttu-id="4a7ae-105"><see cref="T:Microsoft.Azure.Documents.Client.AccessConditionType" /> IfMatch IfNotMatch は、これは ETag と比較するためにあります。</span><span class="sxs-lookup"><span data-stu-id="4a7ae-105">For <see cref="T:Microsoft.Azure.Documents.Client.AccessConditionType" /> IfMatch and IfNotMatch, this is the ETag that has to be compared to.</span></span>
            </value>
        <remarks>To be added.</remarks>
        <altmember cref="T:Microsoft.Azure.Documents.Resource" />
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4a7ae-106">取得または Azure Cosmos DB サービスの条件の種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="4a7ae-106">Gets or sets the condition type in the Azure Cosmos DB service.</span></span>
            </summary>
        <value>
            <span data-ttu-id="4a7ae-107">条件の種類。</span><span class="sxs-lookup"><span data-stu-id="4a7ae-107">The condition type.</span></span> <span data-ttu-id="4a7ae-108">IfMatch または IfNoneMatch を指定できます。</span><span class="sxs-lookup"><span data-stu-id="4a7ae-108">Can be IfMatch or IfNoneMatch.</span></span>
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
