<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="887f6-101">仮想マシンのスケールのステージでは、リソース グループを指定できるように定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="887f6-101">The stage of a virtual machine scale set definition allowing to specify the resource group.</span></span>
            </summary>
