<Type Name="IWithManagedCreate" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithManagedCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d4016-101">作成して管理されているデータ ディスクを指定する特定の設定が可能で、VM スケール セットの最低限必要な入力すべてにはが含まれている定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="d4016-101">The stage of the definition which contains all the minimum required inputs for the VM scale set to be created and optionally allow managed data disks specific settings to be specified.</span></span>
            </summary>
