<Type Name="IWithUnmanagedDataDisk" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithUnmanagedDataDisk">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="62dda-101">仮想マシンのスケールのステージでは、アンマネージ データ ディスクを指定する定義が許可を設定します。</span><span class="sxs-lookup"><span data-stu-id="62dda-101">The stage of the virtual machine scale set definition allowing to specify unmanaged data disk.</span></span>
            </summary>
