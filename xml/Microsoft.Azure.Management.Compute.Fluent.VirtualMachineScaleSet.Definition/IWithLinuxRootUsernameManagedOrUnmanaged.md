<Type Name="IWithLinuxRootUsernameManagedOrUnmanaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithLinuxRootUsernameManagedOrUnmanaged">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="52b88-101">Linux 仮想マシンのスケールのステージでは、SSH ルート ユーザーの名前を指定できるように定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="52b88-101">The stage of the Linux virtual machine scale set definition allowing to specify SSH root user name.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithRootUsername">
      ...
      <Docs>
        <param name="rootUserName"><span data-ttu-id="52b88-102">Linux ユーザー名の必要な命名規則に従ったルート ユーザーの名前。</span><span class="sxs-lookup"><span data-stu-id="52b88-102">A root user name following the required naming convention for Linux user names.</span></span></param>
        <summary>
            <span data-ttu-id="52b88-103">Linux 仮想マシンの SSH ルート ユーザー名を指定します。</span><span class="sxs-lookup"><span data-stu-id="52b88-103">Specifies the SSH root user name for the Linux virtual machine.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="52b88-104">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="52b88-104">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>