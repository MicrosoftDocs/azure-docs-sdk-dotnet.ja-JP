<Type Name="IWithLinuxCreateManagedOrUnmanaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSet.Definition.IWithLinuxCreateManagedOrUnmanaged">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9bd5e-101">Linux 仮想マシンのスケールのステージの設定を含むすべての最低限必要な入力を作成するリソースの定義を指定する省略可能なその他の設定も可能ですが。</span><span class="sxs-lookup"><span data-stu-id="9bd5e-101">The stage of a Linux virtual machine scale set definition which contains all the minimum required inputs for the resource to be created, but also allows for any other optional settings to be specified.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithSsh">
      ...
      <Docs>
        <param name="publicKey"><span data-ttu-id="9bd5e-102">PEM 形式での SSH 公開キー。</span><span class="sxs-lookup"><span data-stu-id="9bd5e-102">An SSH public key in the PEM format.</span></span></param>
        <summary>
            <span data-ttu-id="9bd5e-103">SSH 公開キーを指定します。</span><span class="sxs-lookup"><span data-stu-id="9bd5e-103">Specifies the SSH public key.</span></span>
            <span data-ttu-id="9bd5e-104">このメソッドを呼び出すたびでは、VM のパブリック キーの一覧に指定されたパブリック キーを追加します。</span><span class="sxs-lookup"><span data-stu-id="9bd5e-104">Each call to this method adds the given public key to the list of VM's public keys.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9bd5e-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="9bd5e-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithUnmanagedDisks">
      ...
      <Docs>
        ...
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9bd5e-106">仮想マシン スケール セットの定義をアンマネージ ディスクの次のステージに基づいています。</span><span class="sxs-lookup"><span data-stu-id="9bd5e-106">The next stage of a unmanaged disk based virtual machine scale set definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>