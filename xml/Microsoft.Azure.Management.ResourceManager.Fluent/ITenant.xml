<Type Name="ITenant" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.ITenant">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="43174-101">Azure のテナントの変更できないクライアント側表現。</span><span class="sxs-lookup"><span data-stu-id="43174-101">An immutable client-side representation of an Azure tenant.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="TenantId">
      ...
      <Docs>
        ...
        <value><span data-ttu-id="43174-102">テナントの UUID</span><span class="sxs-lookup"><span data-stu-id="43174-102">a UUID of the tenant</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
