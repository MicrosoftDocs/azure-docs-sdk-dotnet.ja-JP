<Type Name="IDefinition" FullName="Microsoft.Azure.Management.Compute.Fluent.Disk.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="711de-101">管理対象ディスクの定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="711de-101">The entirety of the managed disk definition.</span></span>
            </summary>
