<Type Name="UserCreateParametersInner" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.Models.UserCreateParametersInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f2235-101">新しい仕事や学校のアカウント ユーザーを作成するためのパラメーターを要求します。</span><span class="sxs-lookup"><span data-stu-id="f2235-101">Request parameters for creating a new work or school account user.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2235-102">UserCreateParametersInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="f2235-102">Initializes a new instance of the UserCreateParametersInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="AccountEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2235-103">取得またはアカウントが有効になっているかどうかを設定します。</span><span class="sxs-lookup"><span data-stu-id="f2235-103">Gets or sets whether the account is enabled.</span></span>
            </summary>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2235-104">取得またはユーザーの表示名を設定します。</span><span class="sxs-lookup"><span data-stu-id="f2235-104">Gets or sets the display name of the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ImmutableId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2235-105">この必須の設定を取得または使用するかどうか、フェデレーション ドメイン ユーザーの userPrincipalName (UPN) プロパティの新しいユーザー アカウントを作成するときに指定します。</span><span class="sxs-lookup"><span data-stu-id="f2235-105">Gets or sets this must be specified if you are using a federated domain for the user's userPrincipalName (UPN) property when creating a new user account.</span></span> <span data-ttu-id="f2235-106">内部設置型 Active Directory ユーザー アカウントを関連付ける Azure AD ユーザー オブジェクトに使用されます。</span><span class="sxs-lookup"><span data-stu-id="f2235-106">It is used to associate an on-premises Active Directory user account with their Azure AD user object.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MailNickname">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2235-107">取得またはユーザーのメールの別名を設定します。</span><span class="sxs-lookup"><span data-stu-id="f2235-107">Gets or sets the mail alias for the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PasswordProfile">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2235-108">取得または設定パスワード プロファイル</span><span class="sxs-lookup"><span data-stu-id="f2235-108">Gets or sets password Profile</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserPrincipalName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2235-109">取得または設定のユーザー プリンシパル名 (someuser@contoso.com)。</span><span class="sxs-lookup"><span data-stu-id="f2235-109">Gets or sets the user principal name (someuser@contoso.com).</span></span> <span data-ttu-id="f2235-110">テナントの確認済みドメインのいずれかでなければなりません。</span><span class="sxs-lookup"><span data-stu-id="f2235-110">It must contain one of the verified domains for the tenant.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f2235-111">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="f2235-111">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="f2235-112">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="f2235-112">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
