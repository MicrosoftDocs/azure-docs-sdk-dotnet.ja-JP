<Type Name="UserInner" FullName="Microsoft.Azure.Management.Graph.RBAC.Fluent.Models.UserInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="af9a4-101">Active Directory ユーザーの情報です。</span><span class="sxs-lookup"><span data-stu-id="af9a4-101">Active Directory user information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af9a4-102">UserInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="af9a4-102">Initializes a new instance of the UserInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af9a4-103">取得またはユーザーの表示名を設定します。</span><span class="sxs-lookup"><span data-stu-id="af9a4-103">Gets or sets the display name of the user.</span></span>
            </summary>
    ...
    <Member MemberName="Mail">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af9a4-104">取得またはユーザーのプライマリ電子メール アドレスを設定します。</span><span class="sxs-lookup"><span data-stu-id="af9a4-104">Gets or sets the primary email address of the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MailNickname">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af9a4-105">取得またはユーザーのメールの別名を設定します。</span><span class="sxs-lookup"><span data-stu-id="af9a4-105">Gets or sets the mail alias for the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ObjectId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af9a4-106">取得または設定オブジェクトの id です。</span><span class="sxs-lookup"><span data-stu-id="af9a4-106">Gets or sets the object ID.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ObjectType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af9a4-107">取得またはオブジェクトの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="af9a4-107">Gets or sets the object type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SignInName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af9a4-108">取得またはユーザーのサインイン名を設定します。</span><span class="sxs-lookup"><span data-stu-id="af9a4-108">Gets or sets the sign-in name of the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UserPrincipalName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="af9a4-109">取得またはユーザーのプリンシパル名を設定します。</span><span class="sxs-lookup"><span data-stu-id="af9a4-109">Gets or sets the principal name of the user.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
