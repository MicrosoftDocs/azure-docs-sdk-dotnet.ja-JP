<Type Name="VaultCreateOrUpdateParameters" FullName="Microsoft.Azure.Management.KeyVault.Models.VaultCreateOrUpdateParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="de17f-101">作成または資格情報コンテナーを更新するためのパラメーター</span><span class="sxs-lookup"><span data-stu-id="de17f-101">Parameters for creating or updating a vault</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de17f-102">VaultCreateOrUpdateParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="de17f-102">Initializes a new instance of the VaultCreateOrUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="location"><span data-ttu-id="de17f-103">Key vault を作成する必要が Azure のサポートされている場所です。</span><span class="sxs-lookup"><span data-stu-id="de17f-103">The supported Azure location where the key vault should be created.</span></span></param>
        <param name="properties"><span data-ttu-id="de17f-104">資格情報コンテナーのプロパティ</span><span class="sxs-lookup"><span data-stu-id="de17f-104">Properties of the vault</span></span></param>
        <param name="tags"><span data-ttu-id="de17f-105">Key vault に割り当てられるタグ。</span><span class="sxs-lookup"><span data-stu-id="de17f-105">The tags that will be assigned to the key vault.</span></span></param>
        <summary>
            <span data-ttu-id="de17f-106">VaultCreateOrUpdateParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="de17f-106">Initializes a new instance of the VaultCreateOrUpdateParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de17f-107">取得または、key vault を作成する必要がサポートされている Azure の場所を設定します。</span><span class="sxs-lookup"><span data-stu-id="de17f-107">Gets or sets the supported Azure location where the key vault should be created.</span></span>
            </summary>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de17f-108">取得または設定、資格情報コンテナーのプロパティ</span><span class="sxs-lookup"><span data-stu-id="de17f-108">Gets or sets properties of the vault</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de17f-109">取得またはキーの資格情報コンテナーに割り当てられるタグを設定します。</span><span class="sxs-lookup"><span data-stu-id="de17f-109">Gets or sets the tags that will be assigned to the key vault.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de17f-110">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="de17f-110">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="de17f-111">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="de17f-111">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
