<Type Name="IWithExistingPublicIPAddress&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasPublicIPAddress.UpdateDefinition.IWithExistingPublicIPAddress&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="9cd03-101">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="9cd03-101">The next stage of the definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="9cd03-102">関連付ける既存のパブリック IP アドレス リソースを許可する、定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="9cd03-102">The stage of the definition allowing to associate the resource with an existing public IP address.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithExistingPublicIPAddress">
      ...
      <Docs>
        <param name="publicIPAddress"><span data-ttu-id="9cd03-103">既存のパブリック IP アドレス。</span><span class="sxs-lookup"><span data-stu-id="9cd03-103">An existing public IP address.</span></span></param>
        <summary>
            <span data-ttu-id="9cd03-104">既存のパブリック IP アドレスをリソースに関連付けます。</span><span class="sxs-lookup"><span data-stu-id="9cd03-104">Associates an existing public IP address with the resource.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9cd03-105">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="9cd03-105">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithExistingPublicIPAddress">
      ...
      <Docs>
        <param name="resourceId"><span data-ttu-id="9cd03-106">既存のパブリック IP アドレスのリソース ID です。</span><span class="sxs-lookup"><span data-stu-id="9cd03-106">The resource ID of an existing public IP address.</span></span></param>
        <summary>
            <span data-ttu-id="9cd03-107">既存のパブリック IP アドレスをリソースに関連付けます。</span><span class="sxs-lookup"><span data-stu-id="9cd03-107">Associates an existing public IP address with the resource.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="9cd03-108">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="9cd03-108">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>