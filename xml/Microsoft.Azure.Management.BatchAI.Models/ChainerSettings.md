<Type Name="ChainerSettings" FullName="Microsoft.Azure.Management.BatchAI.Models.ChainerSettings">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0b8b2-101">チェイナーのジョブの設定を指定します。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-101">Specifies the settings for Chainer job.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b8b2-102">ChainerSettings クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-102">Initializes a new instance of the ChainerSettings class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="pythonScriptFilePath"><span data-ttu-id="0b8b2-103">ジョブを実行する python スクリプトのパスとファイル名。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-103">The path and file name of the python script to execute the job.</span></span></param>
        <param name="pythonInterpreterPath"><span data-ttu-id="0b8b2-104">Python インタープリターへのパス。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-104">The path to python interpreter.</span></span></param>
        <param name="commandLineArgs"><span data-ttu-id="0b8b2-105">Python スクリプトに渡される必要があるコマンドライン引数</span><span class="sxs-lookup"><span data-stu-id="0b8b2-105">Command line arguments that needs to be passed to the python script</span></span></param>
        <param name="processCount"><span data-ttu-id="0b8b2-106">MPI ランタイムに渡されるプロセス パラメーターの数です。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-106">Number of processes parameter that is passed to MPI runtime.</span></span></param>
        <summary>
            <span data-ttu-id="0b8b2-107">ChainerSettings クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-107">Initializes a new instance of the ChainerSettings class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CommandLineArgs">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b8b2-108">取得または設定すると、python スクリプトに渡される必要があるコマンドライン引数</span><span class="sxs-lookup"><span data-stu-id="0b8b2-108">Gets or sets command line arguments that needs to be passed to the python script</span></span>
            </summary>
    ...
    <Member MemberName="ProcessCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b8b2-109">取得または MPI ランタイムに渡されるプロセス パラメーターの数を設定します。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-109">Gets or sets number of processes parameter that is passed to MPI runtime.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>
            <span data-ttu-id="0b8b2-110">このプロパティの既定値が、nodeCount プロパティと等しい</span><span class="sxs-lookup"><span data-stu-id="0b8b2-110">The default value for this property is equal to nodeCount property</span></span>
            </remarks>
      </Docs>
    </Member>
    <Member MemberName="PythonInterpreterPath">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b8b2-111">取得または python インタープリターにパスを設定します。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-111">Gets or sets the path to python interpreter.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PythonScriptFilePath">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b8b2-112">取得またはジョブを実行するスクリプトを python のパスとファイル名を設定します。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-112">Gets or sets the path and file name of the python script to execute the job.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0b8b2-113">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-113">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="0b8b2-114">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="0b8b2-114">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
