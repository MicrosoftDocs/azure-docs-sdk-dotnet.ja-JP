<Type Name="IUpdateExternalEndpoint" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficManagerEndpoint.UpdateExternalEndpoint.IUpdateExternalEndpoint">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c1dac-101">親 traffic manager プロファイルのプロファイルの更新の一部としての外部エンドポイントの更新プログラムの全体です。</span><span class="sxs-lookup"><span data-stu-id="c1dac-101">The entirety of an external endpoint update as a part of parent traffic manager profile profile update.</span></span>
            </summary>
