<Type Name="AzureActiveDirectoryTokenProvider" FullName="Microsoft.ServiceBus.AzureActiveDirectoryTokenProvider">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="9e0ab-101">Service Bus、および Event Hubs の Azure Active Directory のトークン プロバイダーを表します。</span><span class="sxs-lookup"><span data-stu-id="9e0ab-101">Represents the Azure Active Directory token provider for the Service Bus and Event Hubs.</span></span></summary>
