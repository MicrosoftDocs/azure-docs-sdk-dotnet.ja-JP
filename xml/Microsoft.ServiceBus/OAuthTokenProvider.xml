<Type Name="OAuthTokenProvider" FullName="Microsoft.ServiceBus.OAuthTokenProvider">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="d0806-101">Service bus の認証トークンを提供します。</span><span class="sxs-lookup"><span data-stu-id="d0806-101">Provides authentication token for the service bus.</span></span></summary>
  ...
  <Members>
    <Member MemberName="BuildKey">
      ...
      <Docs>
        <param name="appliesTo"><span data-ttu-id="d0806-102">キーの適用されるプロバイダー。</span><span class="sxs-lookup"><span data-stu-id="d0806-102">The provider in which the key will be applied.</span></span></param>
        <param name="action"><span data-ttu-id="d0806-103">アクション。</span><span class="sxs-lookup"><span data-stu-id="d0806-103">The action.</span></span></param>
        <summary><span data-ttu-id="d0806-104">プロバイダーのキーを作成します。</span><span class="sxs-lookup"><span data-stu-id="d0806-104">Builds a key for the provider.</span></span></summary>
        <returns><span data-ttu-id="d0806-105">キーがあります。</span><span class="sxs-lookup"><span data-stu-id="d0806-105">A Key.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NormalizeAppliesTo">
      ...
      <Docs>
        <param name="appliesTo"><span data-ttu-id="d0806-106">正規化を適用するトークン プロバイダー。</span><span class="sxs-lookup"><span data-stu-id="d0806-106">The token provider where the normalization will be applied.</span></span></param>
        <summary><span data-ttu-id="d0806-107">トークン プロバイダーに正規化を適用します。</span><span class="sxs-lookup"><span data-stu-id="d0806-107">Applies normalization into the token provider.</span></span></summary>
        <returns><span data-ttu-id="d0806-108">正規化されたトークン プロバイダー。</span><span class="sxs-lookup"><span data-stu-id="d0806-108">The normalized token provider.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnBeginGetToken">
      ...
      <Docs>
        <param name="appliesTo"><span data-ttu-id="d0806-109">トークンが適用されるプロバイダー。</span><span class="sxs-lookup"><span data-stu-id="d0806-109">The provider in which the token will be applied.</span></span></param>
        <param name="action"><span data-ttu-id="d0806-110">アクション。</span><span class="sxs-lookup"><span data-stu-id="d0806-110">The action.</span></span></param>
        <param name="timeout"><span data-ttu-id="d0806-111">期間。</span><span class="sxs-lookup"><span data-stu-id="d0806-111">The duration.</span></span></param>
        <param name="callback"><span data-ttu-id="d0806-112">コールバック。</span><span class="sxs-lookup"><span data-stu-id="d0806-112">The callback.</span></span></param>
        <param name="state"><span data-ttu-id="d0806-113">操作の状態。</span><span class="sxs-lookup"><span data-stu-id="d0806-113">The state of the operation.</span></span></param>
        <summary><span data-ttu-id="d0806-114">プロバイダーが開始されると、トークンを取得します。</span><span class="sxs-lookup"><span data-stu-id="d0806-114">Retrieves a token when the provider begins.</span></span></summary>
        <returns><span data-ttu-id="d0806-115">操作の非同期の結果。</span><span class="sxs-lookup"><span data-stu-id="d0806-115">The asynchronous result of the operation.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnBeginGetWebToken">
      ...
      <Docs>
        <param name="appliesTo"><span data-ttu-id="d0806-116">プロバイダー web トークンが適用されます。</span><span class="sxs-lookup"><span data-stu-id="d0806-116">The provider in which the web token will be applied.</span></span></param>
        <param name="action"><span data-ttu-id="d0806-117">アクション。</span><span class="sxs-lookup"><span data-stu-id="d0806-117">The action.</span></span></param>
        <param name="timeout"><span data-ttu-id="d0806-118">期間。</span><span class="sxs-lookup"><span data-stu-id="d0806-118">The duration.</span></span></param>
        <param name="callback"><span data-ttu-id="d0806-119">コールバック。</span><span class="sxs-lookup"><span data-stu-id="d0806-119">The callback.</span></span></param>
        <param name="state"><span data-ttu-id="d0806-120">操作の状態。</span><span class="sxs-lookup"><span data-stu-id="d0806-120">The state of the operation.</span></span></param>
        <summary><span data-ttu-id="d0806-121">プロバイダーが開始されると、web トークンを取得します。</span><span class="sxs-lookup"><span data-stu-id="d0806-121">Retrieves a web token when the provider begins.</span></span></summary>
        <returns><span data-ttu-id="d0806-122">操作の非同期の結果。</span><span class="sxs-lookup"><span data-stu-id="d0806-122">The asynchronous result of the operation.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndGetToken">
      ...
      <Docs>
        <param name="result"><span data-ttu-id="d0806-123">操作の結果。</span><span class="sxs-lookup"><span data-stu-id="d0806-123">The result of the operation.</span></span></param>
        <param name="cacheUntil"><span data-ttu-id="d0806-124">データを格納するプロバイダーの期間です。</span><span class="sxs-lookup"><span data-stu-id="d0806-124">The duration for the provider to store data.</span></span></param>
        <summary><span data-ttu-id="d0806-125">プロバイダーの終了時に、トークンを取得します。</span><span class="sxs-lookup"><span data-stu-id="d0806-125">Retrieves a token when the provider ends.</span></span></summary>
        <returns><span data-ttu-id="d0806-126">取得したトークンです。</span><span class="sxs-lookup"><span data-stu-id="d0806-126">The retrieved token.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndGetWebToken">
      ...
      <Docs>
        <param name="result"><span data-ttu-id="d0806-127">操作の結果。</span><span class="sxs-lookup"><span data-stu-id="d0806-127">The result of the operation.</span></span></param>
        <param name="cacheUntil"><span data-ttu-id="d0806-128">データを格納するプロバイダーの期間です。</span><span class="sxs-lookup"><span data-stu-id="d0806-128">The duration for the provider to store data.</span></span></param>
        <summary><span data-ttu-id="d0806-129">プロバイダーの終了時に、web トークンを取得します。</span><span class="sxs-lookup"><span data-stu-id="d0806-129">Retrieves a web token when the provider ends.</span></span></summary>
        <returns><span data-ttu-id="d0806-130">取得したトークンです。</span><span class="sxs-lookup"><span data-stu-id="d0806-130">The retrieved token.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
