<Type Name="IUpdateDefinitionWithNewVhd&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineUnmanagedDataDisk.UpdateDefinitionWithNewVhd.IUpdateDefinitionWithNewVhd&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="e4b6a-101">この定義をアタッチした後に戻るに親の更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="e4b6a-101">The stage of the parent update to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="e4b6a-102">仮想マシンのスケールのアンマネージ データ ディスクの全体は、更新プログラムを設定します。</span><span class="sxs-lookup"><span data-stu-id="e4b6a-102">The entirety of a unmanaged data disk of a virtual machine scale set update.</span></span>
            </summary>
