<Type Name="ProvisioningStateDR" FullName="Microsoft.Azure.Management.ServiceBus.Models.ProvisioningStateDR">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="af03b-101">ProvisioningStateDR の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="af03b-101">Defines values for ProvisioningStateDR.</span></span>
            </summary>
