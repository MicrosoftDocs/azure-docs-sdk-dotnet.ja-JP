<Type Name="ISqlElasticPools" FullName="Microsoft.Azure.Management.Sql.Fluent.ISqlElasticPools">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="80e53-101">SQL 弾力性プールの管理 API へのエントリ ポイントです。</span><span class="sxs-lookup"><span data-stu-id="80e53-101">Entry point to SQL Elastic Pool management API.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="GetBySqlServer">
      ...
      <Docs>
        <param name="sqlServer"><span data-ttu-id="80e53-102">SQLServer のインスタンス。</span><span class="sxs-lookup"><span data-stu-id="80e53-102">The instance of SQLServer.</span></span></param>
        <param name="name"><span data-ttu-id="80e53-103">SQLElasticPool の名前。</span><span class="sxs-lookup"><span data-stu-id="80e53-103">The name of SQLElasticPool.</span></span></param>
        <summary>
            <span data-ttu-id="80e53-104">Sql Server インスタンスおよび SQLElasticPool 名に基づいて SQLElasticPool を取得します。</span><span class="sxs-lookup"><span data-stu-id="80e53-104">Gets the SQLElasticPool based on the SQLServer instance and SQLElasticPool name.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="80e53-105">SQLElasticPool の変更できない形式です。</span><span class="sxs-lookup"><span data-stu-id="80e53-105">An immutable representation of the SQLElasticPool.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="GetBySqlServer">
      ...
      <Docs>
        <param name="resourceGroup"><span data-ttu-id="80e53-106">リソース グループの名前。</span><span class="sxs-lookup"><span data-stu-id="80e53-106">The name of resource group.</span></span></param>
        <param name="sqlServerName"><span data-ttu-id="80e53-107">sql Server の名前。</span><span class="sxs-lookup"><span data-stu-id="80e53-107">The name of SQLServer.</span></span></param>
        <param name="name"><span data-ttu-id="80e53-108">SQLElasticPool の名前。</span><span class="sxs-lookup"><span data-stu-id="80e53-108">The name of SQLElasticPool.</span></span></param>
        <summary>
            <span data-ttu-id="80e53-109">リソース グループ名、sql Server 名および SQLElasticPool 名に基づいて SQLElasticPool を取得します。</span><span class="sxs-lookup"><span data-stu-id="80e53-109">Gets the SQLElasticPool based on the resource group name, SQLServer name and SQLElasticPool name.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="80e53-110">SQLElasticPool の変更できない形式です。</span><span class="sxs-lookup"><span data-stu-id="80e53-110">An immutable representation of the SQLElasticPool.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListBySqlServer">
      ...
      <Docs>
        <param name="sqlServer"><span data-ttu-id="80e53-111">SQLServer のインスタンス。</span><span class="sxs-lookup"><span data-stu-id="80e53-111">The instance of SQLServer.</span></span></param>
        <summary>
            <span data-ttu-id="80e53-112">SQLServer に基づく SQLElasticPool を取得します。</span><span class="sxs-lookup"><span data-stu-id="80e53-112">Gets the SQLElasticPool based on the SQLServer.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="80e53-113">SQLServer で SQLElasticPools の一覧。</span><span class="sxs-lookup"><span data-stu-id="80e53-113">The list of SQLElasticPools in a SQLServer.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListBySqlServer">
      ...
      <Docs>
        <param name="resourceGroupName"><span data-ttu-id="80e53-114">リソースを一覧表示するリソース グループの名前。</span><span class="sxs-lookup"><span data-stu-id="80e53-114">The name of the resource group to list the resources from.</span></span></param>
        <param name="sqlServerName"><span data-ttu-id="80e53-115">sql Server の名前。</span><span class="sxs-lookup"><span data-stu-id="80e53-115">The name of SQLServer.</span></span></param>
        <summary>
            <span data-ttu-id="80e53-116">指定されたリソース グループと sql Server で指定した型のリソースを一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="80e53-116">Lists resources of the specified type in the specified resource group and SQLServer.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="80e53-117">SQLServer で SQLElasticPools の一覧。</span><span class="sxs-lookup"><span data-stu-id="80e53-117">The list of SQLElasticPools in a SQLServer.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>