<Type Name="ISqlFirewallRules" FullName="Microsoft.Azure.Management.Sql.Fluent.ISqlFirewallRules">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="01b88-101">SQL FirewallRule 管理 API へのエントリ ポイントです。</span><span class="sxs-lookup"><span data-stu-id="01b88-101">Entry point to SQL FirewallRule management API.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="GetBySqlServer">
      ...
      <Docs>
        <param name="sqlServer"><span data-ttu-id="01b88-102">SQLServer のインスタンス。</span><span class="sxs-lookup"><span data-stu-id="01b88-102">The instance of SQLServer.</span></span></param>
        <param name="name"><span data-ttu-id="01b88-103">sql データベースの名前。</span><span class="sxs-lookup"><span data-stu-id="01b88-103">The name of SQLDatabase.</span></span></param>
        <summary>
            <span data-ttu-id="01b88-104">Sql Server インスタンスおよび FirewallRule 名に基づいて sql データベースを取得します。</span><span class="sxs-lookup"><span data-stu-id="01b88-104">Gets the SQLDatabase based on the SQLServer instance and FirewallRule name.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="01b88-105">Sql データベースの変更できない形式です。</span><span class="sxs-lookup"><span data-stu-id="01b88-105">An immutable representation of the SQLDatabase.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="GetBySqlServer">
      ...
      <Docs>
        <param name="resourceGroup"><span data-ttu-id="01b88-106">リソース グループの名前。</span><span class="sxs-lookup"><span data-stu-id="01b88-106">The name of resource group.</span></span></param>
        <param name="sqlServerName"><span data-ttu-id="01b88-107">sql Server の名前。</span><span class="sxs-lookup"><span data-stu-id="01b88-107">The name of SQLServer.</span></span></param>
        <param name="name"><span data-ttu-id="01b88-108">sql データベースの名前。</span><span class="sxs-lookup"><span data-stu-id="01b88-108">The name of SQLDatabase.</span></span></param>
        <summary>
            <span data-ttu-id="01b88-109">リソース グループ名、sql Server 名および FirewallRule 名に基づいて sql データベースを取得します。</span><span class="sxs-lookup"><span data-stu-id="01b88-109">Gets the SQLDatabase based on the resource group name, SQLServer name and FirewallRule name.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="01b88-110">Sql データベースの変更できない形式です。</span><span class="sxs-lookup"><span data-stu-id="01b88-110">An immutable representation of the SQLDatabase.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListBySqlServer">
      ...
      <Docs>
        <param name="sqlServer"><span data-ttu-id="01b88-111">SQLServer のインスタンス。</span><span class="sxs-lookup"><span data-stu-id="01b88-111">The instance of SQLServer.</span></span></param>
        <summary>
            <span data-ttu-id="01b88-112">SQLServer に基づいて sql データベースを取得します。</span><span class="sxs-lookup"><span data-stu-id="01b88-112">Gets the SQLDatabase based on the SQLServer.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="01b88-113">SQLServer で SQLDatabases の一覧。</span><span class="sxs-lookup"><span data-stu-id="01b88-113">The list of SQLDatabases in a SQLServer.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="ListBySqlServer">
      ...
      <Docs>
        <param name="resourceGroupName"><span data-ttu-id="01b88-114">リソースを一覧表示するリソース グループの名前。</span><span class="sxs-lookup"><span data-stu-id="01b88-114">The name of the resource group to list the resources from.</span></span></param>
        <param name="sqlServerName"><span data-ttu-id="01b88-115">sql Server の名前。</span><span class="sxs-lookup"><span data-stu-id="01b88-115">The name of SQLServer.</span></span></param>
        <summary>
            <span data-ttu-id="01b88-116">指定されたリソース グループと sql Server で指定した型のリソースを一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="01b88-116">Lists resources of the specified type in the specified resource group and SQLServer.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="01b88-117">SQLServer で SQLDatabases の一覧。</span><span class="sxs-lookup"><span data-stu-id="01b88-117">The list of SQLDatabases in a SQLServer.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>