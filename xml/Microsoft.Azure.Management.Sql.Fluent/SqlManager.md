<Type Name="SqlManager" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlManager">
  ...
  <Members>
    ...
    <Member MemberName="Authenticate">
      ...
      <Docs>
        <param name="restClient"> <span data-ttu-id="4f98e-101">API 呼び出しに使用する RestClient</span><span class="sxs-lookup"><span data-stu-id="4f98e-101">the RestClient to be used for API calls</span></span></param>
        <param name="subscriptionId"> <span data-ttu-id="4f98e-102">サブスクリプション</span><span class="sxs-lookup"><span data-stu-id="4f98e-102">the subscription</span></span></param>
        <summary>
            <span data-ttu-id="4f98e-103">Sql 管理 API エントリ ポイントを公開する SqlManager のインスタンスを作成します。</span><span class="sxs-lookup"><span data-stu-id="4f98e-103">Creates an instance of SqlManager that exposes Sql management API entry points.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="4f98e-104">SqlManager</span><span class="sxs-lookup"><span data-stu-id="4f98e-104">The SqlManager</span></span></return>
      </Docs>
    </Member>
