<Type Name="IWithConfigurations" FullName="Microsoft.Azure.Management.KeyVault.Fluent.Vault.Definition.IWithConfigurations">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6ade9-101">設定するさまざまな構成を許可する資格情報コンテナーの定義。</span><span class="sxs-lookup"><span data-stu-id="6ade9-101">A key vault definition allowing various configurations to be set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithDeploymentDisabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ade9-102">Key vault からシークレットとして格納されている証明書を取得する Azure の仮想マシンを無効にします。</span><span class="sxs-lookup"><span data-stu-id="6ade9-102">Disable Azure Virtual Machines to retrieve certificates stored as secrets from the key vault.</span></span>
            </summary>
        <returns><span data-ttu-id="6ade9-103">資格情報コンテナー定義の次のステージ</span><span class="sxs-lookup"><span data-stu-id="6ade9-103">the next stage of key vault definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WithDeploymentEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ade9-104">Key vault からシークレットとして格納されている証明書を取得する Azure の仮想マシンを有効にします。</span><span class="sxs-lookup"><span data-stu-id="6ade9-104">Enable Azure Virtual Machines to retrieve certificates stored as secrets from the key vault.</span></span>
            </summary>
        <returns><span data-ttu-id="6ade9-105">資格情報コンテナー定義の次のステージ</span><span class="sxs-lookup"><span data-stu-id="6ade9-105">the next stage of key vault definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WithDiskEncryptionDisabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ade9-106">Vault からシークレットを取得し、キーのラップを解除する Azure ディスクの暗号化を無効にします。</span><span class="sxs-lookup"><span data-stu-id="6ade9-106">Disable Azure Disk Encryption to retrieve secrets from the vault and unwrap keys.</span></span>
            </summary>
        <returns><span data-ttu-id="6ade9-107">資格情報コンテナー定義の次のステージ</span><span class="sxs-lookup"><span data-stu-id="6ade9-107">the next stage of key vault definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WithDiskEncryptionEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ade9-108">Vault からシークレットを取得し、キーのラップを解除する Azure ディスクの暗号化を有効にします。</span><span class="sxs-lookup"><span data-stu-id="6ade9-108">Enable Azure Disk Encryption to retrieve secrets from the vault and unwrap keys.</span></span>
            </summary>
        <returns><span data-ttu-id="6ade9-109">資格情報コンテナー定義の次のステージ</span><span class="sxs-lookup"><span data-stu-id="6ade9-109">the next stage of key vault definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WithTemplateDeploymentDisabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ade9-110">Key vault からシークレットを取得する Azure Resource Manager を無効にします。</span><span class="sxs-lookup"><span data-stu-id="6ade9-110">Disable Azure Resource Manager to retrieve secrets from the key vault.</span></span>
            </summary>
        <returns><span data-ttu-id="6ade9-111">資格情報コンテナー定義の次のステージ</span><span class="sxs-lookup"><span data-stu-id="6ade9-111">the next stage of key vault definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WithTemplateDeploymentEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6ade9-112">Key vault からシークレットを取得する Azure Resource Manager を有効にします。</span><span class="sxs-lookup"><span data-stu-id="6ade9-112">Enable Azure Resource Manager to retrieve secrets from the key vault.</span></span>
            </summary>
        <returns><span data-ttu-id="6ade9-113">資格情報コンテナー定義の次のステージ</span><span class="sxs-lookup"><span data-stu-id="6ade9-113">the next stage of key vault definition</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
