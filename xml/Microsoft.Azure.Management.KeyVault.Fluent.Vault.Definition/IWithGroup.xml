<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.KeyVault.Fluent.Vault.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ca3bd-101">リソース グループを設定できるように資格情報コンテナーの定義。</span><span class="sxs-lookup"><span data-stu-id="ca3bd-101">A key vault definition allowing resource group to be set.</span></span>
            </summary>
