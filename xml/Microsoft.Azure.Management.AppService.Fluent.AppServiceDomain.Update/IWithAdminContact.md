<Type Name="IWithAdminContact" FullName="Microsoft.Azure.Management.AppService.Fluent.AppServiceDomain.Update.IWithAdminContact">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="43553-101">許可を設定する管理者にお問い合わせください。 ドメイン定義します。</span><span class="sxs-lookup"><span data-stu-id="43553-101">A domain definition allowing admin contact to be set.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithAdminContact">
      ...
      <Docs>
        <param name="contact"><span data-ttu-id="43553-102">管理者に問い合わせてください。</span><span class="sxs-lookup"><span data-stu-id="43553-102">The admin contact.</span></span></param>
        <summary>
            <span data-ttu-id="43553-103">管理者の連絡先を指定します。</span><span class="sxs-lookup"><span data-stu-id="43553-103">Specify the admin contact.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="43553-104">ドメイン定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="43553-104">The next stage of domain definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>