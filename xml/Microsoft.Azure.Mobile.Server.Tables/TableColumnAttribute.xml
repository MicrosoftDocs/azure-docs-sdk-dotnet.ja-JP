<Type Name="TableColumnAttribute" FullName="Microsoft.Azure.Mobile.Server.Tables.TableColumnAttribute">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b73ca-101"><see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableColumnAttribute" />によって使用されるシステム プロパティを表すデータ モデルのプロパティに注釈を付けるに使用できる、<see cref="T:Microsoft.Azure.Mobile.Server.TableController`1" />です。</span><span class="sxs-lookup"><span data-stu-id="b73ca-101">The <see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableColumnAttribute" /> can be used to annotate data model properties that represent system properties used by the <see cref="T:Microsoft.Azure.Mobile.Server.TableController`1" />.</span></span> <span data-ttu-id="b73ca-102">指定することにより、id、バージョン、createdAt などの列として使用する列、さまざまなドメイン管理者は、特定のバックエンド ストアに最適なマッピングを提供するには、その情報を活用できます。</span><span class="sxs-lookup"><span data-stu-id="b73ca-102">By indicating which columns are the id, version, createdAt, etc. columns, the various domain managers can leverage that information to provide the best possible mapping to any particular backend store.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="columnType"><span data-ttu-id="b73ca-103"><see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableColumnType" />プロパティにこの属性が適用されます。</span><span class="sxs-lookup"><span data-stu-id="b73ca-103">The <see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableColumnType" /> for property this attribute is applied to.</span></span></param>
        <summary>
            <span data-ttu-id="b73ca-104">新しいインスタンスを初期化、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableColumnAttribute" />と、指定された<paramref name="columnType" />です。</span><span class="sxs-lookup"><span data-stu-id="b73ca-104">Initializes a new instance of the <see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableColumnAttribute" /> with a given <paramref name="columnType" />.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ColumnType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b73ca-105"><see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableColumnType" />プロパティにこの属性が適用されます。</span><span class="sxs-lookup"><span data-stu-id="b73ca-105">The <see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableColumnType" /> for property this attribute is applied to.</span></span>
            </summary>
    ...
    <Member MemberName="TableColumnAnnotation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b73ca-106">登録するときに、<see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableColumnAttribute" />と Entity Framework は、モデル ビルダー コード最初の規則を使用して、テーブル列の注釈の名前としてこの名前を使用します。</span><span class="sxs-lookup"><span data-stu-id="b73ca-106">When registering the <see cref="T:Microsoft.Azure.Mobile.Server.Tables.TableColumnAttribute" /> with Entity Framework using a model builder code first convention, use this name as the table column annotation name.</span></span> <span data-ttu-id="b73ca-107">参照してください<c>https://entityframework.codeplex.com/wikipage?title=Code%20First%20Annotations</c> Entity Framework の詳細については、最初の規則とコード コメントをコードします。</span><span class="sxs-lookup"><span data-stu-id="b73ca-107">See <c>https://entityframework.codeplex.com/wikipage?title=Code%20First%20Annotations</c> for more information about Entity Framework code first conventions and code annotations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
