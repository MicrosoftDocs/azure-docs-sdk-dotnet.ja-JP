<Type Name="TableControllerConfigProvider" FullName="Microsoft.Azure.Mobile.Server.Tables.TableControllerConfigProvider">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0b100-101">設定をカスタマイズ<see cref="T:Microsoft.Azure.Mobile.Server.TableController`1" />コント ローラーを派生します。</span><span class="sxs-lookup"><span data-stu-id="0b100-101">Customizes settings for <see cref="T:Microsoft.Azure.Mobile.Server.TableController`1" /> derived controllers.</span></span>
            </summary>
