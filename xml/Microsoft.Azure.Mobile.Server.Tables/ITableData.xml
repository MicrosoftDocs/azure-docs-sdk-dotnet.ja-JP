<Type Name="ITableData" FullName="Microsoft.Azure.Mobile.Server.Tables.ITableData">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="004ad-101"><see cref="T:Microsoft.Azure.Mobile.Server.Tables.ITableData" />特定のテーブルのデータ モデルのシステム プロパティをクライアントと通信するときにシリアル化する方法を示す抽象化を提供します。</span><span class="sxs-lookup"><span data-stu-id="004ad-101">The <see cref="T:Microsoft.Azure.Mobile.Server.Tables.ITableData" /> provides an abstraction indicating how the system properties for a given table data model are to be serialized when communicating with the clients.</span></span> <span data-ttu-id="004ad-102">システムのプロパティのシリアル化の uniform こと、クライアントは処理システム プロパティ一様プラットフォーム間でことを確認します。</span><span class="sxs-lookup"><span data-stu-id="004ad-102">The uniform serialization of system properties ensures that the clients can process the system properties uniformly across platforms.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CreatedAt">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="004ad-103">取得またはエンティティが作成された日時を設定します。</span><span class="sxs-lookup"><span data-stu-id="004ad-103">Gets or sets the date and time the entity was created.</span></span>
            </summary>
    ...
    <Member MemberName="Deleted">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="004ad-104">取得またはエンティティが削除されたかどうかを示す値を設定します。</span><span class="sxs-lookup"><span data-stu-id="004ad-104">Gets or sets a value indicating whether the entity has been deleted.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="004ad-105">取得またはこのエンティティの一意の ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="004ad-105">Gets or sets the unique ID for this entity.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UpdatedAt">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="004ad-106">取得またはエンティティが最後に変更された日時を設定します。</span><span class="sxs-lookup"><span data-stu-id="004ad-106">Gets or sets the date and time the entity was last modified.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="004ad-107">取得またはエンティティが更新されるたびに更新される一意のバージョン識別子を設定します。</span><span class="sxs-lookup"><span data-stu-id="004ad-107">Gets or sets the unique version identifier which is updated every time the entity is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
