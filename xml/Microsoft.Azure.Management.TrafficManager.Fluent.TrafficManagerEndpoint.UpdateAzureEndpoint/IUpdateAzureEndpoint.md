<Type Name="IUpdateAzureEndpoint" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficManagerEndpoint.UpdateAzureEndpoint.IUpdateAzureEndpoint">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7e7ff-101">親 traffic manager プロファイルのプロファイルの更新の一部としての Azure エンドポイントの更新プログラムの全体です。</span><span class="sxs-lookup"><span data-stu-id="7e7ff-101">The entirety of an Azure endpoint update as a part of parent traffic manager profile profile update.</span></span>
            </summary>
