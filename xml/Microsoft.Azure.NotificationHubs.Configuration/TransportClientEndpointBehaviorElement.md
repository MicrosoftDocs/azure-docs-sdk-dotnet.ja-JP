<Type Name="TransportClientEndpointBehaviorElement" FullName="Microsoft.Azure.NotificationHubs.Configuration.TransportClientEndpointBehaviorElement">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="840cc-102"><see cref="T:Microsoft.Azure.NotificationHubs.Configuration.TransportClientEndpointBehaviorElement" /> クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="840cc-102">Initializes a new instance of the <see cref="T:Microsoft.Azure.NotificationHubs.Configuration.TransportClientEndpointBehaviorElement" /> class.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BehaviorType">
      ...
      <Docs>
        <summary><span data-ttu-id="840cc-103">取得またはトランスポート クライアント エンドポイントの動作の型を設定します。</span><span class="sxs-lookup"><span data-stu-id="840cc-103">Gets or sets the behavior type for the transport client endpoint.</span></span></summary>
        <value><span data-ttu-id="840cc-104">トランスポート クライアント エンドポイントの動作の型。</span><span class="sxs-lookup"><span data-stu-id="840cc-104">The behavior type for the transport client endpoint.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyFrom">
      ...
      <Docs>
        <param name="from"><span data-ttu-id="840cc-105">コンテンツをコピーする構成要素。</span><span class="sxs-lookup"><span data-stu-id="840cc-105">The configuration element to copy the contents from.</span></span></param>
        <summary><span data-ttu-id="840cc-106">この構成要素に指定された構成要素の内容をコピーします。</span><span class="sxs-lookup"><span data-stu-id="840cc-106">Copies the contents of the specified configuration element to this configuration element.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CreateBehavior">
      ...
      <Parameters />
      <Docs>
        <summary><span data-ttu-id="840cc-107">新しいを返します<see cref="T:Microsoft.Azure.NotificationHubs.TransportClientEndpointBehavior" />この構成要素と同じ設定を持つオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="840cc-107">Returns a new <see cref="T:Microsoft.Azure.NotificationHubs.TransportClientEndpointBehavior" /> object with the same settings as this configuration element.</span></span></summary>
        <returns><span data-ttu-id="840cc-108">新しい<see cref="T:Microsoft.Azure.NotificationHubs.TransportClientEndpointBehavior" />この構成要素と同じ設定を持つオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="840cc-108">A new <see cref="T:Microsoft.Azure.NotificationHubs.TransportClientEndpointBehavior" /> object with the same settings as this configuration element.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary><span data-ttu-id="840cc-109">この構成要素に含まれるプロパティのコレクションを取得します。</span><span class="sxs-lookup"><span data-stu-id="840cc-109">Gets the collection of properties contained in this configuration element.</span></span></summary>
        <value><span data-ttu-id="840cc-110">この構成要素に含まれるプロパティのコレクション。</span><span class="sxs-lookup"><span data-stu-id="840cc-110">The collection of properties contained in this configuration element.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TokenProvider">
      ...
      <Docs>
        <summary><span data-ttu-id="840cc-111">取得またはバインド パラメーターとして使用されるトークン プロバイダーを設定します。</span><span class="sxs-lookup"><span data-stu-id="840cc-111">Gets or sets the token provider that is used as a binding parameter.</span></span></summary>
        <value><span data-ttu-id="840cc-112">バインド パラメーターとして使用されるトークン プロバイダー。</span><span class="sxs-lookup"><span data-stu-id="840cc-112">The token provider used as a binding parameter.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
