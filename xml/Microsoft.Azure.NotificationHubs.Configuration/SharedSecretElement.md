<Type Name="SharedSecretElement" FullName="Microsoft.Azure.NotificationHubs.Configuration.SharedSecretElement">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="68818-101">使用するように構成するサービスまたはクライアント エンドポイントの資格情報を指定する構成要素、<see cref="F:Microsoft.Azure.NotificationHubs.TransportClientCredentialType.SharedSecret" />資格情報の種類。</span><span class="sxs-lookup"><span data-stu-id="68818-101">A configuration element that specifies the credentials for a service or client endpoint that is configured to use the <see cref="F:Microsoft.Azure.NotificationHubs.TransportClientCredentialType.SharedSecret" /> credential type.</span></span></summary>
  ...
  <Members>
    <Member MemberName="CopyFrom">
      ...
      <Docs>
        <param name="source"><span data-ttu-id="68818-102">コピーされる共有シークレット構成要素。</span><span class="sxs-lookup"><span data-stu-id="68818-102">The shared secret configuration element to be copied.</span></span></param>
        <summary><span data-ttu-id="68818-103">この構成要素に指定した共有シークレット構成要素の内容をコピーします。</span><span class="sxs-lookup"><span data-stu-id="68818-103">Copies the contents of the specified shared secret configuration element to this configuration element.</span></span></summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IssuerName">
      ...
      <Docs>
        <summary><span data-ttu-id="68818-104">取得または発行者名を設定します。</span><span class="sxs-lookup"><span data-stu-id="68818-104">Gets or sets the issuer name.</span></span></summary>
        <value><span data-ttu-id="68818-105">発行者の名前。</span><span class="sxs-lookup"><span data-stu-id="68818-105">The issuer name.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IssuerSecret">
      ...
      <Docs>
        <summary><span data-ttu-id="68818-106">取得または発行者のシークレット キーを設定します。</span><span class="sxs-lookup"><span data-stu-id="68818-106">Gets or sets the issuer secret key.</span></span></summary>
        <value><span data-ttu-id="68818-107">発行者のシークレット キー。</span><span class="sxs-lookup"><span data-stu-id="68818-107">The issuer secret key.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary><span data-ttu-id="68818-108">発行者名と発行者のシークレット キーが含まれているこの構成要素のプロパティを取得します。</span><span class="sxs-lookup"><span data-stu-id="68818-108">Gets the properties of this configuration element that contain the issuer name and the issuer secret key.</span></span></summary>
        <value><span data-ttu-id="68818-109">発行者名と発行者のシークレット キーを含む、この構成要素のプロパティです。</span><span class="sxs-lookup"><span data-stu-id="68818-109">The properties of this configuration element that contain the issuer name and the issuer secret key.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TokenScope">
      ...
      <Docs>
        <summary><span data-ttu-id="68818-110">取得またはトークンのスコープを設定します。</span><span class="sxs-lookup"><span data-stu-id="68818-110">Gets or sets the token scope.</span></span></summary>
        <value><span data-ttu-id="68818-111">トークンのスコープです。</span><span class="sxs-lookup"><span data-stu-id="68818-111">The token scope.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
