<Type Name="Updates" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.Updates">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="46007-101">デバイスの更新プログラムのプロファイル。</span><span class="sxs-lookup"><span data-stu-id="46007-101">The updates profile of a device.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46007-102">更新プログラムのクラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="46007-102">Initializes a new instance of the Updates class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="46007-103">オブジェクトを一意に識別するパス ID です。</span><span class="sxs-lookup"><span data-stu-id="46007-103">The path ID that uniquely identifies the object.</span></span></param>
        <param name="name"><span data-ttu-id="46007-104">オブジェクトの名前。</span><span class="sxs-lookup"><span data-stu-id="46007-104">The name of the object.</span></span></param>
        <param name="type"><span data-ttu-id="46007-105">オブジェクトの階層型です。</span><span class="sxs-lookup"><span data-stu-id="46007-105">The hierarchical type of the object.</span></span></param>
        <param name="kind"><span data-ttu-id="46007-106">オブジェクトの種類。</span><span class="sxs-lookup"><span data-stu-id="46007-106">The Kind of the object.</span></span> <span data-ttu-id="46007-107">現在は Series8000 はサポートされています。</span><span class="sxs-lookup"><span data-stu-id="46007-107">Currently only Series8000 is supported.</span></span> <span data-ttu-id="46007-108">使用可能な値が含まれます: 'Series8000'</span><span class="sxs-lookup"><span data-stu-id="46007-108">Possible values include: 'Series8000'</span></span></param>
        <param name="regularUpdatesAvailable"><span data-ttu-id="46007-109">通常の更新プログラムがデバイスの使用可能な場合は 'true' に設定されます。</span><span class="sxs-lookup"><span data-stu-id="46007-109">Set to 'true' if regular updates are available for the device.</span></span></param>
        <param name="maintenanceModeUpdatesAvailable"><span data-ttu-id="46007-110">メンテナンス モードを使用可能な更新の場合は 'true' に設定します。</span><span class="sxs-lookup"><span data-stu-id="46007-110">Set to 'true' if maintenance mode update available.</span></span></param>
        <param name="isUpdateInProgress"><span data-ttu-id="46007-111">かどうか、更新が進行中かを示します。</span><span class="sxs-lookup"><span data-stu-id="46007-111">Indicates whether an update is in progress or not.</span></span></param>
        <param name="lastUpdatedTime"><span data-ttu-id="46007-112">前回の更新が完了した時刻。</span><span class="sxs-lookup"><span data-stu-id="46007-112">The time when the last update was completed.</span></span></param>
        <summary>
            <span data-ttu-id="46007-113">更新プログラムのクラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="46007-113">Initializes a new instance of the Updates class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsUpdateInProgress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46007-114">取得または設定するかどうか、更新が進行中かを示します。</span><span class="sxs-lookup"><span data-stu-id="46007-114">Gets or sets indicates whether an update is in progress or not.</span></span>
            </summary>
    ...
    <Member MemberName="LastUpdatedTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46007-115">取得または前回の更新が完了したときに時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="46007-115">Gets or sets the time when the last update was completed.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MaintenanceModeUpdatesAvailable">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46007-116">取得または設定可能な更新がメンテナンス モードの場合は 'true' に設定します。</span><span class="sxs-lookup"><span data-stu-id="46007-116">Gets or sets set to 'true' if maintenance mode update available.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RegularUpdatesAvailable">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="46007-117">取得または通常の更新プログラムがデバイスの使用可能な場合に、'true' に設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="46007-117">Gets or sets set to 'true' if regular updates are available for the device.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
