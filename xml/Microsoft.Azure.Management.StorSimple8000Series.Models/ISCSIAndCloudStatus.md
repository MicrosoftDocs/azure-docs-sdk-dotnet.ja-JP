<Type Name="ISCSIAndCloudStatus" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.ISCSIAndCloudStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="324d1-101">ISCSIAndCloudStatus の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="324d1-101">Defines values for ISCSIAndCloudStatus.</span></span>
            </summary>
