<Type Name="MonitoringStatus" FullName="Microsoft.Azure.Management.StorSimple8000Series.Models.MonitoringStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e30fe-101">MonitoringStatus の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="e30fe-101">Defines values for MonitoringStatus.</span></span>
            </summary>
