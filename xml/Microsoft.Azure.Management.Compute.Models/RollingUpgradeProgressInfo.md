<Type Name="RollingUpgradeProgressInfo" FullName="Microsoft.Azure.Management.Compute.Models.RollingUpgradeProgressInfo">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="31f4e-101">各アップグレードの状態のバーチャル マシン インスタンスの数に関する情報です。</span><span class="sxs-lookup"><span data-stu-id="31f4e-101">Information about the number of virtual machine instances in each upgrade state.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31f4e-102">RollingUpgradeProgressInfo クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="31f4e-102">Initializes a new instance of the RollingUpgradeProgressInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="successfulInstanceCount"><span data-ttu-id="31f4e-103">正常にアップグレードされたインスタンスの数。</span><span class="sxs-lookup"><span data-stu-id="31f4e-103">The number of instances that have been successfully upgraded.</span></span></param>
        <param name="failedInstanceCount"><span data-ttu-id="31f4e-104">正常にアップグレードに失敗したインスタンスの数。</span><span class="sxs-lookup"><span data-stu-id="31f4e-104">The number of instances that have failed to be upgraded successfully.</span></span></param>
        <param name="inProgressInstanceCount"><span data-ttu-id="31f4e-105">現在アップグレードされているインスタンスの数。</span><span class="sxs-lookup"><span data-stu-id="31f4e-105">The number of instances that are currently being upgraded.</span></span></param>
        <param name="pendingInstanceCount"><span data-ttu-id="31f4e-106">アップグレード対象としてがまだ開始されていないインスタンスの数。</span><span class="sxs-lookup"><span data-stu-id="31f4e-106">The number of instances that have not yet begun to be upgraded.</span></span></param>
        <summary>
            <span data-ttu-id="31f4e-107">RollingUpgradeProgressInfo クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="31f4e-107">Initializes a new instance of the RollingUpgradeProgressInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="FailedInstanceCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31f4e-108">正常にアップグレードに失敗したインスタンスの数を取得します。</span><span class="sxs-lookup"><span data-stu-id="31f4e-108">Gets the number of instances that have failed to be upgraded successfully.</span></span>
            </summary>
    ...
    <Member MemberName="InProgressInstanceCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31f4e-109">現在アップグレードされているインスタンスの数を取得します。</span><span class="sxs-lookup"><span data-stu-id="31f4e-109">Gets the number of instances that are currently being upgraded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PendingInstanceCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31f4e-110">アップグレード対象としてがまだ開始されていないインスタンスの数を取得します。</span><span class="sxs-lookup"><span data-stu-id="31f4e-110">Gets the number of instances that have not yet begun to be upgraded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SuccessfulInstanceCount">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31f4e-111">正常にアップグレードされたインスタンスの数を取得します。</span><span class="sxs-lookup"><span data-stu-id="31f4e-111">Gets the number of instances that have been successfully upgraded.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
