<Type Name="RunCommandDocument" FullName="Microsoft.Azure.Management.Compute.Models.RunCommandDocument">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="57c5b-101">コマンドの実行のプロパティについて説明します。</span><span class="sxs-lookup"><span data-stu-id="57c5b-101">Describes the properties of a Run Command.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="57c5b-102">RunCommandDocument クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="57c5b-102">Initializes a new instance of the RunCommandDocument class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="schema"><span data-ttu-id="57c5b-103">VM の実行コマンド スキーマです。</span><span class="sxs-lookup"><span data-stu-id="57c5b-103">The VM run command schema.</span></span></param>
        <param name="id"><span data-ttu-id="57c5b-104">VM の実行コマンド id。</span><span class="sxs-lookup"><span data-stu-id="57c5b-104">The VM run command id.</span></span></param>
        <param name="osType"><span data-ttu-id="57c5b-105">オペレーティング システムの種類。</span><span class="sxs-lookup"><span data-stu-id="57c5b-105">The Operating System type.</span></span> <span data-ttu-id="57c5b-106">使用可能な値が含まれます 'Windows'、'Linux'。</span><span class="sxs-lookup"><span data-stu-id="57c5b-106">Possible values include: 'Windows', 'Linux'</span></span></param>
        <param name="label"><span data-ttu-id="57c5b-107">VM の実行コマンドのラベル。</span><span class="sxs-lookup"><span data-stu-id="57c5b-107">The VM run command label.</span></span></param>
        <param name="description"><span data-ttu-id="57c5b-108">コマンドの説明を実行する VM です。</span><span class="sxs-lookup"><span data-stu-id="57c5b-108">The VM run command description.</span></span></param>
        <param name="script"><span data-ttu-id="57c5b-109">実行するスクリプトです。</span><span class="sxs-lookup"><span data-stu-id="57c5b-109">The script to be executed.</span></span></param>
        <param name="parameters"><span data-ttu-id="57c5b-110">スクリプトによって使用されるパラメーター。</span><span class="sxs-lookup"><span data-stu-id="57c5b-110">The parameters used by the script.</span></span></param>
        <summary>
            <span data-ttu-id="57c5b-111">RunCommandDocument クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="57c5b-111">Initializes a new instance of the RunCommandDocument class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="57c5b-112">取得またはスクリプトによって使用されるパラメーターを設定します。</span><span class="sxs-lookup"><span data-stu-id="57c5b-112">Gets or sets the parameters used by the script.</span></span>
            </summary>
    ...
    <Member MemberName="Script">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="57c5b-113">取得またはを実行するスクリプトを設定します。</span><span class="sxs-lookup"><span data-stu-id="57c5b-113">Gets or sets the script to be executed.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="57c5b-114">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="57c5b-114">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="57c5b-115">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="57c5b-115">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
