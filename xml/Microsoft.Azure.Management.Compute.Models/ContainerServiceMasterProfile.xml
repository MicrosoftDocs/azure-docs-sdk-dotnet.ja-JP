<Type Name="ContainerServiceMasterProfile" FullName="Microsoft.Azure.Management.Compute.Models.ContainerServiceMasterProfile">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="9f59b-101">コンテナー サービス マスター _ に対してプロファイル。</span><span class="sxs-lookup"><span data-stu-id="9f59b-101">Profile for the container service master.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9f59b-102">ContainerServiceMasterProfile クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="9f59b-102">Initializes a new instance of the ContainerServiceMasterProfile class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="dnsPrefix"><span data-ttu-id="9f59b-103">マスターの FQDN の作成に使用する DNS プレフィックス。</span><span class="sxs-lookup"><span data-stu-id="9f59b-103">DNS prefix to be used to create the FQDN for master.</span></span></param>
        <param name="count"><span data-ttu-id="9f59b-104">コンテナー サービスのクラスターにマスター (Vm) の数です。</span><span class="sxs-lookup"><span data-stu-id="9f59b-104">Number of masters (VMs) in the container service cluster.</span></span> <span data-ttu-id="9f59b-105">有効な値は 1、3、および 5 です。</span><span class="sxs-lookup"><span data-stu-id="9f59b-105">Allowed values are 1, 3, and 5.</span></span> <span data-ttu-id="9f59b-106">既定値は 1 です。</span><span class="sxs-lookup"><span data-stu-id="9f59b-106">The default value is 1.</span></span></param>
        <param name="fqdn"><span data-ttu-id="9f59b-107">マスターの fdqn のサンプルです。</span><span class="sxs-lookup"><span data-stu-id="9f59b-107">FDQN for the master.</span></span></param>
        <summary>
            <span data-ttu-id="9f59b-108">ContainerServiceMasterProfile クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="9f59b-108">Initializes a new instance of the ContainerServiceMasterProfile class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9f59b-109">取得またはコンテナー サービスのクラスターにマスター (Vm) の数を設定します。</span><span class="sxs-lookup"><span data-stu-id="9f59b-109">Gets or sets number of masters (VMs) in the container service cluster.</span></span> <span data-ttu-id="9f59b-110">有効な値は 1、3、および 5 です。</span><span class="sxs-lookup"><span data-stu-id="9f59b-110">Allowed values are 1, 3, and 5.</span></span> <span data-ttu-id="9f59b-111">既定値は 1 です。</span><span class="sxs-lookup"><span data-stu-id="9f59b-111">The default value is 1.</span></span>
            </summary>
    ...
    <Member MemberName="DnsPrefix">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9f59b-112">取得またはマスターに対応する FQDN を作成するために使用する DNS プレフィックスを設定します。</span><span class="sxs-lookup"><span data-stu-id="9f59b-112">Gets or sets DNS prefix to be used to create the FQDN for master.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Fqdn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9f59b-113">マスターの fdqn のサンプルを取得します。</span><span class="sxs-lookup"><span data-stu-id="9f59b-113">Gets FDQN for the master.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="9f59b-114">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="9f59b-114">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="9f59b-115">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="9f59b-115">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
