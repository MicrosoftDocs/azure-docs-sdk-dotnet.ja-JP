<Type Name="StatusLevelTypes" FullName="Microsoft.Azure.Management.Compute.Models.StatusLevelTypes">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="cede7-101">StatusLevelTypes の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="cede7-101">Defines values for StatusLevelTypes.</span></span>
            </summary>
