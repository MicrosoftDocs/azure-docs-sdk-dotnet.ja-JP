<Type Name="DiskCreateOptionTypes" FullName="Microsoft.Azure.Management.Compute.Models.DiskCreateOptionTypes">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d6462-101">DiskCreateOptionTypes の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="d6462-101">Defines values for DiskCreateOptionTypes.</span></span>
            </summary>
