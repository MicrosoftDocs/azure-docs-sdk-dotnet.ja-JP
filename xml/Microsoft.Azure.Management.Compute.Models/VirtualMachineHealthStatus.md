<Type Name="VirtualMachineHealthStatus" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineHealthStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b0fcf-101">VM の正常性状態です。</span><span class="sxs-lookup"><span data-stu-id="b0fcf-101">The health status of the VM.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0fcf-102">VirtualMachineHealthStatus クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b0fcf-102">Initializes a new instance of the VirtualMachineHealthStatus class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="status"><span data-ttu-id="b0fcf-103">仮想マシンのヘルス状態情報。</span><span class="sxs-lookup"><span data-stu-id="b0fcf-103">The health status information for the VM.</span></span></param>
        <summary>
            <span data-ttu-id="b0fcf-104">VirtualMachineHealthStatus クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b0fcf-104">Initializes a new instance of the VirtualMachineHealthStatus class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Status">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0fcf-105">仮想マシンのヘルス状態情報を取得します。</span><span class="sxs-lookup"><span data-stu-id="b0fcf-105">Gets the health status information for the VM.</span></span>
            </summary>
