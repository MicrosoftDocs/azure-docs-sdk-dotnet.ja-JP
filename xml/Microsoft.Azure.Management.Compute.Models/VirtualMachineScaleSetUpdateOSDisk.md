<Type Name="VirtualMachineScaleSetUpdateOSDisk" FullName="Microsoft.Azure.Management.Compute.Models.VirtualMachineScaleSetUpdateOSDisk">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5a780-101">仮想マシン スケール セットのオペレーティング システム ディスクの更新オブジェクトについて説明します。</span><span class="sxs-lookup"><span data-stu-id="5a780-101">Describes virtual machine scale set operating system disk Update Object.</span></span> <span data-ttu-id="5a780-102">VMSS OS ディスクの更新のために使用する必要があります。</span><span class="sxs-lookup"><span data-stu-id="5a780-102">This should be used for Updating VMSS OS Disk.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5a780-103">VirtualMachineScaleSetUpdateOSDisk クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="5a780-103">Initializes a new instance of the VirtualMachineScaleSetUpdateOSDisk class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="caching"><span data-ttu-id="5a780-104">キャッシュの型。</span><span class="sxs-lookup"><span data-stu-id="5a780-104">The caching type.</span></span> <span data-ttu-id="5a780-105">使用可能な値が含まれます 'None'、'ReadOnly'、'ReadWrite'。</span><span class="sxs-lookup"><span data-stu-id="5a780-105">Possible values include: 'None', 'ReadOnly', 'ReadWrite'</span></span></param>
        <param name="image"><span data-ttu-id="5a780-106">ソース ユーザー イメージ VirtualHardDisk です。</span><span class="sxs-lookup"><span data-stu-id="5a780-106">The Source User Image VirtualHardDisk.</span></span> <span data-ttu-id="5a780-107">仮想マシンへの接続に使用する前にこの VirtualHardDisk がコピーされます。</span><span class="sxs-lookup"><span data-stu-id="5a780-107">This VirtualHardDisk will be copied before using it to attach to the Virtual Machine.</span></span> <span data-ttu-id="5a780-108">SourceImage を指定すると、送信先 VirtualHardDisk が存在しない必要があります。</span><span class="sxs-lookup"><span data-stu-id="5a780-108">If SourceImage is provided, the destination VirtualHardDisk should not exist.</span></span></param>
        <param name="vhdContainers"><span data-ttu-id="5a780-109">仮想ハード ディスク コンテナーの一覧の uri。</span><span class="sxs-lookup"><span data-stu-id="5a780-109">The list of virtual hard disk container uris.</span></span></param>
        <param name="managedDisk"><span data-ttu-id="5a780-110">管理対象ディスクのパラメーターです。</span><span class="sxs-lookup"><span data-stu-id="5a780-110">The managed disk parameters.</span></span></param>
        <summary>
            <span data-ttu-id="5a780-111">VirtualMachineScaleSetUpdateOSDisk クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="5a780-111">Initializes a new instance of the VirtualMachineScaleSetUpdateOSDisk class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Caching">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5a780-112">取得またはキャッシュの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="5a780-112">Gets or sets the caching type.</span></span> <span data-ttu-id="5a780-113">使用可能な値が含まれます 'None'、'ReadOnly'、'ReadWrite'。</span><span class="sxs-lookup"><span data-stu-id="5a780-113">Possible values include: 'None', 'ReadOnly', 'ReadWrite'</span></span>
            </summary>
    ...
    <Member MemberName="Image">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5a780-114">取得またはソース ユーザー イメージ VirtualHardDisk を設定します。</span><span class="sxs-lookup"><span data-stu-id="5a780-114">Gets or sets the Source User Image VirtualHardDisk.</span></span> <span data-ttu-id="5a780-115">仮想マシンへの接続に使用する前にこの VirtualHardDisk がコピーされます。</span><span class="sxs-lookup"><span data-stu-id="5a780-115">This VirtualHardDisk will be copied before using it to attach to the Virtual Machine.</span></span> <span data-ttu-id="5a780-116">SourceImage を指定すると、送信先 VirtualHardDisk が存在しない必要があります。</span><span class="sxs-lookup"><span data-stu-id="5a780-116">If SourceImage is provided, the destination VirtualHardDisk should not exist.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ManagedDisk">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5a780-117">取得または管理対象ディスク パラメーターを設定します。</span><span class="sxs-lookup"><span data-stu-id="5a780-117">Gets or sets the managed disk parameters.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VhdContainers">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5a780-118">仮想ハード ディスク コンテナーの一覧を取得または uri。</span><span class="sxs-lookup"><span data-stu-id="5a780-118">Gets or sets the list of virtual hard disk container uris.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
