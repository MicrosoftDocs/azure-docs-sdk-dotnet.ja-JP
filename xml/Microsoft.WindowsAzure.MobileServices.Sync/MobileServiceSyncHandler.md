<Type Name="MobileServiceSyncHandler" FullName="Microsoft.WindowsAzure.MobileServices.Sync.MobileServiceSyncHandler">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3e15e-101">ハンドル テーブル操作エラーは、プッシュ完了結果。</span><span class="sxs-lookup"><span data-stu-id="3e15e-101">Handles table operation errors and push completion results.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ExecuteTableOperationAsync">
      ...
      <Docs>
        <param name="operation"><span data-ttu-id="3e15e-102">インスタンス<see cref="T:Microsoft.WindowsAzure.MobileServices.Sync.IMobileServiceTableOperation" />リモート テーブルの操作を表すです。</span><span class="sxs-lookup"><span data-stu-id="3e15e-102">Instance of <see cref="T:Microsoft.WindowsAzure.MobileServices.Sync.IMobileServiceTableOperation" /> that represents a remote table operation.</span></span></param>
        <summary>
            <span data-ttu-id="3e15e-103">リモート テーブルに対して 1 つのテーブル操作を実行するために呼び出されるメソッド。</span><span class="sxs-lookup"><span data-stu-id="3e15e-103">A method that is called to execute a single table operation against remote table.</span></span>
            </summary>
        <returns><span data-ttu-id="3e15e-104">操作が実行されたときに完了するタスクとエラーが処理されました。</span><span class="sxs-lookup"><span data-stu-id="3e15e-104">Task that completes when operation has been executed and errors have been handled.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnPushCompleteAsync">
      ...
      <Docs>
        <param name="result"><span data-ttu-id="3e15e-105"><see cref="T:Microsoft.WindowsAzure.MobileServices.Sync.MobileServicePushCompletionResult" /> のインスタンス。</span><span class="sxs-lookup"><span data-stu-id="3e15e-105">An instance of <see cref="T:Microsoft.WindowsAzure.MobileServices.Sync.MobileServicePushCompletionResult" /></span></span></param>
        <summary>
            <span data-ttu-id="3e15e-106">プッシュ操作が完了したときに呼び出されるメソッド。</span><span class="sxs-lookup"><span data-stu-id="3e15e-106">A method that is called when push operation has completed.</span></span>
            </summary>
        <returns><span data-ttu-id="3e15e-107">結果が処理されたときに完了するタスク。</span><span class="sxs-lookup"><span data-stu-id="3e15e-107">Task that completes when result has been handled.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
