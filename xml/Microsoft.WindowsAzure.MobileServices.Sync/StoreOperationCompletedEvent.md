<Type Name="StoreOperationCompletedEvent" FullName="Microsoft.WindowsAzure.MobileServices.Sync.StoreOperationCompletedEvent">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="31b2a-101">ローカル ストアに対する操作の完了時に発生するイベントを表します。</span><span class="sxs-lookup"><span data-stu-id="31b2a-101">Represents an event raised when an operation against the local store completes.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="EventName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31b2a-102">イベント名、ストアの操作を完了します。</span><span class="sxs-lookup"><span data-stu-id="31b2a-102">The store operation completed event name.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31b2a-103">イベントの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="31b2a-103">Gets the event name.</span></span>
            </summary>
    ...
    <Member MemberName="Operation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="31b2a-104">このイベントをトリガーした操作。</span><span class="sxs-lookup"><span data-stu-id="31b2a-104">The operation that triggered this event.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
