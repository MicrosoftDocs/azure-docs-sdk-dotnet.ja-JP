<Type Name="IStorageAccounts" FullName="Microsoft.Azure.Management.Storage.Fluent.IStorageAccounts">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fe5df-101">エントリは、記憶域アカウント管理 API をポイントします。</span><span class="sxs-lookup"><span data-stu-id="fe5df-101">Entry point for storage accounts management API.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="CheckNameAvailability">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="fe5df-102">チェックするアカウント名。</span><span class="sxs-lookup"><span data-stu-id="fe5df-102">The account name to check.</span></span></param>
        <summary>
            <span data-ttu-id="fe5df-103">アカウント名が有効であり、使用されていないことを確認します。</span><span class="sxs-lookup"><span data-stu-id="fe5df-103">Checks that account name is valid and is not in use.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="fe5df-104">名前が使用できるかどうかと以外の場合は、その他の情報です。</span><span class="sxs-lookup"><span data-stu-id="fe5df-104">Whether the name is available and other info if not.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="CheckNameAvailabilityAsync">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="fe5df-105">チェックするアカウント名。</span><span class="sxs-lookup"><span data-stu-id="fe5df-105">The account name to check.</span></span></param>
        <param name="cancellationToken">To be added.</param>
        <summary>
            <span data-ttu-id="fe5df-106">有効でありで使用されていない非同期的にそのアカウント名を確認します。</span><span class="sxs-lookup"><span data-stu-id="fe5df-106">Checks that account name is valid and is not in use asynchronously.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>
            <span data-ttu-id="fe5df-107">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです。)。</span><span class="sxs-lookup"><span data-stu-id="fe5df-107">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
        <return><span data-ttu-id="fe5df-108">名前が使用できるかどうかと以外の場合は、その他の情報です。</span><span class="sxs-lookup"><span data-stu-id="fe5df-108">Whether the name is available and other info if not.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>