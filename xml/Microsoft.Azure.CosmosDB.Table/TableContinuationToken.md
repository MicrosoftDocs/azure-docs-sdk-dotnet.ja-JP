<Type Name="TableContinuationToken" FullName="Microsoft.Azure.CosmosDB.Table.TableContinuationToken">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="14773-101">一覧作成操作の継続トークンを表します。</span><span class="sxs-lookup"><span data-stu-id="14773-101">Represents a continuation token for listing operations.</span></span> 
            </summary>
    <remarks><span data-ttu-id="14773-102">メソッドを使用して結果のセットの一部を返す可能性があります、<see cref="T:Microsoft.Azure.CosmosDB.Table.TableResultSegment" />オブジェクトも使用可能な結果の次のセットを返す、後続の呼び出しで使用できる継続トークンを返します。</span><span class="sxs-lookup"><span data-stu-id="14773-102">A method that may return a partial set of results via a <see cref="T:Microsoft.Azure.CosmosDB.Table.TableResultSegment" /> object also returns a continuation token, which can be used in a subsequent call to return the next set of available results.</span></span> </remarks>
  </Docs>
  <Members>
    ...
    <Member MemberName="GetSchema">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="14773-103">オブジェクトの XML 表現を取得します。</span><span class="sxs-lookup"><span data-stu-id="14773-103">Gets an XML representation of an object.</span></span>
            </summary>
        <returns>
            <span data-ttu-id="14773-104"><see cref="M:System.Xml.Serialization.IXmlSerializable.WriteXml(System.Xml.XmlWriter)" /> メソッドによって生成され <see cref="M:System.Xml.Serialization.IXmlSerializable.ReadXml(System.Xml.XmlReader)" /> メソッドによって処理されるオブジェクトの XML 表現を記述する <see cref="T:System.Xml.Schema.XmlSchema" />。</span><span class="sxs-lookup"><span data-stu-id="14773-104">An <see cref="T:System.Xml.Schema.XmlSchema" /> that describes the XML representation of the object that is produced by the <see cref="M:System.Xml.Serialization.IXmlSerializable.WriteXml(System.Xml.XmlWriter)" /> method and consumed by the <see cref="M:System.Xml.Serialization.IXmlSerializable.ReadXml(System.Xml.XmlReader)" /> method.</span></span>
            </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextPartitionKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="14773-105">取得または設定の次のパーティション キー<see cref="T:Microsoft.Azure.CosmosDB.Table.ITableEntity" />列挙操作します。</span><span class="sxs-lookup"><span data-stu-id="14773-105">Gets or sets the next partition key for <see cref="T:Microsoft.Azure.CosmosDB.Table.ITableEntity" /> enumeration operations.</span></span>
            </summary>
        <value><span data-ttu-id="14773-106">次のパーティション キーを表す文字列。</span><span class="sxs-lookup"><span data-stu-id="14773-106">A string containing the next partition key.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextRowKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="14773-107">取得または設定の次の行キー<see cref="T:Microsoft.Azure.CosmosDB.Table.ITableEntity" />列挙操作します。</span><span class="sxs-lookup"><span data-stu-id="14773-107">Gets or sets the next row key for <see cref="T:Microsoft.Azure.CosmosDB.Table.ITableEntity" /> enumeration operations.</span></span>
            </summary>
        <value><span data-ttu-id="14773-108">次の行キーを表す文字列。</span><span class="sxs-lookup"><span data-stu-id="14773-108">A string containing the next row key.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextTableName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="14773-109">[次へ] のテーブル名の取得または設定<see cref="T:Microsoft.Azure.CosmosDB.Table.ITableEntity" />列挙操作します。</span><span class="sxs-lookup"><span data-stu-id="14773-109">Gets or sets the next table name for <see cref="T:Microsoft.Azure.CosmosDB.Table.ITableEntity" /> enumeration operations.</span></span>
            </summary>
        <value><span data-ttu-id="14773-110">次の表の名前を含む文字列。</span><span class="sxs-lookup"><span data-stu-id="14773-110">A string containing the name of the next table.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReadXml">
      ...
      <Docs>
        <param name="reader"><span data-ttu-id="14773-111"><see cref="T:System.Xml.XmlReader" />継続トークンを逆シリアル化するストリームします。</span><span class="sxs-lookup"><span data-stu-id="14773-111">The <see cref="T:System.Xml.XmlReader" /> stream from which the continuation token is deserialized.</span></span></param>
        <summary>
            <span data-ttu-id="14773-112">XML 表現からシリアル化可能な継続トークンを生成します。</span><span class="sxs-lookup"><span data-stu-id="14773-112">Generates a serializable continuation token from its XML representation.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TargetLocation">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="14773-113">取得または継続トークンが適用される記憶域の場所を設定します。</span><span class="sxs-lookup"><span data-stu-id="14773-113">Gets or sets the storage location that the continuation token applies to.</span></span>
            </summary>
        <value><span data-ttu-id="14773-114"><see cref="T:Microsoft.Azure.Storage.StorageLocation" /> 列挙値。</span><span class="sxs-lookup"><span data-stu-id="14773-114">A <see cref="T:Microsoft.Azure.Storage.StorageLocation" /> enumeration value.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="WriteXml">
      ...
      <Docs>
        <param name="writer"><span data-ttu-id="14773-115"><see cref="T:System.Xml.XmlWriter" />ストリームの継続トークンのシリアル化します。</span><span class="sxs-lookup"><span data-stu-id="14773-115">The <see cref="T:System.Xml.XmlWriter" /> stream to which the continuation token is serialized.</span></span></param>
        <summary>
            <span data-ttu-id="14773-116">シリアル化可能な継続トークンを XML 表現に変換します。</span><span class="sxs-lookup"><span data-stu-id="14773-116">Converts a serializable continuation token into its XML representation.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
