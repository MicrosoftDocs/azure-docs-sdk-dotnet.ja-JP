<Type Name="FabricUpgradeOrchestrationServiceState" FullName="System.Fabric.FabricUpgradeOrchestrationServiceState">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="5d0c4-101">オーケストレーション サービスのアップグレードのサービスの状態をカプセル化します。</span><span class="sxs-lookup"><span data-stu-id="5d0c4-101">Encapsulates the service state of Upgrade Orchestration Service.</span></span></para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="CurrentCodeVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d0c4-102">コードの現在のバージョン</span><span class="sxs-lookup"><span data-stu-id="5d0c4-102">current code version</span></span>
            </summary>
    ...
    <Member MemberName="CurrentManifestVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d0c4-103">現在のマニフェスト バージョン</span><span class="sxs-lookup"><span data-stu-id="5d0c4-103">current manifest version</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PendingUpgradeType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d0c4-104">保留中のアップグレードの種類</span><span class="sxs-lookup"><span data-stu-id="5d0c4-104">pending upgrade type</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetCodeVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d0c4-105">ターゲット コード バージョン</span><span class="sxs-lookup"><span data-stu-id="5d0c4-105">target code version</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TargetManifestVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d0c4-106">ターゲットのマニフェスト バージョン</span><span class="sxs-lookup"><span data-stu-id="5d0c4-106">target manifest version</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
