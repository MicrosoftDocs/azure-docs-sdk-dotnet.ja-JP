<Type Name="UpgradeDomainState" FullName="System.Fabric.UpgradeDomainState">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="85f62-101">アップグレード ドメインの状態を列挙します。</span><span class="sxs-lookup"><span data-stu-id="85f62-101">Enumerates the states of an upgrade domain.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName="Completed">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="85f62-102">アップグレードが完了したことを示します。</span><span class="sxs-lookup"><span data-stu-id="85f62-102">Indicates that the upgrade is completed.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="InProgress">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="85f62-103">アップグレードが進行中であることを示します。</span><span class="sxs-lookup"><span data-stu-id="85f62-103">Indicates that the upgrade is in progress.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Invalid">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="85f62-104">このアップグレードが有効ではないことを示します。</span><span class="sxs-lookup"><span data-stu-id="85f62-104">Indicates that this upgrade is not valid.</span></span> <span data-ttu-id="85f62-105">無効な型であるすべての Service Fabric 列挙体。</span><span class="sxs-lookup"><span data-stu-id="85f62-105">All Service Fabric enumerations have the invalid type.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Pending">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="85f62-106">アップグレードが保留中ですが開始されていないことを示します。</span><span class="sxs-lookup"><span data-stu-id="85f62-106">Indicates that the upgrade is pending and has not started.</span></span></para>
        </summary>
      </Docs>
    </Member>
  </Members>
