<Type Name="HostType" FullName="System.Fabric.HostType">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="718c8-101">サービス マニフェストで指定されているコード パッケージのメイン エントリ ポイントのホストの種類。</span><span class="sxs-lookup"><span data-stu-id="718c8-101">The type of host for main entry point of a code package as specified in service manifest.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName="ContainerHost">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="718c8-102">ホストは、コンテナーです。</span><span class="sxs-lookup"><span data-stu-id="718c8-102">The host is a container.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="ExeHost">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="718c8-103">ホストは、実行可能ファイルです。</span><span class="sxs-lookup"><span data-stu-id="718c8-103">The host is an executable.</span></span></para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Invalid">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="718c8-104">ホストの種類が不明か無効です。</span><span class="sxs-lookup"><span data-stu-id="718c8-104">The type of host is not known or invalid.</span></span></para>
        </summary>
      </Docs>
    </Member>
  </Members>
