<Type Name="TestCommandType" FullName="System.Fabric.TestCommandType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="acf57-101">照会されたテスト コマンドのテスト コマンドの種類。</span><span class="sxs-lookup"><span data-stu-id="acf57-101">The test command type of the queried test command.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Invalid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="acf57-102">無効</span><span class="sxs-lookup"><span data-stu-id="acf57-102">Invalid</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="NodeTransition">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="acf57-103">テスト コマンドであるノードの移行コマンドを示します</span><span class="sxs-lookup"><span data-stu-id="acf57-103">Indicates the test command is for a node transition command</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="PartitionDataLoss">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="acf57-104">テスト コマンドであるデータが失われるコマンドを示します</span><span class="sxs-lookup"><span data-stu-id="acf57-104">Indicates the test command is for a data loss command</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="PartitionQuorumLoss">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="acf57-105">テスト コマンドがクォーラム損失コマンド</span><span class="sxs-lookup"><span data-stu-id="acf57-105">Indicates the test command is for a quorum loss command</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="PartitionRestart">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="acf57-106">テスト コマンドである再起動 partition コマンドを示します</span><span class="sxs-lookup"><span data-stu-id="acf57-106">Indicates the test command is for a restart partition command</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
