<Type Name="PartitionUpgradeSafetyCheck" FullName="System.Fabric.PartitionUpgradeSafetyCheck">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="79945-101">表す、<see cref="T:System.Fabric.UpgradeSafetyCheck" />パーティション用です。</span><span class="sxs-lookup"><span data-stu-id="79945-101">Represents the <see cref="T:System.Fabric.UpgradeSafetyCheck" /> for a partition.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName="PartitionId">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="79945-102">アップグレードの安全性チェックが実行しているパーティションの ID を取得します。</span><span class="sxs-lookup"><span data-stu-id="79945-102">Gets the ID of a partition that is undergoing a upgrade safety check.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="79945-103">アップグレードの安全性チェックが実行しているパーティションの ID。</span><span class="sxs-lookup"><span data-stu-id="79945-103">The ID of a partition that is undergoing a upgrade safety check.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
