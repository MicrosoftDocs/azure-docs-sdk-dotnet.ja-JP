<Type Name="IBlank" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.TopicAuthorizationRule.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7f42b-101">トピック承認ルールの定義の最初の段階です。</span><span class="sxs-lookup"><span data-stu-id="7f42b-101">The first stage of topic authorization rule definition.</span></span>
            </summary>
