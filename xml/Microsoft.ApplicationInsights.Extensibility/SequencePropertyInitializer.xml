<Type Name="SequencePropertyInitializer" FullName="Microsoft.ApplicationInsights.Extensibility.SequencePropertyInitializer">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4a262-101"><see cref="T:Microsoft.ApplicationInsights.Extensibility.ITelemetryInitializer" />を設定する<see cref="P:Microsoft.ApplicationInsights.Channel.ITelemetry.Sequence" />プロパティは、Microsoft 内部利用統計情報の Vortex エンドポイントに送信します。</span><span class="sxs-lookup"><span data-stu-id="4a262-101">An <see cref="T:Microsoft.ApplicationInsights.Extensibility.ITelemetryInitializer" /> that that populates <see cref="P:Microsoft.ApplicationInsights.Channel.ITelemetry.Sequence" /> property for the Microsoft internal telemetry sent to the Vortex endpoint.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Initialize">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="4a262-102">設定<see cref="P:Microsoft.ApplicationInsights.Channel.ITelemetry.Sequence" />一意の ID とシーケンス番号を使用します。</span><span class="sxs-lookup"><span data-stu-id="4a262-102">Populates <see cref="P:Microsoft.ApplicationInsights.Channel.ITelemetry.Sequence" /> with unique ID and sequential number.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
