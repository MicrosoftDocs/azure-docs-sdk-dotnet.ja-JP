<Type Name="IWithMaxSizeBytes" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlDatabase.Definition.IWithMaxSizeBytes">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3f28f-101">バイト単位でデータベースの最大サイズを設定する SQL データベースの定義。</span><span class="sxs-lookup"><span data-stu-id="3f28f-101">The SQL Database definition to set the Max Size in Bytes for database.</span></span>
            </summary>
    ...
    <Member MemberName="WithMaxSizeBytes">
      ...
      <Docs>
        <param name="maxSizeBytes">
            <span data-ttu-id="3f28f-102">Azure SQL データベースの最大サイズは、バイトで表現されます。</span><span class="sxs-lookup"><span data-stu-id="3f28f-102">Max size of the Azure SQL Database expressed in bytes.</span></span> <span data-ttu-id="3f28f-103">注: (各エディションで配置されている制限事項) だけでなく、次のサイズのみがサポートされて: {100 MB | 500 MB | 1 GB | 5 GB | 10 GB | 20 GB | 30 GB.</span><span class="sxs-lookup"><span data-stu-id="3f28f-103">Note: Only the following sizes are supported (in addition to limitations being placed on each edition): { 100 MB | 500 MB |1 GB | 5 GB | 10 GB | 20 GB | 30 GB …</span></span> <span data-ttu-id="3f28f-104">150 GB |200 GB しています.</span><span class="sxs-lookup"><span data-stu-id="3f28f-104">150 GB | 200 GB …</span></span> <span data-ttu-id="3f28f-105">500 GB}。</span><span class="sxs-lookup"><span data-stu-id="3f28f-105">500 GB }.</span></span>
            </param>
        <summary>
            <span data-ttu-id="3f28f-106">(バイト単位) SQL データベースの最大サイズを設定します。</span><span class="sxs-lookup"><span data-stu-id="3f28f-106">Sets the max size in bytes for SQL Database.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="3f28f-107">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="3f28f-107">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>