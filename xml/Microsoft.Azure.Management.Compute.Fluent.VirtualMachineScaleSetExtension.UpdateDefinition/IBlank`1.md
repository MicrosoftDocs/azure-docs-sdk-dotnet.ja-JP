<Type Name="IBlank&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSetExtension.UpdateDefinition.IBlank&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="4fffc-101">この定義をアタッチした後に戻るに親の更新の段階です。</span><span class="sxs-lookup"><span data-stu-id="4fffc-101">The stage of the parent update to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="4fffc-102">仮想マシンのスケールの最初の段階では、拡張機能の定義を設定します。</span><span class="sxs-lookup"><span data-stu-id="4fffc-102">The first stage of a virtual machine scale set extension definition.</span></span>
            </summary>
