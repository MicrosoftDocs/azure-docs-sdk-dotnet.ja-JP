<Type Name="TransportProtocolVersion" FullName="Microsoft.Azure.Management.DataFactories.Core.Registration.Models.TransportProtocolVersion">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fdfae-101">計算型トランスポート プロトコルのサポートされているすべてのバージョンを列挙します。</span><span class="sxs-lookup"><span data-stu-id="fdfae-101">The enum for all supported versions of the compute type transport protocol.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="V1">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fdfae-102">バージョン 1.0 - 計算型トランスポート プロトコルのプレビュー。</span><span class="sxs-lookup"><span data-stu-id="fdfae-102">Version 1.0-preview of the compute type transport protocol.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="V2">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fdfae-103">バージョン 2.0 - 計算型トランスポート プロトコルのプレビュー。</span><span class="sxs-lookup"><span data-stu-id="fdfae-103">Version 2.0-preview of the compute type transport protocol.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
