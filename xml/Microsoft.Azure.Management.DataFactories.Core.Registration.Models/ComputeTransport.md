<Type Name="ComputeTransport" FullName="Microsoft.Azure.Management.DataFactories.Core.Registration.Models.ComputeTransport">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="83ded-101">ComputeType との通信プロトコル定義します。</span><span class="sxs-lookup"><span data-stu-id="83ded-101">The protocol definition for communication with a ComputeType.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="83ded-102">ComputeTransport クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="83ded-102">Initializes a new instance of the ComputeTransport class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TransportProtocolVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="83ded-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="83ded-103">Optional.</span></span> <span data-ttu-id="83ded-104">ADF とユーザーのコンピューティング リソースのプロキシ サービス間の通信のトランスポート プロトコルのバージョン。</span><span class="sxs-lookup"><span data-stu-id="83ded-104">The version of the transport protocol for communication between ADF and the user's compute resource proxy service.</span></span>
            </summary>
