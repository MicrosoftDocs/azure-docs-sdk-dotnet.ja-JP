<Type Name="IWithFromImageCreateOptionsManagedOrUnmanaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.Definition.IWithFromImageCreateOptionsManagedOrUnmanaged">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4f0e9-101">イメージから仮想マシンが作成されるときに、さまざまな設定を含む仮想マシンの定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="4f0e9-101">The stage of a virtual machine definition containing various settings when virtual machine is created from image.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithUnmanagedDisks">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4f0e9-102">管理されていないディスクを使用することを指定します。</span><span class="sxs-lookup"><span data-stu-id="4f0e9-102">Specifies that unmanaged disks will be used.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="4f0e9-103">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="4f0e9-103">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>