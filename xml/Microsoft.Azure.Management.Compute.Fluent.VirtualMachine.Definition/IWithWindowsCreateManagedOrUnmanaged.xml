<Type Name="IWithWindowsCreateManagedOrUnmanaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.Definition.IWithWindowsCreateManagedOrUnmanaged">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="97451-101">管理されていないディスクを有効にする場合や管理対象ディスクのみを含む VM の定義を続行できるように Windows 仮想マシンの定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="97451-101">The stage of the Windows virtual machine definition allowing to enable unmanaged disks or continue the definition of the VM with managed disks only.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithUnmanagedDisks">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="97451-102">このバーチャル マシンでアンマネージのディスク サポートを有効にします。</span><span class="sxs-lookup"><span data-stu-id="97451-102">Enables unmanaged disk support on this virtual machine.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="97451-103">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="97451-103">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>