<Type Name="IWithWindowsCreateUnmanaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.Definition.IWithWindowsCreateUnmanaged">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ddd6e-101">リソースを作成するには、最低限必要な入力を含む Windows 仮想マシンの定義のステージを指定する省略可能なその他の設定も可能ですが。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-101">The stage of the Windows virtual machine definition which contains all the minimum required inputs for the resource to be created, but also allows for any other optional settings to be specified.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithoutAutoUpdate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ddd6e-102">自動更新を無効にすることを指定します。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-102">Specifies that automatic updates should be disabled.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="ddd6e-103">Windows VM の作成可能な定義を表す段階です。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-103">The stage representing creatable Windows VM definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithoutVMAgent">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ddd6e-104">VM エージェントをプロビジョニングされていないことを指定します。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-104">Specifies that VM Agent should not be provisioned.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="ddd6e-105">Windows VM の作成可能な定義を表す段階です。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-105">The stage representing creatable Windows VM definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithTimeZone">
      ...
      <Docs>
        <param name="timeZone"><span data-ttu-id="ddd6e-106">タイム ゾーン。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-106">The timezone.</span></span></param>
        <summary>
            <span data-ttu-id="ddd6e-107">タイム ゾーンを指定します。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-107">Specifies the time-zone.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="ddd6e-108">Windows VM の作成可能な定義を表す段階です。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-108">The stage representing creatable Windows VM definition.</span></span></return>
      </Docs>
    </Member>
    <Member MemberName="WithWinRM">
      ...
      <Docs>
        <param name="listener"><span data-ttu-id="ddd6e-109">WinRMListener です。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-109">The WinRMListener.</span></span></param>
        <summary>
            <span data-ttu-id="ddd6e-110">WINRM リスナーを指定します。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-110">Specifies the WINRM listener.</span></span>
            <span data-ttu-id="ddd6e-111">このメソッドを呼び出すたびでは、VM の WinRM リスナーのリストに指定されたリスナーを追加します。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-111">Each call to this method adds the given listener to the list of VM's WinRM listeners.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="ddd6e-112">Windows VM の作成可能な定義を表す段階です。</span><span class="sxs-lookup"><span data-stu-id="ddd6e-112">The stage representing creatable Windows VM definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>