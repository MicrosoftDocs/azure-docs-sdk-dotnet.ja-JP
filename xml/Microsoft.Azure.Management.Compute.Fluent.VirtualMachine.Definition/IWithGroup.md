<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3509a-101">リソース グループを指定できるように仮想マシンの定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="3509a-101">The stage of a virtual machine definition allowing to specify the resource group.</span></span>
            </summary>
