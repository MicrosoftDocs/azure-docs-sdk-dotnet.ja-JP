<Type Name="IWithFromImageCreateOptionsManaged" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachine.Definition.IWithFromImageCreateOptionsManaged">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="7c6ea-101">イメージから仮想マシンが作成されるときに、さまざまな設定を含む仮想マシンの定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="7c6ea-101">The stage of a virtual machine definition containing various settings when virtual machine is created from image.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithComputerName">
      ...
      <Docs>
        <param name="computerName"><span data-ttu-id="7c6ea-102">コンピューターの名前。</span><span class="sxs-lookup"><span data-stu-id="7c6ea-102">A name for the computer.</span></span></param>
        <summary>
            <span data-ttu-id="7c6ea-103">仮想マシンのコンピューター名を指定します。</span><span class="sxs-lookup"><span data-stu-id="7c6ea-103">Specifies the computer name for the virtual machine.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="7c6ea-104">定義の次のステージのステージ。</span><span class="sxs-lookup"><span data-stu-id="7c6ea-104">The next stage stage of the definition.</span></span></return>
      </Docs>
    </Member>
