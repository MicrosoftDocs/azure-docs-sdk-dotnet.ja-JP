<Type Name="OperationsExtensions" FullName="Microsoft.Azure.Management.Redis.OperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="47c88-101">操作の拡張メソッド。</span><span class="sxs-lookup"><span data-stu-id="47c88-101">Extension methods for Operations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="List">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="47c88-102">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="47c88-102">The operations group for this extension method.</span></span>
            </param>
        <summary>
            <span data-ttu-id="47c88-103">すべての Microsoft.Cache プロバイダーの使用可能な REST API 操作の一覧を表示します。</span><span class="sxs-lookup"><span data-stu-id="47c88-103">Lists all of the available REST API operations of the Microsoft.Cache provider.</span></span>
            </summary>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="47c88-104">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="47c88-104">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="47c88-105">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="47c88-105">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="47c88-106">すべての Microsoft.Cache プロバイダーの使用可能な REST API 操作の一覧を表示します。</span><span class="sxs-lookup"><span data-stu-id="47c88-106">Lists all of the available REST API operations of the Microsoft.Cache provider.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNext">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="47c88-107">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="47c88-107">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="47c88-108">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="47c88-108">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <summary>
            <span data-ttu-id="47c88-109">すべての Microsoft.Cache プロバイダーの使用可能な REST API 操作の一覧を表示します。</span><span class="sxs-lookup"><span data-stu-id="47c88-109">Lists all of the available REST API operations of the Microsoft.Cache provider.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="47c88-110">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="47c88-110">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="47c88-111">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="47c88-111">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="47c88-112">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="47c88-112">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="47c88-113">すべての Microsoft.Cache プロバイダーの使用可能な REST API 操作の一覧を表示します。</span><span class="sxs-lookup"><span data-stu-id="47c88-113">Lists all of the available REST API operations of the Microsoft.Cache provider.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
