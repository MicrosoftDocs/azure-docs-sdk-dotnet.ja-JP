<Type Name="IUpdate" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Subscription.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="71624-101">変更可能なすべての設定を含む、サブスクリプションの更新操作のテンプレートです。</span><span class="sxs-lookup"><span data-stu-id="71624-101">The template for a subscription update operation, containing all the settings that can be modified.</span></span>
            </summary>
