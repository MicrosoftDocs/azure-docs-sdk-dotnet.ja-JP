<Type Name="IDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.NetworkSecurityRule.Definition.IDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="e9c49-101">最終的な Attachable.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="e9c49-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="e9c49-102">ネットワーク セキュリティ ルールの定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="e9c49-102">The entirety of a network security rule definition.</span></span>
            </summary>
