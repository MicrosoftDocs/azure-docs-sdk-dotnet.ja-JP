<Type Name="NotificationHubJobStatus" FullName="Microsoft.Azure.NotificationHubs.NotificationHubJobStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ba741-101">通知ハブのジョブの状態を返します。</span><span class="sxs-lookup"><span data-stu-id="ba741-101">Returns the status of a Notification Hub Job.</span></span>
            </summary>
