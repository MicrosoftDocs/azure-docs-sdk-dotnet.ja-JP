<Type Name="SharedSecretTokenProvider" FullName="Microsoft.Azure.NotificationHubs.SharedSecretTokenProvider">
  ...
  <Interfaces />
  <Docs>
    <summary><span data-ttu-id="6a7c1-101">Web トークンのアサーションの名前/値ペアを返すし、非同期の共有シークレット トークン取得操作を実行するメソッドを提供します。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-101">Provides methods that return name/value pairs for web token assertions, and that execute asynchronous shared secret token retrieval operations.</span></span></summary>
  ...
  <Members>
    <Member MemberName="BuildKey">
      ...
      <Docs>
        <param name="appliesTo"><span data-ttu-id="6a7c1-102">アクセス トークンが適用される URI。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-102">The URI which the access token applies to.</span></span></param>
        <param name="action"><span data-ttu-id="6a7c1-103">要求された操作。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-103">The request action.</span></span></param>
        <summary><span data-ttu-id="6a7c1-104">トークン プロバイダーをキーを生成します。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-104">Generates a key for the token provider.</span></span></summary>
        <returns><span data-ttu-id="6a7c1-105">トークン プロバイダー用に生成されたキー。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-105">A generated key for the token provider.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ComputeSimpleWebTokenString">
      ...
      <Docs>
        <param name="issuerName"><span data-ttu-id="6a7c1-106">発行者の名前。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-106">The issuer name.</span></span></param>
        <param name="issuerSecret"><span data-ttu-id="6a7c1-107">発行者のシークレット。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-107">The issuer secret.</span></span></param>
        <summary><span data-ttu-id="6a7c1-108">URL の文字列エンコードの指定した発行者名と発行者のシークレットを使用して、単純な web トークン アサーションの名前/値ペアを返します。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-108">Returns a string of URL encoded name/value pairs for a simple web token assertion using the specified issuer name and issuer secret.</span></span></summary>
        <returns><span data-ttu-id="6a7c1-109">URL は、単純な web トークン アサーションの名前/値ペアをエンコードします。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-109">A URL encoded name/value pairs for a simple web token assertion.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ComputeSimpleWebTokenString">
      ...
      <Docs>
        <param name="issuerName"><span data-ttu-id="6a7c1-110">発行者の名前。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-110">The issuer name.</span></span></param>
        <param name="issuerSecret"><span data-ttu-id="6a7c1-111">発行者のシークレット。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-111">The issuer secret.</span></span></param>
        <summary><span data-ttu-id="6a7c1-112">URL の文字列エンコードの指定した発行者名と発行者のシークレットを使用して、単純な web トークン アサーションの名前/値ペアを返します。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-112">Returns a string of URL encoded name/value pairs for a simple web token assertion using the specified issuer name and issuer secret.</span></span></summary>
        <returns><span data-ttu-id="6a7c1-113">URL は、単純な web トークン アサーションの名前/値ペアをエンコードします。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-113">A URL encoded name/value pairs for a simple web token assertion.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnBeginGetToken">
      ...
      <Docs>
        <param name="appliesTo"><span data-ttu-id="6a7c1-114">アクセス トークンが適用される URI。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-114">The URI which the access token applies to.</span></span></param>
        <param name="action"><span data-ttu-id="6a7c1-115">要求された操作。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-115">The request action.</span></span></param>
        <param name="timeout"><span data-ttu-id="6a7c1-116">セキュリティ トークンを取得するメッセージのタイムアウト値を指定する時間間隔。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-116">The time span that specifies the timeout value for the message that gets the security token.</span></span></param>
        <param name="callback"><span data-ttu-id="6a7c1-117">操作の完了時に呼び出すメソッドを参照する <see cref="T:System.AsyncCallback" /> デリゲート。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-117">An <see cref="T:System.AsyncCallback" /> delegate that references the method to invoke when the operation is complete.</span></span></param>
        <param name="state"><span data-ttu-id="6a7c1-118">非同期操作に関する状態情報を含むユーザー定義のオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-118">A user-defined object that contains state information about the asynchronous operation.</span></span></param>
        <summary><span data-ttu-id="6a7c1-119">Begin get トークン アクションを実行します。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-119">Executes the begin get token action.</span></span></summary>
        <returns><span data-ttu-id="6a7c1-120"><see cref="T:System.IAsyncResult" />トークンを取得する非同期操作を参照するオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-120">An <see cref="T:System.IAsyncResult" /> object that references the asynchronous operation to get a token.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnBeginGetWebToken">
      ...
      <Docs>
        <param name="appliesTo"><span data-ttu-id="6a7c1-121">アクセス トークンが適用される URI。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-121">The URI which the access token applies to.</span></span></param>
        <param name="action"><span data-ttu-id="6a7c1-122">要求された操作。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-122">The request action.</span></span></param>
        <param name="timeout"><span data-ttu-id="6a7c1-123">セキュリティ トークンを取得するメッセージのタイムアウト値を指定する時間間隔。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-123">The time span that specifies the timeout value for the message that gets the security token.</span></span></param>
        <param name="callback"><span data-ttu-id="6a7c1-124">操作の完了時に呼び出すメソッドを参照する <see cref="T:System.AsyncCallback" /> デリゲート。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-124">An <see cref="T:System.AsyncCallback" /> delegate that references the method to invoke when the operation is complete.</span></span></param>
        <param name="state"><span data-ttu-id="6a7c1-125">非同期操作に関する状態情報を含むユーザー定義のオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-125">A user-defined object that contains state information about the asynchronous operation.</span></span></param>
        <summary><span data-ttu-id="6a7c1-126">Begin get web トークンのアクションを実行します。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-126">Executes the begin get web token action.</span></span></summary>
        <returns><span data-ttu-id="6a7c1-127"><see cref="T:System.IAsyncResult" /> Web トークンを取得する非同期操作を参照するオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-127">An <see cref="T:System.IAsyncResult" /> object that references the asynchronous operation to get a web token.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndGetToken">
      ...
      <Docs>
        <param name="result"><span data-ttu-id="6a7c1-128"><see cref="T:System.IAsyncResult" />トークンを取得する非同期操作を参照するオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-128">An <see cref="T:System.IAsyncResult" /> object that references the asynchronous operation to get a token.</span></span></param>
        <param name="cacheUntil"><span data-ttu-id="6a7c1-129">このメソッドが戻るとき、有効期限の日付と時刻、キャッシュ内のトークンの情報が含まれています。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-129">When this method returns, contains the expiration date and time of the token information in the cache.</span></span></param>
        <summary><span data-ttu-id="6a7c1-130">最後の get トークン アクションを実行します。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-130">Executes the end get token action.</span></span></summary>
        <returns><span data-ttu-id="6a7c1-131">セキュリティ トークン。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-131">The security token.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="OnEndGetWebToken">
      ...
      <Docs>
        <param name="result"><span data-ttu-id="6a7c1-132"><see cref="T:System.IAsyncResult" /> Web トークンを取得する非同期操作を参照するオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-132">An <see cref="T:System.IAsyncResult" /> object that references the asynchronous operation to get a web token.</span></span></param>
        <param name="cacheUntil"><span data-ttu-id="6a7c1-133">このメソッドが戻るとき、有効期限の日付と時刻、キャッシュ内のトークンの情報が含まれています。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-133">When this method returns, contains the expiration date and time of the token information in the cache.</span></span></param>
        <summary><span data-ttu-id="6a7c1-134">End get web トークンのアクションを実行します。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-134">Executes the end get web token action.</span></span></summary>
        <returns><span data-ttu-id="6a7c1-135">Web トークンです。</span><span class="sxs-lookup"><span data-stu-id="6a7c1-135">The web token.</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
