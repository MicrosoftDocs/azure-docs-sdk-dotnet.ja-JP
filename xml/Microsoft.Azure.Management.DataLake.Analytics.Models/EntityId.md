<Type Name="EntityId" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.EntityId">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="844a5-101">Data Lake Analytics カタログ エンティティ識別子オブジェクト。</span><span class="sxs-lookup"><span data-stu-id="844a5-101">A Data Lake Analytics catalog entity identifier object.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="844a5-102">EntityId クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="844a5-102">Initializes a new instance of the EntityId class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="844a5-103">このデータベース、スキーマとテーブルに関連付けられている外部テーブルの名前。</span><span class="sxs-lookup"><span data-stu-id="844a5-103">the name of the external table associated with this database, schema and table.</span></span></param>
        <param name="version"><span data-ttu-id="844a5-104">外部データ ソースのバージョン。</span><span class="sxs-lookup"><span data-stu-id="844a5-104">the version of the external data source.</span></span></param>
        <summary>
            <span data-ttu-id="844a5-105">EntityId クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="844a5-105">Initializes a new instance of the EntityId class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="844a5-106">取得またはこのデータベース、スキーマとテーブルに関連付けられている外部テーブルの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="844a5-106">Gets or sets the name of the external table associated with this database, schema and table.</span></span>
            </summary>
    ...
    <Member MemberName="Version">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="844a5-107">取得または外部データ ソースのバージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="844a5-107">Gets or sets the version of the external data source.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
