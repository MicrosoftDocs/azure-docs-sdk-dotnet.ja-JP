<Type Name="DataLakeAnalyticsAccountStatus" FullName="Microsoft.Azure.Management.DataLake.Analytics.Models.DataLakeAnalyticsAccountStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0e98a-101">DataLakeAnalyticsAccountStatus の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="0e98a-101">Defines values for DataLakeAnalyticsAccountStatus.</span></span>
            </summary>
