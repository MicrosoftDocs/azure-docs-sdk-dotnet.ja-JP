<Type Name="IRecoveryServicesClient" FullName="Microsoft.Azure.Management.RecoveryServices.IRecoveryServicesClient">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e5ead-101">回復サービス クライアントの複合 Swagger</span><span class="sxs-lookup"><span data-stu-id="e5ead-101">Composite Swagger for Recovery Services Client</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AcceptLanguage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-102">取得または応答の優先言語を設定します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-102">Gets or sets the preferred language for the response.</span></span>
            </summary>
    ...
    <Member MemberName="BackupStorageConfigs">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-103">IBackupStorageConfigsOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-103">Gets the IBackupStorageConfigsOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BackupVaultConfigs">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-104">IBackupVaultConfigsOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-104">Gets the IBackupVaultConfigsOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="BaseUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-105">サービスのベース URI。</span><span class="sxs-lookup"><span data-stu-id="e5ead-105">The base URI of the service.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Credentials">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-106">Azure に接続するクライアントに必要な資格情報です。</span><span class="sxs-lookup"><span data-stu-id="e5ead-106">Credentials needed for the client to connect to Azure.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DeserializationSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-107">取得または json に逆シリアル化の設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-107">Gets or sets json deserialization settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GenerateClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-108">設定すると、一意の x ms-クライアントの要求 id 値を true に生成され、各要求に含まれます。</span><span class="sxs-lookup"><span data-stu-id="e5ead-108">When set to true a unique x-ms-client-request-id value is generated and included in each request.</span></span> <span data-ttu-id="e5ead-109">既定値は true です。</span><span class="sxs-lookup"><span data-stu-id="e5ead-109">Default is true.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LongRunningOperationRetryTimeout">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-110">取得または長時間実行される操作の秒単位の再試行タイムアウトを設定します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-110">Gets or sets the retry timeout in seconds for Long Running Operations.</span></span> <span data-ttu-id="e5ead-111">既定値は 30 です。</span><span class="sxs-lookup"><span data-stu-id="e5ead-111">Default value is 30.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Operations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-112">IOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-112">Gets the IOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RegisteredIdentities">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-113">IRegisteredIdentitiesOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-113">Gets the IRegisteredIdentitiesOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReplicationUsages">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-114">IReplicationUsagesOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-114">Gets the IReplicationUsagesOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SerializationSettings">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-115">取得または json のシリアル化設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-115">Gets or sets json serialization settings.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubscriptionId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-116">サブスクリプション id</span><span class="sxs-lookup"><span data-stu-id="e5ead-116">The subscription Id.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Usages">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-117">IUsagesOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-117">Gets the IUsagesOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VaultCertificates">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-118">IVaultCertificatesOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-118">Gets the IVaultCertificatesOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VaultExtendedInfo">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-119">IVaultExtendedInfoOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-119">Gets the IVaultExtendedInfoOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Vaults">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e5ead-120">IVaultsOperations を取得します。</span><span class="sxs-lookup"><span data-stu-id="e5ead-120">Gets the IVaultsOperations.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
