<Type Name="IVaults" FullName="Microsoft.Azure.Management.KeyVault.Fluent.IVaults">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fde1c-101">エントリは、キー資格情報コンテナーの管理 API にポイントします。</span><span class="sxs-lookup"><span data-stu-id="fde1c-101">Entry point for key vaults management API.</span></span>
            </summary>
