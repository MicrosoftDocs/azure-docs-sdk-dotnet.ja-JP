<Type Name="AppServiceAuthenticationOptions" FullName="Microsoft.Azure.Mobile.Server.Authentication.AppServiceAuthenticationOptions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a8f6d-101"><see cref="T:Microsoft.Azure.Mobile.Server.Authentication.AppServiceAuthenticationOptions" /> OWIN のオプションを提供<see cref="T:Microsoft.Azure.Mobile.Server.Authentication.AppServiceAuthenticationMiddleware" />クラスです。</span><span class="sxs-lookup"><span data-stu-id="a8f6d-101">The <see cref="T:Microsoft.Azure.Mobile.Server.Authentication.AppServiceAuthenticationOptions" /> provides options for the OWIN <see cref="T:Microsoft.Azure.Mobile.Server.Authentication.AppServiceAuthenticationMiddleware" /> class.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="SigningKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a8f6d-102">取得またはアプリケーションの署名キーを設定します。</span><span class="sxs-lookup"><span data-stu-id="a8f6d-102">Gets or sets the application signing key.</span></span>
            </summary>
