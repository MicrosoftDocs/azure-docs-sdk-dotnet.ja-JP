<Type Name="IWithServiceObjective" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlDatabase.Update.IWithServiceObjective">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6c2c1-101">サービス レベル目標を設定する SQL データベースの定義。</span><span class="sxs-lookup"><span data-stu-id="6c2c1-101">The SQL Database definition to set the service level objective.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithServiceObjective">
      ...
      <Docs>
        <param name="serviceLevelObjective"><span data-ttu-id="6c2c1-102">サービス レベルの SQL データベースのオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="6c2c1-102">Service level objected for the SQL Database.</span></span></param>
        <summary>
            <span data-ttu-id="6c2c1-103">SQL データベースのサービス レベル目標を設定します。</span><span class="sxs-lookup"><span data-stu-id="6c2c1-103">Sets the service level objective for the SQL Database.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="6c2c1-104">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="6c2c1-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>