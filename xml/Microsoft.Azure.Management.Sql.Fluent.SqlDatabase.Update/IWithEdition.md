<Type Name="IWithEdition" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlDatabase.Update.IWithEdition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ade07-101">データベースのエディションを設定する SQL データベースの定義。</span><span class="sxs-lookup"><span data-stu-id="ade07-101">The SQL Database definition to set the edition for database.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithEdition">
      ...
      <Docs>
        <param name="edition"><span data-ttu-id="ade07-102">データベース用に設定するエディションです。</span><span class="sxs-lookup"><span data-stu-id="ade07-102">Edition to be set for database.</span></span></param>
        <summary>
            <span data-ttu-id="ade07-103">SQL データベースのエディションを設定します。</span><span class="sxs-lookup"><span data-stu-id="ade07-103">Sets the edition for the SQL Database.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="ade07-104">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="ade07-104">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>