<Type Name="DeletedSecretItem" FullName="Microsoft.Azure.KeyVault.Models.DeletedSecretItem">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="de7d2-101">削除したシークレットに関するメタデータが含まれているシークレットの削除された項目。</span><span class="sxs-lookup"><span data-stu-id="de7d2-101">The deleted secret item containing metadata about the deleted secret.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de7d2-102">DeletedSecretItem クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="de7d2-102">Initializes a new instance of the DeletedSecretItem class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="de7d2-103">シークレットの識別子。</span><span class="sxs-lookup"><span data-stu-id="de7d2-103">Secret identifier.</span></span></param>
        <param name="attributes"><span data-ttu-id="de7d2-104">シークレットの管理の属性です。</span><span class="sxs-lookup"><span data-stu-id="de7d2-104">The secret management attributes.</span></span></param>
        <param name="tags"><span data-ttu-id="de7d2-105">キー/値ペアの形式でのアプリケーション固有のメタデータ。</span><span class="sxs-lookup"><span data-stu-id="de7d2-105">Application specific metadata in the form of key-value pairs.</span></span></param>
        <param name="contentType"><span data-ttu-id="de7d2-106">パスワードなどの秘密の値の型。</span><span class="sxs-lookup"><span data-stu-id="de7d2-106">Type of the secret value such as a password.</span></span></param>
        <param name="managed"><span data-ttu-id="de7d2-107">シークレットの有効期間が資格情報コンテナーで管理されている場合は true。</span><span class="sxs-lookup"><span data-stu-id="de7d2-107">True if the secret's lifetime is managed by key vault.</span></span> <span data-ttu-id="de7d2-108">これは、キーのバックアップし、管理、証明書が true になります。</span><span class="sxs-lookup"><span data-stu-id="de7d2-108">If this is a key backing a certificate, then managed will be true.</span></span></param>
        <param name="recoveryId"><span data-ttu-id="de7d2-109">識別し、削除されたシークレットを復元するために使用、回復オブジェクトの url です。</span><span class="sxs-lookup"><span data-stu-id="de7d2-109">The url of the recovery object, used to identify and recover the deleted secret.</span></span></param>
        <param name="scheduledPurgeDate"><span data-ttu-id="de7d2-110">シークレットが utc 形式で、消去する予定時刻</span><span class="sxs-lookup"><span data-stu-id="de7d2-110">The time when the secret is scheduled to be purged, in UTC</span></span></param>
        <param name="deletedDate"><span data-ttu-id="de7d2-111">ときに、シークレットが削除された utc 時刻</span><span class="sxs-lookup"><span data-stu-id="de7d2-111">The time when the secret was deleted, in UTC</span></span></param>
        <summary>
            <span data-ttu-id="de7d2-112">DeletedSecretItem クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="de7d2-112">Initializes a new instance of the DeletedSecretItem class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="DeletedDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de7d2-113">ときに、シークレットが削除された utc 時刻を取得します。</span><span class="sxs-lookup"><span data-stu-id="de7d2-113">Gets the time when the secret was deleted, in UTC</span></span>
            </summary>
    ...
    <Member MemberName="RecoveryId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de7d2-114">取得または識別し、削除されたシークレットを復元するために使用、回復オブジェクトの url を設定します。</span><span class="sxs-lookup"><span data-stu-id="de7d2-114">Gets or sets the url of the recovery object, used to identify and recover the deleted secret.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecoveryIdentifier">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de7d2-115">削除されたシークレット オブジェクトの識別子。</span><span class="sxs-lookup"><span data-stu-id="de7d2-115">The identifier of the deleted secret object.</span></span> <span data-ttu-id="de7d2-116">シークレットの復元に使用されます。</span><span class="sxs-lookup"><span data-stu-id="de7d2-116">This is used to recover the secret.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ScheduledPurgeDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="de7d2-117">シークレットが utc 形式で、消去する予定時刻を取得します。</span><span class="sxs-lookup"><span data-stu-id="de7d2-117">Gets the time when the secret is scheduled to be purged, in UTC</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
