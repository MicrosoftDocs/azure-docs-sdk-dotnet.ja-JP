<Type Name="PendingCertificateSigningRequestResult" FullName="Microsoft.Azure.KeyVault.Models.PendingCertificateSigningRequestResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f0429-101">保留中証明書署名要求の結果。</span><span class="sxs-lookup"><span data-stu-id="f0429-101">The pending certificate signing request result.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f0429-102">PendingCertificateSigningRequestResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="f0429-102">Initializes a new instance of the PendingCertificateSigningRequestResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="f0429-103">保留中の証明書署名要求を Base64 としてエンコードされた文字列。</span><span class="sxs-lookup"><span data-stu-id="f0429-103">The pending certificate signing request as Base64 encoded string.</span></span></param>
        <summary>
            <span data-ttu-id="f0429-104">PendingCertificateSigningRequestResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="f0429-104">Initializes a new instance of the PendingCertificateSigningRequestResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f0429-105">保留中の証明書署名 Base64 でエンコードされた文字列としての要求を取得します。</span><span class="sxs-lookup"><span data-stu-id="f0429-105">Gets the pending certificate signing request as Base64 encoded string.</span></span>
            </summary>
