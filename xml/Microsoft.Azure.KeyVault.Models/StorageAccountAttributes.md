<Type Name="StorageAccountAttributes" FullName="Microsoft.Azure.KeyVault.Models.StorageAccountAttributes">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="45389-101">ストレージ アカウントの管理属性。</span><span class="sxs-lookup"><span data-stu-id="45389-101">The storage account management attributes.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="45389-102">StorageAccountAttributes クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="45389-102">Initializes a new instance of the StorageAccountAttributes class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="enabled"><span data-ttu-id="45389-103">オブジェクトの有効な状態です。</span><span class="sxs-lookup"><span data-stu-id="45389-103">the enabled state of the object.</span></span></param>
        <param name="created"><span data-ttu-id="45389-104">作成時刻 (utc) です。</span><span class="sxs-lookup"><span data-stu-id="45389-104">Creation time in UTC.</span></span></param>
        <param name="updated"><span data-ttu-id="45389-105">最終更新時刻 (utc)。</span><span class="sxs-lookup"><span data-stu-id="45389-105">Last updated time in UTC.</span></span></param>
        <summary>
            <span data-ttu-id="45389-106">StorageAccountAttributes クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="45389-106">Initializes a new instance of the StorageAccountAttributes class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Created">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="45389-107">(Utc) には、作成時刻を取得します。</span><span class="sxs-lookup"><span data-stu-id="45389-107">Gets creation time in UTC.</span></span>
            </summary>
    ...
    <Member MemberName="Enabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="45389-108">取得またはオブジェクトの有効な状態を設定します。</span><span class="sxs-lookup"><span data-stu-id="45389-108">Gets or sets the enabled state of the object.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Updated">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="45389-109">(Utc) には、最終更新時刻を取得します。</span><span class="sxs-lookup"><span data-stu-id="45389-109">Gets last updated time in UTC.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
