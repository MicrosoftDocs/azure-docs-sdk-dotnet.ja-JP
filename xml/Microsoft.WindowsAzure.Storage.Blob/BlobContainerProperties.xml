<Type Name="BlobContainerProperties" FullName="Microsoft.WindowsAzure.Storage.Blob.BlobContainerProperties">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e256a-101">コンテナーのシステム プロパティを表します。</span><span class="sxs-lookup"><span data-stu-id="e256a-101">Represents the system properties for a container.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ETag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e256a-102">コンテナーの ETag 値を取得します。</span><span class="sxs-lookup"><span data-stu-id="e256a-102">Gets the ETag value for the container.</span></span>
            </summary>
        <value><span data-ttu-id="e256a-103">コンテナーの文字列には、ETag 値が引用符で囲みます。</span><span class="sxs-lookup"><span data-stu-id="e256a-103">A string containing the container's quoted ETag value.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="LastModified">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e256a-104">コンテナーの最終更新時刻を取得します。</span><span class="sxs-lookup"><span data-stu-id="e256a-104">Gets the container's last-modified time.</span></span>
            </summary>
        <value><span data-ttu-id="e256a-105">A <see cref="T:System.DateTimeOffset" /> UTC 形式で、コンテナーの最終更新時刻を含むです。</span><span class="sxs-lookup"><span data-stu-id="e256a-105">A <see cref="T:System.DateTimeOffset" /> containing the container's last-modified time, in UTC format.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="LeaseDuration">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e256a-106">コンテナーのリース期間を取得します。</span><span class="sxs-lookup"><span data-stu-id="e256a-106">Gets the container's lease duration.</span></span>
            </summary>
        <value><span data-ttu-id="e256a-107">A<see cref="P:Microsoft.WindowsAzure.Storage.Blob.BlobContainerProperties.LeaseDuration" />コンテナーのリース期間を示すオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="e256a-107">A <see cref="P:Microsoft.WindowsAzure.Storage.Blob.BlobContainerProperties.LeaseDuration" /> object that indicates the container's lease duration.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="LeaseState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e256a-108">コンテナーのリース状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="e256a-108">Gets the container's lease state.</span></span>
            </summary>
        <value><span data-ttu-id="e256a-109">A<see cref="P:Microsoft.WindowsAzure.Storage.Blob.BlobContainerProperties.LeaseState" />コンテナーのリースの状態を示すオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="e256a-109">A <see cref="P:Microsoft.WindowsAzure.Storage.Blob.BlobContainerProperties.LeaseState" /> object that indicates the container's lease state.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="LeaseStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e256a-110">コンテナーのリース ステータスを取得します。</span><span class="sxs-lookup"><span data-stu-id="e256a-110">Gets the container's lease status.</span></span>
            </summary>
        <value><span data-ttu-id="e256a-111">A<see cref="P:Microsoft.WindowsAzure.Storage.Blob.BlobContainerProperties.LeaseStatus" />コンテナーのリース ステータスを示すオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="e256a-111">A <see cref="P:Microsoft.WindowsAzure.Storage.Blob.BlobContainerProperties.LeaseStatus" /> object that indicates the container's lease status.</span></span></value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="PublicAccess">
      ...
      <Docs>
        <summary>
             <span data-ttu-id="e256a-112">コンテナーのパブリック アクセスを取得します。</span><span class="sxs-lookup"><span data-stu-id="e256a-112">Gets the public access for the container.</span></span>
            </summary>
        <value><span data-ttu-id="e256a-113">A<see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContainerPublicAccessType" />コンテナーで許可されているパブリック アクセスのレベルを指定します。</span><span class="sxs-lookup"><span data-stu-id="e256a-113">A <see cref="T:Microsoft.WindowsAzure.Storage.Blob.BlobContainerPublicAccessType" /> that specifies the level of public access that is allowed on the container.</span></span></value>
        <remarks><span data-ttu-id="e256a-114">このフィールドは、コンテナーの Create() メソッドまたは SetPermissions() メソッドを使用する設定のみ</span><span class="sxs-lookup"><span data-stu-id="e256a-114">This field should only be set using the container's Create() method or SetPermissions() method</span></span></remarks>
      </Docs>
    </Member>
  </Members>
</Type>