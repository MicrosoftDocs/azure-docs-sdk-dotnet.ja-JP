<Type Name="IUpdateAaaaRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateAaaaRecordSet.IUpdateAaaaRecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="960d8-101">AAAA レコードの全体は、親 DNS ゾーンの更新プログラムの一部として更新を設定します。</span><span class="sxs-lookup"><span data-stu-id="960d8-101">The entirety of an AAAA record set update as a part of parent DNS zone update.</span></span>
            </summary>
