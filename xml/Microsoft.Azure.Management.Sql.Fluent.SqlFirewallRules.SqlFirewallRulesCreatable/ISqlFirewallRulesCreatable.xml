<Type Name="ISqlFirewallRulesCreatable" FullName="Microsoft.Azure.Management.Sql.Fluent.SqlFirewallRules.SqlFirewallRulesCreatable.ISqlFirewallRulesCreatable">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="781ff-101">指定された sql Server で既にある SQL FirewallRule 管理 API へのエントリ ポイントです。</span><span class="sxs-lookup"><span data-stu-id="781ff-101">Entry point to SQL FirewallRule management API, which already have the SQLServer specified.</span></span>
            </summary>
