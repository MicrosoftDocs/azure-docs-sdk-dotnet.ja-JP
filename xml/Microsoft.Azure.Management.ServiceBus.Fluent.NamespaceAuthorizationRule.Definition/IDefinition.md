<Type Name="IDefinition" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.NamespaceAuthorizationRule.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b570b-101">名前空間の承認規則の定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="b570b-101">The entirety of the namespace authorization rule definition.</span></span>
            </summary>
