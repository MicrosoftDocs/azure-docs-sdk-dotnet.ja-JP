<Type Name="IBlank" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.NamespaceAuthorizationRule.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d7d98-101">承認規則の名前空間の定義の最初の段階です。</span><span class="sxs-lookup"><span data-stu-id="d7d98-101">The first stage of namespace authorization rule definition.</span></span>
            </summary>
