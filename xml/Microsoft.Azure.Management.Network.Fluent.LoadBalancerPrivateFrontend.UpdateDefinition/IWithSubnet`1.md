<Type Name="IWithSubnet&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerPrivateFrontend.UpdateDefinition.IWithSubnet&lt;ParentT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="c6795-101">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c6795-101">The next stage of the definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="c6795-102">選択したネットワークのサブネットを指定できるようにプライベート フロント エンドの定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="c6795-102">The stage of a private frontend definition allowing to specify a subnet from the selected network.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithExistingSubnet">
      ...
      <Docs>
        <param name="network"><span data-ttu-id="c6795-103">仮想ネットワークが、サブネットに存在します。</span><span class="sxs-lookup"><span data-stu-id="c6795-103">The virtual network the subnet exists in.</span></span></param>
        <param name="subnetName"><span data-ttu-id="c6795-104">サブネットの名前。</span><span class="sxs-lookup"><span data-stu-id="c6795-104">The name of a subnet.</span></span></param>
        <summary>
            <span data-ttu-id="c6795-105">内部ロード バランサーのこのプライベート フロント エンドに指定されたサブネットを割り当てます。</span><span class="sxs-lookup"><span data-stu-id="c6795-105">Assigns the specified subnet to this private frontend of the internal load balancer.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="c6795-106">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="c6795-106">The next stage of the definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>