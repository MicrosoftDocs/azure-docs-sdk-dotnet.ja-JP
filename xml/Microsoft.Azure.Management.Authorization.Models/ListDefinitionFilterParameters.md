<Type Name="ListDefinitionFilterParameters" FullName="Microsoft.Azure.Management.Authorization.Models.ListDefinitionFilterParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d7fd4-101">ロール定義フィルターの一覧です。</span><span class="sxs-lookup"><span data-stu-id="d7fd4-101">List role definitions filter.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d7fd4-102">ListDefinitionFilterParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="d7fd4-102">Initializes a new instance of the ListDefinitionFilterParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AtScopeAndBelow">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d7fd4-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="d7fd4-103">Optional.</span></span> <span data-ttu-id="d7fd4-104">指定した場合は、すべてのロールの定義のスコープで、以下も返します。</span><span class="sxs-lookup"><span data-stu-id="d7fd4-104">If specified, also returns all role definition at scope and below.</span></span>
            </summary>
    ...
    <Member MemberName="RoleName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d7fd4-105">省略可能。</span><span class="sxs-lookup"><span data-stu-id="d7fd4-105">Optional.</span></span> <span data-ttu-id="d7fd4-106">この名前を持つロールの定義を返します。</span><span class="sxs-lookup"><span data-stu-id="d7fd4-106">Returns role definitions with this name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
