<Type Name="RoleAssignmentDeleteResult" FullName="Microsoft.Azure.Management.Authorization.Models.RoleAssignmentDeleteResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="99924-101">ロールの割り当ての削除の結果</span><span class="sxs-lookup"><span data-stu-id="99924-101">Role assignments delete result</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99924-102">RoleAssignmentDeleteResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="99924-102">Initializes a new instance of the RoleAssignmentDeleteResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RoleAssignment">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99924-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="99924-103">Optional.</span></span> <span data-ttu-id="99924-104">ロール割り当て</span><span class="sxs-lookup"><span data-stu-id="99924-104">Role assignment</span></span>
            </summary>
