<Type Name="IWithFrontend&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasFrontend.Definition.IWithFrontend&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="3acb5-101">定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="3acb5-101">The next stage of the definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="3acb5-102">ロード バランサーのフロント エンドを指定できるように定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="3acb5-102">The stage of a definition allowing to specify a load balancer frontend.</span></span>
            </summary>
