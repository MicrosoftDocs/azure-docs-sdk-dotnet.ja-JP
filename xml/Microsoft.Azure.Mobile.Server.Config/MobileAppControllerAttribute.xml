<Type Name="MobileAppControllerAttribute" FullName="Microsoft.Azure.Mobile.Server.Config.MobileAppControllerAttribute">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="adad3-101">このコント ローラーは、Azure のモバイル アプリのクライアントで使用することを指定します。</span><span class="sxs-lookup"><span data-stu-id="adad3-101">Specifies that this controller is for use by an Azure Mobile App client.</span></span> <span data-ttu-id="adad3-102">特定の設定は、コント ローラーは、クライアントと正しく対話を確実に適用されます。</span><span class="sxs-lookup"><span data-stu-id="adad3-102">Specific settings are applied to ensure the controller interacts correctly with the client.</span></span>
            </summary>
