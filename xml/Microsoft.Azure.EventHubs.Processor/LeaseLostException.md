<Type Name="LeaseLostException" FullName="Microsoft.Azure.EventHubs.Processor.LeaseLostException">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d0ba5-101">サービスのリースが失われたときに発生する例外を表します。</span><span class="sxs-lookup"><span data-stu-id="d0ba5-101">Represents an exception that occurs when the service lease has been lost.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="PartitionId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d0ba5-102">例外が発生した、パーティション ID を取得します。</span><span class="sxs-lookup"><span data-stu-id="d0ba5-102">Gets the partition ID where the exception occured.</span></span>
            </summary>
