<Type Name="InternalContext" FullName="Microsoft.ApplicationInsights.Extensibility.Implementation.InternalContext">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a2c9f-101">内部情報をカプセル化します。</span><span class="sxs-lookup"><span data-stu-id="a2c9f-101">Encapsulates Internal information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="AgentVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a2c9f-102">取得またはアプリケーション insights のエージェントのバージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="a2c9f-102">Gets or sets application insights agent version.</span></span>
            </summary>
    ...
    <Member MemberName="NodeName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a2c9f-103">取得または課金の目的でのノード名を設定します。</span><span class="sxs-lookup"><span data-stu-id="a2c9f-103">Gets or sets node name for the billing purposes.</span></span> <span data-ttu-id="a2c9f-104">このノードの名前が検出されましたが、標準的な方法をオーバーライドするフィールドを使用します。</span><span class="sxs-lookup"><span data-stu-id="a2c9f-104">Use this filed to override the standard way node names got detected.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SdkVersion">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="a2c9f-105">取得またはアプリケーション insights SDK のバージョンを設定します。</span><span class="sxs-lookup"><span data-stu-id="a2c9f-105">Gets or sets application insights SDK version.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
