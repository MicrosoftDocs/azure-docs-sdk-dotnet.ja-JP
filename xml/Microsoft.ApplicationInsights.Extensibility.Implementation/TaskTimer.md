<Type Name="TaskTimer" FullName="Microsoft.ApplicationInsights.Extensibility.Implementation.TaskTimer">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4d8c7-101">遅延特定し、すべてのエラー ログに記録した後は、タスクを実行します。</span><span class="sxs-lookup"><span data-stu-id="4d8c7-101">Runs a task after a certain delay and log any error.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Cancel">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4d8c7-102">現在のタスクを取り消します。</span><span class="sxs-lookup"><span data-stu-id="4d8c7-102">Cancels the current task.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Delay">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4d8c7-103">取得または、タスクの開始前に遅延を設定します。</span><span class="sxs-lookup"><span data-stu-id="4d8c7-103">Gets or sets the delay before the task starts.</span></span> 
            </summary>
    ...
    <Member MemberName="Dispose">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4d8c7-104">リリースでは、アンマネージし、必要に応じてマネージ リソース。</span><span class="sxs-lookup"><span data-stu-id="4d8c7-104">Releases unmanaged and - optionally - managed resources.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="InfiniteTimeSpan">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4d8c7-105">無限の期間を表します。</span><span class="sxs-lookup"><span data-stu-id="4d8c7-105">Represents an infinite time span.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsStarted">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4d8c7-106">タスクが既に開始されているかどうかを示す値を示す値かどうか取得します。</span><span class="sxs-lookup"><span data-stu-id="4d8c7-106">Gets a value indicating whether value that indicates if a task has already started.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Start">
      ...
      <Docs>
        <param name="elapsed"><span data-ttu-id="4d8c7-107">タスクを実行します。</span><span class="sxs-lookup"><span data-stu-id="4d8c7-107">The task to run.</span></span></param>
        <summary>
            <span data-ttu-id="4d8c7-108">タスクを開始します。</span><span class="sxs-lookup"><span data-stu-id="4d8c7-108">Start the task.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
