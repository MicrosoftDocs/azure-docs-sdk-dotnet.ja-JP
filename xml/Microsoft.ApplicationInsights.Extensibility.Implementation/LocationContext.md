<Type Name="LocationContext" FullName="Microsoft.ApplicationInsights.Extensibility.Implementation.LocationContext">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="aa07b-101">製品利用統計情報の場所情報をカプセル化します。</span><span class="sxs-lookup"><span data-stu-id="aa07b-101">Encapsulates telemetry location information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Ip">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="aa07b-102">取得または場所 IP を設定します。</span><span class="sxs-lookup"><span data-stu-id="aa07b-102">Gets or sets the location IP.</span></span>
            </summary>
