<Type Name="LoggingOperations" FullName="Microsoft.WindowsAzure.Storage.Shared.Protocol.LoggingOperations">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="0dd4b-101">サービスでログ記録の状態を表す列挙体です。</span><span class="sxs-lookup"><span data-stu-id="0dd4b-101">Enumeration representing the state of logging in a service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="All">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0dd4b-102">すべての操作を記録します。</span><span class="sxs-lookup"><span data-stu-id="0dd4b-102">Log all operations.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Delete">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0dd4b-103">ログは、操作を削除します。</span><span class="sxs-lookup"><span data-stu-id="0dd4b-103">Log delete operations.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0dd4b-104">ログ記録は無効です。</span><span class="sxs-lookup"><span data-stu-id="0dd4b-104">Logging is disabled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Read">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0dd4b-105">ログは読み取り操作です。</span><span class="sxs-lookup"><span data-stu-id="0dd4b-105">Log read operations.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Write">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="0dd4b-106">ログは書き込み操作です。</span><span class="sxs-lookup"><span data-stu-id="0dd4b-106">Log write operations.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
