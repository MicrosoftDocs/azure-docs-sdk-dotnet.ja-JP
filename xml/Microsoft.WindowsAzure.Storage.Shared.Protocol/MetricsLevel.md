<Type Name="MetricsLevel" FullName="Microsoft.WindowsAzure.Storage.Shared.Protocol.MetricsLevel">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="97ee7-101">サービスのメトリックの収集の状態を表す列挙体です。</span><span class="sxs-lookup"><span data-stu-id="97ee7-101">Enumeration representing the state of metrics collection in a service.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="97ee7-102">メトリックの収集は無効です。</span><span class="sxs-lookup"><span data-stu-id="97ee7-102">Metrics collection is disabled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Service">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="97ee7-103">サービス レベル メトリックの収集が有効になっているとします。</span><span class="sxs-lookup"><span data-stu-id="97ee7-103">Service-level metrics collection is enabled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="ServiceAndApi">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="97ee7-104">サービス レベルと API のメトリックの収集が有効になります。</span><span class="sxs-lookup"><span data-stu-id="97ee7-104">Service-level and API metrics collection are enabled.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
