<Type Name="ActivityTypeGetResponse" FullName="Microsoft.Azure.Management.DataFactories.Registration.Models.ActivityTypeGetResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c0658-101">ActivityType の取得操作の応答。</span><span class="sxs-lookup"><span data-stu-id="c0658-101">The Get ActivityType operation response.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="ActivityType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c0658-102">省略可能。</span><span class="sxs-lookup"><span data-stu-id="c0658-102">Optional.</span></span> <span data-ttu-id="c0658-103">ActivityType のインスタンス。</span><span class="sxs-lookup"><span data-stu-id="c0658-103">The ActivityType instance.</span></span>
            </summary>
