<Type Name="ActivityTypeGetParameters" FullName="Microsoft.Azure.Management.DataFactories.Registration.Models.ActivityTypeGetParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e74d6-101">取得操作で、ActivityType 定義を返す方法を指定するパラメーターです。</span><span class="sxs-lookup"><span data-stu-id="e74d6-101">Parameters specifying how to return an ActivityType definition for a Get operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e74d6-102">ActivityTypeGetParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="e74d6-102">Initializes a new instance of the ActivityTypeGetParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="e74d6-103">必須の引数で ActivityTypeGetParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="e74d6-103">Initializes a new instance of the ActivityTypeGetParameters class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ActivityTypeName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e74d6-104">必須。</span><span class="sxs-lookup"><span data-stu-id="e74d6-104">Required.</span></span> <span data-ttu-id="e74d6-105">ActivityType の名。</span><span class="sxs-lookup"><span data-stu-id="e74d6-105">An ActivityType name.</span></span>
            </summary>
    ...
    <Member MemberName="RegistrationScope">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e74d6-106">必須。</span><span class="sxs-lookup"><span data-stu-id="e74d6-106">Required.</span></span> <span data-ttu-id="e74d6-107">ActivityType 定義を取得する対象のスコープです。</span><span class="sxs-lookup"><span data-stu-id="e74d6-107">The scope for which to get an ActivityType definition.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Resolved">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e74d6-108">省略可能。</span><span class="sxs-lookup"><span data-stu-id="e74d6-108">Optional.</span></span> <span data-ttu-id="e74d6-109">True の場合は、その基本型から継承して、ActivityType のプロパティを取得します。</span><span class="sxs-lookup"><span data-stu-id="e74d6-109">If true, gets the properties of any base types an ActivityType inherits from.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
