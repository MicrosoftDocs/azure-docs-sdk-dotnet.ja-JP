<Type Name="ActivityTypeProperties" FullName="Microsoft.Azure.Management.DataFactories.Registration.Models.ActivityTypeProperties">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2bfe8-101">アクティビティ型のプロパティです。</span><span class="sxs-lookup"><span data-stu-id="2bfe8-101">Activity type properties.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="BaseType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2bfe8-102">ActivityType の基本型。</span><span class="sxs-lookup"><span data-stu-id="2bfe8-102">Base type of the ActivityType.</span></span> <span data-ttu-id="2bfe8-103">組み込みデータ ファクトリのアクティビティ型である必要があります。</span><span class="sxs-lookup"><span data-stu-id="2bfe8-103">Must be a built-in Data Factory Activity type.</span></span>
            </summary>
