<Type Name="IDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficManagerEndpoint.Definition.IDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="cad6d-101">最終的な Attachable.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="cad6d-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="cad6d-102">親の定義の一部として traffic manager プロファイル エンドポイント定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="cad6d-102">The entirety of a traffic manager profile endpoint definition as a part of parent definition.</span></span>
            </summary>
