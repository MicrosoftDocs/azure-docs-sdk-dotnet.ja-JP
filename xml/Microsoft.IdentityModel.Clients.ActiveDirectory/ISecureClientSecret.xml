<Type Name="ISecureClientSecret" FullName="Microsoft.IdentityModel.Clients.ActiveDirectory.ISecureClientSecret">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="498d8-101">クライアント シークレット SecureString として渡されるを許可するためのインターフェイスします。</span><span class="sxs-lookup"><span data-stu-id="498d8-101">Interface to allow for client secret to be passed in as a SecureString</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="ApplyTo">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="498d8-102">SecureString をディクショナリに書き込みます。</span><span class="sxs-lookup"><span data-stu-id="498d8-102">Writes SecureString to the dictionary.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
