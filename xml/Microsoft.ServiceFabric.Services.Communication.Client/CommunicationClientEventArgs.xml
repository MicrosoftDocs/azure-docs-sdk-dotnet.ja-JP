<Type Name="CommunicationClientEventArgs" FullName="Microsoft.ServiceFabric.Services.Communication.Client.CommunicationClientEventArgs">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5cd20-101">通信のクライアント接続切断イベント ハンドラーの引数を指定します。</span><span class="sxs-lookup"><span data-stu-id="5cd20-101">Specifies the arguments for the communication client connected/disconnected events handler.</span></span>
            </summary>
