<Type Name="IDefinition" FullName="Microsoft.Azure.Management.TrafficManager.Fluent.TrafficManagerProfile.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="791fb-101">トラフィック マネージャー プロファイル定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="791fb-101">The entirety of the traffic manager profile definition.</span></span>
            </summary>
