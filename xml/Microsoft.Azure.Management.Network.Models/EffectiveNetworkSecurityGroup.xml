<Type Name="EffectiveNetworkSecurityGroup" FullName="Microsoft.Azure.Management.Network.Models.EffectiveNetworkSecurityGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f8d44-101">有効なネットワーク セキュリティ グループです。</span><span class="sxs-lookup"><span data-stu-id="f8d44-101">Effective network security group.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f8d44-102">EffectiveNetworkSecurityGroup クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="f8d44-102">Initializes a new instance of the EffectiveNetworkSecurityGroup class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="networkSecurityGroup"><span data-ttu-id="f8d44-103">適用されているネットワーク セキュリティ グループの ID。</span><span class="sxs-lookup"><span data-stu-id="f8d44-103">The ID of network security group that is applied.</span></span></param>
        <param name="association"><span data-ttu-id="f8d44-104">関連付けられているリソース。</span><span class="sxs-lookup"><span data-stu-id="f8d44-104">Associated resources.</span></span></param>
        <param name="effectiveSecurityRules"><span data-ttu-id="f8d44-105">有効なセキュリティの規則のコレクション。</span><span class="sxs-lookup"><span data-stu-id="f8d44-105">A collection of effective security rules.</span></span></param>
        <param name="tagMap"><span data-ttu-id="f8d44-106">タグ内に含まれる IP アドレスの一覧をタグのマッピングです。</span><span class="sxs-lookup"><span data-stu-id="f8d44-106">Mapping of tags to list of IP Addresses included within the tag.</span></span></param>
        <summary>
            <span data-ttu-id="f8d44-107">EffectiveNetworkSecurityGroup クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="f8d44-107">Initializes a new instance of the EffectiveNetworkSecurityGroup class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Association">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f8d44-108">取得または関連付けられているリソースを設定します。</span><span class="sxs-lookup"><span data-stu-id="f8d44-108">Gets or sets associated resources.</span></span>
            </summary>
    ...
    <Member MemberName="EffectiveSecurityRules">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f8d44-109">取得または効果的なセキュリティの規則のコレクションを設定します。</span><span class="sxs-lookup"><span data-stu-id="f8d44-109">Gets or sets a collection of effective security rules.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NetworkSecurityGroup">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f8d44-110">取得または適用されているネットワーク セキュリティ グループの ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="f8d44-110">Gets or sets the ID of network security group that is applied.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TagMap">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f8d44-111">取得またはタグ内に含まれる IP アドレスの一覧をタグのマッピングを設定します。</span><span class="sxs-lookup"><span data-stu-id="f8d44-111">Gets or sets mapping of tags to list of IP Addresses included within the tag.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
