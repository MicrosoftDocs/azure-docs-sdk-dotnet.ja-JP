<Type Name="EffectiveRouteState" FullName="Microsoft.Azure.Management.Network.Models.EffectiveRouteState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e9aa6-101">EffectiveRouteState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="e9aa6-101">Defines values for EffectiveRouteState.</span></span>
            </summary>
