<Type Name="TroubleshootingRecommendedActions" FullName="Microsoft.Azure.Management.Network.Models.TroubleshootingRecommendedActions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ea716-101">検出された問題に基づいた操作をお勧めします。</span><span class="sxs-lookup"><span data-stu-id="ea716-101">Recommended actions based on discovered issues.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea716-102">TroubleshootingRecommendedActions クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ea716-102">Initializes a new instance of the TroubleshootingRecommendedActions class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="actionId"><span data-ttu-id="ea716-103">推奨される操作の ID です。</span><span class="sxs-lookup"><span data-stu-id="ea716-103">ID of the recommended action.</span></span></param>
        <param name="actionText"><span data-ttu-id="ea716-104">推奨される操作の説明です。</span><span class="sxs-lookup"><span data-stu-id="ea716-104">Description of recommended actions.</span></span></param>
        <param name="actionUri"><span data-ttu-id="ea716-105">推奨されるトラブルシューティングの操作のドキュメントへのリンク uri。</span><span class="sxs-lookup"><span data-stu-id="ea716-105">The uri linking to a documentation for the recommended troubleshooting actions.</span></span></param>
        <param name="actionUriText"><span data-ttu-id="ea716-106">推奨されるトラブルシューティングの操作の URI からの情報。</span><span class="sxs-lookup"><span data-stu-id="ea716-106">The information from the URI for the recommended troubleshooting actions.</span></span></param>
        <summary>
            <span data-ttu-id="ea716-107">TroubleshootingRecommendedActions クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ea716-107">Initializes a new instance of the TroubleshootingRecommendedActions class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ActionId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea716-108">取得または推奨される操作の ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="ea716-108">Gets or sets ID of the recommended action.</span></span>
            </summary>
    ...
    <Member MemberName="ActionText">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea716-109">取得または推奨される操作の説明を設定します。</span><span class="sxs-lookup"><span data-stu-id="ea716-109">Gets or sets description of recommended actions.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ActionUri">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea716-110">取得または推奨されるトラブルシューティングの操作のドキュメントへのリンク uri を設定します。</span><span class="sxs-lookup"><span data-stu-id="ea716-110">Gets or sets the uri linking to a documentation for the recommended troubleshooting actions.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ActionUriText">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ea716-111">取得または推奨されるトラブルシューティングの操作の URI から情報を設定します。</span><span class="sxs-lookup"><span data-stu-id="ea716-111">Gets or sets the information from the URI for the recommended troubleshooting actions.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
