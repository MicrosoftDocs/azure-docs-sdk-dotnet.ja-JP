<Type Name="PacketCaptureResult" FullName="Microsoft.Azure.Management.Network.Models.PacketCaptureResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dddab-101">パケット キャプチャ セッションに関する情報です。</span><span class="sxs-lookup"><span data-stu-id="dddab-101">Information about packet capture session.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dddab-102">PacketCaptureResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="dddab-102">Initializes a new instance of the PacketCaptureResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="target"><span data-ttu-id="dddab-103">対象のリソースのみの VM の ID は現在サポートされています。</span><span class="sxs-lookup"><span data-stu-id="dddab-103">The ID of the targeted resource, only VM is currently supported.</span></span></param>
        <param name="storageLocation">To be added.</param>
        <param name="name"><span data-ttu-id="dddab-104">パケット キャプチャ セッションの名前です。</span><span class="sxs-lookup"><span data-stu-id="dddab-104">Name of the packet capture session.</span></span></param>
        <param name="id"><span data-ttu-id="dddab-105">パケット キャプチャ操作の ID です。</span><span class="sxs-lookup"><span data-stu-id="dddab-105">ID of the packet capture operation.</span></span></param>
        <param name="etag">To be added.</param>
        <param name="bytesToCapturePerPacket"><span data-ttu-id="dddab-106">数パケットごとに取得 (バイト単位) の残りのバイトが切り捨てられます。</span><span class="sxs-lookup"><span data-stu-id="dddab-106">Number of bytes captured per packet, the remaining bytes are truncated.</span></span></param>
        <param name="totalBytesPerSession"><span data-ttu-id="dddab-107">キャプチャ出力の最大サイズ。</span><span class="sxs-lookup"><span data-stu-id="dddab-107">Maximum size of the capture output.</span></span></param>
        <param name="timeLimitInSeconds"><span data-ttu-id="dddab-108">秒単位でキャプチャ セッションの最大期間です。</span><span class="sxs-lookup"><span data-stu-id="dddab-108">Maximum duration of the capture session in seconds.</span></span></param>
        <param name="filters">To be added.</param>
        <param name="provisioningState"><span data-ttu-id="dddab-109">パケット キャプチャ セッションのプロビジョニングの状態。</span><span class="sxs-lookup"><span data-stu-id="dddab-109">The provisioning state of the packet capture session.</span></span> <span data-ttu-id="dddab-110">使用可能な値が含まれます: '成功'、'更新'、'削除'、'失敗'</span><span class="sxs-lookup"><span data-stu-id="dddab-110">Possible values include: 'Succeeded', 'Updating', 'Deleting', 'Failed'</span></span></param>
        <summary>
            <span data-ttu-id="dddab-111">PacketCaptureResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="dddab-111">Initializes a new instance of the PacketCaptureResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="BytesToCapturePerPacket">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dddab-112">パケットごとに取得するバイト数を取得または残りのバイトが切り捨てられます。</span><span class="sxs-lookup"><span data-stu-id="dddab-112">Gets or sets number of bytes captured per packet, the remaining bytes are truncated.</span></span>
            </summary>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dddab-113">パケット キャプチャ操作の ID を取得します。</span><span class="sxs-lookup"><span data-stu-id="dddab-113">Gets ID of the packet capture operation.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dddab-114">パケット キャプチャ セッションの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="dddab-114">Gets name of the packet capture session.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dddab-115">取得またはパケット キャプチャ セッションのプロビジョニングの状態を設定します。</span><span class="sxs-lookup"><span data-stu-id="dddab-115">Gets or sets the provisioning state of the packet capture session.</span></span>
            <span data-ttu-id="dddab-116">使用可能な値が含まれます: '成功'、'更新'、'削除'、'失敗'</span><span class="sxs-lookup"><span data-stu-id="dddab-116">Possible values include: 'Succeeded', 'Updating', 'Deleting', 'Failed'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Target">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dddab-117">取得または設定対象のリソースのみの VM の ID は現在サポートされています。</span><span class="sxs-lookup"><span data-stu-id="dddab-117">Gets or sets the ID of the targeted resource, only VM is currently supported.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeLimitInSeconds">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dddab-118">取得またはキャプチャ セッションの最大継続時間を秒単位で設定します。</span><span class="sxs-lookup"><span data-stu-id="dddab-118">Gets or sets maximum duration of the capture session in seconds.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TotalBytesPerSession">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dddab-119">取得またはキャプチャ出力の最大サイズを設定します。</span><span class="sxs-lookup"><span data-stu-id="dddab-119">Gets or sets maximum size of the capture output.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="dddab-120">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="dddab-120">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="dddab-121">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="dddab-121">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
