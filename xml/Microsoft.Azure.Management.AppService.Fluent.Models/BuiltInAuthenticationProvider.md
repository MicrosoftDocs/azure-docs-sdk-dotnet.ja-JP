<Type Name="BuiltInAuthenticationProvider" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.BuiltInAuthenticationProvider">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="77fb1-101">BuiltInAuthenticationProvider の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="77fb1-101">Defines values for BuiltInAuthenticationProvider.</span></span>
            </summary>
