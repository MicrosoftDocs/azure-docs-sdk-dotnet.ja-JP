<Type Name="ConnStringInfo" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.ConnStringInfo">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="894bf-101">データベース接続文字列の情報です。</span><span class="sxs-lookup"><span data-stu-id="894bf-101">Database connection string information.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="894bf-102">ConnStringInfo クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="894bf-102">Initializes a new instance of the ConnStringInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="894bf-103">接続文字列の名前です。</span><span class="sxs-lookup"><span data-stu-id="894bf-103">Name of connection string.</span></span></param>
        <param name="connectionString"><span data-ttu-id="894bf-104">接続文字列値です。</span><span class="sxs-lookup"><span data-stu-id="894bf-104">Connection string value.</span></span></param>
        <param name="type"><span data-ttu-id="894bf-105">データベースの種類。</span><span class="sxs-lookup"><span data-stu-id="894bf-105">Type of database.</span></span> <span data-ttu-id="894bf-106">使用可能な値が含まれます: 'MySql'、'SQLServer'、'SQLAzure'、'Custom'、'NotificationHub'、'ServiceBus'、'EventHub'、'ApiHub'、'DocDb'、'RedisCache'</span><span class="sxs-lookup"><span data-stu-id="894bf-106">Possible values include: 'MySql', 'SQLServer', 'SQLAzure', 'Custom', 'NotificationHub', 'ServiceBus', 'EventHub', 'ApiHub', 'DocDb', 'RedisCache'</span></span></param>
        <summary>
            <span data-ttu-id="894bf-107">ConnStringInfo クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="894bf-107">Initializes a new instance of the ConnStringInfo class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ConnectionString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="894bf-108">取得または接続文字列の値を設定します。</span><span class="sxs-lookup"><span data-stu-id="894bf-108">Gets or sets connection string value.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="894bf-109">取得または接続文字列の名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="894bf-109">Gets or sets name of connection string.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="894bf-110">取得またはデータベースの種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="894bf-110">Gets or sets type of database.</span></span> <span data-ttu-id="894bf-111">使用可能な値が含まれます: 'MySql'、'SQLServer'、'SQLAzure'、'Custom'、'NotificationHub'、'ServiceBus'、'EventHub'、'ApiHub'、'DocDb'、'RedisCache'</span><span class="sxs-lookup"><span data-stu-id="894bf-111">Possible values include: 'MySql', 'SQLServer', 'SQLAzure', 'Custom', 'NotificationHub', 'ServiceBus', 'EventHub', 'ApiHub', 'DocDb', 'RedisCache'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
