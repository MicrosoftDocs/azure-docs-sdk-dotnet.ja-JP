<Type Name="PushSettingsInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.PushSettingsInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="23d5b-101">アプリの設定をプッシュします。</span><span class="sxs-lookup"><span data-stu-id="23d5b-101">Push settings for the App.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="23d5b-102">PushSettingsInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="23d5b-102">Initializes a new instance of the PushSettingsInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="DynamicTagsJson">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="23d5b-103">取得またはプッシュ登録エンドポイントのユーザー要求からに評価される動的のタグの一覧を含む JSON 文字列を設定します。</span><span class="sxs-lookup"><span data-stu-id="23d5b-103">Gets or sets a JSON string containing a list of dynamic tags that will be evaluated from user claims in the push registration endpoint.</span></span>
            </summary>
    ...
    <Member MemberName="IsPushEnabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="23d5b-104">取得またはプッシュ エンドポイントが有効になっているかどうかを示すフラグを設定します。</span><span class="sxs-lookup"><span data-stu-id="23d5b-104">Gets or sets a flag indicating whether the Push endpoint is enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TagsRequiringAuth">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="23d5b-105">取得またはプッシュ登録エンドポイントで使用されるユーザー認証を必要とするタグの一覧を含む JSON 文字列を設定します。</span><span class="sxs-lookup"><span data-stu-id="23d5b-105">Gets or sets a JSON string containing a list of tags that require user authentication to be used in the push registration endpoint.</span></span>
            <span data-ttu-id="23d5b-106">タグは、英数字と次で構成できます: '_'、' @'、'#'、'. ',':'、'-' です。</span><span class="sxs-lookup"><span data-stu-id="23d5b-106">Tags can consist of alphanumeric characters and the following: '_', '@', '#', '.', ':', '-'.</span></span>
            <span data-ttu-id="23d5b-107">PushRequestHandler で検証を実行する必要があります。</span><span class="sxs-lookup"><span data-stu-id="23d5b-107">Validation should be performed at the PushRequestHandler.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TagWhitelistJson">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="23d5b-108">取得またはホワイト リストに登録プッシュ登録エンドポイントで使用するためにあるタグの一覧を含む JSON 文字列を設定します。</span><span class="sxs-lookup"><span data-stu-id="23d5b-108">Gets or sets a JSON string containing a list of tags that are whitelisted for use by the push registration endpoint.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="23d5b-109">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="23d5b-109">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="23d5b-110">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="23d5b-110">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
  </Members>
