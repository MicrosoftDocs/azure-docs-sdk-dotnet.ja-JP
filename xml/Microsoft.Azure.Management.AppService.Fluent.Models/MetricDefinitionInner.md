<Type Name="MetricDefinitionInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.MetricDefinitionInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ef683-101">メトリックのメタデータ。</span><span class="sxs-lookup"><span data-stu-id="ef683-101">Metadata for a metric.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef683-102">MetricDefinitionInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ef683-102">Initializes a new instance of the MetricDefinitionInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef683-103">UI に表示されるフレンドリ名を取得します。</span><span class="sxs-lookup"><span data-stu-id="ef683-103">Gets friendly name shown in the UI.</span></span>
            </summary>
    ...
    <Member MemberName="MetricAvailabilities">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef683-104">保有期間と共にメトリックに対してサポートされて時間結晶の一覧を取得します。</span><span class="sxs-lookup"><span data-stu-id="ef683-104">Gets list of time grains supported for the metric together with retention period.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MetricDefinitionName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef683-105">メトリックの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="ef683-105">Gets name of the metric.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrimaryAggregationType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef683-106">プライマリの集計の種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="ef683-106">Gets primary aggregation type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ef683-107">メトリックの単位を取得します。</span><span class="sxs-lookup"><span data-stu-id="ef683-107">Gets unit of the metric.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
