<Type Name="RecommendationInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.RecommendationInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b5b91-101">リコメンデーション エンジンによって生成された推奨設定の結果を表します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-101">Represents a recommendation result generated by the recommendation engine.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-102">RecommendationInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-102">Initializes a new instance of the RecommendationInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ActionName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-103">取得またはこのオブジェクトで推奨されたアクションの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-103">Gets or sets name of action recommended by this object.</span></span>
            </summary>
    ...
    <Member MemberName="Channels">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-104">取得またはこの推奨事項が適用可能なチャネルのリストを設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-104">Gets or sets list of channels that this recommendation can apply.</span></span>
            <span data-ttu-id="b5b91-105">使用可能な値が含まれます: '通知'、'Api'、'電子メール'、'Webhook'、'All'</span><span class="sxs-lookup"><span data-stu-id="b5b91-105">Possible values include: 'Notification', 'Api', 'Email', 'Webhook', 'All'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CreationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-106">取得または、このインスタンスの作成時にタイムスタンプを設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-106">Gets or sets timestamp when this instance was created.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-107">取得または (が一意でない)、規則の UI の表示名を設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-107">Gets or sets UI friendly name of the rule (may not be unique).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EndTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-108">取得または (utc) の推奨事項が参照する範囲の終了時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-108">Gets or sets the end time in UTC of a range that the recommendation refers to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-109">取得またはこの推奨設定に影響する重大度を示すレベルを設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-109">Gets or sets level indicating how critical this recommendation can impact.</span></span> <span data-ttu-id="b5b91-110">使用可能な値が含まれます: '重大'、'警告'、'情報'、'NonUrgentSuggestion'</span><span class="sxs-lookup"><span data-stu-id="b5b91-110">Possible values include: 'Critical', 'Warning', 'Information', 'NonUrgentSuggestion'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-111">取得または推奨事項のテキストを設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-111">Gets or sets recommendation text.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NextNotificationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-112">取得または設定 (utc) でこの推奨事項を次に通知します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-112">Gets or sets when to notify this recommendation next in UTC.</span></span> <span data-ttu-id="b5b91-113">Null では、このことはありませんに通知されることされなくなります。</span><span class="sxs-lookup"><span data-stu-id="b5b91-113">Null means that this will never be notified anymore.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NotificationExpirationTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-114">取得またはこの通知の有効期限が切れるときに、日付と時刻を UTC に設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-114">Gets or sets date and time in UTC when this notification expires.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NotifiedTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-115">取得または最後のタイムスタンプをこのインスタンスが実際に通知を受け取った UTC に設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-115">Gets or sets last timestamp in UTC this instance was actually notified.</span></span> <span data-ttu-id="b5b91-116">Null では、この推奨設定がまだ通知されていないことを意味します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-116">Null means that this recommendation hasn't been notified yet.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecommendationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-117">取得または推奨設定の各オブジェクトに関連付けられている GUID 値を設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-117">Gets or sets a GUID value that each recommendation object is associated with.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-118">取得またはこの推奨設定オブジェクトが関連付けられている完全な ARM リソース ID 文字列を設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-118">Gets or sets full ARM resource ID string that this recommendation object is associated with.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceScope">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-119">取得またはこの推奨事項が適用されるリソースの種類などのサブスクリプションの場合、サーバー ファームでは、サイトの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-119">Gets or sets name of a resource type this recommendation applies, e.g. Subscription, ServerFarm, Site.</span></span> <span data-ttu-id="b5b91-120">使用可能な値が含まれます: 'ServerFarm'、'Subscription'、'web サイト'</span><span class="sxs-lookup"><span data-stu-id="b5b91-120">Possible values include: 'ServerFarm', 'Subscription', 'WebSite'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RuleName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-121">取得またはルールの一意の名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-121">Gets or sets unique name of the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Score">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-122">取得またはルールによって測定されるメトリックの値を設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-122">Gets or sets a metric value measured by the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StartTime">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-123">取得または (utc) の推奨事項が参照する範囲の開始時刻を設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-123">Gets or sets the beginning time in UTC of a range that the recommendation refers to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b5b91-124">取得またはこの推奨設定が属するカテゴリのタグの一覧を設定します。</span><span class="sxs-lookup"><span data-stu-id="b5b91-124">Gets or sets the list of category tags that this recommendation belongs to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
