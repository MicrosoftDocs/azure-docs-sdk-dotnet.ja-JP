<Type Name="RecommendationRuleInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.RecommendationRuleInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c83c9-101">リコメンデーション エンジンを実行できるリコメンデーション ルールを表します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-101">Represents a recommendation rule that the recommendation engine can perform.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c83c9-102">RecommendationRuleInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-102">Initializes a new instance of the RecommendationRuleInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="ActionName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c83c9-103">取得または文字列でこの規則によって推奨されるアクションの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-103">Gets or sets name of action that is recommended by this rule in string.</span></span>
            </summary>
    ...
    <Member MemberName="Channels">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c83c9-104">取得または、この規則が適用される利用可能なチャネルのリストを設定します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-104">Gets or sets list of available channels that this rule applies.</span></span>
            <span data-ttu-id="c83c9-105">使用可能な値が含まれます: '通知'、'Api'、'電子メール'、'Webhook'、'All'</span><span class="sxs-lookup"><span data-stu-id="c83c9-105">Possible values include: 'Notification', 'Api', 'Email', 'Webhook', 'All'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Description">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c83c9-106">取得またはルールのローカライズの詳細な説明を設定します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-106">Gets or sets localized detailed description of the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c83c9-107">取得または規則の UI の表示名を設定します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-107">Gets or sets UI friendly name of the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Level">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c83c9-108">取得または、このルールは、重大度を示すへの影響のレベルを設定します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-108">Gets or sets level of impact indicating how critical this rule is.</span></span>
            <span data-ttu-id="c83c9-109">使用可能な値が含まれます: '重大'、'警告'、'情報'、'NonUrgentSuggestion'</span><span class="sxs-lookup"><span data-stu-id="c83c9-109">Possible values include: 'Critical', 'Warning', 'Information', 'NonUrgentSuggestion'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c83c9-110">取得またはルール (UI に適している) のローカライズされた名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-110">Gets or sets localized name of the rule (Good for UI).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c83c9-111">取得またはルールの一意の名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-111">Gets or sets unique name of the rule.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecommendationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c83c9-112">取得または推奨設定が存在する場合、そのルールに関連付けられている推奨事項が関連付けられているオブジェクトの ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-112">Gets or sets recommendation ID of an associated recommendation object tied to the rule, if exists.</span></span>
            <span data-ttu-id="c83c9-113">設定されているようなオブジェクトが存在しない場合に null です。</span><span class="sxs-lookup"><span data-stu-id="c83c9-113">If such an object doesn't exist, it is set to null.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c83c9-114">取得またはルールを含むカテゴリのタグの配列を設定します。</span><span class="sxs-lookup"><span data-stu-id="c83c9-114">Gets or sets an array of category tags that the rule contains.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
