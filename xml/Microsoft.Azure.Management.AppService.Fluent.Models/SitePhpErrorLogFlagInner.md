<Type Name="SitePhpErrorLogFlagInner" FullName="Microsoft.Azure.Management.AppService.Fluent.Models.SitePhpErrorLogFlagInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b2e86-101">PHP のエラー ログのフラグを取得するために使用します。</span><span class="sxs-lookup"><span data-stu-id="b2e86-101">Used for getting PHP error logging flag.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b2e86-102">SitePhpErrorLogFlagInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b2e86-102">Initializes a new instance of the SitePhpErrorLogFlagInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="LocalLogErrors">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b2e86-103">取得またはローカル log_errors 設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="b2e86-103">Gets or sets local log_errors setting.</span></span>
            </summary>
    ...
    <Member MemberName="LocalLogErrorsMaxLength">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b2e86-104">取得またはローカル log_errors_max_len 設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="b2e86-104">Gets or sets local log_errors_max_len setting.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MasterLogErrors">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b2e86-105">取得またはマスター log_errors 設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="b2e86-105">Gets or sets master log_errors setting.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MasterLogErrorsMaxLength">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b2e86-106">取得またはマスター log_errors_max_len 設定を設定します。</span><span class="sxs-lookup"><span data-stu-id="b2e86-106">Gets or sets master log_errors_max_len setting.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
