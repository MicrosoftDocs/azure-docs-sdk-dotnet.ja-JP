<Type Name="JobListResponse" FullName="Microsoft.Azure.Management.HDInsight.Job.Models.JobListResponse">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2eed2-101">一覧のジョブ操作の応答。</span><span class="sxs-lookup"><span data-stu-id="2eed2-101">The List Job operation response.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2eed2-102">JobListResponse クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="2eed2-102">Initializes a new instance of the JobListResponse class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2eed2-103">JobList のシーケンスを取得します。</span><span class="sxs-lookup"><span data-stu-id="2eed2-103">Gets the sequence of JobList.</span></span>
            </summary>
    ...
    <Member MemberName="JobList">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2eed2-104">省略可能。</span><span class="sxs-lookup"><span data-stu-id="2eed2-104">Optional.</span></span> <span data-ttu-id="2eed2-105">取得または HDInsight クラスターから受信したジョブ一覧結果オブジェクトを設定します。</span><span class="sxs-lookup"><span data-stu-id="2eed2-105">Gets or sets the job list result object recieved from the HDInsight cluster.</span></span>
            </summary>
    ...
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2eed2-106">JobList のシーケンスを取得します。</span><span class="sxs-lookup"><span data-stu-id="2eed2-106">Gets the sequence of JobList.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
