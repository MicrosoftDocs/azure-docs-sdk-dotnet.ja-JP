<Type Name="MigrationPlanInfoMsgList" FullName="Microsoft.WindowsAzure.Management.StorSimple.MigrationPlanInfoMsgList">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="48b8c-101">クラスは、特定の状態の移行計画の一覧を表します。</span><span class="sxs-lookup"><span data-stu-id="48b8c-101">Class represents the list of migration plan in a particular status</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="status"><span data-ttu-id="48b8c-102">移行計画の状態</span><span class="sxs-lookup"><span data-stu-id="48b8c-102">migration plan status</span></span></param>
        <summary>
            <span data-ttu-id="48b8c-103">指定された移行計画の状態の MigrationPlanInfoMsgList を構築します。</span><span class="sxs-lookup"><span data-stu-id="48b8c-103">Constructs MigrationPlanInfoMsgList of specified migration plan status</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="MigrationTimeEstimationInfoList">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48b8c-104">取得または指定された状態の移行計画の一覧の設定</span><span class="sxs-lookup"><span data-stu-id="48b8c-104">Gets or sets the list of migration plan in the given state</span></span>
            </summary>
    ...
    <Member MemberName="MigrationTimeEstimationStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48b8c-105">取得または設定の移行の推定状態</span><span class="sxs-lookup"><span data-stu-id="48b8c-105">Gets or sets the migration estimation state</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="48b8c-106">移行計画の一覧を目的の形式の文字列に変換します</span><span class="sxs-lookup"><span data-stu-id="48b8c-106">Converts migration plan list to string desired format</span></span>
            </summary>
        <returns><span data-ttu-id="48b8c-107">移行計画の一覧を目的の形式の文字列</span><span class="sxs-lookup"><span data-stu-id="48b8c-107">migration plan list to string desired format</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
