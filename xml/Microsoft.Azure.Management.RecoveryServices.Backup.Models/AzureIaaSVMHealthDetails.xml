<Type Name="AzureIaaSVMHealthDetails" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.AzureIaaSVMHealthDetails">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="c22a9-101">Azure IaaS VM ワークロードに固有の正常性の詳細。</span><span class="sxs-lookup"><span data-stu-id="c22a9-101">Azure IaaS VM workload-specific Health Details.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c22a9-102">AzureIaaSVMHealthDetails クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c22a9-102">Initializes a new instance of the AzureIaaSVMHealthDetails class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code"><span data-ttu-id="c22a9-103">状態コード</span><span class="sxs-lookup"><span data-stu-id="c22a9-103">Health Code</span></span></param>
        <param name="title"><span data-ttu-id="c22a9-104">正常性のタイトル</span><span class="sxs-lookup"><span data-stu-id="c22a9-104">Health Title</span></span></param>
        <param name="message"><span data-ttu-id="c22a9-105">正常性メッセージ</span><span class="sxs-lookup"><span data-stu-id="c22a9-105">Health Message</span></span></param>
        <param name="recommendations"><span data-ttu-id="c22a9-106">推奨される操作の正常性</span><span class="sxs-lookup"><span data-stu-id="c22a9-106">Health Recommended Actions</span></span></param>
        <summary>
            <span data-ttu-id="c22a9-107">AzureIaaSVMHealthDetails クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="c22a9-107">Initializes a new instance of the AzureIaaSVMHealthDetails class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c22a9-108">取得または設定の状態コード</span><span class="sxs-lookup"><span data-stu-id="c22a9-108">Gets or sets health Code</span></span>
            </summary>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c22a9-109">取得または設定の正常性メッセージ</span><span class="sxs-lookup"><span data-stu-id="c22a9-109">Gets or sets health Message</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Recommendations">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c22a9-110">取得または推奨される操作の正常性の設定</span><span class="sxs-lookup"><span data-stu-id="c22a9-110">Gets or sets health Recommended Actions</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Title">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="c22a9-111">取得または設定のタイトルのヘルス</span><span class="sxs-lookup"><span data-stu-id="c22a9-111">Gets or sets health Title</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
