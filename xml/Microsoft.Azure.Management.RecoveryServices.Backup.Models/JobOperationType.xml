<Type Name="JobOperationType" FullName="Microsoft.Azure.Management.RecoveryServices.Backup.Models.JobOperationType">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="a19de-101">JobOperationType の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="a19de-101">Defines values for JobOperationType.</span></span>
            </summary>
