<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewaySslCertificate.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3207a-101">アプリケーション ゲートウェイの更新プログラムの一部としてアプリケーション ゲートウェイの SSL 証明書の更新の全体です。</span><span class="sxs-lookup"><span data-stu-id="3207a-101">The entirety of an application gateway SSL certificate update as part of an application gateway update.</span></span>
            </summary>
