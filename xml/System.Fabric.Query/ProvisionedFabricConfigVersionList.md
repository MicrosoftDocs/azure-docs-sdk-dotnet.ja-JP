<Type Name="ProvisionedFabricConfigVersionList" FullName="System.Fabric.Query.ProvisionedFabricConfigVersionList">
  ...
  <Members>
    <Member MemberName="Add">
      ...
      <Docs>
        <param name="item">
          <para><span data-ttu-id="b71ed-102">指定した項目を一覧に追加します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-102">The specified item to add in the list.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="b71ed-103">この一覧に指定した項目を追加します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-103">Adds the specified item to this list.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Clear">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="b71ed-104">このリストからすべての項目を削除します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-104">Removes all items from this list.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Contains">
      ...
      <Docs>
        <param name="item">
          <para><span data-ttu-id="b71ed-105">一覧に含まれている指定された項目。</span><span class="sxs-lookup"><span data-stu-id="b71ed-105">The specified item that is contained in the list.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="b71ed-106">指定した項目がこの一覧に含まれている場合は true を返します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-106">Returns true if the specified item is contained in this list.</span></span></para>
        </summary>
        <returns>
          <para>
            <span data-ttu-id="b71ed-107"><languageKeyword>true</languageKeyword>指定した項目がこの一覧に含まれている、それ以外の場合は<languageKeyword>false</languageKeyword>です。</span><span class="sxs-lookup"><span data-stu-id="b71ed-107"><languageKeyword>true</languageKeyword> if the specified item is contained in this list; otherwise, <languageKeyword>false</languageKeyword>.</span></span></para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CopyTo">
      ...
      <Docs>
        <param name="array">
          <para><span data-ttu-id="b71ed-108">コピーされた要素のコピー先である 1 次元配列<see cref="T:System.Fabric.Query.ProvisionedFabricConfigVersionList" />です。</span><span class="sxs-lookup"><span data-stu-id="b71ed-108">The one-dimensional array that is the destination of elements copied from <see cref="T:System.Fabric.Query.ProvisionedFabricConfigVersionList" />.</span></span> <span data-ttu-id="b71ed-109">配列には、0 から始まるインデックスが設定されている必要があります。</span><span class="sxs-lookup"><span data-stu-id="b71ed-109">The array must have zero-based indexing.</span></span></para>
        </param>
        <param name="arrayIndex">
          <para><span data-ttu-id="b71ed-110">コピーの開始位置となる、配列の 0 から始まるインデックス。</span><span class="sxs-lookup"><span data-stu-id="b71ed-110">The zero-based index in array at which copying begins.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="b71ed-111">この一覧から項目を指定したインデックス位置の指定した配列にコピーします。</span><span class="sxs-lookup"><span data-stu-id="b71ed-111">Copies items from this list to the specified array at the specified index.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Count">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="b71ed-112">この一覧の項目の数を取得します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-112">Gets the number of items in this list.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="b71ed-113">この一覧のアイテムの数。</span><span class="sxs-lookup"><span data-stu-id="b71ed-113">The number of items in this list.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="GetEnumerator">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="b71ed-114">この一覧の項目を列挙子を返します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-114">Returns an enumerator to the items in this list.</span></span></para>
        </summary>
        <returns>
          <para><span data-ttu-id="b71ed-115">この一覧の項目を列挙子。</span><span class="sxs-lookup"><span data-stu-id="b71ed-115">An enumerator to the items in this list.</span></span></para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IndexOf">
      ...
      <Docs>
        <param name="item">
          <para><span data-ttu-id="b71ed-116">一覧内で検索する指定された項目。</span><span class="sxs-lookup"><span data-stu-id="b71ed-116">The specified item to locate in the list.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="b71ed-117">この一覧に指定された項目のインデックスを返します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-117">Returns the index of the specified item in this list.</span></span></para>
        </summary>
        <returns>
          <para><span data-ttu-id="b71ed-118">この一覧に指定した項目のインデックス。</span><span class="sxs-lookup"><span data-stu-id="b71ed-118">The index of the specified item in this list.</span></span></para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Insert">
      ...
      <Docs>
        <param name="index">
          <para><span data-ttu-id="b71ed-119">項目を挿入する位置の、0 から始まるインデックス。</span><span class="sxs-lookup"><span data-stu-id="b71ed-119">The zero-based index at which item should be inserted.</span></span></para>
        </param>
        <param name="item">
          <para><span data-ttu-id="b71ed-120">リストに挿入するオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="b71ed-120">The object to insert into the list.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="b71ed-121">指定したインデックス位置には、この一覧に指定した項目を挿入します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-121">Inserts the specified item into this list at the specified index.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="IsReadOnly">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="b71ed-122">このプロパティが false の場合にのみ、リストを変更できるかどうかを示す値を取得します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-122">Gets a value that indicates whether the list can be modified only if this property is false.</span></span></para>
        </summary>
        <value>
          <para>
            <span data-ttu-id="b71ed-123"><languageKeyword>true</languageKeyword>のみです。 それ以外の場合、リストを変更できる場合<languageKeyword>false</languageKeyword>です。</span><span class="sxs-lookup"><span data-stu-id="b71ed-123"><languageKeyword>true</languageKeyword> if the list can be modified only; otherwise, <languageKeyword>false</languageKeyword>.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Item">
      ...
      <Docs>
        <param name="index">
          <para><span data-ttu-id="b71ed-124">指定したインデックス。</span><span class="sxs-lookup"><span data-stu-id="b71ed-124">The specified index.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="b71ed-125">指定したインデックスにある項目を取得します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-125">Gets the item at the specified index.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="b71ed-126">指定したインデックスにある項目。</span><span class="sxs-lookup"><span data-stu-id="b71ed-126">The item at the specified index.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Remove">
      ...
      <Docs>
        <param name="item">
          <para><span data-ttu-id="b71ed-127">リストから削除するオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="b71ed-127">The object to remove from the list.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="b71ed-128">この一覧から、指定した項目を削除します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-128">Removes the specified item from this list.</span></span></para>
        </summary>
        <returns>
          <para>
            <span data-ttu-id="b71ed-129"><languageKeyword>true</languageKeyword>した項目が正常に一覧から削除された、それ以外の場合<languageKeyword>false</languageKeyword>です。</span><span class="sxs-lookup"><span data-stu-id="b71ed-129"><languageKeyword>true</languageKeyword> if the item was successfully removed from the list; otherwise, <languageKeyword>false</languageKeyword>.</span></span></para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RemoveAt">
      ...
      <Docs>
        <param name="index">
          <para><span data-ttu-id="b71ed-130">削除する項目の 0 から始まるインデックス。</span><span class="sxs-lookup"><span data-stu-id="b71ed-130">The zero-based index of the item to remove.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="b71ed-131">指定したインデックスから、項目を削除します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-131">Removes the item from the specified index.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="System.Collections.IEnumerable.GetEnumerator">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="b71ed-132">この一覧に項目を列挙子を取得します。</span><span class="sxs-lookup"><span data-stu-id="b71ed-132">Gets an enumerator to the items in this list.</span></span></para>
        </summary>
        <returns>
          <para><span data-ttu-id="b71ed-133">この一覧の項目を列挙子。</span><span class="sxs-lookup"><span data-stu-id="b71ed-133">An enumerator to the items in this list.</span></span></para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
