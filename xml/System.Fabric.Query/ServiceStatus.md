<Type Name="ServiceStatus" FullName="System.Fabric.Query.ServiceStatus">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="99151-101">呼び出すことによって取得されたサービスの状態を表す<see cref="M:System.Fabric.FabricClient.QueryClient.GetServiceListAsync(System.Uri)" />です。</span><span class="sxs-lookup"><span data-stu-id="99151-101">Represents the status of a service retrieved by calling <see cref="M:System.Fabric.FabricClient.QueryClient.GetServiceListAsync(System.Uri)" />.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Active">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99151-102">サービスが正常に作成されました。</span><span class="sxs-lookup"><span data-stu-id="99151-102">The service has been successfully created.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Creating">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99151-103">サービスを作成しています。</span><span class="sxs-lookup"><span data-stu-id="99151-103">The service is being created.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Deleting">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99151-104">サービスを削除しています。</span><span class="sxs-lookup"><span data-stu-id="99151-104">The service is being deleted.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Failed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99151-105">作成または削除は永続的な失敗したため終了しました。</span><span class="sxs-lookup"><span data-stu-id="99151-105">Creation or deletion was terminated due to persistent failures.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Unknown">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99151-106">サービスの状態は不明です。</span><span class="sxs-lookup"><span data-stu-id="99151-106">The service status is not yet known.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Upgrading">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="99151-107">サービスをアップグレード中です。</span><span class="sxs-lookup"><span data-stu-id="99151-107">The service is being upgraded.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
