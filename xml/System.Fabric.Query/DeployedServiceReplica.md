<Type Name="DeployedServiceReplica" FullName="System.Fabric.Query.DeployedServiceReplica">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="21f05-101">ノード上のレプリカのビューを表します。</span><span class="sxs-lookup"><span data-stu-id="21f05-101">Represents the view of a replica on a node.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kind">
          <para><span data-ttu-id="21f05-102">サービスの種類。</span><span class="sxs-lookup"><span data-stu-id="21f05-102">The service kind.</span></span></para>
        </param>
        <summary>
          <para><span data-ttu-id="21f05-103"><see cref="T:System.Fabric.Query.DeployedServiceReplica" /> クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="21f05-103">Initializes a new instance of the <see cref="T:System.Fabric.Query.DeployedServiceReplica" /> class.</span></span></para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Address">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="21f05-104">Open または ChangeRole 内のレプリカによって返される最後のアドレス。</span><span class="sxs-lookup"><span data-stu-id="21f05-104">The last address returned by the replica in Open or ChangeRole.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="21f05-105">Open または ChangeRole 内のレプリカによって返される最後のアドレス。</span><span class="sxs-lookup"><span data-stu-id="21f05-105">The last address returned by the replica in Open or ChangeRole.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="CodePackageName">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="21f05-106">このレプリカをホストするコード パッケージの名前。</span><span class="sxs-lookup"><span data-stu-id="21f05-106">The name of the code package that hosts this replica.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="21f05-107">このレプリカをホストするコード パッケージの名前。</span><span class="sxs-lookup"><span data-stu-id="21f05-107">The name of the code package that hosts this replica.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="HostProcessId">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="21f05-108">ホスト プロセス id。</span><span class="sxs-lookup"><span data-stu-id="21f05-108">The host process id.</span></span></para>
          <value><span data-ttu-id="21f05-109">レプリカがダウンした場合は、0 になります。</span><span class="sxs-lookup"><span data-stu-id="21f05-109">This will be zero if the replica is down.</span></span></value>
        </summary>
    ...
    <Member MemberName="Partitionid">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="21f05-110">この replia のパーティションの id。</span><span class="sxs-lookup"><span data-stu-id="21f05-110">The partition id for this replia.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="21f05-111">この replia のパーティションの id。</span><span class="sxs-lookup"><span data-stu-id="21f05-111">The partition id for this replia.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ReplicaStatus">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="21f05-112">レプリカの状態です。</span><span class="sxs-lookup"><span data-stu-id="21f05-112">The status of the replica.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="21f05-113">レプリカの状態です。</span><span class="sxs-lookup"><span data-stu-id="21f05-113">The status of the replica.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ServiceKind">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="21f05-114">レプリカ (ステートフルまたはステートレス) の型。</span><span class="sxs-lookup"><span data-stu-id="21f05-114">The type of the replica (Stateful or Stateless).</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="21f05-115"><see cref="T:System.Fabric.Query.ServiceKind" /> を返します。</span><span class="sxs-lookup"><span data-stu-id="21f05-115">Returns <see cref="T:System.Fabric.Query.ServiceKind" />.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ServiceManifestName">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="21f05-116">このレプリカをホストしているコード パッケージを含むサービス パッケージの名前。</span><span class="sxs-lookup"><span data-stu-id="21f05-116">The name of the service package that contains the code package hosting this replica.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="21f05-117"><see cref="T:System.String" /> を返します。</span><span class="sxs-lookup"><span data-stu-id="21f05-117">Returns <see cref="T:System.String" />.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ServiceManifestVersion">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="21f05-118">サービス マニフェストのバージョン。</span><span class="sxs-lookup"><span data-stu-id="21f05-118">The version of the service manifest.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="21f05-119">サービス マニフェストのバージョン。</span><span class="sxs-lookup"><span data-stu-id="21f05-119">The version of the service manifest.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ServiceName">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="21f05-120">サービスの名前。</span><span class="sxs-lookup"><span data-stu-id="21f05-120">The name of the service.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="21f05-121">サービスの名前。</span><span class="sxs-lookup"><span data-stu-id="21f05-121">The name of the service.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ServicePackageActivationId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="21f05-122">サービス パッケージの ActivationId します。</span><span class="sxs-lookup"><span data-stu-id="21f05-122">The ActivationId of service package.</span></span>
            </summary>
        <value>
          <para>
            <span data-ttu-id="21f05-123">展開済みサービス パッケージの ActivationId を表す文字列。</span><span class="sxs-lookup"><span data-stu-id="21f05-123">A string representing ActivationId of deployed service package.</span></span> <span data-ttu-id="21f05-124">場合<see cref="T:System.Fabric.Description.ServicePackageActivationMode" />サービスの作成時に指定した<see cref="F:System.Fabric.Description.ServicePackageActivationMode.SharedProcess" />(が指定されていない場合に既定値はまたは<see cref="F:System.Fabric.Description.ServicePackageActivationMode.SharedProcess" />)、次の値が<see cref="P:System.Fabric.Query.DeployedServiceReplica.ServicePackageActivationId" />は常に空の文字列。</span><span class="sxs-lookup"><span data-stu-id="21f05-124">If <see cref="T:System.Fabric.Description.ServicePackageActivationMode" /> specified at the time of creating the service is <see cref="F:System.Fabric.Description.ServicePackageActivationMode.SharedProcess" /> (or if it is not specified, in which case it defaults to <see cref="F:System.Fabric.Description.ServicePackageActivationMode.SharedProcess" />), then value of <see cref="P:System.Fabric.Query.DeployedServiceReplica.ServicePackageActivationId" /> is always an empty string.</span></span>
            <span data-ttu-id="21f05-125">詳細をご覧ください。<see cref="T:System.Fabric.Description.ServicePackageActivationMode" />です。</span><span class="sxs-lookup"><span data-stu-id="21f05-125">For more details please see <see cref="T:System.Fabric.Description.ServicePackageActivationMode" />.</span></span>
            </para>
          <remarks>
            <span data-ttu-id="21f05-126">場合は、null 値を持つこのできます<see cref="P:System.Fabric.Query.DeployedServiceReplica.ReplicaStatus" />以外の場合は、 <see cref="F:System.Fabric.Query.ServiceReplicaStatus.InBuild" />、<see cref="F:System.Fabric.Query.ServiceReplicaStatus.Standby" />または<see cref="F:System.Fabric.Query.ServiceReplicaStatus.Ready" />です。</span><span class="sxs-lookup"><span data-stu-id="21f05-126">This can have null value if <see cref="P:System.Fabric.Query.DeployedServiceReplica.ReplicaStatus" /> is other than <see cref="F:System.Fabric.Query.ServiceReplicaStatus.InBuild" />, <see cref="F:System.Fabric.Query.ServiceReplicaStatus.Standby" /> or <see cref="F:System.Fabric.Query.ServiceReplicaStatus.Ready" />.</span></span>
            </remarks>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceTypeName">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="21f05-127">サービスの種類の名前。</span><span class="sxs-lookup"><span data-stu-id="21f05-127">The name of the service type.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="21f05-128">サービスの種類の名前。</span><span class="sxs-lookup"><span data-stu-id="21f05-128">The name of the service type.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
