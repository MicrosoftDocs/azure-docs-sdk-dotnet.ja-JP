<Type Name="ImageStoreFileInfo" FullName="System.Fabric.Query.ImageStoreFileInfo">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2fa8c-101">ImageStoreFileInfo には、ネイティブ イメージ ストア ファイルの情報が含まれています。</span><span class="sxs-lookup"><span data-stu-id="2fa8c-101">A ImageStoreFileInfo contains information about the native image store file</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="FileSize">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="2fa8c-102">イメージ ストア ファイルのバイト単位のサイズを取得します。</span><span class="sxs-lookup"><span data-stu-id="2fa8c-102">Gets the size in bytes of the image store file.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="2fa8c-103">イメージ ストア ファイルのバイト サイズ。</span><span class="sxs-lookup"><span data-stu-id="2fa8c-103">The size in bytes of the image store file.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="FileVersion">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="2fa8c-104">イメージ ストア ファイルのバージョンを取得します。</span><span class="sxs-lookup"><span data-stu-id="2fa8c-104">Gets the image store file version.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="2fa8c-105">イメージ ストア ファイルのバージョン。</span><span class="sxs-lookup"><span data-stu-id="2fa8c-105">The image store file verison.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ModifiedDate">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="2fa8c-106">ファイルが最後に変更された日時を取得します。</span><span class="sxs-lookup"><span data-stu-id="2fa8c-106">Gets the date and time when the file was last modified.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="2fa8c-107">日付と、ファイルの最終変更時刻。</span><span class="sxs-lookup"><span data-stu-id="2fa8c-107">The date and time when the file was last modified.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="StoreRelativePath">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="2fa8c-108">ネイティブ イメージ ストアのルートから、ファイルの相対パスを取得します。</span><span class="sxs-lookup"><span data-stu-id="2fa8c-108">Get the relative path of the file from the native image store root.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="2fa8c-109">ネイティブ イメージからファイルの相対パスでは、ルートを格納します。</span><span class="sxs-lookup"><span data-stu-id="2fa8c-109">The relative path of the file from the native image store root.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
