<Type Name="PremiumMessagingRegionsOperationsExtensions" FullName="Microsoft.Azure.Management.ServiceBus.PremiumMessagingRegionsOperationsExtensions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="dd881-101">PremiumMessagingRegionsOperations の拡張メソッド。</span><span class="sxs-lookup"><span data-stu-id="dd881-101">Extension methods for PremiumMessagingRegionsOperations.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="List">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="dd881-102">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="dd881-102">The operations group for this extension method.</span></span>
            </param>
        <summary>
            <span data-ttu-id="dd881-103">メッセージング servicebus の領域の使用可能な premium を取得します。</span><span class="sxs-lookup"><span data-stu-id="dd881-103">Gets the available premium messaging regions for servicebus</span></span>
            </summary>
    ...
    <Member MemberName="ListAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="dd881-104">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="dd881-104">The operations group for this extension method.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="dd881-105">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="dd881-105">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="dd881-106">メッセージング servicebus の領域の使用可能な premium を取得します。</span><span class="sxs-lookup"><span data-stu-id="dd881-106">Gets the available premium messaging regions for servicebus</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNext">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="dd881-107">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="dd881-107">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="dd881-108">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="dd881-108">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <summary>
            <span data-ttu-id="dd881-109">メッセージング servicebus の領域の使用可能な premium を取得します。</span><span class="sxs-lookup"><span data-stu-id="dd881-109">Gets the available premium messaging regions for servicebus</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ListNextAsync">
      ...
      <Docs>
        <param name="operations">
            <span data-ttu-id="dd881-110">この拡張メソッドの操作のグループです。</span><span class="sxs-lookup"><span data-stu-id="dd881-110">The operations group for this extension method.</span></span>
            </param>
        <param name="nextPageLink">
            <span data-ttu-id="dd881-111">一覧表示操作に成功した呼び出しからの NextLink です。</span><span class="sxs-lookup"><span data-stu-id="dd881-111">The NextLink from the previous successful call to List operation.</span></span>
            </param>
        <param name="cancellationToken">
            <span data-ttu-id="dd881-112">キャンセル トークン。</span><span class="sxs-lookup"><span data-stu-id="dd881-112">The cancellation token.</span></span>
            </param>
        <summary>
            <span data-ttu-id="dd881-113">メッセージング servicebus の領域の使用可能な premium を取得します。</span><span class="sxs-lookup"><span data-stu-id="dd881-113">Gets the available premium messaging regions for servicebus</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
