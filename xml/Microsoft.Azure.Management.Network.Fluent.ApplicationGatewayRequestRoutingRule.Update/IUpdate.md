<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.ApplicationGatewayRequestRoutingRule.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="812e6-101">Application gateway の全体は、アプリケーション ゲートウェイの更新プログラムの一部としてルーティング ルールの更新を要求します。</span><span class="sxs-lookup"><span data-stu-id="812e6-101">The entirety of an application gateway request routing rule update as part of an application gateway update.</span></span>
            </summary>
