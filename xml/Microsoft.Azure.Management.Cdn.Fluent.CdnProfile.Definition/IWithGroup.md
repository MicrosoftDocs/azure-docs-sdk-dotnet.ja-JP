<Type Name="IWithGroup" FullName="Microsoft.Azure.Management.Cdn.Fluent.CdnProfile.Definition.IWithGroup">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d0f61-101">CDN プロファイル定義を指定するリソース グループの段階です。</span><span class="sxs-lookup"><span data-stu-id="d0f61-101">The stage of a CDN profile definition allowing the resource group to be specified.</span></span>
            </summary>
