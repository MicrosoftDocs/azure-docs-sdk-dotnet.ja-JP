<Type Name="IWithDeleteOnIdle" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Topic.Definition.IWithDeleteOnIdle">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2a742-101">自動を定義できるようにトピック定義のステージでは、動作を削除します。</span><span class="sxs-lookup"><span data-stu-id="2a742-101">The stage of the topic definition allowing to define auto delete behaviour.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithDeleteOnIdleDurationInMinutes">
      ...
      <Docs>
        <param name="durationInMinutes"><span data-ttu-id="2a742-102">アイドル状態の期間 (分) です。</span><span class="sxs-lookup"><span data-stu-id="2a742-102">Idle duration in minutes.</span></span></param>
        <summary>
            <span data-ttu-id="2a742-103">トピックは自動的に削除するまでのアイドル間隔です。</span><span class="sxs-lookup"><span data-stu-id="2a742-103">The idle interval after which the topic is automatically deleted.</span></span>
            <span data-ttu-id="2a742-104">注: は明示的にオーバーライドしない限り、アイドル状態の期間で delete を既定値は無限 (TimeSpan.Max)。</span><span class="sxs-lookup"><span data-stu-id="2a742-104">Note: unless it is explicitly overridden the default delete on idle duration is infinite (TimeSpan.Max).</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="2a742-105">トピックの定義の次のステージ。</span><span class="sxs-lookup"><span data-stu-id="2a742-105">The next stage of topic definition.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>