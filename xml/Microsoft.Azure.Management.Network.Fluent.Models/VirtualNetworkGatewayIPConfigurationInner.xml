<Type Name="VirtualNetworkGatewayIPConfigurationInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.VirtualNetworkGatewayIPConfigurationInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b58ed-101">仮想ネットワーク ゲートウェイの IP の構成</span><span class="sxs-lookup"><span data-stu-id="b58ed-101">IP configuration for virtual network gateway</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b58ed-102">VirtualNetworkGatewayIPConfigurationInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b58ed-102">Initializes a new instance of the VirtualNetworkGatewayIPConfigurationInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b58ed-103">取得または設定、リソースを更新するたびに変化する一意の読み取り専用文字列。</span><span class="sxs-lookup"><span data-stu-id="b58ed-103">Gets or sets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b58ed-104">取得またはリソース グループ内で一意であるリソースの名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="b58ed-104">Gets or sets the name of the resource that is unique within a resource group.</span></span> <span data-ttu-id="b58ed-105">この名前は、リソースへのアクセスに使用できます。</span><span class="sxs-lookup"><span data-stu-id="b58ed-105">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrivateIPAllocationMethod">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b58ed-106">取得またはプライベート IP の割り当て方法を設定します。</span><span class="sxs-lookup"><span data-stu-id="b58ed-106">Gets or sets the private IP allocation method.</span></span> <span data-ttu-id="b58ed-107">使用可能な値が: 'Static' と 'Dynamic' です。</span><span class="sxs-lookup"><span data-stu-id="b58ed-107">Possible values are: 'Static' and 'Dynamic'.</span></span> <span data-ttu-id="b58ed-108">使用可能な値が含まれます: 'Static'、'Dynamic'</span><span class="sxs-lookup"><span data-stu-id="b58ed-108">Possible values include: 'Static', 'Dynamic'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b58ed-109">パブリック IP リソースのプロビジョニングの状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="b58ed-109">Gets the provisioning state of the public IP resource.</span></span> <span data-ttu-id="b58ed-110">使用可能な値が: '更新'、'削除' および '失敗' です。</span><span class="sxs-lookup"><span data-stu-id="b58ed-110">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicIPAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b58ed-111">取得またはパブリック IP リソースへの参照を設定します。</span><span class="sxs-lookup"><span data-stu-id="b58ed-111">Gets or sets the reference of the public IP resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subnet">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b58ed-112">取得またはサブネットのリソースへの参照を設定します。</span><span class="sxs-lookup"><span data-stu-id="b58ed-112">Gets or sets the reference of the subnet resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
