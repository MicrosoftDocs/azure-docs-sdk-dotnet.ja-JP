<Type Name="RouteTableInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.RouteTableInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="78a1f-101">テーブル リソースをルーティングします。</span><span class="sxs-lookup"><span data-stu-id="78a1f-101">Route table resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78a1f-102">RouteTableInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="78a1f-102">Initializes a new instance of the RouteTableInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="routes"><span data-ttu-id="78a1f-103">ルート テーブル内に含まれるルートのコレクション。</span><span class="sxs-lookup"><span data-stu-id="78a1f-103">Collection of routes contained within a route table.</span></span></param>
        <param name="subnets"><span data-ttu-id="78a1f-104">サブネットへの参照のコレクション。</span><span class="sxs-lookup"><span data-stu-id="78a1f-104">A collection of references to subnets.</span></span></param>
        <param name="provisioningState"><span data-ttu-id="78a1f-105">リソースのプロビジョニングの状態。</span><span class="sxs-lookup"><span data-stu-id="78a1f-105">The provisioning state of the resource.</span></span> <span data-ttu-id="78a1f-106">使用可能な値が: '更新'、'削除' および '失敗' です。</span><span class="sxs-lookup"><span data-stu-id="78a1f-106">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span></param>
        <param name="etag"><span data-ttu-id="78a1f-107">リソースを更新するたびに変化する一意の読み取り専用文字列を取得します。</span><span class="sxs-lookup"><span data-stu-id="78a1f-107">Gets a unique read-only string that changes whenever the resource is updated.</span></span></param>
        <summary>
            <span data-ttu-id="78a1f-108">RouteTableInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="78a1f-108">Initializes a new instance of the RouteTableInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78a1f-109">リソースを更新するたびに変化する一意の読み取り専用文字列を取得します。</span><span class="sxs-lookup"><span data-stu-id="78a1f-109">Gets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78a1f-110">取得またはリソースのプロビジョニングの状態を設定します。</span><span class="sxs-lookup"><span data-stu-id="78a1f-110">Gets or sets the provisioning state of the resource.</span></span> <span data-ttu-id="78a1f-111">使用可能な値が: '更新'、'削除' および '失敗' です。</span><span class="sxs-lookup"><span data-stu-id="78a1f-111">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Routes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78a1f-112">取得または、ルート テーブル内に含まれるルートのコレクションを設定します。</span><span class="sxs-lookup"><span data-stu-id="78a1f-112">Gets or sets collection of routes contained within a route table.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Subnets">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="78a1f-113">サブネットへの参照のコレクションを取得します。</span><span class="sxs-lookup"><span data-stu-id="78a1f-113">Gets a collection of references to subnets.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
