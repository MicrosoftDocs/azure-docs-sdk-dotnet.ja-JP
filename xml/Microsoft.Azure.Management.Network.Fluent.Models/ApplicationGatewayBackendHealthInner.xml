<Type Name="ApplicationGatewayBackendHealthInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewayBackendHealthInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2df2b-101">ApplicationGatewayBackendHealthPool リソースの一覧です。</span><span class="sxs-lookup"><span data-stu-id="2df2b-101">List of ApplicationGatewayBackendHealthPool resources.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="2df2b-102">ApplicationGatewayBackendHealthInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="2df2b-102">Initializes a new instance of the ApplicationGatewayBackendHealthInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="2df2b-103">ApplicationGatewayBackendHealthInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="2df2b-103">Initializes a new instance of the ApplicationGatewayBackendHealthInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
