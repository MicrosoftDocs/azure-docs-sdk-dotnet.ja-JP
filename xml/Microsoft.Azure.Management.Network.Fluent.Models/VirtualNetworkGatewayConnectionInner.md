<Type Name="VirtualNetworkGatewayConnectionInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.VirtualNetworkGatewayConnectionInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="02777-101">一般的なリソースについての一般的なクラス</span><span class="sxs-lookup"><span data-stu-id="02777-101">A common class for general resource information</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-102">VirtualNetworkGatewayConnectionInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="02777-102">Initializes a new instance of the VirtualNetworkGatewayConnectionInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="AuthorizationKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-103">取得または、authorizationKey を設定します。</span><span class="sxs-lookup"><span data-stu-id="02777-103">Gets or sets the authorizationKey.</span></span>
            </summary>
    ...
    <Member MemberName="ConnectionStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-104">仮想ネットワーク ゲートウェイ接続の状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="02777-104">Gets virtual network Gateway connection status.</span></span> <span data-ttu-id="02777-105">使用可能な値は 'Unknown'、'接続'、'接続' および 'NotConnected' です。</span><span class="sxs-lookup"><span data-stu-id="02777-105">Possible values are 'Unknown', 'Connecting', 'Connected' and 'NotConnected'.</span></span> <span data-ttu-id="02777-106">使用可能な値が含まれます: 'Unknown'、'接続'、'接続'、'NotConnected'</span><span class="sxs-lookup"><span data-stu-id="02777-106">Possible values include: 'Unknown', 'Connecting', 'Connected', 'NotConnected'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ConnectionType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-107">取得またはゲートウェイ接続の種類を設定します。</span><span class="sxs-lookup"><span data-stu-id="02777-107">Gets or sets gateway connection type.</span></span> <span data-ttu-id="02777-108">使用可能な値が: 'Ipsec'、'Vnet2Vnet'、'ExpressRoute' および ' がない場合。</span><span class="sxs-lookup"><span data-stu-id="02777-108">Possible values are: 'Ipsec','Vnet2Vnet','ExpressRoute', and 'VPNClient.</span></span> <span data-ttu-id="02777-109">使用可能な値が含まれます 'IPsec'、'Vnet2Vnet'、'ExpressRoute'、'がない場合'。</span><span class="sxs-lookup"><span data-stu-id="02777-109">Possible values include: 'IPsec', 'Vnet2Vnet', 'ExpressRoute', 'VPNClient'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EgressBytesTransferred">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-110">この接続で転送された送信バイト数を取得します。</span><span class="sxs-lookup"><span data-stu-id="02777-110">Gets the egress bytes transferred in this connection.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="EnableBgp">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-111">取得または enableBgp フラグを設定</span><span class="sxs-lookup"><span data-stu-id="02777-111">Gets or sets enableBgp flag</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-112">リソースを更新するたびに変化する一意の読み取り専用文字列を取得します。</span><span class="sxs-lookup"><span data-stu-id="02777-112">Gets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IngressBytesTransferred">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-113">この接続で転送された受信バイト数を取得します。</span><span class="sxs-lookup"><span data-stu-id="02777-113">Gets the ingress bytes transferred in this connection.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Peer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-114">取得またはピアリング リソースへの参照を設定します。</span><span class="sxs-lookup"><span data-stu-id="02777-114">Gets or sets the reference to peerings resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-115">VirtualNetworkGatewayConnection リソースのプロビジョニングの状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="02777-115">Gets the provisioning state of the VirtualNetworkGatewayConnection resource.</span></span> <span data-ttu-id="02777-116">使用可能な値が: '更新'、'削除' および '失敗' です。</span><span class="sxs-lookup"><span data-stu-id="02777-116">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceGuid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-117">取得またはリソース VirtualNetworkGatewayConnection リソースの GUID プロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="02777-117">Gets or sets the resource GUID property of the VirtualNetworkGatewayConnection resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RoutingWeight">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-118">取得またはルーティングの重みを設定します。</span><span class="sxs-lookup"><span data-stu-id="02777-118">Gets or sets the routing weight.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SharedKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-119">取得または IPSec の共有キーを設定します。</span><span class="sxs-lookup"><span data-stu-id="02777-119">Gets or sets the IPSec shared key.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TunnelConnectionStatus">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-120">すべてのトンネルの接続のヘルス状態のコレクションを取得します。</span><span class="sxs-lookup"><span data-stu-id="02777-120">Gets collection of all tunnels' connection health status.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="02777-121">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="02777-121">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="02777-122">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="02777-122">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
