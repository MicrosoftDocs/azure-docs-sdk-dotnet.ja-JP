<Type Name="BgpSettings" FullName="Microsoft.Azure.Management.Network.Fluent.Models.BgpSettings">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab6fe-101">BgpSettings クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ab6fe-101">Initializes a new instance of the BgpSettings class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="asn"><span data-ttu-id="ab6fe-102">BGP のスピーカーの ASN です。</span><span class="sxs-lookup"><span data-stu-id="ab6fe-102">The BGP speaker's ASN.</span></span></param>
        <param name="bgpPeeringAddress"><span data-ttu-id="ab6fe-103">BGP ピアリングとアドレスこの BGP スピーカーの BGP の識別子。</span><span class="sxs-lookup"><span data-stu-id="ab6fe-103">The BGP peering address and BGP identifier of this BGP speaker.</span></span></param>
        <param name="peerWeight"><span data-ttu-id="ab6fe-104">この BGP のスピーカーから学習したルートに追加の太さ。</span><span class="sxs-lookup"><span data-stu-id="ab6fe-104">The weight added to routes learned from this BGP speaker.</span></span></param>
        <summary>
            <span data-ttu-id="ab6fe-105">BgpSettings クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="ab6fe-105">Initializes a new instance of the BgpSettings class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Asn">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab6fe-106">取得または BGP スピーカーの ASN を設定します。</span><span class="sxs-lookup"><span data-stu-id="ab6fe-106">Gets or sets the BGP speaker's ASN.</span></span>
            </summary>
    ...
    <Member MemberName="BgpPeeringAddress">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab6fe-107">取得またはこの BGP スピーカーの BGP の識別子と BGP のピアリング アドレスを設定します。</span><span class="sxs-lookup"><span data-stu-id="ab6fe-107">Gets or sets the BGP peering address and BGP identifier of this BGP speaker.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PeerWeight">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ab6fe-108">取得またはこの BGP のスピーカーから学習したルートに追加された重みを設定します。</span><span class="sxs-lookup"><span data-stu-id="ab6fe-108">Gets or sets the weight added to routes learned from this BGP speaker.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
