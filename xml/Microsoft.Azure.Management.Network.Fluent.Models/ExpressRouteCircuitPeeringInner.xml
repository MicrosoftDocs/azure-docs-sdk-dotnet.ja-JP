<Type Name="ExpressRouteCircuitPeeringInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ExpressRouteCircuitPeeringInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4976f-101">ピアリング ExpressRouteCircuit リソースでします。</span><span class="sxs-lookup"><span data-stu-id="4976f-101">Peering in an ExpressRouteCircuit resource.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-102">ExpressRouteCircuitPeeringInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="4976f-102">Initializes a new instance of the ExpressRouteCircuitPeeringInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="AzureASN">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-103">取得または Azure ASN を設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-103">Gets or sets the Azure ASN.</span></span>
            </summary>
    ...
    <Member MemberName="Etag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-104">リソースを更新するたびに変化する一意の読み取り専用文字列を取得します。</span><span class="sxs-lookup"><span data-stu-id="4976f-104">Gets a unique read-only string that changes whenever the resource is updated.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="GatewayManagerEtag">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-105">取得または GatewayManager Etag を設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-105">Gets or sets the GatewayManager Etag.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LastModifiedBy">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-106">プロバイダーまたは顧客の最後に変更された、ピアリングするかどうかを取得します。</span><span class="sxs-lookup"><span data-stu-id="4976f-106">Gets whether the provider or the customer last modified the peering.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MicrosoftPeeringConfig">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-107">取得または Microsoft ピアリング構成を設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-107">Gets or sets the Microsoft peering configuration.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-108">リソース グループ内で一意であるリソースの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="4976f-108">Gets name of the resource that is unique within a resource group.</span></span>
            <span data-ttu-id="4976f-109">この名前は、リソースへのアクセスに使用できます。</span><span class="sxs-lookup"><span data-stu-id="4976f-109">This name can be used to access the resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PeerASN">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-110">取得またはピア ASN を設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-110">Gets or sets the peer ASN.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PeeringType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-111">取得または、PeeringType を設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-111">Gets or sets the PeeringType.</span></span> <span data-ttu-id="4976f-112">使用可能な値が: 'AzurePublicPeering'、'AzurePrivatePeering' および 'MicrosoftPeering' です。</span><span class="sxs-lookup"><span data-stu-id="4976f-112">Possible values are: 'AzurePublicPeering', 'AzurePrivatePeering', and 'MicrosoftPeering'.</span></span> <span data-ttu-id="4976f-113">使用可能な値が含まれます: 'AzurePublicPeering'、'AzurePrivatePeering'、'MicrosoftPeering'</span><span class="sxs-lookup"><span data-stu-id="4976f-113">Possible values include: 'AzurePublicPeering', 'AzurePrivatePeering', 'MicrosoftPeering'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrimaryAzurePort">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-114">取得またはポートのプライマリを設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-114">Gets or sets the primary port.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PrimaryPeerAddressPrefix">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-115">取得またはプライマリ アドレス プレフィックスを設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-115">Gets or sets the primary address prefix.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-116">パブリック IP リソースのプロビジョニングの状態を取得します。</span><span class="sxs-lookup"><span data-stu-id="4976f-116">Gets the provisioning state of the public IP resource.</span></span> <span data-ttu-id="4976f-117">使用可能な値が: '更新'、'削除' および '失敗' です。</span><span class="sxs-lookup"><span data-stu-id="4976f-117">Possible values are: 'Updating', 'Deleting', and 'Failed'.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RouteFilter">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-118">取得または RouteFilter リソースへの参照を設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-118">Gets or sets the reference of the RouteFilter resource.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecondaryAzurePort">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-119">取得またはセカンダリ ポートを設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-119">Gets or sets the secondary port.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecondaryPeerAddressPrefix">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-120">取得またはセカンダリのアドレス プレフィックスを設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-120">Gets or sets the secondary address prefix.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SharedKey">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-121">取得または共有キーを設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-121">Gets or sets the shared key.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-122">取得またはピアリングの状態を設定します。</span><span class="sxs-lookup"><span data-stu-id="4976f-122">Gets or sets the state of peering.</span></span> <span data-ttu-id="4976f-123">使用可能な値が: 'Disabled'、'Enabled' です。</span><span class="sxs-lookup"><span data-stu-id="4976f-123">Possible values are: 'Disabled' and 'Enabled'.</span></span> <span data-ttu-id="4976f-124">使用可能な値が含まれます: '無効'、'Enabled'</span><span class="sxs-lookup"><span data-stu-id="4976f-124">Possible values include: 'Disabled', 'Enabled'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Stats">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-125">統計のピアリングを取得します。</span><span class="sxs-lookup"><span data-stu-id="4976f-125">Gets peering stats.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VlanId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4976f-126">取得または VLAN ID を設定します</span><span class="sxs-lookup"><span data-stu-id="4976f-126">Gets or sets the VLAN ID.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
