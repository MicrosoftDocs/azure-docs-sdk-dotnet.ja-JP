<Type Name="ApplicationGatewayBackendHealthServerHealth" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ApplicationGatewayBackendHealthServerHealth">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="599fe-101">ApplicationGatewayBackendHealthServerHealth の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="599fe-101">Defines values for ApplicationGatewayBackendHealthServerHealth.</span></span>
            </summary>
