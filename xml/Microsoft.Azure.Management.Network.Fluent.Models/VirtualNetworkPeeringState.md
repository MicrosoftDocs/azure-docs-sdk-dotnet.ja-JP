<Type Name="VirtualNetworkPeeringState" FullName="Microsoft.Azure.Management.Network.Fluent.Models.VirtualNetworkPeeringState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="78ab4-101">VirtualNetworkPeeringState の値を定義します。</span><span class="sxs-lookup"><span data-stu-id="78ab4-101">Defines values for VirtualNetworkPeeringState.</span></span>
            </summary>
