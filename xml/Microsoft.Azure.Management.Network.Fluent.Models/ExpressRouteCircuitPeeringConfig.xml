<Type Name="ExpressRouteCircuitPeeringConfig" FullName="Microsoft.Azure.Management.Network.Fluent.Models.ExpressRouteCircuitPeeringConfig">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="d741e-101">ピアリングの構成を指定します。</span><span class="sxs-lookup"><span data-stu-id="d741e-101">Specifies the peering configuration.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d741e-102">ExpressRouteCircuitPeeringConfig クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="d741e-102">Initializes a new instance of the ExpressRouteCircuitPeeringConfig class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="AdvertisedPublicPrefixes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d741e-103">取得または AdvertisedPublicPrefixes への参照を設定します。</span><span class="sxs-lookup"><span data-stu-id="d741e-103">Gets or sets the reference of AdvertisedPublicPrefixes.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="AdvertisedPublicPrefixesState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d741e-104">取得またはピアリング リソースの advertisedPublicPrefixState を設定します。</span><span class="sxs-lookup"><span data-stu-id="d741e-104">Gets or sets advertisedPublicPrefixState of the Peering resource.</span></span>
            <span data-ttu-id="d741e-105">使用可能な値は 'NotConfigured'、'構成'、'構成' および 'ValidationNeeded' です。</span><span class="sxs-lookup"><span data-stu-id="d741e-105">Possible values are 'NotConfigured', 'Configuring', 'Configured', and 'ValidationNeeded'.</span></span> <span data-ttu-id="d741e-106">使用可能な値が含まれます: 'NotConfigured'、'構成'、'構成'、'ValidationNeeded'</span><span class="sxs-lookup"><span data-stu-id="d741e-106">Possible values include: 'NotConfigured', 'Configuring', 'Configured', 'ValidationNeeded'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="CustomerASN">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d741e-107">取得またはピアリングの CustomerASN を設定します。</span><span class="sxs-lookup"><span data-stu-id="d741e-107">Gets or sets the CustomerASN of the peering.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RoutingRegistryName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="d741e-108">取得または設定の RoutingRegistryName を設定します。</span><span class="sxs-lookup"><span data-stu-id="d741e-108">Gets or sets the RoutingRegistryName of the configuration.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
