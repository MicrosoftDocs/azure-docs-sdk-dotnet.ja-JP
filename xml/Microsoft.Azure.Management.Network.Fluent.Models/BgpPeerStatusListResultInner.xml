<Type Name="BgpPeerStatusListResultInner" FullName="Microsoft.Azure.Management.Network.Fluent.Models.BgpPeerStatusListResultInner">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="90165-101">BGP ピアの状態 API サービスの一覧について応答を呼び出す</span><span class="sxs-lookup"><span data-stu-id="90165-101">Response for list BGP peer status API service call</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="90165-102">BgpPeerStatusListResultInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="90165-102">Initializes a new instance of the BgpPeerStatusListResultInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="90165-103">BGP ピアの一覧</span><span class="sxs-lookup"><span data-stu-id="90165-103">List of BGP peers</span></span></param>
        <summary>
            <span data-ttu-id="90165-104">BgpPeerStatusListResultInner クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="90165-104">Initializes a new instance of the BgpPeerStatusListResultInner class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="90165-105">取得または設定の BGP ピアの一覧</span><span class="sxs-lookup"><span data-stu-id="90165-105">Gets or sets list of BGP peers</span></span>
            </summary>
