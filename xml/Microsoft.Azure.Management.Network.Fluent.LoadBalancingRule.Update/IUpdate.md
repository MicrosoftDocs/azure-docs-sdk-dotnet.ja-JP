<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancingRule.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4ebc9-101">ロード バランシング ルールの全体は、ロード バランサーの更新の一部として更新します。</span><span class="sxs-lookup"><span data-stu-id="4ebc9-101">The entirety of a load balancing rule update as part of a load balancer update.</span></span>
            </summary>
