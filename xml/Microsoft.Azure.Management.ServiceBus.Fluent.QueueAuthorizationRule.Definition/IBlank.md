<Type Name="IBlank" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.QueueAuthorizationRule.Definition.IBlank">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="8b2d4-101">キューの承認規則の定義の最初の段階です。</span><span class="sxs-lookup"><span data-stu-id="8b2d4-101">The first stage of queue authorization rule definition.</span></span>
            </summary>
