<Type Name="JobPreparationTaskState" FullName="Microsoft.Azure.Batch.Common.JobPreparationTaskState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="ae13c-101">ジョブの準備タスクの状態。</span><span class="sxs-lookup"><span data-stu-id="ae13c-101">The state of a Job Preparation task.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Completed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ae13c-102">タスクは終了コード 0 で終了しましたまたはタスクで、再試行の制限が使い果たさか、バッチ サービスは、スケジュール エラーのためタスクを開始できませんでした。</span><span class="sxs-lookup"><span data-stu-id="ae13c-102">The task has exited with exit code 0, or the task has exhausted its retry limit, or the Batch service was unable to start the task due to scheduling errors.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Running">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="ae13c-103">(再試行を含む)、タスクは実行中です。</span><span class="sxs-lookup"><span data-stu-id="ae13c-103">The task is currently running (including retrying).</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
