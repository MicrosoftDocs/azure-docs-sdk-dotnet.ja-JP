<Type Name="RequestInformation" FullName="Microsoft.Azure.Batch.Common.RequestInformation">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="1bc64-101">要求に関連付けられた一般的な情報のセット。</span><span class="sxs-lookup"><span data-stu-id="1bc64-101">A set of common information associated with a request.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="BatchError">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1bc64-102">取得または発生した特定のエラーに関する詳細なメタデータを含むバッチのエラー情報を設定します。</span><span class="sxs-lookup"><span data-stu-id="1bc64-102">Gets or sets the Batch Error information which contains detailed metadata around the specific error encountered.</span></span>
            </summary>
    ...
    <Member MemberName="ClientRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1bc64-103">取得または設定、クライアント要求 id。 クライアントによって設定します。</span><span class="sxs-lookup"><span data-stu-id="1bc64-103">Gets or sets the client-request-id set by the client.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HttpStatusCode">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1bc64-104">取得または要求の HTTP ステータス コードを設定します。</span><span class="sxs-lookup"><span data-stu-id="1bc64-104">Gets or sets the HTTP status code for the request.</span></span>
            <span data-ttu-id="1bc64-105">HTTP 応答をことはありません (たとえば クライアント側のタイムアウト) 受信した場合は、このプロパティが null です。</span><span class="sxs-lookup"><span data-stu-id="1bc64-105">In cases where an HTTP response was never recieved (for example on client side timeout) this property is null.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HttpStatusMessage">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1bc64-106">取得または要求の HTTP ステータス メッセージを設定します。</span><span class="sxs-lookup"><span data-stu-id="1bc64-106">Gets or sets the HTTP status message for the request.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceRequestId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="1bc64-107">取得または、この要求のサービス要求 ID を設定します。</span><span class="sxs-lookup"><span data-stu-id="1bc64-107">Gets or sets the service request ID for this request.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
