<Type Name="JobState" FullName="Microsoft.Azure.Batch.Common.JobState">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b0169-101">ジョブの状態</span><span class="sxs-lookup"><span data-stu-id="b0169-101">The state of job</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Active">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0169-102">ジョブは、スケジュールされたタスクがある使用可能です。</span><span class="sxs-lookup"><span data-stu-id="b0169-102">The job is available to have tasks scheduled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Completed">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0169-103">すべてのタスクが終了すると、し、システムより多くのタスクまたはジョブにさらなる変更を許可されません。</span><span class="sxs-lookup"><span data-stu-id="b0169-103">All tasks have terminated, and the system will not accept any more tasks or any further changes to the job.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Deleting">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0169-104">ユーザーが、ジョブが削除されることを要求されましたが、(たとえば、システムがまだ終了していますのタスクを実行している) ため、削除操作が進行中です。</span><span class="sxs-lookup"><span data-stu-id="b0169-104">A user has requested that the job be deleted, but the delete operation is still in progress (for example, because the system is still terminating running tasks).</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Disabled">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0169-105">ユーザーは、ジョブを無効にします。</span><span class="sxs-lookup"><span data-stu-id="b0169-105">A user has disabled the job.</span></span> <span data-ttu-id="b0169-106">タスクが実行されていないと、新しいタスクがスケジュールされません。</span><span class="sxs-lookup"><span data-stu-id="b0169-106">No tasks are running, and no new tasks will be scheduled.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Disabling">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0169-107">ユーザーがジョブを無効にする、要求しますが、無効化操作がまだ進行中 (たとえば、タスクの終了を待機しています)。</span><span class="sxs-lookup"><span data-stu-id="b0169-107">A user has requested that the job be disabled, but the disable operation is still in progress (for example, waiting for tasks to terminate).</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Enabling">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0169-108">ユーザーがジョブを有効にする、要求しますが、有効にする操作が進行中です。</span><span class="sxs-lookup"><span data-stu-id="b0169-108">A user has requested that the job be enabled, but the enable operation is still in progress.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Terminating">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0169-109">ジョブが完了すると、ジョブ マネージャー タスクが完了したか、ユーザーが、ジョブを終了しましたが、(たとえば、ジョブのリリース タスクが実行されている) ために、終了操作が進行中です。</span><span class="sxs-lookup"><span data-stu-id="b0169-109">The job is about to complete, either because a Job Manager task has completed or because the user has terminated the job, but the terminate operation is still in progress (for example, because Job Release tasks are running).</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
