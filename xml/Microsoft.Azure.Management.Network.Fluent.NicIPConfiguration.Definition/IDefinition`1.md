<Type Name="IDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.NicIPConfiguration.Definition.IDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="e6f8c-101">最終的な Attachable.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="e6f8c-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="e6f8c-102">ネットワーク インターフェイス IP 構成の定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="e6f8c-102">The entirety of the network interface IP configuration definition.</span></span>
            </summary>
