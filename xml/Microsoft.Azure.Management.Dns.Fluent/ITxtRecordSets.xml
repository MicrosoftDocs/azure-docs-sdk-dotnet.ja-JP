<Type Name="ITxtRecordSets" FullName="Microsoft.Azure.Management.Dns.Fluent.ITxtRecordSets">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="44966-101">TXT レコードへのエントリ ポイントを DNS ゾーンに設定します。</span><span class="sxs-lookup"><span data-stu-id="44966-101">Entry point to TXT record sets in a DNS zone.</span></span>
            </summary>
