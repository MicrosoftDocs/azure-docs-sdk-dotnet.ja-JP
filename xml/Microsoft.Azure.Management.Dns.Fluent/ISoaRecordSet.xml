<Type Name="ISoaRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.ISoaRecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f18cd-101">Azure DNS ゾーンの SOA (start 機関の) レコードの変更できないクライアント側表現を設定します。</span><span class="sxs-lookup"><span data-stu-id="f18cd-101">An immutable client-side representation of a SOA (start of authority) record set in Azure DNS Zone.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Record">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f18cd-102">このレコード セット内の SOA レコードを取得します。</span><span class="sxs-lookup"><span data-stu-id="f18cd-102">Gets the SOA record in this record set.</span></span>
            </summary>
