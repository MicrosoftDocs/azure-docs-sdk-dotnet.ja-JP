<Type Name="IDnsRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.IDnsRecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="383fa-101">Azure DNS ゾーンのレコード セットの変更できないクライアント側表現。</span><span class="sxs-lookup"><span data-stu-id="383fa-101">An immutable client-side representation of a record set in Azure DNS Zone.</span></span>
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Metadata">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="383fa-102">このレコード セットに関連付けられているメタデータを取得します。</span><span class="sxs-lookup"><span data-stu-id="383fa-102">Gets the metadata associated with this record set.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RecordType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="383fa-103">このレコード セット内のレコードの種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="383fa-103">Gets the type of records in this record set.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TimeToLive">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="383fa-104">このレコード セット内のレコードの TTL を取得します。</span><span class="sxs-lookup"><span data-stu-id="383fa-104">Gets TTL of the records in this record set.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
