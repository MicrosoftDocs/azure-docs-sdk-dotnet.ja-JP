<Type Name="IPtrRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.IPtrRecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="fd9cf-101">PTR (ポインター) レコードの変更できないクライアント側表現は、Azure DNS ゾーンで設定します。</span><span class="sxs-lookup"><span data-stu-id="fd9cf-101">An immutable client-side representation of a PTR (pointer) record set in Azure DNS Zone.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="TargetDomainNames">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="fd9cf-102">このレコード セット内の PTR レコードのターゲットのドメイン名を取得します。</span><span class="sxs-lookup"><span data-stu-id="fd9cf-102">Gets the target domain names of PTR records in this record set.</span></span>
            </summary>
