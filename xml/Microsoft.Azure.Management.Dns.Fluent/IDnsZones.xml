<Type Name="IDnsZones" FullName="Microsoft.Azure.Management.Dns.Fluent.IDnsZones">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b68fc-101">Azure での DNS ゾーン管理 API へのエントリ ポイントです。</span><span class="sxs-lookup"><span data-stu-id="b68fc-101">Entry point to DNS zone management API in Azure.</span></span>
            </summary>
