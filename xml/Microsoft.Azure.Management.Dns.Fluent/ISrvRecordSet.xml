<Type Name="ISrvRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.ISrvRecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3db9c-101">SVR (サービス) のレコードの変更できないクライアント側表現は、Azure DNS ゾーンで設定します。</span><span class="sxs-lookup"><span data-stu-id="3db9c-101">An immutable client-side representation of an SVR (service) record set in Azure DNS Zone.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Records">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3db9c-102">このレコード セット内の SRV レコードを取得します。</span><span class="sxs-lookup"><span data-stu-id="3db9c-102">Gets the SRV records in this record set.</span></span>
            </summary>
