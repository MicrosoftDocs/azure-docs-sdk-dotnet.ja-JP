<Type Name="IDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.LoadBalancerInboundNatPool.Definition.IDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="4b4fe-101">最終的な DefinitionStages.WithAttach.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="4b4fe-101">The return type of the final  DefinitionStages.WithAttach.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="4b4fe-102">着信 NAT プール定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="4b4fe-102">The entirety of an inbound NAT pool definition.</span></span>
            </summary>
