<Type Name="IDefinition&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.AppService.Fluent.WebAppSourceControl.Definition.IDefinition&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="18026-101">最終的な Attachable.attach() の戻り値の型。</span><span class="sxs-lookup"><span data-stu-id="18026-101">The return type of the final  Attachable.attach().</span></span></typeparam>
    <summary>
            <span data-ttu-id="18026-102">Web アプリ ソース コントロールの定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="18026-102">The entirety of a web app source control definition.</span></span>
            </summary>
