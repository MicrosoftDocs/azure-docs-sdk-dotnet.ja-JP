<Type Name="IUpdateTxtRecordSet" FullName="Microsoft.Azure.Management.Dns.Fluent.DnsRecordSet.UpdateTxtRecordSet.IUpdateTxtRecordSet">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="48041-101">TXT レコードの全体は、親 DNS ゾーンの更新プログラムの一部として更新を設定します。</span><span class="sxs-lookup"><span data-stu-id="48041-101">The entirety of a TXT record set update as a part of parent DNS zone update.</span></span>
            </summary>
