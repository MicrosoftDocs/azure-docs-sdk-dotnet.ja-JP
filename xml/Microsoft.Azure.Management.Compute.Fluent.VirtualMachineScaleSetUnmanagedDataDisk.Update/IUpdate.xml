<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineScaleSetUnmanagedDataDisk.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e9fef-101">仮想マシン スケール セットの更新の一部としてアンマネージ データ ディスクの更新プログラムの全体です。</span><span class="sxs-lookup"><span data-stu-id="e9fef-101">The entirety of a unmanaged data disk update as part of a virtual machine scale set update.</span></span>
            </summary>
