<Type Name="IWithAttach&lt;ParentT&gt;" FullName="Microsoft.Azure.Management.Compute.Fluent.VirtualMachineUnmanagedDataDisk.Definition.IWithAttach&lt;ParentT&gt;">
  ...
  <Docs>
    <typeparam name="ParentT"><span data-ttu-id="4f81b-101">この定義をアタッチした後に戻るに親の定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="4f81b-101">The stage of the parent definition to return to after attaching this definition.</span></span></typeparam>
    <summary>
            <span data-ttu-id="4f81b-102">データ ディスクの定義の最終段階です。</span><span class="sxs-lookup"><span data-stu-id="4f81b-102">The final stage of the data disk definition.</span></span>
            </summary>
