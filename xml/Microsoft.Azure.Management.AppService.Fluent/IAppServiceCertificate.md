<Type Name="IAppServiceCertificate" FullName="Microsoft.Azure.Management.AppService.Fluent.IAppServiceCertificate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="e964e-101">Azure app service 証明書の変更できないクライアント側表現。</span><span class="sxs-lookup"><span data-stu-id="e964e-101">An immutable client-side representation of an Azure app service certificate.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="e964e-102">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです。)。</span><span class="sxs-lookup"><span data-stu-id="e964e-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="CertificateBlob">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-103">.Cer ファイルの生のバイトを取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-103">Gets the raw bytes of .cer file.</span></span>
            </summary>
    ...
    <Member MemberName="ExpirationDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-104">証明書の expriration 日付を取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-104">Gets the certificate expriration date.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FriendlyName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-105">証明書のフレンドリ名を取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-105">Gets the friendly name of the certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HostingEnvironmentProfile">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-106">証明書の使用を App Service 環境の仕様を取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-106">Gets the specification for the App Service Environment to use for the certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HostNames">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-107">証明書が対象のホスト名を取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-107">Gets the host names the certificate applies to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IssueDate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-108">証明書の発行日を取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-108">Gets the certificate issue Date.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Issuer">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-109">証明書の発行者を取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-109">Gets the certificate issuer.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Password">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-110">証明書のパスワードを取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-110">Gets the certificate password.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PfxBlob">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-111">Pfx blob を取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-111">Gets the pfx blob.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="PublicKeyHash">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-112">公開キー ハッシュを取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-112">Gets the public key hash.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SelfLink">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-113">自己リンクを取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-113">Gets the self link.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SiteName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-114">アプリ名を取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-114">Gets the app name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SubjectName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-115">証明書のサブジェクト名を取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-115">Gets the subject name of the certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Thumbprint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-116">証明書の拇印を取得します。</span><span class="sxs-lookup"><span data-stu-id="e964e-116">Gets the certificate thumbprint.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Valid">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="e964e-117">場合の取得、証明書が有効です。</span><span class="sxs-lookup"><span data-stu-id="e964e-117">Gets if the certificate valid.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
