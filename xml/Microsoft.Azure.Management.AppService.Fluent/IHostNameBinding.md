<Type Name="IHostNameBinding" FullName="Microsoft.Azure.Management.AppService.Fluent.IHostNameBinding">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b12a5-101">ホスト名のバインドの変更できない形式です。</span><span class="sxs-lookup"><span data-stu-id="b12a5-101">An immutable representation of a host name binding.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="b12a5-102">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです。)。</span><span class="sxs-lookup"><span data-stu-id="b12a5-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="AzureResourceName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b12a5-103">バインドする Azure リソースの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="b12a5-103">Gets Azure resource name to bind to.</span></span>
            </summary>
    ...
    <Member MemberName="AzureResourceType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b12a5-104">Azure リソースの種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="b12a5-104">Gets Azure resource type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DnsRecordType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b12a5-105">カスタムの DNS レコードの種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="b12a5-105">Gets custom DNS record type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DomainId">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b12a5-106">完全修飾の ARM ドメインのリソース URI を取得します。</span><span class="sxs-lookup"><span data-stu-id="b12a5-106">Gets the fully qualified ARM domain resource URI.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HostName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b12a5-107">バインドするホスト名を取得します。</span><span class="sxs-lookup"><span data-stu-id="b12a5-107">Gets the hostname to bind to.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="HostNameType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b12a5-108">ホスト名の種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="b12a5-108">Gets the host name type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="WebAppName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b12a5-109">Web アプリの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="b12a5-109">Gets the web app name.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
