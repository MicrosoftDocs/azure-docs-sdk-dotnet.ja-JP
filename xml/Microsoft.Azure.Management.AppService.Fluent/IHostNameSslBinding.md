<Type Name="IHostNameSslBinding" FullName="Microsoft.Azure.Management.AppService.Fluent.IHostNameSslBinding">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5d669-101">ホスト名の SSL バインドの変更できない形式です。</span><span class="sxs-lookup"><span data-stu-id="5d669-101">An immutable representation of an host name SSL binding.</span></span>
            </summary>
    <remarks>
            <span data-ttu-id="5d669-102">(ベータ版: この機能はプレビュー期間中および将来のリリースでは、任意の互換性の期待に関係なく、削除を含む設定を含むライブラリのバージョン番号非下位互換性を保つ方法で変更されるようです。)。</span><span class="sxs-lookup"><span data-stu-id="5d669-102">(Beta: This functionality is in preview and as such is subject to change in non-backwards compatible ways in future releases, including removal, regardless of any compatibility expectations set by the containing library version number.).</span></span>
            </remarks>
  </Docs>
  <Members>
    <Member MemberName="SslState">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d669-103">SSL の種類を取得します。</span><span class="sxs-lookup"><span data-stu-id="5d669-103">Gets the SSL type.</span></span>
            </summary>
    ...
    <Member MemberName="Thumbprint">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d669-104">SSL 証明書の拇印を取得します。</span><span class="sxs-lookup"><span data-stu-id="5d669-104">Gets the SSL cert thumbprint.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VirtualIP">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d669-105">IP ベースの SSL の場合は、ホスト名に割り当てられている仮想 IP アドレスが有効になっているを取得します。</span><span class="sxs-lookup"><span data-stu-id="5d669-105">Gets the virtual IP address assigned to the host name if IP based SSL is enabled.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
