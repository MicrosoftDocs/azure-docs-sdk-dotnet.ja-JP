<Type Name="SharedAccessQueuePermissions" FullName="Microsoft.WindowsAzure.Storage.Queue.SharedAccessQueuePermissions">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="5fec2-101">共有アクセス キュー ポリシーのアクセス許可のセットを指定します。</span><span class="sxs-lookup"><span data-stu-id="5fec2-101">Specifies the set of possible permissions for a shared access queue policy.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="Add">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5fec2-102">許可メッセージを追加する権限。</span><span class="sxs-lookup"><span data-stu-id="5fec2-102">Permission to add messages granted.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5fec2-103">共有のアクセスが許可されます。</span><span class="sxs-lookup"><span data-stu-id="5fec2-103">No shared access granted.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="ProcessMessages">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5fec2-104">取得および削除するアクセス許可が付与されるメッセージです。</span><span class="sxs-lookup"><span data-stu-id="5fec2-104">Permission to get and delete messages granted.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Read">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5fec2-105">メッセージをピークし、キューのメタデータを取得するを許可する権限です。</span><span class="sxs-lookup"><span data-stu-id="5fec2-105">Permission to peek messages and get queue metadata granted.</span></span>
            </summary>
      </Docs>
    </Member>
    <Member MemberName="Update">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5fec2-106">メッセージを更新する許可されたアクセスを許可します。</span><span class="sxs-lookup"><span data-stu-id="5fec2-106">Permissions to update messages granted.</span></span>
            </summary>
      </Docs>
    </Member>
  </Members>
