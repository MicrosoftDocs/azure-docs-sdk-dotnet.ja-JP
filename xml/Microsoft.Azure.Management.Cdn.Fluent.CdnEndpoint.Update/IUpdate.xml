<Type Name="IUpdate" FullName="Microsoft.Azure.Management.Cdn.Fluent.CdnEndpoint.Update.IUpdate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6ca57-101">CDN プロファイルの更新の一部としての CDN エンドポイントの更新プログラムの全体です。</span><span class="sxs-lookup"><span data-stu-id="6ca57-101">The entirety of a CDN endpoint update as part of a CDN profile update.</span></span>
            </summary>
