<Type Name="StorageAccountKey" FullName="Microsoft.Azure.Management.Storage.Models.StorageAccountKey">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="274c1-101">ストレージ アカウントのアクセス キー。</span><span class="sxs-lookup"><span data-stu-id="274c1-101">An access key for the storage account.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="274c1-102">StorageAccountKey クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="274c1-102">Initializes a new instance of the StorageAccountKey class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="keyName"><span data-ttu-id="274c1-103">キーの名前です。</span><span class="sxs-lookup"><span data-stu-id="274c1-103">Name of the key.</span></span></param>
        <param name="value"><span data-ttu-id="274c1-104">ベース 64 でエンコードされたキーの値。</span><span class="sxs-lookup"><span data-stu-id="274c1-104">Base 64-encoded value of the key.</span></span></param>
        <param name="permissions"><span data-ttu-id="274c1-105">完全なアクセス許可または、キー--読み取り専用のアクセス許可。</span><span class="sxs-lookup"><span data-stu-id="274c1-105">Permissions for the key -- read-only or full permissions.</span></span> <span data-ttu-id="274c1-106">使用可能な値が含まれます '読み取り'、'Full'。</span><span class="sxs-lookup"><span data-stu-id="274c1-106">Possible values include: 'Read', 'Full'</span></span></param>
        <summary>
            <span data-ttu-id="274c1-107">StorageAccountKey クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="274c1-107">Initializes a new instance of the StorageAccountKey class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="KeyName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="274c1-108">キーの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="274c1-108">Gets name of the key.</span></span>
            </summary>
    ...
    <Member MemberName="Permissions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="274c1-109">完全なアクセス許可またはキー--読み取り専用のアクセス許可を取得します。</span><span class="sxs-lookup"><span data-stu-id="274c1-109">Gets permissions for the key -- read-only or full permissions.</span></span>
            <span data-ttu-id="274c1-110">使用可能な値が含まれます '読み取り'、'Full'。</span><span class="sxs-lookup"><span data-stu-id="274c1-110">Possible values include: 'Read', 'Full'</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="274c1-111">取得は基本キーの値を 64 エンコード形式です。</span><span class="sxs-lookup"><span data-stu-id="274c1-111">Gets base 64-encoded value of the key.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
