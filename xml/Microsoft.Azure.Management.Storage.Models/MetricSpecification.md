<Type Name="MetricSpecification" FullName="Microsoft.Azure.Management.Storage.Models.MetricSpecification">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="3ee95-101">操作のメトリックの仕様です。</span><span class="sxs-lookup"><span data-stu-id="3ee95-101">Metric specification of operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ee95-102">MetricSpecification クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="3ee95-102">Initializes a new instance of the MetricSpecification class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="3ee95-103">メトリックの仕様の名前。</span><span class="sxs-lookup"><span data-stu-id="3ee95-103">Name of metric specification.</span></span></param>
        <param name="displayName"><span data-ttu-id="3ee95-104">メトリックの仕様の名前を表示します。</span><span class="sxs-lookup"><span data-stu-id="3ee95-104">Display name of metric specification.</span></span></param>
        <param name="displayDescription"><span data-ttu-id="3ee95-105">メトリックの仕様の説明を表示します。</span><span class="sxs-lookup"><span data-stu-id="3ee95-105">Display description of metric specification.</span></span></param>
        <param name="unit"><span data-ttu-id="3ee95-106">単位は、バイトまたはカウントがあります。</span><span class="sxs-lookup"><span data-stu-id="3ee95-106">Unit could be Bytes or Count.</span></span></param>
        <param name="dimensions"><span data-ttu-id="3ee95-107">Blob の種類とアクセスのレベルなど、blob のサイズ。</span><span class="sxs-lookup"><span data-stu-id="3ee95-107">Dimensions of blobs, including blob type and access tier.</span></span></param>
        <param name="aggregationType"><span data-ttu-id="3ee95-108">集計の種類には、平均可能性があります。</span><span class="sxs-lookup"><span data-stu-id="3ee95-108">Aggregation type could be Average.</span></span></param>
        <param name="fillGapWithZero"><span data-ttu-id="3ee95-109">か 0 で塗りつぶしギャップを決定するプロパティです。</span><span class="sxs-lookup"><span data-stu-id="3ee95-109">The property to decide fill gap with zero or not.</span></span></param>
        <param name="category"><span data-ttu-id="3ee95-110">このメトリックの仕様が属しているカテゴリには、容量があります。</span><span class="sxs-lookup"><span data-stu-id="3ee95-110">The category this metric specification belong to, could be Capacity.</span></span></param>
        <param name="resourceIdDimensionNameOverride"><span data-ttu-id="3ee95-111">アカウントのリソース id です。</span><span class="sxs-lookup"><span data-stu-id="3ee95-111">Account Resource Id.</span></span></param>
        <summary>
            <span data-ttu-id="3ee95-112">MetricSpecification クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="3ee95-112">Initializes a new instance of the MetricSpecification class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="AggregationType">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ee95-113">取得または設定の集計の種類は平均値である可能性があります。</span><span class="sxs-lookup"><span data-stu-id="3ee95-113">Gets or sets aggregation type could be Average.</span></span>
            </summary>
    ...
    <Member MemberName="Category">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ee95-114">取得または設定に、このメトリックの仕様が属しているカテゴリの容量がある可能性があります。</span><span class="sxs-lookup"><span data-stu-id="3ee95-114">Gets or sets the category this metric specification belong to, could be Capacity.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Dimensions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ee95-115">取得または blob の種類とアクセスのレベルなど、blob のサイズを設定します。</span><span class="sxs-lookup"><span data-stu-id="3ee95-115">Gets or sets dimensions of blobs, including blob type and access tier.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisplayDescription">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ee95-116">取得または仕様のメトリックの表示の説明を設定します。</span><span class="sxs-lookup"><span data-stu-id="3ee95-116">Gets or sets display description of metric specification.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="DisplayName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ee95-117">取得または仕様のメトリックの表示名を設定します。</span><span class="sxs-lookup"><span data-stu-id="3ee95-117">Gets or sets display name of metric specification.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FillGapWithZero">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ee95-118">取得またはか 0 で塗りつぶしギャップを決定するプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="3ee95-118">Gets or sets the property to decide fill gap with zero or not.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ee95-119">取得またはメトリックの仕様の名前を設定します。</span><span class="sxs-lookup"><span data-stu-id="3ee95-119">Gets or sets name of metric specification.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ResourceIdDimensionNameOverride">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ee95-120">取得または設定アカウント リソース id です。</span><span class="sxs-lookup"><span data-stu-id="3ee95-120">Gets or sets account Resource Id.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Unit">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="3ee95-121">取得または設定単位となるバイトまたはカウントします。</span><span class="sxs-lookup"><span data-stu-id="3ee95-121">Gets or sets unit could be Bytes or Count.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
