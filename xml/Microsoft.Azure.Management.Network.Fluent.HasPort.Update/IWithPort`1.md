<Type Name="IWithPort&lt;ReturnT&gt;" FullName="Microsoft.Azure.Management.Network.Fluent.HasPort.Update.IWithPort&lt;ReturnT&gt;">
  ...
  <Interfaces />
  <Docs>
    <typeparam name="ReturnT"><span data-ttu-id="1c098-101">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="1c098-101">The next stage of the update.</span></span></typeparam>
    <summary>
            <span data-ttu-id="1c098-102">ポート番号を指定できるように定義の段階です。</span><span class="sxs-lookup"><span data-stu-id="1c098-102">The stage of a definition allowing to specify a port number.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName="WithPort">
      ...
      <Docs>
        <param name="portNumber"><span data-ttu-id="1c098-103">ポート番号です。</span><span class="sxs-lookup"><span data-stu-id="1c098-103">A port number.</span></span></param>
        <summary>
            <span data-ttu-id="1c098-104">ポート番号を指定します。</span><span class="sxs-lookup"><span data-stu-id="1c098-104">Specifies the port number.</span></span>
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return><span data-ttu-id="1c098-105">更新プログラムの次のステージ。</span><span class="sxs-lookup"><span data-stu-id="1c098-105">The next stage of the update.</span></span></return>
      </Docs>
    </Member>
  </Members>
</Type>