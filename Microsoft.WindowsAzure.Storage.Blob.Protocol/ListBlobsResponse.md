<Type Name="ListBlobsResponse" FullName="Microsoft.WindowsAzure.Storage.Blob.Protocol.ListBlobsResponse">
  ...
  <Docs>
    <summary>
            Blob の一覧作成操作からの応答を解析するためのメソッドを提供します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.Blob.Protocol.ListBlobsResponse" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Blobs">
      ...
      <Docs>
        <summary>
            実装するオブジェクトの列挙可能なコレクションを取得<see cref="T:Microsoft.WindowsAzure.Storage.Blob.Protocol.IListBlobEntry" />応答からです。
            </summary>
        <value>実装するオブジェクトの列挙可能なコレクション<see cref="T:Microsoft.WindowsAzure.Storage.Blob.Protocol.IListBlobEntry" />です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Delimiter">
      ...
      <Docs>
        <summary>
            XML 応答の一覧作成操作に指定された区切り記号値を取得します。
            </summary>
        <value>区切り記号の値を含む文字列。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ListingContext">
      ...
      <Docs>
        ...
        <value><see cref="T:Microsoft.WindowsAzure.Storage.Blob.Protocol.BlobListingContext" /> オブジェクト。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="MaxResults">
      ...
      <Docs>
        ...
        <value>MaxResults の値を格納する整数。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextMarker">
      ...
      <Docs>
        <summary>
            取得または一覧が完了しなかった場合に、XML 応答から NextMarker 値を設定します。
            </summary>
    ...
    <Member MemberName="ParseXml">
      ...
      <Docs>
        <summary>
            Blob の一覧作成操作の応答 XML を解析します。
            </summary>
        <returns>実装するオブジェクトの列挙可能なコレクション<see cref="T:Microsoft.WindowsAzure.Storage.Blob.Protocol.IListBlobEntry" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
