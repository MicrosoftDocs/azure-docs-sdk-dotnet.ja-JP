<Type Name="VirtualMachineScaleSetExtensionsOperationsExtensions" FullName="Microsoft.Azure.Management.Compute.VirtualMachineScaleSetExtensionsOperationsExtensions">
  ...
  <Docs>
    <summary>
            VirtualMachineScaleSetExtensionsOperations の拡張メソッド。
            </summary>
  ...
  <Members>
    <Member MemberName="BeginCreateOrUpdate">
      ...
      <Docs>
        ...
        <param name="vmScaleSetName">
            設定の拡張機能が表示される必要のある VM スケールの名前は、作成または更新します。
            </param>
        <param name="vmssExtensionName">
            VM スケールの名前は、拡張機能を設定します。
            </param>
        <param name="extensionParameters">
            VM の作成のスケールを指定するパラメーターは、拡張機能の操作を設定します。
            </param>
        <summary>
            作成または拡張機能を更新する操作です。
            </summary>
    ...
    <Member MemberName="List">
      ...
      <Docs>
        ...
        <summary>
            VM スケール セット内のすべての拡張機能の一覧を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
      </Docs>
