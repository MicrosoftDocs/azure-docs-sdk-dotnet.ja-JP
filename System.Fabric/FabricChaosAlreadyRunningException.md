<Type Name="FabricChaosAlreadyRunningException" FullName="System.Fabric.FabricChaosAlreadyRunningException">
  ...
  <Docs>
    <summary>
      <para>クラスターでサービスが既に実行されているときに、Service Fabric の組み込みの複雑さテスト サービスの新しいインスタンスを作成しようとした場合にスローされる例外。</para>
    </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            新しいインスタンスを初期化<see cref="T:System.Fabric.FabricChaosAlreadyRunningException" />エラー コードを持つクラス<see cref="F:System.Fabric.FabricErrorCode.ChaosAlreadyRunning" />です。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化<see cref="T:System.Fabric.FabricChaosAlreadyRunningException" />エラー コードを持つクラス<see cref="F:System.Fabric.FabricErrorCode.ChaosAlreadyRunning" />と指定したエラー メッセージ。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化<see cref="T:System.Fabric.FabricChaosAlreadyRunningException" />コンテキストを指定して、シリアル化されたオブジェクトのデータからのクラスです。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化<see cref="T:System.Fabric.FabricChaosAlreadyRunningException" />指定したエラー メッセージおよびこの例外の原因となった内部例外への参照を持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
