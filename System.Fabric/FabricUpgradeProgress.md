<Type Name="FabricUpgradeProgress" FullName="System.Fabric.FabricUpgradeProgress">
  ...
  <Members>
    ...
    <Member MemberName="GetChangedUpgradeDomains">
      ...
      <Docs>
        <param name="previousProgress">
          <para>このアップグレード プロセスから以前の進行状況レポートです。</para>
        </param>
        <summary>
          <para>変更されたアップグレード ドメインの一覧を取得します。</para>
        </summary>
        <returns>
          <para>変更されたアップグレード ドメインの一覧。</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="NextUpgradeDomain">
      ...
      <Docs>
        <summary>
          <para>このアップグレードには、次のアップグレード ドメインを取得します。</para>
        </summary>
        <value>
          <para>このアップグレードの次のアップグレード ドメイン。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RollingUpgradeMode">
      ...
      <Docs>
        <summary>
          <para>このアップグレードのローリング アップグレードのモードを取得します。</para>
        </summary>
        <value>
          <para>このアップグレードのローリング アップグレード モードです。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="TargetCodeVersion">
      ...
      <Docs>
        <summary>
          <para>このアップグレードのターゲット コード バージョンを取得します。</para>
        </summary>
        <value>
          <para>このアップグレードのターゲット コード バージョンです。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="TargetConfigVersion">
      ...
      <Docs>
        <summary>
          <para>このアップグレードのターゲットの構成バージョンを取得します。</para>
        </summary>
        <value>
          <para>このアップグレードのターゲットの構成のバージョン。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
            Fabric アップグレードの進行状況の文字列表現を取得します。
            </summary>
        <returns><see cref="T:System.Fabric.FabricUpgradeProgress" /> の文字列形式。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UnhealthyEvaluations">
      ...
      <Docs>
        <summary>
          <para>データおよびクラスターの正常性を評価する正常性マネージャーによって使用されるアルゴリズムを記述する正常性評価を取得します。 正常性状態が設定されるクラスターの集計の場合のみ<see cref="F:System.Fabric.Health.HealthState.Error" />です。 正常性評価のため、アップグレードがロールバック時に、正常性チェックが実行された時刻に稼働状態のスナップショット ビューを提供します。</para>
        </summary>
        <value>
          <para>現在の集計された正常性状態を原因となった異常な評価。 次の種類の一覧の項目を指定できます: <see cref="T:System.Fabric.Health.ApplicationsHealthEvaluation" />、 <see cref="T:System.Fabric.Health.NodesHealthEvaluation" />、 <see cref="T:System.Fabric.Health.UpgradeDomainNodesHealthEvaluation" />、 <see cref="T:System.Fabric.Health.SystemApplicationHealthEvaluation" /> oror<see cref="T:System.Fabric.Health.EventHealthEvaluation" />です。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UpgradeDescription">
      ...
      <Docs>
        <summary>
          <para>現在のアップグレードの動作を記述するアップグレード パラメーターの詳細を取得します。</para>
        </summary>
        <value>
          <para>アップグレード パラメーターの詳細を現在のアップグレードの動作を記述します。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UpgradeDomainProgressAtFailure">
      ...
      <Docs>
        ...
        <value>
          <para>アップグレードの進行状況の詳細。 <see cref="T:System.Fabric.UpgradeDomainProgress" /></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UpgradeDomains">
      ...
      <Docs>
        <summary>
          <para>アップグレード ドメインの一覧を取得します。</para>
        </summary>
        <value>
          <para>アップグレード ドメインの一覧。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
