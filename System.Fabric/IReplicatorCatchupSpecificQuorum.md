<Type Name="IReplicatorCatchupSpecificQuorum" FullName="System.Fabric.IReplicatorCatchupSpecificQuorum">
  ...
  <Docs>
    <summary>
      <para>遅れ ReplicaInformation MustCatchup フラグの使用に特定のクォーラムをサポートしていることを示すために、IReplicator を使用できます。</para>
    </summary>
