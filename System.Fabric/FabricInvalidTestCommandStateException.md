<Type Name="FabricInvalidTestCommandStateException" FullName="System.Fabric.FabricInvalidTestCommandStateException">
  ...
  <Docs>
    <summary>
      <para>操作が特定の状態でテスト コマンドに対して無効な場合にスローされる例外。</para>
    </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            新しいインスタンスを初期化<see cref="T:System.Fabric.FabricInvalidTestCommandStateException" />エラー コードを持つクラス<see cref="F:System.Fabric.FabricErrorCode.InvalidTestCommandState" />です。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化<see cref="T:System.Fabric.FabricInvalidTestCommandStateException" />エラー コードを持つクラス<see cref="F:System.Fabric.FabricErrorCode.InvalidTestCommandState" />と指定したエラー メッセージ。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化<see cref="T:System.Fabric.FabricInvalidTestCommandStateException" />コンテキストを指定して、シリアル化されたオブジェクトのデータからのクラスです。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを初期化<see cref="T:System.Fabric.FabricInvalidTestCommandStateException" />指定したエラー メッセージおよびこの例外の原因となった内部例外への参照を持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
