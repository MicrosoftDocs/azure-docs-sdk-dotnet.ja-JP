<Type Name="UpgradeDomainStatus" FullName="System.Fabric.UpgradeDomainStatus">
  ...
  <Docs>
    <summary>
      <para>アップグレード ドメインの状態を表します。</para>
    </summary>
  ...
  <Members>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
          <para>アップグレード ドメインの名前を指定します。 </para>
        </summary>
        <value>
    ...
    <Member MemberName="State">
      ...
      <Docs>
        <summary>
          <para>アップグレード ドメインの状態を指定します。</para>
        </summary>
        <value>
          <para><see cref="T:System.Fabric.UpgradeDomainState" /> を返します。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ToString">
      ...
      <Docs>
        <summary>
          <para>
            アップグレード ドメインの状態の文字列表現を生成します。
            </para>
        </summary>
        <returns>
          <para>アップグレード ドメインの状態を表す文字列。</para>
        </returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
