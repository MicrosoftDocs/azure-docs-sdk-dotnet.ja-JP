<Type Name="FabricUpgradeState" FullName="System.Fabric.FabricUpgradeState">
  ...
  <Docs>
    <summary>
      <para>Service Fabric をアップグレードする場合は、アップグレードの状態を指定します。</para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="RollingBackCompleted">
      ...
      <Docs>
        <summary>
          <para>ロールバック プロセスが完了したことを指定します。</para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="RollingBackInProgress">
      ...
      <Docs>
        <summary>
          <para>ロールバック プロセスが進行中にあるを指定します。</para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="RollingForwardCompleted">
      ...
      <Docs>
        <summary>
          <para>ローリングの転送プロセスが完了したことを指定します。</para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="RollingForwardInProgress">
      ...
      <Docs>
        <summary>
          <para>進行中のローリングの転送プロセスを指定します。</para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="RollingForwardPending">
      ...
      <Docs>
        <summary>
          <para>ローリングの転送処理が保留中であるを指定します。</para>
        </summary>
      </Docs>
    </Member>
  </Members>
