  ...
  <Members>
    ...
    <Member MemberName="ProcessingFailure">
      ...
      <Docs>
        <summary>
          <para>
            処理エラーのため、アップグレードが失敗しました。
            例: プロセスの既定のサービスに失敗します。 詳細については、「<see cref="P:System.Fabric.ApplicationUpgradeProgress.UpgradeStatusDetails" />」を参照してください。
            </para>
        </summary>
      </Docs>
    </Member>
