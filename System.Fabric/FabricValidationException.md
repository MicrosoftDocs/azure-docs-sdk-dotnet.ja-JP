<Type Name="FabricValidationException" FullName="System.Fabric.FabricValidationException">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            FabricValidationException の既定のコンス トラクター
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="errorCode">失敗の FabricErrorCode</param>
        <summary>
            FabricErrorCode 取得 FabricValidationException のコンス トラクター
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            メッセージにかかる FabricValidationException のコンス トラクター
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            FabricValidationException コンス トラクター
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            メッセージとに向けて例外を受け取る FabricValidationException のコンス トラクター
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="message">エラー メッセージ </param>
        <param name="errorCode">ファブリック エラー コード</param>
        <summary>
            メッセージにかかる FabricValidationException および FabricErrorCode コンス トラクター
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="errorCode">ファブリック エラー コード</param>
        <summary>
            メッセージとに向けて例外とファブリック エラー コードは FabricValidationException のコンス トラクター
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
