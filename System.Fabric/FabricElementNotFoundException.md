<Type Name="FabricElementNotFoundException" FullName="System.Fabric.FabricElementNotFoundException">
  ...
  <Docs>
    <summary>
      <para>Service Fabric 要素が利用できない場合にスローされる例外。</para>
    </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
          <para>新しいインスタンスを初期化<see cref="T:System.Fabric.FabricElementNotFoundException" />エラー コードを持つクラス<see cref="F:System.Fabric.FabricErrorCode.Unknown" />です。</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
          <para>新しいインスタンスを初期化<see cref="T:System.Fabric.FabricElementNotFoundException" />クラスを指定したエラー コード。</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
          <para>新しいインスタンスを初期化<see cref="T:System.Runtime.Serialization.StreamingContext" />エラー コードを持つクラス<see cref="F:System.Fabric.FabricErrorCode.Unknown" />と指定したエラー メッセージ。</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
          <para>新しいインスタンスを初期化<see cref="T:System.Fabric.FabricElementNotFoundException" />、指定した情報を持つクラス コンテキスト。</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
          <para>新しいインスタンスを初期化<see cref="T:System.Runtime.Serialization.StreamingContext" />クラスを指定したエラー メッセージと内部例外を使用します。</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
          <para>新しいインスタンスを初期化<see cref="T:System.Fabric.FabricElementNotFoundException" />クラスを指定したメッセージとエラー コード。</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
          <para>新しいインスタンスを初期化<see cref="T:System.Fabric.FabricElementNotFoundException" />クラスを指定した情報、コンテキストおよびエラー コード。</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
          <para>新しいインスタンスを初期化<see cref="T:System.Fabric.FabricElementNotFoundException" />クラスは、指定したメッセージ、内部例外とエラー コード。</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
