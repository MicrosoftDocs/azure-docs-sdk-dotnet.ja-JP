<Type Name="FabricOnlyValidForStatefulPersistentServicesException" FullName="System.Fabric.FabricOnlyValidForStatefulPersistentServicesException">
  ...
  <Docs>
    <summary>
            操作がステートフルの永続的なサービスの有効なだけの場合にスローされる例外。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:System.Fabric.FabricOnlyValidForStatefulPersistentServicesException" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            指定したエラー メッセージを使用して、<see cref="T:System.Fabric.FabricOnlyValidForStatefulPersistentServicesException" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            指定したエラー メッセージおよびこの例外の原因となった内部例外への参照を使用して、<see cref="T:System.Fabric.FabricOnlyValidForStatefulPersistentServicesException" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
          <para>新しいインスタンスを初期化<see cref="T:System.Fabric.FabricOnlyValidForStatefulPersistentServicesException" />メッセージ、エラーのコードを指定します。</para>
        </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
