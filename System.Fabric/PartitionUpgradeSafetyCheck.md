<Type Name="PartitionUpgradeSafetyCheck" FullName="System.Fabric.PartitionUpgradeSafetyCheck">
  ...
  <Docs>
    <summary>
      <para>表す、<see cref="T:System.Fabric.UpgradeSafetyCheck" />パーティション用です。</para>
    </summary>
  ...
  <Members>
    <Member MemberName="PartitionId">
      ...
      <Docs>
        <summary>
          <para>アップグレードの安全性チェックが実行しているパーティションの ID を取得します。</para>
        </summary>
        <value>
          <para>アップグレードの安全性チェックが実行しているパーティションの ID。</para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
