<Type Name="KeyValueStoreItem" FullName="System.Fabric.KeyValueStoreItem">
  ...
  <Docs>
    <summary>
      <para><span data-ttu-id="95a3b-101">キー/値のストア内の項目を表します。</span><span class="sxs-lookup"><span data-stu-id="95a3b-101">Represents an item in the key/value store.</span></span></para>
    </summary>
  ...
  <Members>
    <Member MemberName="Metadata">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="95a3b-102">取得、<see cref="T:System.Fabric.KeyValueStoreItemMetadata" />キー/値のストア内の項目のメタデータを表すオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="95a3b-102">Gets a <see cref="T:System.Fabric.KeyValueStoreItemMetadata" /> object that represents the metadata for an item in the key/value store.</span></span> </para>
        </summary>
        <value>
          <para><span data-ttu-id="95a3b-103">A<see cref="T:System.Fabric.KeyValueStoreItemMetadata" />キー/値のストア内の項目のメタデータを表すオブジェクト。</span><span class="sxs-lookup"><span data-stu-id="95a3b-103">A <see cref="T:System.Fabric.KeyValueStoreItemMetadata" /> object that represents the metadata for an item in the key/value store.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
          <para><span data-ttu-id="95a3b-104">取得、<see cref="T:System.Byte" />キー/値のストア内の項目の値を表すです。</span><span class="sxs-lookup"><span data-stu-id="95a3b-104">Gets a <see cref="T:System.Byte" /> that represents the value of an item in the key/value store.</span></span></para>
        </summary>
        <value>
          <para><span data-ttu-id="95a3b-105">A<see cref="T:System.Byte" />キー/値のストア内の項目の値を表すです。</span><span class="sxs-lookup"><span data-stu-id="95a3b-105">A <see cref="T:System.Byte" /> that represents the value of an item in the key/value store.</span></span></para>
        </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
