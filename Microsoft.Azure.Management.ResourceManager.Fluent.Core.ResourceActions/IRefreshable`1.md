<Type Name="IRefreshable&lt;T&gt;" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Core.ResourceActions.IRefreshable&lt;T&gt;">
  ...
  <Members>
    <Member MemberName="Refresh">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="93fb5-101">Azure との同期にリソースを更新します。</span><span class="sxs-lookup"><span data-stu-id="93fb5-101">Refreshes the resource to sync with Azure.</span></span>
            </summary>
        <returns><span data-ttu-id="93fb5-102">更新されたリソース</span><span class="sxs-lookup"><span data-stu-id="93fb5-102">the refreshed resource</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="RefreshAsync">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="93fb5-103">Azure との同期にリソースを更新します。</span><span class="sxs-lookup"><span data-stu-id="93fb5-103">Refreshes the resource to sync with Azure.</span></span>
            </summary>
        <returns><span data-ttu-id="93fb5-104">更新されたリソース</span><span class="sxs-lookup"><span data-stu-id="93fb5-104">the refreshed resource</span></span></returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
