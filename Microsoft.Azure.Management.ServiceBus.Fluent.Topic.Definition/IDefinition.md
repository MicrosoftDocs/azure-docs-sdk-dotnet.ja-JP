<Type Name="IDefinition" FullName="Microsoft.Azure.Management.ServiceBus.Fluent.Topic.Definition.IDefinition">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="077cb-101">Service Bus トピックの定義の全体です。</span><span class="sxs-lookup"><span data-stu-id="077cb-101">The entirety of the Service Bus topic definition.</span></span>
            </summary>
