<Type Name="IWithCreate" FullName="Microsoft.Azure.Management.AppService.Fluent.AppServiceDomain.Definition.IWithCreate">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="2e562-101">クラウドを指定する省略可能な追加の入力を公開することで、新しいドメインを作成するための十分な入力を持つドメイン定義です。</span><span class="sxs-lookup"><span data-stu-id="2e562-101">A domain definition with sufficient inputs to create a new domain in the cloud, but exposing additional optional inputs to specify.</span></span>
            </summary>
