<Type Name="IRedisCaches" FullName="Microsoft.Azure.Management.Redis.Fluent.IRedisCaches">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="abd00-101">Redis Cache 管理 API 用のエントリ ポイントです。</span><span class="sxs-lookup"><span data-stu-id="abd00-101">Entry point for Redis Cache management API.</span></span>
            </summary>
