<Type Name="IRedisCache" FullName="Microsoft.Azure.Management.Redis.Fluent.IRedisCache">
  ...
  <Docs>
    <summary>
            Azure Redis Cache の変更できないクライアント側表現。
            </summary>
  ...
  <Members>
    <Member MemberName="AsPremium">
      ...
      <Docs>
        ...
        <remarks>To be added.</remarks>
        <return>Premium Sku Redis Cache のインスタンスにのみ使用可能な機能を公開します。</return>
      </Docs>
    </Member>
    ...
    <Member MemberName="IsPremium">
      ...
      <Docs>
        <summary>
            Redis Cache の現在のインスタンスに Premium Sku が設定されている場合は、true を返しますを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NonSslPort">
      ...
      <Docs>
        <summary>
            非 SSL ポートは有効な場合は false をそれ以外の場合は true を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RefreshKeys">
      ...
      <Docs>
        <summary>
            Redis キャッシュ用 Azure からの最新の状態のアクセス キーを取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>この Redis Cache のアクセス キー。</return>
      </Docs>
    </Member>
    <Member MemberName="RegenerateKey">
      ...
      <Docs>
        <param name="keyType">キーの型を再生成します。</param>
        <summary>
            この Redis Cache のアクセス キーを再生成します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>生成されたアクセスは、この Redis Cache をキーします。</return>
      </Docs>
    </Member>
