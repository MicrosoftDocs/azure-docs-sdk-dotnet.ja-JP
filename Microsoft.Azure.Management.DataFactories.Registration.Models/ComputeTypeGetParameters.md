<Type Name="ComputeTypeGetParameters" FullName="Microsoft.Azure.Management.DataFactories.Registration.Models.ComputeTypeGetParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="806fa-101">取得操作の定義を ComputeType を返す方法を指定するパラメーターです。</span><span class="sxs-lookup"><span data-stu-id="806fa-101">Parameters specifying how to return a ComputeType definition for a Get operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="806fa-102">ComputeTypeGetParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="806fa-102">Initializes a new instance of the ComputeTypeGetParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <span data-ttu-id="806fa-103">必須の引数で ComputeTypeGetParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="806fa-103">Initializes a new instance of the ComputeTypeGetParameters class with required arguments.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ComputeTypeName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="806fa-104">必須。</span><span class="sxs-lookup"><span data-stu-id="806fa-104">Required.</span></span> <span data-ttu-id="806fa-105">ComputeType 名前です。</span><span class="sxs-lookup"><span data-stu-id="806fa-105">A ComputeType name.</span></span>
            </summary>
    ...
    <Member MemberName="RegistrationScope">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="806fa-106">必須。</span><span class="sxs-lookup"><span data-stu-id="806fa-106">Required.</span></span> <span data-ttu-id="806fa-107">ComputeType 定義を取得する対象のスコープです。</span><span class="sxs-lookup"><span data-stu-id="806fa-107">The scope for which to get a ComputeType definition.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
