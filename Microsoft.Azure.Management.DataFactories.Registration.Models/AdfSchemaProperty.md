<Type Name="AdfSchemaProperty" FullName="Microsoft.Azure.Management.DataFactories.Registration.Models.AdfSchemaProperty">
  ...
  <Members>
    ...
    <Member MemberName="Items">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d7d9-101">配列のプロパティの型の項目です。</span><span class="sxs-lookup"><span data-stu-id="5d7d9-101">Items for array property type.</span></span> 
            </summary>
    ...
    <Member MemberName="MaxItems">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d7d9-102">配列のプロパティの項目の最大数を入力します。</span><span class="sxs-lookup"><span data-stu-id="5d7d9-102">Maximum number of items for array property type.</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="MinItems">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d7d9-103">配列のプロパティのアイテムの最小数を入力します。</span><span class="sxs-lookup"><span data-stu-id="5d7d9-103">Minimum number of items for array property type.</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d7d9-104">入れ子になったプロパティのこの (オブジェクトの種類に対してのみ有効です)。</span><span class="sxs-lookup"><span data-stu-id="5d7d9-104">Nested properties of this property (only valid for object types).</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Required">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d7d9-105">型の必須プロパティの名前。</span><span class="sxs-lookup"><span data-stu-id="5d7d9-105">Name of the required properties for the type.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="UniqueItems">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="5d7d9-106">配列のプロパティのアイテムの一意の番号を入力します。</span><span class="sxs-lookup"><span data-stu-id="5d7d9-106">Unique number of items for array property type.</span></span> 
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
