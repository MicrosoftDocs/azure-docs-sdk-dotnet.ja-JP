<Type Name="ActivityTypeListParameters" FullName="Microsoft.Azure.Management.DataFactories.Registration.Models.ActivityTypeListParameters">
  ...
  <Docs>
    <summary>
            ActivityType 定義を一覧表示操作の一覧を返す方法を指定するパラメーターです。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ActivityTypeListParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="RegistrationScope">
      ...
      <Docs>
        <summary>
            省略可能。 ActivityType 定義を一覧表示する対象のスコープです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Resolved">
      ...
      <Docs>
        <summary>
            省略可能。 True の場合は、その基本型から継承して各 ActivityType のプロパティを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
