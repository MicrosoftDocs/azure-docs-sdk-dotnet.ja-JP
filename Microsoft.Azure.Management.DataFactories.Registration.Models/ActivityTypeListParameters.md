<Type Name="ActivityTypeListParameters" FullName="Microsoft.Azure.Management.DataFactories.Registration.Models.ActivityTypeListParameters">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="4c5ac-101">ActivityType 定義を一覧表示操作の一覧を返す方法を指定するパラメーターです。</span><span class="sxs-lookup"><span data-stu-id="4c5ac-101">Parameters specifying how to return a list of ActivityType definitions for a List operation.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4c5ac-102">ActivityTypeListParameters クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="4c5ac-102">Initializes a new instance of the ActivityTypeListParameters class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ActivityTypeName">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4c5ac-103">省略可能。</span><span class="sxs-lookup"><span data-stu-id="4c5ac-103">Optional.</span></span> <span data-ttu-id="4c5ac-104">ActivityType リストの名前。</span><span class="sxs-lookup"><span data-stu-id="4c5ac-104">The name of the ActivityType to list.</span></span>
            </summary>
    ...
    <Member MemberName="RegistrationScope">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4c5ac-105">省略可能。</span><span class="sxs-lookup"><span data-stu-id="4c5ac-105">Optional.</span></span> <span data-ttu-id="4c5ac-106">ActivityType 定義を一覧表示する対象のスコープです。</span><span class="sxs-lookup"><span data-stu-id="4c5ac-106">The scope for which to list the ActivityType definitions.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Resolved">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="4c5ac-107">省略可能。</span><span class="sxs-lookup"><span data-stu-id="4c5ac-107">Optional.</span></span> <span data-ttu-id="4c5ac-108">True の場合は、その基本型から継承して各 ActivityType のプロパティを取得します。</span><span class="sxs-lookup"><span data-stu-id="4c5ac-108">If true, gets the properties of any base types each ActivityType inherits from.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
