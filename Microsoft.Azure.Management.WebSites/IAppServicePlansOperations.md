<Type Name="IAppServicePlansOperations" FullName="Microsoft.Azure.Management.WebSites.IAppServicePlansOperations">
  ...
  <Docs>
    <summary>
            AppServicePlansOperations 操作です。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="GetServerFarmSkusWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            指定された App Service プランの選択可能なすべての sku を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>
            指定された App Service プランの選択可能なすべての sku を取得します。
    ...
    <Member MemberName="ListMetricDefintionsNextWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            App Service プランとその定義のクエリ可能なメトリックを取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>
            App Service プランとその定義のクエリ可能なメトリックを取得します。
    ...
    <Member MemberName="ListMetricsWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="details">
            指定&lt;コード&gt;true&lt;/code&gt;にインスタンスの詳細を含めます。
            既定値は&lt;コード&gt;false&lt;/code&gt;です。
            </param>
        <param name="filter">
    ...
    <Member MemberName="ListUsagesWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="filter">
            使用状況/メトリックのみ、フィルターで指定されたを返します。 フィルターは、odata 構文に準拠します。 例: $filter = (name.value eq 'Metric1' または name.value eq 'Metric2')。
            </param>
        <param name="customHeaders">
            追加されるヘッダーを要求します。
            </param>
    ...
    <Member MemberName="ListWebAppsWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <param name="skipToken">
            App service プランに関連付けられている webapps の一覧で web アプリに進んでください。 指定した場合、結果のリスト (など)、skipToken から web アプリが含まれます。 それ以外の場合、結果のリストが一覧の先頭からの web アプリが含まれます
            </param>
        <param name="filter">
