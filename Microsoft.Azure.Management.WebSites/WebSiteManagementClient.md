  ...
  <Members>
    ...
    <Member MemberName="GetSubscriptionDeploymentLocationsWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            使用可能な地理的位置 plus ministamps の一覧を取得します。
            </summary>
        <returns>To be added.</returns>
        <remarks>
            使用可能な地理的位置 plus ministamps の一覧を取得します。
    ...
    <Member MemberName="ListGeoRegionsWithHttpMessagesAsync">
      ...
      <Docs>
        <param name="sku">
            SKU の名前は、領域をフィルター処理に使用します。 使用可能な値が含まれます: 'Free'、'Shared'、'Basic'、'Standard'、'Premium'、'PremiumV2'、'Dynamic'、'Isolated'
            </param>
        <param name="linuxWorkersEnabled">
            指定&lt;コード&gt;true&lt;/code&gt; Linux ワーカーをサポートする領域だけにフィルターを適用する場合。
            </param>
        <param name="customHeaders">
            追加されるヘッダーを要求します。
            </param>
    ...
    <Member MemberName="VerifyHostingEnvironmentVnetWithHttpMessagesAsync">
      ...
      <Docs>
        ...
        <summary>
            ネットワーク セキュリティ グループ ルールを分析して、この VNET が App Service 環境に互換性があることを確認します。
            </summary>
        <returns>To be added.</returns>
        <remarks>
            ネットワーク セキュリティ グループ ルールを分析して、この VNET が App Service 環境に互換性があることを確認します。
