<Type Name="ProviderInner" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Models.ProviderInner">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ProviderInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">プロバイダーの id。</param>
        <param name="namespaceProperty">プロバイダーの名前空間です。</param>
    ...
    <Member MemberName="ResourceTypes">
      ...
      <Docs>
        <summary>
            取得またはプロバイダーの種類のリソースのコレクションを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
