<Type Name="DeploymentProperties" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Models.DeploymentProperties">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="mode">配置モードです。 使用可能な値が含まれます: '増分'、'完了'</param>
        <param name="template">テンプレートの内容。 JObject または適切な形式の JSON 文字列を指定できます。 Template と TemplateLink の 1 つのみを使用します。</param>
        <param name="templateLink">URI テンプレートです。 Template と TemplateLink の 1 つのみを使用します。</param>
        <param name="parameters">デプロイ パラメーターです。 JObject または適切な形式の JSON 文字列を指定できます。 Parameters と ParametersLink の 1 つのみを使用します。</param>
        <param name="parametersLink">URI のパラメーター。 Parameters と ParametersLink の 1 つのみを使用します。</param>
    ...
    <Member MemberName="Mode">
      ...
      <Docs>
        <summary>
            取得または配置モードを設定します。 使用可能な値が含まれます: '増分'、'完了'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            取得またはデプロイのパラメーターを設定します。 JObject または適切な形式の JSON 文字列を指定できます。 Parameters と ParametersLink の 1 つのみを使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ParametersLink">
      ...
      <Docs>
        <summary>
            取得または URI パラメーターを設定します。 Parameters と ParametersLink の 1 つのみを使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Template">
      ...
      <Docs>
        <summary>
            取得またはテンプレートの内容を設定します。 JObject または適切な形式の JSON 文字列を指定できます。 Template と TemplateLink の 1 つのみを使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="TemplateLink">
      ...
      <Docs>
        <summary>
            取得またはテンプレートの URI を設定します。 Template と TemplateLink の 1 つのみを使用します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
