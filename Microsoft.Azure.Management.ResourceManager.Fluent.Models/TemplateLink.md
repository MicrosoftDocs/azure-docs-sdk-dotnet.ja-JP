<Type Name="TemplateLink" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Models.TemplateLink">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            TemplateLink クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="uri">テンプレートを参照する URI。</param>
        <param name="contentVersion">含まれている場合、テンプレート内の ContentVersion に一致する必要があります。</param>
        <summary>
            TemplateLink クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="ContentVersion">
      ...
      <Docs>
        <summary>
            取得または設定が含まれている場合は、テンプレート内の ContentVersion と一致する必要があります。
            </summary>
