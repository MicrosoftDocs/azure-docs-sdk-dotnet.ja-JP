<Type Name="ExportTemplateRequestInner" FullName="Microsoft.Azure.Management.ResourceManager.Fluent.Models.ExportTemplateRequestInner">
  ...
  <Docs>
    <summary>
            リソース グループ テンプレート要求パラメーターをエクスポートします。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ExportTemplateRequestInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="resources">リソースの id。 唯一サポートされている文字列が現在は ' *' (すべてのリソース)。 Api の今後の更新は、特定のリソースのエクスポートをサポートします。</param>
        <param name="options">テンプレートのエクスポート オプション。 サポートされている値は、'IncludeParameterDefaultValue'、'IncludeComments' または ' IncludeParameterDefaultValue、IncludeComments</param>
        <summary>
            ExportTemplateRequestInner クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Options">
      ...
      <Docs>
        <summary>
            取得またはエクスポート テンプレート オプションを設定します。 サポートされている値は、'IncludeParameterDefaultValue'、'IncludeComments' または ' IncludeParameterDefaultValue、IncludeComments
            </summary>
    ...
    <Member MemberName="Resources">
      ...
      <Docs>
        <summary>
            取得またはリソースの id を設定します。 唯一サポートされている文字列が現在は ' *' (すべてのリソース)。 Api の今後の更新は、特定のリソースのエクスポートをサポートします。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
