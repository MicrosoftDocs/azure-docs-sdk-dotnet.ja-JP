<Type Name="ConnectionStatusChangeReason" FullName="Microsoft.Azure.Devices.Client.ConnectionStatusChangeReason">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="62e7a-101">接続の状態を変更する DeviceClient でサポートされている理由</span><span class="sxs-lookup"><span data-stu-id="62e7a-101">Connection status change reason supported by DeviceClient</span></span>
            </summary>
