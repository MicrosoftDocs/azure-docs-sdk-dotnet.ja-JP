<Type Name="ServiceBusTransport" FullName="Microsoft.Azure.Management.DataFactories.Core.Registration.Models.ServiceBusTransport">
  ...
  <Docs>
    <summary>
            ComputeType との通信に Service Bus エンドポイントの定義。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ServiceBusTransport クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="ActivityRequestQueue">
      ...
      <Docs>
        <summary>
            必須。 Azure ServiceBus キューは、ADF がアクティビティのスライスの実行ジョブを送信します。
            </summary>
    ...
    <Member MemberName="ActivityStatusQueue">
      ...
      <Docs>
        <summary>
            必須。 Azure ServiceBus セッション キューがアクティビティ実行プログラムがスライスのステータスを報告する必要があります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceBusEndpoint">
      ...
      <Docs>
        <summary>
            必須。 Azure ServiceBus のエンドポイントです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceBusSharedAccessKey">
      ...
      <Docs>
        <summary>
            必須。 Azure ServiceBus の共有アクセス キー。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ServiceBusSharedAccessKeyName">
      ...
      <Docs>
        <summary>
            必須。 Azure ServiceBus の共有アクセス キーの名前。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
