<Type Name="ComputeTypeListParameters" FullName="Microsoft.Azure.Management.DataFactories.Core.Registration.Models.ComputeTypeListParameters">
  ...
  <Docs>
    <summary>
            一覧表示操作の ComputeType 定義の一覧を返す方法を指定するパラメーターです。名前とスコープの両方を指定する場合は、(が存在する場合) ComputeType の 1 つのリストが返されます。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ComputeTypeListParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で ComputeTypeListParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="RegistrationScope">
      ...
      <Docs>
        <summary>
            必須。 ComputeType 定義を一覧表示する対象のスコープです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
