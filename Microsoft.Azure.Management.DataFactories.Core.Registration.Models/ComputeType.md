<Type Name="ComputeType" FullName="Microsoft.Azure.Management.DataFactories.Core.Registration.Models.ComputeType">
  ...
  <Docs>
    <summary>
            ComputeType は、登録されている、パイプラインのアクティビティを実行するために使用できるユーザー定義のコンピューティング/リンクされたサービス型です。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ComputeType クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            必須の引数で ComputeType クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
