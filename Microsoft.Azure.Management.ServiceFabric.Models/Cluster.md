  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="managementEndpoint">クラスターの http 管理エンドポイント</param>
        <param name="nodeTypes">クラスターを構成する nodetypes の一覧</param>
        <param name="id">リソースの ID</param>
        <param name="name">リソース名。</param>
        <param name="type">リソースの種類。</param>
        <param name="tags">リソース タグ。</param>
        <param name="availableClusterVersions">使用可能なクラスター コードのバージョンをクラスターにアップグレードできますにアップグレードするにはマニュアル upgradeMode を選択する必要がありますに注意してください。</param>
        <param name="clusterId">クラスター リソースの一意の識別子</param>
        <param name="clusterState">クラスターの状態です。 使用可能な値が含まれます: 'WaitingForNodes'、'を展開する'、'BaselineUpgrade'、'UpdatingUserConfiguration'、'UpdatingUserCertificate'、'UpdatingInfrastructure'、'EnforcingClusterVersion'、'UpgradeServiceUnreachable'、'AutoScale'、'準備完了'</param>
        <param name="clusterEndpoint">Servicefabric リソース プロバイダーに接続する、クラスターのエンドポイント</param>
        <param name="clusterCodeVersion">クラスターで実行されている ServiceFabric コードのバージョン</param>
        <param name="certificate">このプライマリ証明書は、クラスターにノードのセキュリティ、クラスター管理エンドポイントと既定の管理クライアントの SSL 証明書として使用されます。</param>
        <param name="reliabilityLevel">クラスターの信頼性レベルでは、システム サービスのレプリカ セットのサイズを示します。 使用可能な値が含まれます: 'ブロンズ'、'銀色'、'ゴールド'、'プラチナ'</param>
        <param name="upgradeMode">クラスターのアップグレード モードでは、かどうかの fabric アップグレードが自動的に開始、システムによってかを示します。 使用可能な値が含まれます '自動'、'Manual'。</param>
        <param name="clientCertificateThumbprints">クライアント拇印詳細については、クラスター操作用のクライアント アクセスに使用されます</param>
        <param name="clientCertificateCommonNames"> クライアント証明書の共通名に基づくホワイト リストの一覧</param>
        <param name="fabricSettings">クラスターを構成するカスタム ファブリック設定の一覧です。</param>
        <param name="reverseProxyCertificate">リバース プロキシによって使用されるサーバーの証明書</param>
        <param name="azureActiveDirectory">クラスターの AAD 認証を有効に設定</param>
        <param name="provisioningState">クラスター リソースのプロビジョニングの状態。 使用可能な値が含まれます: '更新'、'成功'、'失敗'、'キャンセル'</param>
        <param name="vmImage">VM イメージ VMSS の名前が構成されています。 Windows または Linux などの汎用名を使用できます。</param>
        <param name="diagnosticsStorageAccountConfig">ストレージ診断アカウント構成の詳細</param>
    ...
    <Member MemberName="AvailableClusterVersions">
      ...
      <Docs>
        <summary>
            使用可能なクラスター コードのクラスターをアップグレードするバージョンを取得にアップグレードするにはマニュアル upgradeMode を選択する必要があることに注意してください。
            </summary>
    ...
    <Member MemberName="Certificate">
      ...
      <Docs>
        <summary>
            クラスターにノードのセキュリティ、クラスター管理エンドポイントと既定の管理クライアントの SSL 証明書のとして使用されるこのプライマリ証明書を取得または設定
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ClientCertificateCommonNames">
      ...
      <Docs>
        <summary>
            取得またはホワイト リストの共通名に基づいたクライアントの証明書の一覧を設定
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ClientCertificateThumbprints">
      ...
      <Docs>
        <summary>
            取得または拇印の詳細については、クライアントを設定クラスター操作用のクライアント アクセスに使用されます
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ClusterCodeVersion">
      ...
      <Docs>
        <summary>
            取得または設定、クラスターで実行されている ServiceFabric コードのバージョン
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ClusterEndpoint">
      ...
      <Docs>
        <summary>
            エンドポイント servicefabric リソース プロバイダーに接続するクラスターを取得します
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ClusterState">
      ...
      <Docs>
        <summary>
            クラスターの状態を取得します。 使用可能な値が含まれます: 'WaitingForNodes'、'を展開する'、'BaselineUpgrade'、'UpdatingUserConfiguration'、'UpdatingUserCertificate'、'UpdatingInfrastructure'、'EnforcingClusterVersion'、'UpgradeServiceUnreachable'、'AutoScale'、'準備完了'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="FabricSettings">
      ...
      <Docs>
        <summary>
            取得またはクラスターを構成するカスタム ファブリック設定の一覧を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="NodeTypes">
      ...
      <Docs>
        <summary>
            取得または設定、クラスターを構成する nodetypes の一覧
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ProvisioningState">
      ...
      <Docs>
        <summary>
            クラスター リソースのプロビジョニングの状態を取得します。 使用可能な値が含まれます: '更新'、'成功'、'失敗'、'キャンセル'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReliabilityLevel">
      ...
      <Docs>
        <summary>
            取得または設定クラスター信頼性レベルでは、レプリカ セットのシステム サービスのサイズを示します。 使用可能な値が含まれます: 'ブロンズ'、'銀色'、'ゴールド'、'プラチナ'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReverseProxyCertificate">
      ...
      <Docs>
        <summary>
            取得またはリバース プロキシによって使用されるサーバーの証明書の設定
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="VmImage">
      ...
      <Docs>
        <summary>
            取得または VMSS はで構成されている VM イメージの名前を設定します。
            Windows または Linux などの汎用名を使用できます。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
