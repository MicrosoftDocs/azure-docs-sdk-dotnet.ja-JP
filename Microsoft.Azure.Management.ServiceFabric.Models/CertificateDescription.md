<Type Name="CertificateDescription" FullName="Microsoft.Azure.Management.ServiceFabric.Models.CertificateDescription">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            CertificateDescription クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="thumbprint">プライマリ証明書の拇印</param>
        <param name="thumbprintSecondary">セカンダリ証明書の拇印</param>
        <param name="x509StoreName">ローカルの証明書ストアの場所。
            使用可能な値が含まれます: 'AddressBook'、'AuthRoot'、'CertificateAuthority'、'許可されていない'、'My'、'Root'、'TrustedPeople'、'TrustedPublisher'</param>
        <summary>
            CertificateDescription クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="X509StoreName">
      ...
      <Docs>
        <summary>
            取得またはローカルの証明書ストアの場所を設定します。 使用可能な値が含まれます: 'AddressBook'、'AuthRoot'、'CertificateAuthority'、'許可されていない'、'My'、'Root'、'TrustedPeople'、'TrustedPublisher'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
