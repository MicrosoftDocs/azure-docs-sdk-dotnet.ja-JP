  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="display">結果の dispaly</param>
        <param name="origin">配信元の結果</param>
        <param name="nextLink">次の結果セットを取得するために使用する URL。</param>
        <summary>
            OperationResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="NextLink">
      ...
      <Docs>
        <summary>
            取得または次の結果セットを取得するために使用する URL を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
