<Type Name="ClusterCodeVersionsResult" FullName="Microsoft.Azure.Management.ServiceFabric.Models.ClusterCodeVersionsResult">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            ClusterCodeVersionsResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">結果の id</param>
        <param name="name">結果の名前</param>
        <param name="type">結果のリソースの種類</param>
        <param name="codeVersion">クラスターの ServiceFabric ランタイムのバージョン</param>
        <param name="supportExpiryUtc">バージョンのサポートの有効期限の日付</param>
        <param name="environment">オペレーティング システムをクラスター化します。 使用可能な値が含まれます 'Windows'、'Linux'。</param>
        <summary>
            ClusterCodeVersionsResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="CodeVersion">
      ...
      <Docs>
        <summary>
            取得または設定、クラスターの ServiceFabric ランタイムのバージョン
            </summary>
    ...
    <Member MemberName="Environment">
      ...
      <Docs>
        <summary>
            取得またはクラスター オペレーティング システムを設定します。 使用可能な値が含まれます 'Windows'、'Linux'。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
