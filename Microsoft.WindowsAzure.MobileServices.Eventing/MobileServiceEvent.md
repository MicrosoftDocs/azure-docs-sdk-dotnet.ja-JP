<Type Name="MobileServiceEvent" FullName="Microsoft.WindowsAzure.MobileServices.Eventing.MobileServiceEvent">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="6652a-101">モバイル サービス イベントを表します。</span><span class="sxs-lookup"><span data-stu-id="6652a-101">Represents a mobile service event.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name"><span data-ttu-id="6652a-102">イベントの名前です。</span><span class="sxs-lookup"><span data-stu-id="6652a-102">The event name.</span></span></param>
        <summary>
            <span data-ttu-id="6652a-103">インスタンスを作成、<see cref="T:Microsoft.WindowsAzure.MobileServices.Eventing.MobileServiceEvent" />です。</span><span class="sxs-lookup"><span data-stu-id="6652a-103">Creates an instance of a <see cref="T:Microsoft.WindowsAzure.MobileServices.Eventing.MobileServiceEvent" />.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="6652a-104">イベントの名前を取得します。</span><span class="sxs-lookup"><span data-stu-id="6652a-104">Gets the event name.</span></span>
            </summary>
