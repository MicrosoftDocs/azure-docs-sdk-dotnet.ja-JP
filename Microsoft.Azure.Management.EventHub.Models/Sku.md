<Type Name="Sku" FullName="Microsoft.Azure.Management.EventHub.Models.Sku">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="name">この SKU の名前です。 使用可能な値が含まれます: 'Basic'、'Standard'</param>
        <param name="tier">この特定の SKU の請求層です。
            使用可能な値が含まれます: 'Basic'、'Standard'</param>
        <param name="capacity">Event Hubs スループット単位、値は、0 ~ 20 スループット単位にする必要があります。</param>
        <summary>
            Sku クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Capacity">
      ...
      <Docs>
        <summary>
            取得または Event Hubs スループット単位の設定値は 0 ~ 20 スループット単位をする必要があります。
            </summary>
    ...
    <Member MemberName="Name">
      ...
      <Docs>
        <summary>
            取得またはこの SKU の名前を設定します。 使用可能な値が含まれます: 'Basic'、'Standard'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Tier">
      ...
      <Docs>
        <summary>
            取得またはこの特定の SKU の請求層を設定します。 使用可能な値が含まれます: 'Basic'、'Standard'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
