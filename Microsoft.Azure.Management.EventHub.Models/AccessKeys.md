<Type Name="AccessKeys" FullName="Microsoft.Azure.Management.EventHub.Models.AccessKeys">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="primaryConnectionString">作成された名前空間 AuthorizationRule のプライマリ接続文字列。</param>
        <param name="secondaryConnectionString">作成された名前空間 AuthorizationRule のセカンダリ接続文字列。</param>
        ...
        <param name="keyName">AuthorizationRule を説明する文字列。</param>
        <summary>
            AccessKeys クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="KeyName">
      ...
      <Docs>
        <summary>
            AuthorizationRule を説明する文字列を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
