<Type Name="TrackedResource" FullName="Microsoft.Azure.Management.EventHub.Models.TrackedResource">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="037d7-101">リソースの定義</span><span class="sxs-lookup"><span data-stu-id="037d7-101">Definition of Resource</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="037d7-102">TrackedResource クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="037d7-102">Initializes a new instance of the TrackedResource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="037d7-103">リソース Id</span><span class="sxs-lookup"><span data-stu-id="037d7-103">Resource Id</span></span></param>
        <param name="name"><span data-ttu-id="037d7-104">リソース名</span><span class="sxs-lookup"><span data-stu-id="037d7-104">Resource name</span></span></param>
        <param name="type"><span data-ttu-id="037d7-105">リソースの種類</span><span class="sxs-lookup"><span data-stu-id="037d7-105">Resource type</span></span></param>
        <param name="location"><span data-ttu-id="037d7-106">リソースの場所</span><span class="sxs-lookup"><span data-stu-id="037d7-106">Resource location</span></span></param>
        <param name="tags"><span data-ttu-id="037d7-107">リソース タグ</span><span class="sxs-lookup"><span data-stu-id="037d7-107">Resource tags</span></span></param>
        <summary>
            <span data-ttu-id="037d7-108">TrackedResource クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="037d7-108">Initializes a new instance of the TrackedResource class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Location">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="037d7-109">取得またはリソースの場所の設定</span><span class="sxs-lookup"><span data-stu-id="037d7-109">Gets or sets resource location</span></span>
            </summary>
    ...
    <Member MemberName="Tags">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="037d7-110">取得またはリソース タグを設定</span><span class="sxs-lookup"><span data-stu-id="037d7-110">Gets or sets resource tags</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
