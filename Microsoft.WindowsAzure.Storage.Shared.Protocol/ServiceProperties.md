<Type Name="ServiceProperties" FullName="Microsoft.WindowsAzure.Storage.Shared.Protocol.ServiceProperties">
  ...
  <Docs>
    <summary>
            クラウド ストレージ サービスに関連するプロパティのセットを表すクラスです。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="Cors">
      ...
      <Docs>
        <summary>
            取得またはクロス オリジン リソース共有 (CORS) のプロパティを設定します。
            </summary>
    ...
    <Member MemberName="DefaultServiceVersion">
      ...
      <Docs>
        <summary>
            取得または既定のサービス バージョンを設定します。
            </summary>
        <value>既定のサービスのバージョン識別子です。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="MinuteMetrics">
      ...
      <Docs>
        <summary>
            取得または分単位のメトリックのプロパティを設定します。
            </summary>
        <value>分単位のメトリックのプロパティです。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
