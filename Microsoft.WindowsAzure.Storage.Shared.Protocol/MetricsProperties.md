<Type Name="MetricsProperties" FullName="Microsoft.WindowsAzure.Storage.Shared.Protocol.MetricsProperties">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            MetricsProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="MetricsLevel">
      ...
      <Docs>
        <summary>
            取得またはメトリックの収集の状態を設定します。
            </summary>
        <value>A<see cref="P:Microsoft.WindowsAzure.Storage.Shared.Protocol.MetricsProperties.MetricsLevel" />存在する場合、収集するメトリックを示す値。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
