  ...
  <Members>
    ...
    <Member MemberName="TargetStorageVersion">
      ...
      <Docs>
        <summary>
            現在の記憶域バージョン ヘッダーの値。
            このバージョンが変更されるたびに、アセンブリのバージョンをも更新する必要があります。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
