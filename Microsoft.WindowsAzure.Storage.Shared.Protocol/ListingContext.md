<Type Name="ListingContext" FullName="Microsoft.WindowsAzure.Storage.Shared.Protocol.ListingContext">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="prefix">リソース名のプレフィックス。</param>
        <param name="maxResults">5000 の操作あたりの上限に達するまでの 1 つの操作で返されるリソースの最大数。</param>
        <summary>
            <see cref="T:Microsoft.WindowsAzure.Storage.Shared.Protocol.ListingContext" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
