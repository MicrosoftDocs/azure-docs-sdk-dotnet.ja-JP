<Type Name="IAppServiceDomains" FullName="Microsoft.Azure.Management.AppService.Fluent.IAppServiceDomains">
  ...
  <Members>
    <Member MemberName="ListAgreements">
      ...
      <Docs>
        <param name="topLevelExtension">ドメイン、たとえば、"com"と、"net"、「組織」の最上位レベルの拡張機能です。</param>
        <summary>
            特定最上位レベルの拡張子を持つドメインを購入するためのアグリーメントを一覧表示します。
            </summary>
        <returns>To be added.</returns>
        <remarks>To be added.</remarks>
        <return>注文書に必要な契約の一覧。</return>
      </Docs>
    </Member>
  </Members>
</Type>