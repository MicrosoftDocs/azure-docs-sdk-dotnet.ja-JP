<Type Name="ChaosStatus" FullName="System.Fabric.Chaos.DataStructures.ChaosStatus">
  ...
  <Docs>
    <summary>
      <para>Chaos が現在実行中のタスクを表します。</para>
    </summary>
  ...
  <Members>
    <Member MemberName="None">
      ...
      <Docs>
        <summary>
          <para>現在のタスクが有効ではないことを示します。</para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Running">
      ...
      <Docs>
        <summary>
          <para>Chaos がエラーを発生させることの一部としてアクションを実行していることを示します。</para>
        </summary>
      </Docs>
    </Member>
    <Member MemberName="Stopped">
      ...
      <Docs>
        <summary>
          <para>今すぐ検証する場合は、クラスターが安定し、正常な状態、Chaos にエラーを発生させることが完了したことを示します。</para>
        </summary>
      </Docs>
    </Member>
  </Members>
