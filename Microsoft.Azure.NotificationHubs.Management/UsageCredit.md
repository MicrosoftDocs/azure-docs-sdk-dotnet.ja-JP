<Type Name="UsageCredit" FullName="Microsoft.Azure.NotificationHubs.Management.UsageCredit">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Parameters />
      <Docs>
        <summary><see cref="T:Microsoft.Azure.NotificationHubs.Management.UsageCredit" /> クラスの新しいインスタンスを初期化します。</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="NHBasicUnit">
      ...
      <Docs>
        <summary>取得または通知ハブの基本単位を設定します。</summary>
    ...
    <Member MemberName="NHStandardUnit">
      ...
      <Docs>
        <summary>取得または通知ハブの標準的な単位を設定します。</summary>
    ...
    <Member MemberName="ToString">
      ...
      <Parameters />
      <Docs>
        <summary>文字列表現を返します<see cref="T:Microsoft.Azure.NotificationHubs.Management.UsageCredit" />です。</summary>
        <returns>文字列表現<see cref="T:Microsoft.Azure.NotificationHubs.Management.UsageCredit" />です。</returns>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="UpdatedAt">
      ...
      <Docs>
        <summary>取得または最後の日付、クレジットの詳細が更新された日時を設定します。</summary>
        <value>最後の日付では、クレジットの詳細が更新された日時。</value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
  </Members>
