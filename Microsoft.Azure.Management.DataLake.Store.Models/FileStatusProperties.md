<Type Name="FileStatusProperties" FullName="Microsoft.Azure.Management.DataLake.Store.Models.FileStatusProperties">
  ...
  <Docs>
    <summary>
            Data Lake Store のファイルまたはディレクトリの情報です。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            FileStatusProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="accessTime">エポック以降のタイマー刻みとしての最終アクセス時刻です。</param>
        <param name="blockSize">ファイルのブロック サイズ。</param>
        <param name="childrenNum">ディレクトリ内の子の数。</param>
        <param name="expirationTime">存在する場合、エポック以降のティックとして、有効期限を取得します。 値が 0 または DateTime.MaxValue 場合の有効期限はありません。</param>
        <param name="group">グループの所有者。</param>
        <param name="length">ファイル内のバイト数。</param>
        <param name="modificationTime">タイマー刻みとしてエポック以降の更新時刻。</param>
        <param name="owner">所有者であるユーザー。</param>
        <param name="pathSuffix">パスのサフィックス。</param>
        <param name="permission">アクセス許可を文字列として表されます。</param>
        <param name="type">パス オブジェクトの型。 使用可能な値が含まれます 'FILE'、'DIRECTORY'。</param>
        <param name="aclBit">拡張 acl が有効になっているかどうかを示すフラグします。
            </param>
        <summary>
            FileStatusProperties クラスの新しいインスタンスを初期化します。
            </summary>
    ...
    <Member MemberName="AccessTime">
      ...
      <Docs>
        <summary>
            タイマー刻みとして新しいエポック以降の最終アクセス時刻を取得します。
            </summary>
    ...
    <Member MemberName="AclBit">
      ...
      <Docs>
        <summary>
            拡張 acl が有効になっているかどうかを示すためにフラグを取得
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ExpirationTime">
      ...
      <Docs>
        <summary>
            存在する場合、エポック以降のティックとして、有効期限を取得します。 値が 0 または DateTime.MaxValue 場合の有効期限はありません。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            パス オブジェクトの種類を取得します。 使用可能な値が含まれます 'FILE'、'DIRECTORY'。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
