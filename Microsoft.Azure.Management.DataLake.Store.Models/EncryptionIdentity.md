<Type Name="EncryptionIdentity" FullName="Microsoft.Azure.Management.DataLake.Store.Models.EncryptionIdentity">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            EncryptionIdentity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="principalId">暗号化に関連付けられているプリンシパルの識別子。</param>
        <param name="tenantId">暗号化に関連付けられているテナントの識別子です。</param>
        <summary>
            EncryptionIdentity クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Type">
      ...
      <Docs>
        <summary>
            使用されている暗号化の種類。 現在、唯一サポートされている型は 'SystemAssigned' です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
