<Type Name="AclStatus" FullName="Microsoft.Azure.Management.DataLake.Store.Models.AclStatus">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            AclStatus クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="entries">ファイルまたはディレクトリに対する ACLSpec エントリの一覧です。</param>
        <param name="group">グループの所有者、AAD のオブジェクト id です。</param>
        <param name="owner">AAD のオブジェクト ID のユーザーを所有者</param>
        <param name="permission">名前のないユーザー、マスクと他のアクセス許可の 8 進数表現です。</param>
        <param name="stickyBit">付箋のビットがオンかオフかどうかを示すインジケーター。</param>
        <summary>
            AclStatus クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Entries">
      ...
      <Docs>
        <summary>
            取得または ACLSpec エントリの一覧をファイルまたはディレクトリに設定します。
            </summary>
    ...
    <Member MemberName="Group">
      ...
      <Docs>
        <summary>
            取得または設定グループの所有者、AAD のオブジェクト id です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Owner">
      ...
      <Docs>
        <summary>
            取得または設定、ユーザーの所有者、AAD のオブジェクト id です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Permission">
      ...
      <Docs>
        <summary>
            取得または、8 進数形式の名前のないユーザー、マスクと他のアクセス許可を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="StickyBit">
      ...
      <Docs>
        <summary>
            付箋のビットがオンかオフかどうかを示すインジケーターを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
