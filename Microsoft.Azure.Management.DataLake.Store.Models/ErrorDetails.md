<Type Name="ErrorDetails" FullName="Microsoft.Azure.Management.DataLake.Store.Models.ErrorDetails">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="b0c2a-101">Data Lake Store エラーの詳細情報</span><span class="sxs-lookup"><span data-stu-id="b0c2a-101">Data Lake Store error details information</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0c2a-102">ErrorDetails クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b0c2a-102">Initializes a new instance of the ErrorDetails class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="code"><span data-ttu-id="b0c2a-103">HTTP ステータス コードまたはこのエラーに関連付けられているエラー コード</span><span class="sxs-lookup"><span data-stu-id="b0c2a-103">the HTTP status code or error code associated with this error</span></span></param>
        <param name="message"><span data-ttu-id="b0c2a-104">エラー メッセージに基づいてブラウザーの言語のローカライズ</span><span class="sxs-lookup"><span data-stu-id="b0c2a-104">the error message localized based on Accept-Language</span></span></param>
        <param name="target"><span data-ttu-id="b0c2a-105">特定のエラー (たとえば、エラー プロパティの名前) のターゲットです。</span><span class="sxs-lookup"><span data-stu-id="b0c2a-105">the target of the particular error (for example, the name of the property in error).</span></span></param>
        <summary>
            <span data-ttu-id="b0c2a-106">ErrorDetails クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="b0c2a-106">Initializes a new instance of the ErrorDetails class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Code">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0c2a-107">HTTP ステータス コードまたはこのエラーに関連付けられているエラー コードを取得します。</span><span class="sxs-lookup"><span data-stu-id="b0c2a-107">Gets the HTTP status code or error code associated with this error</span></span>
            </summary>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0c2a-108">ブラウザーの言語に基づいて、エラー メッセージがローカライズされた取得</span><span class="sxs-lookup"><span data-stu-id="b0c2a-108">Gets the error message localized based on Accept-Language</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Target">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="b0c2a-109">特定のエラー (たとえば、エラー プロパティの名前) のターゲットを取得します。</span><span class="sxs-lookup"><span data-stu-id="b0c2a-109">Gets the target of the particular error (for example, the name of the property in error).</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
