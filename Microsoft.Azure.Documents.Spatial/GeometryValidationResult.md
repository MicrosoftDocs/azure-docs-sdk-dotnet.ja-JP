<Type Name="GeometryValidationResult" FullName="Microsoft.Azure.Documents.Spatial.GeometryValidationResult">
  ...
  <Docs>
    <summary>
      <para>
            値を返す<see cref="M:Microsoft.Azure.Documents.Spatial.GeometryOperationExtensions.IsValidDetailed(Microsoft.Azure.Documents.Spatial.Geometry)" />Cosmos DB の Azure サービスにします。
            </para>
      <para>
            詳細な説明、geometyr が有効な理由にはが含まれています。
            </para>
    </summary>
  ...
  <Members>
    ...
    <Member MemberName="IsValid">
      ...
      <Docs>
        <summary>
            示す値を返すかどうかを geometry<see cref="M:Microsoft.Azure.Documents.Spatial.GeometryOperationExtensions.IsValidDetailed(Microsoft.Azure.Documents.Spatial.Geometry)" />が呼び出されましたが有効か、Azure Cosmos DB ではなくサービスを提供します。
            </summary>
        <value>
          <c>true</c>場合を geometry<see cref="M:Microsoft.Azure.Documents.Spatial.GeometryOperationExtensions.IsValidDetailed(Microsoft.Azure.Documents.Spatial.Geometry)" />が呼び出されましたが有効です。 <c>false</c>それ以外の場合。
            </value>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Reason">
      ...
      <Docs>
        <summary>
            Geometry が有効でない場合は、Azure Cosmos DB サービスの詳細な理由を返します。
            </summary>
        <value>
            Geometry が有効な理由の説明。
            </value>
