<Type Name="SecretBundle" FullName="Microsoft.Azure.KeyVault.Models.SecretBundle">
  ...
  <Members>
    ...
    <Member MemberName="Kid">
      ...
      <Docs>
        <summary>
            このフィールドを KV 証明書をバックアップ、対応するキーを指定し、これは、シークレット KV 証明書をバックアップする場合を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Managed">
      ...
      <Docs>
        <summary>
            シークレットの有効期間が資格情報コンテナーで管理されている場合は true を取得します。 これは、シークレットのバックアップし、管理、証明書が true になります。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
