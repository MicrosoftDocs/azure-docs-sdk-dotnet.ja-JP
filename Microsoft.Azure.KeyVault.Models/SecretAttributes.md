  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="recoveryLevel">削除回復のレベルは、現在有効で、現在の資格情報コンテナー内の機密情報が反映されます。 特権を持つユーザーは、シークレットを完全に削除 'Purgeable' が含まれている場合それ以外の場合、システムだけでは、保有期間の最後に、シークレットを削除できます。 使用可能な値が含まれます: 'パージ可能な'、' 回復可能な + Purgeable'、'回復可能な'、' 回復可能な + ProtectedSubscription'</param>
        <summary>
            SecretAttributes クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="RecoveryLevel">
      ...
      <Docs>
        <summary>
            取得には、削除回復のレベルは、現在有効で、現在の資格情報コンテナー内の機密情報が反映されます。 特権を持つユーザーは、シークレットを完全に削除 'Purgeable' が含まれている場合それ以外の場合、システムだけでは、保有期間の最後に、シークレットを削除できます。 使用可能な値が含まれます: 'パージ可能な'、' 回復可能な + Purgeable'、'回復可能な'、' 回復可能な + ProtectedSubscription'
            </summary>
