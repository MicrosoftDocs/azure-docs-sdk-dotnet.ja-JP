<Type Name="CertificatePolicy" FullName="Microsoft.Azure.KeyVault.Models.CertificatePolicy">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="bcb48-101">証明書の管理ポリシー。</span><span class="sxs-lookup"><span data-stu-id="bcb48-101">Management policy for a certificate.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bcb48-102">CertificatePolicy クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="bcb48-102">Initializes a new instance of the CertificatePolicy class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id"><span data-ttu-id="bcb48-103">証明書の id です。</span><span class="sxs-lookup"><span data-stu-id="bcb48-103">The certificate id.</span></span></param>
        <param name="keyProperties"><span data-ttu-id="bcb48-104">証明書をバックアップするキーのプロパティです。</span><span class="sxs-lookup"><span data-stu-id="bcb48-104">Properties of the key backing a certificate.</span></span></param>
        <param name="secretProperties"><span data-ttu-id="bcb48-105">証明書をバックアップするシークレットのプロパティです。</span><span class="sxs-lookup"><span data-stu-id="bcb48-105">Properties of the secret backing a certificate.</span></span></param>
        <param name="x509CertificateProperties"><span data-ttu-id="bcb48-106">プロパティの X509 証明書のコンポーネントです。</span><span class="sxs-lookup"><span data-stu-id="bcb48-106">Properties of the X509 component of a certificate.</span></span></param>
        <param name="lifetimeActions"><span data-ttu-id="bcb48-107">Key Vault によって証明書の有効期間にわたって実行されるアクション。</span><span class="sxs-lookup"><span data-stu-id="bcb48-107">Actions that will be performed by Key Vault over the lifetime of a certificate.</span></span></param>
        <param name="issuerParameters"><span data-ttu-id="bcb48-108">パラメーターが X509 の発行者の証明書のコンポーネントです。</span><span class="sxs-lookup"><span data-stu-id="bcb48-108">Parameters for the issuer of the X509 component of a certificate.</span></span></param>
        <param name="attributes"><span data-ttu-id="bcb48-109">証明書の属性です。</span><span class="sxs-lookup"><span data-stu-id="bcb48-109">The certificate attributes.</span></span></param>
        <summary>
            <span data-ttu-id="bcb48-110">CertificatePolicy クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="bcb48-110">Initializes a new instance of the CertificatePolicy class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Attributes">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bcb48-111">取得または証明書の属性を設定します。</span><span class="sxs-lookup"><span data-stu-id="bcb48-111">Gets or sets the certificate attributes.</span></span>
            </summary>
    ...
    <Member MemberName="Id">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bcb48-112">証明書の id を取得します。</span><span class="sxs-lookup"><span data-stu-id="bcb48-112">Gets the certificate id.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="IssuerParameters">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bcb48-113">取得または設定のパラメーター、発行者の X509 証明書のコンポーネントです。</span><span class="sxs-lookup"><span data-stu-id="bcb48-113">Gets or sets parameters for the issuer of the X509 component of a certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="KeyProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bcb48-114">取得または証明書をバックアップするキーのプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="bcb48-114">Gets or sets properties of the key backing a certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LifetimeActions">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bcb48-115">取得または証明書の有効期間にわたって Key Vault によって実行されるアクションを設定します。</span><span class="sxs-lookup"><span data-stu-id="bcb48-115">Gets or sets actions that will be performed by Key Vault over the lifetime of a certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecretProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bcb48-116">取得または証明書をバックアップするシークレットのプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="bcb48-116">Gets or sets properties of the secret backing a certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Validate">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bcb48-117">オブジェクトを検証します。</span><span class="sxs-lookup"><span data-stu-id="bcb48-117">Validate the object.</span></span>
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:Microsoft.Rest.ValidationException">
            <span data-ttu-id="bcb48-118">検証が失敗した場合にスローされます。</span><span class="sxs-lookup"><span data-stu-id="bcb48-118">Thrown if validation fails</span></span>
            </exception>
      </Docs>
    </Member>
    <Member MemberName="X509CertificateProperties">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="bcb48-119">取得または設定のプロパティの X509 証明書のコンポーネントです。</span><span class="sxs-lookup"><span data-stu-id="bcb48-119">Gets or sets properties of the X509 component of a certificate.</span></span>
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
