  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="keyProperties">証明書をバックアップするキーのプロパティです。</param>
        <param name="secretProperties">証明書をバックアップするシークレットのプロパティです。</param>
        <param name="x509CertificateProperties">プロパティの X509 証明書のコンポーネントです。</param>
        <param name="lifetimeActions">Key Vault によって証明書の有効期間にわたって実行されるアクション。</param>
    ...
    <Member MemberName="KeyProperties">
      ...
      <Docs>
        <summary>
            取得または証明書をバックアップするキーのプロパティを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="LifetimeActions">
      ...
      <Docs>
        <summary>
            取得または証明書の有効期間にわたって Key Vault によって実行されるアクションを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="SecretProperties">
      ...
      <Docs>
        <summary>
            取得または証明書をバックアップするシークレットのプロパティを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="X509CertificateProperties">
      ...
      <Docs>
        <summary>
            取得または設定のプロパティの X509 証明書のコンポーネントです。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
