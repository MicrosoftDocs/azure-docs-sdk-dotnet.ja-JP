<Type Name="SasDefinitionBundle" FullName="Microsoft.Azure.KeyVault.Models.SasDefinitionBundle">
  ...
  <Docs>
    <summary>
            SAS 定義バンドルは、資格情報コンテナーの SAS 定義の詳細とその属性で構成されます。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SasDefinitionBundle クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">SAS 定義 id。</param>
        <param name="secretId">記憶域アカウント SAS 定義シークレット id です。</param>
        <param name="parameters">キー/値ペアの形式で SAS 定義のメタデータ。</param>
        <param name="attributes">SAS 定義の属性です。</param>
    ...
    <Member MemberName="SecretId">
      ...
      <Docs>
        <summary>
            記憶域アカウント SAS 定義シークレット id を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
