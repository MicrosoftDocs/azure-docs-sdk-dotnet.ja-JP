<Type Name="KeyVerifyResult" FullName="Microsoft.Azure.KeyVault.Models.KeyVerifyResult">
  ...
  <Docs>
    <summary>
            <span data-ttu-id="f937c-101">キーの検証結果を返します。</span><span class="sxs-lookup"><span data-stu-id="f937c-101">The key verify result.</span></span>
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f937c-102">KeyVerifyResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="f937c-102">Initializes a new instance of the KeyVerifyResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value"><span data-ttu-id="f937c-103">True の場合、署名が検証され、それ以外の場合は false。</span><span class="sxs-lookup"><span data-stu-id="f937c-103">True if the signature is verified, otherwise false.</span></span></param>
        <summary>
            <span data-ttu-id="f937c-104">KeyVerifyResult クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="f937c-104">Initializes a new instance of the KeyVerifyResult class.</span></span>
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            <span data-ttu-id="f937c-105">署名が検証され、それ以外の場合は false である場合は true を取得します。</span><span class="sxs-lookup"><span data-stu-id="f937c-105">Gets true if the signature is verified, otherwise false.</span></span>
            </summary>
