<Type Name="StorageBundle" FullName="Microsoft.Azure.KeyVault.Models.StorageBundle">
  ...
  <Docs>
    <summary>
            ストレージ アカウントのバンドルは、資格情報コンテナーのストレージ アカウントの詳細とその属性で構成されます。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            StorageBundle クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="id">ストレージ アカウント id を指定します。</param>
        <param name="resourceId">ストレージ アカウントのリソース id です。</param>
        <param name="activeKeyName">現在アクティブなストレージ アカウント キー名。</param>
        ...
        <param name="attributes">ストレージ アカウントの属性です。</param>
    ...
    <Member MemberName="AutoRegenerateKey">
      ...
      <Docs>
        <summary>
            Keyvault はユーザー用のストレージ アカウントを管理するかどうかを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="RegenerationPeriod">
      ...
      <Docs>
        <summary>
            キーの再生成 ISO 8601 形式で指定されている期間を取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
