<Type Name="SecretRestoreParameters" FullName="Microsoft.Azure.KeyVault.Models.SecretRestoreParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SecretRestoreParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="secretBundleBackup">シークレットのバンドルに関連付けられているバックアップ blob です。</param>
        <summary>
            SecretRestoreParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="SecretBundleBackup">
      ...
      <Docs>
        <summary>
            取得またはシークレットのバンドルに関連付けられているバックアップ blob を設定します。
            </summary>
