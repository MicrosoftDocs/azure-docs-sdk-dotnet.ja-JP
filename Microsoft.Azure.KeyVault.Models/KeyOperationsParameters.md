<Type Name="KeyOperationsParameters" FullName="Microsoft.Azure.KeyVault.Models.KeyOperationsParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            KeyOperationsParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="algorithm">アルゴリズムの識別子です。 使用可能な値が含まれます: ' RSA OAEP'、' RSA OAEP 256'、': rsa1_5 '。</param>
    ...
    <Member MemberName="Algorithm">
      ...
      <Docs>
        <summary>
            取得またはアルゴリズム識別子を設定します。 使用可能な値が含まれます: ' RSA OAEP'、' RSA OAEP 256'、': rsa1_5 '。
            </summary>
