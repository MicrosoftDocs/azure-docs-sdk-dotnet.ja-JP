<Type Name="KeyProperties" FullName="Microsoft.Azure.KeyVault.Models.KeyProperties">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="exportable">秘密キーをエクスポートできるかどうかを示します。</param>
        <param name="keyType">キーの型。</param>
        <param name="keySize">キーのサイズ (バイト単位)。 例を示します。 1024 または
            2048.</param>
        <param name="reuseKey">同じキー ペアが証明書の更新で使用されるかどうかを示します。</param>
        <summary>
            KeyProperties クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Exportable">
      ...
      <Docs>
        <summary>
            取得または設定は、秘密キーをエクスポートできるかどうかを示します。
            </summary>
    ...
    <Member MemberName="KeySize">
      ...
      <Docs>
        <summary>
            取得またはキーのサイズをバイト単位で設定します。 例を示します。 1024 または 2048。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="ReuseKey">
      ...
      <Docs>
        <summary>
            取得または設定は、同じキー ペアが証明書の更新で使用されるかどうかを示します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
