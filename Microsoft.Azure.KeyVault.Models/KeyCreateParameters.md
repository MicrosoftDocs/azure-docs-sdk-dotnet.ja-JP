<Type Name="KeyCreateParameters" FullName="Microsoft.Azure.KeyVault.Models.KeyCreateParameters">
  ...
  <Members>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="kty">作成するキーの型。 有効な値は、JsonWebKeyType を参照してください。 使用可能な値が含まれます: 'EC'、' EC HSM'、'RSA'、' RSA-HSM '、'oct'</param>
        <param name="keySize">キーのサイズ (バイト単位)。 たとえば、1024 または
            2048.</param>
        ...
        <param name="curve">楕円曲線の名前です。 有効な値は、JsonWebKeyCurveName を参照してください。 使用可能な値が含まれます: 'P-256'、'P-384'、'P-521'、'SECP256K1'</param>
        <summary>
            KeyCreateParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Curve">
      ...
      <Docs>
        <summary>
            楕円曲線名前設定または取得します。 有効な値は、JsonWebKeyCurveName を参照してください。 使用可能な値が含まれます: 'P-256'、'P-384'、'P-521'、'SECP256K1'
            </summary>
    ...
    <Member MemberName="KeySize">
      ...
      <Docs>
        <summary>
            取得またはキーのサイズをバイト単位で設定します。 たとえば、1024 または 2048。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Kty">
      ...
      <Docs>
        <summary>
            取得または作成するキーの種類を設定します。 有効な値は、JsonWebKeyType を参照してください。 使用可能な値が含まれます: 'EC'、' EC HSM'、'RSA'、' RSA-HSM '、'oct'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
