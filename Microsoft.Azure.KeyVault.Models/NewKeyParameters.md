<Type Name="NewKeyParameters" FullName="Microsoft.Azure.KeyVault.Models.NewKeyParameters">
  ...
  <Docs>
    <summary>
            新しい暗号化キーの作成に使用されるパラメーターをについて説明します。
            </summary>
  ...
  <Members>
    ...
    <Member MemberName="CurveName">
      ...
      <Docs>
        <summary>
            取得または楕円曲線暗号 (ECC) のアルゴリズムでは使用を目的の曲線の名前を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Kty">
      ...
      <Docs>
        <summary>
            取得または目的の JsonWebKey キーの種類を設定します。 使用可能な値が含まれます: 'EC'、' EC HSM'、'RSA'、' RSA-HSM '、'oct'
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
