<Type Name="SasDefinitionCreateParameters" FullName="Microsoft.Azure.KeyVault.Models.SasDefinitionCreateParameters">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            SasDefinitionCreateParameters クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="parameters">Sas 定義は、キー/値ペアの形式でのメタデータを作成します。</param>
    ...
    <Member MemberName="Parameters">
      ...
      <Docs>
        <summary>
            取得またはキー/値ペアの形式で sas 定義の作成のメタデータを設定します。
            </summary>
