<Type Name="PendingCertificateSigningRequestResult" FullName="Microsoft.Azure.KeyVault.Models.PendingCertificateSigningRequestResult">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            PendingCertificateSigningRequestResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="value">保留中の証明書署名要求を Base64 としてエンコードされた文字列。</param>
        <summary>
            PendingCertificateSigningRequestResult クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Value">
      ...
      <Docs>
        <summary>
            保留中の証明書署名 Base64 でエンコードされた文字列としての要求を取得します。
            </summary>
