<Type Name="EndpointNotFoundException" FullName="Microsoft.Azure.Relay.EndpointNotFoundException">
  ...
  <Docs>
    <summary>
            リレー HybridConnection/エンドポイントが存在する必要がありますが存在しなかった場合は、例外を表します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
                      ...
                      <see cref="T:Microsoft.Azure.Relay.EndpointNotFoundException" /> クラスの新しいインスタンスを作成します。
</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを作成、<see cref="T:Microsoft.Azure.Relay.EndpointNotFoundException" />指定したエラー メッセージを使用します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを作成、<see cref="T:Microsoft.Azure.Relay.EndpointNotFoundException" />シリアル化されたデータを持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            新しいインスタンスを作成、<see cref="T:Microsoft.Azure.Relay.EndpointNotFoundException" />指定したエラー メッセージおよびこの例外の原因となった内部例外への参照を持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
