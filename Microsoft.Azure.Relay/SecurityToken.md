<Type Name="SecurityToken" FullName="Microsoft.Azure.Relay.SecurityToken">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="tokenString">文字列の形式でトークンです。</param>
        <param name="audienceFieldName">対象フィールドのキー名。</param>
        <param name="expiresOnFieldName">キーの名前、フィールドの有効期限します。</param>
        <param name="keyValueSeparator">キーと値の間の区切り記号。</param>
        <param name="pairSeparator">別のキー/値ペアの間の区切り記号。</param>
        <summary>
            
                      <see cref="T:Microsoft.Azure.Relay.SecurityToken" /> クラスの新しいインスタンスを作成します。
</summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
