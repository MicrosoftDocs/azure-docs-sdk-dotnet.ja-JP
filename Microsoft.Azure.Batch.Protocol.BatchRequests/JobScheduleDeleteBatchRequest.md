<Type Name="JobScheduleDeleteBatchRequest" FullName="Microsoft.Azure.Batch.Protocol.BatchRequests.JobScheduleDeleteBatchRequest">
  ...
  <Docs>
    <summary>
            <see cref="T:Microsoft.Azure.Batch.Protocol.IBatchRequest" /> JobScheduleDelete 操作します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <see cref="T:Microsoft.Azure.Batch.Protocol.BatchRequests.JobScheduleDeleteBatchRequest" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
