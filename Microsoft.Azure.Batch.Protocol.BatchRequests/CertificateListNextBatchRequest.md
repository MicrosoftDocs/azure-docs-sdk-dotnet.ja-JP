<Type Name="CertificateListNextBatchRequest" FullName="Microsoft.Azure.Batch.Protocol.BatchRequests.CertificateListNextBatchRequest">
  ...
  <Docs>
    <summary>
            <see cref="T:Microsoft.Azure.Batch.Protocol.IBatchRequest" /> CertificateListNext 操作します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <see cref="T:Microsoft.Azure.Batch.Protocol.BatchRequests.CertificateListNextBatchRequest" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
