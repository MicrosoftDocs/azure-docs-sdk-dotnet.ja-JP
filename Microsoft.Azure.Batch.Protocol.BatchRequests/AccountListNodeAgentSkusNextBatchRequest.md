<Type Name="AccountListNodeAgentSkusNextBatchRequest" FullName="Microsoft.Azure.Batch.Protocol.BatchRequests.AccountListNodeAgentSkusNextBatchRequest">
  ...
  <Docs>
    <summary>
            <see cref="T:Microsoft.Azure.Batch.Protocol.IBatchRequest" /> AccountListNodeAgentSkusNext 操作します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <see cref="T:Microsoft.Azure.Batch.Protocol.BatchRequests.AccountListNodeAgentSkusNextBatchRequest" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
