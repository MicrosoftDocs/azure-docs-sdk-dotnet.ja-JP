<Type Name="PerformanceCounterTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.PerformanceCounterTelemetry">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.ApplicationInsights.DataContracts.PerformanceCounterTelemetry" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="value">パフォーマンス カウンターの値。</param>
        <summary>
            <see cref="T:Microsoft.ApplicationInsights.DataContracts.PerformanceCounterTelemetry" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
