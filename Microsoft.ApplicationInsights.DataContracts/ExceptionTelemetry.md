<Type Name="ExceptionTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.ExceptionTelemetry">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.ApplicationInsights.DataContracts.ExceptionTelemetry" />空のプロパティを持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="exception">例外のインスタンス。</param>
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.ApplicationInsights.DataContracts.ExceptionTelemetry" />空のプロパティを持つクラス。
            </summary>
        <remarks>To be added.</remarks>
    ...
    <Member MemberName="Exception">
      ...
      <Docs>
        <summary>
            これによって追跡される元の例外の設定を取得または<see cref="T:Microsoft.ApplicationInsights.Channel.ITelemetry" />です。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Message">
      ...
      <Docs>
        <summary>
            取得または ExceptionTelemetry メッセージを設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Metrics">
      ...
      <Docs>
        <summary>
            アプリケーション定義の例外のメトリックのディクショナリを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            アプリケーションで定義されたプロパティの名前と値がこの例外に関する追加情報を提供するディクショナリを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
