<Type Name="MetricTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.MetricTelemetry">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.ApplicationInsights.DataContracts.MetricTelemetry" />空のプロパティを持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            指定された <see cref="T:Microsoft.ApplicationInsights.DataContracts.MetricTelemetry" /> と <paramref name="metricName" /> を使用して、<paramref name="metricValue" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentException"><paramref name="metricName" /> Null または空の文字列です。</exception>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <param name="count">集計間隔の間に取得した値の数。</param>
        <param name="sum">集計間隔の間に取得した値の合計です。</param>
        <param name="min">集計間隔の間に取得された最小値。</param>
        <param name="max">集計間隔の間に取得した値の最大値。</param>
        <param name="standardDeviation">集計間隔の間に取得した値の標準偏差。</param>
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.ApplicationInsights.DataContracts.MetricTelemetry" />提供のプロパティを持つクラス。
            </summary>
        <remarks>
            提供されるメトリックの統計情報は、1 分が期間にわたって計算されると見なされます。
            </remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            アプリケーション定義のプロパティ名とこのメトリックに関する追加情報を提供する値のディクショナリを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
