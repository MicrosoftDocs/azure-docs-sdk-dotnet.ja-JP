<Type Name="SessionStateTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.SessionStateTelemetry">
  ...
  <Docs>
    <summary>
            テレメトリの種類がユーザー セッションを追跡するために使用します。
            </summary>
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.ApplicationInsights.DataContracts.SessionStateTelemetry" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <param name="state">
            A<see cref="T:Microsoft.ApplicationInsights.DataContracts.SessionState" />ユーザー セッションの状態を示す値。
            </param>
        <summary>
            <see cref="T:Microsoft.ApplicationInsights.DataContracts.SessionStateTelemetry" /> を指定して、<paramref name="state" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    <Member MemberName="Context">
      ...
      <Docs>
        <summary>
            取得、<see cref="T:Microsoft.ApplicationInsights.DataContracts.TelemetryContext" />セッション状態が記録されたときに、アプリケーションのです。
            </summary>
    ...
    <Member MemberName="Microsoft.ApplicationInsights.Channel.ITelemetry.Sanitize">
      ...
      <Docs>
        <summary>
            機能では、Application Insights でできることを確認するには、この製品利用統計情報インスタンスです。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
