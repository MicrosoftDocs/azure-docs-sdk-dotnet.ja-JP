<Type Name="AvailabilityTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.AvailabilityTelemetry">
  ...
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            新しいインスタンスを初期化、<see cref="T:Microsoft.ApplicationInsights.DataContracts.AvailabilityTelemetry" />空のプロパティを持つクラス。
            </summary>
        <remarks>To be added.</remarks>
      </Docs>
    </Member>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            アプリケーションで定義されたプロパティの名前と値がこの可用性テストの実行に関する追加情報を提供するディクショナリを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
    ...
    <Member MemberName="Success">
      ...
      <Docs>
        <summary>
            取得または可用性テストが正常に終了したかどうかを示す値を設定します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
