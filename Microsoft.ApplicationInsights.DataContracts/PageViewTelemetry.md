<Type Name="PageViewTelemetry" FullName="Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry">
  ...
  <Docs>
    <summary>
            製品利用統計情報の種類がページ ビューを追跡するために使用します。
            </summary>
    <remarks>
            インスタンスを渡すことによって、アプリケーションに Application Insights で表示したページに関する情報を送信することができます、<see cref="T:Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry" />クラスを<see cref="M:Microsoft.ApplicationInsights.TelemetryClient.TrackPageView(Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry)" />メソッドです。
            </remarks>
  </Docs>
  <Members>
    <Member MemberName=".ctor">
      ...
      <Docs>
        <summary>
            <see cref="T:Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry" /> クラスの新しいインスタンスを初期化します。
            </summary>
    ...
    <Member MemberName=".ctor">
      ...
      <Docs>
        ...
        <summary>
            <see cref="T:Microsoft.ApplicationInsights.DataContracts.PageViewTelemetry" /> を指定して、<paramref name="pageName" /> クラスの新しいインスタンスを初期化します。
            </summary>
        <remarks>To be added.</remarks>
        <exception cref="T:System.ArgumentException"><paramref name="pageName" /> Null または空の文字列です。</exception>
      </Docs>
    </Member>
    ...
    <Member MemberName="Properties">
      ...
      <Docs>
        <summary>
            アプリケーションで定義されたプロパティの名前と値のこのページ ビューに関する追加情報を提供するディクショナリを取得します。
            </summary>
        <value>To be added.</value>
        <remarks>To be added.</remarks>
      </Docs>
